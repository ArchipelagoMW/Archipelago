...
class TestDistributeItemsRestrictive(unittest.TestCase):
    ...
    def test_deprioritized_still_goes_on_priority_if_necessary(self):
        multiworld = generate_test_multiworld(1)
        player1 = generate_player_data(multiworld, 1, 1, prog_item_count=1)
        ...
        self.assertTrue(player1.locations[0].item.deprioritized)
