...
from worlds.alttp.Options import WorldState, Logic, MireMedallion, TurtleMedallion
...
class TestInvertedMinor(TestBase):
    def setUp(self):
        ...
        setattr(self.multiworld, "glitches_required", {1: Logic(Logic.option_minor_glitches)})
