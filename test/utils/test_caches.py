...
from Utils import cache_argsless, cache_self1, cache_self1_default
...
class TestCacheSelf1Default(unittest.TestCase):
    def test_cache(self) -> None:
        class Cls:
            @cache_self1_default
            def func(self, _: Any = 3) -> object:
                return object()
    ...
    def test_default(self) -> None:
        ...
        o1 = Cls()
        self.assertTrue(o1.func(1) is o1.func())
    ...
    if __debug__:  # assert only available with __debug__
        def test_no_self(self) -> None:
            with self.assertRaises(Exception):
                @cache_self1_default  # type: ignore[arg-type]
                def func() -> Any:
                    pass
