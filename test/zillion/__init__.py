...
# copied from SoE (and fixed typing)
# TODO: put somewhere for all games
class ZillionTestBase(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        for name, option in AutoWorld.AutoWorldRegister.world_types[self.game].option_definitions.items():
            setattr(args, name, {
                # TODO: from_any abstract class method on AssembleOptions
                1: typing.cast(typing.Callable[[typing.Any], Option[typing.Any]],
                               getattr(option, "from_any"))(self.options.get(name, getattr(option, "default")))
            })
        # TODO: typing for set_options on MultiWorld
        typing.cast(typing.Callable[[Namespace], None], getattr(self.world, "set_options"))(args)
