...
class TestAdvancements(TestMinecraft):
    ...
    def test_42098(self):
        self.run_location_tests([
            ...
            ["Is It a Plane?", False, ['Progressive Weapons'], ['Progressive Weapons', 'Progressive Weapons']], 
            ["Is It a Plane?", False, [], ['Progressive Armor']], 
