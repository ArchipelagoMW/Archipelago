...
| create_as_hint | int | If non-zero, the scouted locations get created and broadcasted as a player-visible hint. <br/>If 2 only new unfound hints are broadcast, however this does not remove them from the LocationInfo reply. |
