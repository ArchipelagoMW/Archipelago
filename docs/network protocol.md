...
### Retrieved
Sent to clients as a response to a [Get](#Get) package.
#### Arguments
| Name | Type             | Notes                                                                                               |
|------|------------------|-----------------------------------------------------------------------------------------------------|
...
`location` is the location id of the item inside the world. Location ids are only supported in the range of [-2<sup>53</sup>, 2<sup>53</sup> - 1].
...
server most easily and not maintain their own mappings. Some contents include:
   ...
   - ID to Name mappings for items and locations.
...
* IDs <= 0 are reserved for "Archipelago" and should not be used by other world definitions.
* The IDs from the game "Archipelago" (in `worlds/generic`) may be used in any other game.
...
| item_name_groups     | dict[str, str] | Mapping of all item name groups and what item names are associated with that group.                                           |
| location_name_groups | dict[str, str] | Mapping of all location name groups and what location names are associated with that group.                                   |
