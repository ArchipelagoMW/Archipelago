...
Refer to the following documents as well:
    ...
    * [api.md](https://github.com/ArchipelagoMW/Archipelago/blob/main/docs/api.md)
...
The minimum requirements for a new archipelago world are the module itself (the world folder containing a file named `__init__.py`),
