...
Ashipelago is a custom fork of Archipelago that provides a generic framework for developing multiworld capability for game randomizers as well as custom Discord integration and custom world integration. In all cases,
