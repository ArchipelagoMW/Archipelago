...
location_table = {
    ...
    'Pinball Zone - Full Health Item Box':                LocationData(LocationType.BOX,  (Passage.RUBY,     3, ItemFlag.FULL_HEALTH),   'Health',  _EASIER),
    'Pinball Zone - Pink Room Full Health Item Box':      LocationData(LocationType.BOX,  (Passage.RUBY,     3, ItemFlag.FULL_HEALTH),   'Health',  _S_HARD),
    'Pinball Zone - Rolling Room Full Health Item Box':   LocationData(LocationType.BOX,  (Passage.RUBY,     3, ItemFlag.FULL_HEALTH_2), 'Health2', _S_HARD),
