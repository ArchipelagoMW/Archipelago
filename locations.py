...
location_table = {
    ...
    'Cractus - 0:55':                                     LocationData(LocationType.CHEST, (Passage.EMERALD,  4, ItemFlag.JEWEL_NE),      _ALL),
    'Cractus - 0:35':                                     LocationData(LocationType.CHEST, (Passage.EMERALD,  4, ItemFlag.JEWEL_SE),      _ALL),
    'Cractus - 0:15':                                     LocationData(LocationType.CHEST, (Passage.EMERALD,  4, ItemFlag.JEWEL_SW),      _ALL),
    ...
    '40 Below Fridge - Snowman Puzzle Lower Box':         LocationData(LocationType.BOX,   (Passage.RUBY,     2, ItemFlag.JEWEL_SW),      _ALL),
    '40 Below Fridge - Snowman Puzzle Upper Box':         LocationData(LocationType.BOX,   (Passage.RUBY,     2, ItemFlag.JEWEL_NW),      _ALL),
    ...
    'Cuckoo Condor - 0:55':                               LocationData(LocationType.CHEST, (Passage.RUBY,     4, ItemFlag.JEWEL_NE),      _ALL),
    'Cuckoo Condor - 0:35':                               LocationData(LocationType.CHEST, (Passage.RUBY,     4, ItemFlag.JEWEL_SE),      _ALL),
    'Cuckoo Condor - 0:15':                               LocationData(LocationType.CHEST, (Passage.RUBY,     4, ItemFlag.JEWEL_SW),      _ALL),
    ...
    'Aerodent - 0:55':                                    LocationData(LocationType.CHEST, (Passage.TOPAZ,    4, ItemFlag.JEWEL_NE),      _ALL),
    'Aerodent - 0:35':                                    LocationData(LocationType.CHEST, (Passage.TOPAZ,    4, ItemFlag.JEWEL_SE),      _ALL),
    'Aerodent - 0:15':                                    LocationData(LocationType.CHEST, (Passage.TOPAZ,    4, ItemFlag.JEWEL_SW),      _ALL),
    ...
    'Catbat - 0:55':                                      LocationData(LocationType.CHEST, (Passage.SAPPHIRE, 4, ItemFlag.JEWEL_NE),      _ALL),
    'Catbat - 0:35':                                      LocationData(LocationType.CHEST, (Passage.SAPPHIRE, 4, ItemFlag.JEWEL_SE),      _ALL),
    'Catbat - 0:15':                                      LocationData(LocationType.CHEST, (Passage.SAPPHIRE, 4, ItemFlag.JEWEL_SW),      _ALL),
...
class WL4Location(Location):
    ...
    def __init__(self, player: int, name: str, parent: Optional[Region] = None):
        ...
        self.type, status, self.difficulty = location_table[name]
