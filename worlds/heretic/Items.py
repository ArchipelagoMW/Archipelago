...
item_table: Dict[int, ItemDict] = {
    ...
    370005: {'classification': ItemClassification.progression,
             ...
             'episode': -1,
             'map': -1},
    370006: {'classification': ItemClassification.progression_skip_balancing,
             'count': 1,
             'name': 'Bag of Holding',
             'doom_type': 8,
             'episode': -1,
    ...
    370534: {'classification': ItemClassification.filler,
             ...
             'episode': 5,
             'map': 9},
    370600: {'classification': ItemClassification.progression_skip_balancing,
             'count': 0,
             'name': 'Crystal Capacity',
             'doom_type': 65001,
             'episode': -1,
             'map': -1},
    370601: {'classification': ItemClassification.progression_skip_balancing,
             'count': 0,
             'name': 'Ethereal Arrow Capacity',
             'doom_type': 65002,
             'episode': -1,
             'map': -1},
    370602: {'classification': ItemClassification.progression_skip_balancing,
             'count': 0,
             'name': 'Claw Orb Capacity',
             'doom_type': 65003,
             'episode': -1,
             'map': -1},
    370603: {'classification': ItemClassification.progression_skip_balancing,
             'count': 0,
             'name': 'Rune Capacity',
             'doom_type': 65004,
             'episode': -1,
             'map': -1},
    370604: {'classification': ItemClassification.progression_skip_balancing,
             'count': 0,
             'name': 'Flame Orb Capacity',
             'doom_type': 65005,
             'episode': -1,
             'map': -1},
    370605: {'classification': ItemClassification.progression_skip_balancing,
             'count': 0,
