...
location_rows = [
	...
	LocationRow('Telegrab a Gold Bar in Varrock', 'magic', ['Law Runes', 'West Varrock', ], [SkillRequirement('Magic', 33), ], [], 0),
	...
	LocationRow('Spin a Ball of Wool', 'crafting', ['Sheep', 'Spinning Wheel', ], [SkillRequirement('Crafting', 1), ], [], 0),
	...
	LocationRow('Reach a Level 20', 'general', [], [], [], 2),
	LocationRow('Reach a Level 30', 'general', [], [], [], 6),
	LocationRow('Reach a Level 40', 'general', [], [], [], 16),
	...
	LocationRow('Change your Gender', 'general', ['Makeover', ], [], [], 0),
	LocationRow('Get a Flyer from Ali the Leaflet Dropper', 'general', ['Al Kharid', 'South of Varrock', ], [], [], 0),
	...
	LocationRow('Have the Apothecary Make a Strength Potion', 'general', ['Central Varrock', 'Red Spider', 'Limpwurt Root', ], [], [], 0),
	LocationRow('Put a Whole Banana into a Bottle of Karamjan Rum', 'general', ['Karamja', ], [], [], 0),
	LocationRow('Attempt to Shear "The Thing"', 'general', ['Lumbridge Farms', ], [], [], 0),
	LocationRow('Eat a Kebab', 'general', ['Al Kharid', ], [], [], 0),
	LocationRow('Return a Beer Glass to a Bar', 'general', ['Bar', ], [], [], 0),
	LocationRow('Drink a Cadava Potion', 'general', ['Central Varrock', 'South of Varrock', ], [], [], 0),
	...
	LocationRow('Insult the Homeless', 'general', ['Central Varrock', 'South of Varrock', ], [], [], 0),
	...
	LocationRow('Pull the Lever in the Party Room', 'general', ['Falador', ], [], [], 0),
