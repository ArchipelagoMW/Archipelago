...
region_data_table: Dict[str, FF12OpenWorldRegionData] = {
    ...
    "Initial": FF12OpenWorldRegionData(connecting_regions=["Archades <-> Balfonheim Skyferry", "Bhujerba <-> Balfonheim Skyferry", "Nalbina <-> Archades Skyferry", "Nalbina <-> Balfonheim Skyferry", "Rabanastre", "Rabanastre <-> Archades Skyferry", "Rabanastre <-> Bhujerba Skyferry", "Rabanastre <-> Nalbina Skyferry", "Skyferry"]),
