...
region_data_table: Dict[str, FF12OpenWorldRegionData] = {
    ...
    "Archades": FF12OpenWorldRegionData(connecting_regions=["Aerodrome", "Balfonheim", "Draklor Laboratory", "Nalbina Fortress", "Old Archades", "Rabanastre", "Strahl"]),
    "Archades <-> Balfonheim Skyferry": FF12OpenWorldRegionData(connecting_regions=[]),
    "Bahamut": FF12OpenWorldRegionData(connecting_regions=[]),
    "Balfonheim": FF12OpenWorldRegionData(connecting_regions=["Aerodrome", "Archades", "Bhujerba", "Cerobi Steppe", "Nalbina Fortress", "Strahl"]),
    ...
    "Bhujerba": FF12OpenWorldRegionData(connecting_regions=["Aerodrome", "Balfonheim", "Dreadnought Leviathan", "Lhusu Mines", "Rabanastre", "Strahl"]),
    "Bhujerba <-> Balfonheim Skyferry": FF12OpenWorldRegionData(connecting_regions=[]),
    ...
    "Initial": FF12OpenWorldRegionData(connecting_regions=["Archades <-> Balfonheim Skyferry", "Bhujerba <-> Balfonheim Skyferry", "Nalbina <-> Archades Skyferry", "Nalbina <-> Balfonheim Skyferry", "Rabanastre", "Rabanastre <-> Archades Skyferry", "Rabanastre <-> Bhujerba Skyferry", "Rabanastre <-> Nalbina Skyferry", "Skyferry", "Trials"]),
    ...
    "Nalbina <-> Archades Skyferry": FF12OpenWorldRegionData(connecting_regions=[]),
    "Nalbina <-> Balfonheim Skyferry": FF12OpenWorldRegionData(connecting_regions=[]),
    "Nalbina Dungeon": FF12OpenWorldRegionData(connecting_regions=["Barheim Passage Shop"]),
    "Nalbina Fortress": FF12OpenWorldRegionData(connecting_regions=["Aerodrome", "Archades", "Balfonheim", "Dalmasca Estersand", "Mosphoran Highwaste", "Rabanastre", "Strahl"]),
    ...
    "Rabanastre": FF12OpenWorldRegionData(connecting_regions=["Aerodrome", "Archades", "Bahamut", "Bhujerba", "Clan Hall", "Dalmasca Estersand", "Dalmasca Westersand", "Giza Plains Dry", "Giza Plains Rains", "Lowtown", "Nalbina Fortress", "Strahl"]),
    "Rabanastre <-> Archades Skyferry": FF12OpenWorldRegionData(connecting_regions=[]),
    "Rabanastre <-> Bhujerba Skyferry": FF12OpenWorldRegionData(connecting_regions=[]),
    "Rabanastre <-> Nalbina Skyferry": FF12OpenWorldRegionData(connecting_regions=[]),
