...
ITEM_TABLE: dict[str, LMItemData] = {
    "Heart Key": LMItemData("Door Key", 0, IC.progression),
    "Club Key": LMItemData("Door Key", 1, IC.progression),
    "Diamond Key": LMItemData("Door Key", 2, IC.progression),
    "Spade Key": LMItemData("Door Key", 3, IC.progression),
    # "Parlor Key":          LMItemData("Door Key",   04, IC.progression), TODO: Left here in case I can play with starting location
