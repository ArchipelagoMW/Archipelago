...
def create_regions(world: MultiWorld, player: int, locations: LMLocation[Location, ...], location_cache: List[Location]):
    ...
    connect(world, player, names, 'Foyer', '2F Front Hallway')
    connect(world, player, names, '2F Front Hallway', 'Study', lambda state: state.has("Study Key", player))
    ...
    connect(world, player, names, '1F Hallway', '1F Washroom')
    ...
    connect(world, player, names, 'Laundry Room', 'Butler\'s Room', lambda state: state.has("Butler Key", player))
    ...
    connect(world, player, names, 'Basement Stairwell', 'Breaker room', lambda state: state.has("Breaker Key", player))
