...
- Your legally obtained Secret of Mana US ROM file, probably named `Secret of Mana (U).smc`
...
them. Player options page: [Secret of Mana Player Options Page](/games/Secret%20of%20Mana/player-options)
...
Stand-alone "Secret of Mana Randomizer" has more options. Visit
[secretofmanaancientcave.blogspot.com](https://secretofmanaancientcave.blogspot.com/)
if you want to try the official stand-alone, otherwise read below.

1. Navigate to the Player Options page, configure your options, and click the "Generate Game" button.
    - Player Options page: [Secret of Mana Player Options Page](/games/Secret%20of%20Mana/player-options)
...
5. Run your patch file through the apbpatch on evermizer.com and load it in your emulator or console.
    * apbpatch page: [apbpatch Page](https://evermizer.com/apbpatch)
6. Join the room the same way you would for [Joining a MultiWorld Game](#joining-a-multiworld-game).
...
files. Your patch file should have a `.apsom` extension.
...
page: [apbpatch Page](https://evermizer.com/apbpatch)
...
FIXME: do we want to support both from the same client or provide two separate clients?

Open ap-somclient ([Evermizer Archipelago Client Page](http://evermizer.com/somclient)) in a modern browser.
