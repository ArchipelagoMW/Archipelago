...
vanilla_shuffle_order = [
    ...
    FillMission(MissionPools.MEDIUM, [11], "Skygeirr Station", completion_critical=True, or_requirements=True), # should have and requirement (5,8,11)
    ...
    FillMission(MissionPools.MEDIUM, [11], "Dominion Space", completion_critical=True, or_requirements=True), # should have and requirement (5,8,11)
...
mini_campaign_order = [
    FillMission(MissionPools.STARTER, [-1], "Umoja", completion_critical=True),
    FillMission(MissionPools.EASY, [0], "Kaldir", completion_critical=True),
    FillMission(MissionPools.MEDIUM, [1], "Kaldir", completion_critical=True),
    FillMission(MissionPools.EASY, [0], "Char", completion_critical=True),
    FillMission(MissionPools.MEDIUM, [3], "Char", completion_critical=True),
    FillMission(MissionPools.MEDIUM, [2,4], "Zerus", completion_critical=True, or_requirements=True),
    FillMission(MissionPools.MEDIUM, [5], "Zerus", completion_critical=True),
    FillMission(MissionPools.HARD, [2,4,6], "Skygeirr Station", completion_critical=True),
    FillMission(MissionPools.HARD, [7], "Skygeirr Station", completion_critical=True),
    FillMission(MissionPools.HARD, [2,4,6], "Dominion Space", completion_critical=True),
    FillMission(MissionPools.HARD, [9], "Dominion Space", completion_critical=True),
    FillMission(MissionPools.HARD, [8,10], "Korhal", completion_critical=True),
