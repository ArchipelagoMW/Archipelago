...
# Redundant?
all_duelists: typing.Tuple[Duelist, ...] = (
    Duelist(7, "Grandpa", 1 << 0),
    Duelist(6, "Demitrius the Bully", 1 << 1),
    Duelist(5, "Tea Gardner", 1 << 2),
    Duelist(4, "Tristan Taylor", 1 << 3),
    Duelist(3, "Joey Wheeler", 1 << 4),
    Duelist(2, "Yugi Moto", 1 << 5),
    Duelist(1, "Yami Yugi", 1 << 6, True),
    # 1 << 7 unused,
    Duelist(15, "Miss Madusa", 1 << 8),
    Duelist(14, "Kreiger", 1 << 9),
    Duelist(13, "Fortuno", 1 << 10),
    Duelist(12, "Jackpot", 1 << 11),
    Duelist(11, "Fender Shrill", 1 << 12),
    Duelist(10, "Lint Greendale", 1 << 13),
    Duelist(9, "Director Lucius", 1 << 14),
    Duelist(8, "AD Archie", 1 << 15),
    Duelist(23, "Kane Minion B", 1 << 16),
    Duelist(22, "Kane Minion A", 1 << 17),
    Duelist(21, "Diesel Kane", 1 << 18),
    Duelist(20, "Seto Kaiba", 1 << 19),
    Duelist(19, "Venom C", 1 << 20),
    Duelist(18, "Venom B", 1 << 21),
    Duelist(17, "Venom A", 1 << 22),
    Duelist(16, "Scorpion Shoes Owner", 1 << 23),
    Duelist(31, "Beluga", 1 << 24),
    Duelist(30, "Professor Jeremy Harrison", 1 << 25),
    Duelist(29, "Shadi", 1 << 26),
    Duelist(28, "Curator Adriel Wainwright", 1 << 27),
    Duelist(27, "Kane Minion F", 1 << 28),
    Duelist(26, "Kane Minion E", 1 << 29),
    Duelist(25, "Kane Minion D", 1 << 30),
    Duelist(24, "Kane Minion C", 1 << 31),
    Duelist(39, "Cedric", 1 << 32),
    Duelist(38, "Feng Long", 1 << 33),
    Duelist(37, "Mokuba Kaiba", 1 << 34),
    Duelist(36, "Egger Baldwin", 1 << 35),
    Duelist(35, "Thug C", 1 << 36),
    Duelist(34, "Thug B", 1 << 37),
    Duelist(33, "Thug A", 1 << 38),
    Duelist(32, "The Greendale Zompire", 1 << 39),
    Duelist(47, "Stringer", 1 << 40),
    Duelist(46, "Game Show Producer", 1 << 41),
    Duelist(45, "Anton Periwig", 1 << 42),
    Duelist(44, "Chopman", 1 << 43),
    Duelist(43, "Kaibas' Butler", 1 << 44),
    Duelist(42, "Snipes Crosshair", 1 << 45),
    Duelist(41, "Bickford Gage", 1 << 46),
    Duelist(40, "Charlie Gale", 1 << 47),
    Duelist(55, "Rex Raptor", 1 << 48),
    Duelist(54, "Weevil Underwood", 1 << 49),
    Duelist(53, "Yami Bakura", 1 << 50),
    Duelist(52, "Mr. Titus", 1 << 51),
    Duelist(51, "Bakura", 1 << 52),
    Duelist(50, "Nibbles", 1 << 53),
    Duelist(49, "Damien Draco", 1 << 54),
    Duelist(48, "Tick-Tock", 1 << 55),
    Duelist(63, "Para", 1 << 56),
    Duelist(62, "Panik", 1 << 57),
    Duelist(61, "The Puppeteer", 1 << 58),
    Duelist(60, "Mako Tsunami", 1 << 59),
    Duelist(59, "Mai Valentine", 1 << 60),
    Duelist(58, "Melody", 1 << 61),
    Duelist(57, "Serenity Wheeler", 1 << 62),
    Duelist(56, "Maximillion Pegasus", 1 << 63),
    Duelist(71, "Espa Roba", 1 << 64),
    Duelist(70, "Bonz", 1 << 65),
    Duelist(69, "Sindin the Clown", 1 << 66),
    Duelist(68, "Duke Devlin", 1 << 67),
    Duelist(67, "Bandit Keith", 1 << 68),
    Duelist(66, "Kemo", 1 << 69),
    Duelist(65, "Croquet", 1 << 70),
    Duelist(64, "Dox", 1 << 71),
    Duelist(79, "The Merchant", 1 << 72),
    Duelist(78, "Strings", 1 << 73),
    Duelist(77, "Arkana", 1 << 74),
    Duelist(76, "Marik Ishtar", 1 << 75),
    Duelist(75, "Yugi's Mother", 1 << 76),
    Duelist(74, "Johnny Steps", 1 << 77),
    Duelist(73, "Seeker", 1 << 78),
    Duelist(72, "Ishizu Ishtar", 1 << 79),
    Duelist(87, "Roger", 1 << 80),
    Duelist(86, "Lloyd", 1 << 81),
    Duelist(85, "Norman", 1 << 82),
    # 1 << 83 unused?,
    Duelist(83, "Odion", 1 << 84),
    Duelist(82, "Umbra", 1 << 85),
    Duelist(81, "Lumis", 1 << 86),
    Duelist(80, "Paradox", 1 << 87),
    # 1 << 88 unused,
    # 1 << 89 unused,
    Duelist(93, "Doris", 1 << 90),
    Duelist(92, "Jill", 1 << 91),
    Duelist(91, "Ryan", 1 << 92),
    Duelist(90, "Paul", 1 << 93),
    Duelist(89, "Diana", 1 << 94),
    Duelist(88, "Andrea", 1 << 95)
)
