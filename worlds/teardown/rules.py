...
from .options import Bonus_Level
...
def set_all_entrance_rules(world: TeardownWorld) -> None:
    ...
    #level_3_to_level_4 = world.get_entrance("Right Room to Final Boss Room")
    ...
    can_access_level_2 = Has("Level 2 Unlock")
    ...
    world.set_rule(level_1_to_level_2, can_access_level_2)

    # Conditions can also depend on event items.
    can_access_level_3 = Has("Level 3 Unlock")
    world.set_rule(level_2_to_level_3, can_access_level_3)
    ...
    #world.set_rule(level_1_to_top_left_room, lambda state: state.has("Key", world.player))
    ...
    #world.set_rule(level_1_to_top_left_room, Has("Key"))
