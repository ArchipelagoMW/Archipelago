...
class TeardownWorld(World):
    ...
    # (Note: options.py has been imported as "teardown_options" at the top of this file to avoid a name conflict)
    options_dataclass = teardown_options.TeardownOptions
    options: teardown_options.TeardownOptions  # Common mistake: This has to be a colon (:), not an equals sign (=).
