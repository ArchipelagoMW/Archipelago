...
mandatory_sve_connections = [
    ...
    ConnectionData(SVEEntrance.to_grandpa_upstairs, SVERegion.grandpas_shed_upstairs),
    ConnectionData(SVEEntrance.grandpa_shed_to_town, Region.town),
    ConnectionData(SVEEntrance.bmv_to_sophia, SVERegion.sophias_house),
    ConnectionData(SVEEntrance.boat_to_highlands, SVERegion.highlands),
    ConnectionData(SVEEntrance.guild_to_interior, SVERegion.guild_summit),
    ConnectionData(SVEEntrance.backwoods_to_grove, SVERegion.enchanted_grove),
    ConnectionData(SVEEntrance.grove_to_outpost, SVERegion.galmoran_outpost),
    ConnectionData(SVEEntrance.grove_to_wizard, Region.wizard_basement),
    ConnectionData(SVEEntrance.grove_to_aurora, SVERegion.aurora_vineyard_basement),
    ConnectionData(SVEEntrance.to_aurora_basement, SVERegion.aurora_vineyard_basement),
    ConnectionData(SVEEntrance.grove_to_farm, Region.farm),
    ConnectionData(SVEEntrance.grove_to_guild, Region.adventurer_guild),
    ConnectionData(SVEEntrance.grove_to_junimo, SVERegion.junimo_woods),
    ConnectionData(SVEEntrance.use_purple_junimo, SVERegion.purple_junimo_shop),
    ConnectionData(SVEEntrance.grove_to_spring, SVERegion.sprite_spring),
    ...
    ConnectionData(SVEEntrance.to_outpost_roof, SVERegion.outpost_roof),
    ...
    ConnectionData(SVEEntrance.forest_to_junimo, SVERegion.junimo_woods),
    ...
    ConnectionData(SVEEntrance.to_susan_house, SVERegion.susans_house),
    ConnectionData(SVEEntrance.enter_summit, SVERegion.summit),
    ConnectionData(SVEEntrance.forest_to_fairhaven, SVERegion.fairhaven_farm),
    ConnectionData(SVEEntrance.highlands_to_lance, SVERegion.lances_house),
    ConnectionData(SVEEntrance.lance_ladder_to_highlands, SVERegion.highlands),
