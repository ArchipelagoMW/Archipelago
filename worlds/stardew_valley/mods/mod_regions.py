...
stardew_valley_expanded_regions = [
    ...
    RegionData(SVERegion.grandpas_shed_interior, [SVEEntrance.to_grandpa_upstairs]),
    RegionData(SVERegion.grandpas_shed_upstairs),
    RegionData(Region.forest,
               [SVEEntrance.forest_to_fairhaven, SVEEntrance.forest_to_west, SVEEntrance.forest_to_junimo,
    ...
    RegionData(SVERegion.guild_summit, [SVEEntrance.guild_to_interior, SVEEntrance.guild_to_mines,
                                        SVEEntrance.summit_to_boat]),
    RegionData(SVERegion.marlon_boat, [SVEEntrance.boat_to_highlands]),
    RegionData(Region.railroad, [SVEEntrance.to_susan_house, SVEEntrance.enter_summit]),
    ...
    RegionData(SVERegion.first_slash_guild),
    RegionData(SVERegion.highlands, [SVEEntrance.highlands_to_lance, SVEEntrance.highlands_to_cave]),
    RegionData(SVERegion.highlands_cavern, [SVEEntrance.to_dwarf_prison]),
    RegionData(SVERegion.dwarf_prison),
    RegionData(SVERegion.lances_house, [SVEEntrance.lance_ladder_to_highlands]),
    ...
    RegionData(SVERegion.sprite_spring),
    RegionData(SVERegion.junimo_woods, [SVEEntrance.use_purple_junimo]),
    RegionData(SVERegion.purple_junimo_shop),
    RegionData(SVERegion.enchanted_grove, [SVEEntrance.grove_to_outpost, SVEEntrance.grove_to_wizard,
                                           SVEEntrance.grove_to_farm, SVEEntrance.grove_to_guild, SVEEntrance.grove_to_junimo,
                                           SVEEntrance.grove_to_spring, SVEEntrance.grove_to_aurora]),
    RegionData(SVERegion.galmoran_outpost, [SVEEntrance.outpost_to_badlands_entrance, SVEEntrance.use_alesia_shop,
                                            SVEEntrance.use_issac_shop, SVEEntrance.to_outpost_roof]),
    RegionData(SVERegion.outpost_roof),
...
mandatory_sve_connections = [
    ...
    ConnectionData(SVEEntrance.grandpa_shed_to_interior, SVERegion.grandpas_shed_interior, flag=RandomizationFlag.NON_PROGRESSION| RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(SVEEntrance.to_grandpa_upstairs, SVERegion.grandpas_shed_upstairs, flag=RandomizationFlag.BUILDINGS),
    ...
    ConnectionData(SVEEntrance.boat_to_highlands, SVERegion.highlands, flag=RandomizationFlag.BUILDINGS),
    ...
    ConnectionData(SVEEntrance.grove_to_outpost, SVERegion.galmoran_outpost, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(SVEEntrance.grove_to_wizard, Region.wizard_basement, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(SVEEntrance.grove_to_aurora, SVERegion.aurora_vineyard_basement, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(SVEEntrance.to_aurora_basement, SVERegion.aurora_vineyard_basement, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(SVEEntrance.grove_to_farm, Region.farm, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(SVEEntrance.grove_to_guild, Region.adventurer_guild, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(SVEEntrance.grove_to_junimo, SVERegion.junimo_woods, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(SVEEntrance.use_purple_junimo, SVERegion.purple_junimo_shop),
    ConnectionData(SVEEntrance.grove_to_spring, SVERegion.sprite_spring, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(SVEEntrance.wizard_to_fable_reef, SVERegion.fable_reef, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(SVEEntrance.fable_reef_to_guild, SVERegion.first_slash_guild, flag=RandomizationFlag.NON_PROGRESSION),
    ConnectionData(SVEEntrance.to_outpost_roof, SVERegion.outpost_roof, flag=RandomizationFlag.NON_PROGRESSION),
    ConnectionData(SVEEntrance.outpost_to_badlands_entrance, SVERegion.badlands_entrance, flag=RandomizationFlag.NON_PROGRESSION),
    ConnectionData(SVEEntrance.badlands_entrance_to_badlands, SVERegion.crimson_badlands, flag=RandomizationFlag.NON_PROGRESSION),
    ConnectionData(SVEEntrance.badlands_to_cave, SVERegion.badlands_cave, flag=RandomizationFlag.NON_PROGRESSION),
    ...
    ConnectionData(SVEEntrance.summit_to_boat, SVERegion.marlon_boat),
    ...
    ConnectionData(SVEEntrance.forest_to_junimo, SVERegion.junimo_woods, flag=RandomizationFlag.NON_PROGRESSION),
    ...
    ConnectionData(SVEEntrance.to_susan_house, SVERegion.susans_house, flag=RandomizationFlag.NON_PROGRESSION),
    ...
    ConnectionData(SVEEntrance.highlands_to_lance, SVERegion.lances_house, flag=RandomizationFlag.NON_PROGRESSION),
    ConnectionData(SVEEntrance.lance_ladder_to_highlands, SVERegion.highlands, flag=RandomizationFlag.NON_PROGRESSION),
    ConnectionData(SVEEntrance.highlands_to_cave, SVERegion.highlands_cavern, flag=RandomizationFlag.NON_PROGRESSION),
