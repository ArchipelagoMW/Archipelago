...
vanilla_regions: tuple[RegionData, ...] = (
    ...
    RegionData(RegionName.forest,
               (Entrance.forest_to_town, Entrance.enter_secret_woods, Entrance.forest_to_wizard_tower, Entrance.forest_to_marnie_ranch,
                ...
                LogicEntrance.has_giant_stump, LogicEntrance.fish_in_waterfall, LogicEntrance.attend_flower_dance, LogicEntrance.attend_trout_derby,
...
ginger_island_regions = (
    ...
    RegionData(RegionName.wizard_tower,
               (Entrance.enter_wizard_basement, Entrance.use_desert_obelisk, Entrance.use_island_obelisk,)),
