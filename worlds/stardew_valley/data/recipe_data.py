...
from ..strings.fish_names import Fish, SVEFish, WaterItem, DistantLandsFish, ModWaterItem
...
seaweed_salad = shop_recipe(SVEMeal.seaweed_salad, Region.fish_shop, 1250, {ModWaterItem.dulse_seaweed: 2, WaterItem.seaweed: 2, Ingredient.oil: 1}, ModNames.sve)
