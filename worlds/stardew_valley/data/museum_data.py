...
class Mineral:
    ...
    prismatic_shard = create_mineral("Prismatic Shard", Region.skull_cavern_100,
                                     geodes=unlikely,
                                     monsters=unlikely)
    alamite = create_mineral("Alamite", Region.town,
                             geodes=(Geode.geode, Geode.omni))
    bixite = create_mineral("Bixite", Region.town,
                            geodes=(Geode.magma, Geode.omni),
                            monsters=unlikely)
    baryte = create_mineral("Baryte", Region.town,
                            geodes=(Geode.magma, Geode.omni))
    aerinite = create_mineral("Aerinite", Region.town,
                              geodes=(Geode.frozen, Geode.omni))
    calcite = create_mineral("Calcite", Region.town,
                             geodes=(Geode.geode, Geode.omni))
    dolomite = create_mineral("Dolomite", Region.town,
                              geodes=(Geode.magma, Geode.omni))
    esperite = create_mineral("Esperite", Region.town,
                              geodes=(Geode.frozen, Geode.omni))
    fluorapatite = create_mineral("Fluorapatite", Region.town,
                                  geodes=(Geode.frozen, Geode.omni))
    geminite = create_mineral("Geminite", Region.town,
                              geodes=(Geode.frozen, Geode.omni))
    helvite = create_mineral("Helvite", Region.town,
                             geodes=(Geode.magma, Geode.omni))
    jamborite = create_mineral("Jamborite", Region.town,
                               geodes=(Geode.geode, Geode.omni))
    jagoite = create_mineral("Jagoite", Region.town,
                             geodes=(Geode.geode, Geode.omni))
    kyanite = create_mineral("Kyanite", Region.town,
                             geodes=(Geode.frozen, Geode.omni))
    lunarite = create_mineral("Lunarite", Region.town,
                              geodes=(Geode.frozen, Geode.omni))
    malachite = create_mineral("Malachite", Region.town,
                               geodes=(Geode.geode, Geode.omni))
    neptunite = create_mineral("Neptunite", Region.town,
                               geodes=(Geode.magma, Geode.omni))
    lemon_stone = create_mineral("Lemon Stone", Region.town,
                                 geodes=(Geode.magma, Geode.omni))
    nekoite = create_mineral("Nekoite", Region.town,
                             geodes=(Geode.geode, Geode.omni))
    orpiment = create_mineral("Orpiment", Region.town,
                              geodes=(Geode.geode, Geode.omni))
    petrified_slime = create_mineral("Petrified Slime", Region.town,
                                     geodes=(Geode.geode, Geode.omni))
    thunder_egg = create_mineral("Thunder Egg", Region.town,
                                 geodes=(Geode.geode, Geode.omni))
    pyrite = create_mineral("Pyrite", Region.town,
                            geodes=(Geode.frozen, Geode.omni))
    ocean_stone = create_mineral("Ocean Stone", Region.town,
                                 geodes=(Geode.frozen, Geode.omni))
    ghost_crystal = create_mineral("Ghost Crystal", Region.town,
                                   geodes=(Geode.frozen, Geode.omni))
    tigerseye = create_mineral("Tigerseye", Region.town,
                               geodes=(Geode.magma, Geode.omni))
    jasper = create_mineral("Jasper", Region.town,
                            geodes=(Geode.magma, Geode.omni))
    opal = create_mineral("Opal", Region.town,
                          geodes=(Geode.frozen, Geode.omni))
    fire_opal = create_mineral("Fire Opal", Region.town,
                               geodes=(Geode.magma, Geode.omni))
    celestine = create_mineral("Celestine", Region.town,
                               geodes=(Geode.geode, Geode.omni))
    marble = create_mineral("Marble", Region.town,
                            geodes=(Geode.frozen, Geode.omni))
    sandstone = create_mineral("Sandstone", Region.town,
                               geodes=(Geode.geode, Geode.omni))
    granite = create_mineral("Granite", Region.town,
                             geodes=(Geode.geode, Geode.omni))
    basalt = create_mineral("Basalt", Region.town,
                            geodes=(Geode.magma, Geode.omni))
    limestone = create_mineral("Limestone", Region.town,
                               geodes=(Geode.geode, Geode.omni))
    soapstone = create_mineral("Soapstone", Region.town,
                               geodes=(Geode.frozen, Geode.omni))
    hematite = create_mineral("Hematite", Region.town,
                              geodes=(Geode.frozen, Geode.omni))
    mudstone = create_mineral("Mudstone", Region.town,
                              geodes=(Geode.geode, Geode.omni))
    obsidian = create_mineral("Obsidian", Region.town,
                              geodes=(Geode.magma, Geode.omni))
    slate = create_mineral("Slate", Region.town,
                           geodes=(Geode.geode, Geode.omni))
    fairy_stone = create_mineral("Fairy Stone", Region.town,
                                 geodes=(Geode.frozen, Geode.omni))
    star_shards = create_mineral("Star Shards", Region.town,
                                 geodes=(Geode.magma, Geode.omni))
