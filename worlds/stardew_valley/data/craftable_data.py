...
from ..strings.fish_names import Fish, WaterItem, ArchaeologyTrash
...
rust_path = skill_recipe(ModFloor.rusty_path, ModSkill.archaeology, 2, {ArchaeologyTrash.rusty_scrap: 2}, ModNames.archaeology)
rusty_brazier = skill_recipe(ModCraftable.rusty_brazier, ModSkill.archaeology, 3, {ArchaeologyTrash.rusty_scrap: 10, Material.coal: 1, Material.fiber: 1}, ModNames.archaeology)
