...
josh = villager(NPC.alex, True, town + alex_house, "Summer", universal_loves + complete_breakfast + salmon_dinner, True)
elliott = villager(NPC.elliott, True, town + beach + elliott_house, "Fall", universal_loves + elliott_loves, True)
harvey = villager(NPC.harvey, True, town + hospital, "Winter", universal_loves + harvey_loves, True)
sam = villager(NPC.sam, True, town, "Summer", universal_loves + sam_loves, True)
sebastian = villager(NPC.sebastian, True, carpenter, "Winter", universal_loves + sebastian_loves, True)
shane = villager(NPC.shane, True, ranch, "Spring", universal_loves + shane_loves, True)
best_girl = villager(NPC.abigail, True, town, "Fall", universal_loves + abigail_loves, True)
emily = villager(NPC.emily, True, town, "Spring", universal_loves + emily_loves, True)
hoe = villager(NPC.haley, True, town, "Spring", universal_loves_no_prismatic_shard + haley_loves, True)
leah = villager(NPC.leah, True, forest, "Winter", universal_loves + leah_loves, True)
nerd = villager(NPC.maru, True, carpenter + hospital + town, "Summer", universal_loves + maru_loves, True)
penny = villager(NPC.penny, True, town, "Fall", universal_loves_no_rabbit_foot + penny_loves, True)
caroline = villager(NPC.caroline, False, town, "Winter", universal_loves + caroline_loves, True)
clint = villager(NPC.clint, False, town, "Winter", universal_loves + clint_loves, True)
demetrius = villager(NPC.demetrius, False, carpenter, "Summer", universal_loves + demetrius_loves, True)
dwarf = villager(NPC.dwarf, False, mines_dwarf_shop, "Summer", universal_loves + dwarf_loves, False)
gilf = villager(NPC.evelyn, False, town, "Winter", universal_loves + evelyn_loves, True)
boomer = villager(NPC.george, False, town, "Fall", universal_loves + george_loves, True)
gus = villager(NPC.gus, False, town, "Summer", universal_loves + gus_loves, True)
jas = villager(NPC.jas, False, ranch, "Summer", universal_loves + jas_loves, True)
jodi = villager(NPC.jodi, False, town, "Fall", universal_loves + jodi_loves, True)
kent = villager(NPC.kent, False, town, "Spring", universal_loves + kent_loves, False)
krobus = villager(NPC.krobus, False, sewers, "Winter", universal_loves + krobus_loves, False)
leo = villager(NPC.leo, False, island, "Summer", universal_loves + leo_loves, False)
lewis = villager(NPC.lewis, False, town, "Spring", universal_loves + lewis_loves, True)
linus = villager(NPC.linus, False, mountain, "Winter", universal_loves + linus_loves, True)
marnie = villager(NPC.marnie, False, ranch, "Fall", universal_loves + marnie_loves, True)
pam = villager(NPC.pam, False, town, "Spring", universal_loves + pam_loves, True)
pierre = villager(NPC.pierre, False, town, "Spring", universal_loves + pierre_loves, True)
milf = villager(NPC.robin, False, carpenter, "Fall", universal_loves + robin_loves, True)
sandy = villager(NPC.sandy, False, oasis, "Fall", universal_loves + sandy_loves, False)
vincent = villager(NPC.vincent, False, town, "Spring", universal_loves + vincent_loves, True)
willy = villager(NPC.willy, False, beach, "Summer", universal_loves + willy_loves, True)
wizard = villager(NPC.wizard, False, forest, "Winter", universal_loves + wizard_loves, True)

# Custom NPCs
alec = villager(ModNPC.alec, True, forest, "Winter", universal_loves + trilobite, True, ModNames.alec)
ayeisha = villager(ModNPC.ayeisha, False, town, "Summer", universal_loves + ayeisha_loves, True, ModNames.ayeisha)
delores = villager(ModNPC.delores, True, forest, "Winter", universal_loves + delores_loves, True, ModNames.delores)
eugene = villager(ModNPC.eugene, True, forest, "Spring", universal_loves + eugene_loves, True, ModNames.eugene)
jasper = villager(ModNPC.jasper, True, town, "Fall", universal_loves + jasper_loves, True, ModNames.jasper)
juna = villager(ModNPC.juna, False, forest, "Summer", universal_loves + juna_loves, True, ModNames.juna)
kitty = villager(ModNPC.mr_ginger, False, forest, "Summer", universal_loves + mister_ginger_loves, True, ModNames.ginger)
shiko = villager(ModNPC.shiko, True, town, "Winter", universal_loves + shiko_loves, True, ModNames.shiko)
wellwick = villager(ModNPC.wellwick, True, forest, "Winter", universal_loves + wellwick_loves, True, ModNames.shiko)
yoba = villager(ModNPC.yoba, False, secret_woods, "Spring", universal_loves + yoba_loves, False, ModNames.yoba)
