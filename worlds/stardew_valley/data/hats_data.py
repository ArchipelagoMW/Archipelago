...
class Hats:
    ...
    bridal_veil = create_hat("Bridal Veil", [HatsanityOptionName.tailoring, HatsanityOptionName.rng])
    ...
    dinosaur_hat = create_hat("Dinosaur Hat", [HatsanityOptionName.tailoring, HatsanityOptionName.rng])
    ...
    golden_mask = create_hat("Golden Mask", [HatsanityOptionName.tailoring, HatsanityOptionName.rng], need_clarifier=True)
    ...
    hair_bone = create_hat("Hair Bone", [HatsanityOptionName.tailoring, HatsanityOptionName.rng])
    ...
    pirate_hat = create_hat("Pirate Hat", [HatsanityOptionName.tailoring, HatsanityOptionName.rng])
    ...
    wearable_dwarf_helm = create_hat("Wearable Dwarf Helm", [HatsanityOptionName.tailoring, HatsanityOptionName.rng])
