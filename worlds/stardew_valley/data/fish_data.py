...
lionfish = create_fish("Lionfish", 837, ginder_island_ocean, season.all_seasons, 50)
...
pufferfish = create_fish("Pufferfish", 128, ocean + ginder_island_ocean, season.summer, 80)
...
super_cucumber = create_fish("Super Cucumber", 155, ocean + ginder_island_ocean, (season.summer, season.fall), 80)
tiger_trout = create_fish("Tiger Trout", 699, town_river + forest_river, (season.fall, season.winter), 60)
tilapia = create_fish("Tilapia", 701, ocean + ginder_island_ocean, (season.summer, season.fall), 50)
tuna = create_fish("Tuna", 130, ocean + ginder_island_ocean, (season.summer, season.winter), 70)
