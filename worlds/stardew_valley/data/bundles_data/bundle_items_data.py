...
dragon_tooth = BundleItem(Forageable.dragon_tooth, source=BundleItem.Sources.island)
...
pineapple_wine = BundleItem(ArtisanGood.specific_wine(Fruit.pineapple), source=BundleItem.Sources.island)
dried_pineapple = BundleItem(ArtisanGood.specific_dried_fruit(Fruit.pineapple), source=BundleItem.Sources.island)
...
banana_sapling = BundleItem(Sapling.banana, source=BundleItem.Sources.island)
cherry_sapling = BundleItem(Sapling.cherry)
mango_sapling = BundleItem(Sapling.mango, source=BundleItem.Sources.island)
