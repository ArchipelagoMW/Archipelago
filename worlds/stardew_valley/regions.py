...
vanilla_regions = [
    ...
    RegionData(Region.forest,
               [Entrance.forest_to_town, Entrance.enter_secret_woods, Entrance.forest_to_wizard_tower,
                ...
                Entrance.buy_from_traveling_merchant, Entrance.complete_raccoon_requests,
                Entrance.attend_flower_dance, Entrance.attend_trout_derby, Entrance.attend_festival_of_ice]),
    ...
    RegionData(Region.raccoon_daddy, [Entrance.buy_from_raccoon]),
    RegionData(Region.raccoon_shop),
    ...
    RegionData(Region.bookseller_1, [Entrance.buy_year1_books]),
    RegionData(Region.bookseller_2, [Entrance.buy_year3_books]),
    RegionData(Region.bookseller_3),
    ...
    RegionData(Region.desert, [Entrance.enter_skull_cavern_entrance, Entrance.enter_oasis, Entrance.attend_desert_festival]),
    ...
    RegionData(Region.desert_festival),
    RegionData(Region.flower_dance),
    RegionData(Region.luau),
    RegionData(Region.trout_derby),
...
vanilla_connections = [
    ...
    ConnectionData(Entrance.complete_raccoon_requests, Region.raccoon_daddy),
    ConnectionData(Entrance.buy_from_raccoon, Region.raccoon_shop),
    ...
    ConnectionData(Entrance.attend_desert_festival, Region.desert_festival),
    ConnectionData(Entrance.attend_flower_dance, Region.flower_dance),
    ConnectionData(Entrance.attend_luau, Region.luau),
    ConnectionData(Entrance.attend_trout_derby, Region.trout_derby),
