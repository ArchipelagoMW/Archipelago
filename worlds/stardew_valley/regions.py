...
vanilla_regions = [
    ...
    RegionData(Region.farm,
               [Entrance.farm_to_backwoods, Entrance.farm_to_bus_stop, Entrance.farm_to_forest,
                ...
                Entrance.use_desert_obelisk, Entrance.use_island_obelisk, Entrance.farming]),
    ...
    RegionData(Region.beach,
               [Entrance.beach_to_willy_fish_shop, Entrance.enter_elliott_house, Entrance.enter_tide_pools, Entrance.fishing]),
