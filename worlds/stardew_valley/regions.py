...
vanilla_regions = [
    ...
    RegionData(Region.forest,
               [Entrance.forest_to_town, Entrance.enter_secret_woods, Entrance.forest_to_wizard_tower,
                ...
                Entrance.forest_to_leah_cottage, Entrance.forest_to_sewers,
    ...
    RegionData(Region.tunnel_entrance, [Entrance.enter_tunnel]),
    ...
    RegionData(Region.town,
               [Entrance.town_to_community_center, Entrance.town_to_beach, Entrance.town_to_hospital,
                ...
                Entrance.town_to_sam_house, Entrance.town_to_haley_house, Entrance.town_to_sewers,
    ...
    RegionData(Region.sewers, [Entrance.enter_mutant_bug_lair]),
    ...
    RegionData(Region.skull_cavern_25, [Entrance.mine_to_skull_cavern_floor_100]),
    ...
    RegionData(Region.dig_site,
               [Entrance.parrot_express_dig_site_to_volcano, Entrance.parrot_express_dig_site_to_docks,
...
vanilla_connections = [
    ...
    ConnectionData(Entrance.enter_tunnel, Region.tunnel),
