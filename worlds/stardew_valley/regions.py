...
stardew_valley_regions = [
    ...
    RegionData(SVRegion.fish_shop, [SVEntrance.fish_shop_to_backroom]),
    RegionData(SVRegion.fish_shop_backroom, [SVEntrance.boat_to_ginger_island]),
    ...
    RegionData(SVRegion.desert, [SVEntrance.enter_skull_cavern_entrance]),
    RegionData(SVRegion.skull_cavern_entrance, [SVEntrance.enter_skull_cavern]),
    RegionData(SVRegion.skull_cavern, [SVEntrance.mine_to_skull_cavern_floor_25, SVEntrance.mine_to_skull_cavern_floor_100]),
    ...
    RegionData(SVRegion.island_west, [SVEntrance.island_west_to_gourmand_cave, SVEntrance.island_west_to_crystals_cave,
                                      SVEntrance.island_west_to_shipwreck, SVEntrance.island_west_to_qi_walnut_room]),
    ...
    RegionData(SVRegion.island_north, [SVEntrance.island_north_to_field_office, SVEntrance.island_north_to_dig_site,
                                      SVEntrance.island_north_to_volcano]),
...
mandatory_connections = [
    ...
    ConnectionData(SVEntrance.mine_to_skull_cavern_floor_100, SVRegion.perfect_skull_cavern),
