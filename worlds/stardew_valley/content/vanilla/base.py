...
base_game = BaseGameContentPack(
    ...
    hat_sources={
        ...
        Hats.beanie.name: (Tag(ItemTag.HAT), TailoringSource(tailoring_items=(TreeSeed.acorn, TreeSeed.mahogany, TreeSeed.maple, TreeSeed.pine,)),),
        Hats.blobfish_mask.name: (Tag(ItemTag.HAT), TailoringSource(tailoring_items=(Fish.blobfish,)),),
        Hats.bridal_veil.name: (Tag(ItemTag.HAT), TailoringSource(tailoring_items=(Gift.pearl,)),),
        Hats.dinosaur_hat.name: (Tag(ItemTag.HAT), TailoringSource(tailoring_items=(AnimalProduct.dinosaur_egg,)),),
        Hats.fashion_hat.name: (Tag(ItemTag.HAT), TailoringSource(tailoring_items=(ArtisanGood.caviar,)),),
        Hats.flat_topped_hat.name: (Tag(ItemTag.HAT), TailoringSource(tailoring_items=(Meal.cranberry_sauce, Meal.stuffing,)),),
        Hats.floppy_beanie.name: (Tag(ItemTag.HAT), TailoringSource(tailoring_items=(ArtisanGood.maple_syrup, ArtisanGood.oak_resin, ArtisanGood.pine_tar,)),),
        Hats.goggles.name: (Tag(ItemTag.HAT), TailoringSource(tailoring_items=(Edible.bug_steak,)),),
        Hats.hair_bone.name: (Tag(ItemTag.HAT), TailoringSource(tailoring_items=(Fossil.prehistoric_tibia,)),),
        Hats.party_hat_blue.name: (Tag(ItemTag.HAT), TailoringSource(tailoring_items=(Meal.chocolate_cake, Consumable.fireworks_purple,)),),
        Hats.party_hat_green.name: (Tag(ItemTag.HAT), TailoringSource(tailoring_items=(Consumable.fireworks_green, Meal.fish_taco,)),),
        Hats.party_hat_red.name: (Tag(ItemTag.HAT), TailoringSource(tailoring_items=(Consumable.fireworks_red, Meal.pizza,)),),
        Hats.pirate_hat.name: (Tag(ItemTag.HAT), TailoringSource(tailoring_items=(WaterChest.treasure,)),),
        Hats.propeller_hat.name: (Tag(ItemTag.HAT), TailoringSource(tailoring_items=(Meal.miners_treat,)),),
        Hats.pumpkin_mask.name: (Tag(ItemTag.HAT), TailoringSource(tailoring_items=(Lighting.jack_o_lantern,)),),
        Hats.star_helmet.name: (Tag(ItemTag.HAT), TailoringSource(tailoring_items=(TreeSeed.mushroom,)),),
