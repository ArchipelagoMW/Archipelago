...
from ...strings.forageable_names import all_edible_mushrooms, Mushroom
...
class BaseGameContentPack(ContentPack):
    ...
    def harvest_source_hook(self, content: StardewContent):
        ...
        # FIXME add fruit tag to forageables
        for fruit in all_fruits:
            if fruit == Fruit.banana or fruit == Fruit.pineapple or fruit == Fruit.mango:
                continue

            content.tag_item(fruit, ItemTag.FRUIT)

        # FIXME add Fiddlehead fern to vegetables
