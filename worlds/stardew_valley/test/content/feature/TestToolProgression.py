...
class TestToolDistribution(unittest.TestCase):
    ...
    def test_given_vanilla_tool_progression_when_create_tool_progression_feature_then_only_one_scythe_is_randomized(self):
    ...
    def test_given_progressive_tool_when_create_tool_progression_feature_then_all_tool_upgrades_are_randomized(self):
        tool_progression = ToolProgression(ToolProgression.option_progressive)
        skill_progression = SkillProgression(SkillProgression.option_vanilla)
    ...
    def test_given_progressive_tool_and_skill_masteries_randomized_when_create_tool_progression_feature_then_additional_scythe_and_fishing_rod_are_randomized(
            self):
        tool_progression = ToolProgression(ToolProgression.option_progressive)
