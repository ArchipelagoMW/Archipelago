...
class TestArcadeMachinesLogic(SVTestBase):
    ...
    def test_prairie_king(self):
        ...
        self.assertFalse(self.get_can_reach_location_rule("Journey of the Prairie King Victory")(self.multiworld.state))
        ...
        self.assertTrue(self.world.logic.region.can_reach("JotPK World 2")(self.multiworld.state))
        self.assertTrue(self.world.logic.region.can_reach("JotPK World 3")(self.multiworld.state))
        self.assertTrue(self.get_can_reach_location_rule("Journey of the Prairie King Victory")(self.multiworld.state))
        self.remove(boots)
        self.remove(boots)
        self.remove(gun)
        self.remove(gun)
