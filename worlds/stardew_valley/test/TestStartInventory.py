...
class TestStartInventoryAllsanity(WorldAssertMixin, SVTestCase):
    ...
    def test_start_inventory_movement_speed(self):
        ...
        multiworld = setup_solo_multiworld(option_dict)
        self.assert_basic_checks_with_subtests(multiworld)
