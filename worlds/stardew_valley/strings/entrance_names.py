...
class SVEEntrance:
    ...
    grove_to_guild_warp = "Enchanted Grove to Grove Adventurer's Guild Warp"
    guild_warp_to_guild = "Grove Adventurer's Guild Warp to Adventurer's Guild Summit"
    ...
    summit_to_highlands = "Adventurer's Guild Summit to Highlands"
    ...
    highlands_to_cave = "Highlands to Highlands Cavern"
