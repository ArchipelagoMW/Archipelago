...
from ..options import ExcludeGingerIsland, FestivalLocations, StardewValleyOptions, Walnutsanity
...
class StardewLogic(ReceivedLogicMixin, HasLogicMixin, RegionLogicMixin, TravelingMerchantLogicMixin, TimeLogicMixin,
                   ...
                   RequirementLogicMixin, BookLogicMixin, GrindLogicMixin, FestivalLogicMixin):
    player: int
