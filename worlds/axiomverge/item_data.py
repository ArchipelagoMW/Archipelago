...
raw_item_data: t.Tuple[AVItemData] = (
    AVItemData(0, "Axiom Disruptor", AVItemType.WEAPON, ItemClassification.progression, True),
    AVItemData(1, "Data Bomb", AVItemType.WEAPON, ItemClassification.progression, True),
    AVItemData(2, "Firewall", AVItemType.WEAPON, ItemClassification.progression, True),
    AVItemData(3, "Inertial Pulse", AVItemType.WEAPON, ItemClassification.progression, True),
    AVItemData(4, "Ion Beam", AVItemType.WEAPON, ItemClassification.progression, True),
    AVItemData(5, "Lightning Gun", AVItemType.WEAPON, ItemClassification.progression, True),
    AVItemData(6, "Multi-Disruptor", AVItemType.WEAPON, ItemClassification.progression, True),
    AVItemData(7, "Reflector", AVItemType.WEAPON, ItemClassification.progression, True),
    AVItemData(8, "Shards", AVItemType.WEAPON, ItemClassification.progression, True),
    AVItemData(9, "Quantum Variegator", AVItemType.WEAPON, ItemClassification.progression, True),
    AVItemData(10, "Turbine Pulse", AVItemType.WEAPON, ItemClassification.progression, True),
    AVItemData(11, "Voranj", AVItemType.WEAPON, ItemClassification.progression, True),
    AVItemData(12, "Nova", AVItemType.WEAPON, ItemClassification.progression, True),
    AVItemData(13, "Tethered Charge", AVItemType.WEAPON, ItemClassification.progression, True),
    AVItemData(14, "Hypo-Atomizer", AVItemType.WEAPON, ItemClassification.progression, True),
    AVItemData(15, "Orbital Discharge", AVItemType.WEAPON, ItemClassification.progression, True),
    AVItemData(16, "Distortion Field", AVItemType.WEAPON, ItemClassification.progression, True),
    AVItemData(17, "FlameThrower", AVItemType.WEAPON, ItemClassification.progression, True),
    ...
    AVItemData(20, "Fat Beam", AVItemType.WEAPON, ItemClassification.progression, False),
    AVItemData(21, "Heat Seeker", AVItemType.WEAPON, ItemClassification.progression, False),
    AVItemData(22, "Scissor Beam", AVItemType.WEAPON, ItemClassification.progression, False),
    ...
    AVItemData(39, "Health Node", AVItemType.HEALTH_NODE, ItemClassification.progression, False),
    AVItemData(40, "Power Node", AVItemType.POWER_NODE, ItemClassification.progression, False),
    AVItemData(41, "Health Node Fragment", AVItemType.HEALTH_NODE_FRAGMENT, ItemClassification.filler, False),
    AVItemData(42, "Power Node Fragment", AVItemType.POWER_NODE_FRAGMENT, ItemClassification.filler, False),
