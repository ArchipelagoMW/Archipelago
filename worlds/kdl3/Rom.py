...
def patch_rom(multiworld, player, rom, heart_stars_required, boss_requirements, shuffled_levels):
    ...
    if multiworld.strict_bosses[player]:
        rom.write_bytes(0x3A000, [0xDA, 0xAE, 0xCD, 0x53, 0xEC, 0xC1, 0x5A, 0xD0, 0x19, 0xE0, 0x07, 0x00, 0xD0, 0x14,
                                  0xAE, 0xCB, 0x53, 0xCA, 0x8A, 0x0A, 0xAA, 0xAD, 0x70, 0x80, 0xDF, 0x00, 0xD0, 0x07,
                                  0xB0, 0x03, 0x18, 0x80, 0x01, 0x38, 0xFA, 0xAD, 0xCD, 0x53, 0x6B, ])
        rom.write_bytes(0x143C7, [0x22, 0x00, 0xA0, 0x07, 0xEA, 0xEA, 0xB0, ])
