...
def patch_rom(multiworld, player, rom, heart_stars_required, boss_requirements, shuffled_levels):
    ...
    rom.write_bytes(0x39A00, [0x8A, 0xC9, 0x00, 0x00, 0xF0, 0x03, 0x4A, 0x4A, 0x1A, 0xAA, 0xAD, 0x70, 0x80, 0x18, 0xCF,
                              ...
                              0xBF, 0x00, 0xD0, 0x07, 0xCD, 0x70, 0x80, 0x90, 0x02, 0x38, 0x6B, 0x18, 0x6B, ])
    ...
    if multiworld.strict_bosses[player]:
        rom.write_bytes(0x3A000, [0xDA, 0xAE, 0xCB, 0x53, 0xBF, 0x00, 0xD0, 0x07, 0xCD, 0x70, 0x80, 0x90, 0x0B, 0x8A, 0x1A,
                                  0x8D, 0xC1, 0x5A, 0x8D, 0xCB, 0x53, 0x9C, 0xCD, 0x53, 0x8A, 0x6B, ])
        rom.write_bytes(0x143E1, [0x22, 0x00, 0xA0, 0x07, 0xEA, 0xEA, 0xEA, 0xEA, 0xEA, 0xEA, 0xEA, 0xEA, 0xEA, ])
