...
animal_friends = {  # individual spawn addresses for each animal friend
    0x770010: [  # Rick
        2960854, 2973713, 3047772, 3109906, 3072123, 2971412, 3164056, 2956485, 3664418, 3057740, 3315310, 2977125,
        3397478, 2994412, 3604390, 3131799, 3132841, 3068643, 3038404, 3285176, 3072609, 3022489, 3015498, 3197815
    ],
    0x770011: [  # Kine
