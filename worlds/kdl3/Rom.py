...
def patch_rom(multiworld, player, rom, heart_stars_required, boss_requirements, shuffled_levels):
    ...
    rom.write_bytes(0x39E00, [0xA0, 0x01, 0x60, 0xA9, 0xFD, 0x9F, 0x54, 0x40, 0x40, 0xA2, 0x00, 0xD0, 0xA0, 0x00, 0x90,
                              0xA9, 0x00, 0x10, 0x54, 0x40, 0x07, 0xA2, 0xC0, 0xFF, 0xA0, 0x00, 0x81, 0xA9, 0x15, 0x00,
                              0x54, 0x40, 0x00, 0x6B, 0xEA, ])
