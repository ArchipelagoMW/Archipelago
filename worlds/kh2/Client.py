                    ...
                    if self.game_communication_path:
                        ...
                        if self.mem_json:
                            for key in self.mem_json.keys():
                                if self.kh2_read_string(int(self.mem_json[key]["GameVersionCheck"]), 4) == "KH2J":
                                    self.Now = int(self.mem_json[key]["Now"])
                                    self.Save = int(self.mem_json[key]["Save"])
                                    self.Slot1 = int(self.mem_json[key]["Slot1"])
                                    self.Journal = int(self.mem_json[key]["Journal"])
                                    self.Shop = int(self.mem_json[key]["Shop"])
