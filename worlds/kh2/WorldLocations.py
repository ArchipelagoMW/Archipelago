...
Sunset_Checks = {
    LocationName.SunsetPuzzleTT3UndergroundConcourse1: WorldLocationData(0x24CD, 4),
    LocationName.SunsetPuzzleTT3UndergroundConcourse2: WorldLocationData(0x24CC, 5),
    LocationName.SunsetPuzzleTT3Tunnelway:             WorldLocationData(0x24CB, 6),
    LocationName.SunsetPuzzleTT3TSunsetTerrace1:       WorldLocationData(0x24C8, 6),
    LocationName.SunsetPuzzleTT3TSunsetTerrace2:       WorldLocationData(0x24C8, 7),
    LocationName.SunsetPuzzleTT3TSunsetHill1:          WorldLocationData(0x24C8, 1),
    LocationName.SunsetPuzzleTT3TSunsetHill2:          WorldLocationData(0x24C9, 4),
    LocationName.SunsetPuzzleTT3OldMansion:            WorldLocationData(0x24C9, 1),
    LocationName.SunsetPuzzleTT3TheWhiteRoom:          WorldLocationData(0x24CA, 7),
    LocationName.SunsetPuzzlePostTT3Tower:             WorldLocationData(0x24C9, 6),
    LocationName.SunsetPuzzlePostTT3TowerWardrobe:     WorldLocationData(0x24CA, 5),
    LocationName.SunsetPuzzleHB1Borough:               WorldLocationData(0x24C8, 3),
    ...
    LocationName.SunsetPuzzleCoRMiningArea1:           WorldLocationData(0x24C9, 5),
    LocationName.SunsetPuzzleCoRMiningArea2:           WorldLocationData(0x24C9, 7),  # piston puzzle
    LocationName.SunsetPuzzleCoRMiningArea3:           WorldLocationData(0x24CA, 2),  # below the platform
    LocationName.SunsetPuzzleCoRMiningArea4:           WorldLocationData(0x24CB, 2),
    LocationName.SunsetPuzzleCoRMineshaftMiddle:       WorldLocationData(0x24CB, 5),
    LocationName.SunsetPuzzleCoRMineshaftUpper1:       WorldLocationData(0x24CC, 7),
    LocationName.SunsetPuzzleCoRMineshaftUpper2:       WorldLocationData(0x24CC, 3),
    LocationName.SunsetPuzzleCoRMineshaftUpper3:       WorldLocationData(0x24CB, 7),
    LocationName.SunsetPuzzleEncampmentAwayFromStand:  WorldLocationData(0x24CD, 2),
    LocationName.SunsetPuzzleEntranceHall:             WorldLocationData(0x24CC, 4),
    LocationName.SunsetPuzzlePostXaldin:               WorldLocationData(0x24CB, 3),
    ...
    LocationName.SunsetPuzzleCurlyHill:                WorldLocationData(0x24CA, 4),
    LocationName.SunsetPuzzleToyFactory:               WorldLocationData(0x24CB, 0),
    LocationName.SunsetPuzzlePrideRock:                WorldLocationData(0x24CB, 4),
    LocationName.SunsetPuzzleCanyon:                   WorldLocationData(0x24CD, 3),
    LocationName.SunsetPuzzleSolarSailor:              WorldLocationData(0x24C8, 2),
    LocationName.SunsetPuzzleMCP:                      WorldLocationData(0x24CD, 5),
    LocationName.SunsetPuzzleMemorysSkyscraper:        WorldLocationData(0x24CC, 2),
    LocationName.SunsetPuzzleCrooked:                  WorldLocationData(0x24CB, 1),
