...
Awakening_Checks = {
    ...
    LocationName.AwakeningPuzzleHB1MarketplaceArmor: WorldLocationData(0x24A0, 0),
    LocationName.AwakeningPuzzleHB1Borough:          WorldLocationData(0x24A0, 2),
    LocationName.AwakeningPuzzleHB1MerlinHouse:      WorldLocationData(0x24A0, 1),
    LocationName.AwakeningPuzzleVillageHayPile:      WorldLocationData(0x24A1, 3),
    LocationName.AwakeningPuzzleRidgeOne:            WorldLocationData(0x24A1, 2),
    LocationName.AwakeningPuzzleRidgeTwo:            WorldLocationData(0x24A0, 7),
    LocationName.AwakeningPuzzleUnderCroftOne:       WorldLocationData(0x24A1, 1),
    LocationName.AwakeningPuzzleUnderCroftTwo:       WorldLocationData(0x24A0, 3),
    LocationName.AwakeningPuzzleSecretPassageOne:    WorldLocationData(0x24A0, 6),
    LocationName.AwakeningPuzzleSecretPassageTwo:    WorldLocationData(0x24A1, 0),
    LocationName.AwakeningPuzzleBeastRoom:           WorldLocationData(0x24A0, 5),
}
Heart_Checks = {
    LocationName.HeartPuzzleHB1MarketplaceItem:  WorldLocationData(0x24A8,5),
    LocationName.HeartPuzzleEncampmentNearStand: WorldLocationData(0x24A9,3),
    LocationName.HeartPuzzleVillageHome:         WorldLocationData(0x24A9,2),
    LocationName.HeartPuzzleWestWing:            WorldLocationData(0x24A9,1),
    LocationName.HeartPuzzleCaveDeadEntrance:    WorldLocationData(0x24A8,2),
    LocationName.HeartPuzzleUnderworldEntrance:  WorldLocationData(0x24A9,0),
    LocationName.HeartPuzzleAtrium:              WorldLocationData(0x24A8,3),
    LocationName.HeartPuzzleCourtyardOne:        WorldLocationData(0x24A8,0),
    LocationName.HeartPuzzleCourtyardTwo:        WorldLocationData(0x24A8,1),
    LocationName.HeartPuzzleWaterway:            WorldLocationData(0x24A8,7),
    LocationName.HeartPuzzleRampart:             WorldLocationData(0x24A8,6),
    LocationName.HeartPuzzlePowderStore:         WorldLocationData(0x24A8,4),
}
Duality_Checks = {
    LocationName.DualityPuzzleHB1Bailey:           WorldLocationData(0x24B0,6),
    LocationName.DualityPuzzleLostRoadThree:       WorldLocationData(0x24B0,5),
    LocationName.DualityPuzzleTheLock:             WorldLocationData(0x24B1,1),
    LocationName.DualityPuzzleGummiHangar:         WorldLocationData(0x24B0,2),
    LocationName.DualityPuzzleCourtyard:           WorldLocationData(0x24B1,3),
    LocationName.DualityPuzzlePierTree:            WorldLocationData(0x24B1,0),
    LocationName.DualityPuzzleTown:                WorldLocationData(0x24B1,2),
    LocationName.DualityPuzzlePowderStore:         WorldLocationData(0x24B0,3),
    LocationName.DualityPuzzleAgrabah:             WorldLocationData(0x24B0,4),
    LocationName.DualityPuzzleHalloweenTownSquare: WorldLocationData(0x24B0,7),
    LocationName.DualityPuzzleHinterlands:         WorldLocationData(0x24B0,1),
...
Frontier_Checks = {
    ...
    LocationName.FrontierPuzzleTown:              WorldLocationData(0x24B8,6),
    LocationName.FrontierPuzzleAgrabah:           WorldLocationData(0x24B8,2),
    LocationName.FrontierPuzzleBazaar:            WorldLocationData(0x24B9,0),
    LocationName.FrontierPuzzleValleyOfStone:     WorldLocationData(0x24B9,1),
    LocationName.FrontierPuzzleSantaHouse:        WorldLocationData(0x24B8,1),
    LocationName.FrontierPuzzleTritonOne:         WorldLocationData(0x24B9,2),
...
Daylight_Checks = {
    ...
    LocationName.DaylightPuzzleThroneRoomClose:        WorldLocationData(0x24C1,0),
    LocationName.DaylightPuzzleRoomFar:                WorldLocationData(0x24C1,6),
    LocationName.DaylightPuzzleWestHall:               WorldLocationData(0x24C5,2),
    LocationName.DaylightPuzzleCaveDeadPassage:        WorldLocationData(0x24C3,0),
    LocationName.DaylightPuzzleUnderworldEntrance:     WorldLocationData(0x24C4,1),
    LocationName.DaylightPuzzleLostRoadOne:            WorldLocationData(0x24C4,7),
    LocationName.DaylightPuzzleLostRoadTwo:            WorldLocationData(0x24C5,5),
    LocationName.DaylightPuzzleCollannade:             WorldLocationData(0x24C1,7),
    ...
    LocationName.DaylightPuzzleSeaDriftKeep:           WorldLocationData(0x24C4,0),
    ...
    LocationName.DaylightPuzzleChasmOfChallengesOne:   WorldLocationData(0x24C1,1),
    LocationName.DaylightPuzzleChasmOfChallengesTwo:   WorldLocationData(0x24C1,2),
    ...
    LocationName.DaylightPuzzleElephantTwo:            WorldLocationData(0x24C5,1),
    LocationName.DaylightPuzzleWildebeestOne:          WorldLocationData(0x24C0,1),
    LocationName.DaylightPuzzleWildebeestTwo:          WorldLocationData(0x24C5,7),
    LocationName.DaylightPuzzleWastelandsOne:          WorldLocationData(0x24C0,0),
    LocationName.DaylightPuzzleWastelandsTwo:          WorldLocationData(0x24C0,2),
    LocationName.DaylightPuzzleJungle:                 WorldLocationData(0x24C5,6),
    LocationName.DaylightPuzzleOasis:                  WorldLocationData(0x24C0,3),
    LocationName.DaylightPuzzleKingsDen:               WorldLocationData(0x24C2,1),
    LocationName.DaylightPuzzleCanyon:                 WorldLocationData(0x24C4,5),
    LocationName.DaylightPuzzleNaughts:                WorldLocationData(0x24C2,0),
    LocationName.DaylightPuzzlePooh:                   WorldLocationData(0x24C0,6),
    LocationName.DaylightPuzzlePiglet:                 WorldLocationData(0x24C3,1),
    LocationName.DaylightPuzzleRabbit:                 WorldLocationData(0x24C2,2),
    LocationName.DaylightPuzzleKanga:                  WorldLocationData(0x24C1,4),
    LocationName.DaylightPuzzleSpookyCave:             WorldLocationData(0x24C2,3),
    LocationName.DaylightPuzzleStarryHill:             WorldLocationData(0x24C1,5),
}
Sunset_Checks = {
    LocationName.SunsetPuzzleTT3UndergroundConcourse1: WorldLocationData(,),
    LocationName.SunsetPuzzleTT3UndergroundConcourse2: WorldLocationData(,),
    LocationName.SunsetPuzzleTT3Tunnelway:             WorldLocationData(,),
    LocationName.SunsetPuzzleTT3TSunsetTerrace1:       WorldLocationData(,),
    LocationName.SunsetPuzzleTT3TSunsetTerrace2:       WorldLocationData(,),
    LocationName.SunsetPuzzleTT3TSunsetHill1:          WorldLocationData(,),
    LocationName.SunsetPuzzleTT3TSunsetHill2:          WorldLocationData(,),
    LocationName.SunsetPuzzleTT3OldMansion:            WorldLocationData(,),
    LocationName.SunsetPuzzleTT3TheWhiteRoom:          WorldLocationData(,),
    LocationName.SunsetPuzzlePostTT3Tower:             WorldLocationData(,),
    LocationName.SunsetPuzzlePostTT3TowerWardrobe:     WorldLocationData(,),
    LocationName.SunsetPuzzleHB1Borough:               WorldLocationData(,),
    LocationName.SunsetPuzzleHB2Corridors:             WorldLocationData(,),
    LocationName.SunsetPuzzleHB2BaileyDancers:         WorldLocationData(,),
    LocationName.SunsetPuzzlePostHB2Ansems:            WorldLocationData(,),
    LocationName.SunsetPuzzlePostHB2Heartless:         WorldLocationData(,),
    LocationName.SunsetPuzzleCoRDepths1:               WorldLocationData(,),
    LocationName.SunsetPuzzleCoRDepths2:               WorldLocationData(,),
    LocationName.SunsetPuzzleCoRMineshaftLower:        WorldLocationData(,),
    LocationName.SunsetPuzzleCoRMiningArea1:           WorldLocationData(,),
    LocationName.SunsetPuzzleCoRMiningArea2:           WorldLocationData(,),
    LocationName.SunsetPuzzleCoRMiningArea3:           WorldLocationData(,),
    LocationName.SunsetPuzzleCoRMiningArea4:           WorldLocationData(,),
    LocationName.SunsetPuzzleCoRMineshaftMiddle:       WorldLocationData(,),
    LocationName.SunsetPuzzleCoRMineshaftUpper1:       WorldLocationData(,),
    LocationName.SunsetPuzzleCoRMineshaftUpper2:       WorldLocationData(,),
    LocationName.SunsetPuzzleCoRMineshaftUpper3:       WorldLocationData(,),
    LocationName.SunsetPuzzleEncampmentAwayFromStand:  WorldLocationData(,),
    LocationName.SunsetPuzzleEntranceHall:             WorldLocationData(,),
    LocationName.SunsetPuzzlePostXaldin:               WorldLocationData(,),
    LocationName.SunsetPuzzleHarbor:                   WorldLocationData(,),
    LocationName.SunsetPuzzleInterceptor:              WorldLocationData(,),
    LocationName.SunsetPuzzleSeaDriftRowOne:           WorldLocationData(,),
    LocationName.SunsetPuzzleSeaDriftKeep:             WorldLocationData(,),
    LocationName.SunsetPuzzleBazaar:                   WorldLocationData(,),
    LocationName.SunsetPuzzleSandSwept:                WorldLocationData(,),
    LocationName.SunsetPuzzleCurlyHill:                WorldLocationData(,),
    LocationName.SunsetPuzzleToyFactory:               WorldLocationData(,),
    LocationName.SunsetPuzzlePrideRock:                WorldLocationData(,),
    LocationName.SunsetPuzzleCanyon:                   WorldLocationData(,),
    LocationName.SunsetPuzzleSolarSailor:              WorldLocationData(,),
    LocationName.SunsetPuzzleMCP:                      WorldLocationData(,),
    LocationName.SunsetPuzzleMemorysSkyscraper:        WorldLocationData(,),
    LocationName.SunsetPuzzleCrooked:                  WorldLocationData(,),
    LocationName.SunsetPuzzleTwilightView:             WorldLocationData(,),
    LocationName.SunsetPuzzleProofExistence:           WorldLocationData(,),
    LocationName.SunsetPuzzleRuinPassageOne:           WorldLocationData(,),
    LocationName.SunsetPuzzleRuinPassageTwo:           WorldLocationData(,)
}
all_world_locations = {
    **TWTNW_Checks,
    **TT_Checks,
