...
AwakeningPuzzleTT1Tower = "Awakening Puzzle Piece: (TT1) Tower"
FrontierPuzzleTT2TramCommon = "Frontier Puzzle Piece: (TT2) Tram Common - On Top of House"
DaylightPuzzleTT2TramCommon = "Daylight Puzzle Piece: (TT2) Tram Common - On Synth Shop"
DaylightPuzzleTT2MarketStreet = "Daylight Puzzle Piece: (TT2) Market Street - Station Heights"  # need vertical+glide
FrontierPuzzleTT2StationPlaza = "Frontier Puzzle Piece: (TT2) Station Plaza"
SunsetPuzzleTT3UndergroundConcourse1 = "Sunset Puzzle Piece 1: (TT3) Underground Concourse"
SunsetPuzzleTT3UndergroundConcourse2 = "Sunset Puzzle Piece 2: (TT3) Underground Concourse"
SunsetPuzzleTT3Tunnelway = "Sunset Puzzle Piece: (TT3) Tunnelway"
SunsetPuzzleTT3TSunsetTerrace1 = "Sunset Puzzle Piece 1: (TT3) Sunset Terrace"  # vertical glide for waterfall piece
SunsetPuzzleTT3TSunsetTerrace2 = "Sunset Puzzle Piece 2: (TT3) Sunset Terrace"
SunsetPuzzleTT3TSunsetHill1 = "Sunset Puzzle Piece 1: (TT3) Sunset Hill"
SunsetPuzzleTT3TSunsetHill2 = "Sunset Puzzle Piece 2: (TT3) Sunset Hill"
SunsetPuzzleTT3OldMansion = "Sunset Puzzle Piece: (TT3) The Old Mansion"  # need vertical glide
DaylightPuzzleTT3MansionFoyer1 = "Daylight Puzzle Piece 1: (TT3) Mansion Foyer"
DaylightPuzzleTT3MansionFoyer2 = "Daylight Puzzle Piece 2: (TT3) Mansion Foyer"  # need glide 2 or 3 or smthing
SunsetPuzzleTT3TheWhiteRoom = "Sunset Puzzle Piece: (TT3) The White Room"
DaylightPuzzleTT3PodRoom = "Daylight Puzzle Piece: (TT3) Pod Room"
DaylightPuzzleTT3SttComputerRoom = "Daylight Puzzle Piece: (TT3) STT Computer Room"
SunsetPuzzlePostTT3Tower = "Sunset Puzzle Piece: (Post TT3) The Tower"
SunsetPuzzlePostTT3TowerWardrobe = "Sunset Puzzle Piece: (Post TT3) The Tower: Wardrobe"

AwakeningPuzzleHB1MarketplaceArmor = "Awakening Puzzle Piece: (HB1) Marketplace - Armor Shop"
HeartPuzzleHB1MarketplaceItem = "Heart Puzzle Piece: (HB1) Marketplace - Item Shop"
AwakeningPuzzleHB1Borough = "Awakening Puzzle Piece: (HB1) Borough - Top of the Wall"
SunsetPuzzleHB1Borough = "Sunset Puzzle Piece: (HB1) Borough - Top of the House"
AwakeningPuzzleHB1MerlinHouse = "Awakening Puzzle Piece: (HB1) Merlin's House"
DualityPuzzleHB1Bailey = "Duality Puzzle Piece: (HB1) Bailey"
DaylightPuzzleHB2PosternAerith = "Daylight Puzzle Piece: (HB2) Postern - Near Stairs"
FrontierPuzzleHB2PosternDoorway = "Frontier Puzzle Piece: (HB2) Postern - Above Doorway"  # vertical or glide
SunsetPuzzleHB2Corridors = "Sunset Puzzle Piece: (HB2) Corridors"  # vertical+glide
SunsetPuzzleHB2BaileyDancers = "Sunset Puzzle Piece: (HB2) Bailey - Post Dancers"
SunsetPuzzlePostHB2Ansems = "Sunset Puzzle Piece: (Post HB2) Ansem's Study"
DaylightPuzzlePostHB2Heartless = "Daylight Puzzle Piece: (Post HB2) Heartless Manufactory"

SunsetPuzzleCoRDepths1 = "Sunset Puzzle Piece 1: (CoR) Depths"
SunsetPuzzleCoRDepths2 = "Sunset Puzzle Piece 2: (CoR) Depths"
SunsetPuzzleCoRMineshaftLower = "Sunset Puzzle Piece: (CoR) Mineshaft Lower"
SunsetPuzzleCoRMiningArea1 = "Sunset Puzzle Piece 1: (CoR) Mining Area"
SunsetPuzzleCoRMiningArea2 = "Sunset Puzzle Piece 2: (CoR) Mining Area"
SunsetPuzzleCoRMiningArea3 = "Sunset Puzzle Piece 3: (CoR) Mining Area"
SunsetPuzzleCoRMiningArea4 = "Sunset Puzzle Piece 4: (CoR) Mining Area"
SunsetPuzzleCoRMineshaftMiddle = "Sunset Puzzle Piece 1: (CoR) Mineshaft Middle"
SunsetPuzzleCoRMineshaftUpper1 = "Sunset Puzzle Piece 1: (CoR) Mineshaft Upper"
SunsetPuzzleCoRMineshaftUpper2 = "Sunset Puzzle Piece 2: (CoR) Mineshaft Upper"
SunsetPuzzleCoRMineshaftUpper3 = "Sunset Puzzle Piece 3: (CoR) Mineshaft Upper"

HeartPuzzleEncampmentNearStand = "Heart Puzzle Piece: (LoD1) Encampment Near Stand"
SunsetPuzzleEncampmentAwayFromStand = "Sunset Puzzle Piece: (LoD1) Encampment Away From Stand"
FrontierPuzzleMountainTrail = "Frontier Puzzle Piece: (LoD1) Mountain Trail"
AwakeningPuzzleVillageHayPile = "Awakening Puzzle Piece: (LoD1) Village Hay Pile"
HeartPuzzleVillageHome = "Heart Puzzle Piece: (LoD1) Village Home"  # vertical
DaylightPuzzleVillageBell = "Daylight Puzzle Piece: (LoD1) Village Top of the Bell"  # vertical+glide, around level 2+magic if town is burnt (yes)
AwakeningPuzzleRidgeOne = "Awakening Puzzle Piece 1: (LoD1) Ridge"
AwakeningPuzzleRidgeTwo = "Awakening Puzzle Piece 2: (LoD1) Ridge"

DaylightPuzzleThroneRoomClose = "Daylight Puzzle Piece: (LoD2) Throne Room Close"  # v+g around level 2
DaylightPuzzleRoomFar = "Daylight Puzzle Piece: (LoD2) Throne Room Far"  # v+g around lvl 3

SunsetPuzzleEntranceHall = "Sunset Puzzle Piece: (BC1) Entrance Hall"  # v+g around 2
DaylightPuzzleWestHall = "Daylight Puzzle Piece: (BC1) West Hall"  # v+g around level 1
AwakeningPuzzleUnderCroftOne = "Awakening Puzzle Piece 1: (BC1) Under Croft"
AwakeningPuzzleUnderCroftTwo = "Awakening Puzzle Piece 2: (BC1) Under Croft"
AwakeningPuzzleSecretPassageOne = "Awakening Puzzle Piece 1: (BC1) Secret Passage"
...
HeartPuzzleCourtyardTwo = "Heart Puzzle Piece: (DC) Courtyard - Castle Hedge"  # high jump 1 or somthing idk
DualityPuzzleCourtyard = "Duality Puzzle Piece: (DC) Courtyard - Behind Trombone Hedge"
DaylightPuzzleCollannade = "Daylight Puzzle Piece: (DC) Collannade"  # v or g
DualityPuzzlePierTree = "Duality Puzzle Piece: (TR) Pier - Tree"  # vertical or glide
FrontierPuzzlePierBoat = "Frontier Puzzle Piece: (TR) Pier - Boat Tickets"
HeartPuzzleWaterway = "Heart Puzzle Piece: (TR) Waterway"

HeartPuzzleRampart = "Heart Puzzle Piece: (PR1) Rampart"
SunsetPuzzleHarbor = "Sunset Puzzle Piece: (PR1) Harbor"  # v+g 2
DualityPuzzleTown = "Duality Puzzle Piece: (PR1) Town - Next to Explosives"
FrontierPuzzleTown = "Frontier Puzzle Piece: (PR1) Town - Above Explosives"
HeartPuzzlePowderStore = "Heart Puzzle Piece: (PR1) Powder Store - Middle/Right Explosives"
DualityPuzzlePowderStore = "Duality Puzzle Piece: (PR1) Powder Store - Middle/Right Explosives"
DaylightPuzzleBlackPearlBack = "Daylight Puzzle Piece: (PR1) Black Pearl - Back of Ship"
DaylightPuzzleBlackPearlFlags = "Daylight Puzzle Piece: (PR1) Black Pearl - Flag"  # v+g 2
...
DaylightPuzzleSeaDriftKeepAnchor = "Daylight Puzzle Piece: (PR2) Sea Drift Keep - Anchor"
...
FrontierPuzzleBazaar = "Frontier Puzzle Piece: (AG1) Bazaar - Inside Stand"  # magic
SunsetPuzzleBazaar = "Sunset Puzzle Piece: (AG1) Bazaar - Above Gate"  # v+g 2
DaylightPuzzleCaveOfWonders = "Daylight Puzzle Piece: (AG1) Cave of Wonders"
FrontierPuzzleValleyOfStone = "Frontier Puzzle Piece: (AG1) Valley Of Stone"
DaylightPuzzleTreasureRooms = "Daylight Puzzle Piece: (AG1) Treasure Room - Not Gold Pile"
SunsetPuzzleTreasureRooms = "Sunset Puzzle Piece: (AG1) Treasure Room - On top of Gold Pile"
DaylightPuzzleChasmOfChallengesOne = "Daylight Puzzle Piece 1: (AG1) Chasm Of Challenges"
DaylightPuzzleChasmOfChallengesTwo = "Daylight Puzzle Piece 2: (AG1) Chasm Of Challenges"
DaylightPuzzleChasmOfChallengesThree = "Daylight Puzzle Piece 3: (AG1) Chasm Of Challenges"
SunsetPuzzleSandSwept = "Sunset Puzzle Piece: (AG2) Sandswept Ruins - 1st Arch"  # don't need magic for these
DaylightPuzzleSandSweptOne = "Daylight Puzzle Piece 1: (AG2) Sandswept Ruins"
DaylightPuzzleSandSweptTwo = "Daylight Puzzle Piece 2: (AG2) Sandswept Ruins"

DualityPuzzleHalloweenTownSquare = "Duality Puzzle Piece: (HT1) Halloween Town Square"
DualityPuzzleHinterlands = "Duality Puzzle Piece: (HT1) Hinterlands"
DaylightPuzzleYuletide = "Daylight Puzzle Piece: (HT1) Yuletide Hill"
DaylightPuzzleSantaHouse = "Daylight Puzzle Piece: (HT1) Santa House"
FrontierPuzzleSantaHouse = "Frontier Puzzle Piece: (HT1) Santa House"
SunsetPuzzleCurlyHill = "Sunset Puzzle Piece: (HT1) Curly Hill (Prison Keeper Arena)"  # post pk, v+g 3
DaylightPuzzleToyFactory = "Daylight Puzzle Piece: (HT2) Toy Factory"
SunsetPuzzleToyFactory = "Sunset Puzzle Piece: (HT2) Toy Factory - Standalone Pillar"  # v+g

DaylightPuzzleElephantOne = "Daylight Puzzle Piece 1: (PL1) Elephant Graveyard"
DaylightPuzzleElephantTwo = "Daylight Puzzle Piece 2: (PL1) Elephant Graveyard"
SunsetPuzzlePrideRock = "Sunset Puzzle Piece: (PL1) Pride Rock"
DaylightPuzzleWildebeestOne = "Daylight Puzzle Piece 1: (PL1) Wildebeest Valley"
DaylightPuzzleWildebeestTwo = "Daylight Puzzle Piece 2: (PL1) Wildebeest Valley"
DaylightPuzzleWastelandsOne = "Daylight Puzzle Piece 1: (PL1) Wastelands"
DaylightPuzzleWastelandsTwo = "Daylight Puzzle Piece 2: (PL1) Wastelands"
DaylightPuzzleJungle = "Daylight Puzzle Piece: (PL1) Jungle"
DaylightPuzzleOasis = "Daylight Puzzle Piece: (PL1) Oasis"
DaylightPuzzleKingsDen = "Daylight Puzzle Piece: (PL1) The King's Den (Post Hyenas 1)"

DaylightPuzzleCanyon = "Daylight Puzzle Piece: (SP1) The Canyon - Top Steps"
SunsetPuzzleCanyon = "Sunset Puzzle Piece: (SP1) The Canyon - Other Side of Steps"  # v+g 3
SunsetPuzzleSolarSailor = "Sunset Puzzle Piece: (SP2) Solar Sailor"
SunsetPuzzleMCP = "Sunset Puzzle Piece: (SP2) MCP Arena"

SunsetPuzzleMemorysSkyscraper = "Sunset Puzzle Piece: (TWTNW2) Memory's Skyscraper"
SunsetPuzzleCrooked = "Sunset Puzzle Piece: (TWTNW2) Crooked Ascension"
SunsetPuzzleTwilightView = "Sunset Puzzle Piece: (TWTNW2) Twilight View"  # v+g level2
DaylightPuzzleNaughts = "Daylight Puzzle Piece: (TWTNW2) Naughts Skyway"
SunsetPuzzleProofExistence = "Sunset Puzzle Piece: (TWTNW2) Proof of Existence"
...
FrontierPuzzleTritonTwo = "Frontier Puzzle Piece 2: (AT) Triton's Throne"
