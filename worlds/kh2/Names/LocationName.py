...
AwakeningPuzzleTT1Tower = "(TT) Tower Awakening Puzzle Piece"
FrontierPuzzleTT2TramCommon = "(TT2) Tram Common - On Top of House Frontier Puzzle Piece"
DaylightPuzzleTT2TramCommon = "(TT2) Tram Common - On Synth Shop Daylight Puzzle Piece"
DaylightPuzzleTT2MarketStreet = "(TT2) Market Street - Station Heights Daylight Puzzle Piece"  # need vertical+glide
FrontierPuzzleTT2StationPlaza = "(TT2) Station Plaza Frontier Puzzle Piece"
SunsetPuzzleTT3UndergroundConcourse1 = "(TT3) Underground Concourse Sunset Puzzle Piece 1"
SunsetPuzzleTT3UndergroundConcourse2 = "(TT3) Underground Concourse Sunset Puzzle Piece 2"
SunsetPuzzleTT3Tunnelway = "(TT3) Tunnelway Sunset Puzzle Piece"
SunsetPuzzleTT3TSunsetTerrace1 = "(TT3) Sunset Terrace Sunset Puzzle Piece 1"  # vertical glide for waterfall piece
SunsetPuzzleTT3TSunsetTerrace2 = "(TT3) Sunset Terrace Sunset Puzzle Piece 2"
SunsetPuzzleTT3TSunsetHill1 = "(TT3) Sunset Hill Sunset Puzzle Piece 1"
SunsetPuzzleTT3TSunsetHill2 = "(TT3) Sunset Hill Sunset Puzzle Piece 2"
SunsetPuzzleTT3OldMansion = "(TT3) The Old Mansion Sunset Puzzle Piece"  # need vertical glide
DaylightPuzzleTT3MansionFoyer1 = "(TT3) Mansion Foyer Daylight Puzzle Piece 1"
DaylightPuzzleTT3MansionFoyer2 = "(TT3) Mansion Foyer Daylight Puzzle Piece 2"  # need glide 2 or 3 or smthing
SunsetPuzzleTT3TheWhiteRoom = "(TT3) The White Room Sunset Puzzle Piece"
DaylightPuzzleTT3PodRoom = "(TT3) Pod Room Daylight Puzzle Piece"
DaylightPuzzleTT3SttComputerRoom = "(TT3) STT Computer Room Daylight Puzzle Piece"
SunsetPuzzlePostTT3Tower = "(Post TT3) The Tower Sunset Puzzle Piece"
SunsetPuzzlePostTT3TowerWardrobe = "(Post TT3) The Tower: Wardrobe Sunset Puzzle Piece"

AwakeningPuzzleHB1MarketplaceArmor = "(HB) Marketplace - Armor Shop Awakening Puzzle Piece"
HeartPuzzleHB1MarketplaceItem = "(HB) Marketplace - Item Shop Heart Puzzle Piece"
AwakeningPuzzleHB1Borough = "(HB) Borough - Top of the Wall Awakening Puzzle Piece"
SunsetPuzzleHB1Borough = "(HB) Borough - Top of the House Sunset Puzzle Piece"
AwakeningPuzzleHB1MerlinHouse = "(HB) Merlin's House Awakening Puzzle Piece"
DualityPuzzleHB1Bailey = "(HB) Bailey Duality Puzzle Piece"
DaylightPuzzleHB2PosternAerith = "(HB2) Postern - Near Stairs Daylight Puzzle Piece"
FrontierPuzzleHB2PosternDoorway = "(HB2) Postern - Above Doorway Frontier Puzzle Piece"  # vertical or glide
SunsetPuzzleHB2Corridors = "(HB2) Corridors Sunset Puzzle Piece"  # vertical+glide
SunsetPuzzleHB2BaileyDancers = "(HB2) Bailey - Post Dancers Sunset Puzzle Piece"
SunsetPuzzlePostHB2Ansems = "(Post HB2) Ansem's Study Sunset Puzzle Piece"
DaylightPuzzlePostHB2Heartless = "(Post HB2) Heartless Manufactory Daylight Puzzle Piece"

SunsetPuzzleCoRDepths1 = "(CoR) Depths Sunset Puzzle Piece 1"
SunsetPuzzleCoRDepths2 = "(CoR) Depths Sunset Puzzle Piece 2"
SunsetPuzzleCoRMineshaftLower = "(CoR) Mineshaft Lower Sunset Puzzle Piece"
SunsetPuzzleCoRMiningArea1 = "(CoR) Mining Area Sunset Puzzle Piece 1"
SunsetPuzzleCoRMiningArea2 = "(CoR) Mining Area Sunset Puzzle Piece 2"
SunsetPuzzleCoRMiningArea3 = "(CoR) Mining Area Sunset Puzzle Piece 3"
SunsetPuzzleCoRMiningArea4 = "(CoR) Mining Area Sunset Puzzle Piece 4"
SunsetPuzzleCoRMineshaftMiddle = "(CoR) Mineshaft Middle Sunset Puzzle Piece 1"
SunsetPuzzleCoRMineshaftUpper1 = "(CoR) Mineshaft Upper Sunset Puzzle Piece 1"
SunsetPuzzleCoRMineshaftUpper2 = "(CoR) Mineshaft Upper Sunset Puzzle Piece 2"
SunsetPuzzleCoRMineshaftUpper3 = "(CoR) Mineshaft Upper Sunset Puzzle Piece 3"

HeartPuzzleEncampmentNearStand = "(LoD) Encampment Near Stand Heart Puzzle Piece"
SunsetPuzzleEncampmentAwayFromStand = "(LoD) Encampment Away From Stand Sunset Puzzle Piece"
FrontierPuzzleMountainTrail = "(LoD) Mountain Trail Frontier Puzzle Piece"
AwakeningPuzzleVillageHayPile = "(LoD) Village Hay Pile Awakening Puzzle Piece"
HeartPuzzleVillageHome = "(LoD) Village Home Heart Puzzle Piece"  # vertical
DaylightPuzzleVillageBell = "(LoD) Village Top of the Bell Daylight Puzzle Piece"  # vertical+glide, around level 2+magic if town is burnt (yes)
AwakeningPuzzleRidgeOne = "(LoD) Ridge Awakening Puzzle Piece 1"
AwakeningPuzzleRidgeTwo = "(LoD) Ridge Awakening Puzzle Piece 2"

DaylightPuzzleThroneRoomClose = "(LoD2) Throne Room Close Daylight Puzzle Piece"  # v+g around level 2
DaylightPuzzleRoomFar = "(LoD2) Throne Room Far Daylight Puzzle Piece"  # v+g around lvl 3

SunsetPuzzleEntranceHall = "(BC) Entrance Hall Sunset Puzzle Piece"  # v+g around 2
DaylightPuzzleWestHall = "(BC) West Hall Daylight Puzzle Piece"  # v+g around level 1
AwakeningPuzzleUnderCroftOne = "(BC) Under Croft Awakening Puzzle Piece 1"
AwakeningPuzzleUnderCroftTwo = "(BC) Under Croft Awakening Puzzle Piece 2"
AwakeningPuzzleSecretPassageOne = "(BC) Secret Passage Awakening Puzzle Piece 1"
AwakeningPuzzleSecretPassageTwo = "(BC) Secret Passage Awakening Puzzle Piece 2"
HeartPuzzleWestWing = "(BC) West Wing Heart Puzzle Piece"
AwakeningPuzzleBeastRoom = "(BC) The Beast's Room Awakening Puzzle Piece"
SunsetPuzzlePostXaldin = "(BC2) Bridge (Post-Xaldin) Sunset Puzzle Piece"

HeartPuzzleCaveDeadEntrance = "(OC) Cave of the Dead Entrance Heart Puzzle Piece"
DaylightPuzzleCaveDeadPassage = "(OC) Cave of the Dead Passage Daylight Puzzle Piece"
HeartPuzzleUnderworldEntrance = "(OC) Underworld Caverns - Entrance:Near Entrance Heart Puzzle Piece"
DaylightPuzzleUnderworldEntrance = "(OC) Underworld Caverns - Entrance:Behind Pillar Daylight Puzzle Piece"
DaylightPuzzleLostRoadOne = "(OC) Lost Road Daylight Puzzle Piece 1"  # v 2
DaylightPuzzleLostRoadTwo = "(OC) Lost Road Daylight Puzzle Piece 2"  # v 2
DualityPuzzleLostRoadThree = "(OC) Lost Road Duality Puzzle Piece"
HeartPuzzleAtrium = "(OC) Atrium Heart Puzzle Piece"
DualityPuzzleTheLock = "(OC) The Lock Duality Puzzle Piece"

DualityPuzzleGummiHangar = "(DC) Gummi Hangar Duality Puzzle Piece"  # v or g and magic
HeartPuzzleCourtyardOne = "(DC) Courtyard - Pig Hedge Heart Puzzle Piece"  # vertical or magic buffer
HeartPuzzleCourtyardTwo = "(DC) Courtyard - Castle Hedge Heart Puzzle Piece"  # high jump 1 or somthing idk
DualityPuzzleCourtyard = "(DC) Courtyard - Behind Trombone Hedge Duality Puzzle Piece"
DaylightPuzzleCollannade = "(DC) Collannade Daylight Puzzle Piece"  # v or g
DualityPuzzlePierTree = "(TR) Pier - Tree Duality Puzzle Piece"  # vertical or glide
FrontierPuzzlePierBoat = "(TR) Pier - Boat Tickets Frontier Puzzle Piece"
HeartPuzzleWaterway = "(TR) Waterway Heart Puzzle Piece"

HeartPuzzleRampart = "(PR) Rampart Heart Puzzle Piece"
SunsetPuzzleHarbor = "(PR) Harbor Sunset Puzzle Piece"  # v+g 2
DualityPuzzleTown = "(PR) Town - Next to Explosives Duality Puzzle Piece"
FrontierPuzzleTown = "(PR) Town - Above Explosives Frontier Puzzle Piece"
HeartPuzzlePowderStore = "(PR) Powder Store - Middle/Right Explosives Heart Puzzle Piece"
DualityPuzzlePowderStore = "(PR) Powder Store - Middle/Right Explosives Duality Puzzle Piece"
DaylightPuzzleBlackPearlBack = "(PR) Black Pearl - Back of Ship Daylight Puzzle Piece"
DaylightPuzzleBlackPearlFlags = "(PR) Black Pearl - Flag Daylight Puzzle Piece"  # v+g 2
DaylightPuzzleBlackPearlInside = "(PR) Black Pearl - Inside Daylight Puzzle Piece"
SunsetPuzzleInterceptor = "(PR2) The Interceptor's Hold Sunset Puzzle Piece"
SunsetPuzzleSeaDriftRowOne = "(PR2) Sea Drift Row Sunset Puzzle Piece 1"
SunsetPuzzleSeaDriftKeepWindow = "(PR2) Sea Drift Keep - Window Sunset Puzzle Piece"
DaylightPuzzleSeaDriftKeepAnchor = "(PR2) Sea Drift Keep - Anchor Daylight Puzzle Piece"

FrontierPuzzleAgrabah = "(AG) Agrabah - Inside Stand Frontier Puzzle Piece"  # magic
DualityPuzzleAgrabah = "(AG) Agrabah - Above Stand Duality Puzzle Piece"
FrontierPuzzleBazaar = "(AG) Bazaar - Inside Stand Frontier Puzzle Piece"  # magic
SunsetPuzzleBazaar = "(AG) Bazaar - Above Gate Sunset Puzzle Piece"  # v+g 2
DaylightPuzzleCaveOfWonders = "(AG) Cave of Wonders Daylight Puzzle Piece"
FrontierPuzzleValleyOfStone = "(AG) Valley Of Stone Frontier Puzzle Piece"
DaylightPuzzleTreasureRooms = "(AG) Treasure Room - Not Gold Pile Daylight Puzzle Piece"
SunsetPuzzleTreasureRooms = "(AG) Treasure Room - On top of Gold Pile Sunset Puzzle Piece"
DaylightPuzzleChasmOfChallengesOne = "(AG) Chasm Of Challenges Daylight Puzzle Piece 1"
DaylightPuzzleChasmOfChallengesTwo = "(AG) Chasm Of Challenges Daylight Puzzle Piece 2"
DaylightPuzzleChasmOfChallengesThree = "(AG) Chasm Of Challenges Daylight Puzzle Piece 3"
SunsetPuzzleSandSwept = "(AG2) Sandswept Ruins - 1st Arch Sunset Puzzle Piece"  # don't need magic for these
DaylightPuzzleSandSweptOne = "(AG2) Sandswept Ruins Daylight Puzzle Piece 1"
DaylightPuzzleSandSweptTwo = "(AG2) Sandswept Ruins Daylight Puzzle Piece 2"

DualityPuzzleHalloweenTownSquare = "(HT) Halloween Town Square Duality Puzzle Piece"
DualityPuzzleHinterlands = "(HT) Hinterlands Duality Puzzle Piece"
DaylightPuzzleYuletide = "(HT) Yuletide Hill Daylight Puzzle Piece"
DaylightPuzzleSantaHouse = "(HT) Santa House Daylight Puzzle Piece"
FrontierPuzzleSantaHouse = "(HT) Santa House Frontier Puzzle Piece"
SunsetPuzzleCurlyHill = "(HT) Curly Hill (Prison Keeper Arena) Sunset Puzzle Piece"  # post pk, v+g 3
DaylightPuzzleToyFactory = "(HT2) Toy Factory Daylight Puzzle Piece"
SunsetPuzzleToyFactory = "(HT2) Toy Factory - Standalone Pillar Sunset Puzzle Piece"  # v+g

DaylightPuzzleElephantOne = "(PL) Elephant Graveyard Daylight Puzzle Piece 1"
DaylightPuzzleElephantTwo = "(PL) Elephant Graveyard Daylight Puzzle Piece 2"
SunsetPuzzlePrideRock = "(PL) Pride Rock Sunset Puzzle Piece"
DaylightPuzzleWildebeestOne = "(PL) Wildebeest Valley Daylight Puzzle Piece 1"
DaylightPuzzleWildebeestTwo = "(PL) Wildebeest Valley Daylight Puzzle Piece 2"
DaylightPuzzleWastelandsOne = "(PL) Wastelands Daylight Puzzle Piece 1"
DaylightPuzzleWastelandsTwo = "(PL) Wastelands Daylight Puzzle Piece 2"
DaylightPuzzleJungle = "(PL) Jungle Daylight Puzzle Piece"
DaylightPuzzleOasis = "(PL) Oasis Daylight Puzzle Piece"
DaylightPuzzleKingsDen = "(PL) The King's Den (Post Hyenas ) Daylight Puzzle Piece"

DaylightPuzzleCanyon = "(SP) The Canyon - Top Steps Daylight Puzzle Piece"
SunsetPuzzleCanyon = "(SP) The Canyon - Other Side of Steps Sunset Puzzle Piece"  # v+g 3
SunsetPuzzleSolarSailor = "(SP2) Solar Sailor Sunset Puzzle Piece"
SunsetPuzzleMCP = "(SP2) MCP Arena Sunset Puzzle Piece"

SunsetPuzzleMemorysSkyscraper = "(TWTNW2) Memory's Skyscraper Sunset Puzzle Piece"
SunsetPuzzleCrooked = "(TWTNW2) Crooked Ascension Sunset Puzzle Piece"
SunsetPuzzleTwilightView = "(TWTNW2) Twilight View Sunset Puzzle Piece"  # v+g level2
DaylightPuzzleNaughts = "(TWTNW2) Naughts Skyway Daylight Puzzle Piece"
SunsetPuzzleProofExistence = "(TWTNW2) Proof of Existence Sunset Puzzle Piece"
SunsetPuzzleRuinPassageOne = "(TWTNW3) Ruin  and Creation's Passage Sunset Puzzle Piece 1"
SunsetPuzzleRuinPassageTwo = "(TWTNW3) Ruin  and Creation's Passage Sunset Puzzle Piece 2"

DaylightPuzzlePooh = "(100Acre 0 Torn Page) Pooh's House Daylight Puzzle Piece"
DaylightPuzzlePiglet = "(100Acre 1 Torn Page) Piglet's House Daylight Puzzle Piece"
DaylightPuzzleRabbit = "(100Acre 2 Torn Page) Rabbit's House Daylight Puzzle Piece"
DaylightPuzzleKanga = "(100Acre 3 Torn Page) Kanga's House Daylight Puzzle Piece"
DaylightPuzzleSpookyCave = "(100Acre 4 Torn Page) Spooky Cave Daylight Puzzle Piece"
DaylightPuzzleStarryHill = "(100Acre 5 Torn Page) Starry Hill Daylight Puzzle Piece"

DualityPuzzleUndersea = "(AT) Undersea Courtyard Duality Puzzle Piece"
FrontierPuzzleTritonOne = "(AT) Triton's Throne Frontier Puzzle Piece 1"
FrontierPuzzleTritonTwo = "(AT) Triton's Throne Frontier Puzzle Piece 2"
