...
DonaldAbility_Table = {
    ItemName.DonaldFire: 				ItemData(0x1300F9,  1,165,0x111 ),
    ItemName.DonaldBlizzard: 			ItemData(0x1300FA,  1,166,0x111 ),
    ItemName.DonaldThunder: 			ItemData(0x1300FB,  1,167,0x111 ),
    ItemName.DonaldCure: 				ItemData(0x1300FC,  1,168,0x111 ),
    ItemName.Fantasia: 				    ItemData(0x1300FD,  1,199,0x111 ),
    ItemName.FlareForce: 				ItemData(0x1300FE,  1,200,0x111 ),
    ItemName.DonaldMPRage: 				ItemData(0x1300FF,  3,412,0x111 ),
    ItemName.DonaldJackpot: 			ItemData(0x130100,  1,406,0x111 ),
    ItemName.DonaldLuckyLucky: 			ItemData(0x130101,  3,407,0x111 ),
    ItemName.DonaldFireBoost: 			ItemData(0x130102,  2,408,0x111 ),
    ItemName.DonaldBlizzardBoost: 		ItemData(0x130103,  2,409,0x111 ),
    ItemName.DonaldThunderBoost: 		ItemData(0x130104,  2,410,0x111 ),
    ItemName.DonaldMPHastera: 			ItemData(0x130105,  3,421,0x111 ),
    ItemName.DonaldAutoLimit: 			ItemData(0x130106,  1,417,0x111 ),
    ItemName.DonaldHyperHealing: 		ItemData(0x130107,  2,419,0x111 ),
    ItemName.DonaldAutoHealing: 		ItemData(0x130108,  1,420,0x111 ),
    ItemName.DonaldMPHastega: 			ItemData(0x130109,  2,422,0x111 ),
    ItemName.DonaldItemBoost: 			ItemData(0x13010A,  1,411,0x111 ),
    ItemName.DonaldDamageControl: 		ItemData(0x13010B,  2,542,0x111 ),
    ItemName.DonaldDraw: 				ItemData(0x13010C,  1,405,0x111 ),
}#32
GoofyAbility_Table = {
    ItemName.GoofyTornado: 				ItemData(0x13010D,  1,423,0x111 ),
    ItemName.GoofyTurbo: 				ItemData(0x13010E,  1,425,0x111 ),
    ItemName.GoofyBash: 				ItemData(0x13010F,  1,429,0x111 ),
    ItemName.TornadoFusion: 			ItemData(0x130110,  1,201,0x111 ),
    ItemName.Teamwork: 				    ItemData(0x130111,  1,202,0x111 ),
    ItemName.GoofyDraw: 				ItemData(0x130112,  1,405,0x111 ),
    ItemName.GoofyJackpot: 				ItemData(0x130113,  1,406,0x111 ),
    ItemName.GoofyLuckyLucky: 			ItemData(0x130114,  1,407,0x111 ),
    ItemName.GoofyItemBoost: 			ItemData(0x130115,  2,411,0x111 ),
    ItemName.GoofyMPRage: 				ItemData(0x130116,  2,412,0x111 ),
    ItemName.GoofyDefender: 			ItemData(0x130117,  2,414,0x111 ),
    ItemName.GoofyDamageControl: 		ItemData(0x130118,  3,542,0x111 ),
    ItemName.GoofyAutoLimit: 			ItemData(0x130119,  1,417,0x111 ),
    ItemName.GoofySecondChance: 		ItemData(0x13011A,  1,415,0x111 ),
    ItemName.GoofyOnceMore: 			ItemData(0x13011B,  1,416,0x111 ),
    ItemName.GoofyAutoChange: 			ItemData(0x13011C,  1,418,0x111 ),
    ItemName.GoofyHyperHealing: 		ItemData(0x13011D,  2,419,0x111 ),
    ItemName.GoofyAutoHealing: 			ItemData(0x13011E,  1,420,0x111 ),
    ItemName.GoofyMPHaste: 				ItemData(0x13011F,  1,413,0x111 ),
    ItemName.GoofyMPHastera: 			ItemData(0x130120,  1,421,0x111 ),
    ItemName.GoofyMPHastega: 			ItemData(0x130121,  1,422,0x111 ),
    ItemName.GoofyProtect: 				ItemData(0x130122,  2,596,0x111 ),
    ItemName.GoofyProtera: 				ItemData(0x130123,  2,597,0x111 ),
    ItemName.GoofyProtega: 				ItemData(0x130124,  2,598,0x111 ),
