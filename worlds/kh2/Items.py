...
Movement_Table = {                               
    ...
    ItemName.HighJump: 				    ItemData(0x130030,  4,94,  0x05E,0,1,True),                                                                       
    ItemName.QuickRun: 				    ItemData(0x130031,  4,98,  0x062,0,1,True), 
    ItemName.DodgeRoll: 				ItemData(0x130032,  4,564, 0x234,0,1,True),
    ItemName.AerialDodge: 				ItemData(0x130033,  4,102, 0x066,0,1,True),                                                                      
    ItemName.Glide: 				    ItemData(0x130034,  4,106, 0x06A,0,1,True),                                                                   
...
SupportAbility_Table = {                         
    ItemName.Scan: 				        ItemData(0x1300AD,  2,138, 0x08A ,0,1,True),
    ItemName.AerialRecovery: 			ItemData(0x1300AE,  1,158, 0x09E ,0,1,True),
    ItemName.ComboMaster: 				ItemData(0x1300AF,  1,539, 0x21B ,0,1,True),
    ItemName.ComboPlus: 				ItemData(0x1300B0,  3,162, 0x0A2 ,0,1,True),
    ItemName.AirComboPlus: 				ItemData(0x1300B1,  3,163, 0x0A3 ,0,1,True),
    ItemName.ComboBoost: 				ItemData(0x1300B2,  2,390, 0x186 ,0,1,True),
    ItemName.AirComboBoost: 			ItemData(0x1300B3,  2,391, 0x187 ,0,1,True),
    ItemName.ReactionBoost: 			ItemData(0x1300B4,  3,392, 0x188 ,0,1,True),
    ItemName.FinishingPlus: 			ItemData(0x1300B5,  3,393, 0x189 ,0,1,True),
    ItemName.NegativeCombo: 			ItemData(0x1300B6,  2,394, 0x18A ,0,1,True),
    ItemName.BerserkCharge: 			ItemData(0x1300B7,  2,395, 0x18B ,0,1,True),
    ItemName.DamageDrive: 				ItemData(0x1300B8,  2,396, 0x18C ,0,1,True),
    ItemName.DriveBoost: 				ItemData(0x1300B9,  2,397, 0x18D ,0,1,True),
    ItemName.FormBoost: 				ItemData(0x1300BA,  3,398, 0x18E ,0,1,True),
    ItemName.SummonBoost: 				ItemData(0x1300BB,  1,399, 0x18F ,0,1,True),
    ItemName.ExperienceBoost: 			ItemData(0x1300BC,  2,401, 0x191 ,0,1,True),
    ItemName.Draw: 				        ItemData(0x1300BD,  4,405, 0x195 ,0,1,True),
    ItemName.Jackpot: 				    ItemData(0x1300BE,  2,406, 0x196 ,0,1,True),
    ItemName.LuckyLucky: 				ItemData(0x1300BF,  3,407, 0x197 ,0,1,True),
    ItemName.DriveConverter: 			ItemData(0x1300C0,  2,540, 0x21C ,0,1,True),
    ItemName.FireBoost: 				ItemData(0x1300C1,  2,408, 0x198 ,0,1,True),
    ItemName.BlizzardBoost: 			ItemData(0x1300C2,  2,409, 0x199 ,0,1,True),
    ItemName.ThunderBoost: 				ItemData(0x1300C3,  2,410, 0x19A ,0,1,True),
    ItemName.ItemBoost: 				ItemData(0x1300C4,  2,411, 0x19B ,0,1,True),
    ItemName.MPRage: 				    ItemData(0x1300C5,  2,412, 0x19C ,0,1,True),
    ItemName.MPHaste: 				    ItemData(0x1300C6,  2,413, 0x19D ,0,1,True),
    ItemName.MPHastera: 				ItemData(0x1300C7,  2,421, 0x1A5 ,0,1,True),
    ...
    ItemName.LeafBracer: 				ItemData(0x1300CE,  1,402, 0x192 , 0,1,True ),
    ItemName.CombinationBoost: 			ItemData(0x1300CF,  1,400, 0x190 , 0,1,True ),
    ItemName.OnceMore: 				    ItemData(0x1300D0,  1,416, 0x1A0 , 0,1,True ),
    ItemName.SecondChance: 				ItemData(0x1300D1,  1,415, 0x19F , 0,1,True ),
}                                                
ActionAbility_Table = {                          
    ItemName.Guard: 				    ItemData(0x1300D2,  1,82,  0x052  ,0,1,True ),                    
    ItemName.UpperSlash: 				ItemData(0x1300D3,  1,137, 0x089 , 0,1,True ),              
    ItemName.HorizontalSlash: 			ItemData(0x1300D4,  1,271, 0x10F , 0,1,True ),         
    ItemName.FinishingLeap: 			ItemData(0x1300D5,  1,267, 0x10B , 0,1,True ),           
    ItemName.RetaliatingSlash: 			ItemData(0x1300D6,  1,273, 0x111 , 0,1,True ),        
    ItemName.Slapshot: 				    ItemData(0x1300D7,  1,262, 0x106 , 0,1,True ),                
    ItemName.DodgeSlash: 				ItemData(0x1300D8,  1,263, 0x107 , 0,1,True ),              
    ItemName.FlashStep: 				ItemData(0x1300D9,  1,559, 0x22F , 0,1,True ),               
    ItemName.SlideDash: 				ItemData(0x1300DA,  1,264, 0x108 , 0,1,True ),               
    ItemName.VicinityBreak: 			ItemData(0x1300DB,  1,562, 0x232 , 0,1,True ),           
    ItemName.GuardBreak: 				ItemData(0x1300DC,  1,265, 0x109 , 0,1,True ),              
    ItemName.Explosion: 				ItemData(0x1300DD,  1,266, 0x10A , 0,1,True ),               
    ItemName.AerialSweep: 				ItemData(0x1300DE,  1,269, 0x10D , 0,1,True ),             
    ItemName.AerialDive: 				ItemData(0x1300DF,  1,560, 0x230 , 0,1,True ),              
    ItemName.AerialSpiral: 				ItemData(0x1300E0,  1,270, 0x10E , 0,1,True ),            
    ItemName.AerialFinish: 				ItemData(0x1300E1,  1,272, 0x110 , 0,1,True ),            
    ItemName.MagnetBurst: 				ItemData(0x1300E2,  1,561, 0x231 , 0,1,True ),             
    ItemName.Counterguard: 				ItemData(0x1300E3,  1,268, 0x10C , 0,1,True ),            
    ItemName.AutoValor: 				ItemData(0x1300E4,  1,385, 0x181 , 0,1,True ),               
    ItemName.AutoWisdom: 				ItemData(0x1300E5,  1,386, 0x182 , 0,1,True ),              
    ItemName.AutoLimit: 				ItemData(0x1300E6,  1,568, 0x238 , 0,1,True ),               
    ItemName.AutoMaster: 				ItemData(0x1300E7,  1,387, 0x183 , 0,1,True ),              
    ItemName.AutoFinal: 				ItemData(0x1300E8,  1,388, 0x184 , 0,1,True ),               
    ItemName.AutoSummon: 				ItemData(0x1300E9,  1,389, 0x185 , 0,1,True ),              
    ItemName.TrinityLimit: 				ItemData(0x1300EA,  1,198, 0x0C6,  0,1,True  ),                   
}                                                
Items_Table = {                                  
...
DonaldAbility_Table = {
    ...
    ItemName.DonaldThunder: 			ItemData(0x1300FB,  1,167,0x0A7 ,0,1,True),
    ItemName.DonaldCure: 				ItemData(0x1300FC,  1,168,0x0A8 ,0,1,True),
    ...
    ItemName.DonaldJackpot: 			ItemData(0x130100,  1,406,0x196 ,0,1,True),
    ItemName.DonaldLuckyLucky: 			ItemData(0x130101,  3,407,0x197 ,0,1,True),
    ItemName.DonaldFireBoost: 			ItemData(0x130102,  2,408,0x198 ,0,1,True),
    ItemName.DonaldBlizzardBoost: 		ItemData(0x130103,  2,409,0x199 ,0,1,True),
    ItemName.DonaldThunderBoost: 		ItemData(0x130104,  2,410,0x19A ,0,1,True),
    ItemName.DonaldMPHaste:             ItemData(0x130105,  1,413,0x19D ,0,1,True),
    ItemName.DonaldMPHastera: 			ItemData(0x130106,  2,421,0x1A5 ,0,1,True),
    ItemName.DonaldMPHastega: 			ItemData(0x130107,  2,422,0x1A6 ,0,1,True),
    ItemName.DonaldAutoLimit: 			ItemData(0x130108,  1,417,0x1A1 ,0,1,True),
    ItemName.DonaldHyperHealing: 		ItemData(0x130109,  2,419,0x1A3 ,0,1,True),
    ItemName.DonaldAutoHealing: 		ItemData(0x13010A,  1,420,0x1A4 ,0,1,True),
    ItemName.DonaldItemBoost: 			ItemData(0x13010B,  1,411,0x19B ,0,1,True),
    ItemName.DonaldDamageControl: 		ItemData(0x13010C,  2,542,0x21E ,0,1,True),
    ItemName.DonaldDraw: 				ItemData(0x13010D,  1,405,0x195 ,0,1,True),
}#32                                                                    
GoofyAbility_Table = {                                                  
    ItemName.GoofyTornado: 				ItemData(0x13010E,  1,423,0x1A7 ,0,1,True),
    ItemName.GoofyTurbo: 				ItemData(0x13010F,  1,425,0x1A9 ,0,1,True),
    ItemName.GoofyBash: 				ItemData(0x130110,  1,429,0x1AD ,0,1,True),
    ItemName.TornadoFusion: 			ItemData(0x130111,  1,201,0x0C9 ,0,1,True),
    ItemName.Teamwork: 				    ItemData(0x130112,  1,202,0x0CA ,0,1,True),
    ItemName.GoofyDraw: 				ItemData(0x130113,  1,405,0x195 ,0,1,True),
    ItemName.GoofyJackpot: 				ItemData(0x130114,  1,406,0x196 ,0,1,True),
    ItemName.GoofyLuckyLucky: 			ItemData(0x130115,  1,407,0x197 ,0,1,True),
    ItemName.GoofyItemBoost: 			ItemData(0x130116,  2,411,0x19B ,0,1,True),
    ItemName.GoofyMPRage: 				ItemData(0x130117,  2,412,0x19C ,0,1,True),
    ItemName.GoofyDefender: 			ItemData(0x130118,  2,414,0x19E ,0,1,True),
    ItemName.GoofyDamageControl: 		ItemData(0x130119,  3,542,0x21E ,0,1,True),
    ItemName.GoofyAutoLimit: 			ItemData(0x13011A,  1,417,0x1A1 ,0,1,True),
    ItemName.GoofySecondChance: 		ItemData(0x13011B,  1,415,0x19F ,0,1,True),
    ItemName.GoofyOnceMore: 			ItemData(0x13011C,  1,416,0x1A0 ,0,1,True),
    ItemName.GoofyAutoChange: 			ItemData(0x13011D,  1,418,0x1A2 ,0,1,True),
    ItemName.GoofyHyperHealing: 		ItemData(0x13011E,  2,419,0x1A3 ,0,1,True),
    ItemName.GoofyAutoHealing: 			ItemData(0x13011F,  1,420,0x1A4 ,0,1,True),
    ItemName.GoofyMPHaste: 				ItemData(0x130120,  1,413,0x19D ,0,1,True),
    ItemName.GoofyMPHastera: 			ItemData(0x130121,  1,421,0x1A5 ,0,1,True),
    ItemName.GoofyMPHastega: 			ItemData(0x130122,  1,422,0x1A6 ,0,1,True),
    ItemName.GoofyProtect: 				ItemData(0x130123,  2,596,0x254 ,0,1,True),
    ItemName.GoofyProtera: 				ItemData(0x130124,  2,597,0x255 ,0,1,True),
    ItemName.GoofyProtega: 				ItemData(0x130125,  2,598,0x256 ,0,1,True),
