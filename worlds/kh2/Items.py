...
DonaldAbility_Table = {
    ...
    ItemName.DonaldMPHastera: 			ItemData(0x130105,  3,421,0x1A5 ,0,1,True),
    ItemName.DonaldAutoLimit: 			ItemData(0x130106,  1,417,0x1A1 ,0,1,True),
    ItemName.DonaldHyperHealing: 		ItemData(0x130107,  2,419,0x1A3 ,0,1,True),
...
GoofyAbility_Table = {                                                  
    ItemName.GoofyTornado: 				ItemData(0x13010D,  1,423,0x1A7 ,0,1,True),
    ItemName.GoofyTurbo: 				ItemData(0x13010E,  1,425,0x1A9 ,0,1,True),
    ItemName.GoofyBash: 				ItemData(0x13010F,  1,429,0x81AD ,0,1,True),
    ItemName.TornadoFusion: 			ItemData(0x130110,  1,201,0x0C9 ,0,1,True),
    ItemName.Teamwork: 				    ItemData(0x130111,  1,202,0x0CA ,0,1,True),
    ItemName.GoofyDraw: 				ItemData(0x130112,  1,405,0x195 ,0,1,True),
    ItemName.GoofyJackpot: 				ItemData(0x130113,  1,406,0x196 ,0,1,True),
    ItemName.GoofyLuckyLucky: 			ItemData(0x130114,  1,407,0x197 ,0,1,True),
    ItemName.GoofyItemBoost: 			ItemData(0x130115,  2,411,0x19B ,0,1,True),
    ItemName.GoofyMPRage: 				ItemData(0x130116,  2,412,0x19C ,0,1,True),
    ItemName.GoofyDefender: 			ItemData(0x130117,  2,414,0x19E ,0,1,True),
    ItemName.GoofyDamageControl: 		ItemData(0x130118,  3,542,0x21E ,0,1,True),
    ItemName.GoofyAutoLimit: 			ItemData(0x130119,  1,417,0x1A1 ,0,1,True),
    ItemName.GoofySecondChance: 		ItemData(0x13011A,  1,415,0x19F ,0,1,True),
    ItemName.GoofyOnceMore: 			ItemData(0x13011B,  1,416,0x1A0 ,0,1,True),
    ItemName.GoofyAutoChange: 			ItemData(0x13011C,  1,418,0x1A2 ,0,1,True),
    ItemName.GoofyHyperHealing: 		ItemData(0x13011D,  2,419,0x1A3 ,0,1,True),
    ItemName.GoofyAutoHealing: 			ItemData(0x13011E,  1,420,0x1A4 ,0,1,True),
    ItemName.GoofyMPHaste: 				ItemData(0x13011F,  1,413,0x19D ,0,1,True),
    ItemName.GoofyMPHastera: 			ItemData(0x130120,  1,421,0x1A5 ,0,1,True),
    ItemName.GoofyMPHastega: 			ItemData(0x130121,  1,422,0x1A6 ,0,1,True),
    ItemName.GoofyProtect: 				ItemData(0x130122,  2,596,0x254 ,0,1,True),
    ItemName.GoofyProtera: 				ItemData(0x130123,  2,597,0x255 ,0,1,True),
    ItemName.GoofyProtega: 				ItemData(0x130124,  2,598,0x256 ,0,1,True),
