...
SoraLevels = {
    # LocationName.Lvl1:  LocationData(1, "Levels"),
...
AllWeaponSlot = {
    weapon_name for weapon_list in
    [weapon_to_slots.keys(), [
...
exclusion_table = {
    ...
    "Cups":          {
        cup_location for cup_location in Oc_Cups.keys()
    },
    "BetterChests":  {location for location, data in all_locations.items() if data.yml == "Chest" and location not in popups_set and location != LocationName.StationofSerenityPotion}
}
