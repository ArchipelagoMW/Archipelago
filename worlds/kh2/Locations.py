...
Daylight_Checks = {
    ...
    LocationName.DaylightPuzzleVillageBell:            LocationData(8, "PuzzlePiece"),
    LocationName.DaylightPuzzleThroneRoomClose:        LocationData(9, "PuzzlePiece"),
    LocationName.DaylightPuzzleRoomFar:                LocationData(10, "PuzzlePiece"),
    LocationName.DaylightPuzzleWestHall:               LocationData(11, "PuzzlePiece"),
    LocationName.DaylightPuzzleCaveDeadPassage:        LocationData(12, "PuzzlePiece"),
    LocationName.DaylightPuzzleUnderworldEntrance:     LocationData(13, "PuzzlePiece"),
    LocationName.DaylightPuzzleLostRoadOne:            LocationData(14, "PuzzlePiece"),
    LocationName.DaylightPuzzleLostRoadTwo:            LocationData(15, "PuzzlePiece"),
    LocationName.DaylightPuzzleCollannade:             LocationData(16, "PuzzlePiece"),
    LocationName.DaylightPuzzleBlackPearlBack:         LocationData(17, "PuzzlePiece"),
    LocationName.DaylightPuzzleBlackPearlFlags:        LocationData(18, "PuzzlePiece"),
    LocationName.DaylightPuzzleBlackPearlInside:       LocationData(19, "PuzzlePiece"),
    LocationName.DaylightPuzzleSeaDriftKeep:           LocationData(20, "PuzzlePiece"),
    LocationName.DaylightPuzzleCaveOfWonders:          LocationData(21, "PuzzlePiece"),
    LocationName.DaylightPuzzleChasmOfChallengesOne:   LocationData(22, "PuzzlePiece"),
    LocationName.DaylightPuzzleChasmOfChallengesTwo:   LocationData(23, "PuzzlePiece"),
    LocationName.DaylightPuzzleChasmOfChallengesThree: LocationData(24, "PuzzlePiece"),
    LocationName.DaylightPuzzleSandSweptOne:           LocationData(25, "PuzzlePiece"),
    LocationName.DaylightPuzzleSandSweptTwo:           LocationData(26, "PuzzlePiece"),
    LocationName.DaylightPuzzleYuletide:               LocationData(27, "PuzzlePiece"),
    LocationName.DaylightPuzzleSantaHouse:             LocationData(28, "PuzzlePiece"),
    LocationName.DaylightPuzzleToyFactory:             LocationData(29, "PuzzlePiece"),
    LocationName.DaylightPuzzleElephantOne:            LocationData(30, "PuzzlePiece"),
    LocationName.DaylightPuzzleElephantTwo:            LocationData(31, "PuzzlePiece"),
    LocationName.DaylightPuzzleWildebeestOne:          LocationData(32, "PuzzlePiece"),
    LocationName.DaylightPuzzleWildebeestTwo:          LocationData(33, "PuzzlePiece"),
    LocationName.DaylightPuzzleWastelandsOne:          LocationData(34, "PuzzlePiece"),
    LocationName.DaylightPuzzleWastelandsTwo:          LocationData(35, "PuzzlePiece"),
    LocationName.DaylightPuzzleJungle:                 LocationData(36, "PuzzlePiece"),
    LocationName.DaylightPuzzleOasis:                  LocationData(37, "PuzzlePiece"),
    LocationName.DaylightPuzzleKingsDen:               LocationData(38, "PuzzlePiece"),
    LocationName.DaylightPuzzleCanyon:                 LocationData(39, "PuzzlePiece"),
    LocationName.DaylightPuzzleNaughts:                LocationData(40, "PuzzlePiece"),
    LocationName.DaylightPuzzlePooh:                   LocationData(41, "PuzzlePiece"),
    LocationName.DaylightPuzzlePiglet:                 LocationData(42, "PuzzlePiece"),
    LocationName.DaylightPuzzleRabbit:                 LocationData(43, "PuzzlePiece"),
    LocationName.DaylightPuzzleKanga:                  LocationData(44, "PuzzlePiece"),
    LocationName.DaylightPuzzleSpookyCave:             LocationData(45, "PuzzlePiece"),
    LocationName.DaylightPuzzleStarryHill:             LocationData(46, "PuzzlePiece"),
}
Sunset_Checks = {
    ...
    LocationName.SunsetPuzzlePostHB2Heartless:         LocationData(16, "PuzzlePiece"),
    LocationName.SunsetPuzzleCoRDepths1:               LocationData(17, "PuzzlePiece"),
    LocationName.SunsetPuzzleCoRDepths2:               LocationData(18, "PuzzlePiece"),
    LocationName.SunsetPuzzleCoRMineshaftLower:        LocationData(19, "PuzzlePiece"),
    LocationName.SunsetPuzzleCoRMiningArea1:           LocationData(20, "PuzzlePiece"),
    LocationName.SunsetPuzzleCoRMiningArea2:           LocationData(21, "PuzzlePiece"),
    LocationName.SunsetPuzzleCoRMiningArea3:           LocationData(22, "PuzzlePiece"),
    LocationName.SunsetPuzzleCoRMiningArea4:           LocationData(23, "PuzzlePiece"),
    LocationName.SunsetPuzzleCoRMineshaftMiddle:       LocationData(24, "PuzzlePiece"),
    LocationName.SunsetPuzzleCoRMineshaftUpper1:       LocationData(25, "PuzzlePiece"),
    LocationName.SunsetPuzzleCoRMineshaftUpper2:       LocationData(26, "PuzzlePiece"),
    LocationName.SunsetPuzzleCoRMineshaftUpper3:       LocationData(27, "PuzzlePiece"),
    LocationName.SunsetPuzzleEncampmentAwayFromStand:  LocationData(28, "PuzzlePiece"),
    LocationName.SunsetPuzzleEntranceHall:             LocationData(29, "PuzzlePiece"),
    LocationName.SunsetPuzzlePostXaldin:               LocationData(30, "PuzzlePiece"),
    LocationName.SunsetPuzzleHarbor:                   LocationData(31, "PuzzlePiece"),
    LocationName.SunsetPuzzleInterceptor:              LocationData(32, "PuzzlePiece"),
    LocationName.SunsetPuzzleSeaDriftRowOne:           LocationData(33, "PuzzlePiece"),
    LocationName.SunsetPuzzleSeaDriftKeep:             LocationData(34, "PuzzlePiece"),
    LocationName.SunsetPuzzleBazaar:                   LocationData(35, "PuzzlePiece"),
