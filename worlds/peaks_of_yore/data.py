...
full_location_list: list[LocationData] = [
    ...
    LocationData('Coffeebox 1', 'Artefact', 207, PeaksOfYoreRegion.FUNDAMENTALS),
    LocationData('Coffeebox 2', 'Artefact', 208, PeaksOfYoreRegion.FUNDAMENTALS),
...
full_item_list: list[ItemData] = [
    ...
    ItemData('Coffeebox 1', 'Artefact', 207),
    ItemData('Coffeebox 2', 'Artefact', 208),
