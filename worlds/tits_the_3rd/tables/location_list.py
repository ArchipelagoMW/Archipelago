...
location_table = dict([
    ...
    (LocationName.tita_orbment_item_1,                                                          Data(1163,      "Character Gear",       RegionName.jade_corridor_start,                 ItemName.ep_cut_2,                                  LocationName.tita_orbment_item_1_spoiler)),
    (LocationName.tita_orbment_item_2,                                                          Data(1164,      "Character Gear",       RegionName.jade_corridor_start,                 ItemName.attack_1,                                  LocationName.tita_orbment_item_2_spoiler)),
    (LocationName.tita_orbment_item_3,                                                          Data(1165,      "Character Gear",       RegionName.jade_corridor_start,                 ItemName.eagle_eye,                                 LocationName.tita_orbment_item_3_spoiler)),
    (LocationName.tita_orbment_item_4,                                                          Data(1166,      "Character Gear",       RegionName.jade_corridor_start,                 ItemName.hp_1,                                      LocationName.tita_orbment_item_4_spoiler)),
    ### Julia
    ...
    (LocationName.julia_orbment_item_1,                                                         Data(1233,      "Character Gear",       RegionName.jade_corridor_arseille,              ItemName.ep_cut_2,                                  LocationName.julia_orbment_item_1_spoiler)),
    (LocationName.julia_orbment_item_2,                                                         Data(1234,      "Character Gear",       RegionName.jade_corridor_arseille,              ItemName.action_1,                                  LocationName.julia_orbment_item_2_spoiler)),
    (LocationName.julia_orbment_item_3,                                                         Data(1235,      "Character Gear",       RegionName.jade_corridor_arseille,              ItemName.hit_1,                                     LocationName.julia_orbment_item_3_spoiler)),
    (LocationName.julia_orbment_item_4,                                                         Data(1236,      "Character Gear",       RegionName.jade_corridor_arseille,              ItemName.range_1,                                   LocationName.julia_orbment_item_4_spoiler)),
    (LocationName.julia_orbment_item_5,                                                         Data(1237,      "Character Gear",       RegionName.jade_corridor_arseille,              ItemName.move_1,                                    LocationName.julia_orbment_item_5_spoiler)),
    (LocationName.julia_orbment_item_6,                                                         Data(1238,      "Character Gear",       RegionName.jade_corridor_arseille,              ItemName.attack_1,                                  LocationName.julia_orbment_item_6_spoiler)),
    (LocationName.julia_orbment_item_7,                                                         Data(1239,      "Character Gear",       RegionName.jade_corridor_arseille,              ItemName.shield_1,                                  LocationName.julia_orbment_item_7_spoiler)),
