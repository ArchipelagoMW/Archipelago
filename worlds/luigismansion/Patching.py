...
def update_observer_info(observer_info):
    ...
    # Adds an observer in Blackout Breaker room (event44) to turn on spikes on the doors when room flag 120 is on.
    observer_info.info_file_field_entries.append({
        "name": "observer",
        "code_name": "(null)",
        "string_arg0": "(null)",
    ...
    # Adds an observer in Blackout Breaker room (event44) to turn off spikes on the doors when room flag 120 is off.
    observer_info.info_file_field_entries.append({
        "name": "observer",
        "code_name": "(null)",
        "string_arg0": "(null)",
