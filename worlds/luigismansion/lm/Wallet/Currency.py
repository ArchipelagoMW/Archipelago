...
CURRENCIES: dict[int, Currency] = {
    CURRENCY_INDEX.COIN: Currency(CURRENCY_NAME.COINS, 0x324, 5000),
    CURRENCY_INDEX.BILLS: Currency(CURRENCY_NAME.BILLS, 0x328, 20000),
    CURRENCY_INDEX.GOLD_BARS: Currency(CURRENCY_NAME.GOLD_BARS, 0x32C, 100000),
    CURRENCY_INDEX.SAPPHIRE: Currency(CURRENCY_NAME.SAPPHIRE, 0x330, 500000),
    CURRENCY_INDEX.EMERALD: Currency(CURRENCY_NAME.EMERALD, 0x334, 800000),
    CURRENCY_INDEX.RUBY: Currency(CURRENCY_NAME.RUBY, 0x338, 1000000),
    CURRENCY_INDEX.DIAMOND: Currency(CURRENCY_NAME.DIAMOND, 0x33C, 2000000),
    CURRENCY_INDEX.GOLD_DIAMOND: Currency(CURRENCY_NAME.GOLD_DIAMOND, 0x344, 20000000),
    CURRENCY_INDEX.SMALL_PEARL: Currency(CURRENCY_NAME.SMALL_PEARL, 0x348, 50000),
    CURRENCY_INDEX.MEDIUM_PEARL: Currency(CURRENCY_NAME.MEDIUM_PEARL, 0x34C, 100000),
    CURRENCY_INDEX.LARGE_PEARL: Currency(CURRENCY_NAME.LARGE_PEARL, 0x350, 1000000),
}