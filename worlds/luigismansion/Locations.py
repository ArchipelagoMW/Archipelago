...
FURNITURE_LOCATION_TABLE: dict[str, LMLocationData] = {
    ...
    "Lydia's Vanity": LMLocationData("Master Bedroom", 159, "Furniture", 375, [], 34),
    ...
    "Chauncey's Crib": LMLocationData("Nursery", 167, "Furniture", 372, [], 26),
    ...
    "Clairvoya's Crystal Ball": LMLocationData("Fortune-Teller's Room", 231, "Furniture", 117, [], 3),
    ...
    "Melody's Piano": LMLocationData("Conservatory", 281, "Furniture", 130, [], 22),
    ...
    "Spooky's Dog Bowl": LMLocationData("Boneyard", 317, "Furniture", 97, [], 11),
    ...
    "Bogmire's Tombstone": LMLocationData("Graveyard", 321, "Furniture", 181, [], 15),  # Bogmire's
    ...
    "Nana's Yarn Balls": LMLocationData("Nana's Room", 401, "Furniture", 382, [], 49),
    ...
    "Slim's Pool Table": LMLocationData("Billiards Room", 409, "Furniture", 147, [], 12),
    ...
    "Sue Pea's Bed": LMLocationData("Guest Room", 578, "Furniture", 420, ["Water Element Medal"], 29),
    ...
    "Weston's Camp Gear": LMLocationData("Cold Storage", 591, "Furniture", 74, [], 64),
...
SPEEDY_LOCATION_TABLE: dict[str, LMLocationData] = {
    "Wardrobe Speedy Spirit": LMLocationData("Wardrobe", 643, "BSpeedy", 128, [], 38,
                                             room_ram_addr=0x803D5DC3, locationbit=0),
    "Study Speedy Spirit": LMLocationData("Study", 644, "BSpeedy", 113, [], 34,
    ...
    "Dining Room Speedy Spirit": LMLocationData("Dining Room", 649, "BSpeedy", 60, [], 9,
                                                room_ram_addr=0x803D5DC2, locationbit=1),
    "Kitchen Speedy Spirit": LMLocationData("Kitchen", 650, "BSpeedy", 66, [], 8,
                                            room_ram_addr=0x803D5DC2, locationbit=5),
    "Rec Room Speedy Spirit": LMLocationData("Rec Room", 651, "BSpeedy", 67, [], 22,
                                             room_ram_addr=0x803D5DC2, locationbit=7),
    "Nana's Room Speedy Spirit": LMLocationData("Nana's Room", 652, "BSpeedy", 115, [], 46,
    ...
    "Twins' Room Speedy Spirit": LMLocationData("Twins' Room", 655, "BSpeedy", 114, [], 25,
                                                room_ram_addr=0x803D5DC2, locationbit=3),
    "Breaker Room Speedy Spirit": LMLocationData("Breaker Room", 656, "BSpeedy", 7, [], 67,
                                                 room_ram_addr=0x803D5DC3, locationbit=2),
    "Cellar Speedy Spirit": LMLocationData("Cellar", 657, "BSpeedy", 6, [], 63,
                                           room_ram_addr=0x803D5DC3, locationbit=1),
    "Sealed Room Speedy Spirit": LMLocationData("Sealed Room", 658, "BSpeedy", 125, [], 36,
