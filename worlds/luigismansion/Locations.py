...
LIGHT_LOCATION_TABLE: dict[str, LMLocationData] = {
    ...
    "Basement Stairwell Light On": LMLocationData("Basement Stairwell", 778, "KingdomHearts", 0, [], 67,
...
WALK_LOCATION_TABLE: dict[str, LMLocationData] = {
    ...
    "East Attic Hallway Visited": LMLocationData("East Attic", 846, "Walk", 0, [], 54, room_ram_addr=0x803CDFB6),
    "West Attic Hallway Visited": LMLocationData("West Attic", 847, "Walk", 0, [], 57, room_ram_addr=0x803CDFB2),
