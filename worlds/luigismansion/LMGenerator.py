...
class LuigisMansionRandomizer:
    ...
    def save_randomized_iso(self):
        ...
        bool_pickup_anim_enabled: bool = True if int(self.output_data["Options"]["enable_pickup_animation"]) == 0 else False
        bool_fear_anim_disabled: bool = True if int(self.output_data["Options"]["enable_fear_animation"]) == 0 else False
