...
filler_items: Dict[str, LMItemData] = {
    ...
    "Poison Mushroom": LMItemData("Trap", 125, IC.trap,
        update_ram_addr=[LMRamData(0x804ddac0, ram_byte_size=4, item_count=5)]), # value of 5
    ...
    "Ice Trap": LMItemData("Trap", 131, IC.trap,
        update_ram_addr=[LMRamData(0x804ddac0, ram_byte_size=4, item_count=3)]), # value of
    "Banana Trap": LMItemData("Trap", 132, IC.trap,
        update_ram_addr=[LMRamData(0x804ddac0, ram_byte_size=4, item_count=2)]), # value of
