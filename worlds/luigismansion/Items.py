...
ITEM_TABLE: dict[str, LMItemData] = {
    ...
    "Fire Element Medal": LMItemData("Medal", 55, IC.progression, None, 0x803D5DB2, 5),
    "Water Element Medal": LMItemData("Medal", 56, IC.progression, None, 0x803D5DB2, 7),
    "Ice Element Medal": LMItemData("Medal", 57, IC.progression, None, 0x803D5DB2, 6),
    "Mario's Glove": LMItemData("Mario Item", 58, IC.progression, None, 0x803D5DBB, 6),
    "Mario's Hat": LMItemData("Mario Item", 59, IC.progression, None, 0x803D5DBB, 4),
    "Mario's Letter": LMItemData("Mario Item", 60, IC.progression, None, 0x803D5DBC, 0),
    "Mario's Star": LMItemData("Mario Item", 61, IC.progression, None, 0x803D5DBB, 5),
    "Mario's Shoe": LMItemData("Mario Item", 62, IC.progression, None, 0x803D5DBB, 7),
    "Boo Radar": LMItemData("Upgrade", 63, IC.progression, None), #TODO
    "Poltergust 4000": LMItemData("Upgrade", 64, IC.useful,None), #TODO
    "Gold Diamond": LMItemData("Money", 65, IC.progression, None), #TODO
}

BOO_ITEM_TABLE: dict[str, LMItemData] = {
    "Butler's Room Boo (PeekaBoo)": LMItemData("Boo", 66, IC.progression, None, 0x803D5E04, 0),
    "Hidden Room Boo (GumBoo)": LMItemData("Boo", 67, IC.progression, None, 0x803D5E04, 1),
    "Fortune Teller Boo (Booigi)": LMItemData("Boo", 68, IC.progression, None, 0x803D5E04, 2),
    "Mirror Room Boo (Kung Boo)": LMItemData("Boo", 69, IC.progression, None, 0x803D5E04, 3),
    "Laundry Room Boo (Boogie)": LMItemData("Boo", 70, IC.progression, None, 0x803D5E04, 4),
    "Kitchen Boo (Booligan)": LMItemData("Boo", 71, IC.progression, None, 0x803D5E04, 5),
    "Dining Room Boo (Boodacious)": LMItemData("Boo", 72, IC.progression, None, 0x803D5E04, 6),
    "Ball Room Boo (Boo La La)": LMItemData("Boo", 73, IC.progression, None, 0x803D5E04, 7),
    "Billiards Boo (Boohoo)": LMItemData("Boo", 74, IC.progression, None, 0x803D5E05, 0),
    "Projection Room Boo (ShamBoo)": LMItemData("Boo", 75, IC.progression, None, 0x803D5E05, 1),
    "Storage Room Boo (Game Boo)": LMItemData("Boo", 76, IC.progression, None, 0x803D5E05, 2),
    "Conservatory Boo (Boomeo)": LMItemData("Boo", 77, IC.progression, None, 0x803D5E05, 3),
    "Rec Room Boo (Booregard)": LMItemData("Boo", 78, IC.progression, None, 0x803D5E05, 4),
    "Nursery Boo (TurBoo)": LMItemData("Boo", 79, IC.progression, None, 0x803D5E05, 5),
    "Twin's Room Boo (Booris)": LMItemData("Boo", 80, IC.progression, None, 0x803D5E05, 6),
    "Sitting Room Boo (Boolivia)": LMItemData("Boo", 81, IC.progression, None, 0x803D5E05, 7),
    "Guest Room (Boonita)": LMItemData("Boo", 82, IC.progression, None, 0x803D5E06, 0),
    "Master Bedroom Boo (Boolicious)": LMItemData("Boo", 83, IC.progression, None, 0x803D5E06, 1),
    "Study Boo (TaBoo)": LMItemData("Boo", 84, IC.progression, None, 0x803D5E06, 2),
    "Parlor Boo (BamBoo)": LMItemData("Boo", 85, IC.progression, None, 0x803D5E06, 3),
    "Wardrobe Boo (GameBoo Advance)": LMItemData("Boo", 86, IC.progression, None, 0x803D5E06, 4),
    "Anteroom  Boo (Bootha)": LMItemData("Boo", 87, IC.progression, None, 0x803D5E06, 5),
    "Astral Boo (Boonswoggle)": LMItemData("Boo", 88, IC.progression, None, 0x803D5E06, 6),
    "Nana's Room (LamBooger)": LMItemData("Boo", 89, IC.progression, None, 0x803D5E06, 7),
    "Tea Room (Mr. Boojangles)": LMItemData("Boo", 90, IC.progression, None, 0x803D5E07, 0),
    "Armory Boo (Underboo)": LMItemData("Boo", 91, IC.progression, None, 0x803D5E07, 1),
    "Telephone Room Boo (Boomerang)": LMItemData("Boo", 92, IC.progression, None, 0x803D5E07, 2),
    "Safari Room Boo (Little Boo Peep)": LMItemData("Boo", 93, IC.progression, None, 0x803D5E07, 3),
    "Ceramics Studio (TamBoorine)": LMItemData("Boo", 94, IC.progression, None, 0x803D5E07, 4),
    "Clockwork Room Boo (Booscaster)": LMItemData("Boo", 95, IC.progression, None, 0x803D5E07, 5),
    "Artist's Studio Boo (Bootique)": LMItemData("Boo", 96, IC.progression, None, 0x803D5E07, 6),
    "Cold Storage Boo (Boolderdash)": LMItemData("Boo", 97, IC.progression, None, 0x803D5E07, 7),
    "Cellar Boo (Booripedes)": LMItemData("Boo", 98, IC.progression, None, 0x803D5E08, 0),
    "Pipe Room  Boo (Booffant)": LMItemData("Boo", 99, IC.progression, None, 0x803D5E08, 1),
    "Breaker Room Boo (Boo B. Hatch)": LMItemData("Boo", 100, IC.progression, None, 0x803D5E08, 2),
    "Boolossus Boo 1": LMItemData("Boo", 101, IC.progression, None, 0x803D5E08, 3),
    "Boolossus Boo 2": LMItemData("Boo", 102, IC.progression, None, 0x803D5E08, 4),
    "Boolossus Boo 3": LMItemData("Boo", 103, IC.progression, None, 0x803D5E08, 5),
    "Boolossus Boo 4": LMItemData("Boo", 104, IC.progression, None, 0x803D5E08, 6),
    "Boolossus Boo 5": LMItemData("Boo", 105, IC.progression, None, 0x803D5E08, 7),
    "Boolossus Boo 6": LMItemData("Boo", 107, IC.progression, None, 0x803D5E09, 0),
    "Boolossus Boo 7": LMItemData("Boo", 108, IC.progression, None, 0x803D5E09, 1),
    "Boolossus Boo 8": LMItemData("Boo", 109, IC.progression, None, 0x803D5E09, 2),
    "Boolossus Boo 9": LMItemData("Boo", 110, IC.progression, None, 0x803D5E09, 3),
    "Boolossus Boo 10": LMItemData("Boo", 111, IC.progression, None, 0x803D5E09, 4),
    "Boolossus Boo 11": LMItemData("Boo", 112, IC.progression, None, 0x803D5E09, 5),
    "Boolossus Boo 12": LMItemData("Boo", 113, IC.progression, None, 0x803D5E09, 6),
    "Boolossus Boo 13": LMItemData("Boo", 114, IC.progression, None, 0x803D5E09, 7),
    "Boolossus Boo 14": LMItemData("Boo", 115, IC.progression, None, 0x803D5E0A, 0),
    "Boolossus Boo 15": LMItemData("Boo", 116, IC.progression, None, 0x803D5E0A, 1),
}
