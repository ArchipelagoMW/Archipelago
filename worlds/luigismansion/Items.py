...
ITEM_TABLE: dict[str, LMItemData] = {
    ...
    "3F Right Hallway Key": LMItemData("Door Key", 49, IC.progression, 55, ram_addr=0x803D5E1A, itembit=7), #TODO West Safari Hallway Key
...
BOO_ITEM_TABLE: dict[str, LMItemData] = {
    ...
    "Guest Room (Boonita)": LMItemData("Boo", 82, IC.progression, ram_addr=0x803D5E06, itembit=0),
    ...
    "Tea Room (Mr. Boojangles)": LMItemData("Boo", 90, IC.progression, ram_addr=0x803D5E07, itembit=0),
    ...
    "Ceramics Studio (TamBoorine)": LMItemData("Boo", 94, IC.progression, ram_addr=0x803D5E07, itembit=4),
