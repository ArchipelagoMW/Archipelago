...
ITEM_TABLE: dict[str, LMItemData] = {
    "Heart Key": LMItemData("Door Key", 0, IC.progression, 3, [LMRamData(0x803D5E14), True, 3, 1]),
    "Club Key": LMItemData("Door Key", 1, IC.progression, 42, [LMRamData(0x803D5E19), True, 2, 1]),
    "Diamond Key": LMItemData("Door Key", 2, IC.progression, 59, [LMRamData(0x803D5E1B), True, 3, 1]),
    "Spade Key": LMItemData("Door Key", 3, IC.progression, 72, [LMRamData(0x803D5E1D), True, 0, 1]),
    "Parlor Key": LMItemData("Door Key", 4, IC.progression, 34, [LMRamData(0x803D5E18), True, 2, 1]),
    "Anteroom Key": LMItemData("Door Key", 5, IC.progression, 38, [LMRamData(0x803D5E18), True, 6, 1]),
    "Wardrobe Key": LMItemData("Door Key", 6, IC.progression, 43, [LMRamData(0x803D5E19), True, 3, 1]),
    "Family Hallway Key": LMItemData("Door Key", 7, IC.progression, 33, [LMRamData(0x803D5E18), True, 1, 1]),
    "Master Bedroom Key": LMItemData("Door Key", 8, IC.progression, 31, [LMRamData(0x803D5E17), True, 7, 1]),
    "Nursery Key": LMItemData("Door Key", 9, IC.progression, 27, [LMRamData(0x803D5E17), True, 3, 1]),
    "Twins Bedroom Key": LMItemData("Door Key", 10, IC.progression, 28, [LMRamData(0x803D5E17), True, 4, 1]),
    "Ballroom Key": LMItemData("Door Key", 11, IC.progression, 15, [LMRamData(0x803D5E15), True, 7, 1]),
    "Storage Room Key": LMItemData("Door Key", 12, IC.progression, 16, [LMRamData(0x803D5E16), True, 0, 1]),
    "Fortune Teller Key": LMItemData("Door Key", 13, IC.progression, 4, [LMRamData(0x803D5E14), True, 4, 1]),
    "Laundry Room Key": LMItemData("Door Key", 14, IC.progression, 7, [LMRamData(0x803D5E14), True, 7, 1]),
    "Lower 2F Stairwell Key": LMItemData("Door Key", 15, IC.progression, 74, [LMRamData(0x803D5E1D), True, 2, 1]),
    "Conservatory Key": LMItemData("Door Key", 16, IC.progression, 21, [LMRamData(0x803D5E16), True, 5, 1]),
    "Dining Room Key": LMItemData("Door Key", 17, IC.progression, 14, [LMRamData(0x803D5E15), True, 6, 1]),
    "North Rec Room Key": LMItemData("Door Key", 18, IC.progression, 25, [LMRamData(0x803D5E17), True, 1, 1]),
    "Billiards Key": LMItemData("Door Key", 19, IC.progression, 17, [LMRamData(0x803D5E16), True, 1, 1]),
    "Safari Room Key": LMItemData("Door Key", 20, IC.progression, 56, [LMRamData(0x803D5E1B), True, 0, 1]),
    "Balcony Key": LMItemData("Door Key", 21, IC.progression, 62, [LMRamData(0x803D5E1B), True, 6, 1]),
    "Cellar Key": LMItemData("Door Key", 23, IC.progression, 68, [LMRamData(0x803D5E1C), True, 4, 1]),
    "Clockwork Key": LMItemData("Door Key", 24, IC.progression, 53, [LMRamData(0x803D5E1A), True, 5, 1]),
    "Armory Key": LMItemData("Door Key", 25, IC.progression, 51, [LMRamData(0x803D5E1A), True, 3, 1]),
    "Sitting Room Key": LMItemData("Door Key", 26, IC.progression, 29, [LMRamData(0x803D5E17), True, 5, 1]),
    "Pipe Room Key": LMItemData("Door Key", 27, IC.progression, 69, [LMRamData(0x803D5E1C), True, 5, 1]),
    "Cold Storage Key": LMItemData("Door Key", 28, IC.progression, 65, [LMRamData(0x803D5E1C), True, 1, 1]),
    "Artist's Studio Key": LMItemData("Door Key", 29, IC.progression, 63, [LMRamData(0x803D5E1B), True, 7, 1]),
    "Wardrobe Balcony Key": LMItemData("Door Key", 30, IC.progression, 41, [LMRamData(0x803D5E19), True, 1, 1]),
    "Study Key": LMItemData("Door Key", 31, IC.progression, 32, [LMRamData(0x803D5E18), True, 0, 1]),
    "Basement Stairwell Key": LMItemData("Door Key", 32, IC.progression, 9, [LMRamData(0x803D5E15), True, 1, 1]),
    "1F Bathroom Key": LMItemData("Door Key", 33, IC.progression, 23, [LMRamData(0x803D5E16), True, 7, 1]),
    "1F Washroom Key": LMItemData("Door Key", 34, IC.progression, 20, [LMRamData(0x803D5E16), True, 4, 1]),
    "Kitchen Key": LMItemData("Door Key", 35, IC.progression, 11, [LMRamData(0x803D5E15), True, 3, 1]),
    "Boneyard Key": LMItemData("Door Key", 36, IC.progression, 10, [LMRamData(0x803D5E15), True, 2, 1]),
    "Projection Room Key": LMItemData("Door Key", 37, IC.progression, 18, [LMRamData(0x803D5E16), True, 2, 1]),
    "Mirror Room Key": LMItemData("Door Key", 38, IC.progression, 5, [LMRamData(0x803D5E14), True, 5, 1]),
    "Butler's Room Key": LMItemData("Door Key", 39, IC.progression, 1, [LMRamData(0x803D5E14), True, 1, 1]),
    "Tea Room Key": LMItemData("Door Key", 40, IC.progression, 47, [LMRamData(0x803D5E19), True, 7, 1]),
    "South Rec Room Key": LMItemData("Door Key", 41, IC.progression, 24, [LMRamData(0x803D5E17), True, 0, 1]),
    "Upper 2F Stairwell Key": LMItemData("Door Key", 42, IC.progression, 75, [LMRamData(0x803D5E1D), True, 3, 1]),
    "2F Bathroom Key": LMItemData("Door Key", 43, IC.progression, 48,[LMRamData(0x803D5E1A), True, 0, 1]),
    "2F Washroom Key": LMItemData("Door Key", 44, IC.progression, 45, [LMRamData(0x803D5E19), True, 5, 1]),
    "Nana's Room Key": LMItemData("Door Key", 45, IC.progression, 49, [LMRamData(0x803D5E1A), True, 1, 1]),
    "Astral Hall Key": LMItemData("Door Key", 46, IC.progression, 44, [LMRamData(0x803D5E19), True, 4, 1]),
    "Observatory Key": LMItemData("Door Key", 47, IC.progression, 40, [LMRamData(0x803D5E19), True, 0, 1]),
    "Guest Room Key": LMItemData("Door Key", 48, IC.progression, 30, [LMRamData(0x803D5E17), True, 6, 1]),
    "East Attic Hallway Key": LMItemData("Door Key", 49, IC.progression, 55, [LMRamData(0x803D5E1A), True, 7, 1]),
    "Telephone Room Key": LMItemData("Door Key", 50, IC.progression, 52, [LMRamData(0x803D5E1A), True, 4, 1]),
    "Ceramics Studio Key": LMItemData("Door Key", 51, IC.progression, 50, [LMRamData(0x803D5E1A), True, 2, 1]),
    "Breaker Room Key": LMItemData("Door Key", 52, IC.progression, 71, [LMRamData(0x803D5E1C), True, 7, 1]),
    "Basement Hallway Key": LMItemData("Door Key", 53, IC.progression, 67, [LMRamData(0x803D5E1C), True, 3, 1]),
    "Altar Hallway Key": LMItemData("Door Key", 54, IC.progression, 70, [LMRamData(0x803D5E1C), True, 6, 1]),
