...
ITEM_TABLE: dict[str, LMItemData] = {
    ...
    "Progressive Vacuum": LMItemData("Upgrade", 64, IC.useful, update_ram_addr=[LMRamData(0x80081CC8, item_count=0)]),
