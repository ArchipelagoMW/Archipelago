...
BOO_ITEM_TABLE: dict[str, LMItemData] = {
    "Butler's Room Boo (PeekaBoo)": LMItemData("Boo Item", 38, IC.progression),
    "Hidden Room Boo (GumBoo)": LMItemData("Boo Item", 64, IC.progression),
    "Fortune Teller Boo (Booigi)": LMItemData("Boo Item", 65, IC.progression),
    "Mirror Room Boo (Kung Boo)": LMItemData("Boo Item", 66, IC.progression),
    "Laundry Room Boo (Boogie)": LMItemData("Boo Item", 67, IC.progression),
    "Kitchen Boo (Booligan)": LMItemData("Boo Item", 68, IC.progression),
    "Dining Room Boo (Boodacious)": LMItemData("Boo Item", 69, IC.progression),
    "Ball Room Boo (Boo La La)": LMItemData("Boo Item", 70, IC.progression),
    "Billiards Boo (Boohoo)": LMItemData("Boo Item", 71, IC.progression),
    "Projection Room Boo (ShamBoo)": LMItemData("Boo Item", 72, IC.progression),
    "Storage Room Boo (Game Boo)": LMItemData("Boo Item", 73, IC.progression),
    "Conservatory Boo (Boomeo)": LMItemData("Boo Item", 74, IC.progression),
    "Rec Room Boo (Booregard)": LMItemData("Boo Item", 75, IC.progression),
    "Nursery Boo (TurBoo)": LMItemData("Boo Item", 76, IC.progression),
    "Twin's Room Boo (Booris)": LMItemData("Boo Item", 77, IC.progression),
    "Sitting Room Boo (Boolivia)": LMItemData("Boo Item", 78, IC.progression),
    "Guest Room (Boonita)": LMItemData("Boo Item", 79, IC.progression),
    "Master Bedroom Boo (Boolicious)": LMItemData("Boo Item", 80, IC.progression),
    "Study Boo (TaBoo)": LMItemData("Boo Item", 81, IC.progression),
    "Parlor Boo (BamBoo)": LMItemData("Boo Item", 82, IC.progression),
    "Wardrobe Boo (GameBoo Advance)": LMItemData("Boo Item", 83, IC.progression),
    "Anteroom  Boo (Bootha)": LMItemData("Boo Item", 84, IC.progression),
    "Astral Boo (Boonswoggle)": LMItemData("Boo Item", 85, IC.progression),
    "Nana's Room (LamBooger)": LMItemData("Boo Item", 86, IC.progression),
    "Tea Room (Mr. Boojangles)": LMItemData("Boo Item", 87, IC.progression),
    "Armory Boo (Underboo)": LMItemData("Boo Item", 88, IC.progression),
    "Telephone Room Boo (Boomerang)": LMItemData("Boo Item", 89, IC.progression),
    "Safari Room Boo (Little Boo Peep)": LMItemData("Boo Item", 90, IC.progression),
    "Ceramics Studio (TamBoorine)": LMItemData("Boo Item", 91, IC.progression),
    "Clockwork Room Boo (Booscaster)": LMItemData("Boo Item", 92, IC.progression),
    "Artist's Studio Boo (Bootique)": LMItemData("Boo Item", 93, IC.progression),
    "Cold Storage Boo (Boolderdash)": LMItemData("Boo Item", 94, IC.progression),
