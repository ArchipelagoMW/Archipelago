...
def create_regions(multiworld: MultiWorld, player: int):
    ...
    connect(multiworld, player, "Route 10 North", "Rock Tunnel 1F", lambda state: state.pokemon_rb_can_flash(player) or state.pokemon_rb_can_navigate_darkness(player))
    ...
    connect(multiworld, player, "Rock Tunnel 1F", "Route 10 South", lambda state: state.pokemon_rb_can_flash(player) or state.pokemon_rb_can_navigate_darkness(player))
    ...
    connect(multiworld, player, "Pokemon Tower 6F", "Pokemon Tower 7F", lambda state: state.pokemon_rb_can_pass_ghost(player))
