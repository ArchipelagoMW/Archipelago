...
location_data = [
    ...
    LocationData("Cerulean City", "Rocket Thief", "TM28 Dig", rom_addresses["Event_Rocket_Thief"],
                 Missable(6)),
    LocationData("Route 2-Southeast", "South Item", "Moon Stone", rom_addresses["Missable_Route_2_Item_1"],
                 Missable(25)),
    LocationData("Route 2-Southeast", "North Item", "HP Up", rom_addresses["Missable_Route_2_Item_2"], Missable(26)),
