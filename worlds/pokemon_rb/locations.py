...
class LocationData:
    ...
    def __init__(self, region, name, original_item, rom_address=None, ram_address=None, event=False, type="Item",
                 inclusion=always_on, level=None):
        self.region = region
        self.name = region.split("-")[0] + " - " + name if name != "Trainer Parties" else region + " - Trainer Parties"
...
location_data = [
    ...
    LocationData("Cerulean Bicycle Shop", "Bicycle Shop", "Bicycle", rom_addresses["Event_Bicycle_Shop"], EventFlag(192)),
    ...
    LocationData("Celadon City", "Stranded Man", "TM41 Soft-Boiled", rom_addresses["Event_Stranded_Man"],
                 EventFlag(384)),
    LocationData("Celadon Pokemart Roof", "Thirsty Girl Gets Water", "TM13 Ice Beam",
                 rom_addresses["Event_Thirsty_Girl_Water"], EventFlag(396)),
    LocationData("Celadon Pokemart Roof", "Thirsty Girl Gets Soda Pop", "TM48 Rock Slide",
                 rom_addresses["Event_Thirsty_Girl_Soda"], EventFlag(397)),
    LocationData("Celadon Pokemart Roof", "Thirsty Girl Gets Lemonade", "TM49 Tri Attack",
                 rom_addresses["Event_Thirsty_Girl_Lemonade"], EventFlag(398)),
    LocationData("Celadon Pokemart 3F", "Counter Man", "TM18 Counter", rom_addresses["Event_Counter"], EventFlag(399)),
    ...
    LocationData("Safari Zone Secret House", "Secret House", "HM03 Surf", rom_addresses["Event_Safari_Zone_Secret_House"], EventFlag(2176)),
    ...
    LocationData("S.S. Anne 1F Rooms-Two Trainers Room", "Lass", None, rom_addresses["Trainersanity_EVENT_BEAT_SS_ANNE_8_TRAINER_3_ITEM"], EventFlag(117), inclusion=trainersanity),
    LocationData("S.S. Anne 1F Rooms-Two Trainers Room", "Youngster", None, rom_addresses["Trainersanity_EVENT_BEAT_SS_ANNE_8_TRAINER_2_ITEM"], EventFlag(120), inclusion=trainersanity),
    ...
    LocationData("Route 10-N", "PokeManiac 1", None, rom_addresses["Trainersanity_EVENT_BEAT_ROUTE_10_TRAINER_0_ITEM"], EventFlag(311), inclusion=trainersanity),
    ...
    *[LocationData("Pokedex", mon, ball, rom_addresses["Dexsanity_Items"] + i, DexSanityFlag(i), type="Item",
    ...
    LocationData("Celadon Pokemart Roof", "Vending Machines", "Vending Machine Drinks", event=True),
    ...
    LocationData("Oak's Lab", "Starter 1", "Charmander", [rom_addresses["Starter1_A"],
    ...
    LocationData("Oak's Lab", "Starter 2", "Squirtle", [rom_addresses["Starter2_A"],
    ...
    LocationData("Oak's Lab", "Starter 3", "Bulbasaur", [rom_addresses["Starter3_A"],
...
trainer_data = {
    ...
    'Celadon Gym': [
        ...
        {'level': [29, 24, 29], 'party': ['Victreebel', 'Tangela', 'Vileplume'],
         'party_address': 'Trainer_Party_Erika_A'},], 'S.S. Anne Bow': [
 ...
 {'level': 29, 'party': ['Voltorb', 'Electrode'], 'party_address': 'Trainer_Party_Route_12_Rocker_A'}],
    ...
    'S.S. Anne 2F': [ ###
        ...
        {'level': [25, 23, 22, 20, 25], 'party': ['Pidgeotto', 'Exeggcute', 'Gyarados', 'Kadabra', 'Charmeleon'],
         'party_address': 'Trainer_Party_Pokemon_Tower_2F_Green2_C'}],
...
level_object_list = [(loc.name, loc.level) for loc in location_data if loc.type == "Wild Encounter" and loc.level is not None]
# wild_lists = []
# while wild_list:
...
for region in trainer_data:
    ...
    for trainer in party_loc.party_data:
        if isinstance(trainer["level"], int):
            level_object_list.append(((trainer["party_address"], 0), trainer["level"]))
        else:
            for i, level in enumerate(trainer["level"]):
                level_object_list.append(((trainer["party_address"], i), level))
