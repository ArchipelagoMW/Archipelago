...
location_data = [
    ...
    LocationData("Route 12-S", "Item Behind Cuttable Tree", "Iron", rom_addresses["Missable_Route_12_Item_2"], Missable(31)),
    ...
    LocationData("Silph Co 5F", "Southeast Item", "Card Key 2F", rom_addresses["Missable_Silph_Co_5F_Item_3"], Missable(157)),
    ...
    LocationData("Silph Co 7F-E", "East Item (Card Key)", "TM03 Swords Dance", rom_addresses["Missable_Silph_Co_7F_Item_2"],
                 Missable(169)),
    ...
    LocationData("Silph Co 3F-W", "Scientist (Card Key)", None, rom_addresses["Trainersanity_EVENT_BEAT_SILPH_CO_3F_TRAINER_1_ITEM"], EventFlag(72), inclusion=trainersanity),
    ...
    *[LocationData("Pokedex", mon, ball, rom_addresses["Dexsanity_Items"] + i, DexSanityFlag(i), type="Item",
    ...
    LocationData("Route 6", "Super Rod Pokemon - 2", "Shellder", rom_addresses["Wild_Super_Rod_D"] + 3, None,
                 event=True, type="Wild Encounter"),
    LocationData("Route 10-N", "Super Rod Pokemon - 1", "Poliwhirl", rom_addresses["Wild_Super_Rod_E"] + 1, None,
                 event=True, type="Wild Encounter"),
    LocationData("Route 10-N", "Super Rod Pokemon - 2", "Slowpoke", rom_addresses["Wild_Super_Rod_E"] + 3, None,
                 event=True, type="Wild Encounter"),
    ...
    LocationData("Safari Zone Center", "Super Rod Pokemon - 4", "Slowpoke", rom_addresses["Wild_Super_Rod_F"] + 7,
                 None, event=True, type="Wild Encounter"),
    LocationData("Route 12-N", "Super Rod Pokemon - 1", "Tentacool", rom_addresses["Wild_Super_Rod_G"] + 1,
                 None, event=True, type="Wild Encounter"),
    LocationData("Route 12-N", "Super Rod Pokemon - 2", "Krabby", rom_addresses["Wild_Super_Rod_G"] + 3,
                 None, event=True, type="Wild Encounter"),
    LocationData("Route 12-N", "Super Rod Pokemon - 3", "Goldeen", rom_addresses["Wild_Super_Rod_G"] + 5,
                 None, event=True, type="Wild Encounter"),
    LocationData("Route 12-N", "Super Rod Pokemon - 4", "Magikarp", rom_addresses["Wild_Super_Rod_G"] + 7,
                 None, event=True, type="Wild Encounter"),
    LocationData("Route 19-N", "Super Rod Pokemon - 1", "Staryu", rom_addresses["Wild_Super_Rod_H"] + 1,
                 None, event=True, type="Wild Encounter"),
    LocationData("Route 19-N", "Super Rod Pokemon - 2", "Horsea", rom_addresses["Wild_Super_Rod_H"] + 3,
                 None, event=True, type="Wild Encounter"),
    LocationData("Route 19-N", "Super Rod Pokemon - 3", "Shellder", rom_addresses["Wild_Super_Rod_H"] + 5,
                 None, event=True, type="Wild Encounter"),
    LocationData("Route 19-N", "Super Rod Pokemon - 4", "Goldeen", rom_addresses["Wild_Super_Rod_H"] + 7,
                 None, event=True, type="Wild Encounter"),
    LocationData("Route 23-C", "Super Rod Pokemon - 1", "Slowbro", rom_addresses["Wild_Super_Rod_I"] + 1,
                 None, event=True, type="Wild Encounter"),
    LocationData("Route 23-C", "Super Rod Pokemon - 2", "Seaking", rom_addresses["Wild_Super_Rod_I"] + 3,
                 None, event=True, type="Wild Encounter"),
    LocationData("Route 23-C", "Super Rod Pokemon - 3", "Kingler", rom_addresses["Wild_Super_Rod_I"] + 5,
                 None, event=True, type="Wild Encounter"),
    LocationData("Route 23-C", "Super Rod Pokemon - 4", "Seadra", rom_addresses["Wild_Super_Rod_I"] + 7,
                 None, event=True, type="Wild Encounter"),
