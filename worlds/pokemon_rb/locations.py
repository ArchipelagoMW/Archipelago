...
class LocationData:
    def __init__(self, region, name, original_item, rom_address=None, ram_address=None, rule=lambda state: True,
                 event=False, item_rule=lambda state: True, type="Item"):
        self.region = region
        if "Route" in region:
...
def get_locations(player=None):
    ...
    locations = [
        ...
        LocationData("Route 2 East", "Oak's Aide", "HM05 Flash", rom_addresses["Event_Route_2_Oaks_Aide"],
                     EventFlag(984), lambda state: state._pokemon_rb_has_pokemon(10, player)),
        ...
        LocationData("Route 11 East", "Oak's Aide", "Item Finder", rom_addresses["Event_Rt11_Oaks_Aide"],
                     EventFlag(1151), lambda state: state._pokemon_rb_has_pokemon(30, player)),
        ...
        LocationData("Route 15", "Oak's Aide", "Exp. All", rom_addresses["Event_Rt_15_Oaks_Aide"], EventFlag(1200), lambda state: state._pokemon_rb_has_pokemon(50, player)),
        ...
        LocationData("Pallet Town", "Super Rod Pokemon - 1", "Tentacool", rom_addresses["Wild_Super_Rod_A"] + 1, None,
                     rule=lambda state: state.has("Super Rod", player), event=True, type="Wild Encounter"),
        ...
        LocationData("Route 22", "Super Rod Pokemon - 2", "Poliwag", rom_addresses["Wild_Super_Rod_B"] + 3, None,
                     rule=lambda state: state.has("Super Rod", player), event=True, type="Wild Encounter"),
        LocationData("Cerulean City", "Super Rod Pokemon - 1", "Psyduck", rom_addresses["Wild_Super_Rod_C"] + 1, None,
                     rule=lambda state: state.has("Super Rod", player), event=True, type="Wild Encounter"),
        ...
        LocationData("Safari Zone Center", "Super Rod Pokemon - 1", "Dratini", rom_addresses["Wild_Super_Rod_F"] + 1,
                     None, rule=lambda state: state.has("Super Rod", player), event=True, type="Wild Encounter"),
        ...
        LocationData("Route 12 Grass", "Wild Pokemon - 10", ["Gloom", "Weepinbell"], rom_addresses["Wild_Route12"] + 19,
                     None, event=True, type="Wild Encounter"),
        LocationData("Route 8", "Wild Pokemon - 1", "Pidgey", rom_addresses["Wild_Route8"] + 1, None, event=True,
                     type="Wild Encounter"),
        LocationData("Route 8", "Wild Pokemon - 2", ["Mankey", "Meowth"], rom_addresses["Wild_Route8"] + 3, None,
                     event=True, type="Wild Encounter"),
        LocationData("Route 8", "Wild Pokemon - 3", ["Ekans", "Sandshrew"], rom_addresses["Wild_Route8"] + 5, None,
                     event=True, type="Wild Encounter"),
        LocationData("Route 8", "Wild Pokemon - 4", ["Growlithe", "Vulpix"], rom_addresses["Wild_Route8"] + 7, None,
                     event=True, type="Wild Encounter"),
        LocationData("Route 8", "Wild Pokemon - 5", "Pidgey", rom_addresses["Wild_Route8"] + 9, None, event=True,
                     type="Wild Encounter"),
        LocationData("Route 8", "Wild Pokemon - 6", ["Mankey", "Meowth"], rom_addresses["Wild_Route8"] + 11, None,
                     event=True, type="Wild Encounter"),
        LocationData("Route 8", "Wild Pokemon - 7", ["Ekans", "Sandshrew"], rom_addresses["Wild_Route8"] + 13, None,
                     event=True, type="Wild Encounter"),
        LocationData("Route 8", "Wild Pokemon - 8", ["Growlithe", "Vulpix"], rom_addresses["Wild_Route8"] + 15, None,
                     event=True, type="Wild Encounter"),
        LocationData("Route 8", "Wild Pokemon - 9", ["Growlithe", "Vulpix"], rom_addresses["Wild_Route8"] + 17, None,
                     event=True, type="Wild Encounter"),
        LocationData("Route 8", "Wild Pokemon - 10", ["Growlithe", "Vulpix"], rom_addresses["Wild_Route8"] + 19, None,
                     event=True, type="Wild Encounter"),
        ...
        LocationData("Route 15", "Wild Pokemon - 10", "Pidgeotto", rom_addresses["Wild_Route15"] + 19, None, event=True,
                     type="Wild Encounter"),
        LocationData("Route 16", "Wild Pokemon - 1", "Spearow", rom_addresses["Wild_Route16"] + 1, None, event=True,
                     type="Wild Encounter"),
        LocationData("Route 16", "Wild Pokemon - 2", "Spearow", rom_addresses["Wild_Route16"] + 3, None, event=True,
                     type="Wild Encounter"),
        LocationData("Route 16", "Wild Pokemon - 3", "Rattata", rom_addresses["Wild_Route16"] + 5, None, event=True,
                     type="Wild Encounter"),
        LocationData("Route 16", "Wild Pokemon - 4", "Doduo", rom_addresses["Wild_Route16"] + 7, None, event=True,
                     type="Wild Encounter"),
        LocationData("Route 16", "Wild Pokemon - 5", "Rattata", rom_addresses["Wild_Route16"] + 9, None, event=True,
                     type="Wild Encounter"),
        LocationData("Route 16", "Wild Pokemon - 6", "Doduo", rom_addresses["Wild_Route16"] + 11, None, event=True,
                     type="Wild Encounter"),
        LocationData("Route 16", "Wild Pokemon - 7", "Doduo", rom_addresses["Wild_Route16"] + 13, None, event=True,
                     type="Wild Encounter"),
        LocationData("Route 16", "Wild Pokemon - 8", "Rattata", rom_addresses["Wild_Route16"] + 15, None, event=True,
                     type="Wild Encounter"),
        LocationData("Route 16", "Wild Pokemon - 9", "Raticate", rom_addresses["Wild_Route16"] + 17, None, event=True,
                     type="Wild Encounter"),
        LocationData("Route 16", "Wild Pokemon - 10", "Raticate", rom_addresses["Wild_Route16"] + 19, None, event=True,
                     type="Wild Encounter"),
        ...
        LocationData("Safari Zone West", "Wild Pokemon - 10", "Kangaskhan", rom_addresses["Wild_SafariZoneWest"] + 19,
                     None, event=True, type="Wild Encounter"),
        LocationData("Route 20 West", "Wild Pokemon - 1", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 1, None,
                     event=True, type="Wild Encounter"),
        LocationData("Route 20 West", "Wild Pokemon - 2", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 3, None,
                     event=True, type="Wild Encounter"),
        LocationData("Route 20 West", "Wild Pokemon - 3", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 5, None,
                     event=True, type="Wild Encounter"),
        LocationData("Route 20 West", "Wild Pokemon - 4", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 7, None,
                     event=True, type="Wild Encounter"),
        LocationData("Route 20 West", "Wild Pokemon - 5", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 9, None,
                     event=True, type="Wild Encounter"),
        LocationData("Route 20 West", "Wild Pokemon - 6", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 11, None,
                     event=True, type="Wild Encounter"),
        LocationData("Route 20 West", "Wild Pokemon - 7", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 13, None,
                     event=True, type="Wild Encounter"),
        LocationData("Route 20 West", "Wild Pokemon - 8", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 15, None,
                     event=True, type="Wild Encounter"),
        LocationData("Route 20 West", "Wild Pokemon - 9", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 17, None,
                     event=True, type="Wild Encounter"),
        LocationData("Route 20 West", "Wild Pokemon - 10", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 19, None,
                     event=True, type="Wild Encounter"),
        ...
        LocationData("Anywhere", "Good Rod Pokemon - 1", "Goldeen", rom_addresses["Wild_Good_Rod"] + 1, None,
                     rule=lambda state: state.has("Good Rod", player), event=True, type="Wild Encounter"),
        ...
        LocationData("Celadon Prize Corner", "Pokemon Prize - 2", "Clefairy", rom_addresses["Prize_Mon_B"], None,
                     rule=lambda state: state.has("Coin Case", player), event=True, type="Wild Encounter"),
        LocationData("Celadon Prize Corner", "Pokemon Prize - 3", ["Nidorina", "Nidorino"], rom_addresses["Prize_Mon_C"], None,
                     rule=lambda state: state.has("Coin Case", player), event=True, type="Wild Encounter"),
        LocationData("Celadon Prize Corner", "Pokemon Prize - 4", ["Dratini", "Pinsir"], rom_addresses["Prize_Mon_D"], None,
                     rule=lambda state: state.has("Coin Case", player), event=True, type="Wild Encounter"),
        LocationData("Celadon Prize Corner", "Pokemon Prize - 5", ["Scyther", "Dratini"], rom_addresses["Prize_Mon_E"], None,
                     rule=lambda state: state.has("Coin Case", player), event=True, type="Wild Encounter"),
        LocationData("Celadon Prize Corner", "Pokemon Prize - 6", "Porygon", rom_addresses["Prize_Mon_F"], None,
                     rule=lambda state: state.has("Coin Case", player), event=True, type="Wild Encounter"),
        # LocationData("Evolution", "Ivysaur", "Ivysaur", None, None, rule=lambda state: state.has("Bulbasaur", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Venusaur", "Venusaur", None, None, rule=lambda state: state.has("Ivysaur", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Charmeleon", "Charmeleon", None, None,
        #              rule=lambda state: state.has("Charmander", player), event=True, type="Evolution"),
        # LocationData("Evolution", "Charizard", "Charizard", None, None,
        #              rule=lambda state: state.has("Charmeleon", player), event=True, type="Evolution"),
        # LocationData("Evolution", "Wartortle", "Wartortle", None, None,
        #              rule=lambda state: state.has("Squirtle", player), event=True, type="Evolution"),
        # LocationData("Evolution", "Blastoise", "Blastoise", None, None,
        #              rule=lambda state: state.has("Wartortle", player), event=True, type="Evolution"),
        # LocationData("Evolution", "Metapod", "Metapod", None, None, rule=lambda state: state.has("Caterpie", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Butterfree", "Butterfree", None, None,
        #              rule=lambda state: state.has("Metapod", player), event=True, type="Evolution"),
        # LocationData("Evolution", "Kakuna", "Kakuna", None, None, rule=lambda state: state.has("Weedle", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Beedrill", "Beedrill", None, None, rule=lambda state: state.has("Kakuna", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Pidgeotto", "Pidgeotto", None, None, rule=lambda state: state.has("Pidgey", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Pidgeot", "Pidgeot", None, None, rule=lambda state: state.has("Pidgeotto", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Raticate", "Raticate", None, None, rule=lambda state: state.has("Rattata", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Fearow", "Fearow", None, None, rule=lambda state: state.has("Spearow", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Arbok", "Arbok", None, None, rule=lambda state: state.has("Ekans", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Raichu", "Raichu", None, None, rule=lambda state: state.has("Pikachu", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Sandslash", "Sandslash", None, None,
        #              rule=lambda state: state.has("Sandshrew", player), event=True, type="Evolution"),
        # LocationData("Evolution", "Nidorina", "Nidorina", None, None, rule=lambda state: state.has("Nidoran F", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Nidoqueen", "Nidoqueen", None, None,
        #              rule=lambda state: state.has("Nidorina", player), event=True, type="Evolution"),
        # LocationData("Evolution", "Nidorino", "Nidorino", None, None, rule=lambda state: state.has("Nidoran M", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Nidoking", "Nidoking", None, None, rule=lambda state: state.has("Nidorino", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Cledable", "Cledable", None, None, rule=lambda state: state.has("Clefairy", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Ninetales", "Ninetales", None, None, rule=lambda state: state.has("Vulpix", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Wigglytuff", "Wigglytuff", None, None,
        #              rule=lambda state: state.has("Jigglypuff", player), event=True, type="Evolution"),
        # LocationData("Evolution", "Golbat", "Golbat", None, None, rule=lambda state: state.has("Zubat", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Gloom", "Gloom", None, None, rule=lambda state: state.has("Oddish", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Vileplume", "Vileplume", None, None, rule=lambda state: state.has("Gloom", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Parasect", "Parasect", None, None, rule=lambda state: state.has("Paras", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Venomoth", "Venomoth", None, None, rule=lambda state: state.has("Venonat", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Dugtrio", "Dugtrio", None, None, rule=lambda state: state.has("Diglett", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Persian", "Persian", None, None, rule=lambda state: state.has("Meowth", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Golduck", "Golduck", None, None, rule=lambda state: state.has("Psyduck", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Primeape", "Primeape", None, None, rule=lambda state: state.has("Mankey", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Arcanine", "Arcanine", None, None, rule=lambda state: state.has("Growlithe", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Poliwhirl", "Poliwhirl", None, None, rule=lambda state: state.has("Poliwag", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Poliwrath", "Poliwrath", None, None,
        #              rule=lambda state: state.has("Poliwhirl", player), event=True, type="Evolution")
        # LocationData("Evolution", "Kadabra", "Kadabra", None, None, rule=lambda state: state.has("Abra", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Alakazam", "Alakazam", None, None, rule=lambda state: state.has("Kadabra", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Machoke", "Machoke", None, None, rule=lambda state: state.has("Machop", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Machamp", "Machamp", None, None, rule=lambda state: state.has("Machoke", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Weepinbell", "Weepinbell", None, None,
        #              rule=lambda state: state.has("Bellsprout", player), event=True, type="Evolution"),
        # LocationData("Evolution", "Victreebel", "Victreebel", None, None,
        #              rule=lambda state: state.has("Weepinbell", player), event=True, type="Evolution"),
        # LocationData("Evolution", "Tentacruel", "Tentacruel", None, None,
        #              rule=lambda state: state.has("Tentacool", player), event=True, type="Evolution"),
        # LocationData("Evolution", "Graveler", "Graveler", None, None, rule=lambda state: state.has("Geodude", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Golem", "Golem", None, None, rule=lambda state: state.has("Graveler", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Rapidash", "Rapidash", None, None, rule=lambda state: state.has("Ponyta", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Slowbro", "Slowbro", None, None, rule=lambda state: state.has("Slowpoke", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Magneton", "Magneton", None, None, rule=lambda state: state.has("Magnemite", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Dodrio", "Dodrio", None, None, rule=lambda state: state.has("Doduo", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Dewdong", "Dewdong", None, None, rule=lambda state: state.has("Seel", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Muk", "Muk", None, None, rule=lambda state: state.has("Grimer", player), event=True,
        #              type="Evolution"),
        # LocationData("Evolution", "Cloyster", "Cloyster", None, None, rule=lambda state: state.has("Shellder", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Haunter", "Haunter", None, None, rule=lambda state: state.has("Gastly", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Gengar", "Gengar", None, None, rule=lambda state: state.has("Haunter", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Hypno", "Hypno", None, None, rule=lambda state: state.has("Drowzee", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Kingler", "Kingler", None, None, rule=lambda state: state.has("Krabby", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Electrode", "Electrode", None, None, rule=lambda state: state.has("Voltorb", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Exeggutor", "Exeggutor", None, None,
        #              rule=lambda state: state.has("Exeggcute", player), event=True, type="Evolution"),
        # LocationData("Evolution", "Marowak", "Marowak", None, None, rule=lambda state: state.has("Cubone", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Weezing", "Weezing", None, None, rule=lambda state: state.has("Koffing", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Rhydon", "Rhydon", None, None, rule=lambda state: state.has("Rhyhorn", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Seadra", "Seadra", None, None, rule=lambda state: state.has("Horsea", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Seaking", "Seaking", None, None, rule=lambda state: state.has("Goldeen", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Starmie", "Starmie", None, None, rule=lambda state: state.has("Staryu", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Gyarados", "Gyarados", None, None, rule=lambda state: state.has("Magikarp", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Vaporeon", "Vaporeon", None, None, rule=lambda state: state.has("Eevee", player) and state.has("Water Stone"),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Jolteon", "Jolteon", None, None, rule=lambda state: state.has("Eevee", player) and state.has("Thunder Stone"),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Flareon", "Flareon", None, None, rule=lambda state: state.has("Eevee", player and state.has("Fire Stone")),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Omastar", "Omastar", None, None, rule=lambda state: state.has("Omanyte", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Kabutops", "Kabutops", None, None, rule=lambda state: state.has("Kabuto", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Dragonair", "Dragonair", None, None, rule=lambda state: state.has("Dratini", player),
        #              event=True, type="Evolution"),
        # LocationData("Evolution", "Dragonite", "Dragonite", None, None,
        #              rule=lambda state: state.has("Dragonair", player), event=True, type="Evolution")

]
    # from .poke_data import id_to_mon
    # with open("C:\\src\\pokered\\pokered.gbc", "rb") as file:
    #     data = bytearray(file.read())
    # with open("C:\\src\\loc.txt") as file:
    #     text = file.read()
    # for loc, line in zip(thing, text.split("\n")):
    #     address = loc.original_item
    #     pokemon = data[address]
    #     pokemon = id_to_mon[pokemon]
    #     line = f", \"{pokemon}\", rom_addresses".join(line.split(", rom_addresses"))
    #     print(line)
    # breakpoint()
