...
def get_locations(player=None):
    ...
    locations = [
        ...
        LocationData("Rocket Hideout B3F", "Hidden Item Near Item", "Nugget", rom_addresses['Hidden_Item_Rocket_Hideout_B3F'], Hidden(10), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
