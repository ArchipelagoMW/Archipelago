...
def get_locations(player=None):
    locations = [
        ...
        LocationData("Viridian City", "Sleepy Guy", "TM42 Dream Eater", rom_addresses["Event_Sleepy_Guy"],
                     EventFlag(41), lambda state: state.pokemon_rb_can_cut(player) or state.pokemon_rb_can_surf(player)),
        ...
        LocationData("Route 2 East", "Oak's Aide", "HM05 Flash", rom_addresses["Event_Route_2_Oaks_Aide"],
                     EventFlag(984), lambda state: state.pokemon_rb_has_pokemon(state.world.oaks_aide_rt_2[player].value + 5, player)),
        LocationData("Pewter City", "Museum", "Old Amber", rom_addresses["Event_Museum"], EventFlag(105), lambda state: state.pokemon_rb_can_cut(player)),
        ...
        LocationData("Vermilion Gym", "Lt. Surge 2", "TM24 Thunderbolt", rom_addresses["Event_Vermillion_Gym"],
                     EventFlag(358), lambda state: state.pokemon_rb_can_cut(player or state.pokemon_rb_can_surf(player))),
        ...
        LocationData("Route 11 East", "Oak's Aide", "Item Finder", rom_addresses["Event_Rt11_Oaks_Aide"],
                     EventFlag(1151), lambda state: state.pokemon_rb_has_pokemon(state.world.oaks_aide_rt_11[player].value + 5, player)),
        LocationData("Celadon City", "Stranded Man", "TM41 Soft Boiled", rom_addresses["Event_Stranded_Man"],
                     EventFlag(384), lambda state: state.pokemon_rb_can_surf(player)),
        ...
        LocationData("Fossil", "Choice A", "Dome Fossil",
                     ...
                     lambda state: state.pokemon_rb_fossil_checks(player)),
        ...
        LocationData("Route 25", "Item", "TM19 Seismic Toss", rom_addresses["Missable_Route_25_Item"], Missable(38), lambda state: state.pokemon_rb_can_cut(player)),
        ...
        LocationData("Fuchsia City", "Warden's House Item", "Rare Candy", rom_addresses["Missable_Wardens_House_Item"],
                     Missable(71), lambda state: state.pokemon_rb_can_strength(player)),
        ...
        LocationData("Rocket Hideout B4F", "Giovanni Item", "Silph Scope",
                     rom_addresses["Missable_Rocket_Hideout_B4F_Item_4"], [EventFlag(0x6A7), Missable(135)], lambda state: state.has("Lift Key", player)),
        ...
        LocationData("Safari Zone Center", "Island Item", "Nugget", rom_addresses["Missable_Safari_Zone_Center_Item"],
                     Missable(205), lambda state: state.pokemon_rb_can_surf(player)),
        ...
        LocationData("Cerulean Cave 2F", "Southwest Item", "Ultra Ball", rom_addresses["Missable_Cerulean_Cave_2F_Item_2"],
                     Missable(207), lambda state: state.pokemon_rb_can_surf(player)),
        LocationData("Cerulean Cave 2F", "North Item", "Full Restore", rom_addresses["Missable_Cerulean_Cave_2F_Item_3"],
                     Missable(208), lambda state: state.pokemon_rb_can_surf(player)),
        ...
        LocationData("Cerulean Cave B1F", "North Item", "Max Revive", rom_addresses["Missable_Cerulean_Cave_B1F_Item_2"],
                     Missable(211)),
        LocationData("Victory Road 1F", "Left Item", "TM43 Sky Attack", rom_addresses["Missable_Victory_Road_1F_Item_1"],
                     Missable(212)),
        LocationData("Victory Road 1F", "Top Item", "Rare Candy", rom_addresses["Missable_Victory_Road_1F_Item_2"],
                     Missable(213)),
        ...
        LocationData("Viridian Forest", "Hidden Item Northwest by Trainer", "Potion", rom_addresses['Hidden_Item_Viridian_Forest_1'], Hidden(0), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Viridian Forest", "Hidden Item Entrance Tree", "Antidote", rom_addresses['Hidden_Item_Viridian_Forest_2'], Hidden(1), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Mt Moon B2F", "Hidden Item Dead End Before Fossils", "Moon Stone", rom_addresses['Hidden_Item_MtMoonB2F_1'], Hidden(2), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Route 25", "Hidden Item Fence Outside Bill's House", "Ether", rom_addresses['Hidden_Item_Route_25_1'], Hidden(3), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Route 9", "Hidden Item Rock By Grass", "Ether", rom_addresses['Hidden_Item_Route_9'], Hidden(4), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("S.S. Anne 1F", "Hidden Item Kitchen Trash", "Great Ball", rom_addresses['Hidden_Item_SS_Anne_Kitchen'], Hidden(5), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("S.S. Anne B1F", "Hidden Item Under Pillow", "Hyper Potion", rom_addresses['Hidden_Item_SS_Anne_B1F'], Hidden(6), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Route 10 North", "Hidden Item Behind Rock Tunnel Entrance Bush", "Super Potion", rom_addresses['Hidden_Item_Route_10_1'], Hidden(7), lambda state: state.pokemon_rb_can_get_hidden_items(player) and state.pokemon_rb_can_cut(player)),
        LocationData("Route 10 South", "Hidden Item Rock", "Max Ether", rom_addresses['Hidden_Item_Route_10_2'], Hidden(8), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Rocket Hideout B1F", "Hidden Item Pot Plant", "PP Up", rom_addresses['Hidden_Item_Rocket_Hideout_B1F'], Hidden(9), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Rocket Hideout B3F", "Hidden Item Near East Item", "Nugget", rom_addresses['Hidden_Item_Rocket_Hideout_B3F'], Hidden(10), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Rocket Hideout B4F", "Hidden Item Behind Giovanni", "Super Potion", rom_addresses['Hidden_Item_Rocket_Hideout_B4F'], Hidden(11), lambda state: state.pokemon_rb_can_get_hidden_items(player) and state.has("Lift Key", player)),
        LocationData("Pokemon Tower 5F", "Hidden Item Near West Staircase", "Elixir", rom_addresses['Hidden_Item_Pokemon_Tower_5F'], Hidden(12), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        ...
        LocationData("Copycat's House", "Hidden Item Desk", "Nugget", rom_addresses['Hidden_Item_Copycats_House'], Hidden(20), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Cerulean Cave 1F", "Hidden Item Center Rocks", "Rare Candy", rom_addresses['Hidden_Item_Cerulean_Cave_1F'], Hidden(21), lambda state: state.pokemon_rb_can_get_hidden_items(player) and state.pokemon_rb_can_surf(player)),
        LocationData("Cerulean Cave B1F", "Hidden Item Northeast Rocks", "Ultra Ball", rom_addresses['Hidden_Item_Cerulean_Cave_B1F'], Hidden(22), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Power Plant", "Hidden Item Central Dead End", "Max Elixir", rom_addresses['Hidden_Item_Power_Plant_1'], Hidden(23), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Power Plant", "Hidden Item Before Zapdos", "PP Up", rom_addresses['Hidden_Item_Power_Plant_2'], Hidden(24), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Seafoam Islands B2F", "Hidden Item Rock", "Nugget", rom_addresses['Hidden_Item_Seafoam_Islands_B2F'], Hidden(25), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Seafoam Islands B4F", "Hidden Item Corner Island", "Ultra Ball", rom_addresses['Hidden_Item_Seafoam_Islands_B4F'], Hidden(26), lambda state: state.pokemon_rb_can_get_hidden_items(player) and state.pokemon_rb_can_surf(player)),
        LocationData("Pokemon Mansion 1F", "Hidden Item Block Near Entrance Carpet", "Moon Stone", rom_addresses['Hidden_Item_Pokemon_Mansion_1F'], Hidden(27), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Pokemon Mansion 3F", "Hidden Item Behind Burglar", "Max Revive", rom_addresses['Hidden_Item_Pokemon_Mansion_3F'], Hidden(28), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Route 23 North", "Hidden Item Rocks Before Final Guard", "Full Restore", rom_addresses['Hidden_Item_Route_23_1'], Hidden(29), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Route 23 North", "Hidden Item East Tree After Water", "Ultra Ball", rom_addresses['Hidden_Item_Route_23_2'], Hidden(30), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Route 23 South", "Hidden Item On Island", "Max Ether", rom_addresses['Hidden_Item_Route_23_3'], Hidden(31), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Victory Road 2F", "Hidden Item Rock Before Moltres", "Ultra Ball", rom_addresses['Hidden_Item_Victory_Road_2F_1'], Hidden(32), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Victory Road 2F", "Hidden Item Rock In Final Room", "Full Restore", rom_addresses['Hidden_Item_Victory_Road_2F_2'], Hidden(33), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        #LocationData("Vermilion City", "Hidden Item The Truck", "Max Elixir", rom_addresses['Hidden_Item_Unused_6F'], Hidden(34), lambda state: state.pokemon_rb_can_get_hidden_items(player) and state.pokemon_rb_can_surf(player) and state.has("S.S. Ticket", player)),
        LocationData("Viridian City", "Hidden Item Cuttable Tree", "Potion", rom_addresses['Hidden_Item_Viridian_City'], Hidden(35), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Route 11", "Hidden Item Isolated Tree Near Gate", "Potion", rom_addresses['Hidden_Item_Route_11'], Hidden(36), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Route 12 West", "Hidden Item Tree Near Gate", "Hyper Potion", rom_addresses['Hidden_Item_Route_12'], Hidden(37), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Route 17", "Hidden Item In Grass", "Rare Candy", rom_addresses['Hidden_Item_Route_17_1'], Hidden(38), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Route 17", "Hidden Item Near Northernmost Sign", "Full Restore", rom_addresses['Hidden_Item_Route_17_2'], Hidden(39), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Route 17", "Hidden Item East Center", "PP Up", rom_addresses['Hidden_Item_Route_17_3'], Hidden(40), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Route 17", "Hidden Item West Center", "Max Revive", rom_addresses['Hidden_Item_Route_17_4'], Hidden(41), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Route 17", "Hidden Item Before Final Bridge", "Max Elixir", rom_addresses['Hidden_Item_Route_17_5'], Hidden(42), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Underground Tunnel North-South", "Hidden Item Near Northern Stairs", "Full Restore", rom_addresses['Hidden_Item_Underground_Path_NS_1'], Hidden(43), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Underground Tunnel North-South", "Hidden Item Near Southern Stairs", "X Special", rom_addresses['Hidden_Item_Underground_Path_NS_2'], Hidden(44), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Underground Tunnel West-East", "Hidden Item West", "Nugget", rom_addresses['Hidden_Item_Underground_Path_WE_1'], Hidden(45), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Underground Tunnel West-East", "Hidden Item East", "Elixir", rom_addresses['Hidden_Item_Underground_Path_WE_2'], Hidden(46), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Celadon City", "Hidden Item Dead End Near Cuttable Bush", "PP Up", rom_addresses['Hidden_Item_Celadon_City'], Hidden(47), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Route 25", "Hidden Item Northeast Of Grass", "Elixir", rom_addresses['Hidden_Item_Route_25_2'], Hidden(48), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Mt Moon B2F", "Hidden Item Lone Rock", "Ether", rom_addresses['Hidden_Item_MtMoonB2F_2'], Hidden(49), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Seafoam Islands B3F", "Hidden Item Rock", "Max Elixir", rom_addresses['Hidden_Item_Seafoam_Islands_B3F'], Hidden(50), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Vermilion City", "Hidden Item In Water Near Fan Club", "Max Ether", rom_addresses['Hidden_Item_Vermilion_City'], Hidden(51), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Cerulean City", "Hidden Item Gym Badge Guy's Backyard", "Rare Candy", rom_addresses['Hidden_Item_Cerulean_City'], Hidden(52), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        LocationData("Route 4", "Hidden Item Plateau East Of Mt Moon", "Great Ball", rom_addresses['Hidden_Item_Route_4'], Hidden(53), lambda state: state.pokemon_rb_can_get_hidden_items(player)),
        ...
        LocationData("Route 16 North", "Wild Pokemon - 9", "Raticate", rom_addresses["Wild_Route16"] + 17, None, event=True,
                     type="Wild Encounter"),
        LocationData("Route 16 North", "Wild Pokemon - 10", "Raticate", rom_addresses["Wild_Route16"] + 19, None, event=True,
                     type="Wild Encounter"),
        ...
        LocationData("Celadon Prize Corner", "Pokemon Prize - 1", "Abra", [rom_addresses["Prize_Mon_A"],
                     rom_addresses["Prize_Mon_A2"]], None, rule=lambda state: state.has("Coin Case", player),
                     event=True, type="Wild Encounter"),
        LocationData("Celadon Prize Corner", "Pokemon Prize - 2", "Clefairy", [rom_addresses["Prize_Mon_B"],
                     rom_addresses["Prize_Mon_B2"]], None, rule=lambda state: state.has("Coin Case", player),
                     event=True, type="Wild Encounter"),
        LocationData("Celadon Prize Corner", "Pokemon Prize - 3", ["Nidorina", "Nidorino"], [rom_addresses["Prize_Mon_C"],
                     rom_addresses["Prize_Mon_C2"]], None, rule=lambda state: state.has("Coin Case", player),
                     event=True, type="Wild Encounter"),
        LocationData("Celadon Prize Corner", "Pokemon Prize - 4", ["Dratini", "Pinsir"],[rom_addresses["Prize_Mon_D"],
                     rom_addresses["Prize_Mon_D2"]], None, rule=lambda state: state.has("Coin Case", player),
                     event=True, type="Wild Encounter"),
        LocationData("Celadon Prize Corner", "Pokemon Prize - 5", ["Scyther", "Dratini"], [rom_addresses["Prize_Mon_E"],
                     rom_addresses["Prize_Mon_E2"]], None, rule=lambda state: state.has("Coin Case", player),
                     event=True, type="Wild Encounter"),
        LocationData("Celadon Prize Corner", "Pokemon Prize - 6", "Porygon", [rom_addresses["Prize_Mon_F"],
                     rom_addresses["Prize_Mon_F2"]], None, rule=lambda state: state.has("Coin Case", player),
                     event=True, type="Wild Encounter"),
        ...
        LocationData("Seafoam Islands B4F", "Legendary Pokemon", "Articuno", rom_addresses["Static_Encounter_Articuno"],
                     None, event=True, type="Legendary Pokemon", rule=lambda state: state.pokemon_rb_can_strength(player)),
        ...
        LocationData("Vermilion City", "Legendary Pokemon", "Mew", rom_addresses["Static_Encounter_Mew"],
                     None, event=True, type="Legendary Pokemon", rule=lambda state: state.pokemon_rb_can_surf(player) and state.has("S.S. Ticket", player)),
]
