...
class LocationData:
    ...
    def __init__(self, region, name, original_item, rom_address=None, ram_address=None, event=False, type="Item",
                 inclusion=always_on, level=None, level_after=False):
        self.region = region
        self.name = region.split("-")[0] + " - " + name
...
location_data = [
    ...
    LocationData("Route 11 Gate", "Oak's Aide", "Item Finder", rom_addresses["Event_Rt11_Oaks_Aide"],
                 EventFlag(1151)),
    ...
    LocationData("Silph Co 11F-C", "Silph Co President (Card Key)", "Master Ball", rom_addresses["Event_Silph_Co_President"],
                 EventFlag(1933)),
    ...
    LocationData("Route 15 Gate", "Oak's Aide", "Exp. All", rom_addresses["Event_Rt_15_Oaks_Aide"], EventFlag(1200)),
    ...
    LocationData("Saffron Gym-C", "Sabrina 2", "TM46 Psywave", rom_addresses["Event_Saffron_Gym"], EventFlag(864)),
    ...
    LocationData("Route 4-East", "Item", "TM04 Whirlwind", rom_addresses["Missable_Route_4_Item"], Missable(27)),
    ...
    LocationData("Rocket Hideout B1F-SW", "Southwest Item", "Hyper Potion",
    ...
    LocationData("Silph Co 4F-W", "Left Item (Card Key)", "Full Heal", rom_addresses["Missable_Silph_Co_4F_Item_1"],
                 Missable(148)),
    LocationData("Silph Co 4F-W", "Middle Item (Card Key)", "Max Revive", rom_addresses["Missable_Silph_Co_4F_Item_2"],
                 Missable(149)),
    LocationData("Silph Co 4F-W", "Right Item (Card Key)", "Escape Rope", rom_addresses["Missable_Silph_Co_4F_Item_3"],
                 Missable(150)),
    LocationData("Silph Co 5F-SW", "Southwest Item", "TM09 Take Down", rom_addresses["Missable_Silph_Co_5F_Item_1"],
                 Missable(155)),
    LocationData("Silph Co 5F-NW", "Northwest Item (Card Key)", "Protein", rom_addresses["Missable_Silph_Co_5F_Item_2"], Missable(156)),
    LocationData("Silph Co 5F", "Southeast Item", "Card Key", rom_addresses["Missable_Silph_Co_5F_Item_3"], Missable(157)),
    LocationData("Silph Co 6F-SW", "Southwest Top Item (Card Key)", "HP Up", rom_addresses["Missable_Silph_Co_6F_Item_1"], Missable(161)),
    LocationData("Silph Co 6F-SW", "Southwest Bottom Item (Card Key)", "X Accuracy", rom_addresses["Missable_Silph_Co_6F_Item_2"],
                 Missable(162)),
    ...
    LocationData("Saffron Gym-C", "Sabrina 1", "Marsh Badge", rom_addresses['Badge_Saffron_Gym'], EventFlag(0x8A5)),
    ...
    LocationData("Silph Co 9F-SW", "Hidden Item Nurse Bed (Card Key)", "Max Potion", rom_addresses['Hidden_Item_Silph_Co_9F'], Hidden(19), inclusion=hidden_items),
    ...
    LocationData("Route 23-C", "Hidden Item Rocks Before Victory Road", "Full Restore", rom_addresses['Hidden_Item_Route_23_1'], Hidden(29), inclusion=hidden_items),
    LocationData("Route 23-C", "Hidden Item East Bush After Water", "Ultra Ball", rom_addresses['Hidden_Item_Route_23_2'], Hidden(30), inclusion=hidden_items),
    ...
    LocationData("Cerulean City-Badge House Backyard", "Hidden Item", "Rare Candy", rom_addresses['Hidden_Item_Cerulean_City'], Hidden(52), inclusion=hidden_items),
    LocationData("Route 4-East", "Hidden Item Plateau East Of Mt Moon", "Great Ball", rom_addresses['Hidden_Item_Route_4'], Hidden(53), inclusion=hidden_items),
    ...
    LocationData("Silph Co 11F-W", "Rocket 2 (Card Key)", None, rom_addresses["Trainersanity_EVENT_BEAT_SILPH_CO_11F_TRAINER_0_ITEM"], EventFlag(46), inclusion=trainersanity),
    ...
    LocationData("Silph Co 9F-NW", "Rocket 2 (Card Key)", None, rom_addresses["Trainersanity_EVENT_BEAT_SILPH_CO_9F_TRAINER_0_ITEM"], EventFlag(51), inclusion=trainersanity),
    ...
    LocationData("Silph Co 7F", "Rocket 3-SE", None, rom_addresses["Trainersanity_EVENT_BEAT_SILPH_CO_7F_TRAINER_3_ITEM"], EventFlag(55), inclusion=trainersanity),
    ...
    LocationData("Rocket Hideout B1F-SW", "Rocket 3", None, rom_addresses["Trainersanity_EVENT_BEAT_ROCKET_HIDEOUT_1_TRAINER_3_ITEM"], EventFlag(96), inclusion=trainersanity),
    LocationData("Rocket Hideout B1F-SW", "Rocket 4", None, rom_addresses["Trainersanity_EVENT_BEAT_ROCKET_HIDEOUT_1_TRAINER_2_ITEM"], EventFlag(97), inclusion=trainersanity),
    LocationData("Rocket Hideout B1F-SE", "Rocket 5 (Lift Key)", None, rom_addresses["Trainersanity_EVENT_BEAT_ROCKET_HIDEOUT_1_TRAINER_4_ITEM"], EventFlag(95), inclusion=trainersanity),
    ...
    LocationData("Route 18-East", "Bird Keeper 1", None, rom_addresses["Trainersanity_EVENT_BEAT_ROUTE_18_TRAINER_2_ITEM"], EventFlag(200), inclusion=trainersanity),
    LocationData("Route 18-East", "Bird Keeper 2", None, rom_addresses["Trainersanity_EVENT_BEAT_ROUTE_18_TRAINER_1_ITEM"], EventFlag(201), inclusion=trainersanity),
    LocationData("Route 18-East", "Bird Keeper 3", None, rom_addresses["Trainersanity_EVENT_BEAT_ROUTE_18_TRAINER_0_ITEM"], EventFlag(202), inclusion=trainersanity),
    ...
    LocationData("Route 10-North", "PokeManiac 1", None, rom_addresses["Trainersanity_EVENT_BEAT_ROUTE_10_TRAINER_0_ITEM"], EventFlag(311), inclusion=trainersanity),
    ...
    LocationData("Route 10-South", "PokeManiac 2", None, rom_addresses["Trainersanity_EVENT_BEAT_ROUTE_10_TRAINER_2_ITEM"], EventFlag(309), inclusion=trainersanity),
    ...
    *[LocationData("Pokedex", mon, ball, rom_addresses["Dexsanity_Items"] + i, DexSanityFlag(i), type="Item",
    ...
    LocationData("Route 4-East", "Wild Pokemon - 1", "Rattata", rom_addresses["Wild_Route4"] + 1, None, event=True,
                 type="Wild Encounter", level=10),
    LocationData("Route 4-East", "Wild Pokemon - 2", "Spearow", rom_addresses["Wild_Route4"] + 3, None, event=True,
                 type="Wild Encounter", level=10),
    LocationData("Route 4-East", "Wild Pokemon - 3", "Rattata", rom_addresses["Wild_Route4"] + 5, None, event=True,
                 type="Wild Encounter", level=8),
    LocationData("Route 4-East", "Wild Pokemon - 4", ["Ekans", "Sandshrew"], rom_addresses["Wild_Route4"] + 7, None,
                 event=True, type="Wild Encounter", level=6),
    LocationData("Route 4-East", "Wild Pokemon - 5", "Spearow", rom_addresses["Wild_Route4"] + 9, None, event=True,
                 type="Wild Encounter", level=8),
    LocationData("Route 4-East", "Wild Pokemon - 6", ["Ekans", "Sandshrew"], rom_addresses["Wild_Route4"] + 11, None,
                 event=True, type="Wild Encounter", level=10),
    LocationData("Route 4-East", "Wild Pokemon - 7", "Rattata", rom_addresses["Wild_Route4"] + 13, None, event=True,
                 type="Wild Encounter", level=12),
    LocationData("Route 4-East", "Wild Pokemon - 8", "Spearow", rom_addresses["Wild_Route4"] + 15, None, event=True,
                 type="Wild Encounter", level=12),
    LocationData("Route 4-East", "Wild Pokemon - 9", ["Ekans", "Sandshrew"], rom_addresses["Wild_Route4"] + 17, None,
                 event=True, type="Wild Encounter", level=8),
    LocationData("Route 4-East", "Wild Pokemon - 10", ["Ekans", "Sandshrew"], rom_addresses["Wild_Route4"] + 19, None,
                 event=True, type="Wild Encounter", level=12),
    ...
    LocationData("Route 17", "Wild Pokemon - 10", "Fearow", rom_addresses["Wild_Route17"] + 19, None, event=True,
                 type="Wild Encounter", level=27),
    LocationData("Route 18-East", "Wild Pokemon - 1", "Spearow", rom_addresses["Wild_Route18"] + 1, None, event=True,
                 type="Wild Encounter", level=20),
    LocationData("Route 18-East", "Wild Pokemon - 2", "Spearow", rom_addresses["Wild_Route18"] + 3, None, event=True,
                 type="Wild Encounter", level=22),
    LocationData("Route 18-East", "Wild Pokemon - 3", "Raticate", rom_addresses["Wild_Route18"] + 5, None, event=True,
                 type="Wild Encounter", level=25),
    LocationData("Route 18-East", "Wild Pokemon - 4", "Doduo", rom_addresses["Wild_Route18"] + 7, None, event=True,
                 type="Wild Encounter", level=24),
    LocationData("Route 18-East", "Wild Pokemon - 5", "Fearow", rom_addresses["Wild_Route18"] + 9, None, event=True,
                 type="Wild Encounter", level=25),
    LocationData("Route 18-East", "Wild Pokemon - 6", "Doduo", rom_addresses["Wild_Route18"] + 11, None, event=True,
                 type="Wild Encounter", level=26),
    LocationData("Route 18-East", "Wild Pokemon - 7", "Doduo", rom_addresses["Wild_Route18"] + 13, None, event=True,
                 type="Wild Encounter", level=28),
    LocationData("Route 18-East", "Wild Pokemon - 8", "Raticate", rom_addresses["Wild_Route18"] + 15, None, event=True,
                 type="Wild Encounter", level=29),
    LocationData("Route 18-East", "Wild Pokemon - 9", "Fearow", rom_addresses["Wild_Route18"] + 17, None, event=True,
                 type="Wild Encounter", level=27),
    LocationData("Route 18-East", "Wild Pokemon - 10", "Fearow", rom_addresses["Wild_Route18"] + 19, None, event=True,
                 type="Wild Encounter", level=29),
    ...
    LocationData("Safari Zone West", "Wild Pokemon - 10", "Kangaskhan", rom_addresses["Wild_SafariZoneWest"] + 19,
                 None, event=True, type="Wild Encounter", level=28),
    LocationData("Route 20-Water", "Surf Pokemon - 1", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 1, None,
                 event=True, type="Wild Encounter", level=5),
    LocationData("Route 20-Water", "Surf Pokemon - 2", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 3, None,
                 event=True, type="Wild Encounter", level=10),
    LocationData("Route 20-Water", "Surf Pokemon - 3", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 5, None,
                 event=True, type="Wild Encounter", level=15),
    LocationData("Route 20-Water", "Surf Pokemon - 4", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 7, None,
                 event=True, type="Wild Encounter", level=5),
    LocationData("Route 20-Water", "Surf Pokemon - 5", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 9, None,
                 event=True, type="Wild Encounter", level=10),
    LocationData("Route 20-Water", "Surf Pokemon - 6", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 11, None,
                 event=True, type="Wild Encounter", level=15),
    LocationData("Route 20-Water", "Surf Pokemon - 7", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 13, None,
                 event=True, type="Wild Encounter", level=20),
    LocationData("Route 20-Water", "Surf Pokemon - 8", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 15, None,
                 event=True, type="Wild Encounter", level=30),
    LocationData("Route 20-Water", "Surf Pokemon - 9", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 17, None,
                 event=True, type="Wild Encounter", level=35),
    LocationData("Route 20-Water", "Surf Pokemon - 10", "Tentacool", rom_addresses["Wild_SeaRoutes"] + 19, None,
    ...
    LocationData("Route 23-C", "Wild Pokemon - 1", ["Ekans", "Sandshrew"], rom_addresses["Wild_Route23"] + 1,
                 None, event=True, type="Wild Encounter", level=26),
    LocationData("Route 23-C", "Wild Pokemon - 2", "Ditto", rom_addresses["Wild_Route23"] + 3, None, event=True,
                 type="Wild Encounter", level=33),
    LocationData("Route 23-C", "Wild Pokemon - 3", "Spearow", rom_addresses["Wild_Route23"] + 5, None,
                 event=True, type="Wild Encounter", level=26),
    LocationData("Route 23-C", "Wild Pokemon - 4", "Fearow", rom_addresses["Wild_Route23"] + 7, None,
                 event=True, type="Wild Encounter", level=38),
    LocationData("Route 23-C", "Wild Pokemon - 5", "Ditto", rom_addresses["Wild_Route23"] + 9, None, event=True,
                 type="Wild Encounter", level=38),
    LocationData("Route 23-C", "Wild Pokemon - 6", "Fearow", rom_addresses["Wild_Route23"] + 11, None,
                 event=True, type="Wild Encounter", level=38),
    LocationData("Route 23-C", "Wild Pokemon - 7", ["Arbok", "Sandslash"], rom_addresses["Wild_Route23"] + 13,
                 None, event=True, type="Wild Encounter", level=41),
    LocationData("Route 23-C", "Wild Pokemon - 8", "Ditto", rom_addresses["Wild_Route23"] + 15, None,
                 event=True, type="Wild Encounter", level=43),
    LocationData("Route 23-C", "Wild Pokemon - 9", "Fearow", rom_addresses["Wild_Route23"] + 17, None,
                 event=True, type="Wild Encounter", level=41),
    LocationData("Route 23-C", "Wild Pokemon - 10", "Fearow", rom_addresses["Wild_Route23"] + 19, None,
                 event=True, type="Wild Encounter", level=43),
    ...
    LocationData("Anywhere", "Old Rod Pokemon", "Magikarp", rom_addresses["Wild_Old_Rod"] + 1, None,
                 event=True, type="Wild Encounter"), #, level=5, level_after=True),
    ...
    LocationData("Route 2 Gate", "Marcel Trade", "Mr Mime", rom_addresses["Trade_Marcel"] + 1, None, event=True,
                 type="Static Pokemon"),
    LocationData("Underground Path North South", "Spot Trade", "Nidoran F", rom_addresses["Trade_Spot"] + 1, None,
                 event=True, type="Static Pokemon"),
    LocationData("Route 11 Gate", "Terry Trade", "Nidorina", rom_addresses["Trade_Terry"] + 1, None, event=True,
                 type="Static Pokemon"),
    LocationData("Route 18 Gate", "Marc Trade", "Lickitung", rom_addresses["Trade_Marc"] + 1, None, event=True,
                 type="Static Pokemon"),
...
wild_list = [loc for loc in location_data if loc.type == "Wild Encounter" and loc.level is not None ]
wild_lists = []
while wild_list:
    wild_lists.append(wild_list[:10])
    wild_list = wild_list[10:]
wild_lists.sort(key=lambda wild_list: sum([loc.level for loc in wild_list]))
wild_list = sum(wild_lists, [])
wild_level_list = [loc.level for loc in wild_list]
wild_name_list = [loc.name for loc in wild_list]
...
trainer_data = {
    ...
    'Mt Moon 1F': [{'level': 10, 'party': ['Rattata', 'Rattata', 'Zubat'],
                   ...
                   {'level': 10, 'party': ['Geodude', 'Geodude', 'Onix'],
                    'party_address': 'Trainer_Party_Mt_Moon_1F_Hiker_A'}], 'S.S. Anne 1F': [
        {'level': 21, 'party': ['Nidoran M'], 'party_address': 'Trainer_Party_SS_Anne_1F_Rooms_Youngster_A'},
        {'level': 18, 'party': ['Pidgey', 'Nidoran F'], 'party_address': 'Trainer_Party_SS_Anne_1F_Rooms_Lass_A'},
    ...
    'Celadon Gym': [
        ...
        {'level': 24, 'party': ['Weepinbell', 'Gloom', 'Ivysaur'],
         'party_address': 'Trainer_Party_Celadon_Gym_CooltrainerF_A'}], 'S.S. Anne 3F': [
    ...
    'S.S. Anne B1F': [{'level': 21, 'party': ['Shellder'], 'party_address': 'Trainer_Party_SS_Anne_B1F_Rooms_Sailor_A'},
    ...
    'Route 12-South': [{'level': 29, 'party': ['Nidoran M', 'Nidorino'], 'party_address': 'Trainer_Party_Route_12_JrTrainerM_A'},
 {'level': 29, 'party': ['Voltorb', 'Electrode'], 'party_address': 'Trainer_Party_Route_12_Rocker_A'}],
    ...
    'Cerulean Gym': [{'level': 19, 'party': ['Goldeen'], 'party_address': 'Trainer_Party_Cerulean_Gym_JrTrainerF_A'},
                     {'level': 16, 'party': ['Horsea', 'Shellder'],
                      'party_address': 'Trainer_Party_Cerulean_Gym_Swimmer_A'}], 'Route 10': [
    ...
    'Rock Tunnel B1F': [{'level': 21, 'party': ['Jigglypuff', 'Pidgey', 'Meowth'],
    ...
    'Route 20-West': [{'level': 31, 'party': ['Goldeen', 'Seaking'], 'party_address': 'Trainer_Party_Route_20_JrTrainerF_A'},
                 ...
                 {'level': 30, 'party': ['Fearow', 'Fearow', 'Pidgeotto'],
                  'party_address': 'Trainer_Party_Route_20_BirdKeeper_A'}], 'Rock Tunnel 1F': [
    ...
    'Victory Road 2F': [{'level': 40, 'party': ['Charmeleon', 'Lapras', 'Lickitung'],
        ...
        {'level': 12, 'party': ['Zubat', 'Ekans'], 'party_address': 'Trainer_Party_Mt_Moon_B2F_Rocket_C'},
        {'level': 16, 'party': ['Raticate'], 'party_address': 'Trainer_Party_Mt_Moon_B2F_Rocket_D'}], 'Cinnabar Gym': [
    ...
    'Mansion 3F': [{'level': 38, 'party': ['Ninetales'], 'party_address': 'Trainer_Party_Mansion_3F_Burglar_A'},
                   {'level': 33, 'party': ['Magnemite', 'Magneton', 'Voltorb'],
                    'party_address': 'Trainer_Party_Mansion_3F_Scientist_A'}], 'Mansion B1F': [
    ...
    'Route 19': [{'level': 30, 'party': ['Tentacool', 'Shellder'], 'party_address': 'Trainer_Party_Route_19_Swimmer_A'},
                 ...
                 {'level': 29, 'party': ['Staryu', 'Staryu', 'Staryu'],
                  'party_address': 'Trainer_Party_Route_19_Beauty_C'}], 'Saffron Gym': [
    ...
    'Route 18-East': [{'level': 29, 'party': ['Spearow', 'Fearow'], 'party_address': 'Trainer_Party_Route_18_BirdKeeper_A'},
                 {'level': 34, 'party': ['Dodrio'], 'party_address': 'Trainer_Party_Route_18_BirdKeeper_B'},
                 {'level': 26, 'party': ['Spearow', 'Spearow', 'Fearow', 'Spearow'],
                  'party_address': 'Trainer_Party_Route_18_BirdKeeper_C'}], 'Fighting Dojo': [
    ...
    'Pallet Town': [{'level': 5, 'party': ['Squirtle'], 'party_address': 'Trainer_Party_Pallet_Town_Green1_A'},
                    {'level': 5, 'party': ['Bulbasaur'], 'party_address': 'Trainer_Party_Pallet_Town_Green1_B'},
                    {'level': 5, 'party': ['Charmander'], 'party_address': 'Trainer_Party_Pallet_Town_Green1_C'}],
    'Route 22': [{'level': [9, 8], 'party': ['Pidgey', 'Squirtle'], 'party_address': 'Trainer_Party_Route_22_Green1_A'},
                 {'level': [9, 8], 'party': ['Pidgey', 'Bulbasaur'],
                  'party_address': 'Trainer_Party_Route_22_Green1_B'},
                 {'level': [9, 8], 'party': ['Pidgey', 'Charmander'],
                  'party_address': 'Trainer_Party_Route_22_Green1_C'}, {'level': [47, 45, 45, 47, 50, 53],
                                                                        'party': ['Pidgeot', 'Rhyhorn', 'Growlithe',
                                                                                  'Exeggcute', 'Alakazam', 'Blastoise'],
                                                                        'party_address': 'Trainer_Party_Route_22_Green2_A'},
                 {'level': [47, 45, 45, 47, 50, 53],
                  'party': ['Pidgeot', 'Rhyhorn', 'Gyarados', 'Growlithe', 'Alakazam', 'Venusaur'],
                  'party_address': 'Trainer_Party_Route_22_Green2_B'}, {'level': [47, 45, 45, 47, 50, 53],
                                                                        'party': ['Pidgeot', 'Rhyhorn', 'Exeggcute',
                                                                                  'Gyarados', 'Alakazam', 'Charizard'],
                                                                        'party_address': 'Trainer_Party_Route_22_Green2_C'}],
    'Cerulean City': [{'level': [18, 15, 15, 17], 'party': ['Pidgeotto', 'Abra', 'Rattata', 'Squirtle'],
                       'party_address': 'Trainer_Party_Cerulean_City_Green1_A'},
                      {'level': [18, 15, 15, 17], 'party': ['Pidgeotto', 'Abra', 'Rattata', 'Bulbasaur'],
                       'party_address': 'Trainer_Party_Cerulean_City_Green1_B'},
                      {'level': [18, 15, 15, 17], 'party': ['Pidgeotto', 'Abra', 'Rattata', 'Charmander'],
                       'party_address': 'Trainer_Party_Cerulean_City_Green1_C'},
                      {'level': 17, 'party': ['Machop', 'Drowzee'],
                       'party_address': 'Trainer_Party_Cerulean_City_Rocket_A'}], 'Mansion 1F': [
        {'level': 29, 'party': ['Electrode', 'Weezing'], 'party_address': 'Trainer_Party_Mansion_1F_Scientist_A'}],
    'Silph Co. 2F': [{'level': 26, 'party': ['Grimer', 'Weezing', 'Koffing', 'Weezing'],
                      'party_address': 'Trainer_Party_Silph_Co_2F_Scientist_A'},
                     {'level': 28, 'party': ['Magnemite', 'Voltorb', 'Magneton'],
                     ...
                     {'level': 25, 'party': ['Golbat', 'Zubat', 'Zubat', 'Raticate', 'Zubat'],
                      'party_address': 'Trainer_Party_Silph_Co_2F_Rocket_B'}], 'Silph Co. 3F': [
        {'level': 29, 'party': ['Electrode', 'Weezing'], 'party_address': 'Trainer_Party_Silph_Co_3F_Scientist_A'},
        {'level': 28, 'party': ['Raticate', 'Hypno', 'Raticate'],
         'party_address': 'Trainer_Party_Silph_Co_3F_Rocket_A'}],
    'Silph Co. 4F': [{'level': 33, 'party': ['Electrode'], 'party_address': 'Trainer_Party_Silph_Co_4F_Scientist_A'},
                     {'level': 29, 'party': ['Machop', 'Drowzee'],
    ...
    'Silph Co. 7F': [
        ...
        {'level': [37, 38, 35, 35, 40], 'party': ['Pidgeot', 'Growlithe', 'Exeggcute', 'Alakazam', 'Blastoise'],
         'party_address': 'Trainer_Party_Silph_Co_7F_Green2_A'},
        {'level': [37, 38, 35, 35, 40], 'party': ['Pidgeot', 'Gyarados', 'Growlithe', 'Alakazam', 'Venusaur'],
         'party_address': 'Trainer_Party_Silph_Co_7F_Green2_B'},
        {'level': [37, 38, 35, 35, 40], 'party': ['Pidgeot', 'Exeggcute', 'Gyarados', 'Alakazam', 'Charizard'],
         'party_address': 'Trainer_Party_Silph_Co_7F_Green2_C'}], 'Silph Co. 8F': [
    ...
    'Rocket Hideout B4F': [{'level': [25, 24, 29], 'party': ['Onix', 'Rhyhorn', 'Kangaskhan'],
        ...
        {'level': 32, 'party': ['Cubone', 'Drowzee', 'Marowak'],
         'party_address': 'Trainer_Party_Silph_Co_11F_Rocket_B'}], 'Game Corner': [
    ...
    'Pokemon Tower 7F': [{'level': 25, 'party': ['Zubat', 'Zubat', 'Golbat'],
        ...
        {'level': [38, 37, 38, 43], 'party': ['Kadabra', 'Mr_Mime', 'Venomoth', 'Alakazam'],
         'party_address': 'Trainer_Party_Sabrina_A'},
        {'level': [54, 53, 54, 56, 56], 'party': ['Dewgong', 'Cloyster', 'Slowbro', 'Jynx', 'Lapras'],
        ...
        {'level': [58, 56, 56, 60, 62], 'party': ['Gyarados', 'Dragonair', 'Dragonair', 'Aerodactyl', 'Dragonite'],
         'party_address': 'Trainer_Party_Lance_A'}], 'SS Anne 2F': [
        {'level': [19, 16, 18, 20], 'party': ['Pidgeotto', 'Raticate', 'Kadabra', 'Wartortle'],
         'party_address': 'Trainer_Party_SS_Anne_2F_Green2_A'},
        {'level': [19, 16, 18, 20], 'party': ['Pidgeotto', 'Raticate', 'Kadabra', 'Ivysaur'],
         'party_address': 'Trainer_Party_SS_Anne_2F_Green2_B'},
        {'level': [19, 16, 18, 20], 'party': ['Pidgeotto', 'Raticate', 'Kadabra', 'Charmeleon'],
         'party_address': 'Trainer_Party_SS_Anne_2F_Green2_C'}], 'Pokemon Tower 2F': [
        {'level': [25, 23, 22, 20, 25], 'party': ['Pidgeotto', 'Growlithe', 'Exeggcute', 'Kadabra', 'Wartortle'],
         'party_address': 'Trainer_Party_Pokemon_Tower_2F_Green2_A'},
        {'level': [25, 23, 22, 20, 25], 'party': ['Pidgeotto', 'Gyarados', 'Growlithe', 'Kadabra', 'Ivysaur'],
         'party_address': 'Trainer_Party_Pokemon_Tower_2F_Green2_B'},
        {'level': [25, 23, 22, 20, 25], 'party': ['Pidgeotto', 'Exeggcute', 'Gyarados', 'Kadabra', 'Charmeleon'],
         'party_address': 'Trainer_Party_Pokemon_Tower_2F_Green2_C'}], 'Indigo Plateau': [
        {'level': [61, 59, 61, 61, 63, 65],
         'party': ['Pidgeot', 'Alakazam', 'Rhydon', 'Arcanine', 'Exeggutor', 'Blastoise'],
         'party_address': 'Trainer_Party_Indigo_Plateau_Green3_A'}, {'level': [61, 59, 61, 61, 63, 65],
                                                                     'party': ['Pidgeot', 'Alakazam', 'Rhydon',
                                                                               'Gyarados', 'Arcanine', 'Venusaur'],
                                                                     'party_address': 'Trainer_Party_Indigo_Plateau_Green3_B'},
        {'level': [61, 59, 61, 61, 63, 65],
         'party': ['Pidgeot', 'Alakazam', 'Rhydon', 'Exeggutor', 'Gyarados', 'Charizard'],
         'party_address': 'Trainer_Party_Indigo_Plateau_Green3_C'}], 'Pokemon Tower 3F': [
...
for region in trainer_data:
    party_loc = LocationData(region, "Trainer Parties", "Trainer Parties", event=True, type="Trainer Party")
    party_loc.party_data = trainer_data[region]
    for trainer in party_loc.party_data:
        if isinstance(trainer["level"], int):
            trainer_list.append(((trainer["party_address"], 0), trainer["level"]))
        else:
            for i, level in enumerate(trainer["level"]):
                trainer_list.append(((trainer["party_address"], i), level))
trainer_list.sort(key=lambda trainer: trainer[1])
trainer_level_list = [trainer[1] for trainer in trainer_list]
trainer_list = [trainer[0] for trainer in trainer_list]
...
class PokemonRBLocation(Location):
    ...
    def __init__(self, player, name, address, rom_address, type, level):
