...
warp_data = {'Celadon City': [{'address': 'Warps_CeladonCity', 'id': 0, 'to': {'map': 'Celadon Pokemart 1F', 'id': (0, 1)}},
             ...
             'Pewter City': [{'address': 'Warps_PewterCity', 'id': 0, 'to': {'map': 'Pewter Museum 1F', 'id': (0, 1)}},
                             ...
                             {'address': 'Warps_PewterCity', 'id': 3, 'to': {'map': 'Pewter Nidoran House', 'id': (0, 1)}},
                             {'address': 'Warps_PewterCity', 'id': 4, 'to': {'map': 'Pewter Pokemart', 'id': (0, 1)}},
                             {'address': 'Warps_PewterCity', 'id': 5, 'to': {'map': 'Pewter Speech House', 'id': (0, 1)}},
                             {'address': 'Warps_PewterCity', 'id': 6, 'to': {'map': 'Pewter Pokemon Center', 'id': (0, 1)}}],
             'Cerulean City': [
             ...
             'Silph Co 5F': [{'address': 'Warps_SilphCo5F', 'id': 0, 'to': {'map': 'Silph Co 6F', 'id': 1}},
                             ...
                             {'address': 'Warps_SilphCo5F', 'id': 3, 'to': {'map': 'Silph Co 7F', 'id': 5}},
        ...
        {'address': 'Warps_FuchsiaMart', 'id': (0, 1), 'to': {'map': 'Fuchsia City', 'id': 0}}],
             ...
             "Diglett's Cave Route 2": [
                 {'address': 'Warps_DiglettsCaveRoute2', 'id': (0, 1), 'to': {'map': 'Route 2', 'id': 0}},
             ...
             'Route 7 Gate': [{'address': 'Warps_Route7Gate', 'id': (0, 1), 'to': {'map': 'Route 7', 'id': 3}},
                              {'address': 'Warps_Route7Gate', 'id': (2, 3), 'to': {'map': 'Route 7', 'id': (0, 1)}}],
             'Route 8 Gate': [{'address': 'Warps_Route8Gate', 'id': (0, 1), 'to': {'map': 'Route 8', 'id': (0, 1)}},
                              {'address': 'Warps_Route8Gate', 'id': (2, 3), 'to': {'map': 'Route 8', 'id': (2, 3)}}],
             ...
             'Power Plant': [{'address': 'Warps_PowerPlant', 'id': (0, 1), 'to': {'map': 'Route 10', 'id': 3}},
                             {'address': 'Warps_PowerPlant', 'id': 2, 'to': {'map': 'Route 10', 'id': 3}}],
             ...
             'Pokemon Mansion 1F': [
                 ...
                 {'address': 'Warps_PokemonMansion1F', 'id': (0, 1, 2, 3), 'to': {'map': 'Cinnabar Island', 'id': 0}}],
             'Pokemon Mansion 1F-SE': [
                 {'address': 'Warps_PokemonMansion1F', 'id': 5, 'to': {'map': 'Pokemon Mansion B1F', 'id': 0}},
                 {'address': 'Warps_PokemonMansion1F', 'id': (6, 7), 'to': {'map': 'Cinnabar Island', 'id': 0}}], #255
             'Pokemon Mansion 2F': [
             ...
             'Pokemon Mansion 2F-C': [],
             'Pokemon Mansion 3F': [
                 {'address': 'Warps_PokemonMansion3F', 'id': 1, 'to': {'map': 'Pokemon Mansion 2F', 'id': 3}}],
             'Pokemon Mansion 3F-SE': [
                 {'address': 'Warps_PokemonMansion3F', 'id': 2, 'to': {'map': 'Pokemon Mansion 2F', 'id': 2}}],
             'Pokemon Mansion 3F-SW': [
                 {'address': 'Warps_PokemonMansion3F', 'id': 0, 'to': {'map': 'Pokemon Mansion 2F', 'id': 1}}],
             'Pokemon Mansion B1F': [
                 {'address': 'Warps_PokemonMansionB1F', 'id': 0, 'to': {'map': 'Pokemon Mansion 1F', 'id': 5}}],
             'Rock Tunnel 1F': [{'address': 'Warps_RockTunnel1F', 'id': (0, 1), 'to': {'map': 'Route 10', 'id': 1}},
                                {'address': 'Warps_RockTunnel1F', 'id': (2, 3), 'to': {'map': 'Route 10', 'id': 2}},
             ...
             'Seafoam Islands 1F': [
                 {'address': 'Warps_SeafoamIslands1F', 'id': (2, 3), 'to': {'map': 'Route 20', 'id': 1}},
                 {'address': 'Warps_SeafoamIslands1F', 'id': 4, 'to': {'map': 'Seafoam Islands B1F', 'id': 1}},
                 {'address': 'Warps_SeafoamIslands1F', 'id': 5, 'to': {'map': 'Seafoam Islands B1F', 'id': 6}}],
             'Seafoam Islands 1F-SE':
                 [{'address': 'Warps_SeafoamIslands1F', 'id': (0, 1), 'to': {'map': 'Route 20', 'id': 0}},
                 {'address': 'Warps_SeafoamIslands1F', 'id': 6, 'to': {'map': 'Seafoam Islands B1F', 'id': 4}}],
        ...
        {'address': 'Warps_RocketHideoutB1F', 'id': (2, 4), 'to': {'map': 'Rocket Hideout Elevator', 'id': 0}}],
        ...
        {'address': 'Warps_RocketHideoutB1F', 'id': 3, 'to': {'map': 'Rocket Hideout B2F', 'id': 3}}],
             'Rocket Hideout B2F': [
                 ...
                 {'address': 'Warps_RocketHideoutB2F', 'id': 3, 'to': {'map': 'Rocket Hideout B1F', 'id': 3}}],
             'Rocket Hideout B3F': [
                 {'address': 'Warps_RocketHideoutB3F', 'id': 0, 'to': {'map': 'Rocket Hideout B2F', 'id': 1}},
                 {'address': 'Warps_RocketHideoutB3F', 'id': 1, 'to': {'map': 'Rocket Hideout B4F', 'id': 0}}],
             'Rocket Hideout B4F': [
                 {'address': 'Warps_RocketHideoutB4F', 'id': (1, 2),
                  'to': {'map': 'Rocket Hideout Elevator', 'id': 2}}],
        ...
        {'address': 'RocketHideoutElevatorWarpMaps', 'id': 2, 'to': {'map': 'Rocket Hideout B4F', 'id': 2}}],
             ...
             'Safari Zone Center': [
                 {'address': 'Warps_SafariZoneCenter', 'id': (0, 1), 'to': {'map': 'Safari Zone Gate', 'id': (2, 3)}},
        ...
        {'address': 'Warps_CeruleanCave2F', 'id': 3, 'to': {'map': 'Cerulean Cave 1F', 'id': 5}}],
             ...
             'Seafoam Islands B1F': [
                 {'address': 'Warps_SeafoamIslandsB1F', 'id': 0, 'to': {'map': 'Seafoam Islands B2F', 'id': 0}},
                 {'address': 'Warps_SeafoamIslandsB1F', 'id': 1, 'to': {'map': 'Seafoam Islands 1F', 'id': 4}},
                 {'address': 'Warps_SeafoamIslandsB1F', 'id': 2, 'to': {'map': 'Seafoam Islands B2F', 'id': 2}},
                 {'address': 'Warps_SeafoamIslandsB1F', 'id': 3, 'to': {'map': 'Seafoam Islands B2F', 'id': 3}}],
             'Seafoam Islands B1F-SE': [
                 {'address': 'Warps_SeafoamIslandsB1F', 'id': 4, 'to': {'map': 'Seafoam Islands 1F', 'id': 6}},
                 {'address': 'Warps_SeafoamIslandsB1F', 'id': 5, 'to': {'map': 'Seafoam Islands B2F', 'id': 5}}],
             'Seafoam Islands B1F-NE': [
                 {'address': 'Warps_SeafoamIslandsB1F', 'id': 6, 'to': {'map': 'Seafoam Islands 1F', 'id': 5}}],
             'Seafoam Islands B2F-SE': [
                 {'address': 'Warps_SeafoamIslandsB2F', 'id': 5, 'to': {'map': 'Seafoam Islands B1F', 'id': 5}},
                 {'address': 'Warps_SeafoamIslandsB2F', 'id': 6, 'to': {'map': 'Seafoam Islands B3F', 'id': 4}}],
             'Seafoam Islands B2F-NE': [
                 {'address': 'Warps_SeafoamIslandsB2F', 'id': 4, 'to': {'map': 'Seafoam Islands B3F', 'id': 3}}],
             ...
             'Seafoam Islands B3F': [
                 {'address': 'Warps_SeafoamIslandsB3F', 'id': 0, 'to': {'map': 'Seafoam Islands B2F', 'id': 1}},
             ...
             'Seafoam Islands B3F-SE': [
                 {'address': 'Warps_SeafoamIslandsB3F', 'id': 4, 'to': {'map': 'Seafoam Islands B2F', 'id': 6}}],
             'Seafoam Islands B3F-NE': [
                 {'address': 'Warps_SeafoamIslandsB3F', 'id': 2, 'to': {'map': 'Seafoam Islands B4F', 'id': 3}},
                 {'address': 'Warps_SeafoamIslandsB3F', 'id': 3, 'to': {'map': 'Seafoam Islands B2F', 'id': 4}}],
             'Seafoam Islands B4F': [
                 ...
                 {'address': 'Warps_SeafoamIslandsB4F', 'id': 3, 'to': {'map': 'Seafoam Islands B3F', 'id': 2}}],
             'Route 7': [
                         # {'address': 'Warps_Route7', 'id': 2, 'to': {'map': 'Route 7 Gate', 'id': 0}},
                         {'address': 'Warps_Route7', 'id': 3, 'to': {'map': 'Route 7 Gate', 'id': (0, 1)}},
        ...
        {'address': 'Warps_CeladonPokecenter', 'id': (0, 1), 'to': {'map': 'Celadon City', 'id': 5}}],
             'Celadon Gym': [{'address': 'Warps_CeladonGym', 'id': (0, 1), 'to': {'map': 'Celadon City', 'id': 6}}],
             'Celadon Game Corner': [{'address': 'Warps_GameCorner', 'id': (0, 1), 'to': {'map': 'Celadon City', 'id': 7}},
             ...
             'Route 4 Pokemon Center': [
                 {'address': 'Warps_MtMoonPokecenter', 'id': (0, 1), 'to': {'map': 'Route 4', 'id': 0}}],
             'Rock Tunnel Pokemon Center': [
                 {'address': 'Warps_RockTunnelPokecenter', 'id': (0, 1), 'to': {'map': 'Route 10', 'id': 0}}],
             'Route 11 Gate 1F': [{'address': 'Warps_Route11Gate1F', 'id': (0, 1), 'to': {'map': 'Route 11', 'id': (0, 1)}},
                                  {'address': 'Warps_Route11Gate1F', 'id': (2, 3), 'to': {'map': 'Route 11', 'id': (2, 3)}},
                                  {'address': 'Warps_Route11Gate1F', 'id': 4,
                                   'to': {'map': 'Route 11 Gate 2F', 'id': 0}}], 'Route 11 Gate 2F': [
        {'address': 'Warps_Route11Gate2F', 'id': 0, 'to': {'map': 'Route 11 Gate 1F', 'id': 4}}],
             'Route 12 Gate 1F': [{'address': 'Warps_Route12Gate1F', 'id': (0, 1), 'to': {'map': 'Route 12', 'id': (0, 1)}},
                                  {'address': 'Warps_Route12Gate1F', 'id': (2, 3), 'to': {'map': 'Route 12', 'id': 2}},
                                  {'address': 'Warps_Route12Gate1F', 'id': 4,
                                   'to': {'map': 'Route 12 Gate 2F', 'id': 0}}], 'Route 12 Gate 2F': [
        {'address': 'Warps_Route12Gate2F', 'id': 0, 'to': {'map': 'Route 12 Gate 1F', 'id': 4}}],
             'Route 15 Gate 1F': [{'address': 'Warps_Route15Gate1F', 'id': (0, 1), 'to': {'map': 'Route 15', 'id': (0, 1)}},
                                  {'address': 'Warps_Route15Gate1F', 'id': (2, 3), 'to': {'map': 'Route 15', 'id': (2, 3)}},
                                  {'address': 'Warps_Route15Gate1F', 'id': 4,
                                   'to': {'map': 'Route 15 Gate 2F', 'id': 0}}], 'Route 15 Gate 2F': [
        {'address': 'Warps_Route15Gate2F', 'id': 0, 'to': {'map': 'Route 15 Gate 1F', 'id': 4}}],
             'Route 16 Gate 1F': [{'address': 'Warps_Route16Gate1F', 'id': (0, 1), 'to': {'map': 'Route 16', 'id': (0, 1)}},
                                  {'address': 'Warps_Route16Gate1F', 'id': (2, 3), 'to': {'map': 'Route 16', 'id': 2}},
                                  {'address': 'Warps_Route16Gate1F', 'id': 8,
                                   'to': {'map': 'Route 16 Gate 2F', 'id': 0}}],
             'Route 16 Gate 1F-N': [
                                  {'address': 'Warps_Route16Gate1F', 'id': (4, 5), 'to': {'map': 'Route 16', 'id': (4, 5)}},
                                  {'address': 'Warps_Route16Gate1F', 'id': (6, 7), 'to': {'map': 'Route 16', 'id': (6, 7)}}],
             'Route 16 Gate 2F': [
        {'address': 'Warps_Route16Gate2F', 'id': 0, 'to': {'map': 'Route 16 Gate 1F', 'id': 8}}],
             'Route 18 Gate 1F': [{'address': 'Warps_Route18Gate1F', 'id': (0, 1), 'to': {'map': 'Route 18', 'id': (0, 1)}},
                                  {'address': 'Warps_Route18Gate1F', 'id': (2, 3), 'to': {'map': 'Route 18', 'id': (2, 3)}},
                                  {'address': 'Warps_Route18Gate1F', 'id': 4,
                                   'to': {'map': 'Route 18 Gate 2F', 'id': 0}}], 'Route 18 Gate 2F': [
        {'address': 'Warps_Route18Gate2F', 'id': 0, 'to': {'map': 'Route 18 Gate 1F', 'id': 4}}],
             'Mt Moon 1F': [{'address': 'Warps_MtMoon1F', 'id': (0, 1), 'to': {'map': 'Route 4', 'id': 1}},
             ...
             'Route 23-N': [
                          {'address': 'Warps_Route23', 'id': 3, 'to': {'map': 'Victory Road 2F', 'id': 1}}],
             'Route 24': [],
             ...
             'Victory Road 2F': [{'address': 'Warps_VictoryRoad2F', 'id': 0, 'to': {'map': 'Victory Road 1F', 'id': 2}},
                                 ...
                                 {'address': 'Warps_VictoryRoad2F', 'id': 4, 'to': {'map': 'Victory Road 3F', 'id': 2}},
                                 {'address': 'Warps_VictoryRoad2F', 'id': 5, 'to': {'map': 'Victory Road 3F', 'id': 1}},
                                 {'address': 'Warps_VictoryRoad2F', 'id': 6,
                                  'to': {'map': 'Victory Road 3F', 'id': 3}}],
             'Mt Moon B1F': [{'address': 'Warps_MtMoonB1F', 'id': 0, 'to': {'map': 'Mt Moon 1F', 'id': 2}},
                             {'address': 'Warps_MtMoonB1F', 'id': 1, 'to': {'map': 'Mt Moon B2F', 'id': 0}},
                             ...
                             {'address': 'Warps_MtMoonB1F', 'id': 5, 'to': {'map': 'Mt Moon B2F', 'id': 2}},
                             {'address': 'Warps_MtMoonB1F', 'id': 6, 'to': {'map': 'Mt Moon B2F', 'id': 3}},
                             {'address': 'Warps_MtMoonB1F', 'id': 7, 'to': {'map': 'Route 4', 'id': 2}}],
             ...
             'Silph Co 7F-NW': [{'address': 'Warps_SilphCo7F', 'id': 4, 'to': {'map': 'Silph Co 3F', 'id': 8}},
                             {'address': 'Warps_SilphCo7F', 'id': 3, 'to': {'map': 'Silph Co 11F', 'id': 3}}],
             'Silph Co 7F-SE': [{'address': 'Warps_SilphCo7F', 'id': 5, 'to': {'map': 'Silph Co 5F', 'id': 3}}],
             'Route 2-NW': [
                         {'address': 'Warps_Route2', 'id': 1, 'to': {'map': 'Viridian Forest North Gate', 'id': 1}}],
             'Route 2-SW': [
                         {'address': 'Warps_Route2', 'id': 5, 'to': {'map': 'Viridian Forest South Gate', 'id': 2}}],
             ...
             'Fuchsia Good Rod House': [
                 {'address': 'Warps_FuchsiaGoodRodHouse', 'id': 0, 'to': {'map': 'Fuchsia City-Good Rod House Backyard', 'id': 8}},
             ...
             'Route 12 Super Rod House': [
                 {'address': 'Warps_Route12SuperRodHouse', 'id': (0, 1), 'to': {'map': 'Route 12', 'id': 3}}],
             'Silph Co 8F': [{'address': 'Warps_SilphCo8F', 'id': 0, 'to': {'map': 'Silph Co 9F', 'id': 1}},
                             ...
                             {'address': 'Warps_SilphCo8F', 'id': 6, 'to': {'map': 'Silph Co 8F', 'id': 3}}],
             'Silph Co 8F-W': [{'address': 'Warps_SilphCo8F', 'id': 3, 'to': {'map': 'Silph Co 8F', 'id': 6}}],
             'Route 6': [{'address': 'Warps_Route6', 'id': 1, 'to': {'map': 'Route 6 Gate', 'id': 2}},
             ...
             'Route 16-SW': [{'address': 'Warps_Route16', 'id': (0, 1), 'to': {'map': 'Route 16 Gate 1F', 'id': (0, 1)}}],
             'Route 16-NW': [
                          {'address': 'Warps_Route16', 'id': (4, 5), 'to': {'map': 'Route 16 Gate 1F', 'id': (4, 5)}},
             ...
             'Silph Co 3F': [{'address': 'Warps_SilphCo3F', 'id': 0, 'to': {'map': 'Silph Co 2F', 'id': 1}},
                             ...
                             {'address': 'Warps_SilphCo3F', 'id': 5, 'to': {'map': 'Silph Co 5F', 'id': 6}},
                             {'address': 'Warps_SilphCo3F', 'id': 6, 'to': {'map': 'Silph Co 2F', 'id': 3}},
                             {'address': 'Warps_SilphCo3F', 'id': 9, 'to': {'map': 'Silph Co 3F', 'id': 3}}],
             'Silph Co 3F-C': [{'address': 'Warps_SilphCo3F', 'id': 8, 'to': {'map': 'Silph Co 7F', 'id': 4}}],
             'Silph Co 3F-W': [{'address': 'Warps_SilphCo3F', 'id': 7, 'to': {'map': 'Silph Co 9F', 'id': 3}}],
             ...
             'Silph Co 10F-SE': [{'address': 'Warps_SilphCo10F', 'id': 3, 'to': {'map': 'Silph Co 4F', 'id': 3}},
        ...
        {'address': 'Warps_HallOfFame', 'id': 1, 'to': {'map': "Indigo Plateau Champion's Room", 'id': 3}}],
             ...
             'Vermilion Gym': [
                 {'address': 'Warps_VermilionGym', 'id': (0, 1), 'to': {'map': 'Vermilion City', 'id': 3}}],
             "Copycat's House 2F": [
                 {'address': 'Warps_CopycatsHouse2F', 'id': 0, 'to': {'map': "Copycat's House 1F", 'id': 2}}],
             'Saffron Fighting Dojo': [
                 {'address': 'Warps_FightingDojo', 'id': (0, 1), 'to': {'map': 'Saffron City', 'id': 1}}],
             'Saffron Gym': [{'address': 'Warps_SaffronGym', 'id': (0, 1), 'to': {'map': 'Saffron City', 'id': 2}}],
             'Saffron Gym-NW': [{'address': 'Warps_SaffronGym', 'id': 2, 'to': {'map': 'Saffron Gym', 'id': 22}},
                             {'address': 'Warps_SaffronGym', 'id': 3, 'to': {'map': 'Saffron Gym', 'id': 15}},
                             {'address': 'Warps_SaffronGym', 'id': 4, 'to': {'map': 'Saffron Gym', 'id': 18}},
                             {'address': 'Warps_SaffronGym', 'id': 5, 'to': {'map': 'Saffron Gym', 'id': 8}}],
             'Saffron Gym-W': [{'address': 'Warps_SaffronGym', 'id': 6, 'to': {'map': 'Saffron Gym', 'id': 27}},
                             {'address': 'Warps_SaffronGym', 'id': 7, 'to': {'map': 'Saffron Gym', 'id': 16}},
                             {'address': 'Warps_SaffronGym', 'id': 8, 'to': {'map': 'Saffron Gym', 'id': 5}},
                             {'address': 'Warps_SaffronGym', 'id': 9, 'to': {'map': 'Saffron Gym', 'id': 13}}],
             'Saffron Gym-SW': [{'address': 'Warps_SaffronGym', 'id': 10, 'to': {'map': 'Saffron Gym', 'id': 23}},
                             {'address': 'Warps_SaffronGym', 'id': 11, 'to': {'map': 'Saffron Gym', 'id': 30}},
                             {'address': 'Warps_SaffronGym', 'id': 12, 'to': {'map': 'Saffron Gym', 'id': 17}},
                             {'address': 'Warps_SaffronGym', 'id': 13, 'to': {'map': 'Saffron Gym', 'id': 9}}],
             'Saffron Gym-N': [{'address': 'Warps_SaffronGym', 'id': 14, 'to': {'map': 'Saffron Gym', 'id': 26}},
                             {'address': 'Warps_SaffronGym', 'id': 15, 'to': {'map': 'Saffron Gym', 'id': 3}},
                             {'address': 'Warps_SaffronGym', 'id': 16, 'to': {'map': 'Saffron Gym', 'id': 7}},
                             {'address': 'Warps_SaffronGym', 'id': 17, 'to': {'map': 'Saffron Gym', 'id': 12}}],
             'Saffron Gym-C': [{'address': 'Warps_SaffronGym', 'id': 18, 'to': {'map': 'Saffron Gym', 'id': 4}}],
             'Saffron Gym-S': [{'address': 'Warps_SaffronGym', 'id': 19, 'to': {'map': 'Saffron Gym', 'id': 31}}],
             'Saffron Gym-NE': [{'address': 'Warps_SaffronGym', 'id': 20, 'to': {'map': 'Saffron Gym', 'id': 24}},
                             {'address': 'Warps_SaffronGym', 'id': 21, 'to': {'map': 'Saffron Gym', 'id': 28}},
                             {'address': 'Warps_SaffronGym', 'id': 22, 'to': {'map': 'Saffron Gym', 'id': 2}},
                                {'address': 'Warps_SaffronGym', 'id': 23, 'to': {'map': 'Saffron Gym', 'id': 10}}],
             'Saffron Gym-E': [{'address': 'Warps_SaffronGym', 'id': 24, 'to': {'map': 'Saffron Gym', 'id': 20}},
                             {'address': 'Warps_SaffronGym', 'id': 25, 'to': {'map': 'Saffron Gym', 'id': 29}},
                             {'address': 'Warps_SaffronGym', 'id': 26, 'to': {'map': 'Saffron Gym', 'id': 14}},
                               {'address': 'Warps_SaffronGym', 'id': 27, 'to': {'map': 'Saffron Gym', 'id': 6}}],
             'Saffron Gym-SE': [{'address': 'Warps_SaffronGym', 'id': 28, 'to': {'map': 'Saffron Gym', 'id': 21}},
                             {'address': 'Warps_SaffronGym', 'id': 29, 'to': {'map': 'Saffron Gym', 'id': 25}},
                             {'address': 'Warps_SaffronGym', 'id': 30, 'to': {'map': 'Saffron Gym', 'id': 11}},
                             {'address': 'Warps_SaffronGym', 'id': 31, 'to': {'map': 'Saffron Gym', 'id': 19}}],
             'Saffron Pokemart': [
             ...
             'Viridian Forest North Gate': [
                 {'address': 'Warps_ViridianForestNorthGate', 'id': 1, 'to': {'map': 'Route 2', 'id': 1}},
                 {'address': 'Warps_ViridianForestNorthGate', 'id': (2, 3), 'to': {'map': 'Viridian Forest', 'id': 0}}],
             'Route 2 Gate': [{'address': 'Warps_Route2Gate', 'id': (0, 1), 'to': {'map': 'Route 2', 'id': 3}},
                              {'address': 'Warps_Route2Gate', 'id': (2, 3), 'to': {'map': 'Route 2', 'id': 4}}],
             'Viridian Forest South Gate': [
                 {'address': 'Warps_ViridianForestSouthGate', 'id': 1, 'to': {'map': 'Viridian Forest', 'id': 4}},
                 {'address': 'Warps_ViridianForestSouthGate', 'id': (2, 3), 'to': {'map': 'Route 2', 'id': 5}}],
        ...
        {'address': 'Warps_UndergroundPathRoute6', 'id': 2, 'to': {'map': 'Underground Path North South', 'id': 1}}],
             ...
             'Silph Co 9F-NW': [{'address': 'Warps_SilphCo9F', 'id': 3, 'to': {'map': 'Silph Co 3F', 'id': 7}}],
             'Victory Road 1F': [{'address': 'Warps_VictoryRoad1F', 'id': (0, 1), 'to': {'map': 'Route 23', 'id': 2}},
        ...
        {'address': 'Warps_DiglettsCave', 'id': 1, 'to': {'map': "Diglett's Cave Route 11", 'id': 2}}],
             ...
             'Cerulean Cave 1F': [
                 ...
                 {'address': 'Warps_CeruleanCave1F', 'id': 5, 'to': {'map': 'Cerulean Cave 2F', 'id': 3}},
                 {'address': 'Warps_CeruleanCave1F', 'id': 6, 'to': {'map': 'Cerulean Cave 2F', 'id': 4}},
                 {'address': 'Warps_CeruleanCave1F', 'id': 7, 'to': {'map': 'Cerulean Cave 2F', 'id': 5}},
                 {'address': 'Warps_CeruleanCave1F', 'id': 8, 'to': {'map': 'Cerulean Cave B1F', 'id': 0}}],
             'Cerulean Badge House': [
                 {'address': 'Warps_CeruleanBadgeHouse', 'id': 0, 'to': {'map': 'Cerulean City', 'id': 9}},
             ...
             'Cinnabar Gym': [
                 {'address': 'Warps_CinnabarGym', 'id': (0, 1), 'to': {'map': 'Cinnabar Island', 'id': 1}}],
        ...
        {'address': 'Warps_CinnabarLabTradeRoom', 'id': (0, 1), 'to': {'map': 'Cinnabar Lab', 'id': 2}}],
             ...
             "Copycat's House 1F": [
                 {'address': 'Warps_CopycatsHouse1F', 'id': (0, 1), 'to': {'map': 'Saffron City', 'id': 0}},
                 {'address': 'Warps_CopycatsHouse1F', 'id': 2, 'to': {'map': "Copycat's House 2F", 'id': 0}}],
             ...
             "Indigo Plateau Lorelei's Room": [
                 ...
                 {'address': 'Warps_LoreleisRoom', 'id': (2, 3), 'to': {'map': "Indigo Plateau Bruno's Room", 'id': (0, 1)}}],
             ...
             "Indigo Plateau Agatha's Room": [
                 {'address': 'Warps_AgathasRoom', 'id': (0, 1), 'to': {'map': "Indigo Plateau Bruno's Room", 'id': (2, 3)}},
