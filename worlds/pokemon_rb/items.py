...
item_table = {
    ...
    "Ultra Ball": ItemData(2, ItemClassification.Philler, ["Consumables", "Poke Balls"]),
    "Great Ball": ItemData(3, ItemClassification.Philler, ["Consumables", "Poke Balls"]),
    "Poke Ball": ItemData(4, ItemClassification.Philler, ["Consumables", "Poke Balls"]),
    ...
    #"Safari Ball": ItemData(8, ItemClassification.Philler),
    ...
    "Antidote": ItemData(11, ItemClassification.Philler, ["Consumables"]),
    "Burn Heal": ItemData(12, ItemClassification.Philler, ["Consumables"]),
    "Ice Heal": ItemData(13, ItemClassification.Philler, ["Consumables"]),
    "Awakening": ItemData(14, ItemClassification.Philler, ["Consumables"]),
    "Paralyze Heal": ItemData(15, ItemClassification.Philler, ["Consumables"]),
    "Full Restore": ItemData(16, ItemClassification.Philler, ["Consumables"]),
    "Max Potion": ItemData(17, ItemClassification.Philler, ["Consumables"]),
    "Hyper Potion": ItemData(18, ItemClassification.Philler, ["Consumables"]),
    "Super Potion": ItemData(19, ItemClassification.Philler, ["Consumables"]),
    "Potion": ItemData(20, ItemClassification.Philler, ["Consumables"]),
    ...
    "Escape Rope": ItemData(29, ItemClassification.Philler, ["Consumables"]),
    "Repel": ItemData(30, ItemClassification.Philler, ["Consumables"]),
    ...
    "HP Up": ItemData(35, ItemClassification.Philler, ["Consumables", "Vitamins"]),
    "Protein": ItemData(36, ItemClassification.Philler, ["Consumables", "Vitamins"]),
    "Iron": ItemData(37, ItemClassification.Philler, ["Consumables", "Vitamins"]),
    "Carbos": ItemData(38, ItemClassification.Philler, ["Consumables", "Vitamins"]),
    "Calcium": ItemData(39, ItemClassification.Philler, ["Consumables", "Vitamins"]),
    ...
    "X Accuracy": ItemData(46, ItemClassification.Philler, ["Consumables", "Battle Items"]),
    ...
    "Nugget": ItemData(49, ItemClassification.Philler, []),
    #"Laptop": ItemData(50, ItemClassification.useful, ["Unique"]),
    "Poke Doll": ItemData(51, ItemClassification.Philler, ["Consumables"]),
    "Full Heal": ItemData(52, ItemClassification.Philler, ["Consumables"]),
    "Revive": ItemData(53, ItemClassification.Philler, ["Consumables"]),
    "Max Revive": ItemData(54, ItemClassification.Philler, ["Consumables"]),
    "Guard Spec": ItemData(55, ItemClassification.Philler, ["Consumables", "Battle Items"]),
    "Super Repel": ItemData(56, ItemClassification.Philler, ["Consumables"]),
    "Max Repel": ItemData(57, ItemClassification.Philler, ["Consumables"]),
    "Dire Hit": ItemData(58, ItemClassification.Philler, ["Consumables", "Battle Items"]),
    "10 Coins": ItemData(59, ItemClassification.Philler, ["Coins"]),
    "Fresh Water": ItemData(60, ItemClassification.Philler, ["Consumables", "Vending Machine Drinks"]),
    "Soda Pop": ItemData(61, ItemClassification.Philler, ["Consumables", "Vending Machine Drinks"]),
    "Lemonade": ItemData(62, ItemClassification.Philler, ["Consumables", "Vending Machine Drinks"]),
    ...
    "X Attack": ItemData(65, ItemClassification.Philler, ["Consumables", "Battle Items"]),
    "X Defend": ItemData(66, ItemClassification.Philler, ["Consumables", "Battle Items"]),
    "X Speed": ItemData(67, ItemClassification.Philler, ["Consumables", "Battle Items"]),
    "X Special": ItemData(68, ItemClassification.Philler, ["Consumables", "Battle Items"]),
    ...
    "PP Up": ItemData(79, ItemClassification.Philler, ["Consumables"]),
    "Ether": ItemData(80, ItemClassification.Philler, ["Consumables"]),
    "Max Ether": ItemData(81, ItemClassification.Philler, ["Consumables"]),
    "Elixir": ItemData(82, ItemClassification.Philler, ["Consumables"]),
    "Max Elixir": ItemData(83, ItemClassification.Philler, ["Consumables"]),
    ...
    "20 Coins": ItemData(98, ItemClassification.Philler, ["Coins"]),
    "100 Coins": ItemData(99, ItemClassification.Philler, ["Coins"]),
    ...
    "TM02 Razor Wind": ItemData(202, ItemClassification.Philler, ["Unique", "TMs"]),
    "TM03 Swords Dance": ItemData(203, ItemClassification.useful, ["Unique", "TMs"]),
    "TM04 Whirlwind": ItemData(204, ItemClassification.Philler, ["Unique", "TMs"]),
    ...
    "TM12 Water Gun": ItemData(212, ItemClassification.Philler, ["Unique", "TMs"]),
    ...
    "TM18 Counter": ItemData(218, ItemClassification.Philler, ["Unique", "TMs"]),
    ...
    "TM30 Teleport": ItemData(230, ItemClassification.Philler, ["Unique", "TMs"]),
    ...
    "TM34 Bide": ItemData(234, ItemClassification.Philler, ["Unique", "TMs"]),
    ...
    "TM40 Skull Bash": ItemData(240, ItemClassification.Philler, ["Unique", "TMs"]),
    ...
    "TM43 Sky Attack": ItemData(243, ItemClassification.Philler, ["Unique", "TMs"]),
    ...
    "TM46 Psywave": ItemData(246, ItemClassification.Philler, ["Unique", "TMs"]),
...
item_table.update({f"TM{str(i).zfill(2)}": ItemData(i + 456, ItemClassification.Philler, ["Unique", "TMs"])
                   for i in range(1, 51)})
