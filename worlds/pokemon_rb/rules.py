...
def set_rules(world):
    ...
    access_rules = {
        ...
        "Viridian City - Sleepy Guy": lambda state: logic.can_cut(state, world) or logic.can_surf(state, world),
        "Route 2 Gate - Oak's Aide": lambda state: logic.oaks_aide(state, world.options.oaks_aide_rt_2.value + 5, world),
        ...
        "Route 11 Gate 2F - Oak's Aide": lambda state: logic.oaks_aide(state, world.options.oaks_aide_rt_11.value + 5, world),
        "Celadon City - Stranded Man": lambda state: logic.can_surf(state, world),
        ...
        "Route 12 - Island Item": lambda state: logic.can_surf(state, world),
        "Route 15 Gate 2F - Oak's Aide": lambda state: logic.oaks_aide(state, world.options.oaks_aide_rt_15.value + 5, world),
        "Route 25 - Item": lambda state: logic.can_cut(state, world),
        "Fuchsia Warden's House - Behind Boulder Item": lambda state: logic.can_strength(state, world),
        "Safari Zone Center - Island Item": lambda state: logic.can_surf(state, world),
        ...
        "Celadon Game Corner - Hidden Item Northwest By Counter": lambda state: state.has("Coin Case", player) and logic.can_get_hidden_items(state, world),
        "Celadon Game Corner - Hidden Item Southwest Corner": lambda state: state.has("Coin Case", player) and logic.can_get_hidden_items(state, world),
        "Celadon Game Corner - Hidden Item Near Rumor Man": lambda state: state.has("Coin Case", player) and logic.can_get_hidden_items(state, world),
        "Celadon Game Corner - Hidden Item Near Speculating Woman": lambda state: state.has("Coin Case", player) and logic.can_get_hidden_items(state, world),
        "Celadon Game Corner - Hidden Item Near West Gifting Gambler": lambda state: state.has("Coin Case", player) and logic.can_get_hidden_items(state, world),
        "Celadon Game Corner - Hidden Item Near Wonderful Time Woman": lambda state: state.has("Coin Case", player) and logic.can_get_hidden_items(state, world),
        "Celadon Game Corner - Hidden Item Near Failing Gym Information Guy": lambda state: state.has( "Coin Case", player) and logic.can_get_hidden_items(state, world),
        "Celadon Game Corner - Hidden Item Near East Gifting Gambler": lambda state: state.has("Coin Case", player) and logic.can_get_hidden_items(state, world),
        "Celadon Game Corner - Hidden Item Near Hooked Guy": lambda state: state.has("Coin Case", player) and logic.can_get_hidden_items(state, world),
        "Celadon Game Corner - Hidden Item at End of Horizontal Machine Row": lambda state: state.has("Coin Case", player) and logic.can_get_hidden_items(state, world),
        "Celadon Game Corner - Hidden Item in Front of Horizontal Machine Row": lambda state: state.has("Coin Case", player) and logic.can_get_hidden_items(state, world),
        ...
        "Seafoam Islands B4F - Legendary Pokemon": lambda state: logic.can_strength(state, world) and state.has("Seafoam Boss Boulders", player),
        "Vermilion Dock - Legendary Pokemon": lambda state: logic.can_surf(state, world),
        "Cerulean Cave B1F - Legendary Pokemon": lambda state: logic.can_surf(state, world),
        ...
        **{f"Pokemon Tower {floor}F - Wild Pokemon - {slot}": lambda state: state.has("Silph Scope", player) for floor in range(3, 8) for slot in range(1, 11)},
        ...
        # # Rock Tunnel
        "Rock Tunnel 1F - PokeManiac": lambda state: logic.rock_tunnel(state, world),
        "Rock Tunnel 1F - Hiker 1": lambda state: logic.rock_tunnel(state, world),
        "Rock Tunnel 1F - Hiker 2": lambda state: logic.rock_tunnel(state, world),
        "Rock Tunnel 1F - Hiker 3": lambda state: logic.rock_tunnel(state, world),
        "Rock Tunnel 1F - Jr. Trainer F 1": lambda state: logic.rock_tunnel(state, world),
        "Rock Tunnel 1F - Jr. Trainer F 2": lambda state: logic.rock_tunnel(state, world),
        "Rock Tunnel 1F - Jr. Trainer F 3": lambda state: logic.rock_tunnel(state, world),
        "Rock Tunnel B1F - PokeManiac 1": lambda state: logic.rock_tunnel(state, world),
        "Rock Tunnel B1F - PokeManiac 2": lambda state: logic.rock_tunnel(state, world),
        "Rock Tunnel B1F - PokeManiac 3": lambda state: logic.rock_tunnel(state, world),
        "Rock Tunnel B1F - Jr. Trainer F 1": lambda state: logic.rock_tunnel(state, world),
        "Rock Tunnel B1F - Jr. Trainer F 2": lambda state: logic.rock_tunnel(state, world),
        "Rock Tunnel B1F - Hiker 1": lambda state: logic.rock_tunnel(state, world),
        "Rock Tunnel B1F - Hiker 2": lambda state: logic.rock_tunnel(state, world),
        "Rock Tunnel B1F - Hiker 3": lambda state: logic.rock_tunnel(state, world),
        "Rock Tunnel B1F - North Item": lambda state: logic.rock_tunnel(state, world),
        "Rock Tunnel B1F - Northwest Item": lambda state: logic.rock_tunnel(state, world),
        "Rock Tunnel B1F - Southwest Item": lambda state: logic.rock_tunnel(state, world),
        "Rock Tunnel B1F - West Item": lambda state: logic.rock_tunnel(state, world),
        ...
        "Viridian Forest - Hidden Item Northwest by Trainer": lambda state: logic.can_get_hidden_items(state, 
            world),
        "Viridian Forest - Hidden Item Entrance Tree": lambda state: logic.can_get_hidden_items(state, world),
        ...
        "Route 25 - Hidden Item Fence Outside Bill's House": lambda state: logic.can_get_hidden_items(state, 
            world),
        "Route 9 - Hidden Item Bush By Grass": lambda state: logic.can_get_hidden_items(state, world),
        "S.S. Anne Kitchen - Hidden Item Kitchen Trash": lambda state: logic.can_get_hidden_items(state, world),
        "S.S. Anne B1F Rooms - Hidden Item Under Pillow": lambda state: logic.can_get_hidden_items(state, world),
        "Route 10 - Hidden Item Behind Rock Tunnel Entrance Cuttable Tree": lambda
            state: logic.can_get_hidden_items(state, world) and logic.can_cut(state, world),
        "Route 10 - Hidden Item Bush": lambda state: logic.can_get_hidden_items(state, world),
        "Rocket Hideout B1F - Hidden Item Pot Plant": lambda state: logic.can_get_hidden_items(state, world),
        "Rocket Hideout B3F - Hidden Item Near East Item": lambda state: logic.can_get_hidden_items(state, world),
        "Rocket Hideout B4F - Hidden Item Behind Giovanni": lambda state:
            logic.can_get_hidden_items(state, world),
        "Pokemon Tower 5F - Hidden Item Near West Staircase": lambda state: logic.can_get_hidden_items(state, 
            world),
        "Route 13 - Hidden Item Dead End Bush": lambda state: logic.can_get_hidden_items(state, world),
        "Route 13 - Hidden Item Dead End By Water Corner": lambda state: logic.can_get_hidden_items(state, world),
        ...
        "Safari Zone West - Hidden Item Secret House Statue": lambda state: logic.can_get_hidden_items(state, 
            world),
        "Silph Co 5F - Hidden Item Pot Plant": lambda state: logic.can_get_hidden_items(state, world),
        "Silph Co 9F - Hidden Item Nurse Bed": lambda state: logic.can_get_hidden_items(state, world),
        "Saffron Copycat's House 2F - Hidden Item Desk": lambda state: logic.can_get_hidden_items(state, world),
        "Cerulean Cave 1F - Hidden Item Center Rocks": lambda state: logic.can_get_hidden_items(state, world),
        "Cerulean Cave B1F - Hidden Item Northeast Rocks": lambda state: logic.can_get_hidden_items(state, world),
        "Power Plant - Hidden Item Central Dead End": lambda state: logic.can_get_hidden_items(state, world),
        "Power Plant - Hidden Item Before Zapdos": lambda state: logic.can_get_hidden_items(state, world),
        "Seafoam Islands B2F - Hidden Item Rock": lambda state: logic.can_get_hidden_items(state, world),
        "Seafoam Islands B3F - Hidden Item Rock": lambda state: logic.can_get_hidden_items(state, world),
        # if you can reach any exit boulders, that means you can drop into the water tunnel and auto-surf
        "Seafoam Islands B4F - Hidden Item Corner Island": lambda state: logic.can_get_hidden_items(state, world),
        "Pokemon Mansion 1F - Hidden Item Block Near Entrance Carpet": lambda
            state: logic.can_get_hidden_items(state, world),
        "Pokemon Mansion 3F - Hidden Item Behind Burglar": lambda state: logic.can_get_hidden_items(state, world),
        ...
        "Route 23 - Hidden Item On Island": lambda state: logic.can_get_hidden_items(state, 
            world) and logic.can_surf(state, world),
        "Victory Road 2F - Hidden Item Rock Before Moltres": lambda state: logic.can_get_hidden_items(state, 
            world),
        "Victory Road 2F - Hidden Item Rock In Final Room": lambda state: logic.can_get_hidden_items(state, world),
        "Viridian City - Hidden Item Cuttable Tree": lambda state: logic.can_get_hidden_items(state, world),
        "Route 11 - Hidden Item Isolated Bush Near Gate": lambda state: logic.can_get_hidden_items(state, world),
        "Route 12 - Hidden Item Bush Near Gate": lambda state: logic.can_get_hidden_items(state, world),
        "Route 17 - Hidden Item In Grass": lambda state: logic.can_get_hidden_items(state, world),
        "Route 17 - Hidden Item Near Northernmost Sign": lambda state: logic.can_get_hidden_items(state, world),
        "Route 17 - Hidden Item East Center": lambda state: logic.can_get_hidden_items(state, world),
        "Route 17 - Hidden Item West Center": lambda state: logic.can_get_hidden_items(state, world),
        "Route 17 - Hidden Item Before Final Bridge": lambda state: logic.can_get_hidden_items(state, world),
        ...
        "Underground Path North South - Hidden Item Near Southern Stairs": lambda
            state: logic.can_get_hidden_items(state, world),
        "Underground Path West East - Hidden Item West": lambda state: logic.can_get_hidden_items(state, world),
        "Underground Path West East - Hidden Item East": lambda state: logic.can_get_hidden_items(state, world),
        "Celadon City - Hidden Item Dead End Near Cuttable Tree": lambda state: logic.can_get_hidden_items(state, 
            world),
        "Route 25 - Hidden Item Northeast Of Grass": lambda state: logic.can_get_hidden_items(state, world),
        "Mt Moon B2F - Hidden Item Lone Rock": lambda state: logic.can_get_hidden_items(state, world),
        ...
        "Cerulean City - Hidden Item Gym Badge Guy's Backyard": lambda state: logic.can_get_hidden_items(state, 
            world),
        "Route 4 - Hidden Item Plateau East Of Mt Moon": lambda state: logic.can_get_hidden_items(state, world),
    ...
    for loc in multiworld.get_locations(player):
        ...
        if loc.name.startswith("Pokedex"):
            ...
            add_rule(loc, lambda state, i=mon: (state.has("Pokedex", player) or not
                     world.options.require_pokedex) and (state.has(i, player)
