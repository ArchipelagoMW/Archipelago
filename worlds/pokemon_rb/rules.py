...
def set_rules(world, player):
    ...
    access_rules = {
        ...
        "Rock Tunnel B1F - Southwest Item": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_items_require_flash(player),
        "Rock Tunnel B1F - West Item": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_items_require_flash(player),
        "Rock Tunnel B1F - Northwest Item": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_items_require_flash(player),
        "Rock Tunnel B1F - North Item": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_items_require_flash(player),
        ...
        "Rock Tunnel 1F - PokeManiac": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_trainers_require_flash(player),
        "Rock Tunnel 1F - Hiker 1": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_trainers_require_flash(player),
        "Rock Tunnel 1F - Hiker 2": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_trainers_require_flash(player),
        "Rock Tunnel 1F - Hiker 3": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_trainers_require_flash(player),
        "Rock Tunnel 1F - Jr. Trainer F 1": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_trainers_require_flash(player),
        "Rock Tunnel 1F - Jr. Trainer F 2": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_trainers_require_flash(player),
        "Rock Tunnel 1F - Jr. Trainer F 3": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_trainers_require_flash(player),
        "Rock Tunnel B1F - PokeManiac 1": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_trainers_require_flash(player),
        "Rock Tunnel B1F - Jr. Trainer F 1": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_trainers_require_flash(player),
        "Rock Tunnel B1F - PokeManiac 2": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_trainers_require_flash(player),
        "Rock Tunnel B1F - Hiker 1": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_trainers_require_flash(player),
        "Rock Tunnel B1F - Hiker 2": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_trainers_require_flash(player),
        "Rock Tunnel B1F - Jr. Trainer F 2": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_trainers_require_flash(player),
        "Rock Tunnel B1F - Hiker 3": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_trainers_require_flash(player),
        "Rock Tunnel B1F - PokeManiac 3": lambda state: state.pokemon_rb_can_flash(player) or not state.pokemon_rb_trainers_require_flash(player),
