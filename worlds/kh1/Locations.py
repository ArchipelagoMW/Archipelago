...
location_table: Dict[str, KH1LocationData] = {
   #"Destiny Islands Chest":                                                            KH1LocationData("Destiny Islands",  265_0011), missable
    ...
    "Halloween Town Cemetary Behind Grave Chest":                                       KH1LocationData("Halloween Town",   265_3054),
    "Halloween Town Cemetary By Cat Shape Chest":                                       KH1LocationData("Halloween Town",   265_3091),
    "Halloween Town Cemetary Between Graves Chest":                                     KH1LocationData("Halloween Town",   265_3092),
    ...
    "Halloween Town Cemetary By Striped Grave Chest":                                   KH1LocationData("Halloween Town",   265_3292),
   ...
   #"Hollow Bastion Entrance Hall Push the Statue Chest":                               KH1LocationData("Hollow Bastion",   265_4493), give vanilla reward
   ...
   #"Traverse Town Magician's Study Turn in all Summon Gems":                           KH1LocationData("Traverse Town",    265_6303),
    ...
    "Traverse Town Piano Room Return 50 Puppies":                                       KH1LocationData("Traverse Town",    265_6318),
...
event_location_table: Dict[str, KH1LocationData] = {
    "Traverse Town Item Shop Postcard":                                                 KH1LocationData("Traverse Town"),
    "Traverse Town 1st District Safe Postcard":                                         KH1LocationData("Traverse Town"),
    "Traverse Town Gizmo Shop Postcard 1":                                              KH1LocationData("Traverse Town"),
    "Traverse Town Gizmo Shop Postcard 2":                                              KH1LocationData("Traverse Town"),
    "Traverse Town Item Workshop Postcard":                                             KH1LocationData("Traverse Town"),
    "Traverse Town 3rd District Balcony Postcard":                                      KH1LocationData("Traverse Town"),
    "Traverse Town Geppetto's House Postcard":                                          KH1LocationData("Traverse Town"),
    "Traverse Town Piano Room Return 50 Puppies Torn Page":                             KH1LocationData("Traverse Town"),
    "Halloween Town Lab Torn Page":                                                     KH1LocationData("Halloween Town"),
    "Atlantica Ariel's Grotto Torn Page":                                               KH1LocationData("Atlantica")
}
