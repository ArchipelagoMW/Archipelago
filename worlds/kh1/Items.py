...
item_table: Dict[str, KH1ItemData] = {
    ...
    "Final Door Key":                    KH1ItemData("Key",              code = 264_1010, classification = ItemClassification.progression, type = "Key",                             ),
    #"Energy Stone":                     KH1ItemData("Synthesis",        code = 264_1011, classification = ItemClassification.filler,      type = "Item",                            ),
    #"Blazing Stone":                    KH1ItemData("Synthesis",        code = 264_1012, classification = ItemClassification.filler,      type = "Item",                            ),
    ...
    #"Tinker Bell":                      KH1ItemData("Weapons",          code = 264_1140, classification = ItemClassification.filler,      type = "Item",                            ),
    ...
    #"Log":                              KH1ItemData("Key",              code = 264_1192, classification = ItemClassification.progression, type = "Item",                            ),
    #"Cloth":                            KH1ItemData("Key",              code = 264_1193, classification = ItemClassification.progression, type = "Item",                            ),
    #"Rope":                             KH1ItemData("Key",              code = 264_1194, classification = ItemClassification.progression, type = "Item",                            ),
    #"Seagull Egg":                      KH1ItemData("Key",              code = 264_1195, classification = ItemClassification.progression, type = "Item",                            ),
    #"Fish":                             KH1ItemData("Key",              code = 264_1196, classification = ItemClassification.progression, type = "Item",                            ),
    #"Mushroom":                         KH1ItemData("Key",              code = 264_1197, classification = ItemClassification.progression, type = "Item",                            ),
    #"Coconut":                          KH1ItemData("Key",              code = 264_1198, classification = ItemClassification.progression, type = "Item",                            ),
    #"Drinking Water":                   KH1ItemData("Key",              code = 264_1199, classification = ItemClassification.progression, type = "Item",                            ),
   ...
   #"Torn Page 5":                       KH1ItemData("Torn Pages",       code = 264_1216, classification = ItemClassification.progression, type = "Item",                            ),
    ...
    #"Power Gem":                        KH1ItemData("Synthesis",        code = 264_1239, classification = ItemClassification.filler,      type = "Item",                            ),
    #"Power Crystal":                    KH1ItemData("Synthesis",        code = 264_1240, classification = ItemClassification.filler,      type = "Item",                            ),
    #"Blaze Shard":                      KH1ItemData("Synthesis",        code = 264_1241, classification = ItemClassification.filler,      type = "Item",                            ),
    #"Blaze Gem":                        KH1ItemData("Synthesis",        code = 264_1242, classification = ItemClassification.filler,      type = "Item",                            ),
    #"Frost Shard":                      KH1ItemData("Synthesis",        code = 264_1243, classification = ItemClassification.filler,      type = "Item",                            ),
    #"Frost Gem":                        KH1ItemData("Synthesis",        code = 264_1244, classification = ItemClassification.filler,      type = "Item",                            ),
    #"Thunder Shard":                    KH1ItemData("Synthesis",        code = 264_1245, classification = ItemClassification.filler,      type = "Item",                            ),
    ...
    #"Mythril":                          KH1ItemData("Synthesis",        code = 264_1254, classification = ItemClassification.filler,      type = "Item",                            ),
    "Orichalcum":                        KH1ItemData("Key",              code = 264_1255, classification = ItemClassification.progression, type = "Item"          , max_quantity = 6 ),
    ...
    "Air Combo Plus":                    KH1ItemData("Abilities",        code = 264_3007, classification = ItemClassification.useful,      type = "Ability",        max_quantity = 2 ),
    ...
    "Sonic Blade":                       KH1ItemData("Abilities",        code = 264_3011, classification = ItemClassification.useful,      type = "Ability",                         ),
    "Ars Arcanum":                       KH1ItemData("Abilities",        code = 264_3012, classification = ItemClassification.useful,      type = "Ability",                         ),
    "Strike Raid":                       KH1ItemData("Abilities",        code = 264_3013, classification = ItemClassification.useful,      type = "Ability",                         ),
    ...
    "Max HP Increase":                   KH1ItemData("Level Up",         code = 264_4001, classification = ItemClassification.useful,      type = "Stats",          max_quantity = 15),
    "Max MP Increase":                   KH1ItemData("Level Up",         code = 264_4002, classification = ItemClassification.useful,      type = "Stats",          max_quantity = 15),
    "Max AP Increase":                   KH1ItemData("Level Up",         code = 264_4003, classification = ItemClassification.useful,      type = "Stats",          max_quantity = 15),
    "Strength Increase":                 KH1ItemData("Level Up",         code = 264_4004, classification = ItemClassification.useful,      type = "Stats",          max_quantity = 15),
    "Defense Increase":                  KH1ItemData("Level Up",         code = 264_4005, classification = ItemClassification.useful,      type = "Stats",          max_quantity = 15),
    "Item Slot Increase":                KH1ItemData("Limited Level Up", code = 264_4006, classification = ItemClassification.useful,      type = "Stats",          max_quantity = 15),
    "Accessory Slot Increase":           KH1ItemData("Limited Level Up", code = 264_4007, classification = ItemClassification.useful,      type = "Stats",          max_quantity = 15),
}
