...
def set_rules(multiworld: MultiWorld, player: int):
   ...
   #multiworld.get_location("Traverse Town Geppetto's House Chest"                                         , player).access_rule = lambda state: has_item(state, player, "")
    ...
    multiworld.get_location("Traverse Town Secret Waterway Near Stairs Chest"                              , player).access_rule = lambda state: has_item(state, player, "Progressive Fire")
   ...
   #multiworld.get_location("Wonderland Queen's Castle Hedge Left Red Chest"                               , player).access_rule = lambda state: has_item(state, player, "")
   #multiworld.get_location("Wonderland Queen's Castle Hedge Right Blue Chest"                             , player).access_rule = lambda state: has_item(state, player, "")
   #multiworld.get_location("Wonderland Queen's Castle Hedge Right Red Chest"                              , player).access_rule = lambda state: has_item(state, player, "")
    multiworld.get_location("Wonderland Lotus Forest Thunder Plant Chest"                                  , player).access_rule = lambda state: has_item(state, player, "Progressive Thunder")
    multiworld.get_location("Wonderland Lotus Forest Through the Painting Thunder Plant Chest"             , player).access_rule = lambda state: has_item(state, player, "Progressive Thunder")
   ...
   #multiworld.get_location("Wonderland Bizarre Room Lamp Chest"                                           , player).access_rule = lambda state: has_item(state, player, "")
    multiworld.get_location("Wonderland Tea Party Garden Above Lotus Forest Entrance 2nd Chest"            , player).access_rule = lambda state: can_glide(state, player) and has_evidence(state, player)
    multiworld.get_location("Wonderland Tea Party Garden Above Lotus Forest Entrance 1st Chest"            , player).access_rule = lambda state: can_glide(state, player) and has_evidence(state, player)
    ...
    multiworld.get_location("Wonderland Tea Party Garden Across From Bizarre Room Entrance Chest"          , player).access_rule = lambda state: can_glide(state, player) and has_evidence(state, player)
    multiworld.get_location("Wonderland Lotus Forest Through the Painting White Trinity Chest"             , player).access_rule = lambda state: has_item(state, player, "White Trinity")
   ...
   #multiworld.get_location("Deep Jungle Hippo's Lagoon Center Chest"                                      , player).access_rule = lambda state: has_item(state, player, "")
    multiworld.get_location("Deep Jungle Hippo's Lagoon Left Chest"                                        , player).access_rule = lambda state: has_item(state, player, "High Jump")
   ...
   #multiworld.get_location("Agrabah Cave of Wonders Entrance Left Chest"                                  , player).access_rule = lambda state: has_item(state, player, "")
    multiworld.get_location("Agrabah Cave of Wonders Entrance Tall Tower Chest"                            , player).access_rule = lambda state: has_item(state, player, "High Jump")
   ...
   #multiworld.get_location("Agrabah Cave of Wonders Bottomless Hall Raised Platform Chest"                , player).access_rule = lambda state: has_item(state, player, "")
    multiworld.get_location("Agrabah Cave of Wonders Bottomless Hall Pillar Chest"                         , player).access_rule = lambda state: has_item(state, player, "High Jump")
   ...
   #multiworld.get_location("Agrabah Cave of Wonders Dark Chamber Near Save Chest"                         , player).access_rule = lambda state: has_item(state, player, "")
    ...
    multiworld.get_location("Agrabah Cave of Wonders Hidden Room Right Chest"                              , player).access_rule = lambda state: has_item(state, player, "Yellow Trinity")
    multiworld.get_location("Agrabah Cave of Wonders Hidden Room Left Chest"                               , player).access_rule = lambda state: has_item(state, player, "Yellow Trinity")
   ...
   #multiworld.get_location("Agrabah Aladdin's House Plaza Entrance Chest"                                 , player).access_rule = lambda state: has_item(state, player, "")
    ...
    multiworld.get_location("Monstro Chamber 6 Other Platform Chest"                                       , player).access_rule = lambda state: has_item(state, player, "")
    ...
    multiworld.get_location("Monstro Chamber 6 Raised Area Near Chamber 1 Entrance Chest"                  , player).access_rule = lambda state: has_item(state, player, "")
   ...
   #multiworld.get_location("Atlantica Undersea Gorge Jammed by Ariel's Grotto Chest"                      , player).access_rule = lambda state: has_item(state, player, "")
    ...
    multiworld.get_location("Halloween Town Bridge Under Bridge"                                           , player).access_rule = lambda state: has_item(state, player, "Forget-Me-Not")
   #multiworld.get_location("Halloween Town Boneyard Tombstone Puzzle Chest"                               , player).access_rule = lambda state: has_item(state, player, "")
    multiworld.get_location("Halloween Town Bridge Right of Gate Chest"                                    , player).access_rule = lambda state: has_item(state, player, "Forget-Me-Not")
   #multiworld.get_location("Halloween Town Cemetary Behind Grave Chest"                                   , player).access_rule = lambda state: has_item(state, player, "")
   #multiworld.get_location("Halloween Town Cemetary By Cat Shape Chest"                                   , player).access_rule = lambda state: has_item(state, player, "")
   #multiworld.get_location("Halloween Town Cemetary Between Graves Chest"                                 , player).access_rule = lambda state: has_item(state, player, "")
    multiworld.get_location("Halloween Town Oogie's Manor Lower Iron Cage Chest"                           , player).access_rule = lambda state: has_item(state, player, "Forget-Me-Not")
    multiworld.get_location("Halloween Town Oogie's Manor Upper Iron Cage Chest"                           , player).access_rule = lambda state: has_item(state, player, "Forget-Me-Not")
    multiworld.get_location("Halloween Town Oogie's Manor Hollow Chest"                                    , player).access_rule = lambda state: has_item(state, player, "Forget-Me-Not")
    multiworld.get_location("Halloween Town Oogie's Manor Grounds Red Trinity Chest"                       , player).access_rule = lambda state: has_item(state, player, "Forget-Me-Not") and has_item(state, player, "Red Trinity")
    ...
    multiworld.get_location("Halloween Town Oogie's Manor Entrance Steps Chest"                            , player).access_rule = lambda state: has_item(state, player, "Forget-Me-Not")
    multiworld.get_location("Halloween Town Oogie's Manor Inside Entrance Chest"                           , player).access_rule = lambda state: has_item(state, player, "Forget-Me-Not")
   #multiworld.get_location("Halloween Town Bridge Left of Gate Chest"                                     , player).access_rule = lambda state: has_item(state, player, "")
   #multiworld.get_location("Halloween Town Cemetary By Striped Grave Chest"                               , player).access_rule = lambda state: has_item(state, player, "")
   ...
   #multiworld.get_location("Monstro Chamber 5 Platform Chest"                                             , player).access_rule = lambda state: has_item(state, player, "")
   ...
   #multiworld.get_location("Monstro Chamber 3 Platform Near Chamber 6 Entrance Chest"                     , player).access_rule = lambda state: has_item(state, player, "")
    multiworld.get_location("Monstro Mouth High Platform Near Teeth Chest"                                 , player).access_rule = lambda state: has_item(state, player, "High Jump")
   #multiworld.get_location("Monstro Chamber 5 Atop Barrel Chest"                                          , player).access_rule = lambda state: has_item(state, player, "")
   ...
   #multiworld.get_location("Monstro Chamber 5 Low 1st Chest"                                              , player).access_rule = lambda state: has_item(state, player, "")
    multiworld.get_location("Neverland Pirate Ship Deck White Trinity Chest"                               , player).access_rule = lambda state: has_item(state, player, "White Trinity")
   #multiworld.get_location("Neverland Pirate Ship Crows Nest Chest"                                       , player).access_rule = lambda state: has_item(state, player, "")
   ...
   #multiworld.get_location("Neverland Cabin Chest"                                                        , player).access_rule = lambda state: has_item(state, player, "")
   #multiworld.get_location("Neverland Hold Flight 1st Chest "                                             , player).access_rule = lambda state: has_item(state, player, "")
   #multiworld.get_location("Neverland Clock Tower Chest"                                                  , player).access_rule = lambda state: has_item(state, player, "")
   #multiworld.get_location("Neverland Hold Flight 2nd Chest"                                              , player).access_rule = lambda state: has_item(state, player, "")
   ...
   #multiworld.get_location("Neverland Captain's Cabin Chest"                                              , player).access_rule = lambda state: has_item(state, player, "")
   ...
   #multiworld.get_location("Hollow Bastion Rising Falls Under Water 2nd Chest"                            , player).access_rule = lambda state: has_item(state, player, "")
   #multiworld.get_location("Hollow Bastion Rising Falls Floating Platform Near Save Chest"                , player).access_rule = lambda state: has_item(state, player, "")
   #multiworld.get_location("Hollow Bastion Rising Falls Floating Platform Near Bubble Chest"              , player).access_rule = lambda state: has_item(state, player, "")
   #multiworld.get_location("Hollow Bastion Rising Falls High Platform Chest"                              , player).access_rule = lambda state: has_item(state, player, "")
   ...
   #multiworld.get_location("Hollow Bastion Library 2nd Floor Turn the Carousel 2nd Chest"                 , player).access_rule = lambda state: has_item(state, player, "")
    multiworld.get_location("Hollow Bastion Lift Stop Library Node After High Tower Switch Gravity Chest"  , player).access_rule = lambda state: has_item(state, player, "Progressive Gravity")
    multiworld.get_location("Hollow Bastion Lift Stop Library Node Gravity Chest"                          , player).access_rule = lambda state: has_item(state, player, "Progressive Gravity")
   #multiworld.get_location("Hollow Bastion Lift Stop Under High Tower Sliding Blocks Chest"               , player).access_rule = lambda state: has_item(state, player, "")
    multiworld.get_location("Hollow Bastion Lift Stop Outside Library Gravity Chest"                       , player).access_rule = lambda state: has_item(state, player, "Progressive Gravity")
   ...
   #multiworld.get_location("Hollow Bastion Waterway Near Save Chest"                                      , player).access_rule = lambda state: has_item(state, player, "")
    multiworld.get_location("Hollow Bastion Waterway Blizzard on Bubble Chest"                             , player).access_rule = lambda state: has_item(state, player, "Progressive Blizzard")
   ...
   #multiworld.get_location("Chronicles Halloween Town"                                                    , player).access_rule = lambda state: has_item(state, player, "")
   #multiworld.get_location("Chronicles Neverland"                                                         , player).access_rule = lambda state: has_item(state, player, "")
   ...
   #multiworld.get_location("Ansem's Secret Report 1"                                                      , player).access_rule = lambda state: has_item(state, player, "")
    ...
    multiworld.get_location("Ansem's Secret Report 7"                                                      , player).access_rule = lambda state: has_item(state, player, "Forget-Me-Not")
    multiworld.get_location("Ansem's Secret Report 8"                                                      , player).access_rule = lambda state: has_item(state, player, "Hades Cup") and has_x_worlds(state, player, 7) and has_item(state, player, "Entry Pass")
   #multiworld.get_location("Ansem's Secret Report 9"                                                      , player).access_rule = lambda state: has_item(state, player, "")
   ...
   #multiworld.get_location("Ansem's Secret Report 13"                                                     , player).access_rule = lambda state: has_item(state, player, "")
    ...
    multiworld.get_entrance("Atlantica"                                                                    , player).access_rule = lambda state: has_item(state, player,"Atlantica")
    multiworld.get_entrance("Halloween Town"                                                               , player).access_rule = lambda state: has_item(state, player,"Halloween Town")
