...
def set_rules(multiworld: MultiWorld, player: int):
   ...
   #multiworld.get_location("Traverse Town Accessory Shop Chest"                                           , player).access_rule = lambda state: has_item(state, player, "")
    multiworld.get_location("Traverse Town Secret Waterway White Trinity Chest"                            , player).access_rule = lambda state: has_item(state, player, "White Trinity") and has_item(state, player, "Red Trinity")
   ...
   #multiworld.get_location("Halloween Town Boneyard Tombstone Puzzle Chest"                               , player).access_rule = lambda state: has_item(state, player, "")
    ...
    multiworld.get_location("Halloween Town Cemetary Behind Grave Chest"                                   , player).access_rule = lambda state: has_item(state, player, "Jack-In-The-Box")
    multiworld.get_location("Halloween Town Cemetary By Cat Shape Chest"                                   , player).access_rule = lambda state: has_item(state, player, "Jack-In-The-Box")
    multiworld.get_location("Halloween Town Cemetary Between Graves Chest"                                 , player).access_rule = lambda state: has_item(state, player, "Jack-In-The-Box")
    multiworld.get_location("Halloween Town Oogie's Manor Lower Iron Cage Chest"                           , player).access_rule = lambda state: has_item(state, player, "Jack-In-The-Box")
    multiworld.get_location("Halloween Town Oogie's Manor Upper Iron Cage Chest"                           , player).access_rule = lambda state: has_item(state, player, "Jack-In-The-Box")
    multiworld.get_location("Halloween Town Oogie's Manor Hollow Chest"                                    , player).access_rule = lambda state: has_item(state, player, "Jack-In-The-Box")
   ...
   #multiworld.get_location("Ansem's Secret Report 1"                                                      , player).access_rule = lambda state: has_item(state, player, "")
    ...
    multiworld.get_location("Ansem's Secret Report 7"                                                      , player).access_rule = lambda state: has_item(state, player, "Jack-In-The-Box")
