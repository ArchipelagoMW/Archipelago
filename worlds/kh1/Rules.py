...
def set_rules(multiworld: MultiWorld, player: int, goal: str, atlantica: bool, required_reports: int):
    #Location rules.
    #Keys
   ...
   #multiworld.get_location("End of the World World Terminus Deep Jungle Chest"                            , player).access_rule = lambda state: has_item(state, player, "")
    multiworld.get_location("End of the World World Terminus Agrabah Chest"                                , player).access_rule = lambda state: has_item(state, player, "High Jump") and can_glide(state, player)
   ...
   #multiworld.get_location("Traverse Town Magician's Study Turn in all Summon Gems"                       , player).access_rule = lambda state: has_item(state, player, "Naturespark") and has_item(state, player, "Watergleam") and has_item(state, player, "Fireglow") and has_item(state, player, "Progressive Fire")
    multiworld.get_location("Traverse Town Geppetto's House Geppetto Reward 1"                             , player).access_rule = lambda state: has_item(state, player, "Monstro") and (has_item(state, player, "High Jump") or can_glide(state, player))
    multiworld.get_location("Traverse Town Geppetto's House Geppetto Reward 2"                             , player).access_rule = lambda state: has_item(state, player, "Monstro") and (has_item(state, player, "High Jump") or can_glide(state, player))
    multiworld.get_location("Traverse Town Geppetto's House Geppetto Reward 3"                             , player).access_rule = lambda state: has_item(state, player, "Monstro") and (has_item(state, player, "High Jump") or can_glide(state, player))
    multiworld.get_location("Traverse Town Geppetto's House Geppetto Reward 4"                             , player).access_rule = lambda state: has_item(state, player, "Monstro") and (has_item(state, player, "High Jump") or can_glide(state, player))
    multiworld.get_location("Traverse Town Geppetto's House Geppetto Reward 5"                             , player).access_rule = lambda state: has_item(state, player, "Monstro") and (has_item(state, player, "High Jump") or can_glide(state, player))
    multiworld.get_location("Traverse Town Geppetto's House Geppetto All Summons Reward"                   , player).access_rule = lambda state: has_item(state, player, "Monstro") and (has_item(state, player, "High Jump") or can_glide(state, player)) and has_all_summons(state, player)
