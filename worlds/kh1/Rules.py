...
def set_rules(multiworld: MultiWorld, player: int, sephiroth: bool, atlantica: bool):
   ...
   #multiworld.get_location("Wonderland Lotus Forest Nut Chest"                                            , player).access_rule = lambda state: has_item(state, player, "")
    ...
    multiworld.get_location("Wonderland Tea Party Garden Above Lotus Forest Entrance 2nd Chest"            , player).access_rule = lambda state: can_glide(state, player) or has_evidence(state, player)
    multiworld.get_location("Wonderland Tea Party Garden Above Lotus Forest Entrance 1st Chest"            , player).access_rule = lambda state: can_glide(state, player) or has_evidence(state, player)
    ...
    multiworld.get_location("Wonderland Tea Party Garden Across From Bizarre Room Entrance Chest"          , player).access_rule = lambda state: can_glide(state, player) or has_evidence(state, player)
