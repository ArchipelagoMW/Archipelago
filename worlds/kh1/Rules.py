...
def set_rules(multiworld: MultiWorld, player: int):
   ...
   #multiworld.get_location("Hollow Bastion Rising Falls Under Water 1st Chest"                            , player).access_rule = lambda state: has_item(state, player, "")
    ...
    multiworld.get_location("Hollow Bastion Rising Falls Floating Platform Near Save Chest"                , player).access_rule = lambda state: has_item(state, player, "High Jump") or has_item(state, player, "Glide") or has_item(state, player, "Progressive Blizzard")
    multiworld.get_location("Hollow Bastion Rising Falls Floating Platform Near Bubble Chest"              , player).access_rule = lambda state: has_item(state, player, "High Jump") or has_item(state, player, "Glide") or has_item(state, player, "Progressive Blizzard")
    multiworld.get_location("Hollow Bastion Rising Falls High Platform Chest"                              , player).access_rule = lambda state: has_item(state, player, "High Jump") or has_item(state, player, "Glide") or has_item(state, player, "Progressive Blizzard")
