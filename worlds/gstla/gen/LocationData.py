...
LocationData(48, 48, 16384000, 16384000,
        [16384000], 128, 0, LocationType.Djinn), # Flint
LocationData(49, 49, 16384002, 16384002,
        [16384002], 128, 1, LocationType.Djinn), # Granite
LocationData(50, 50, 16384004, 16384004,
        [16384004], 128, 2, LocationType.Djinn), # Quartz
LocationData(51, 51, 16384006, 16384006,
        [16384006], 128, 3, LocationType.Djinn), # Vine
LocationData(52, 52, 16384008, 16384008,
        [16384008], 128, 4, LocationType.Djinn), # Sap
LocationData(53, 53, 16384010, 16384010,
        [16384010], 128, 5, LocationType.Djinn), # Ground
LocationData(54, 54, 16384012, 16384012,
        [16384012], 128, 6, LocationType.Djinn), # Bane
LocationData(55, 55, 16384014, 16384014,
        [16384014], 128, 7, LocationType.Djinn), # Echo
LocationData(56, 56, 16384016, 16384016,
        [16384016], 128, 8, LocationType.Djinn), # Iron
LocationData(57, 57, 16384018, 16384018,
        [16384018], 128, 9, LocationType.Djinn), # Steel
LocationData(58, 58, 16384020, 16384020,
        [16384020], 128, 10, LocationType.Djinn), # Mud
LocationData(59, 59, 16384022, 16384022,
        [16384022], 128, 11, LocationType.Djinn), # Flower
LocationData(60, 60, 16384024, 16384024,
        [16384024], 128, 12, LocationType.Djinn), # Meld
LocationData(61, 61, 16384026, 16384026,
        [16384026], 128, 13, LocationType.Djinn), # Petra
LocationData(62, 62, 16384028, 16384028,
        [16384028], 128, 14, LocationType.Djinn), # Salt
LocationData(63, 63, 16384030, 16384030,
        [16384030], 128, 15, LocationType.Djinn), # Geode
LocationData(64, 64, 16384032, 16384032,
        [16384032], 128, 16, LocationType.Djinn), # Mold
LocationData(65, 65, 16384034, 16384034,
        [16384034], 128, 17, LocationType.Djinn), # Crystal
LocationData(68, 68, 16384036, 16384036,
        [16384036], 128, 0, LocationType.Djinn), # Fizz
LocationData(69, 69, 16384038, 16384038,
        [16384038], 128, 1, LocationType.Djinn), # Sleet
LocationData(70, 70, 16384040, 16384040,
        [16384040], 128, 2, LocationType.Djinn), # Mist
LocationData(71, 71, 16384042, 16384042,
        [16384042], 128, 3, LocationType.Djinn), # Spritz
LocationData(72, 72, 16384044, 16384044,
        [16384044], 128, 4, LocationType.Djinn), # Hail
LocationData(73, 73, 16384046, 16384046,
        [16384046], 128, 5, LocationType.Djinn), # Tonic
LocationData(74, 74, 16384048, 16384048,
        [16384048], 128, 6, LocationType.Djinn), # Dew
LocationData(75, 75, 16384050, 16384050,
        [16384050], 128, 7, LocationType.Djinn), # Fog
LocationData(76, 76, 16384052, 16384052,
        [16384052], 128, 8, LocationType.Djinn), # Sour
LocationData(77, 77, 16384054, 16384054,
        [16384054], 128, 9, LocationType.Djinn), # Spring
LocationData(78, 78, 16384056, 16384056,
        [16384056], 128, 10, LocationType.Djinn), # Shade
LocationData(79, 79, 16384058, 16384058,
        [16384058], 128, 11, LocationType.Djinn), # Chill
LocationData(80, 80, 16384060, 16384060,
        [16384060], 128, 12, LocationType.Djinn), # Steam
LocationData(81, 81, 16384062, 16384062,
        [16384062], 128, 13, LocationType.Djinn), # Rime
LocationData(82, 82, 16384064, 16384064,
        [16384064], 128, 14, LocationType.Djinn), # Gel
LocationData(83, 83, 16384066, 16384066,
        [16384066], 128, 15, LocationType.Djinn), # Eddy
LocationData(84, 84, 16384068, 16384068,
        [16384068], 128, 16, LocationType.Djinn), # Balm
LocationData(85, 85, 16384070, 16384070,
        [16384070], 128, 17, LocationType.Djinn), # Serac
LocationData(88, 88, 16384072, 16384072,
        [16384072], 128, 0, LocationType.Djinn), # Forge
LocationData(89, 89, 16384074, 16384074,
        [16384074], 128, 1, LocationType.Djinn), # Fever
LocationData(90, 90, 16384076, 16384076,
        [16384076], 128, 2, LocationType.Djinn), # Corona
LocationData(91, 91, 16384078, 16384078,
        [16384078], 128, 3, LocationType.Djinn), # Scorch
LocationData(92, 92, 16384080, 16384080,
        [16384080], 128, 4, LocationType.Djinn), # Ember
LocationData(93, 93, 16384082, 16384082,
        [16384082], 128, 5, LocationType.Djinn), # Flash
LocationData(94, 94, 16384084, 16384084,
        [16384084], 128, 6, LocationType.Djinn), # Torch
LocationData(95, 95, 16384086, 16384086,
        [16384086], 128, 7, LocationType.Djinn), # Cannon
LocationData(96, 96, 16384088, 16384088,
        [16384088], 128, 8, LocationType.Djinn), # Spark
LocationData(97, 97, 16384090, 16384090,
        [16384090], 128, 9, LocationType.Djinn), # Kindle
LocationData(98, 98, 16384092, 16384092,
        [16384092], 128, 10, LocationType.Djinn), # Char
LocationData(99, 99, 16384094, 16384094,
        [16384094], 128, 11, LocationType.Djinn), # Coal
LocationData(100, 100, 16384096, 16384096,
        [16384096], 128, 12, LocationType.Djinn), # Reflux
LocationData(101, 101, 16384098, 16384098,
        [16384098], 128, 13, LocationType.Djinn), # Core
LocationData(102, 102, 16384100, 16384100,
        [16384100], 128, 14, LocationType.Djinn), # Tinder
LocationData(103, 103, 16384102, 16384102,
        [16384102], 128, 15, LocationType.Djinn), # Shine
LocationData(104, 104, 16384104, 16384104,
        [16384104], 128, 16, LocationType.Djinn), # Fury
LocationData(105, 105, 16384106, 16384106,
        [16384106], 128, 17, LocationType.Djinn), # Fugue
LocationData(108, 108, 16384108, 16384108,
        [16384108], 128, 0, LocationType.Djinn), # Gust
LocationData(109, 109, 16384110, 16384110,
        [16384110], 128, 1, LocationType.Djinn), # Breeze
LocationData(110, 110, 16384112, 16384112,
        [16384112], 128, 2, LocationType.Djinn), # Zephyr
LocationData(111, 111, 16384114, 16384114,
        [16384114], 128, 3, LocationType.Djinn), # Smog
LocationData(112, 112, 16384116, 16384116,
        [16384116], 128, 4, LocationType.Djinn), # Kite
LocationData(113, 113, 16384118, 16384118,
        [16384118], 128, 5, LocationType.Djinn), # Squall
LocationData(114, 114, 16384120, 16384120,
        [16384120], 128, 6, LocationType.Djinn), # Luff
LocationData(115, 115, 16384122, 16384122,
        [16384122], 128, 7, LocationType.Djinn), # Breath
LocationData(116, 116, 16384124, 16384124,
        [16384124], 128, 8, LocationType.Djinn), # Blitz
LocationData(117, 117, 16384126, 16384126,
        [16384126], 128, 9, LocationType.Djinn), # Ether
LocationData(118, 118, 16384128, 16384128,
        [16384128], 128, 10, LocationType.Djinn), # Waft
LocationData(119, 119, 16384130, 16384130,
        [16384130], 128, 11, LocationType.Djinn), # Haze
LocationData(120, 120, 16384132, 16384132,
        [16384132], 128, 12, LocationType.Djinn), # Wheeze
LocationData(121, 121, 16384134, 16384134,
        [16384134], 128, 13, LocationType.Djinn), # Aroma
LocationData(122, 122, 16384136, 16384136,
        [16384136], 128, 14, LocationType.Djinn), # Whorl
LocationData(123, 123, 16384138, 16384138,
        [16384138], 128, 15, LocationType.Djinn), # Gasp
LocationData(124, 124, 16384140, 16384140,
        [16384140], 128, 16, LocationType.Djinn), # Lull
LocationData(125, 125, 16384142, 16384142,
        [16384142], 128, 17, LocationType.Djinn), # Gale

]

summon_tablets = [
    LocationData(19, 19, 19, 992068, [992068],
            132, 3859,  LocationType.Item,
            LocationRestriction(0)), #Moloch
    LocationData(24, 24, 24, 992212, [992212],
            132, 3864,  LocationType.Item,
            LocationRestriction(0)), #Daedalus
    LocationData(18, 18, 18, 992632, [992632],
            132, 3858,  LocationType.Item,
            LocationRestriction(0)), #Flora
    LocationData(20, 20, 20, 993424, [993424],
            132, 3860,  LocationType.Item,
            LocationRestriction(0)), #Ulysses
    LocationData(25, 25, 25, 994300, [994300],
            132, 3865,  LocationType.Item,
            LocationRestriction(0)), #Azul
    LocationData(16, 16, 16, 994844, [994844],
            132, 3856,  LocationType.Item,
            LocationRestriction(0)), #Zagan
    LocationData(17, 17, 17, 994856, [994856],
            132, 3857,  LocationType.Item,
            LocationRestriction(0)), #Megaera
    LocationData(21, 21, 21, 994868, [994868],
            132, 3861,  LocationType.Item,
            LocationRestriction(0)), #Haures
    LocationData(23, 23, 23, 994880, [994880],
            132, 3863,  LocationType.Item,
            LocationRestriction(0)), #Coatlicue
    LocationData(26, 26, 26, 994892, [994892],
            132, 3866,  LocationType.Item,
            LocationRestriction(0)), #Catastrophe
    LocationData(27, 27, 27, 994904, [994904],
            132, 3867,  LocationType.Item,
            LocationRestriction(0)), #Charon
    LocationData(28, 28, 28, 994916, [994916],
            132, 3868,  LocationType.Item,
            LocationRestriction(0)), #Iris
    LocationData(2315, 2315, 2315, 16384198, [16384198],
            132, 3862,  LocationType.Item,
            LocationRestriction(0)), #Eclipse
    
]

psyenergy_locations = [
    LocationData(2260, 2260, 2260, 16384190, [16384190],
        132, 3728, LocationType.Psyenergy,
        LocationRestriction(3)), # Reveal
    LocationData(2478, 2478, 2478, 16384192, [16384192],
        132, 3722, LocationType.Psyenergy,
        LocationRestriction(3)), # Parch
    LocationData(2490, 2490, 2490, 16384194, [16384194],
        132, 3723, LocationType.Psyenergy,
        LocationRestriction(3)), # Sand
    LocationData(2554, 2554, 2554, 16384196, [16384196],
        132, 3738, LocationType.Psyenergy,
        LocationRestriction(3)), # Blaze
    LocationData(2, 6, 2, 16384204, [16384204],
        132, 3725, LocationType.Psyenergy,
        LocationRestriction(4)), # Mind Read
    LocationData(3, 6, 3, 16384206, [16384206],
        132, 3662, LocationType.Psyenergy,
        LocationRestriction(4)), # Whirlwind
    LocationData(4, 4, 4, 16384208, [16384208],
        132, 3596, LocationType.Psyenergy,
        LocationRestriction(4)), # Growth
    
]

events = [
    LocationData(1912, 1912, 5001, 5001, [0], 0,
        5001, LocationType.Event, LocationRestriction(7), True), # Mars Lighthouse - Doom Dragon Fight Victory
    LocationData(2219, 2219, 5002, 5002, [0], 0,
        5002, LocationType.Event, LocationRestriction(7), True), # Alhafra Briggs Briggs defeated
    LocationData(2431, 2431, 5003, 5003, [0], 0,
        5003, LocationType.Event, LocationRestriction(7), True), # Alhafra Prison Briggs Briggs escaped
    LocationData(2303, 2303, 5004, 5004, [0], 0,
        5004, LocationType.Event, LocationRestriction(7), True), # Gabomba Statue Gabomba Statue Completed
    LocationData(2542, 2542, 5005, 5005, [0], 0,
        5005, LocationType.Event, LocationRestriction(7), True), # Gaia Rock - Serpent Fight Serpent defeated
    LocationData(2269, 2269, 5006, 5006, [0], 0,
        5006, LocationType.Event, LocationRestriction(7), True), # Sea of Time - Poseidon fight Poseidon defeated
    LocationData(2367, 2367, 5007, 5007, [0], 0,
        5007, LocationType.Event, LocationRestriction(7), True), # Lemurian Ship - Aqua Hydra fight Aqua Hydra defeated
    LocationData(2381, 2381, 5008, 5008, [0], 0,
        5008, LocationType.Event, LocationRestriction(7), True), # Shaman Village - Moapa fight Moapa defeated
    LocationData(2593, 2593, 5009, 5009, [0], 0,
        5009, LocationType.Event, LocationRestriction(7), True), # Jupiter_Lighthouse Aeri - Agatio and Karst fight Jupiter Beacon Lit
    LocationData(2635, 2635, 5010, 5010, [0], 0,
        5010, LocationType.Event, LocationRestriction(7), True), # Mars Lighthouse - Flame Dragons fight Flame Dragons - defeated
    LocationData(2270, 2270, 5011, 5011, [0], 0,
        5011, LocationType.Event, LocationRestriction(7), True), # Lemurian Ship - Engine Room Ship
...
the_rest = [
    LocationData(3841, 3841, 3841, 991776,
        [991776, 991796], 2, 180,
        LocationType.Hidden, LocationRestriction(0)), # Daila Herb
    LocationData(3842, 3842, 3842, 991784,
        [991784, 991804], 3, 226,
        LocationType.Hidden, LocationRestriction(0)), # Daila Smoke Bomb
    LocationData(3934, 3934, 3934, 991812,
        [991812], 131, 186,
        LocationType.Hidden, LocationRestriction(0)), # Daila Psy Crystal
    LocationData(3858, 3858, 3858, 991824,
        [991824], 3, 229,
        LocationType.Hidden, LocationRestriction(0)), # N Osenia Islet Lucky Medal
    LocationData(3843, 3843, 3843, 991832,
        [991832], 3, 227,
        LocationType.Hidden, LocationRestriction(0)), # Daila Sleep Bomb
    LocationData(3844, 3844, 3844, 991840,
        [991840], 2, 32771,
        LocationType.Hidden, LocationRestriction(0)), # Daila 3 coins
    LocationData(3845, 3845, 3845, 991848,
        [991848], 2, 32780,
        LocationType.Hidden, LocationRestriction(0)), # Daila 12 coins
    ...
    LocationData(3696, 3696, 3696, 991872,
        [991872], 129, 0,
        LocationType.Item, LocationRestriction(0)), # Kandorean Temple Mimic
    ...
    LocationData(3853, 3853, 3853, 991948,
        [991948], 13, 187,
        LocationType.Hidden, LocationRestriction(0)), # Madra Antidote
    LocationData(2328, 2328, 2328, 16384166,
        [16384166, 991956], 128, 3721,
        LocationType.Item, LocationRestriction(3)), # Madra Cyclone Chip
    LocationData(3854, 3854, 3854, 991968,
        [991968], 3, 226,
        LocationType.Hidden, LocationRestriction(0)), # Madra Smoke Bomb
    LocationData(3855, 3855, 3855, 991976,
        [991976], 13, 32783,
        LocationType.Hidden, LocationRestriction(0)), # Madra 15 coins
    LocationData(3856, 3856, 3856, 991984,
        [991984], 2, 227,
        LocationType.Hidden, LocationRestriction(0)), # Madra Sleep Bomb
    LocationData(3857, 3857, 3857, 991996,
        [991996], 2, 188,
        LocationType.Hidden, LocationRestriction(0)), # Madra Elixir
    ...
    LocationData(3977, 3977, 3977, 992128,
        [992128], 131, 33083,
        LocationType.Hidden, LocationRestriction(0)), # Yampi Desert 315 coins
    ...
    LocationData(3979, 3979, 3979, 992204,
        [992204], 131, 435,
        LocationType.Item, LocationRestriction(0)), # Yampi Desert Cave Mythril Silver
    ...
    LocationData(3870, 3870, 3870, 992252,
        [992252], 2, 227,
        LocationType.Hidden, LocationRestriction(0)), # Alhafra Sleep Bomb
    LocationData(3871, 3871, 3871, 992260,
        [992260], 2, 229,
        LocationType.Hidden, LocationRestriction(0)), # Alhafra Lucky Medal
    LocationData(3872, 3872, 3872, 992268,
        [992268], 13, 32800,
        LocationType.Hidden, LocationRestriction(0)), # Alhafra 32 coins
    LocationData(3873, 3873, 3873, 992280,
        [992280], 2, 226,
        LocationType.Hidden, LocationRestriction(0)), # Alhafra Smoke Bomb
    LocationData(3875, 3875, 3875, 992304,
        [992304], 3, 188,
        LocationType.Hidden, LocationRestriction(0)), # Alhafra Elixir
    LocationData(3876, 3876, 3876, 992312,
        [992312], 2, 193,
        LocationType.Hidden, LocationRestriction(0)), # Alhafra Apple
    ...
    LocationData(3982, 3982, 3982, 992348,
        [992348], 2, 191,
        LocationType.Hidden, LocationRestriction(0)), # Alhafran Cave Power Bread
    ...
    LocationData(3881, 3881, 3881, 992396,
        [992396], 13, 181,
        LocationType.Hidden, LocationRestriction(0)), # Mikasalla Nut
    LocationData(3882, 3882, 3882, 992404,
        [992404], 3, 188,
        LocationType.Hidden, LocationRestriction(0)), # Mikasalla Elixir
    LocationData(3883, 3883, 3883, 992416,
        [992416], 3, 196,
        LocationType.Hidden, LocationRestriction(0)), # Mikasalla Lucky Pepper
    LocationData(3884, 3884, 3884, 992424,
        [992424], 2, 180,
        LocationType.Hidden, LocationRestriction(0)), # Mikasalla Herb
    LocationData(3986, 3986, 3986, 992432,
        [992432], 2, 229,
        LocationType.Hidden, LocationRestriction(0)), # E Tundaria Islet Lucky Medal
    ...
    LocationData(3886, 3886, 3886, 992456,
        [992456], 3, 181,
        LocationType.Hidden, LocationRestriction(0)), # Garoh Nut
    LocationData(3887, 3887, 3887, 992464,
        [992464], 3, 226,
        LocationType.Hidden, LocationRestriction(0)), # Garoh Smoke Bomb
    LocationData(3888, 3888, 3888, 992476,
        [992476], 2, 227,
        LocationType.Hidden, LocationRestriction(0)), # Garoh Sleep Bomb
    LocationData(3889, 3889, 3889, 992484,
        [992484], 2, 188,
        LocationType.Hidden, LocationRestriction(0)), # Garoh Elixir
    ...
    LocationData(3697, 3697, 3697, 992520,
        [992520], 129, 1,
        LocationType.Item, LocationRestriction(0)), # Air's Rock Mimic
    ...
    LocationData(3904, 3904, 3904, 992656,
        [992656], 131, 448,
        LocationType.Item, LocationRestriction(0)), # Gondowan Cliffs Healing Fungus
    LocationData(3905, 3905, 3905, 992664,
        [992664], 131, 449,
        LocationType.Item, LocationRestriction(0)), # Gondowan Cliffs Laughing Fungus
    ...
    LocationData(3910, 3910, 3910, 992700,
        [992700], 2, 188,
        LocationType.Hidden, LocationRestriction(0)), # Naribwe Elixir
    LocationData(3911, 3911, 3911, 992712,
        [992712], 2, 32786,
        LocationType.Hidden, LocationRestriction(0)), # Naribwe 18 coins
    LocationData(3912, 3912, 3912, 992720,
        [992720], 2, 227,
        LocationType.Hidden, LocationRestriction(0)), # Naribwe Sleep Bomb
    ...
    LocationData(3916, 3916, 3916, 992764,
        [992764], 13, 226,
        LocationType.Hidden, LocationRestriction(0)), # Kibombo Mountains Smoke Bomb
    LocationData(3918, 3918, 3918, 992800,
        [992800, 992812], 2, 196,
        LocationType.Hidden, LocationRestriction(0)), # Kibombo Lucky Pepper
    LocationData(3919, 3919, 3919, 992824,
        [992824], 2, 229,
        LocationType.Hidden, LocationRestriction(0)), # Kibombo Lucky Medal
    LocationData(3920, 3920, 3920, 992832,
        [992832], 3, 181,
        LocationType.Hidden, LocationRestriction(0)), # Kibombo Nut
    ...
    LocationData(3698, 3698, 3698, 992852,
        [992852], 129, 2,
        LocationType.Item, LocationRestriction(0)), # Gabomba Statue Mimic
    ...
    LocationData(3923, 3923, 3923, 992876,
        [992876], 131, 195,
        LocationType.Hidden, LocationRestriction(0)), # Gabomba Catacombs Mint
    ...
    LocationData(3925, 3925, 3925, 992908,
        [992908], 3, 188,
        LocationType.Hidden, LocationRestriction(0)), # Lemurian Ship Elixir
    LocationData(3926, 3926, 3926, 992916,
        [992916], 13, 187,
        LocationType.Hidden, LocationRestriction(0)), # Lemurian Ship Antidote
    ...
    LocationData(3927, 3927, 3927, 992936,
        [992936, 992944], 3, 238,
        LocationType.Hidden, LocationRestriction(0)), # Lemurian Ship Oil Drop
    ...
    LocationData(2247, 2247, 2247, 992980,
        [992980], 131, 439,
        LocationType.Item, LocationRestriction(0)), # Shrine of the Sea God Right Prong
    LocationData(3930, 3930, 3930, 992992,
        [992992], 3, 229,
        LocationType.Hidden, LocationRestriction(0)), # W Indra Islet Lucky Medal
    LocationData(3931, 3931, 3931, 993016,
        [993016], 13, 229,
        LocationType.Hidden, LocationRestriction(0)), # SE Angara Islet Lucky Medal
    LocationData(3932, 3932, 3932, 993028,
        [993028], 3, 229,
        LocationType.Hidden, LocationRestriction(0)), # Sea of Time Islet Lucky Medal
    LocationData(3936, 3936, 3936, 993040,
        [993040], 131, 181,
        LocationType.Hidden, LocationRestriction(0)), # Yallam Nut
    LocationData(3937, 3937, 3937, 993048,
        [993048], 2, 32784,
        LocationType.Hidden, LocationRestriction(0)), # Yallam 16 coins
    LocationData(3938, 3938, 3938, 993056,
        [993056], 131, 187,
        LocationType.Hidden, LocationRestriction(0)), # Yallam Antidote
    ...
    LocationData(3990, 3990, 3990, 993076,
        [993076], 13, 188,
        LocationType.Hidden, LocationRestriction(0)), # Yallam Elixir
    LocationData(3991, 3991, 3991, 993084,
        [993084], 3, 238,
        LocationType.Hidden, LocationRestriction(0)), # Yallam Oil Drop
    ...
    LocationData(3939, 3939, 3939, 993108,
        [993108], 131, 429,
        LocationType.Item, LocationRestriction(0)), # Taopo Swamp Tear Stone
    ...
    LocationData(3942, 3942, 3942, 993140,
        [993140], 131, 430,
        LocationType.Hidden, LocationRestriction(0)), # Taopo Swamp Star Dust
    LocationData(3993, 3993, 3993, 993152,
        [993152], 131, 240,
        LocationType.Hidden, LocationRestriction(0)), # Taopo Swamp Bramble Seed
    LocationData(3994, 3994, 3994, 993164,
        [993164], 131, 195,
        LocationType.Hidden, LocationRestriction(0)), # Apojii Islands Mint
    LocationData(3995, 3995, 3995, 993172,
        [993172], 131, 180,
        LocationType.Hidden, LocationRestriction(0)), # Apojii Islands Herb
    LocationData(3996, 3996, 3996, 993180,
        [993180], 2, 32950,
        LocationType.Hidden, LocationRestriction(0)), # Apojii Islands 182 coins
    LocationData(3997, 3997, 3997, 993192,
        [993192], 3, 32800,
        LocationType.Hidden, LocationRestriction(0)), # Apojii Islands 32 coins
    LocationData(3998, 3998, 3998, 993204,
        [993204], 131, 240,
        LocationType.Hidden, LocationRestriction(0)), # Apojii Islands Bramble Seed
    ...
    LocationData(3699, 3699, 3699, 993268,
        [993268], 129, 3,
        LocationType.Item, LocationRestriction(0)), # Aqua Rock Mimic
    ...
    LocationData(3999, 3999, 3999, 993360,
        [993360], 131, 187,
        LocationType.Hidden, LocationRestriction(0)), # Izumo Antidote
    LocationData(4000, 4000, 4000, 993368,
        [993368], 131, 187,
        LocationType.Hidden, LocationRestriction(0)), # Izumo Antidote
    LocationData(4001, 4001, 4001, 993376,
        [993376], 131, 229,
        LocationType.Hidden, LocationRestriction(0)), # Izumo Lucky Medal
    LocationData(4002, 4002, 4002, 993384,
        [993384], 2, 188,
        LocationType.Hidden, LocationRestriction(0)), # Izumo Elixir
    LocationData(4003, 4003, 4003, 993392,
        [993392], 2, 189,
        LocationType.Hidden, LocationRestriction(0)), # Izumo Water of Life
    LocationData(4004, 4004, 4004, 993404,
        [993404], 2, 226,
        LocationType.Hidden, LocationRestriction(0)), # Izumo Smoke Bomb
    LocationData(4005, 4005, 4005, 993412,
        [993412], 13, 343,
        LocationType.Hidden, LocationRestriction(0)), # Izumo Festival Coat
    ...
    LocationData(3700, 3700, 3700, 993476,
        [993476], 129, 4,
        LocationType.Item, LocationRestriction(0)), # Gaia Rock Mimic
    ...
    LocationData(3649, 3649, 3649, 993492,
        [993492], 131, 283,
        LocationType.Hidden, LocationRestriction(0)), # Gaia Rock Cloud Brand
    ...
    LocationData(4011, 4011, 4011, 993532,
        [993532], 13, 226,
        LocationType.Hidden, LocationRestriction(0)), # Champa Smoke Bomb
    LocationData(4012, 4012, 4012, 993540,
        [993540], 13, 32780,
        LocationType.Hidden, LocationRestriction(0)), # Champa 12 coins
    LocationData(4013, 4013, 4013, 993548,
        [993548], 2, 229,
        LocationType.Hidden, LocationRestriction(0)), # Champa Lucky Medal
    LocationData(4014, 4014, 4014, 993560,
        [993560], 13, 188,
        LocationType.Hidden, LocationRestriction(0)), # Champa Elixir
    LocationData(4015, 4015, 4015, 993572,
        [993572], 3, 227,
        LocationType.Hidden, LocationRestriction(0)), # Champa Sleep Bomb
    ...
    LocationData(3968, 3968, 3968, 993732,
        [993732], 131, 440,
        LocationType.Item, LocationRestriction(0)), # Ankohl Ruins Left Prong
    ...
    LocationData(2373, 2373, 2373, 16384200,
        [16384200, 993776], 128, 441,
        LocationType.Item, LocationRestriction(0)), # Tundaria Tower Center Prong
    ...
    LocationData(2377, 2377, 2377, 993828,
        [993828], 131, 3735,
        LocationType.Item, LocationRestriction(0)), # Tundaria Tower Burst Brooch
    LocationData(4025, 4025, 4025, 993864,
        [993864], 131, 229,
        LocationType.Hidden, LocationRestriction(0)), # Lemuria Lucky Medal
    LocationData(4026, 4026, 4026, 993872,
        [993872], 131, 417,
        LocationType.Hidden, LocationRestriction(0)), # Lemuria Rusty Sword
    LocationData(4027, 4027, 4027, 993880,
        [993880], 131, 194,
        LocationType.Hidden, LocationRestriction(0)), # Lemuria Hard Nut
    LocationData(4028, 4028, 4028, 993888,
        [993888], 131, 231,
        LocationType.Hidden, LocationRestriction(0)), # Lemuria Bone
    LocationData(4029, 4029, 4029, 993896,
        [993896], 131, 430,
        LocationType.Hidden, LocationRestriction(0)), # Lemuria Star Dust
    ...
    LocationData(4033, 4033, 4033, 993948,
        [993948], 8, 229,
        LocationType.Hidden, LocationRestriction(0)), # Gondowan Settlement Lucky Medal
    ...
    LocationData(4037, 4037, 4037, 994016,
        [994016], 3, 191,
        LocationType.Hidden, LocationRestriction(0)), # Contigo Power Bread
    LocationData(4038, 4038, 4038, 994024,
        [994024], 131, 233,
        LocationType.Item, LocationRestriction(0)), # Contigo Corn
    LocationData(4039, 4039, 4039, 994032,
        [994032], 131, 240,
        LocationType.Hidden, LocationRestriction(0)), # Contigo Bramble Seed
    ...
    LocationData(4041, 4041, 4041, 994052,
        [994052], 2, 229,
        LocationType.Hidden, LocationRestriction(0)), # Shaman Village Lucky Medal
    LocationData(4042, 4042, 4042, 994064,
        [994064], 3, 239,
        LocationType.Hidden, LocationRestriction(0)), # Shaman Village Weasel's Claw
    LocationData(4043, 4043, 4043, 994072,
        [994072], 2, 188,
        LocationType.Hidden, LocationRestriction(0)), # Shaman Village Elixir
    LocationData(4044, 4044, 4044, 994084,
        [994084], 2, 196,
        LocationType.Hidden, LocationRestriction(0)), # Shaman Village Lucky Pepper
    ...
    LocationData(3701, 3701, 3701, 994268,
        [994268], 129, 5,
        LocationType.Item, LocationRestriction(0)), # Treasure Isle Mimic
    ...
    LocationData(4066, 4066, 4066, 994312,
        [994312], 131, 195,
        LocationType.Hidden, LocationRestriction(0)), # Jupiter Lighthouse Mint
    ...
    LocationData(4071, 4071, 4071, 994376,
        [994376], 131, 243,
        LocationType.Item, LocationRestriction(0)), # Jupiter Lighthouse Red Key
    LocationData(3702, 3702, 3702, 994388,
        [994388], 129, 6,
        LocationType.Item, LocationRestriction(0)), # Jupiter Lighthouse Mimic
    LocationData(4072, 4072, 4072, 994396,
        [994396], 131, 244,
        LocationType.Item, LocationRestriction(0)), # Jupiter Lighthouse Blue Key
    ...
    LocationData(3703, 3703, 3703, 994536,
        [994536], 129, 7,
        LocationType.Item, LocationRestriction(0)), # Magma Rock Mimic
    LocationData(4085, 4085, 4085, 994548,
        [994548], 131, 435,
        LocationType.Hidden, LocationRestriction(0)), # Loho Mythril Silver
    LocationData(4086, 4086, 4086, 994556,
        [994556], 131, 434,
        LocationType.Item, LocationRestriction(0)), # Loho Golem Core
    LocationData(4087, 4087, 4087, 994564,
        [994564], 131, 434,
        LocationType.Item, LocationRestriction(0)), # Loho Golem Core
    LocationData(4088, 4088, 4088, 994572,
        [994572], 3, 241,
        LocationType.Hidden, LocationRestriction(0)), # Loho Crystal Powder
    LocationData(4089, 4089, 4089, 994584,
        [994584], 131, 436,
        LocationType.Item, LocationRestriction(0)), # Prox Dark Matter
    LocationData(4090, 4090, 4090, 994592,
        [994592], 2, 192,
        LocationType.Hidden, LocationRestriction(0)), # Prox Cookie
    LocationData(4091, 4091, 4091, 994604,
        [994604], 2, 183,
        LocationType.Hidden, LocationRestriction(0)), # Prox Potion
    LocationData(4092, 4092, 4092, 994612,
        [994612], 13, 236,
        LocationType.Hidden, LocationRestriction(0)), # Prox Sacred Feather
    ...
    LocationData(3704, 3704, 3704, 994644,
        [994644], 129, 8,
        LocationType.Item, LocationRestriction(0)), # Mars Lighthouse Mimic
    ...
    LocationData(3675, 3675, 3675, 994928,
        [994928], 133, 421,
        LocationType.Hidden, LocationRestriction(0)), # Overworld Rusty Axe
    LocationData(3676, 3676, 3676, 994936,
        [994936], 133, 424,
        LocationType.Hidden, LocationRestriction(0)), # Overworld Rusty Mace
    LocationData(3677, 3677, 3677, 994944,
        [994944], 133, 419,
        LocationType.Hidden, LocationRestriction(0)), # Overworld Rusty Sword
    LocationData(3678, 3678, 3678, 994952,
        [994952], 133, 427,
        LocationType.Hidden, LocationRestriction(0)), # Overworld Rusty Staff
    LocationData(3679, 3679, 3679, 994960,
        [994960], 133, 420,
        LocationType.Hidden, LocationRestriction(0)), # Overworld Rusty Sword
    LocationData(2122, 2122, 2122, 16384160,
        [16384160], 128, 3717,
        LocationType.Item, LocationRestriction(3)), # Kandorean Temple Lash Pebble
    LocationData(2168, 2168, 2168, 16384162,
        [16384162], 128, 3718,
        LocationType.Item, LocationRestriction(3)), # Dehkan Plateau Pound Cube
    LocationData(2188, 2188, 2188, 16384164,
        [16384164], 128, 3720,
        LocationType.Item, LocationRestriction(3)), # Yampi Desert Scoop Gem
    LocationData(2381, 2381, 2381, 16384168,
        [16384168], 128, 3737,
        LocationType.Item, LocationRestriction(3)), # Shaman Village Hover Jade
    LocationData(2618, 2618, 2618, 16384170,
        [16384170], 128, 222,
        LocationType.Item, LocationRestriction(3)), # Mars Lighthouse Mars Star
    LocationData(2303, 2303, 2303, 16384172,
        [16384172], 128, 242,
        LocationType.Item, LocationRestriction(3)), # Gabomba Statue Black Crystal
    LocationData(2424, 2424, 2424, 16384174,
        [16384174], 128, 326,
        LocationType.Item, LocationRestriction(3)), # Champa Trident
    LocationData(2722, 2722, 2722, 16384176,
        [16384176], 128, 452,
        LocationType.Trade, LocationRestriction(3)), # E Tundaria Islet Pretty Stone
    LocationData(2724, 2724, 2724, 16384178,
        [16384178], 128, 453,
        LocationType.Trade, LocationRestriction(3)), # SE Angara Islet Red Cloth
    LocationData(2723, 2723, 2723, 16384180,
        [16384180], 128, 454,
        LocationType.Trade, LocationRestriction(3)), # N Osenia Islet Milk
    LocationData(2721, 2721, 2721, 16384182,
        [16384182], 128, 455,
        LocationType.Trade, LocationRestriction(3)), # W Indra Islet Li'l Turtle
    LocationData(2592, 2592, 2592, 16384186,
        [16384186], 128, 458,
        LocationType.Item, LocationRestriction(3)), # Daila Sea God's Tear
    LocationData(2553, 2553, 2553, 16384188,
        [16384188], 128, 460,
        LocationType.Item, LocationRestriction(3)), # Magma Rock Magma Ball
    LocationData(1, 4, 1, 16384202,
        [16384202], 128, 65,
        LocationType.Item, LocationRestriction(4)), # Idejima Shaman's Rod
    LocationData(257, 3, 257, 16384210,
        [16384210], 128, 3731,
        LocationType.Item, LocationRestriction(6)), # Contigo Carry Stone
    LocationData(258, 2, 258, 16384212,
        [16384212], 128, 3727,
        LocationType.Item, LocationRestriction(6)), # Contigo Lifting Gem
    LocationData(259, 1, 259, 16384214,
        [16384214], 128, 3726,
        LocationType.Item, LocationRestriction(6)), # Contigo Orb of Force
    LocationData(260, 0, 260, 16384216,
        [16384216], 128, 3732,
        LocationType.Item, LocationRestriction(6)), # Contigo Catch Beads
    LocationData(261, 7, 261, 16384218,
        [16384218], 128, 3617,
        LocationType.Item, LocationRestriction(4)), # Kibombo Douse Drop
    LocationData(262, 7, 262, 16384220,
        [16384220], 128, 3608,
        LocationType.Item, LocationRestriction(4)), # Kibombo Frost Jewel
    LocationData(3328, 3328, 3328, 16384384,
        [16384384], 132, 3328,
        LocationType.Character, LocationRestriction(3)), # Contigo Isaac
    LocationData(3329, 3329, 3329, 16384386,
        [16384386], 132, 3329,
        LocationType.Character, LocationRestriction(3)), # Contigo Garet
    LocationData(3330, 3330, 3330, 16384388,
        [16384388], 132, 3330,
        LocationType.Character, LocationRestriction(3)), # Contigo Ivan
    LocationData(3331, 3331, 3331, 16384390,
        [16384390], 132, 3331,
        LocationType.Character, LocationRestriction(3)), # Contigo Mia
    LocationData(3333, 3333, 3333, 16384392,
        [16384392], 132, 3333,
        LocationType.Character, LocationRestriction(3)), # Idejima Jenna
    LocationData(3334, 3334, 3334, 16384394,
        [16384394], 132, 3334,
        LocationType.Character, LocationRestriction(3)), # Idejima Sheba
    LocationData(3335, 3335, 3335, 16384396,
        [16384396], 132, 3335,
        LocationType.Character, LocationRestriction(3)), # Kibombo Piers
