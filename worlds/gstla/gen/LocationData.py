...
LocationData(68, 16384036, [16384036], 128, 0, LocationType.Djinn), # Fizz
LocationData(69, 16384038, [16384038], 128, 1, LocationType.Djinn), # Sleet
LocationData(70, 16384040, [16384040], 128, 2, LocationType.Djinn), # Mist
LocationData(71, 16384042, [16384042], 128, 3, LocationType.Djinn), # Spritz
LocationData(72, 16384044, [16384044], 128, 4, LocationType.Djinn), # Hail
LocationData(73, 16384046, [16384046], 128, 5, LocationType.Djinn), # Tonic
LocationData(74, 16384048, [16384048], 128, 6, LocationType.Djinn), # Dew
LocationData(75, 16384050, [16384050], 128, 7, LocationType.Djinn), # Fog
LocationData(76, 16384052, [16384052], 128, 8, LocationType.Djinn), # Sour
LocationData(77, 16384054, [16384054], 128, 9, LocationType.Djinn), # Spring
LocationData(78, 16384056, [16384056], 128, 10, LocationType.Djinn), # Shade
LocationData(79, 16384058, [16384058], 128, 11, LocationType.Djinn), # Chill
LocationData(80, 16384060, [16384060], 128, 12, LocationType.Djinn), # Steam
LocationData(81, 16384062, [16384062], 128, 13, LocationType.Djinn), # Rime
LocationData(82, 16384064, [16384064], 128, 14, LocationType.Djinn), # Gel
LocationData(83, 16384066, [16384066], 128, 15, LocationType.Djinn), # Eddy
LocationData(84, 16384068, [16384068], 128, 16, LocationType.Djinn), # Balm
LocationData(85, 16384070, [16384070], 128, 17, LocationType.Djinn), # Serac
LocationData(88, 16384072, [16384072], 128, 0, LocationType.Djinn), # Forge
LocationData(89, 16384074, [16384074], 128, 1, LocationType.Djinn), # Fever
LocationData(90, 16384076, [16384076], 128, 2, LocationType.Djinn), # Corona
LocationData(91, 16384078, [16384078], 128, 3, LocationType.Djinn), # Scorch
LocationData(92, 16384080, [16384080], 128, 4, LocationType.Djinn), # Ember
LocationData(93, 16384082, [16384082], 128, 5, LocationType.Djinn), # Flash
LocationData(94, 16384084, [16384084], 128, 6, LocationType.Djinn), # Torch
LocationData(95, 16384086, [16384086], 128, 7, LocationType.Djinn), # Cannon
LocationData(96, 16384088, [16384088], 128, 8, LocationType.Djinn), # Spark
LocationData(97, 16384090, [16384090], 128, 9, LocationType.Djinn), # Kindle
LocationData(98, 16384092, [16384092], 128, 10, LocationType.Djinn), # Char
LocationData(99, 16384094, [16384094], 128, 11, LocationType.Djinn), # Coal
LocationData(100, 16384096, [16384096], 128, 12, LocationType.Djinn), # Reflux
LocationData(101, 16384098, [16384098], 128, 13, LocationType.Djinn), # Core
LocationData(102, 16384100, [16384100], 128, 14, LocationType.Djinn), # Tinder
LocationData(103, 16384102, [16384102], 128, 15, LocationType.Djinn), # Shine
LocationData(104, 16384104, [16384104], 128, 16, LocationType.Djinn), # Fury
LocationData(105, 16384106, [16384106], 128, 17, LocationType.Djinn), # Fugue
LocationData(108, 16384108, [16384108], 128, 0, LocationType.Djinn), # Gust
LocationData(109, 16384110, [16384110], 128, 1, LocationType.Djinn), # Breeze
LocationData(110, 16384112, [16384112], 128, 2, LocationType.Djinn), # Zephyr
LocationData(111, 16384114, [16384114], 128, 3, LocationType.Djinn), # Smog
LocationData(112, 16384116, [16384116], 128, 4, LocationType.Djinn), # Kite
LocationData(113, 16384118, [16384118], 128, 5, LocationType.Djinn), # Squall
LocationData(114, 16384120, [16384120], 128, 6, LocationType.Djinn), # Luff
LocationData(115, 16384122, [16384122], 128, 7, LocationType.Djinn), # Breath
LocationData(116, 16384124, [16384124], 128, 8, LocationType.Djinn), # Blitz
LocationData(117, 16384126, [16384126], 128, 9, LocationType.Djinn), # Ether
LocationData(118, 16384128, [16384128], 128, 10, LocationType.Djinn), # Waft
LocationData(119, 16384130, [16384130], 128, 11, LocationType.Djinn), # Haze
LocationData(120, 16384132, [16384132], 128, 12, LocationType.Djinn), # Wheeze
LocationData(121, 16384134, [16384134], 128, 13, LocationType.Djinn), # Aroma
LocationData(122, 16384136, [16384136], 128, 14, LocationType.Djinn), # Whorl
LocationData(123, 16384138, [16384138], 128, 15, LocationType.Djinn), # Gasp
LocationData(124, 16384140, [16384140], 128, 16, LocationType.Djinn), # Lull
LocationData(125, 16384142, [16384142], 128, 17, LocationType.Djinn), # Gale
...
the_rest = [
    LocationData(3841, 3841, [991776, 991796], 2, 180, LocationType.Hidden), # Daila Herb
    LocationData(3842, 3842, [991784, 991804], 3, 226, LocationType.Hidden), # Daila Smoke Bomb
    ...
    LocationData(2328, 2328, [16384166, 991956], 128, 3721, LocationType.Item), # Madra Cyclone Chip
    ...
    LocationData(3861, 3861, [992036, 992048], 128, 459, LocationType.Item), # Madra Catacombs Ruin Key
    ...
    LocationData(3918, 3918, [992800, 992812], 2, 196, LocationType.Hidden), # Kibombo Lucky Pepper
    ...
    LocationData(3927, 3927, [992936, 992944], 3, 238, LocationType.Hidden), # Lemurian Ship Oil Drop
    ...
    LocationData(2373, 2373, [16384200, 993776], 128, 441, LocationType.Item), # Tundaria Tower Center Prong
