...
ItemData(5, "Shamshir", ItemClassification.useful, 730176, ItemType.Weapon, False),
ItemData(6, "Silver Blade", ItemClassification.useful, 730220, ItemType.Weapon, False),
...
ItemData(20, "Ninja Blade", ItemClassification.useful, 730836, ItemType.Weapon, False),
ItemData(21, "Swift Sword", ItemClassification.useful, 730880, ItemType.Weapon, False),
...
ItemData(34, "Dragon Axe", ItemClassification.useful, 731452, ItemType.Weapon, False),
...
ItemData(47, "Righteous Mace", ItemClassification.useful, 732024, ItemType.Weapon, False),
ItemData(55, "Wooden Stick", ItemClassification.filler, 732376, ItemType.Weapon, False),
ItemData(56, "Magic Rod", ItemClassification.useful, 732420, ItemType.Weapon, False),
ItemData(57, "Witch's Wand", ItemClassification.useful, 732464, ItemType.Weapon, False),
ItemData(58, "Blessed Ankh", ItemClassification.useful, 732508, ItemType.Weapon, False),
ItemData(59, "Psynergy Rod", ItemClassification.useful, 732552, ItemType.Weapon, False),
ItemData(60, "Frost Wand", ItemClassification.useful, 732596, ItemType.Weapon, False),
ItemData(61, "Angelic Ankh", ItemClassification.useful, 732640, ItemType.Weapon, False),
ItemData(62, "Demonic Staff", ItemClassification.useful, 732684, ItemType.Weapon, False),
ItemData(63, "Crystal Rod", ItemClassification.useful, 732728, ItemType.Weapon, False),
...
ItemData(109, "Blessed Robe", ItemClassification.useful, 734752, ItemType.Armor, False),
ItemData(110, "Magical Cassock", ItemClassification.useful, 734796, ItemType.Armor, False),
ItemData(111, "Mysterious Robe", ItemClassification.useful, 734840, ItemType.Armor, False),
...
ItemData(122, "Mirrored Shield", ItemClassification.useful, 735324, ItemType.Shield, False),
...
ItemData(131, "War Gloves", ItemClassification.useful, 735720, ItemType.Shield, False),
...
ItemData(140, "Spirit Armlet", ItemClassification.useful, 736116, ItemType.Shield, False),
...
ItemData(159, "Jeweled Crown", ItemClassification.useful, 736952, ItemType.Helm, False),
...
ItemData(402, "Leather Boots", ItemClassification.useful, 747644, ItemType.Boots, False),
ItemData(404, "Safety Boots", ItemClassification.useful, 747732, ItemType.Boots, False),

]

forge_only: List[ItemData] = [
ItemData(272, "Huge Sword", ItemClassification.useful, 741924, ItemType.Weapon, False),
ItemData(273, "Mythril Blade", ItemClassification.useful, 741968, ItemType.Weapon, False),
ItemData(274, "Levatine", ItemClassification.useful, 742012, ItemType.Weapon, False),
ItemData(275, "Darksword", ItemClassification.useful, 742056, ItemType.Weapon, False),
ItemData(276, "Excalibur", ItemClassification.useful, 742100, ItemType.Weapon, False),
ItemData(277, "Robber's Blade", ItemClassification.useful, 742144, ItemType.Weapon, False),
ItemData(278, "Soul Brand", ItemClassification.useful, 742188, ItemType.Weapon, False),
ItemData(285, "Sylph Rapier", ItemClassification.useful, 742496, ItemType.Weapon, False),
ItemData(286, "Burning Sword", ItemClassification.useful, 742540, ItemType.Weapon, False),
ItemData(288, "Corsair's Edge", ItemClassification.useful, 742628, ItemType.Weapon, False),
ItemData(289, "Pirate's Sabre", ItemClassification.useful, 742672, ItemType.Weapon, False),
ItemData(295, "Apollo's Axe", ItemClassification.useful, 742936, ItemType.Weapon, False),
ItemData(296, "Gaia's Axe", ItemClassification.useful, 742980, ItemType.Weapon, False),
ItemData(297, "Stellar Axe", ItemClassification.useful, 743024, ItemType.Weapon, False),
ItemData(298, "Captain's Axe", ItemClassification.useful, 743068, ItemType.Weapon, False),
ItemData(299, "Viking Axe", ItemClassification.useful, 743112, ItemType.Weapon, False),
ItemData(305, "Comet Mace", ItemClassification.useful, 743376, ItemType.Weapon, False),
ItemData(306, "Tungsten Mace", ItemClassification.useful, 743420, ItemType.Weapon, False),
ItemData(307, "Demon Mace", ItemClassification.useful, 743464, ItemType.Weapon, False),
ItemData(308, "Hagbone Mace", ItemClassification.useful, 743508, ItemType.Weapon, False),
ItemData(313, "Cloud Wand", ItemClassification.useful, 743728, ItemType.Weapon, False),
ItemData(314, "Salamander Rod", ItemClassification.useful, 743772, ItemType.Weapon, False),
ItemData(315, "Nebula Wand", ItemClassification.useful, 743816, ItemType.Weapon, False),
ItemData(316, "Dracomace", ItemClassification.useful, 743860, ItemType.Weapon, False),
ItemData(317, "Glower Staff", ItemClassification.useful, 743904, ItemType.Weapon, False),
ItemData(318, "Goblin's Rod", ItemClassification.useful, 743948, ItemType.Weapon, False),
ItemData(328, "Planet Armor", ItemClassification.useful, 744388, ItemType.Armor, False),
ItemData(329, "Dragon Mail", ItemClassification.useful, 744432, ItemType.Armor, False),
ItemData(330, "Chronos Mail", ItemClassification.useful, 744476, ItemType.Armor, False),
ItemData(331, "Stealth Armor", ItemClassification.useful, 744520, ItemType.Armor, False),
ItemData(332, "Xylion Armor", ItemClassification.useful, 744564, ItemType.Armor, False),
ItemData(338, "Faery Vest", ItemClassification.useful, 744828, ItemType.Armor, False),
ItemData(339, "Mythril Clothes", ItemClassification.useful, 744872, ItemType.Armor, False),
ItemData(347, "Dragon Robe", ItemClassification.useful, 745224, ItemType.Armor, False),
ItemData(348, "Ardagh Robe", ItemClassification.useful, 745268, ItemType.Armor, False),
ItemData(353, "Luna Shield", ItemClassification.useful, 745488, ItemType.Shield, False),
ItemData(354, "Dragon Shield", ItemClassification.useful, 745532, ItemType.Shield, False),
ItemData(355, "Flame Shield", ItemClassification.useful, 745576, ItemType.Shield, False),
ItemData(356, "Terra Shield", ItemClassification.useful, 745620, ItemType.Shield, False),
ItemData(357, "Cosmos Shield", ItemClassification.useful, 745664, ItemType.Shield, False),
ItemData(361, "Aerial Gloves", ItemClassification.useful, 745840, ItemType.Shield, False),
ItemData(362, "Titan Gloves", ItemClassification.useful, 745884, ItemType.Shield, False),
ItemData(363, "Big Bang Gloves", ItemClassification.useful, 745928, ItemType.Shield, False),
ItemData(368, "Clear Bracelet", ItemClassification.useful, 746148, ItemType.Shield, False),
ItemData(369, "Mythril Armlet", ItemClassification.useful, 746192, ItemType.Shield, False),
ItemData(374, "Dragon Helm", ItemClassification.useful, 746412, ItemType.Helm, False),
ItemData(375, "Mythril Helm", ItemClassification.useful, 746456, ItemType.Helm, False),
ItemData(376, "Fear Helm", ItemClassification.useful, 746500, ItemType.Helm, False),
ItemData(377, "Millenium Helm", ItemClassification.useful, 746544, ItemType.Helm, False),
ItemData(382, "Floating Hat", ItemClassification.useful, 746764, ItemType.Helm, False),
ItemData(390, "Pure Circlet", ItemClassification.useful, 747116, ItemType.Helm, False),
ItemData(391, "Astral Circlet", ItemClassification.useful, 747160, ItemType.Helm, False),
ItemData(392, "Psychic Circlet", ItemClassification.useful, 747204, ItemType.Helm, False),
ItemData(393, "Demon Circlet", ItemClassification.useful, 747248, ItemType.Helm, False),
ItemData(403, "Dragon Boots", ItemClassification.useful, 747688, ItemType.Boots, False),
ItemData(409, "Spirit Ring", ItemClassification.useful, 747952, ItemType.Ring, False),
ItemData(410, "Stardust Ring", ItemClassification.useful, 747996, ItemType.Ring, False),

]

lucky_only: List[ItemData] = [
ItemData(280, "Hestia Blade", ItemClassification.useful, 742276, ItemType.Weapon, False),
ItemData(302, "Mighty Axe", ItemClassification.useful, 743244, ItemType.Weapon, False),
ItemData(320, "Fireman's Pole", ItemClassification.useful, 744036, ItemType.Weapon, False),
ItemData(335, "Erebus Armor", ItemClassification.useful, 744696, ItemType.Armor, False),
ItemData(341, "Wild Coat", ItemClassification.useful, 744960, ItemType.Armor, False),
ItemData(342, "Floral Dress", ItemClassification.useful, 745004, ItemType.Armor, False),
ItemData(359, "Aegis Shield", ItemClassification.useful, 745752, ItemType.Shield, False),
ItemData(364, "Crafted Gloves", ItemClassification.useful, 745972, ItemType.Shield, False),
ItemData(380, "Minerva Helm", ItemClassification.useful, 746676, ItemType.Helm, False),
ItemData(387, "Crown of Glory", ItemClassification.useful, 746984, ItemType.Helm, False),
ItemData(395, "Brilliant Circlet", ItemClassification.useful, 747336, ItemType.Helm, False),

]

non_vanilla: List[ItemData] = [
ItemData(8, "Arctic Blade", ItemClassification.useful, 730308, ItemType.Weapon, False),
ItemData(9, "Gaia Blade", ItemClassification.useful, 730352, ItemType.Weapon, False),
ItemData(11, "Muramasa", ItemClassification.useful, 730440, ItemType.Weapon, False),
ItemData(15, "Machete", ItemClassification.filler, 730616, ItemType.Weapon, False),
ItemData(22, "Elven Rapier", ItemClassification.useful, 730924, ItemType.Weapon, False),
ItemData(23, "Assassin Blade", ItemClassification.useful, 730968, ItemType.Weapon, False),
ItemData(24, "Mystery Blade", ItemClassification.useful, 731012, ItemType.Weapon, False),
ItemData(25, "Kikuichimonji", ItemClassification.useful, 731056, ItemType.Weapon, False),
ItemData(27, "Bandit's Sword", ItemClassification.useful, 731144, ItemType.Weapon, False),
ItemData(35, "Giant Axe", ItemClassification.useful, 731496, ItemType.Weapon, False),
ItemData(36, "Vulcan Axe", ItemClassification.useful, 731540, ItemType.Weapon, False),
ItemData(37, "Burning Axe", ItemClassification.useful, 731584, ItemType.Weapon, False),
ItemData(38, "Demon Axe", ItemClassification.useful, 731628, ItemType.Weapon, False),
ItemData(48, "Grievous Mace", ItemClassification.useful, 732068, ItemType.Weapon, False),
ItemData(49, "Blessed Mace", ItemClassification.useful, 732112, ItemType.Weapon, False),
ItemData(50, "Wicked Mace", ItemClassification.useful, 732156, ItemType.Weapon, False),
ItemData(64, "Zodiac Wand", ItemClassification.useful, 732772, ItemType.Weapon, False),
ItemData(81, "Spirit Armor", ItemClassification.useful, 733520, ItemType.Armor, False),
ItemData(82, "Dragon Scales", ItemClassification.useful, 733564, ItemType.Armor, False),
ItemData(83, "Demon Mail", ItemClassification.useful, 733608, ItemType.Armor, False),
ItemData(84, "Asura's Armor", ItemClassification.useful, 733652, ItemType.Armor, False),
ItemData(85, "Spiked Armor", ItemClassification.useful, 733696, ItemType.Armor, False),
ItemData(91, "Fur Coat", ItemClassification.filler, 733960, ItemType.Armor, False),
ItemData(93, "Elven Shirt", ItemClassification.useful, 734048, ItemType.Armor, False),
ItemData(95, "Water Jacket", ItemClassification.useful, 734136, ItemType.Armor, False),
ItemData(96, "Storm Gear", ItemClassification.useful, 734180, ItemType.Armor, False),
ItemData(97, "Kimono", ItemClassification.useful, 734224, ItemType.Armor, False),
ItemData(98, "Ninja Garb", ItemClassification.useful, 734268, ItemType.Armor, False),
ItemData(106, "China Dress", ItemClassification.useful, 734620, ItemType.Armor, False),
ItemData(108, "Cocktail Dress", ItemClassification.useful, 734708, ItemType.Armor, False),
ItemData(112, "Feathered Robe", ItemClassification.useful, 734884, ItemType.Armor, False),
ItemData(113, "Oracle's Robe", ItemClassification.useful, 734928, ItemType.Armor, False),
ItemData(123, "Dragon Shield GS", ItemClassification.useful, 735368, ItemType.Shield, False),
ItemData(124, "Earth Shield", ItemClassification.useful, 735412, ItemType.Shield, False),
ItemData(130, "Vambrace", ItemClassification.useful, 735676, ItemType.Shield, False),
ItemData(132, "Spirit Gloves GS", ItemClassification.useful, 735764, ItemType.Shield, False),
ItemData(133, "Battle Gloves", ItemClassification.useful, 735808, ItemType.Shield, False),
ItemData(134, "Aura Gloves", ItemClassification.useful, 735852, ItemType.Shield, False),
ItemData(141, "Virtuous Armlet", ItemClassification.useful, 736160, ItemType.Shield, False),
ItemData(142, "Guardian Armlet", ItemClassification.useful, 736204, ItemType.Shield, False),
ItemData(151, "Warrior's Helm", ItemClassification.useful, 736600, ItemType.Helm, False),
ItemData(152, "Adept's Helm", ItemClassification.useful, 736644, ItemType.Helm, False),
ItemData(160, "Ninja Hood", ItemClassification.useful, 736996, ItemType.Helm, False),
ItemData(161, "Lucky Cap", ItemClassification.useful, 737040, ItemType.Helm, False),
ItemData(162, "Thunder Crown", ItemClassification.useful, 737084, ItemType.Helm, False),
ItemData(163, "Prophet's Hat", ItemClassification.useful, 737128, ItemType.Helm, False),
ItemData(164, "Lure Cap", ItemClassification.useful, 737172, ItemType.Helm, False),
ItemData(170, "Mythril Circlet", ItemClassification.useful, 737436, ItemType.Helm, False),
ItemData(171, "Glittering Tiara", ItemClassification.useful, 737480, ItemType.Helm, False),
ItemData(250, "Mythril Shirt", ItemClassification.useful, 740956, ItemType.Shirt, False),
ItemData(251, "Silk Shirt", ItemClassification.useful, 741000, ItemType.Shirt, False),
ItemData(252, "Running Shirt", ItemClassification.useful, 741044, ItemType.Shirt, False),
ItemData(256, "Hyper Boots", ItemClassification.useful, 741220, ItemType.Boots, False),
ItemData(257, "Quick Boots", ItemClassification.useful, 741264, ItemType.Boots, False),
ItemData(258, "Fur Boots", ItemClassification.useful, 741308, ItemType.Boots, False),
ItemData(262, "Adept Ring", ItemClassification.useful, 741484, ItemType.Ring, False),
ItemData(263, "War Ring", ItemClassification.useful, 741528, ItemType.Ring, False),
ItemData(264, "Sleep Ring", ItemClassification.useful, 741572, ItemType.Ring, False),
ItemData(265, "Healing Ring", ItemClassification.useful, 741616, ItemType.Ring, False),
ItemData(267, "Fairy Ring", ItemClassification.useful, 741704, ItemType.Ring, False),
ItemData(268, "Cleric's Ring", ItemClassification.useful, 741748, ItemType.Ring, False),
ItemData(282, "Rune Blade", ItemClassification.useful, 742364, ItemType.Weapon, False),
ItemData(293, "Tisiphone Edge", ItemClassification.useful, 742848, ItemType.Weapon, False),
ItemData(303, "Tartarus Axe", ItemClassification.useful, 743288, ItemType.Weapon, False),
ItemData(310, "Rising Mace", ItemClassification.useful, 743596, ItemType.Weapon, False),
ItemData(321, "Atropos' Rod", ItemClassification.useful, 744080, ItemType.Weapon, False),
ItemData(322, "Lachesis' Rule", ItemClassification.useful, 744124, ItemType.Weapon, False),
ItemData(323, "Clotho's Distaff", ItemClassification.useful, 744168, ItemType.Weapon, False),
ItemData(324, "Staff of Anubis", ItemClassification.useful, 744212, ItemType.Weapon, False),
ItemData(345, "Triton's Ward", ItemClassification.useful, 745136, ItemType.Armor, False),
ItemData(350, "Aeolian Cassock", ItemClassification.useful, 745356, ItemType.Armor, False),
ItemData(365, "Riot Gloves", ItemClassification.useful, 746016, ItemType.Shield, False),
ItemData(372, "Leda's Bracelet", ItemClassification.useful, 746324, ItemType.Shield, False),
ItemData(379, "Gloria Helm", ItemClassification.useful, 746632, ItemType.Helm, False),
ItemData(385, "Otafuku Mask", ItemClassification.useful, 746896, ItemType.Helm, False),
ItemData(386, "Hiotoko Mask", ItemClassification.useful, 746940, ItemType.Helm, False),
ItemData(396, "Berserker Band", ItemClassification.useful, 747380, ItemType.Helm, False),
ItemData(398, "Divine Camisole", ItemClassification.useful, 747468, ItemType.Shirt, False),
ItemData(399, "Herbed Shirt", ItemClassification.useful, 747512, ItemType.Shirt, False),
ItemData(400, "Golden Shirt", ItemClassification.useful, 747556, ItemType.Shirt, False),
ItemData(401, "Casual Shirt", ItemClassification.useful, 747600, ItemType.Shirt, False),
ItemData(405, "Knight's Greave", ItemClassification.useful, 747776, ItemType.Boots, False),
ItemData(406, "Silver Greave", ItemClassification.useful, 747820, ItemType.Boots, False),
ItemData(407, "Ninja Sandals", ItemClassification.useful, 747864, ItemType.Boots, False),
ItemData(408, "Golden Boots", ItemClassification.useful, 747908, ItemType.Boots, False),
ItemData(411, "Aroma Ring", ItemClassification.useful, 748040, ItemType.Ring, False),
ItemData(412, "Rainbow Ring", ItemClassification.useful, 748084, ItemType.Ring, False),
ItemData(413, "Soul Ring", ItemClassification.useful, 748128, ItemType.Ring, False),
ItemData(415, "Golden Ring", ItemClassification.useful, 748216, ItemType.Ring, False),
