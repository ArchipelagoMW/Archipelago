...
remainder: List[ItemData] = [
    ItemData(3696, "Mimic 0", ItemClassification.filler, 991872, ItemType.Consumable, True),
    ItemData(3697, "Mimic 1", ItemClassification.filler, 992520, ItemType.Consumable, True),
    ItemData(3698, "Mimic 2", ItemClassification.filler, 992852, ItemType.Consumable, True),
    ItemData(3699, "Mimic 3", ItemClassification.filler, 993268, ItemType.Consumable, True),
    ItemData(3700, "Mimic 4", ItemClassification.filler, 993476, ItemType.Consumable, True),
    ItemData(3701, "Mimic 5", ItemClassification.filler, 994268, ItemType.Consumable, True),
    ItemData(3702, "Mimic 6", ItemClassification.filler, 994388, ItemType.Consumable, True),
    ItemData(3703, "Mimic 7", ItemClassification.filler, 994536, ItemType.Consumable, True),
    ItemData(3704, "Mimic 8", ItemClassification.filler, 994644, ItemType.Consumable, True),
