...
djinn_items: List[InternalDjinnItemData] = [
    InternalDjinnItemData(0, name_by_item_id[16384000], 16384000, ElementType(ElementType.Earth), 814004, [8, 4, 3, 0, 0, 0]),
    InternalDjinnItemData(1, name_by_item_id[16384002], 16384002, ElementType(ElementType.Earth), 814016, [9, 0, 0, 2, 2, 1]),
    InternalDjinnItemData(2, name_by_item_id[16384004], 16384004, ElementType(ElementType.Earth), 814028, [10, 3, 0, 0, 3, 0]),
    InternalDjinnItemData(3, name_by_item_id[16384006], 16384006, ElementType(ElementType.Earth), 814040, [12, 4, 0, 3, 0, 1]),
    InternalDjinnItemData(4, name_by_item_id[16384008], 16384008, ElementType(ElementType.Earth), 814052, [10, 0, 3, 0, 0, 1]),
    InternalDjinnItemData(5, name_by_item_id[16384010], 16384010, ElementType(ElementType.Earth), 814064, [9, 3, 0, 0, 3, 0]),
    InternalDjinnItemData(6, name_by_item_id[16384012], 16384012, ElementType(ElementType.Earth), 814076, [12, 0, 4, 0, 0, 0]),
    InternalDjinnItemData(7, name_by_item_id[16384014], 16384014, ElementType(ElementType.Earth), 814088, [9, 4, 3, 0, 0, 0]),
    InternalDjinnItemData(8, name_by_item_id[16384016], 16384016, ElementType(ElementType.Earth), 814100, [11, 0, 0, 2, 3, 0]),
    InternalDjinnItemData(9, name_by_item_id[16384018], 16384018, ElementType(ElementType.Earth), 814112, [9, 0, 4, 2, 0, 1]),
    InternalDjinnItemData(10, name_by_item_id[16384020], 16384020, ElementType(ElementType.Earth), 814124, [10, 4, 0, 0, 3, 0]),
    InternalDjinnItemData(11, name_by_item_id[16384022], 16384022, ElementType(ElementType.Earth), 814136, [12, 4, 0, 0, 0, 0]),
    InternalDjinnItemData(12, name_by_item_id[16384024], 16384024, ElementType(ElementType.Earth), 814148, [9, 0, 0, 0, 4, 1]),
    InternalDjinnItemData(13, name_by_item_id[16384026], 16384026, ElementType(ElementType.Earth), 814160, [11, 0, 0, 3, 0, 0]),
    InternalDjinnItemData(14, name_by_item_id[16384028], 16384028, ElementType(ElementType.Earth), 814172, [9, 5, 0, 0, 0, 1]),
    InternalDjinnItemData(15, name_by_item_id[16384030], 16384030, ElementType(ElementType.Earth), 814184, [12, 0, 6, 0, 0, 0]),
    InternalDjinnItemData(16, name_by_item_id[16384032], 16384032, ElementType(ElementType.Earth), 814196, [8, 0, 4, 0, 2, 1]),
    InternalDjinnItemData(17, name_by_item_id[16384034], 16384034, ElementType(ElementType.Earth), 814208, [10, 5, 0, 2, 0, 0]),
    InternalDjinnItemData(0, name_by_item_id[16384036], 16384036, ElementType(ElementType.Water), 814244, [9, 4, 0, 3, 0, 0]),
    InternalDjinnItemData(1, name_by_item_id[16384038], 16384038, ElementType(ElementType.Water), 814256, [12, 0, 3, 0, 0, 1]),
    InternalDjinnItemData(2, name_by_item_id[16384040], 16384040, ElementType(ElementType.Water), 814268, [11, 0, 4, 0, 0, 0]),
    InternalDjinnItemData(3, name_by_item_id[16384042], 16384042, ElementType(ElementType.Water), 814280, [8, 4, 0, 0, 3, 0]),
    InternalDjinnItemData(4, name_by_item_id[16384044], 16384044, ElementType(ElementType.Water), 814292, [9, 0, 4, 0, 0, 1]),
    InternalDjinnItemData(5, name_by_item_id[16384046], 16384046, ElementType(ElementType.Water), 814304, [8, 3, 0, 2, 0, 2]),
    InternalDjinnItemData(6, name_by_item_id[16384048], 16384048, ElementType(ElementType.Water), 814316, [13, 4, 0, 0, 4, 0]),
    InternalDjinnItemData(7, name_by_item_id[16384050], 16384050, ElementType(ElementType.Water), 814328, [9, 0, 0, 2, 2, 1]),
    InternalDjinnItemData(8, name_by_item_id[16384052], 16384052, ElementType(ElementType.Water), 814340, [8, 4, 3, 0, 0, 0]),
    InternalDjinnItemData(9, name_by_item_id[16384054], 16384054, ElementType(ElementType.Water), 814352, [11, 5, 0, 0, 0, 0]),
    InternalDjinnItemData(10, name_by_item_id[16384056], 16384056, ElementType(ElementType.Water), 814364, [9, 0, 0, 3, 0, 2]),
    InternalDjinnItemData(11, name_by_item_id[16384058], 16384058, ElementType(ElementType.Water), 814376, [10, 3, 0, 2, 0, 0]),
    InternalDjinnItemData(12, name_by_item_id[16384060], 16384060, ElementType(ElementType.Water), 814388, [10, 0, 5, 0, 0, 0]),
    InternalDjinnItemData(13, name_by_item_id[16384062], 16384062, ElementType(ElementType.Water), 814400, [10, 6, 0, 0, 0, 0]),
    InternalDjinnItemData(14, name_by_item_id[16384064], 16384064, ElementType(ElementType.Water), 814412, [9, 0, 5, 0, 2, 0]),
    InternalDjinnItemData(15, name_by_item_id[16384066], 16384066, ElementType(ElementType.Water), 814424, [9, 0, 0, 0, 3, 2]),
    InternalDjinnItemData(16, name_by_item_id[16384068], 16384068, ElementType(ElementType.Water), 814436, [13, 4, 0, 0, 0, 0]),
    InternalDjinnItemData(17, name_by_item_id[16384070], 16384070, ElementType(ElementType.Water), 814448, [12, 0, 3, 0, 0, 0]),
    InternalDjinnItemData(0, name_by_item_id[16384072], 16384072, ElementType(ElementType.Fire), 814484, [10, 0, 2, 0, 2, 2]),
    InternalDjinnItemData(1, name_by_item_id[16384074], 16384074, ElementType(ElementType.Fire), 814496, [8, 0, 3, 0, 2, 0]),
    InternalDjinnItemData(2, name_by_item_id[16384076], 16384076, ElementType(ElementType.Fire), 814508, [12, 3, 0, 3, 0, 1]),
    InternalDjinnItemData(3, name_by_item_id[16384078], 16384078, ElementType(ElementType.Fire), 814520, [8, 0, 3, 0, 0, 0]),
    InternalDjinnItemData(4, name_by_item_id[16384080], 16384080, ElementType(ElementType.Fire), 814532, [9, 4, 0, 2, 2, 0]),
    InternalDjinnItemData(5, name_by_item_id[16384082], 16384082, ElementType(ElementType.Fire), 814544, [14, 3, 0, 2, 0, 0]),
    InternalDjinnItemData(6, name_by_item_id[16384084], 16384084, ElementType(ElementType.Fire), 814556, [9, 0, 3, 0, 0, 1]),
    InternalDjinnItemData(7, name_by_item_id[16384086], 16384086, ElementType(ElementType.Fire), 814568, [10, 0, 3, 0, 0, 0]),
    InternalDjinnItemData(8, name_by_item_id[16384088], 16384088, ElementType(ElementType.Fire), 814580, [11, 6, 0, 0, 0, 0]),
    InternalDjinnItemData(9, name_by_item_id[16384090], 16384090, ElementType(ElementType.Fire), 814592, [8, 0, 5, 0, 0, 1]),
    InternalDjinnItemData(10, name_by_item_id[16384092], 16384092, ElementType(ElementType.Fire), 814604, [9, 0, 2, 0, 2, 1]),
    InternalDjinnItemData(11, name_by_item_id[16384094], 16384094, ElementType(ElementType.Fire), 814616, [11, 3, 0, 0, 3, 0]),
    InternalDjinnItemData(12, name_by_item_id[16384096], 16384096, ElementType(ElementType.Fire), 814628, [9, 0, 0, 3, 0, 2]),
    InternalDjinnItemData(13, name_by_item_id[16384098], 16384098, ElementType(ElementType.Fire), 814640, [8, 0, 4, 2, 0, 0]),
    InternalDjinnItemData(14, name_by_item_id[16384100], 16384100, ElementType(ElementType.Fire), 814652, [12, 5, 0, 0, 0, 0]),
    InternalDjinnItemData(15, name_by_item_id[16384102], 16384102, ElementType(ElementType.Fire), 814664, [9, 0, 3, 3, 2, 0]),
    InternalDjinnItemData(16, name_by_item_id[16384104], 16384104, ElementType(ElementType.Fire), 814676, [12, 4, 0, 0, 0, 0]),
    InternalDjinnItemData(17, name_by_item_id[16384106], 16384106, ElementType(ElementType.Fire), 814688, [11, 4, 0, 2, 0, 0]),
    InternalDjinnItemData(0, name_by_item_id[16384108], 16384108, ElementType(ElementType.Air), 814724, [9, 0, 2, 0, 2, 0]),
    InternalDjinnItemData(1, name_by_item_id[16384110], 16384110, ElementType(ElementType.Air), 814736, [12, 5, 0, 2, 0, 1]),
    InternalDjinnItemData(2, name_by_item_id[16384112], 16384112, ElementType(ElementType.Air), 814748, [11, 3, 0, 0, 2, 1]),
    InternalDjinnItemData(3, name_by_item_id[16384114], 16384114, ElementType(ElementType.Air), 814760, [9, 0, 3, 0, 0, 0]),
    InternalDjinnItemData(4, name_by_item_id[16384116], 16384116, ElementType(ElementType.Air), 814772, [8, 4, 0, 0, 3, 0]),
    InternalDjinnItemData(5, name_by_item_id[16384118], 16384118, ElementType(ElementType.Air), 814784, [10, 0, 5, 0, 0, 0]),
    InternalDjinnItemData(6, name_by_item_id[16384120], 16384120, ElementType(ElementType.Air), 814796, [11, 5, 0, 2, 0, 1]),
    InternalDjinnItemData(7, name_by_item_id[16384122], 16384122, ElementType(ElementType.Air), 814808, [9, 0, 0, 3, 4, 0]),
    InternalDjinnItemData(8, name_by_item_id[16384124], 16384124, ElementType(ElementType.Air), 814820, [10, 4, 3, 0, 0, 0]),
    InternalDjinnItemData(9, name_by_item_id[16384126], 16384126, ElementType(ElementType.Air), 814832, [8, 4, 0, 0, 3, 2]),
    InternalDjinnItemData(10, name_by_item_id[16384128], 16384128, ElementType(ElementType.Air), 814844, [11, 0, 4, 0, 0, 0]),
    InternalDjinnItemData(11, name_by_item_id[16384130], 16384130, ElementType(ElementType.Air), 814856, [10, 0, 0, 2, 3, 2]),
    InternalDjinnItemData(12, name_by_item_id[16384132], 16384132, ElementType(ElementType.Air), 814868, [9, 3, 5, 0, 0, 0]),
    InternalDjinnItemData(13, name_by_item_id[16384134], 16384134, ElementType(ElementType.Air), 814880, [11, 0, 0, 0, 3, 2]),
    InternalDjinnItemData(14, name_by_item_id[16384136], 16384136, ElementType(ElementType.Air), 814892, [9, 0, 4, 2, 0, 0]),
    InternalDjinnItemData(15, name_by_item_id[16384138], 16384138, ElementType(ElementType.Air), 814904, [12, 5, 0, 0, 0, 0]),
    InternalDjinnItemData(16, name_by_item_id[16384140], 16384140, ElementType(ElementType.Air), 814916, [11, 6, 0, 0, 0, 0]),
    InternalDjinnItemData(17, name_by_item_id[16384142], 16384142, ElementType(ElementType.Air), 814928, [10, 0, 0, 0, 5, 3]),
