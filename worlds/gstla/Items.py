...
from .gen.ItemData import (ItemData, events, all_items as all_gen_items,
                           djinn_items, psyenergy_list, psyenergy_as_item_list, summon_list)
from .GameData import ItemType
# from .gen.ItemData import all_items as alL_gen_items
...
def create_items(multiworld: MultiWorld, player: int):
    ...
    # print("Locations: %d Items: %d" % (len(all_locations), len(all_gen_items)))
    for loc in all_locations:
        ...
        if vanilla_item.id == 0:
            ...
            continue
        # if vanilla_item.progression == ItemClassification.filler:
        #     continue
        # if vanilla_item.progression != ItemClassification.progression:
        #     continue
        ap_item = create_item_direct(vanilla_item, player)
        # print(loc_names_by_id[loc.id])
        # print(ap_item)
        # print('')
        # new_pool.append(ap_item)
