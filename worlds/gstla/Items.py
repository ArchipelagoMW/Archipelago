...
test_items: List[ItemData] = [
   ...
   ItemData(12, ItemName.Mist_Potion, ItemClassification.filler, 738316, ItemType.Consumable, 190, 128),
    ...
    ItemData(58, ItemName.Rusty_Sword, ItemClassification.useful, 748348, ItemType.Forgeable, 418, 128),
    ...
    ItemData(58, ItemName.Rusty_Mace, ItemClassification.useful, 748568, ItemType.Forgeable, 423, 128),
    ...
    ItemData(58, ItemName.Rusty_Axe, ItemClassification.useful, 748524, ItemType.Forgeable, 422, 128),
