...
summon_list: List[ItemData] = [
   ItemData(400, ItemName.Moloch, ItemClassification.useful, 3859, ItemType.Psyenergy, 3859, 1, 132),
   ItemData(401, ItemName.Daedalus, ItemClassification.useful, 3864, ItemType.Psyenergy, 3864, 1, 132),
   ItemData(401, ItemName.Flora, ItemClassification.useful, 3858, ItemType.Psyenergy, 3858, 1, 132),
   ItemData(401, ItemName.Ulysses, ItemClassification.useful, 3860, ItemType.Psyenergy, 3860, 1, 132),
   ItemData(401, ItemName.Azul, ItemClassification.useful, 3865, ItemType.Psyenergy, 3865, 1, 132),
   ItemData(401, ItemName.Zagan, ItemClassification.useful, 3856, ItemType.Psyenergy, 3856, 1, 132),
   ItemData(401, ItemName.Megaera, ItemClassification.useful, 3857, ItemType.Psyenergy, 3857, 1, 132),
   ItemData(401, ItemName.Haures, ItemClassification.useful, 3861, ItemType.Psyenergy, 3861, 1, 132),
   ItemData(401, ItemName.Coatlicue, ItemClassification.useful, 3863, ItemType.Psyenergy, 3863, 1, 132),
   ItemData(401, ItemName.Catastrophe, ItemClassification.useful, 3866, ItemType.Psyenergy, 3866, 1, 132),
   ItemData(401, ItemName.Charon, ItemClassification.useful, 3867, ItemType.Psyenergy, 3867, 1, 132),
   ItemData(401, ItemName.Iris, ItemClassification.useful, 3868, ItemType.Psyenergy, 3868, 1, 132),
   ItemData(401, ItemName.Eclipse, ItemClassification.useful, 3862, ItemType.Psyenergy, 3862, 1, 132)
]

psynergy_list: List[ItemData] = [
   ItemData(374, ItemName.Growth, ItemClassification.progression, 3596, ItemType.Psyenergy, 3596, 1, 132),
   ItemData(375, ItemName.Whirlwind, ItemClassification.progression, 3662, ItemType.Psyenergy, 3662, 1, 132),
   ItemData(376, ItemName.Parch, ItemClassification.progression, 3722, ItemType.Psyenergy, 3722, 1, 132),
   ItemData(377, ItemName.Sand, ItemClassification.progression, 3723, ItemType.Psyenergy, 3723, 1, 132),
   ItemData(378, ItemName.Mind_Read, ItemClassification.progression, 3725, ItemType.Psyenergy, 3725, 1, 132),
   ItemData(379, ItemName.Reveal, ItemClassification.progression, 3728, ItemType.Psyenergy, 3728, 1, 132),
   ItemData(380, ItemName.Blaze, ItemClassification.progression, 3738, ItemType.Psyenergy, 3738, 1, 132)
]
...
psyenergy_as_item_list: List[ItemData] = [
   ...
   ItemData(313, ItemName.Lash_Pebble, ItemClassification.progression, 3717, ItemType.PsyenergyItem, 3717, 1, 128),
   ItemData(314, ItemName.Pound_Cube, ItemClassification.progression, 3718, ItemType.PsyenergyItem, 3718, 1, 128),
   ItemData(315, ItemName.Orb_of_Force, ItemClassification.progression, 3726, ItemType.PsyenergyItem, 3726, 1, 128),
   ItemData(316, ItemName.Douse_Drop, ItemClassification.progression, 3617, ItemType.PsyenergyItem, 3617, 1, 128),
   ItemData(317, ItemName.Frost_Jewel, ItemClassification.progression, 3608, ItemType.PsyenergyItem, 3608, 1, 128),
   ItemData(318, ItemName.Lifting_Gem, ItemClassification.progression, 3727, ItemType.PsyenergyItem, 3727, 1, 128),
   ItemData(321, ItemName.Carry_Stone, ItemClassification.progression, 3731, ItemType.PsyenergyItem, 3731, 1, 128),
   ItemData(322, ItemName.Catch_Beads, ItemClassification.progression, 3732, ItemType.PsyenergyItem, 3732, 1, 128),
   ItemData(323, ItemName.Tremor_Bit, ItemClassification.progression, 3719, ItemType.PsyenergyItem, 3719, 1, 128),
   ItemData(324, ItemName.Scoop_Gem, ItemClassification.progression, 3720, ItemType.PsyenergyItem, 3720, 1, 128),
   ItemData(325, ItemName.Cyclone_Chip, ItemClassification.progression, 3721, ItemType.PsyenergyItem, 3721, 1, 128),
   ItemData(326, ItemName.Burst_Brooch, ItemClassification.progression, 3735, ItemType.PsyenergyItem, 3735, 1, 131),
   ItemData(327, ItemName.Grindstone, ItemClassification.progression, 3736, ItemType.PsyenergyItem, 3736, 1, 128),
   ItemData(328, ItemName.Hover_Jade, ItemClassification.progression, 3737, ItemType.PsyenergyItem, 3737, 1, 128),
   ItemData(329, ItemName.Teleport_Lapis, ItemClassification.progression, 3740, ItemType.PsyenergyItem, 3740, 1, 128)
]
...
test_items: List[ItemData] = [
   ItemData(2, ItemName.Herb, ItemClassification.filler, 737876, ItemType.Consumable, 180, 9, 2),
   ItemData(20, ItemName.Smoke_Bomb, ItemClassification.filler, 739900, ItemType.Consumable, 226, 1, 3),
   ItemData(21, ItemName.Sleep_Bomb, ItemClassification.filler, 739944, ItemType.Consumable, 227, 1, 3),
   ItemData(8, ItemName.Psy_Crystal, ItemClassification.filler, 738140, ItemType.Consumable, 186, 1, 131),
   ItemData(61, ItemName.Sea_Gods_Tear, ItemClassification.progression, 750108, ItemType.KeyItem, 458, 1, 128),
   ItemData(371, ItemName.Mysterious_Card, ItemClassification.filler, 749448, ItemType.Class, 443, 1, 128),
   ItemData(3, ItemName.Nut, ItemClassification.filler, 737920, ItemType.Consumable, 181, 1, 128),
   ItemData(10, ItemName.Elixir, ItemClassification.filler, 738228, ItemType.Consumable, 188, 2, 128),
   ItemData(17, ItemName.Mint, ItemClassification.filler, 738536, ItemType.Consumable, 195, 1, 128),
   ItemData(142, ItemName.Themis_Axe, ItemClassification.filler, 743200, ItemType.Weapon, 301, 1, 128),
   ItemData(218, ItemName.Full_Metal_Vest, ItemClassification.filler, 744916, ItemType.Armor, 340, 1, 128),
   ItemData(9, ItemName.Antidote, ItemClassification.filler, 738184, ItemType.Consumable, 187, 1, 128),
   ItemData(300, ItemName.Nurses_Cap, ItemClassification.filler, 746808, ItemType.Helm, 383, 1, 128),

   ItemData(62, ItemName.Ruin_Key, ItemClassification.filler, 750152, ItemType.KeyItem, 459, 1, 128),
   ItemData(15, ItemName.Apple, ItemClassification.filler, 738448, ItemType.Consumable, 193, 1, 128),
   ItemData(23, ItemName.Lucky_Medal, ItemClassification.filler, 740032, ItemType.Consumable, 229, 1, 128),
   ItemData(12, ItemName.Mist_Potion, ItemClassification.filler, 738316, ItemType.Consumable, 190, 1, 128)
]


all_items: List[ItemData] = test_items + djinn_items + psyenergy_as_item_list + psynergy_list + summon_list
