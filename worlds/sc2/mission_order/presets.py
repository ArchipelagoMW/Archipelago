...
from ..options import ( 
    ...
    PlayerColorZergPrimal, PlayerColorNova, SelectRaces, EnabledCampaigns, EnableRaceSwapVariants, EnableMissionRaceBalancing, 
...
template_settings = {
    ...
    OPTION_NAME[SelectRaces]:                           {SC2Race.TERRAN.get_title()},
...
f2p_big_settings = {
    ...
    OPTION_NAME[ProgressionBalancing]:                  ProgressionBalancing.default,
    OPTION_NAME[GameDifficulty]:                        GameDifficulty.option_normal,
    OPTION_NAME[SelectRaces]:                           SelectRaces.valid_keys,
...
zerg_rush_settings = {
    ...
    OPTION_NAME[SelectRaces]:                           {SC2Race.ZERG.get_title()},
...
all_protoss_settings = {
    ...
    OPTION_NAME[ProgressionBalancing]:                  ProgressionBalancing.default,
    OPTION_NAME[GameDifficulty]:                        GameDifficulty.option_normal,
    OPTION_NAME[SelectRaces]:                           {SC2Race.PROTOSS.get_title()},
