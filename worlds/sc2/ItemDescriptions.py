...
item_descriptions = {
    ...
    ItemNames.RAVAGER_DEEP_TUNNEL: "Ravagers gain the Deep Tunnel ability, allowing them to burrow to any visible location on the map.",
    ItemNames.VIPER_PARASITIC_BOMB: "Vipers gain the Parasitic Bomb ability, which inflicts an area-damaging effect on an enemy air unit.",
    ...
    ItemNames.INFESTOR_INFESTED_TERRAN: "Infestors gain the Spawn Infested Terran ability.",
    ItemNames.INFESTOR_MICROBIAL_SHROUD: "Infestors gain the Microbial Shroud ability, which reduces incoming damage from air units in an area.",
    ItemNames.SWARM_QUEEN_SPAWN_LARVAE: "Swarm Queens gain the Spawn Larvae ability.",
    ItemNames.SWARM_QUEEN_DEEP_TUNNEL: "Swarm Queens gain the Deep Tunnel ability.",
    ...
    ItemNames.BROOD_QUEEN_FUNGAL_GROWTH: "Brood Queens gain the Fungal Growth ability.",
    ItemNames.BROOD_QUEEN_ENSNARE: "Brood Queens gain the Ensnare ability.",
    ...
    ItemNames.DARK_TEMPLAR_AVENGER_BLOOD_HUNTER_BLINK: "Dark Templar, Avengers, and Blood Hunters gain the Blink ability.",
    ...
    ItemNames.HIGH_TEMPLAR_SIGNIFIER_HALLUCINATION: "High Templar and Signifiers gain the Hallucination ability, which creates 2 hallucinated copies of a target unit.",
    ...
    ItemNames.DARK_ARCHON_FEEDBACK: "Dark Archons gain the Feedback ability, which drains all energy from a target and deals 1 damage per point of energy drained.",
    ...
    ItemNames.SENTRY_HALLUCINATION: "Sentries gain the Hallucination ability, which creates hallucinated versions of Protoss units.",
