...
item_descriptions = {
    ...
    ItemNames.SUPPLICANT_BLOOD_SHIELD: None,
    ItemNames.SUPPLICANT_SOUL_AUGMENTATION: None,
    ItemNames.SUPPLICANT_SHIELD_REGENERATION: None,
    ItemNames.ADEPT_SHOCKWAVE: None,
    ItemNames.ADEPT_RESONATING_GLAIVES: None,
    ItemNames.ADEPT_PHASE_BULWARK: None,
    ItemNames.STALKER_INSTIGATOR_SLAYER_DISINTEGRATING_PARTICLES: None,
    ItemNames.STALKER_INSTIGATOR_SLAYER_PARTICLE_REFLECTION: None,
    ItemNames.DRAGOON_HIGH_IMPACT_PHASE_DISRUPTORS: None,
    ItemNames.DRAGOON_TRILLIC_COMPRESSION_SYSTEM: None,
    ItemNames.DRAGOON_SINGULARITY_CHARGE: None,
    ItemNames.DRAGOON_ENHANCED_STRIDER_SERVOS: None,
    ItemNames.SCOUT_COMBAT_SENSOR_ARRAY: None,
    ItemNames.SCOUT_APIAL_SENSORS: None,
    ItemNames.SCOUT_GRAVITIC_THRUSTERS: None,
    ItemNames.SCOUT_ADVANCED_PHOTON_BLASTERS: None,
    ItemNames.TEMPEST_TECTONIC_DESTABILIZERS: None,
    ItemNames.TEMPEST_QUANTIC_REACTOR: None,
    ItemNames.TEMPEST_GRAVITY_SLING: None,
    ItemNames.PHOENIX_MIRAGE_IONIC_WAVELENGTH_FLUX: None,
    ItemNames.PHOENIX_MIRAGE_ANION_PULSE_CRYSTALS: None,
    ItemNames.CORSAIR_STEALTH_DRIVE: None,
    ItemNames.CORSAIR_ARGUS_JEWEL: None,
    ItemNames.CORSAIR_SUSTAINING_DISRUPTION: None,
    ItemNames.CORSAIR_NEUTRON_SHIELDS: None,
    ItemNames.ORACLE_STEALTH_DRIVE: None,
    ItemNames.ORACLE_STASIS_CALIBRATION: None,
    ItemNames.ORACLE_TEMPORAL_ACCELERATION_BEAM: None,
    ...
    ItemNames.WARP_PRISM_WAR_CONFIGURATION: None,
    ItemNames.OBSERVER_GRAVITIC_BOOSTERS: None,
    ItemNames.OBSERVER_SENSOR_ARRAY: None,
    ...
    ItemNames.IMMORTAL_ANNIHILATOR_ADVANCED_TARGETING_MECHANICS: None,
    ItemNames.COLOSSUS_PACIFICATION_PROTOCOL: None,
    ItemNames.WRATHWALKER_RAPID_POWER_CYCLING: None,
    ItemNames.WRATHWALKER_EYE_OF_WRATH: None,
    ...
    ItemNames.HIGH_TEMPLAR_SIGNIFIER_KHAYDARIN_AMULET: None,
    ItemNames.ARCHON_HIGH_ARCHON: None,
    ItemNames.DARK_ARCHON_FEEDBACK: None,
    ItemNames.DARK_ARCHON_MAELSTROM: None,
    ItemNames.DARK_ARCHON_ARGUS_TALISMAN: None,
    ItemNames.ASCENDANT_POWER_OVERWHELMING: None,
    ItemNames.ASCENDANT_CHAOTIC_ATTUNEMENT: None,
    ItemNames.ASCENDANT_BLOOD_AMULET: None,
    ItemNames.SENTRY_ENERGIZER_HAVOC_CLOAKING_MODULE: None,
    ItemNames.SENTRY_ENERGIZER_HAVOC_SHIELD_BATTERY_RAPID_RECHARGING: None,
    ItemNames.SENTRY_FORCE_FIELD: None,
    ItemNames.SENTRY_HALLUCINATION: None,
    ItemNames.ENERGIZER_RECLAMATION: None,
    ItemNames.ENERGIZER_FORGED_CHASSIS: None,
    ItemNames.HAVOC_DETECT_WEAKNESS: None,
    ItemNames.HAVOC_BLOODSHARD_RESONANCE: None,
    ItemNames.ZEALOT_SENTINEL_CENTURION_LEG_ENHANCEMENTS: None,
    ItemNames.ZEALOT_SENTINEL_CENTURION_SHIELD_CAPACITY: None,
    ItemNames.SOA_CHRONO_SURGE: None,
    ItemNames.SOA_PROGRESSIVE_PROXY_PYLON: None,
    ItemNames.SOA_PYLON_OVERCHARGE: None,
    ItemNames.SOA_ORBITAL_STRIKE: None,
    ItemNames.SOA_TEMPORAL_FIELD: None,
    ItemNames.SOA_SOLAR_LANCE: None,
    ItemNames.SOA_MASS_RECALL: None,
    ItemNames.SOA_SHIELD_OVERCHARGE: None,
    ItemNames.SOA_DEPLOY_FENIX: None,
    ItemNames.SOA_PURIFIER_BEAM: None,
    ItemNames.SOA_TIME_STOP: None,
    ItemNames.SOA_SOLAR_BOMBARDMENT: None,
