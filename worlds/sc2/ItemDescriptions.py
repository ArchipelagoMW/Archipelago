...
item_descriptions = {
    ...
    ItemNames.MEDIC_RESTORATION: _ability_desc("Medics", "Restoration", "removes negative status effects from a target allied unit"),
    ItemNames.MEDIC_OPTICAL_FLARE: _ability_desc("Medics", "Optical Flare", "reduces vision range of target enemy unit. Disables detection"),
    ItemNames.MEDIC_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.MEDIC),
    ItemNames.FIREBAT_PROGRESSIVE_STIMPACK: STIMPACK_LARGE_DESCRIPTION,
    ItemNames.FIREBAT_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.FIREBAT),
    ...
    ItemNames.GOLIATH_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.GOLIATH),
    ...
    ItemNames.SIEGE_TANK_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.SIEGE_TANK),
    ...
    ItemNames.DIAMONDBACK_BURST_CAPACITORS: inspect.cleandoc("""
                     ...
                     """),
    ItemNames.DIAMONDBACK_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.DIAMONDBACK),
    ...
    ItemNames.PREDATOR_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.PREDATOR),
    ...
    ItemNames.WARHOUND_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.WARHOUND),
    ItemNames.WARHOUND_REINFORCED_PLATING: "Increases Warhound armor by 2.",
    ItemNames.HERC_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.HERC),
    ...
    ItemNames.WRAITH_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.WRAITH),
    ...
    ItemNames.BANSHEE_ROCKET_BARRAGE: _ability_desc("Banshees", "Rocket Barrage", "deals 75 damage to enemy ground units in the target area"),
    ItemNames.GHOST_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.GHOST),
    ItemNames.SPECTRE_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.SPECTRE),
    ...
    ItemNames.RAVEN_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.RAVEN),
    ...
    ItemNames.CYCLONE_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.CYCLONE),
    ...
    ItemNames.LIBERATOR_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.LIBERATOR),
    ...
    ItemNames.VALKYRIE_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.VALKYRIE),
    ...
    ItemNames.ZERGLING_BANELING_ASPECT: "Anti-ground suicide unit. Does damage over a small area on death. Morphed from the Zergling.",
    ...
    ItemNames.SCOURGE_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.SCOURGE),
    ...
    ItemNames.HYDRALISK_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.HYDRALISK),
    ...
    ItemNames.DEVOURER_IMPROVED_OSMOSIS: "Devourer's Acid Spores duration increased by 50%.",
    ItemNames.DEVOURER_PRESCIENT_SPORES: "Allows Devourers to attack ground targets.",
    ItemNames.GUARDIAN_PROLONGED_DISPERSION: "Guardians gain +3 range.",
    ItemNames.GUARDIAN_PRIMAL_ADAPTATION: "Allows Guardians to attack air units with a decreased attack damage.",
    ItemNames.GUARDIAN_SORONAN_ACID: "Guardians deal increased damage to ground targets.",
    ItemNames.IMPALER_ADAPTIVE_TALONS: "Impalers burrow faster.",
    ItemNames.IMPALER_SECRETION_GLANDS: "Impalers generate creep while standing still or burrowed.",
    ItemNames.IMPALER_HARDENED_TENTACLE_SPINES: "Impalers deal increased damage.",
    ItemNames.LURKER_SEISMIC_SPINES: "Lurkers gain +6 range.",
    ItemNames.LURKER_ADAPTED_SPINES: "Lurkers deal increased damage to non-light targets.",
    ItemNames.RAVAGER_POTENT_BILE: "Ravager Corrosive Bile deals an additional +40 damage.",
    ItemNames.RAVAGER_BLOATED_BILE_DUCTS: "Ravager Corrosive Bile hits a much larger area.",
    ItemNames.RAVAGER_DEEP_TUNNEL: _ability_desc("Ravagers", "Deep Tunnel", "allows them to burrow to any visible location on the map"),
    ItemNames.VIPER_PARASITIC_BOMB: _ability_desc("Vipers", "Parasitic Bomb", "inflicts an area-damaging effect on an enemy air unit"),
    ItemNames.VIPER_PARALYTIC_BARBS: "Viper Abduct stuns units for an additional 5 seconds.",
    ItemNames.VIPER_VIRULENT_MICROBES: "All Viper abilities gain +4 range.",
    ItemNames.BROOD_LORD_POROUS_CARTILAGE: "Brood Lords gain increased movement speed.",
    ItemNames.BROOD_LORD_EVOLVED_CARAPACE: "Brood Lords gain +100 life and +1 armor.",
    ItemNames.BROOD_LORD_SPLITTER_MITOSIS: "Brood Lord attacks spawn twice as many broodlings.",
    ItemNames.BROOD_LORD_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(DISPLAY_NAME_BROOD_LORD),
    ItemNames.INFESTOR_INFESTED_TERRAN: _ability_desc("Infestors", "Spawn Infested Terran"),
    ItemNames.INFESTOR_MICROBIAL_SHROUD: _ability_desc("Infestors", "Microbial Shroud", "reduces incoming damage from air units in an area"),
    ItemNames.SWARM_QUEEN_SPAWN_LARVAE: _ability_desc("Swarm Queens", "Spawn Larvae"),
    ItemNames.SWARM_QUEEN_DEEP_TUNNEL: _ability_desc("Swarm Queens", "Deep Tunnel"),
    ItemNames.SWARM_QUEEN_ORGANIC_CARAPACE: "Swarm Queens gain +25 life.",
    ItemNames.SWARM_QUEEN_BIO_MECHANICAL_TRANSFUSION: "Swarm Queen Burst Heal heals an additional +10 life and can now target mechanical units.",
    ItemNames.SWARM_QUEEN_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.SWARM_QUEEN),
    ItemNames.SWARM_QUEEN_INCUBATOR_CHAMBER: "Swarm Queens may now be built two at a time from the Hatchery, Lair, or Hive.",
    ...
    ItemNames.KERRIGAN_KINETIC_BLAST: "Kerrigan deals 300 damage to target unit or structure from long range.",
    ItemNames.KERRIGAN_HEROIC_FORTITUDE: "Kerrigan gains +200 maximum life and double life regeneration rate.",
    ItemNames.KERRIGAN_LEAPING_STRIKE: "Kerrigan leaps to her target and deals 150 damage.",
    ItemNames.KERRIGAN_CRUSHING_GRIP: "Kerrigan stuns enemies in a target area for 3 seconds and deals 30 damage over time. Heroic units are not stunned.",
    ItemNames.KERRIGAN_CHAIN_REACTION: "Kerrigan's attacks deal normal damage to her target then jump to additional nearby enemies.",
    ItemNames.KERRIGAN_PSIONIC_SHIFT: "Kerrigan dashes through enemies, dealing 50 damage to all enemies in her path.",
    ItemNames.KERRIGAN_ZERGLING_RECONSTITUTION: "Killed Zerglings respawn from your primary Hatchery at no cost.",
    ItemNames.KERRIGAN_IMPROVED_OVERLORDS: "Overlords morph instantly and provide 50% more supply.",
    ItemNames.KERRIGAN_AUTOMATED_EXTRACTORS: "Extractors automatically harvest Vespene Gas without the need for Drones.",
    ItemNames.KERRIGAN_WILD_MUTATION: "Kerrigan gives all units in an area +200 max life and double attack speed for 10 seconds.",
    ItemNames.KERRIGAN_SPAWN_BANELINGS: "Kerrigan spawns six Banelings with timed life.",
    ItemNames.KERRIGAN_MEND: "Kerrigan heals for 150 life and heals nearby friendly units for 50 life. An additional +50% life is healed over 15 seconds.",
    ItemNames.KERRIGAN_TWIN_DRONES: "Drones morph in groups of two at no additional cost and require less supply.",
    ItemNames.KERRIGAN_MALIGNANT_CREEP: "Your units and structures gain increased life regeneration and 30% increased attack speed while on creep. Creep Tumors also spread creep faster and farther.",
    ItemNames.KERRIGAN_VESPENE_EFFICIENCY: "Extractors produce Vespene gas 25% faster.",
    ItemNames.KERRIGAN_INFEST_BROODLINGS: "Enemies damaged by Kerrigan become infested and will spawn Broodlings with timed life if killed quickly.",
    ItemNames.KERRIGAN_FURY: "Each of Kerrigan's attacks temporarily increase her attack speed by 15%. Can stack up to 75%.",
    ItemNames.KERRIGAN_ABILITY_EFFICIENCY: "Kerrigan's abilities have their cooldown and energy cost reduced by 20%.",
    ItemNames.KERRIGAN_APOCALYPSE: "Kerrigan deals 300 damage (+400 vs Structure) to enemies in a large area.",
    ItemNames.KERRIGAN_SPAWN_LEVIATHAN: "Kerrigan summons a mightly flying Leviathan with timed life. Deals massive damage and has energy-based abilities.",
    ItemNames.KERRIGAN_DROP_PODS: "Kerrigan drops Primal Zerg forces with timed life to the battlefield.",
    ItemNames.KERRIGAN_PRIMAL_FORM: "Kerrigan takes on her Primal Zerg form and gains greatly increased energy regeneration.",
    ItemNames.KERRIGAN_LEVELS_10: "Gives Kerrigan +10 Levels.",
    ItemNames.KERRIGAN_LEVELS_9: "Gives Kerrigan +9 Levels.",
    ItemNames.KERRIGAN_LEVELS_8: "Gives Kerrigan +8 Levels.",
    ItemNames.KERRIGAN_LEVELS_7: "Gives Kerrigan +7 Levels.",
    ItemNames.KERRIGAN_LEVELS_6: "Gives Kerrigan +6 Levels.",
    ItemNames.KERRIGAN_LEVELS_5: "Gives Kerrigan +5 Levels.",
    ItemNames.KERRIGAN_LEVELS_4: "Gives Kerrigan +4 Levels.",
    ItemNames.KERRIGAN_LEVELS_3: "Gives Kerrigan +3 Levels.",
    ItemNames.KERRIGAN_LEVELS_2: "Gives Kerrigan +2 Levels.",
    ItemNames.KERRIGAN_LEVELS_1: "Gives Kerrigan +1 Level.",
    ItemNames.KERRIGAN_LEVELS_14: "Gives Kerrigan +14 Levels.",
    ItemNames.KERRIGAN_LEVELS_35: "Gives Kerrigan +35 Levels.",
    ItemNames.KERRIGAN_LEVELS_70: "Gives Kerrigan +70 Levels.",
    ItemNames.INFESTED_MEDICS: "Mercenary infested Medics that may be called in from the Hatchery.",
    ItemNames.INFESTED_SIEGE_TANKS: "Mercenary infested Siege Tanks that may be called in from the Hatchery.",
    ItemNames.INFESTED_BANSHEES: "Mercenary infested Banshees that may be called in from the Hatchery.",
    ItemNames.OVERLORD_VENTRAL_SACS: "Overlords gain the ability to transport ground units.",
    ItemNames.MUTALISK_CORRUPTOR_GUARDIAN_ASPECT: "Long-range anti-ground flyer. Can attack ground units. Morphed from the Mutalisk or Corruptor.",
    ItemNames.MUTALISK_CORRUPTOR_DEVOURER_ASPECT: "Anti-air flyer. Attack inflict Acid Spores. Can attack air units. Morphed from the Mutalisk or Corruptor.",
    ItemNames.ROACH_RAVAGER_ASPECT: "Ranged artillery. Can use Corrosive Bile. Can attack ground units. Morphed from the Roach.",
    ...
    ItemNames.ARBITER_KHAYDARIN_CORE: _get_start_and_max_energy_desc("Arbiters"),
    ItemNames.ARBITER_SPACETIME_ANCHOR: "Arbiter Stasis Field lasts 50 seconds longer.",
    ItemNames.ARBITER_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.ARBITER),
    ...
    ItemNames.REAVER_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(ItemNames.REAVER),
    ...
    ItemNames.DARK_TEMPLAR_AVENGER_BLOOD_HUNTER_BLINK: _ability_desc("Dark Templar, Avengers, and Blood Hunters", "Blink"),
    ItemNames.DARK_TEMPLAR_AVENGER_BLOOD_HUNTER_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(DISPLAY_NAME_CLOAKED_ASSASSIN),
    ...
    ItemNames.HIGH_TEMPLAR_SIGNIFIER_HALLUCINATION: _ability_desc("High Templar and Signifiers", "Hallucination", "creates 2 hallucinated copies of a target unit"),
    ItemNames.HIGH_TEMPLAR_SIGNIFIER_KHAYDARIN_AMULET: _get_start_and_max_energy_desc("High Templar and Signifiers"),
    ItemNames.ARCHON_HIGH_ARCHON: "Archons can use High Templar abilities.",
    ItemNames.DARK_ARCHON_FEEDBACK: _ability_desc("Dark Archons", "Feedback", "drains all energy from a target and deals 1 damage per point of energy drained"),
    ItemNames.DARK_ARCHON_MAELSTROM: _ability_desc("Dark Archons", "Maelstrom", "stuns biological units in an area"),
    ItemNames.DARK_ARCHON_ARGUS_TALISMAN: _get_start_and_max_energy_desc("Dark Archons"),
    ...
    ItemNames.ASCENDANT_BLOOD_AMULET: _get_start_and_max_energy_desc("Ascendants"),
    ItemNames.SENTRY_ENERGIZER_HAVOC_CLOAKING_MODULE: "Sentries, Energizers, and Havocs become permanently cloaked.",
    ItemNames.SENTRY_ENERGIZER_HAVOC_SHIELD_BATTERY_RAPID_RECHARGING: "Sentries, Energizers, and Havocs gain +100% energy regeneration rate.",
    ItemNames.SENTRY_FORCE_FIELD: _ability_desc("Sentries", "Force Field"),
    ItemNames.SENTRY_HALLUCINATION: _ability_desc("Sentries", "Hallucination", "creates hallucinated versions of Protoss units"),
    ItemNames.ENERGIZER_RECLAMATION: _ability_desc("Energizers", "Reclamation"),
