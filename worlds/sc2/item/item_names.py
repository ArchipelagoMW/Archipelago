...
MEDIC          = "Medic (Barracks)"
FIREBAT        = "Firebat (Barracks)"
MARAUDER       = "Marauder (Barracks)"
REAPER         = "Reaper (Barracks)"
HELLION        = "Hellion (Factory)"
VULTURE        = "Vulture (Factory)"
GOLIATH        = "Goliath (Factory)"
DIAMONDBACK    = "Diamondback (Factory)"
SIEGE_TANK     = "Siege Tank (Factory)"
MEDIVAC        = "Medivac (Starport)"
WRAITH         = "Wraith (Starport)"
VIKING         = "Viking (Starport)"
BANSHEE        = "Banshee (Starport)"
BATTLECRUISER  = "Battlecruiser (Starport)"
GHOST          = "Ghost (Barracks)"
SPECTRE        = "Spectre (Barracks)"
THOR           = "Thor (Factory)"
RAVEN          = "Raven (Starport)"
SCIENCE_VESSEL = "Science Vessel (Starport)"
PREDATOR       = "Predator (Factory)"
HERCULES       = "Hercules (Starport)"
# Extended units
LIBERATOR        = "Liberator (Starport)"
VALKYRIE         = "Valkyrie (Starport)"
WIDOW_MINE       = "Widow Mine (Factory)"
CYCLONE          = "Cyclone (Factory)"
HERC             = "HERC (Barracks)"
WARHOUND         = "Warhound (Factory)"
DOMINION_TROOPER = "Dominion Trooper (Barracks)"
# Elites
PRIDE_OF_AUGUSTRGRAD = "Pride of Augustgrad (Elite Starport)"
SKY_FURY             = "Sky Fury (Elite Starport)"
SHOCK_DIVISION       = "Shock Division (Elite Factory)"
BLACKHAMMER          = "Blackhammer (Elite Factory)"
AEGIS_GUARD          = "Aegis Guard (Elite Barracks)"
EMPERORS_SHADOW      = "Emperor's Shadow (Elite Barracks)"
SON_OF_KORHAL        = "Son of Korhal (Elite Barracks)"
BULWARK_COMPANY      = "Bulwark Company (Elite Factory)"
FIELD_RESPONSE_THETA = "Field Response Theta (Elite Barracks)"
EMPERORS_GUARDIAN    = "Emperor's Guardian (Elite Starport)"
NIGHT_HAWK           = "Night Hawk (Elite Starport)"
NIGHT_WOLF           = "Night Wolf (Elite Starport)"
...
# Mercenaries
WAR_PIGS          = "War Pigs (Mercenary)"
DEVIL_DOGS        = "Devil Dogs (Mercenary)"
HAMMER_SECURITIES = "Hammer Securities (Mercenary)"
SPARTAN_COMPANY   = "Spartan Company (Mercenary)"
SIEGE_BREAKERS    = "Siege Breakers (Mercenary)"
HELS_ANGELS       = "Hel's Angels (Mercenary)"
DUSK_WINGS        = "Dusk Wings (Mercenary)"
JACKSONS_REVENGE  = "Jackson's Revenge (Mercenary)"
SKIBIS_ANGELS     = "Skibi's Angels (Mercenary)"
DEATH_HEADS       = "Death Heads (Mercenary)"
WINGED_NIGHTMARES = "Winged Nightmares (Mercenary)"
MIDNIGHT_RIDERS   = "Midnight Riders (Mercenary)"
BRYNHILDS         = "Brynhilds (Mercenary)"
JOTUN             = "Jotun (Mercenary)"
...
GHOST_PROGRESSIVE_RESOURCE_EFFICIENCY              = "Progressive Resource Efficiency (Ghost)"
...
SPECTRE_PROGRESSIVE_RESOURCE_EFFICIENCY            = "Progressive Resource Efficiency (Spectre)"
...
# Zerg Units
ZERGLING             = "Zergling (Larva)"
SWARM_QUEEN          = "Swarm Queen (Hatchery)"
ROACH                = "Roach (Larva)"
HYDRALISK            = "Hydralisk (Larva)"
ABERRATION           = "Aberration (Larva)"
MUTALISK             = "Mutalisk (Larva)"
SWARM_HOST           = "Swarm Host (Larva)"
INFESTOR             = "Infestor (Larva)"
ULTRALISK            = "Ultralisk (Larva)"
PYGALISK             = "Pygalisk (Larva)"
CORRUPTOR            = "Corruptor (Larva)"
SCOURGE              = "Scourge (Larva)"
BROOD_QUEEN          = "Brood Queen (Larva)"
DEFILER              = "Defiler (Larva)"
INFESTED_MARINE      = "Infested Marine (Infested Barracks)"
INFESTED_SIEGE_TANK  = "Infested Siege Tank (Infested Factory)"
INFESTED_DIAMONDBACK = "Infested Diamondback (Infested Factory)"
BULLFROG             = "Bullfrog (Infested Factory)"
INFESTED_BANSHEE     = "Infested Banshee (Infested Starport)"
INFESTED_LIBERATOR   = "Infested Liberator (Infested Starport)"
...
# Morphs
ZERGLING_BANELING_ASPECT                = "Baneling (Zergling Morph)"
HYDRALISK_IMPALER_ASPECT                = "Impaler (Hydralisk Morph)"
HYDRALISK_LURKER_ASPECT                 = "Lurker (Hydralisk Morph)"
MUTALISK_CORRUPTOR_BROOD_LORD_ASPECT    = "Brood Lord (Mutalisk/Corruptor Morph)"
MUTALISK_CORRUPTOR_VIPER_ASPECT         = "Viper (Mutalisk/Corruptor Morph)"
MUTALISK_CORRUPTOR_GUARDIAN_ASPECT      = "Guardian (Mutalisk/Corruptor Morph)"
MUTALISK_CORRUPTOR_DEVOURER_ASPECT      = "Devourer (Mutalisk/Corruptor Morph)"
ROACH_RAVAGER_ASPECT                    = "Ravager (Roach Morph)"
OVERLORD_OVERSEER_ASPECT                = "Overseer (Overlord Morph)"
ROACH_PRIMAL_IGNITER_ASPECT             = "Primal Igniter (Roach Morph)"
ULTRALISK_TYRANNOZOR_ASPECT             = "Tyrannozor (Ultralisk Morph)"

# Zerg Mercs
INFESTED_MEDICS         = "Infested Medics (Mercenary)"
INFESTED_SIEGE_BREAKERS = "Infested Siege Breakers (Mercenary)"
INFESTED_DUSK_WINGS     = "Infested Dusk Wings (Mercenary)"
DEVOURING_ONES          = "Devouring Ones (Mercenary)"
HUNTER_KILLERS          = "Hunter Killers (Mercenary)"
...
# Protoss Units
ZEALOT       = "Zealot (Gateway, Aiur)"
STALKER      = "Stalker (Gateway, Nerazim)"
HIGH_TEMPLAR = "High Templar (Gateway, Aiur)"
DARK_TEMPLAR = "Dark Templar (Gateway, Nerazim)"
IMMORTAL     = "Immortal (Robotics Facility, Aiur)"
COLOSSUS     = "Colossus (Robotics Facility, Purifier)"
PHOENIX      = "Phoenix (Stargate, Aiur)"
VOID_RAY     = "Void Ray (Stargate, Nerazim)"
CARRIER      = "Carrier (Stargate, Aiur)"
SKYLORD      = "Skylord (Stargate, Tal'darim)"
TRIREME      = "Trireme (Stargate, Purifier)"
OBSERVER     = "Observer (Robotics Facility)"
CENTURION    = "Centurion (Gateway, Nerazim)"
SENTINEL     = "Sentinel (Gateway, Purifier)"
SUPPLICANT   = "Supplicant (Gateway, Tal'darim)"
INSTIGATOR   = "Instigator (Gateway, Purifier)"
SLAYER       = "Slayer (Gateway, Tal'darim)"
SENTRY       = "Sentry (Gateway, Aiur)"
ENERGIZER    = "Energizer (Gateway, Purifier)"
HAVOC        = "Havoc (Gateway, Tal'darim)"
SIGNIFIER    = "Signifier (Gateway, Nerazim)"
ASCENDANT    = "Ascendant (Gateway, Tal'darim)"
AVENGER      = "Avenger (Gateway, Aiur)"
BLOOD_HUNTER = "Blood Hunter (Gateway, Tal'darim)"
DRAGOON      = "Dragoon (Gateway, Aiur)"
DARK_ARCHON  = "Dark Archon (Gateway, Nerazim)"
ADEPT        = "Adept (Gateway, Purifier)"
WARP_PRISM   = "Warp Prism (Robotics Facility)"
ANNIHILATOR  = "Annihilator (Robotics Facility, Nerazim)"
VANGUARD     = "Vanguard (Robotics Facility, Tal'darim)"
STALWART     = "Stalwart (Robotics Facility, Purifier)"
WRATHWALKER  = "Wrathwalker (Robotics Facility, Tal'darim)"
REAVER       = "Reaver (Robotics Facility, Aiur)"
DISRUPTOR    = "Disruptor (Robotics Facility, Purifier)"
MIRAGE       = "Mirage (Stargate, Purifier)"
SKIRMISHER   = "Skirmisher (Stargate, Tal'darim)"
CORSAIR      = "Corsair (Stargate, Nerazim)"
DESTROYER    = "Destroyer (Stargate, Tal'darim)"
INTERCESSOR  = "Intercessor (Stargate, Aiur)"
DAWNBRINGER  = "Dawnbringer (Stargate, Purifier)"
SCOUT        = "Scout (Stargate, Aiur)"
OPPRESSOR    = "Oppressor (Stargate, Tal'darim)"
CALADRIUS    = "Caladrius (Stargate, Purifier)"
MISTWING     = "Mist Wing (Stargate, Nerazim)"
TEMPEST      = "Tempest (Stargate, Purifier)"
MOTHERSHIP   = "Mothership (Stargate, Tal'darim)"
ARBITER      = "Arbiter (Stargate, Aiur)"
ORACLE       = "Oracle (Stargate, Nerazim)"
...
SCOUT_PROGRESSIVE_RESOURCE_EFFICIENCY                   = "Progressive Resource Efficiency (Scout)"
SCOUT_GAMMA_PHOTON_BLASTERS                             = "Gamma Photon Blasters (Scout)"
...
ORACLE_STASIS_EXPANSION                                 = "Stasis Expansion (Oracle)"
...
VOID_RAY_DESTROYER_INTERCESSOR_DAWNBRINGER_FLUX_VANES   = "Flux Vanes (Void Ray/Destroyer/Intercessor/Dawnbringer)"
...
REAVER_PROGRESSIVE_RESOURCE_EFFICIENCY                  = "Progressive Resource Efficiency (Reaver)"
...
DESTROYER_BLOODSHARD_REALIGNMENT                        = "Bloodshard Realignment (Destroyer)"
INTERCESSOR_CHRONO_SHEAR                                = "Chrono Shear (Intercessor)"
...
ORACLE_PROGRESSIVE_STASIS_CALIBRATION                   = "Progressive Stasis Calibration (Oracle)"
