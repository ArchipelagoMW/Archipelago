...
PLANETARY_FORTRESS_IKBIS_TRACKING_SCANNERS         = "Ikbis Tracking Scanners (Planetary Fortress)"
...
STALWART_REINTIGRATED_FRAMEWORK                         = "Reintigrated Framework (Stalwart)"
...
# War Council
ZEALOT_WHIRLWIND                                        = "Whirlwind (Zealot War Council)"
CENTURION_RESOURCE_EFFICIENCY                           = "Resource Efficiency (Centurion War Council)"
SENTINEL_RESOURCE_EFFICIENCY                            = "Resource Efficiency (Sentinel War Council)"
STALKER_PHASE_REACTOR                                   = "Phase Reactor (Stalker War Council)"
DRAGOON_PHALANX_SUIT                                    = "Phalanx Suit (Dragoon War Council)"
INSTIGATOR_MODERNIZED_SERVOS                            = "Modernized Servos (Instigator War Council)"
ADEPT_DISRUPTIVE_TRANSFER                               = "Disruptive Transfer (Adept War Council)"
SLAYER_PHASE_BLINK                                      = "Phase Blink (Slayer War Council)"
AVENGER_KRYHAS_CLOAK                                    = "Kryhas Cloak (Avenger War Council)"
DARK_TEMPLAR_LESSER_SHADOW_FURY                         = "Lesser Shadow Fury (Dark Templar War Council)"
DARK_TEMPLAR_GREATER_SHADOW_FURY                        = "Greater Shadow Fury (Dark Templar War Council)"
BLOOD_HUNTER_BRUTAL_EFFICIENCY                          = "Brutal Efficiency (Blood Hunter War Council)"
SENTRY_DOUBLE_SHIELD_RECHARGE                           = "Double Shield Recharge (Sentry War Council)"
ENERGIZER_MOBILE_CHRONO_BEAM                            = "Mobile Chrono Beam (Energizer War Council)"
HAVOC_ENDURING_SIGHT                                    = "Enduring Sight (Havoc War Council)"
HIGH_TEMPLAR_PLASMA_SURGE                               = "Plasma Surge (High Templar War Council)"
SIGNIFIER_FEEDBACK                                      = "Feedback (Signifier War Council War Council)"
ASCENDANT_BREATH_OF_CREATION                            = "Breath of Creation (Ascendant War Council)"
DARK_ARCHON_INDOMITABLE_WILL                            = "Indomitable Will (Dark Archon War Council)"
IMMORTAL_IMPROVED_BARRIER                               = "Improved Barrier (Immortal War Council)"
VANGUARD_RAPIDFIRE_CANNON                               = "Rapid-Fire Cannon (Vanguard War Council)"
VANGUARD_FUSION_MORTARS                                 = "Fusion Mortars (Vanguard War Council)"
ANNIHILATOR_TWILIGHT_CHASSIS                            = "Twilight Chassis (Annihilator War Council)"
STALWART_ARC_INDUCERS                                   = "Arc Inducers (Stalwart War Council)"
COLOSSUS_FIRE_LANCE                                     = "Fire Lance (Colossus War Council)"
WRATHWALKER_AERIAL_TRACKING                             = "Aerial Tracking (Wrathwalker War Council)"
REAVER_KHALAI_REPLICATORS                               = "Khalai Replicators (Reaver War Council)"
DISRUPTOR_MOBILITY_PROTOCOLS                            = "Mobility Protocols (Disruptor War Council)"
WARP_PRISM_WARP_REFRACTION                              = "Warp Refraction (Warp Prism War Council)"
OBSERVER_INDUCE_SCOPOPHOBIA                             = "Induce Scopophobia (Observer War Council)"
PHOENIX_DOUBLE_GRAVITON_BEAM                            = "Double Graviton Beam (Phoenix War Council)"
CORSAIR_NETWORK_DISRUPTION                              = "Network Disruption (Corsair War Council)"
MIRAGE_GRAVITON_BEAM                                    = "Graviton Beam (Mirage War Council)"
SKIRMISHER_PEER_CONTEMPT                                = "Peer Contempt (Skirmisher War Council)"
VOID_RAY_PRISMATIC_RANGE                                = "Prismatic Range (Void Ray War Council)"
DESTROYER_BLOODSHARD_REALIGNMENT                        = "Bloodshard Realignment (Destroyer War Council)"
INTERCESSOR_CHRONO_SHEAR                                = "Chrono Shear (Intercessor War Council)"
DAWNBRINGER_SOLARITE_LENS                               = "Solarite Lens (Dawnbringer War Council)"
CARRIER_REPAIR_DRONES                                   = "Repair Drones (Carrier War Council)"
SKYLORD_JUMP                                            = "Jump (Skylord War Council)"
TRIREME_SOLAR_BEAM                                      = "Solar Beam (Trireme War Council)"
TEMPEST_DISINTEGRATION                                  = "Disintegration (Tempest War Council)"
SCOUT_EXPEDITIONARY_HULL                                = "Expeditionary Hull (Scout War Council)"
ARBITER_VESSEL_OF_THE_CONCLAVE                          = "Vessel of the Conclave (Arbiter War Council)"
ORACLE_PROGRESSIVE_STASIS_CALIBRATION                   = "Progressive Stasis Calibration (Oracle War Council)"
MOTHERSHIP_INTEGRATED_POWER                             = "Integrated Power (Mothership War Council)"
OPPRESSOR_VULCAN_BLASTER                                = "Vulcan Blaster (Oppressor War Council)"
CALADRIUS_CORONA_BEAM                                   = "Corona Beam (Caladrius War Council)"
MISTWING_PHANTOM_DASH                                   = "Phantom Dash (Mist Wing War Council)"
