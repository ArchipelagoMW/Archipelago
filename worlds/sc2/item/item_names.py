...
VOID_RAY_DESTROYER_INTERCESSOR_DAWNBRINGER_FLUX_VANES   = "Flux Vanes (Void Ray/Destroyer/Pulsar/Dawnbringer)"
...
INTERCESSOR_CHRONOCLYSM                                 = "Chronoclysm (Pulsar)"
INTERCESSOR_ENTROPIC_REVERSAL                           = "Entropic Reversal (Pulsar)"
...
SIGNIFIER_FEEDBACK                                      = "Feedback (Signifier War Council)"
...
DESTROYER_REFORGED_BLOODSHARD_CORE                      = "Reforged Bloodshard Core (Destroyer War Council)"
INTERCESSOR_CHRONO_SHEAR                                = "Chrono Shear (Pulsar War Council)"
...
ORACLE_STASIS_CALIBRATION                               = "Stasis Calibration (Oracle War Council)"
