...
item_descriptions = {
    ...
    item_names.PROGRESSIVE_FAST_DELIVERY: "At level 1, you can request one Mercenary unit immediately at the start of a mission. Level 2 allows you to calldown all Mercenary units immediately.",
    ...
    item_names.PROGRESSIVE_EVOLUTIONARY_LEAP: "Level 1 halves the initial cooldown for all Zerg Mercenaries. Level 2 removes the initial cooldown.",
