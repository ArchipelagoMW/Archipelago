...
item_descriptions = {
    ...
    item_names.INTERCESSOR: "Support craft. Applies a stacking slow to targets.",
    ...
    item_names.DISRUPTOR_MOBILITY_PROTOCOLS: "Disruptor War Council upgrade. Allows the Disruptor to move while casting Purification Nova. Also allows the Disruptor to Blink.",
    ...
    "Removed item": "This item was from generation."
}
