...
item_descriptions = {
    ...
    item_names.CALADRIUS_CORONA_BEAM: "Caladrius War Council upgrade. " + _ability_desc("Caladrius","Corona Beam", "channels a beam, that drains up to 100 of your shields to deal up to 200 damage over time to a single target"),
