...
item_descriptions = {
    ...
    item_names.DESTROYER_REFORGED_BLOODSHARD_CORE: "Destroyer War Council upgrade. Increases the Destroyer's bounce attack damage to 4 (+2 vs armored) at all charge levels.",
