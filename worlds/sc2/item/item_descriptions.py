...
item_descriptions = {
    ...
    item_names.ARCHON_FLOAT: "Archons can float in the air. Can traverse cliffs and phase through most units.",
    item_names.ARCHON_SIPHON: _ability_desc("Archons", "Power Siphon", "Deals damage to a target and replenishes shields over 2 seconds."),
    item_names.ARCHON_SUICIDE: "On death, Archons launch towards nearby enemy ground units, dealing damage on impact.",
    item_names.ARCHON_WEAPON_UPGRADE: "Archon attacks get increased area of effect, and deal their biological bonus damage to all targets.",
