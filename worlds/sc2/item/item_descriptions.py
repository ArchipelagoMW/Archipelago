...
item_descriptions = {
    ...
    item_names.ORACLE_STASIS_CALIBRATION: "Oracle War Council upgrade. Enemies caught by the Oracle's Stasis Ward may now be attacked.",
    item_names.ORACLE_STASIS_EXPANSION: "The Oracle's Stasis Ward can affect air units.",
