...
item_descriptions = {
    ...
    item_names.INTERCESSOR_CHRONOCLYSM: "Pulsar slow effect is also applied in an area around the primary target.",
    item_names.INTERCESSOR_ENTROPIC_REVERSAL: "Pulsars now regenerate life when out of combat.",
    ...
    item_names.INTERCESSOR_CHRONO_SHEAR: "Pulsar War Council upgrade. Fully-stacked slow on non-heroic targets also applies a defense debuff.",
