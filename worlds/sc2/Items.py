...
item_table = {
    ...
    ItemNames.DEFILER_TRAPDOOR_ADAPTATION:
        ItemData(278 + SC2HOTS_ITEM_ID_OFFSET, ZergItemType.Mutation_3, 19, SC2Race.ZERG, parent_item=ItemNames.DEFILER,
                 origin={"ext"}),
    ItemNames.DEFILER_PREDATORY_CONSUMPTION:
        ItemData(279 + SC2HOTS_ITEM_ID_OFFSET, ZergItemType.Mutation_3, 20, SC2Race.ZERG, parent_item=ItemNames.DEFILER,
                 origin={"ext"}),
    ItemNames.DEFILER_COMORBIDITY:
        ItemData(280 + SC2HOTS_ITEM_ID_OFFSET, ZergItemType.Mutation_3, 18, SC2Race.ZERG, parent_item=ItemNames.DEFILER,
                 origin={"ext"}),
    ...
    ItemNames.STALKER_INSTIGATOR_SLAYER_DISINTEGRATING_PARTICLES: ItemData(306 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_1, 6, SC2Race.PROTOSS, origin={"ext"}, classification=ItemClassification.useful),
    ItemNames.STALKER_INSTIGATOR_SLAYER_PARTICLE_REFLECTION: ItemData(307 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_1, 7, SC2Race.PROTOSS, origin={"ext"}, classification=ItemClassification.useful),
