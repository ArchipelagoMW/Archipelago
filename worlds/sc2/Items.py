...
item_table = {
    ...
    ItemNames.BANELING_RUPTURE: ItemData(210 + SC2HOTS_ITEM_ID_OFFSET, "Mutation 1", 10, SC2Race.ZERG, parent_item=ItemNames.ZERGLING_BANELING_ASPECT, origin={"hots"}, classification=ItemClassification.filler, dsecription="Increases the splash radius of baneling attacks."),
    ...
    ItemNames.ULTRALISK_TISSUE_ANIMATION: ItemData(219 + SC2HOTS_ITEM_ID_OFFSET, "Mutation 1", 19, SC2Race.ZERG, parent_item=ItemNames.ULTRALISK, origin={"hots"}, description="Ultralisks recover health when they deal damage."),
    ...
    ItemNames.MUTALISK_SEVERING_GLAVE: ItemData(234 + SC2HOTS_ITEM_ID_OFFSET, "Mutation 2", 4, SC2Race.ZERG, parent_item=ItemNames.MUTALISK, origin={"ext"}, description="Mutalisk bounce attacks will deal full damage."),
