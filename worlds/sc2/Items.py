...
item_table = {
    ...
    ItemNames.ZERGLING_HARDENED_CARAPACE: ItemData(200 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 0, SC2Race.ZERG, parent_item=ItemNames.ZERGLING, origin={"hots"}),
    ItemNames.ZERGLING_ADRENAL_OVERLOAD: ItemData(201 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 1, SC2Race.ZERG, parent_item=ItemNames.ZERGLING, origin={"hots"}),
    ItemNames.ZERGLING_METABOLIC_BOOST: ItemData(202 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 2, SC2Race.ZERG, parent_item=ItemNames.ZERGLING, origin={"hots"}, classification=ItemClassification.filler),
    ItemNames.ROACH_HYDRIODIC_BILE: ItemData(203 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 3, SC2Race.ZERG, parent_item=ItemNames.ROACH, origin={"hots"}),
    ItemNames.ROACH_ADAPTIVE_PLATING: ItemData(204 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 4, SC2Race.ZERG, parent_item=ItemNames.ROACH, origin={"hots"}),
    ItemNames.ROACH_TUNNELING_CLAWS: ItemData(205 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 5, SC2Race.ZERG, parent_item=ItemNames.ROACH, origin={"hots"}, classification=ItemClassification.filler),
    ItemNames.HYDRALISK_FRENZY: ItemData(206 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 6, SC2Race.ZERG, parent_item=ItemNames.HYDRALISK, origin={"hots"}),
    ItemNames.HYDRALISK_ANCILLARY_CARAPACE: ItemData(207 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 7, SC2Race.ZERG, parent_item=ItemNames.HYDRALISK, origin={"hots"}, classification=ItemClassification.filler),
    ItemNames.HYDRALISK_GROOVED_SPINES: ItemData(208 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 8, SC2Race.ZERG, parent_item=ItemNames.HYDRALISK, origin={"hots"}),
    ItemNames.BANELING_CORROSIVE_ACID: ItemData(209 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 9, SC2Race.ZERG, parent_item=ItemNames.BANELING, origin={"hots"}),
    ItemNames.BANELING_RUPTURE: ItemData(210 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 10, SC2Race.ZERG, parent_item=ItemNames.BANELING, origin={"hots"}, classification=ItemClassification.filler),
    ItemNames.BANELING_REGENERATIVE_ACID: ItemData(211 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 11, SC2Race.ZERG, parent_item=ItemNames.BANELING, origin={"hots"}, classification=ItemClassification.filler),
    ItemNames.MUTALISK_VICIOUS_GLAVE: ItemData(212 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 12, SC2Race.ZERG, parent_item=ItemNames.MUTALISK, origin={"hots"}),
    ItemNames.MUTALISK_RAPID_REGENERATION: ItemData(213 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 13, SC2Race.ZERG, parent_item=ItemNames.MUTALISK, origin={"hots"}),
    ItemNames.MUTALISK_SUNDERING_GLAVE: ItemData(214 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 14, SC2Race.ZERG, parent_item=ItemNames.MUTALISK, origin={"hots"}),
    ItemNames.SWARM_HOST_BURROW: ItemData(215 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 15, SC2Race.ZERG, parent_item=ItemNames.SWARM_HOST, origin={"hots"}, classification=ItemClassification.filler),
    ItemNames.SWARM_HOST_RAPID_INCUBATION: ItemData(216 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 16, SC2Race.ZERG, parent_item=ItemNames.SWARM_HOST, origin={"hots"}),
    ItemNames.SWARM_HOST_PRESSURIZED_GLANDS: ItemData(217 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 17, SC2Race.ZERG, parent_item=ItemNames.SWARM_HOST, origin={"hots"}, classification=ItemClassification.progression),
    ItemNames.ULTRALISK_BURROW_CHARGE: ItemData(218 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 18, SC2Race.ZERG, parent_item=ItemNames.ULTRALISK, origin={"hots"}),
    ItemNames.ULTRALISK_TISSUE_ANIMATION: ItemData(219 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 19, SC2Race.ZERG, parent_item=ItemNames.ULTRALISK, origin={"hots"}),
    ItemNames.ULTRALISK_MONARCH_BLADES: ItemData(220 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 20, SC2Race.ZERG, parent_item=ItemNames.ULTRALISK, origin={"hots"}),
    ItemNames.CORRUPTOR_CAUSTIC_SPRAY: ItemData(221 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 21, SC2Race.ZERG, parent_item=ItemNames.CORRUPTOR, origin={"ext"}),
    ItemNames.CORRUPTOR_CORRUPTION: ItemData(222 + SC2HOTS_ITEM_ID_OFFSET, "Mutation", 22, SC2Race.ZERG, parent_item=ItemNames.CORRUPTOR, origin={"ext"}),
    ...
    ItemNames.HYDRALISK_IMPALER_ASPECT: ItemData(304 + SC2HOTS_ITEM_ID_OFFSET, "Morph", 0, SC2Race.ZERG, parent_item=ItemNames.HYDRALISK, origin={"hots"}, classification=ItemClassification.progression),
    ItemNames.HYDRALISK_LURKER_ASPECT: ItemData(305 + SC2HOTS_ITEM_ID_OFFSET, "Morph", 1, SC2Race.ZERG, parent_item=ItemNames.HYDRALISK, origin={"hots"}, classification=ItemClassification.progression),
    ItemNames.BANELING_SPLITTER_STRAIN: ItemData(306 + SC2HOTS_ITEM_ID_OFFSET, "Strain", 6, SC2Race.ZERG, parent_item=ItemNames.BANELING, origin={"hots"}),
    ItemNames.BANELING_HUNTER_STRAIN: ItemData(307 + SC2HOTS_ITEM_ID_OFFSET, "Strain", 7, SC2Race.ZERG, parent_item=ItemNames.BANELING, origin={"hots"}),
