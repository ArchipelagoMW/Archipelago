...
item_descriptions = {
    ...
    item_names.OVERLORD_SPAWN_CHANGELING: "Overlords can spawn Changeling unit.",
    item_names.OVERLORD_CONTAMINATE: "The target structure will bew unable to train units or research upgrades for 30 seconds.",
    ...
    item_names.VOID_RAY_DESTROYER_FLUX_VANES: "Increases Void Ray and Destroyer movement speed.",
