...
import unittest
from .. import item_groups, item_tables
...
class ItemGroupsUnitTests(unittest.TestCase):
    ...
    def test_terran_original_progressive_group_fully_contained_in_wol_upgrades(self) -> None:
        for item_name in item_groups.terran_original_progressive_upgrades:
            self.assertIn(item_tables.item_table[item_name].type, (item_tables.TerranItemType.Progressive, item_tables.TerranItemType.Progressive_2), f"{item_name} is not progressive")
