...
def get_locations(world: Optional['SC2World']) -> Tuple[LocationData, ...]:
    ...
    location_table: List[LocationData] = [
        ...
        make_location_data(SC2Mission.THE_DIG.mission_name, "Victory", SC2WOL_LOC_ID_OFFSET + 900, LocationType.VICTORY,
            lambda state: (
                (logic.terran_competent_anti_air(state) or adv_tactics and logic.terran_moderate_anti_air(state))
        ...
        make_location_data(SC2Mission.SHATTER_THE_SKY.mission_name, "Victory", SC2WOL_LOC_ID_OFFSET + 2800, LocationType.VICTORY,
            lambda state: logic.terran_competent_comp(state) and logic.terran_army_weapon_armor_upgrade_min_level(state) >= 2
        ),
        ...
        make_location_data(SC2Mission.LAB_RAT.mission_name, "Victory", SC2HOTS_LOC_ID_OFFSET + 100, LocationType.VICTORY,
            lambda state: (logic.zerg_common_unit or state.has_any((item_names.ZERGLING, item_names.PYGALISK), player))
        ),
        ...
        make_location_data(SC2Mission.LAB_RAT.mission_name, "South Zergling Group", SC2HOTS_LOC_ID_OFFSET + 102, LocationType.VANILLA,
            lambda state: adv_tactics or (logic.zerg_common_unit or state.has_any((item_names.ZERGLING, item_names.PYGALISK), player))
        ),
        ...
        make_location_data(SC2Mission.PHANTOMS_OF_THE_VOID.mission_name, "Victory", SC2HOTS_LOC_ID_OFFSET + 1500, LocationType.VICTORY,
            lambda state: (
                logic.zerg_competent_comp(state)
                and (logic.zerg_competent_anti_air(state) or (adv_tactics and logic.zerg_moderate_anti_air(state))))
        ),
        ...
        make_location_data(SC2Mission.CONVICTION.mission_name, "First Secret Documents", SC2HOTS_LOC_ID_OFFSET + 1701, LocationType.VANILLA,
            lambda state: (logic.two_kerrigan_actives(state) and logic.kerrigan_levels(state, 25)) or kerriganless
        ),
        ...
        make_location_data(SC2Mission.DEATH_FROM_ABOVE.mission_name, "Victory", SC2HOTS_LOC_ID_OFFSET + 1900, LocationType.VICTORY,
            lambda state: logic.zerg_competent_comp_competent_aa(state) and (adv_tactics or logic.zerg_base_buster(state))
        ),
        ...
        make_location_data(SC2Mission.THE_RECKONING.mission_name, "Trash the Odin Early", SC2HOTS_LOC_ID_OFFSET + 2005, LocationType.MASTERY,
            lambda state: (
                ...
                and (kerriganless or (logic.kerrigan_levels(state, 50, False) and state.has_any(kerrigan_logic_ultimates, player)))
        ...
        make_location_data(SC2Mission.DARK_WHISPERS.mission_name, "Zerg Base", SC2LOTV_LOC_ID_OFFSET + 105, LocationType.MASTERY,
            lambda state: logic.protoss_deathball(state) and logic.protoss_power_rating(state) >= 6,
            flags=LocationFlag.BASEBUST,
        ),
        make_location_data(SC2Mission.GHOSTS_IN_THE_FOG.mission_name, "Victory", SC2LOTV_LOC_ID_OFFSET + 200, LocationType.VICTORY,
            lambda state: logic.protoss_competent_comp(state) and logic.protoss_mineral_dump(state)
        ),
        ...
        lambda state: adv_tactics or state.count_from_list(
           (
        ...
        make_location_data(SC2Mission.THE_GROWING_SHADOW.mission_name, "Victory", SC2LOTV_LOC_ID_OFFSET + 500, LocationType.VICTORY,
            lambda state: logic.protoss_common_unit(state) and (adv_tactics or logic.protoss_moderate_anti_air(state))
        ),
        ...
        make_location_data(SC2Mission.TEMPLE_OF_UNIFICATION.mission_name, "Terran Main Base", SC2LOTV_LOC_ID_OFFSET + 1207, LocationType.MASTERY,
            lambda state: logic.protoss_temple_of_unification_requirement(state) and logic.protoss_deathball(state),
            flags=LocationFlag.BASEBUST,
        ),
        ...
        make_location_data(SC2Mission.IN_THE_ENEMY_S_SHADOW.mission_name, "Victory", SC2NCO_LOC_ID_OFFSET + 700, LocationType.VICTORY,
            ...
            hard_rule=lambda state: logic.nova_any_nobuild_damage(state) and logic.enemy_shadow_door_unlocks_tool(state)
        ),
        ...
        make_location_data(SC2Mission.ZERO_HOUR_P.mission_name, "Victory", SC2_RACESWAP_LOC_ID_OFFSET + 600, LocationType.VICTORY,
            lambda state: (
                ...
                and (state.has(item_names.PHOTON_CANNON, player) or logic.protoss_basic_splash(state))
            )
        ),
        ...
        make_location_data(SC2Mission.HAVENS_FALL_Z.mission_name, "Southwest Gas Pickups", SC2_RACESWAP_LOC_ID_OFFSET + 1309, LocationType.EXTRA,
            lambda state: state.has_any((item_names.OVERLORD_VENTRAL_SACS, item_names.YGGDRASIL), player)
                           or adv_tactics and state.has_all((item_names.INFESTED_BANSHEE, item_names.INFESTED_BANSHEE_RAPID_HIBERNATION), player),
        ...
        make_location_data(SC2Mission.HAVENS_FALL_Z.mission_name, "East Gas Pickups", SC2_RACESWAP_LOC_ID_OFFSET + 1310, LocationType.EXTRA,
            lambda state: (
                   ...
                   and (
                           ...
                           or adv_tactics and (
                                   state.has_all((item_names.INFESTED_BANSHEE,
        ...
        make_location_data(SC2Mission.HAVENS_FALL_P.mission_name, "Southwest Gas Pickups", SC2_RACESWAP_LOC_ID_OFFSET + 1409, LocationType.EXTRA,
            lambda state: (state.has(item_names.WARP_PRISM, player)
                          or adv_tactics and (
                                  state.has_all((item_names.MISTWING, item_names.MISTWING_PILOT),
                                                player)
        ...
        make_location_data(SC2Mission.HAVENS_FALL_P.mission_name, "East Gas Pickups", SC2_RACESWAP_LOC_ID_OFFSET + 1410, LocationType.EXTRA,
            lambda state: (
                ...
                and (
                        ...
                        or adv_tactics and (
                                state.has_all((item_names.MISTWING, item_names.MISTWING_PILOT), player)
                                or state.has(item_names.ARBITER, player)
                        )
                )
            ),
        ...
        make_location_data(SC2Mission.SMASH_AND_GRAB_Z.mission_name, "Victory", SC2_RACESWAP_LOC_ID_OFFSET + 1500, LocationType.VICTORY,
            lambda state: (
                logic.zerg_common_unit(state)
                and ((adv_tactics and logic.zerg_moderate_anti_air(state))
                    or logic.zerg_competent_anti_air(state)
                ))
        ),
        ...
        make_location_data(SC2Mission.SMASH_AND_GRAB_Z.mission_name, "Second Relic", SC2_RACESWAP_LOC_ID_OFFSET + 1502, LocationType.VANILLA,
            lambda state: logic.zerg_common_unit(state) or state.has(item_names.OVERLORD_VENTRAL_SACS, player)),
        ...
        make_location_data(SC2Mission.THE_DIG_Z.mission_name, "Victory", SC2_RACESWAP_LOC_ID_OFFSET + 1700, LocationType.VICTORY,
            lambda state: (
                (logic.zerg_competent_anti_air(state) or adv_tactics and logic.zerg_moderate_anti_air(state))
        ...
        make_location_data(SC2Mission.THE_DIG_P.mission_name, "Victory", SC2_RACESWAP_LOC_ID_OFFSET + 1800, LocationType.VICTORY,
            lambda state: (
                (logic.protoss_anti_armor_anti_air(state) or adv_tactics and logic.protoss_moderate_anti_air(state))
        ...
        make_location_data(SC2Mission.THE_MOEBIUS_FACTOR_Z.mission_name, "Victory", SC2_RACESWAP_LOC_ID_OFFSET + 1900, LocationType.VICTORY,
            lambda state: (
                ...
                and (logic.zerg_versatile_air(state)
                    or state.has_any({item_names.YGGDRASIL, item_names.OVERLORD_VENTRAL_SACS, item_names.NYDUS_WORM, item_names.BULLFROG}, player)
                    and logic.zerg_common_unit(state)))
        ),
        ...
        make_location_data(SC2Mission.THE_MOEBIUS_FACTOR_Z.mission_name, "South Rescue", SC2_RACESWAP_LOC_ID_OFFSET + 1903, LocationType.EXTRA,
            lambda state: state.has_any({item_names.YGGDRASIL, item_names.OVERLORD_VENTRAL_SACS, item_names.NYDUS_WORM, item_names.BULLFROG}, player)
        ),
        ...
        make_location_data(SC2Mission.THE_GREAT_TRAIN_ROBBERY_Z.mission_name, "Close Infested Diamondback", SC2_RACESWAP_LOC_ID_OFFSET + 3304, LocationType.EXTRA),
        make_location_data(SC2Mission.THE_GREAT_TRAIN_ROBBERY_Z.mission_name, "Northwest Infested Diamondback", SC2_RACESWAP_LOC_ID_OFFSET + 3305, LocationType.EXTRA),
        make_location_data(SC2Mission.THE_GREAT_TRAIN_ROBBERY_Z.mission_name, "North Infested Diamondback", SC2_RACESWAP_LOC_ID_OFFSET + 3306, LocationType.EXTRA),
        make_location_data(SC2Mission.THE_GREAT_TRAIN_ROBBERY_Z.mission_name, "Northeast Infested Diamondback", SC2_RACESWAP_LOC_ID_OFFSET + 3307, LocationType.EXTRA),
        make_location_data(SC2Mission.THE_GREAT_TRAIN_ROBBERY_Z.mission_name, "Southwest Infested Diamondback", SC2_RACESWAP_LOC_ID_OFFSET + 3308, LocationType.EXTRA),
        make_location_data(SC2Mission.THE_GREAT_TRAIN_ROBBERY_Z.mission_name, "Southeast Infested Diamondback", SC2_RACESWAP_LOC_ID_OFFSET + 3309, LocationType.EXTRA),
        ...
        make_location_data(SC2Mission.ECHOES_OF_THE_FUTURE_T.mission_name, "West Obelisk", SC2_RACESWAP_LOC_ID_OFFSET + 4702, LocationType.VANILLA,
            lambda state: adv_tactics or (logic.terran_common_unit(state) and logic.terran_basic_anti_air(state))
        ),
        ...
        make_location_data(SC2Mission.SHATTER_THE_SKY_P.mission_name, "Victory", SC2_RACESWAP_LOC_ID_OFFSET + 5600, LocationType.VICTORY,
            lambda state: logic.protoss_competent_comp(state) and logic.protoss_army_weapon_armor_upgrade_min_level(state) >= 2
        ),
        ...
        make_location_data(SC2Mission.DOMINATION_T.mission_name, "Victory", SC2_RACESWAP_LOC_ID_OFFSET + 7100, LocationType.VICTORY,
            lambda state: logic.terran_common_unit(state) and (logic.terran_basic_anti_air(state) or adv_tactics)
        ),
        ...
        make_location_data(SC2Mission.DOMINATION_P.mission_name, "Victory", SC2_RACESWAP_LOC_ID_OFFSET + 7200, LocationType.VICTORY,
            lambda state: logic.protoss_common_unit(state) and (adv_tactics or logic.protoss_basic_anti_air(state))
        ),
        ...
        make_location_data(SC2Mission.WAKING_THE_ANCIENT_T.mission_name, "Flawless", SC2_RACESWAP_LOC_ID_OFFSET + 7709, LocationType.CHALLENGE,
            lambda state: (
                    ...
                    and (
                        # Fast unit
                        state.has_any((item_names.BANSHEE, item_names.VULTURE, item_names.DIAMONDBACK, item_names.WARHOUND, item_names.CYCLONE), player)
                        or state.has_all((item_names.VALKYRIE, item_names.VALKYRIE_FLECHETTE_MISSILES), player)
                        or state.has_all((item_names.WRAITH, item_names.WRAITH_ADVANCED_LASER_TECHNOLOGY), player)
                    )
            ),
            flags=LocationFlag.PREVENTATIVE,
            hard_rule=logic.terran_any_anti_air,
        ...
        make_location_data(SC2Mission.DEATH_FROM_ABOVE_P.mission_name, "Victory", SC2_RACESWAP_LOC_ID_OFFSET + 9600, LocationType.VICTORY,
            lambda state: logic.protoss_deathball or (adv_tactics and logic.protoss_competent_comp(state))
        ),
        ...
        make_location_data(SC2Mission.THE_RECKONING_P.mission_name, "Trash the Odin Early", SC2_RACESWAP_LOC_ID_OFFSET + 9805, LocationType.MASTERY,
            lambda state: (
                    ...
                    and (logic.protoss_fleet(state) or logic.protoss_power_rating(state) >= 10)),
            flags=LocationFlag.SPEEDRUN
        ),
        ...
        make_location_data(SC2Mission.DARK_WHISPERS_Z.mission_name, "Victory", SC2_RACESWAP_LOC_ID_OFFSET + 10000, LocationType.VICTORY,
            lambda state: logic.zerg_competent_comp and logic.zerg_moderate_anti_air(state)
        ),
        ...
        make_location_data(SC2Mission.LAST_STAND_T.mission_name, "1.5 Billion Zerg", SC2_RACESWAP_LOC_ID_OFFSET + 11705, LocationType.VANILLA,
                           lambda state: logic.terran_last_stand_requirement(state) and logic.terran_defense_rating(state, True, True) >= 13
                           ),
        ...
        make_location_data(SC2Mission.RAK_SHIR_T.mission_name, "Win in under 15 minutes", SC2_RACESWAP_LOC_ID_OFFSET + 13306, LocationType.MASTERY,
            logic.terran_rak_shir_requirement,
            flags=LocationFlag.SPEEDRUN
        ),
