...
_all_items: List[MedievilItemData] = [
    ...
    ("Equipment: Club", 34, MedievilItemCategory.PROGRESSION, False),
    ...
    ("Key Item: Amber Piece 2", 107, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Amber Piece 3", 107, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Amber Piece 4", 107, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Amber Piece 5", 107, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Amber Piece 6", 107, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Amber Piece 7", 107, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Harvester Parts", 108, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Skull Key", 109, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Sheet Music", 110, MedievilItemCategory.PROGRESSION, True),

    # Runes
    ("Chaos Rune: The Graveyard", 111, MedievilItemCategory.PROGRESSION, True),
    ("Chaos Rune: The Hilltop Mausoleum", 112, MedievilItemCategory.PROGRESSION, True),
    ("Chaos Rune: Scarecrow Fields", 113, MedievilItemCategory.PROGRESSION, True),
    ("Chaos Rune: The Lake", 114, MedievilItemCategory.PROGRESSION, True),
    ("Chaos Rune: Pumpkin Gorge", 115, MedievilItemCategory.PROGRESSION, True),
    ("Chaos Rune: Sleeping Village", 116, MedievilItemCategory.PROGRESSION, True),
    ("Chaos Rune: Pools of the Ancient Dead", 117, MedievilItemCategory.PROGRESSION, True),
    ("Chaos Rune: Asylum Grounds", 118, MedievilItemCategory.PROGRESSION, True),
    ("Chaos Rune: The Haunted Ruins", 119, MedievilItemCategory.PROGRESSION, True),
    ("Chaos Rune: Ghost Ship", 120, MedievilItemCategory.PROGRESSION, True),
    ("Chaos Rune: The Time Device", 121, MedievilItemCategory.PROGRESSION, True),

    ("Earth Rune: The Graveyard", 122, MedievilItemCategory.PROGRESSION, True),
    ("Earth Rune: The Hilltop Mausoleum", 123, MedievilItemCategory.PROGRESSION, True),
    ("Earth Rune: Scarecrow Fields", 124, MedievilItemCategory.PROGRESSION, True),
    ("Earth Rune: The Crystal Caves", 125, MedievilItemCategory.PROGRESSION, True),
    ("Earth Rune: The Lake", 126, MedievilItemCategory.PROGRESSION, True),
    ("Earth Rune: Pumpkin Gorge", 127, MedievilItemCategory.PROGRESSION, True),
    ("Earth Rune: Sleeping Village", 128, MedievilItemCategory.PROGRESSION, True),
    ("Earth Rune: Inside the Asylum", 129, MedievilItemCategory.PROGRESSION, True),
    ("Earth Rune: Enchanted Earth", 130, MedievilItemCategory.PROGRESSION, True),
    ("Earth Rune: The Haunted Ruins", 131, MedievilItemCategory.PROGRESSION, True),
    ("Earth Rune: The Entrance Hall", 132, MedievilItemCategory.PROGRESSION, True),
    ("Earth Rune: The Time Device", 133, MedievilItemCategory.PROGRESSION, True),

    ("Moon Rune: The Hilltop Mausoleum", 134, MedievilItemCategory.PROGRESSION, True),
    ("Moon Rune: Scarecrow Fields", 135, MedievilItemCategory.PROGRESSION, True),
    ("Moon Rune: Pumpkin Gorge", 136, MedievilItemCategory.PROGRESSION, True),
    ("Moon Rune: Ghost Ship", 137, MedievilItemCategory.PROGRESSION, True),
    ("Moon Rune: The Time Device", 138, MedievilItemCategory.PROGRESSION, True),

    ("Star Rune: Return to the Graveyard", 139, MedievilItemCategory.PROGRESSION, True),
    ("Star Rune: Dan's Crypt", 140, MedievilItemCategory.PROGRESSION, True),
    ("Star Rune: The Crystal Caves", 141, MedievilItemCategory.PROGRESSION, True),
    ("Star Rune: The Lake", 142, MedievilItemCategory.PROGRESSION, True),
    ("Star Rune: Enchanted Earth", 143, MedievilItemCategory.PROGRESSION, True),
    ("Star Rune: The Gallows Gauntlet", 144, MedievilItemCategory.PROGRESSION, True),
    ("Star Rune: Ghost Ship", 145, MedievilItemCategory.PROGRESSION, True),

    ("Time Rune: The Lake", 146, MedievilItemCategory.PROGRESSION, True),
    ("Time Rune: Pumpkin Gorge", 147, MedievilItemCategory.PROGRESSION, True),
    ("Time Rune: The Time Device", 148, MedievilItemCategory.PROGRESSION, True)
]
