...
_all_items: List[MedievilItemData] = [
    ...
    ("Key Item: Soul Helmet 1", 92, MedievilItemCategory.PROGRESSION, True),
    ...
    ("Key Item: Crucifix", 103, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Landlords Bust", 104, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Crucifix Cast", 105, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Amber Piece 1", 106, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Amber Piece 2", 106, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Amber Piece 3", 106, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Amber Piece 4", 106, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Amber Piece 5", 106, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Amber Piece 6", 106, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Amber Piece 7", 106, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Harvester Parts", 107, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Skull Key", 108, MedievilItemCategory.PROGRESSION, True),
    ("Key Item: Sheet Music", 109, MedievilItemCategory.PROGRESSION, True),
