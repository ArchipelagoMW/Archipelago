...
"MainWorld": [
    ...
    MedievilLocationData("Ant Caves Cleared","Level_End",7,MedievilLocationCategory.LEVEL_END),
    ...
    MedievilLocationData("The Gallows Gauntlet (needs more info) Cleared","Level_End" ,17,MedievilLocationCategory.LEVEL_END), 
