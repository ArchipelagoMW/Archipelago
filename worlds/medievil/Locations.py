...
location_tables = {
    ...
    "Dan's Crypt": [
         ...
         MedievilLocationData("Equipment: Copper Shield in Chest - DC","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ...
    "The Graveyard": [
         ...
         MedievilLocationData("Equipment: Copper Shield - TG","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ...
    "Cemetery Hill": [
         ...
         MedievilLocationData("Equipment: Copper Shield 1 - CH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Equipment: Copper Shield 2 - CH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Equipment: Copper Shield 3 - CH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Equipment: Club - CH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ...
    "The Hilltop Mausoleum": [
        # REQUIRES CLUB TO PROGRESS
         ...
         MedievilLocationData("Equipment: Club near Broken Benches - HM","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Equipment: Daggers near Block Puzzle - HM","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ...
    "Return to the Graveyard": [
        # REQUIRES SKULL KEY TO PROGRESS
         ...
         MedievilLocationData("Equipment: Silver Shield in Chest at Shop - RTG","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Skill: Daring Dash","Gold Shield Ammo (100)", MedievilLocationCategory.FUN),
    ...
    "Scarecrow Fields": [
        ...
        # Requires Harvester Parts for Chalice
         ...
         MedievilLocationData("Chaos Rune: Scarecrow Fields","Gold Shield Ammo (100)",MedievilLocationCategory.PROGRESSION),
         MedievilLocationData("Earth Rune: Scarecrow Fields","Gold Shield Ammo (100)",MedievilLocationCategory.PROGRESSION),
         MedievilLocationData("Moon Rune: Scarecrow Fields","Gold Shield Ammo (100)",MedievilLocationCategory.PROGRESSION),
         MedievilLocationData("Equipment: Club Inside Hut - SF","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Equipment: Silver Shield Behind Windmill - SF","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Equipment: Copper Shield in Chest In the Barn - SF","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ...
    "Ant Hill": [
        # Requres Witches Talisman
         ...
         MedievilLocationData("Equipment: Club in Chest at Barrier - TA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         ...
         MedievilLocationData("Gold Coins: Maggot at Amber 2 - TA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Gold Coins: Maggot after Amber 2 - TA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Gold Coins: Fairy 2 Room Center - TA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Gold Coins: Fairy 2 Room Maggot - TA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Gold Coins: Maggots before Amber 4 - TA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Gold Coins: Maggots at Amber 5 - TA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Gold Coins: Maggots at Amber 7 - TA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Gold Coins: Maggot in nest at Amber 7 - TA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Gold Coins: Maggot in Nest - TA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Gold Coins: Maggot after Fairy 4 - TA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Gold Coins: Maggot after Fairy 4 in Nest - TA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Gold Coins: Maggot at Fairy 5 - TA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Gold Coins: Maggot near Amber 9 - TA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Gold Coins: Maggot near Shop - TA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ...
    "Enchanted Earth": [
        # Requires Shadow Talisman
         ...
         MedievilLocationData("Equipment: Copper Shield in Egg - EE","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         ...
         MedievilLocationData("Gold Coins: Chest In Egg - EE","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ...
    "The Sleeping Village": [
         ...
         MedievilLocationData("Equipment: Silver Shield in Blacksmiths - SV","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Equipment: Club Chest under Inn Stairs - SV","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ...
    "Pools of the Ancient Dead": [
         ...
         MedievilLocationData("Equipment: Silver Shield in Chest Near Soul 5 - PAD","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ...
    "The Lake": [
         ...
         MedievilLocationData("Equipment: Silver Shield In Whirlpool - TL","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ...
    "The Gallows Gauntlet": [
        # Requires Dragon Armour
         ...
         MedievilLocationData("Equipment: Silver Shield in Chest Near Exit - GG","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ...
    "Asylum Grounds": [
         ...
         MedievilLocationData("Equipment: Silver Shield in Chest Behind Door - AG","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ...
    "Inside the Asylum": [
         ...
         MedievilLocationData("Equipment: Silver Shield in Bat Room - IA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Energy Vial: Bat Room - IA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Energy Vial: Asylumn Room 1 - IA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Energy Vial: Asylumn Room 2 - IA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Gold Coins: Bag in Bat Room Left - IA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Gold Coins: Chest in Bat Room - IA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Gold Coins: Bag in Bat Room Centre - IA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Gold Coins: Bag in Bat Room Right - IA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Gold Coins: Bag in Asylumn Room - IA","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ...
    "Pumpkin Gorge": [
         ...
         MedievilLocationData("Equipment: Club in Chest in Tunnel - PG","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Equipment: Silver Shield in Chest at Top of Hill - PG","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ...
    "Pumpkin Serpent": [
         ...
         MedievilLocationData("Equipment: Silver Shield in Chest near Leeches - PS","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ...
    "The Haunted Ruins": [
         ...
         MedievilLocationData("Equipment: Silver Shield in Chest Near Rune Door - HR","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ...
    "The Ghost Ship": [
         ...
         MedievilLocationData("Equipment: Silver Shield in Chest in Barrel Room - GS","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
         MedievilLocationData("Equipment: Club in Chest at Captain - GS","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ...
    "The Time Device": [
         ...
         MedievilLocationData("Equipment: Silver Shield on Clock - TD","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ...
    "Zaroks Lair": [
         MedievilLocationData("Equipment: Good Lightning - ZL","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
