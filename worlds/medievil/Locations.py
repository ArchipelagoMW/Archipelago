...
list_of_level_locations = [
    ...
    ["Energy Vial: Imanzi Shongama 1 - HH","Level_End",MedievilLocationCategory.FUN],
    ["Energy Vial: Imanzi Shongama 2 - HH","Level_End",MedievilLocationCategory.FUN],
    ["Energy Vial: Megwynne Stormbinder 1 - HH","Level_End",MedievilLocationCategory.FUN],
    ["Energy Vial: Megwynne Stormbinder 2 - HH","Level_End",MedievilLocationCategory.FUN],
    ["Energy Vial: Megwynne Stormbinder 3 - HH","Level_End",MedievilLocationCategory.FUN],
    ...
    ["Gold Coins: Life Bottle Left Chest - TG","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Life Bottle Right Chest - TG","Level_End",MedievilLocationCategory.FUN],
    ...
    ["Equipment: Copper Shield 1 - CH","Level_End",MedievilLocationCategory.FUN],
    ["Equipment: Copper Shield 2 - CH","Level_End",MedievilLocationCategory.FUN],
    ["Equipment: Copper Shield 3 - CH","Level_End",MedievilLocationCategory.FUN],
    ...
    ["Energy Vial: Near Shop - CH","Level_End",MedievilLocationCategory.FUN],
    ...
    ["Energy Vial: Near Rune on Left Ramp - HM","Level_End",MedievilLocationCategory.FUN],
    ["Energy Vial: Phantom of the Opera on Left - HM","Level_End",MedievilLocationCategory.FUN],
    ["Energy Vial: Phantom of the Opera on Right - HM","Level_End",MedievilLocationCategory.FUN],
    ...
    ["Gold Coins: Gold Chest at Phantom of the Opera 1 - HM","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Gold Chest at Phantom of the Opera 2 - HM","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Gold Chest at Phantom of the Opera 3 - HM","Level_End",MedievilLocationCategory.FUN],
    ...
    ["Energy Vial: Below Shop - RTG","Level_End",MedievilLocationCategory.FUN],
    ...
    ["Key Item: Amber Piece 1 - TA","Level_End",MedievilLocationCategory.PROGRESSION],
    ["Key Item: Amber Piece 2 - TA","Level_End",MedievilLocationCategory.PROGRESSION],
    ["Key Item: Amber Piece 3 - TA","Level_End",MedievilLocationCategory.PROGRESSION],
    ["Key Item: Amber Piece 4 - TA","Level_End",MedievilLocationCategory.PROGRESSION],
    ["Key Item: Amber Piece 5 - TA","Level_End",MedievilLocationCategory.PROGRESSION],
    ["Key Item: Amber Piece 6 - TA","Level_End",MedievilLocationCategory.PROGRESSION],
    ["Key Item: Amber Piece 7 - TA","Level_End",MedievilLocationCategory.PROGRESSION],
    ["Key Item: Amber Piece 8 - TA","Level_End",MedievilLocationCategory.PROGRESSION],
    ["Key Item: Amber Piece 9 - TA","Level_End",MedievilLocationCategory.PROGRESSION],
    ["Key Item: Amber Piece 10 - TA","Level_End",MedievilLocationCategory.PROGRESSION],
    ["Equipment: Club in Chest at Barrier - TA","Level_End",MedievilLocationCategory.FUN],
    ["Equipment: Chicken Drumsticks - TA","Level_End",MedievilLocationCategory.FUN],
    ["Energy Vial: Before Fairy 1 - TA","Level_End",MedievilLocationCategory.FUN],
    ["Energy Vial: After Amber 2 - TA","Level_End",MedievilLocationCategory.FUN],
    ["Energy Vial: Fairy 2 Room Center - TA","Level_End",MedievilLocationCategory.FUN],
    ["Energy Vial: Fairy 3 - TA","Level_End",MedievilLocationCategory.FUN],
    ["Energy Vial: Birthing room exit - TA","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Chest at Barrier Fairy - TA","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Maggot at Amber 2 - TA","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Maggot after Amber 2 - TA","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Fairy 2 Room Center - TA","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Fairy 2 Room Maggot - TA","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Maggots before Amber 4 - TA","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Maggots at Amber 5 - TA","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Maggots at Amber 7 - TA","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Maggot in nest at Amber 7 - TA","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Maggot in Nest - TA","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Maggot after Fairy 4 - TA","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Maggot after Fairy 4 in Nest - TA","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Maggot at Fairy 5 - TA","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Maggot near Amber 9 - TA","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Maggot near Shop - TA","Level_End",MedievilLocationCategory.FUN],
    ...
    ["Equipment: Silver Shield In Whirlpool - TL","Level_End",MedievilLocationCategory.FUN],
    ...
    ["Star Rune: The Gallows Gauntlet","Level_End",MedievilLocationCategory.PROGRESSION],
    ...
    # Pumpkin Gorge
    ["Time Rune: Pumpkin Gorge","Level_End",MedievilLocationCategory.PROGRESSION], # this one is wierd
    ...
    ["Equipment: Silver Shield on Clock - TD","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Laser Platform Right - TD","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Laser Platform Left - TD","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Lone Pillar 1 - TD","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Lone Pillar 2 - TD","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Lone Pillar 3 - TD","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Bag at Earth Station 1 - TD","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Bag at Earth Station 2 - TD","Level_End",MedievilLocationCategory.FUN],
    ["Gold Coins: Bag at Earth Station 3 - TD","Level_End",MedievilLocationCategory.FUN],
    ...
    # Zaroks Lair    
    ["Equipment: Good Lightning - ZL","Level_End",MedievilLocationCategory.FUN],
    ["Equipment: Silver Shield - ZL Arena","Level_End",MedievilLocationCategory.FUN],
