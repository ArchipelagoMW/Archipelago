    ...
    def CanEnter(self, items:Progression):
        if self.Logic == SMLogic.Normal:
            return items.Varia and items.CardLowerNorfairL1 and (
                    World.CanEnter("Norfair Upper East", items) and items.CanUsePowerBombs() and items.SpaceJump and items.Gravity or
            ...
            return items.Varia and items.CardLowerNorfairL1 and (
                    World.CanEnter("Norfair Upper East", items) and items.CanUsePowerBombs() and (items.HiJump or items.Gravity) or
