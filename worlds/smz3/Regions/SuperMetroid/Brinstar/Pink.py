from Region import SMRegion, RewardType
    ...
    def __init__(self, world: World, config: Config):
        ...
        self.Locations = [
            ...
            Location(self, 24, 0x8F865C, LocationType.Visible, "Power Bomb (pink Brinstar)", 
                lambda items: items.CanUsePowerBombs() and items.Super and items.HasEnergyReserves(1),
            ...
            Location(self, 35, 0x8F8824, LocationType.Visible, "Energy Tank, Brinstar Gate", 
                lambda items: items.CardBrinstarL2 and items.CanUsePowerBombs() and items.Wave and items.HasEnergyReserves(1),
