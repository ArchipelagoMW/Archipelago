...
class ThievesTown(Z3Region, IReward):
        ...
        self.Locations = [
            ...
            Location(self, 256+159, 0x1EA10, LocationType.Regular, "Thieves' Town - Big Chest",
                lambda items: items.BigKeyTT and items.Hammer and
                    (self.GetLocation("Thieves' Town - Big Chest").ItemIs(ItemType.KeyTT, World) or items.KeyTT))
                .AlwaysAllow(lambda item, items: item.Is(ItemType.KeyTT, World) and items.Hammer),
    ...
    def CanEnter(self, items: Progression):
        return items.MoonPearl and World.CanEnter("Dark World North West", items)
