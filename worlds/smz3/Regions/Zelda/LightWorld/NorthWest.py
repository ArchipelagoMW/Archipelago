    ...
    def __init__(self, world: World, config: Config):
        ...
        self.Locations = [
            Location(self, 256+14, 0x589B0, LocationType.Pedestal, "Master Sword Pedestal",
                lambda items: World.CanAquireAll(items, RewardType.PendantGreen, RewardType.PendantNonGreen)),
            ...
            Location(self, 256+17, 0x308001, LocationType.Regular, "Lumberjack Tree",
                lambda items: World.CanAquire(items, RewardType.Agahnim) and items.Boots),
            ...
            Location(self, 256+19, 0x308004, LocationType.Regular, "Graveyard Ledge",
                lambda items: items.Mirror and items.MoonPearl and World.CanEnter("Dark World North West", items)),
            Location(self, 256+20, 0x1E97A, LocationType.Regular, "King's Tomb",
                lambda items: items.Boots and (
                    items.CanLiftHeavy() or
                    items.Mirror and items.MoonPearl and World.CanEnter("Dark World North West", items))),
