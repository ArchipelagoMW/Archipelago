...
class SwampPalace(Z3Region, IReward):
    ...
    def __init__(self, world: World, config: Config):
        ...
        self.Locations = [
            Location(self, 256+135, 0x1EA9D, LocationType.Regular, "Swamp Palace - Entrance")
                .Allow(lambda item, items: Config.Keysanity or item.Is(ItemType.KeySP, World)),
            ...
            Location(self, 256+137, 0x1E989, LocationType.Regular, "Swamp Palace - Big Chest",
                ...
                .AlwaysAllow(lambda item, items: item.Is(ItemType.BigKeySP, World)),
    ...
    def CanEnter(self, items: Progression):
        return items.MoonPearl and items.Mirror and items.Flippers and World.CanEnter("Dark World South", items)
