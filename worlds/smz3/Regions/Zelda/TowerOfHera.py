...
class TowerOfHera(Z3Region, IReward):
    ...
    def __init__(self, world: World, config: Config):
        ...
        self.Locations = [
            ...
            Location(self, 256+117, 0x1E9E6, LocationType.Regular, "Tower of Hera - Big Key Chest",
                ...
                .AlwaysAllow(lambda item, items: item.Is(ItemType.KeyTH, World)),
    ...
    def CanEnter(self, items: Progression):
        return (items.Mirror or items.Hookshot and items.Hammer) and World.CanEnter("Light World Death Mountain West", items)
