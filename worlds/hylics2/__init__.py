...
class Hylics2World(World):
    ...
    def create_regions(self) -> None:
        ...
        region_table: Dict[int, Region] = {
            0: Region("Menu", self.player, self.world),
            1: Region("Afterlife", self.player, self.world),
            2: Region("Waynehouse", self.player, self.world),
            3: Region("World", self.player, self.world),
            4: Region("New Muldul", self.player, self.world),
            5: Region("New Muldul Vault", self.player, self.world),
            6: Region("Viewax", self.player, self.world, "Viewax's Edifice"),
            7: Region("Airship", self.player, self.world),
            8: Region("Arcade Island", self.player, self.world),
            9: Region("TV Island", self.player, self.world),
            10: Region("Juice Ranch", self.player, self.world),
            11: Region("Shield Facility", self.player, self.world),
            12: Region("Worm Pod", self.player, self.world),
            13: Region("Foglast", self.player, self.world),
            14: Region("Drill Castle", self.player, self.world),
            15: Region("Sage Labyrinth", self.player, self.world),
            16: Region("Sage Airship", self.player, self.world),
            17: Region("Hylemxylem", self.player, self.world)
        }
