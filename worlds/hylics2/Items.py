...
item_table: Dict[int, ItemDict] = {
    # Things
    200622: {'classification': ItemClassification.Philler,
             'count': 1,
             'name': 'DUBIOUS BERRY'},
    200623: {'classification': ItemClassification.Philler,
             'count': 11,
             'name': 'BURRITO'},
    200624: {'classification': ItemClassification.Philler,
             'count': 1,
             'name': 'COFFEE'},
    200625: {'classification': ItemClassification.Philler,
             'count': 6,
             'name': 'SOUL SPONGE'},
    200626: {'classification': ItemClassification.useful,
             'count': 6,
             'name': 'MUSCLE APPLIQUE'},
    200627: {'classification': ItemClassification.Philler,
             'count': 1,
             'name': 'POOLWINE'},
    200628: {'classification': ItemClassification.Philler,
             'count': 3,
             'name': 'CUPCAKE'},
    200629: {'classification': ItemClassification.Philler,
             'count': 3,
             'name': 'COOKIE'},
    200630: {'classification': ItemClassification.progression,
             'count': 1,
             'name': 'HOUSE KEY'},
    200631: {'classification': ItemClassification.Philler,
             'count': 2,
             'name': 'MEAT'},
    ...
    200633: {'classification': ItemClassification.progression,
             'count': 1,
             'name': 'CAVE KEY'},
    200634: {'classification': ItemClassification.Philler,
             'count': 6,
             'name': 'JUICE'},
    200635: {'classification': ItemClassification.progression,
             'count': 1,
             'name': 'DOCK KEY'},
    200636: {'classification': ItemClassification.Philler,
             'count': 14,
             'name': 'BANANA'},
    ...
    200641: {'classification': ItemClassification.progression,
             'count': 1,
             'name': 'BRIDGE KEY'},
    200642: {'classification': ItemClassification.Philler,
             'count': 2,
             'name': 'STEM CELL'},
    ...
    200645: {'classification': ItemClassification.Philler,
             'count': 3,
             'name': 'CLOUD GERM'},
    ...
    200648: {'classification': ItemClassification.progression,
             'count': 1,
             'name': 'DEEP KEY'},
    200649: {'classification': ItemClassification.Philler,
             'count': 1,
             'name': 'MULTI-COFFEE'},
    200650: {'classification': ItemClassification.Philler,
             'count': 4,
             'name': 'MULTI-JUICE'},
    200651: {'classification': ItemClassification.Philler,
             'count': 1,
             'name': 'MULTI STEM CELL'},
    200652: {'classification': ItemClassification.Philler,
             'count': 6,
             'name': 'MULTI SOUL SPONGE'},
    #200653: {'classification': ItemClassification.Philler,
    #         'count': 1,
    #         'name': 'ANTENNA'},
    ...
    # Bones
    200686: {'classification': ItemClassification.Philler,
             'count': 1,
             'name': '100 Bones'},
    200687: {'classification': ItemClassification.Philler,
             'count': 1,
             'name': '50 Bones'}
}
...
medallion_item_table: Dict[int, ItemDict] = {
    200692: {'classification': ItemClassification.Philler,
             'count': 30,
             'name': '10 Bones'}
}