...
item_data_table: Dict[str, WordipelagoItemData] = {
    ...
    "Letter L": WordipelagoItemData(code=12,type=ItemClassification.progression | ItemClassification.useful),
    ...
    "Letter P": WordipelagoItemData(code=16,type=ItemClassification.progression | ItemClassification.useful),
    "Letter Q": WordipelagoItemData(code=17,type=ItemClassification.progression),
    "Letter R": WordipelagoItemData(code=18,type=ItemClassification.progression | ItemClassification.useful),
    "Letter S": WordipelagoItemData(code=19,type=ItemClassification.progression | ItemClassification.useful),
    "Letter T": WordipelagoItemData(code=20,type=ItemClassification.progression | ItemClassification.useful),
