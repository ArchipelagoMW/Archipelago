...
## Optional Software
- [Map & Level tracker for Mega Man X2 Archipelago](https://github.com/BrianCumminger/megamanx2-ap-poptracker/releases), 
...
You can generate a yaml or download a template by visiting the [Mega Man X2 Player Options Page](/games/Mega%20Man%20X2%20/player-options)

## Joining a MultiWorld Game

### Get your Mega Man X2 patch

When you join a multiworld game, you will be asked to provide your config file to whoever is hosting. Once that is done,
the host will provide you with either a link to download your patch file, or with a zip file containing everyone's patch
files. Your patch file should have a `.apmmx2` extension.
