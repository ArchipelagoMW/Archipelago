# Mega Man X2 guía de instalación
...
- Una copia de tu Mega Man X2 US proveniente del cartucho original o de la Legacy Collection. La comunidad de 
...
## Software opcional
- [Tracker de mapa y niveles para Mega Man X2 Archipelago](https://github.com/BrianCumminger/megamanx2-ap-poptracker/releases), 
...
Puedes generar un archivo YAML or descargar su plantilla en la [página de configuración de jugador de Mega Man X2](/games/Mega%20Man%20X2%20/player-options)

## Unirse a un juego MultiWorld

### Obtener tu parche de Mega Man X2
...
todos. Tu archivo tiene una extensión `.apmmx2`.

Haz doble clic en tu archivo `.apmmx2` para que se ejecute el cliente y realice el parcheado del ROM.
