...
item_table: Dict[str, RLItemData] = {
    ...
    "Marluxia":              KHCOMItemData("Enemy Battle Cards", 266_2047, ItemClassification.useful,      1,  1),
    ...
    "Key of Guidance F13":   KHCOMItemData("Gold Map Cards",     266_3113, ItemClassification.progression, 1,  1),
    ...
    "Key to Truth F13":      KHCOMItemData("Gold Map Cards",     266_3213, ItemClassification.progression, 1,  1),
    "Key to Rewards F01":    KHCOMItemData("Gold Map Cards",     266_3301, ItemClassification.progression, 1,  1),
    "Key to Rewards F02":    KHCOMItemData("Gold Map Cards",     266_3302, ItemClassification.progression, 1,  1),
    "Key to Rewards F03":    KHCOMItemData("Gold Map Cards",     266_3303, ItemClassification.progression, 1,  1),
    "Key to Rewards F04":    KHCOMItemData("Gold Map Cards",     266_3304, ItemClassification.progression, 1,  1),
    "Key to Rewards F05":    KHCOMItemData("Gold Map Cards",     266_3305, ItemClassification.progression, 1,  1),
    "Key to Rewards F06":    KHCOMItemData("Gold Map Cards",     266_3306, ItemClassification.progression, 1,  1),
    "Key to Rewards F07":    KHCOMItemData("Gold Map Cards",     266_3307, ItemClassification.progression, 1,  1),
    "Key to Rewards F08":    KHCOMItemData("Gold Map Cards",     266_3308, ItemClassification.progression, 1,  1),
    "Key to Rewards F09":    KHCOMItemData("Gold Map Cards",     266_3309, ItemClassification.progression, 1,  1),
    "Key to Rewards F11":    KHCOMItemData("Gold Map Cards",     266_3311, ItemClassification.progression, 1,  1),
    "Key to Rewards F12":    KHCOMItemData("Gold Map Cards",     266_3312, ItemClassification.progression, 1,  1),
    "Key to Rewards F13":    KHCOMItemData("Gold Map Cards",     266_3313, ItemClassification.progression, 1,  1),
