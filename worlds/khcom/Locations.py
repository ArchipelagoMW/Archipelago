...
location_table: Dict[str, KHCOMLocationData] = {
    ...
    "Thunder":               KHCOMLocationData("Boss", 267_1019),
    ...
    "Simba":                 KHCOMLocationData("Boss", 267_1024),
    "Genie":                 KHCOMLocationData("Boss", 267_1025),
    "Bambi":                 KHCOMLocationData("Progression", 267_1026),
    "Dumbo":                 KHCOMLocationData("Boss", 267_1027),
    "Tinker Bell":           KHCOMLocationData("Boss", 267_1028),
    "Mushu":                 KHCOMLocationData("Progression", 267_1029),
    "Cloud":                 KHCOMLocationData("Boss", 267_1030),
    "Potion":                KHCOMLocationData("Progression", 267_1031),
    "Hi-Potion":             KHCOMLocationData("Boss", 267_1032),
    ...
    "Trickmaster":           KHCOMLocationData("Boss", 267_1040),
    "Darkside":              KHCOMLocationData("Boss", 267_1041),
    "Card Soldier (Red)":    KHCOMLocationData("Boss", 267_1042),
    "Hades":                 KHCOMLocationData("Boss", 267_1043),
    "Jafar":                 KHCOMLocationData("Boss", 267_1044),
    "Oogie Boogie":          KHCOMLocationData("Boss", 267_1045),
    "Ursula":                KHCOMLocationData("Boss", 267_1046),
    "Hook":                  KHCOMLocationData("Boss", 267_1047),
    ...
    "Wizard":                KHCOMLocationData("Enemy Unlock", 267_2031),
