...
def set_rules(multiworld: MultiWorld, player: int):
    ...
    multiworld.get_location("Ursula"             , player).access_rule = lambda state: has_room_of_truth     (state, player, "07") and has_room_of_truth(state, player, "06")
    multiworld.get_location("Aero"               , player).access_rule = lambda state: has_room_of_truth     (state, player, "07") and has_room_of_truth(state, player, "06")
    multiworld.get_location("Hook"               , player).access_rule = lambda state: has_room_of_truth     (state, player, "08") and has_room_of_truth(state, player, "06")
    multiworld.get_location("Tinker Bell"        , player).access_rule = lambda state: has_room_of_truth     (state, player, "08") and has_room_of_truth(state, player, "06")
    multiworld.get_location("Dragon Malificent"  , player).access_rule = lambda state: has_room_of_truth     (state, player, "09") and has_room_of_truth(state, player, "06")
    multiworld.get_location("Vexen"              , player).access_rule = lambda state: has_room_of_beginnings(state, player, "11") and has_room_of_truth(state, player, "06")
    multiworld.get_location("Mega-Potion"        , player).access_rule = lambda state: has_room_of_beginnings(state, player, "11") and has_room_of_truth(state, player, "06")
    multiworld.get_location("Darkside"           , player).access_rule = lambda state: has_room_of_guidance  (state, player, "12") and has_room_of_truth(state, player, "06")
    multiworld.get_location("Riku"               , player).access_rule = lambda state: has_room_of_guidance  (state, player, "12") and has_room_of_truth(state, player, "06")
    multiworld.get_location("Larxene"            , player).access_rule = lambda state: has_room_of_guidance  (state, player, "12") and has_room_of_truth(state, player, "06")
    multiworld.get_location("Axel"               , player).access_rule = lambda state: has_room_of_beginnings(state, player, "13") and has_room_of_truth(state, player, "06")
    multiworld.get_location("Marluxia"           , player).access_rule = lambda state: has_room_of_beginnings(state, player, "13") and has_room_of_truth(state, player, "06")
    #Room of Rewards
    ...
    multiworld.get_entrance("Floor 10", player).access_rule = lambda state: has_room_of_truth(state, player, "09")
