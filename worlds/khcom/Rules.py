...
def set_rules(multiworld: MultiWorld, player: int):
    ...
    # Region rules.
    multiworld.get_entrance("Floor 2" , player).access_rule = lambda state: state.has("Key of Beginnings F02", player)
    multiworld.get_entrance("Floor 3" , player).access_rule = lambda state: state.has("Key of Beginnings F03", player)
    multiworld.get_entrance("Floor 4" , player).access_rule = lambda state: state.has("Key of Beginnings F04", player)
    multiworld.get_entrance("Floor 5" , player).access_rule = lambda state: state.has("Key of Beginnings F05", player)
    multiworld.get_entrance("Floor 6" , player).access_rule = lambda state: state.has("Key of Beginnings F06", player)
    multiworld.get_entrance("Floor 7" , player).access_rule = lambda state: state.has("Key of Beginnings F07", player)
    multiworld.get_entrance("Floor 8" , player).access_rule = lambda state: state.has("Key of Beginnings F08", player)
    multiworld.get_entrance("Floor 9" , player).access_rule = lambda state: state.has("Key of Beginnings F09", player)
    multiworld.get_entrance("Floor 10", player).access_rule = lambda state: state.has("Key of Beginnings F10", player)
    multiworld.get_entrance("Floor 11", player).access_rule = lambda state: state.has("Key of Beginnings F11", player)
    multiworld.get_entrance("Floor 12", player).access_rule = lambda state: state.has("Key of Beginnings F12", player)
    multiworld.get_entrance("Floor 13", player).access_rule = lambda state: state.has_all({"Key of Beginnings F12", "Key of Guidance F12"}, player)
    # Win condition.
