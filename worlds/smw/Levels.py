...
level_blocks_data = {
        ...
        0x0E: [72],
        0x0F: [73, 74, 75, 76],
        0x10: [77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90, 91,
            92, 93, 94, 95, 96, 97, 98, 99, 100, 101, 102, 103, 104,
            105, 106, 107, 108, 109, 110, 111
        ],
        0x11: [112],
        0x13: [113, 114, 115, 116, 117],
        0x15: [118, 119, 120, 121, 122, 123, 124, 125, 126, 127, 128, 129,
        ...
        0x24: [187, 188, 189, 190, 191, 192, 193, 194, 195, 196, 197, 198,
            199, 200, 201, 202
        ],
        0x25: [203, 204, 205, 206, 207, 208],
        0x26: [209, 210, 211, 212],
        0x27: [213, 214, 215, 216, 217, 218, 219, 220, 221, 222, 223, 224,
            225, 226, 227, 228, 229, 230
        ],
        0x29: [231, 232, 233, 234],
        0x2A: [235, 236, 237, 238, 239, 240, 241, 242, 243, 244, 245, 246,
            247, 248, 249, 250
        ],
        0x2B: [251, 252, 253, 254, 255],
        0x2D: [256, 257, 258, 259, 260, 261, 262, 263],
        0x2E: [264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275,
            276, 277, 278, 279, 280
        ],
        0x2F: [281, 282, 283, 284, 285],
        0x33: [286, 287, 288, 289, 290, 291],
        0x34: [292, 293, 294],
        0x35: [295, 296],
        0x37: [297, 298],
        0x38: [299, 300, 301, 302],
        0x39: [303, 304, 305, 306],
        0x3A: [307, 308, 309, 310, 311, 312, 313, 314, 315],
        0x3B: [316, 317],
        0x3C: [318, 319, 320, 321, 322, 323, 324, 325, 326, 327, 328, 329,
            330
        ],
        ...
        0x43: [367, 368, 369, 370, 371, 372, 373, 374, 375, 376, 377, 378,
            379
        ],
        0x44: [380, 381, 382, 383, 384, 385, 386],
        0x46: [387, 388, 389],
        0x47: [390, 391, 392, 393, 394, 395, 396, 397, 398, 399, 400, 401,
            402, 403, 404, 405, 406, 407, 408, 409, 410, 411, 412,
            413, 414, 415, 416
        ],
        0x49: [417, 418, 419, 420, 421, 422, 423, 424, 425, 426, 427, 428,
            429, 430, 431, 432, 433, 434, 435, 436, 437, 438, 439,
            440, 441, 442, 443, 444, 445, 446
        ],
        0x4A: [447, 448, 449, 450, 451],
        0x4B: [452, 453, 454, 455, 456, 457, 458, 459, 460, 461, 462, 463,
            464, 465, 466, 467, 468, 469, 470, 471, 472, 473, 474,
            475, 476, 477, 478, 479, 480, 481, 482, 483, 484, 485,
            486, 487, 488, 489
        ],
        0x4C: [490],
        0x4E: [491, 492, 493, 494, 495, 496, 497, 498, 499, 500, 501, 502,
        ...
        0x5A: [539, 540, 541, 542, 543, 544, 545, 546, 547, 548, 549, 550,
...
location_id_to_level_id = {
    ...
    LocationName.yoshis_island_3_yellow_block_13: [0x27, 329],
    LocationName.yoshis_island_3_bonus_block_1: [0x27, 330],
    LocationName.yoshis_island_1_flying_block_1: [0x29, 331],
    LocationName.yoshis_island_1_yellow_block_1: [0x29, 332],
    LocationName.yoshis_island_1_life_block_1: [0x29, 333],
    LocationName.yoshis_island_1_powerup_block_1: [0x29, 334],
    LocationName.yoshis_island_2_flying_block_1: [0x2A, 335],
    LocationName.yoshis_island_2_flying_block_2: [0x2A, 336],
    LocationName.yoshis_island_2_flying_block_3: [0x2A, 337],
    LocationName.yoshis_island_2_flying_block_4: [0x2A, 338],
    LocationName.yoshis_island_2_flying_block_5: [0x2A, 339],
    LocationName.yoshis_island_2_flying_block_6: [0x2A, 340],
    LocationName.yoshis_island_2_coin_block_1: [0x2A, 341],
    LocationName.yoshis_island_2_yellow_block_1: [0x2A, 342],
    LocationName.yoshis_island_2_coin_block_2: [0x2A, 343],
    LocationName.yoshis_island_2_coin_block_3: [0x2A, 344],
    LocationName.yoshis_island_2_yoshi_block_1: [0x2A, 345],
    LocationName.yoshis_island_2_coin_block_4: [0x2A, 346],
    LocationName.yoshis_island_2_yoshi_block_2: [0x2A, 347],
    LocationName.yoshis_island_2_coin_block_5: [0x2A, 348],
    LocationName.yoshis_island_2_vine_block_1: [0x2A, 349],
    LocationName.yoshis_island_2_yellow_block_2: [0x2A, 350],
    LocationName.vanilla_ghost_house_powerup_block_1: [0x2B, 351],
    LocationName.vanilla_ghost_house_vine_block_1: [0x2B, 352],
    LocationName.vanilla_ghost_house_powerup_block_2: [0x2B, 353],
    LocationName.vanilla_ghost_house_multi_coin_block_1: [0x2B, 354],
    LocationName.vanilla_ghost_house_blue_pow_block_1: [0x2B, 355],
    LocationName.vanilla_secret_1_coin_block_1: [0x2D, 356],
    LocationName.vanilla_secret_1_powerup_block_1: [0x2D, 357],
    LocationName.vanilla_secret_1_multi_coin_block_1: [0x2D, 358],
    LocationName.vanilla_secret_1_vine_block_1: [0x2D, 359],
    LocationName.vanilla_secret_1_vine_block_2: [0x2D, 360],
    LocationName.vanilla_secret_1_coin_block_2: [0x2D, 361],
    LocationName.vanilla_secret_1_coin_block_3: [0x2D, 362],
    LocationName.vanilla_secret_1_powerup_block_2: [0x2D, 363],
    LocationName.vanilla_dome_3_coin_block_1: [0x2E, 364],
    LocationName.vanilla_dome_3_flying_block_1: [0x2E, 365],
    LocationName.vanilla_dome_3_flying_block_2: [0x2E, 366],
    LocationName.vanilla_dome_3_powerup_block_1: [0x2E, 367],
    LocationName.vanilla_dome_3_flying_block_3: [0x2E, 368],
    LocationName.vanilla_dome_3_invis_coin_block_1: [0x2E, 369],
    LocationName.vanilla_dome_3_powerup_block_2: [0x2E, 370],
    LocationName.vanilla_dome_3_multi_coin_block_1: [0x2E, 371],
    LocationName.vanilla_dome_3_powerup_block_3: [0x2E, 372],
    LocationName.vanilla_dome_3_yoshi_block_1: [0x2E, 373],
    LocationName.vanilla_dome_3_powerup_block_4: [0x2E, 374],
    LocationName.vanilla_dome_3_pswitch_coin_block_1: [0x2E, 375],
    LocationName.vanilla_dome_3_pswitch_coin_block_2: [0x2E, 376],
    LocationName.vanilla_dome_3_pswitch_coin_block_3: [0x2E, 377],
    LocationName.vanilla_dome_3_pswitch_coin_block_4: [0x2E, 378],
    LocationName.vanilla_dome_3_pswitch_coin_block_5: [0x2E, 379],
    LocationName.vanilla_dome_3_pswitch_coin_block_6: [0x2E, 380],
    LocationName.donut_secret_2_directional_coin_block_1: [0x2F, 381],
    LocationName.donut_secret_2_vine_block_1: [0x2F, 382],
    LocationName.donut_secret_2_star_block_1: [0x2F, 383],
    LocationName.donut_secret_2_powerup_block_1: [0x2F, 384],
    LocationName.donut_secret_2_star_block_2: [0x2F, 385],
    LocationName.valley_of_bowser_4_yellow_block_1: [0x33, 386],
    LocationName.valley_of_bowser_4_powerup_block_1: [0x33, 387],
    LocationName.valley_of_bowser_4_vine_block_1: [0x33, 388],
    LocationName.valley_of_bowser_4_yoshi_block_1: [0x33, 389],
    LocationName.valley_of_bowser_4_life_block_1: [0x33, 390],
    LocationName.valley_of_bowser_4_powerup_block_2: [0x33, 391],
    LocationName.valley_castle_yellow_block_1: [0x34, 392],
    LocationName.valley_castle_yellow_block_2: [0x34, 393],
    LocationName.valley_castle_green_block_1: [0x34, 394],
    LocationName.valley_fortress_green_block_1: [0x35, 395],
    LocationName.valley_fortress_yellow_block_1: [0x35, 396],
    LocationName.valley_of_bowser_3_powerup_block_1: [0x37, 397],
    LocationName.valley_of_bowser_3_powerup_block_2: [0x37, 398],
    LocationName.valley_ghost_house_pswitch_coin_block_1: [0x38, 399],
    LocationName.valley_ghost_house_multi_coin_block_1: [0x38, 400],
    LocationName.valley_ghost_house_powerup_block_1: [0x38, 401],
    LocationName.valley_ghost_house_directional_coin_block_1: [0x38, 402],
    LocationName.valley_of_bowser_2_powerup_block_1: [0x39, 403],
    LocationName.valley_of_bowser_2_yellow_block_1: [0x39, 404],
    LocationName.valley_of_bowser_2_powerup_block_2: [0x39, 405],
    LocationName.valley_of_bowser_2_wings_block_1: [0x39, 406],
    LocationName.valley_of_bowser_1_green_block_1: [0x3A, 407],
    LocationName.valley_of_bowser_1_invis_coin_block_1: [0x3A, 408],
    LocationName.valley_of_bowser_1_invis_coin_block_2: [0x3A, 409],
    LocationName.valley_of_bowser_1_invis_coin_block_3: [0x3A, 410],
    LocationName.valley_of_bowser_1_yellow_block_1: [0x3A, 411],
    LocationName.valley_of_bowser_1_yellow_block_2: [0x3A, 412],
    LocationName.valley_of_bowser_1_yellow_block_3: [0x3A, 413],
    LocationName.valley_of_bowser_1_yellow_block_4: [0x3A, 414],
    LocationName.valley_of_bowser_1_vine_block_1: [0x3A, 415],
    LocationName.chocolate_secret_powerup_block_1: [0x3B, 416],
    LocationName.chocolate_secret_powerup_block_2: [0x3B, 417],
    LocationName.vanilla_dome_2_coin_block_1: [0x3C, 418],
    LocationName.vanilla_dome_2_powerup_block_1: [0x3C, 419],
    LocationName.vanilla_dome_2_coin_block_2: [0x3C, 420],
    LocationName.vanilla_dome_2_coin_block_3: [0x3C, 421],
    LocationName.vanilla_dome_2_vine_block_1: [0x3C, 422],
    LocationName.vanilla_dome_2_invis_life_block_1: [0x3C, 423],
    LocationName.vanilla_dome_2_coin_block_4: [0x3C, 424],
    LocationName.vanilla_dome_2_coin_block_5: [0x3C, 425],
    LocationName.vanilla_dome_2_powerup_block_2: [0x3C, 426],
    LocationName.vanilla_dome_2_powerup_block_3: [0x3C, 427],
    LocationName.vanilla_dome_2_powerup_block_4: [0x3C, 428],
