...
level_info_dict = {
    ...
    0x14: SMWLevel(LocationName.yellow_switch_palace, 0x37813, 0x02),
    ...
    0x3C: SMWLevel(LocationName.vanilla_dome_2_region, 0x37C08, 0x17, SMWPath(0x08, 0x2E, 0x04), SMWPath(0x01, 0x3F, 0x08)),
    0x2D: SMWLevel(LocationName.vanilla_secret_1_region, 0x37C08, 0x1D, SMWPath(0x08, 0x01, 0x02), SMWPath(0x02, 0x2c, 0x01)),
    ...
    0x3F: SMWLevel(LocationName.red_switch_palace, 0x376D1, 0x29),
    ...
    0x0B: SMWLevel(LocationName.vanilla_fortress_region, 0x37730, 0x20, SMWPath(0x01, 0x0C, 0x02)),
    ...
    0x11: SMWLevel(LocationName.soda_lake_region, 0x37774, 0x60, SMWPath(0x04, 0x12, 0x04)),
    ...
    0x43: SMWLevel(LocationName.forest_of_illusion_4_region, 0x37CA4, 0x32, SMWPath(0x02, 0x44, 0x01), SMWPath(0x04, 0x46, 0x08)),
    ...
    0x45: SMWLevel(LocationName.blue_switch_palace, 0x376D1, 0x37),
    ...
    0x18: SMWLevel(LocationName.sunken_ghost_ship_region, 0x378BC, 0x4E, SMWPath(0x08, 0x3A, 0x01)),
