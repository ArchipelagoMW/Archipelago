...
all_random = {
    ...
    "castles_anywhere": "random",
    "exclude_special_zone": "random",
    "boss_shuffle": "random",
    "koopaling_health": "random",
    "bowser_health": "random",
    "swap_donut_gh_exits": "random",
    "level_name_shuffle": "random",
    "level_tile_shuffle": "random",
    ...
    "dry_trap_weight": "random",
    "ice_untrap_weight": "random",
    "timer_untrap_weight": "random",
    "reverse_untrap_weight": "random",
    "autosave": "random",
    "early_climb": "random",
...
allsanity = {
    ...
    "blocksanity": True,
    "level_shuffle": True,
    "castles_anywhere": True,
    "boss_shuffle": "full",
    "level_name_shuffle": "full",
    "level_tile_shuffle": "full",
    "music_shuffle": "full",
    "sfx_shuffle": "full",
    "mario_palette": "random",
