...
npc_release_table = {
    ...
    NPCName.MERMAID4                      : SoulBlazerItemData(ItemID.LAIR_RELEASE, LairID.MERMAID4                     , ItemClassification.progression),
    ...
    NPCName.MERMAID5                      : SoulBlazerItemData(ItemID.LAIR_RELEASE, LairID.MERMAID5                     , ItemClassification.progression),
