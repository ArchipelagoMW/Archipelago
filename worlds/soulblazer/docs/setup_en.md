# Soul Blazer Randomizer Setup Guide
...
- Hardware or software capable of loading and playing SNES ROM files
    ...
    - An SD2SNES, FXPak Pro ([FXPak Pro Store Page](https://krikzz.com/store/home/54-fxpak-pro.html)), or other
      compatible hardware
- Your legally obtained Soul Blazer US ROM file, probably named `Soul Blazer (USA).sfc`
...
them. Player options page: [Soul Blazer Player Options Page](/games/Soul%20Blazer/player-options)
...
1. Navigate to the Player Options page, configure your options, and click the "Generate Game" button.
    - Player Options page: [Soul Blazer Player Options Page](/games/Soul%20Blazer/player-options)
...
files. Your patch file should have a `.apsb` extension.
