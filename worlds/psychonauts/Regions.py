...
def create_figments_20_locations(multiworld: MultiWorld, player: int):
    ...
    _add_locations_to_existing_region(multiworld, player, RegionName.NIMP, {LocationName.BTFigments20})
...
def create_figments_40_locations(multiworld: MultiWorld, player: int):
    ...
    _add_locations_to_existing_region(multiworld, player, RegionName.NIMPMark, {LocationName.BTFigments40})
    _add_locations_to_existing_region(multiworld, player, RegionName.LOMAShield, {LocationName.LOFigments40})
    _add_locations_to_existing_region(multiworld, player, RegionName.MMI1AfterSign, {LocationName.MMFigments40})
...
def create_figments_60_locations(multiworld: MultiWorld, player: int):
    ...
    _add_locations_to_existing_region(multiworld, player, RegionName.NIMPMark, {LocationName.BTFigments60})
    _add_locations_to_existing_region(multiworld, player, RegionName.LOMAShield, {LocationName.LOFigments60})
...
def create_figments_80_locations(multiworld: MultiWorld, player: int):
    ...
    _add_locations_to_existing_region(multiworld, player, RegionName.NIBA, {LocationName.BTFigments80})
...
def create_figments_100_locations(multiworld: MultiWorld, player: int):
    ...
    _add_locations_to_existing_region(multiworld, player, RegionName.NIBA, {LocationName.BTFigments100})
