...
def create_figments_40_locations(multiworld: MultiWorld, player: int):
    ...
    _add_locations_to_existing_region(multiworld, player, RegionName.NIMPMark, {LocationName.NIFigments40})
...
def create_figments_60_locations(multiworld: MultiWorld, player: int):
    ...
    _add_locations_to_existing_region(multiworld, player, RegionName.NIMPMark, {LocationName.NIFigments60})
