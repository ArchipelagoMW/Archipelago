...
strawberry_location_data_table: Dict[str, Celeste64LocationData] = {
    ...
    LocationName.strawberry_21: Celeste64LocationData(RegionName.cassette_1,           celeste_64_base_id + 0x14),
    LocationName.strawberry_22: Celeste64LocationData(RegionName.cassette_2,           celeste_64_base_id + 0x15),
    LocationName.strawberry_23: Celeste64LocationData(RegionName.cassette_3,           celeste_64_base_id + 0x16),
    LocationName.strawberry_24: Celeste64LocationData(RegionName.cassette_4,           celeste_64_base_id + 0x17),
    LocationName.strawberry_25: Celeste64LocationData(RegionName.cassette_5,           celeste_64_base_id + 0x18),
    LocationName.strawberry_26: Celeste64LocationData(RegionName.cassette_6,           celeste_64_base_id + 0x19),
    LocationName.strawberry_27: Celeste64LocationData(RegionName.cassette_7,           celeste_64_base_id + 0x1A),
    LocationName.strawberry_28: Celeste64LocationData(RegionName.cassette_8,           celeste_64_base_id + 0x1B),
    LocationName.strawberry_29: Celeste64LocationData(RegionName.cassette_9,           celeste_64_base_id + 0x1C),
    LocationName.strawberry_30: Celeste64LocationData(RegionName.cassette_10,          celeste_64_base_id + 0x1D),
}
