...
location_standard_moves_logic: Dict[str, List[List[str]]] = {
    ...
    LocationName.strawberry_21: [[ItemName.traffic_block, ItemName.air_dash]],
    LocationName.strawberry_22: [[ItemName.dash_refill, ItemName.air_dash]],
    LocationName.strawberry_23: [[ItemName.coin, ItemName.air_dash, ItemName.climb]],
    LocationName.strawberry_24: [[ItemName.traffic_block, ItemName.air_dash]],
    LocationName.strawberry_25: [[ItemName.double_dash_refill, ItemName.air_dash, ItemName.climb]],
    LocationName.strawberry_26: [[ItemName.air_dash, ItemName.climb]],
    LocationName.strawberry_27: [[ItemName.coin, ItemName.air_dash, ItemName.climb]],
    LocationName.strawberry_28: [[ItemName.feather, ItemName.coin, ItemName.air_dash, ItemName.climb]],
    LocationName.strawberry_29: [[ItemName.dash_refill, ItemName.coin, ItemName.air_dash, ItemName.skid_jump]],
    LocationName.strawberry_30: [[ItemName.dash_refill, ItemName.double_dash_refill, ItemName.traffic_block, ItemName.spring, ItemName.breakables, ItemName.air_dash, ItemName.climb]],
...
location_hard_moves_logic: Dict[str, List[List[str]]] = {
    ...
    LocationName.strawberry_21: [[ItemName.traffic_block, ItemName.air_dash]],
    LocationName.strawberry_22: [[ItemName.ground_dash, ItemName.air_dash],
                                 [ItemName.dash_refill, ItemName.air_dash]],
    LocationName.strawberry_23: [[ItemName.coin, ItemName.air_dash]],
    LocationName.strawberry_24: [[ItemName.ground_dash, ItemName.air_dash],
                                 [ItemName.traffic_block, ItemName.air_dash]],
    LocationName.strawberry_25: [[ItemName.double_dash_refill, ItemName.air_dash, ItemName.climb]],
    LocationName.strawberry_26: [[ItemName.ground_dash],
                                 [ItemName.air_dash]],
    LocationName.strawberry_27: [[ItemName.air_dash, ItemName.skid_jump],
                                 [ItemName.coin, ItemName.ground_dash],
                                 [ItemName.coin, ItemName.air_dash]],
    LocationName.strawberry_28: [[ItemName.feather, ItemName.air_dash],
                                 [ItemName.feather, ItemName.climb]],
    LocationName.strawberry_29: [[ItemName.dash_refill, ItemName.air_dash, ItemName.skid_jump],
                                 [ItemName.ground_dash, ItemName.air_dash]],
    LocationName.strawberry_30: [[ItemName.dash_refill, ItemName.double_dash_refill, ItemName.traffic_block, ItemName.breakables, ItemName.air_dash, ItemName.climb, ItemName.skid_jump],
                                 [ItemName.dash_refill, ItemName.double_dash_refill, ItemName.traffic_block, ItemName.breakables, ItemName.spring, ItemName.air_dash, ItemName.climb]],
...
region_hard_moves_logic: Dict[Tuple[str], List[List[str]]] = {
    ...
    (RegionName.ne_feathers_island, RegionName.cassette_entrance_7): [[ItemName.feather],
                                                                      ...
                                                                      [ItemName.skid_jump, ItemName.air_dash]],
