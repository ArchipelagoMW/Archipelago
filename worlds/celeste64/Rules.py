...
location_standard_logic: Dict[str, List[List[str]]] = {
    ...
    LocationName.strawberry_14: [[ItemName.feather]],
    ...
    LocationName.strawberry_18: [[ItemName.double_dash_refill]],
    LocationName.strawberry_19: [[ItemName.double_dash_refill, ItemName.spring]],
    LocationName.strawberry_20: [[ItemName.feather, ItemName.breakables]],
    ...
    LocationName.strawberry_27: [[ItemName.cassette, ItemName.feather, ItemName.coin]],
    LocationName.strawberry_28: [[ItemName.cassette, ItemName.feather, ItemName.coin]],
    LocationName.strawberry_29: [[ItemName.cassette, ItemName.dash_refill, ItemName.coin]],
    LocationName.strawberry_30: [[ItemName.cassette, ItemName.dash_refill, ItemName.double_dash_refill, ItemName.traffic_block, ItemName.spring, ItemName.breakables]],
