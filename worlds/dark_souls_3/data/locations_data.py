...
painted_world_table = { # DLC
    ...
    "PW: Valorheart": 0x00F646E0, #!
    "PW: Champions Bones": 0x40000869, #!
    "PW: Onyx Blade": 0x00222E00, #!
    "PW: Soul of Sister Friede": 0x400002E8, #!
    "PW: Titanite Slab": 0x400003EB, #!
    "PW: Chillbite Ring": 0x20005208, #!
    "PW: Contraption Key": 0x4000086B #!
}
...
dreg_heap_table = { # DLC
    ...
    "DH: Lothric War Banner": 0x008D24D0, #! FIXED WRONG ID
...
ringed_city_table = { # DLC
    ...
    "RC: Titanite Slab": 0x400003EB, #!
    "RC: Crucifix of the Mad King": 0x008D4BE0, #!
    "RC: Sacred Chime of Filianore": 0x00CCECF0, #!
...
weapon_location_list = { # SOME LOCATIONS ARENT NORMALLY WEAPONS, BUT TO INCLUDE BOSS WEAPONS,
                         # WE INCLUDE THESE LOCATIONS TO THE POOL TO MAKE UP THE COUNT
