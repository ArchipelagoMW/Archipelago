...
_vanilla_items = [DS3ItemData(row[0], row[1], False, row[2]) for row in [
    ...
    ("Titanite Piece",                      0x400003E8, DS3ItemCategory.MISC),
    ("Large Titanite Piece",                0x400003E9, DS3ItemCategory.MISC),
    ...
    ("Estus Piece",                         0x4000085D, DS3ItemCategory.MISC),
    ("Hawkwood's Swordgrass",               0x4000085E, DS3ItemCategory.SKIP),
    ("Undead Bone Piece",                   0x4000085F, DS3ItemCategory.MISC),
