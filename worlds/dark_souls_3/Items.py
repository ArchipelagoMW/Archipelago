...
_vanilla_items = flatten([
    # Ammunition
    DS3ItemData("Standard Arrow x12",                  0x00061A80, DS3ItemCategory.MISC).counts([12]),
    DS3ItemData("Fire Arrow",                          0x00061AE4, DS3ItemCategory.MISC),
    DS3ItemData("Poison Arrow x18",                    0x00061B48, DS3ItemCategory.MISC).counts([18]),
    DS3ItemData("Large Arrow",                         0x00061BAC, DS3ItemCategory.MISC),
    DS3ItemData("Feather Arrow",                       0x00061C10, DS3ItemCategory.MISC),
    DS3ItemData("Moonlight Arrow x6",                  0x00061C74, DS3ItemCategory.MISC).counts([6]),
    DS3ItemData("Wood Arrow",                          0x00061CD8, DS3ItemCategory.MISC),
    DS3ItemData("Dark Arrow",                          0x00061D3C, DS3ItemCategory.MISC),
    DS3ItemData("Dragonslayer Greatarrow x5",          0x00062250, DS3ItemCategory.MISC).counts([5]),
    DS3ItemData("Dragonslayer Lightning Arrow x10",    0x00062318, DS3ItemCategory.MISC).counts([10]),
    DS3ItemData("Onislayer Greatarrow x8",             0x0006237C, DS3ItemCategory.MISC).counts([8]),
    DS3ItemData("Standard Bolt",                       0x00062A20, DS3ItemCategory.MISC),
    DS3ItemData("Heavy Bolt",                          0x00062A84, DS3ItemCategory.MISC),
    DS3ItemData("Sniper Bolt x11",                     0x00062AE8, DS3ItemCategory.MISC).counts([11]),
    DS3ItemData("Wood Bolt",                           0x00062B4C, DS3ItemCategory.MISC),
    DS3ItemData("Lightning Bolt x9",                   0x00062BB0, DS3ItemCategory.MISC).counts([9]),
    DS3ItemData("Lightning Bolt x12",                  0x00062BB0, DS3ItemCategory.MISC).counts([12]),
    DS3ItemData("Splintering Bolt",                    0x00062C14, DS3ItemCategory.MISC),
    DS3ItemData("Exploding Bolt x6",                   0x00062C78, DS3ItemCategory.MISC).counts([6]),
    ...
    # Covenants
    DS3ItemData("Blade of the Darkmoon",               0x20002710, DS3ItemCategory.SKIP),
    DS3ItemData("Watchdogs of Farron",                 0x20002724, DS3ItemCategory.SKIP),
    DS3ItemData("Aldrich Faithful",                    0x2000272E, DS3ItemCategory.SKIP),
    DS3ItemData("Warrior of Sunlight",                 0x20002738, DS3ItemCategory.SKIP),
    DS3ItemData("Mound-makers",                        0x20002742, DS3ItemCategory.SKIP),
    DS3ItemData("Way of Blue",                         0x2000274C, DS3ItemCategory.SKIP),
    DS3ItemData("Blue Sentinels",                      0x20002756, DS3ItemCategory.SKIP),
    DS3ItemData("Rosaria's Fingers",                   0x20002760, DS3ItemCategory.SKIP),
    DS3ItemData("Spears of the Church",                0x2000276A, DS3ItemCategory.SKIP),
    ...
    DS3ItemData("Ring of Sacrifice",                   0x20004EF2, DS3ItemCategory.RING),
    ...
    DS3ItemData("Untrue White Ring",                   0x20004FD8, DS3ItemCategory.RING),
    ...
    # Items
    DS3ItemData("White Sign Soapstone",                0x40000064, DS3ItemCategory.SKIP),
    DS3ItemData("Red Sign Soapstone",                  0x40000066, DS3ItemCategory.SKIP),
    DS3ItemData("Red Eye Orb",                         0x40000066, DS3ItemCategory.SKIP),
    DS3ItemData("Roster of Knights",                   0x4000006C, DS3ItemCategory.SKIP),
    DS3ItemData("Cracked Red Eye Orb",                 0x4000006F, DS3ItemCategory.SKIP),
    DS3ItemData("Cracked Red Eye Orb x5",              0x4000006F, DS3ItemCategory.SKIP).counts([5]),
    ...
    DS3ItemData("Green Blossom",                       0x40000104, DS3ItemCategory.MISC),
    DS3ItemData("Green Blossom x2",                    0x40000104, DS3ItemCategory.MISC).counts([2]),
    DS3ItemData("Green Blossom x3",                    0x40000104, DS3ItemCategory.MISC).counts([3]),
    DS3ItemData("Green Blossom x4",                    0x40000104, DS3ItemCategory.MISC).counts([4]),
    DS3ItemData("Budding Green Blossom",               0x40000106, DS3ItemCategory.MISC),
    DS3ItemData("Budding Green Blossom x2",            0x40000106, DS3ItemCategory.MISC).counts([2]),
    DS3ItemData("Budding Green Blossom x3",            0x40000106, DS3ItemCategory.MISC).counts([3]),
    DS3ItemData("Bloodred Moss Clump",                 0x4000010E, DS3ItemCategory.MISC),
    DS3ItemData("Bloodred Moss Clump x3",              0x4000010E, DS3ItemCategory.MISC),
    DS3ItemData("Purple Moss Clump",                   0x4000010F, DS3ItemCategory.MISC).counts([2, 3, 4]),
    DS3ItemData("Blooming Purple Moss Clump",          0x40000110, DS3ItemCategory.MISC).counts([3]),
    DS3ItemData("Purging Stone",                       0x40000112, DS3ItemCategory.SKIP).counts([2, 3]),
    DS3ItemData("Rime-blue Moss Clump",                0x40000114, DS3ItemCategory.MISC).counts([2, 4]),
    DS3ItemData("Repair Powder",                       0x40000118, DS3ItemCategory.MISC).counts([2, 3, 4]),
    DS3ItemData("Kukri",                               0x40000122, DS3ItemCategory.MISC).counts([8, 9]),
    DS3ItemData("Firebomb",                            0x40000124, DS3ItemCategory.MISC).counts([2, 3, 5, 6]),
    DS3ItemData("Dung Pie",                            0x40000125, DS3ItemCategory.MISC).counts([2, 3, 4]),
    DS3ItemData("Alluring Skull",                      0x40000126, DS3ItemCategory.MISC).counts([2, 3]),
    DS3ItemData("Undead Hunter Charm",                 0x40000128, DS3ItemCategory.MISC).counts([2, 3]),
    DS3ItemData("Black Firebomb",                      0x40000129, DS3ItemCategory.MISC).counts([2, 3, 4]),
    DS3ItemData("Rope Firebomb",                       0x4000012B, DS3ItemCategory.MISC),
    DS3ItemData("Lightning Urn",                       0x4000012C, DS3ItemCategory.MISC).counts([3, 4, 6]),
    ...
    DS3ItemData("Charcoal Pine Resin",                 0x4000014A, DS3ItemCategory.MISC).counts([2]),
    DS3ItemData("Gold Pine Resin",                     0x4000014B, DS3ItemCategory.MISC).counts([2]),
    DS3ItemData("Human Pine Resin",                    0x4000014E, DS3ItemCategory.MISC).counts([2, 4]),
    DS3ItemData("Carthus Rouge",                       0x4000014F, DS3ItemCategory.MISC).counts([2, 3]),
    DS3ItemData("Pale Pine Resin",                     0x40000150, DS3ItemCategory.MISC).counts([2]),
    ...
    DS3ItemData("Homeward Bone",                       0x4000015E, DS3ItemCategory.MISC).counts([2, 3, 6]),
    ...
    DS3ItemData("Proof of a Concord Well Kept",        0x40000171, DS3ItemCategory.SKIP),
    ...
    DS3ItemData("Rubbish",                             0x4000017C, DS3ItemCategory.SKIP),
    DS3ItemData("Dried Finger",                        0x40000181, DS3ItemCategory.SKIP),
    DS3ItemData("Twinkling Dragon Head Stone",         0x40000183, DS3ItemCategory.MISC),
    ...
    DS3ItemData("Young White Branch",                  0x400001C6, DS3ItemCategory.SKIP),
    DS3ItemData("Rusted Coin",                         0x400001C7, DS3ItemCategory.MISC).counts([2]),
    DS3ItemData("Siegbräu",                            0x400001C8, DS3ItemCategory.SKIP),
    DS3ItemData("Rusted Gold Coin",                    0x400001C9, DS3ItemCategory.MISC).counts([2, 3]),
    DS3ItemData("Blue Bug Pellet",                     0x400001CA, DS3ItemCategory.SKIP).counts([2]),
    DS3ItemData("Red Bug Pellet",                      0x400001CB, DS3ItemCategory.SKIP).counts([2, 3]),
    DS3ItemData("Yellow Bug Pellet",                   0x400001CC, DS3ItemCategory.SKIP).counts([2, 3]),
    DS3ItemData("Black Bug Pellet",                    0x400001CD, DS3ItemCategory.SKIP).counts([2, 3]),
    DS3ItemData("Young White Branch",                  0x400001CF, DS3ItemCategory.SKIP),
    DS3ItemData("Dark Sigil",                          0x400001EA, DS3ItemCategory.SKIP),
    DS3ItemData("Ember",                               0x400001F4, DS3ItemCategory.MISC).counts([2]),
    DS3ItemData("Hello Carving",                       0x40000208, DS3ItemCategory.SKIP),
    DS3ItemData("Thank you Carving",                   0x40000209, DS3ItemCategory.SKIP),
    ...
    DS3ItemData("Sharp Gem",                           0x40000456, DS3ItemCategory.MISC),
    DS3ItemData("Refined Gem",                         0x40000460, DS3ItemCategory.MISC),
    DS3ItemData("Crystal Gem",                         0x4000046A, DS3ItemCategory.MISC),
    DS3ItemData("Simple Gem",                          0x40000474, DS3ItemCategory.MISC),
    DS3ItemData("Fire Gem",                            0x4000047E, DS3ItemCategory.MISC),
    DS3ItemData("Chaos Gem",                           0x40000488, DS3ItemCategory.MISC),
    DS3ItemData("Lightning Gem",                       0x40000492, DS3ItemCategory.MISC),
    DS3ItemData("Deep Gem",                            0x4000049C, DS3ItemCategory.MISC),
    DS3ItemData("Dark Gem",                            0x400004A6, DS3ItemCategory.MISC),
    DS3ItemData("Poison Gem",                          0x400004B0, DS3ItemCategory.MISC),
    DS3ItemData("Blood Gem",                           0x400004BA, DS3ItemCategory.MISC),
    DS3ItemData("Raw Gem",                             0x400004C4, DS3ItemCategory.MISC),
    ...
    DS3ItemData("Quelana Pyromancy Tome",              0x40000852, DS3ItemCategory.MISC),
    DS3ItemData("Grave Warden Pyromancy Tome",         0x40000853, DS3ItemCategory.MISC),
    DS3ItemData("Sage's Scroll",                       0x40000854, DS3ItemCategory.MISC),
    DS3ItemData("Logan's Scroll",                      0x40000855, DS3ItemCategory.MISC),
    DS3ItemData("Crystal Scroll",                      0x40000856, DS3ItemCategory.MISC),
...
_dlc_items = flatten([
    # Ammunition
    DS3ItemData("Millwood Greatarrow",              0x000623E0, DS3ItemCategory.SKIP).counts([5]),
    ...
    DS3ItemData("Soul of Sister Friede",            0x400002E8, DS3ItemCategory.BOSS),
    DS3ItemData("Soul of Slave Knight Gael",        0x400002E9, DS3ItemCategory.BOSS),
...
_cut_content_items = [
    # Weapons
    DS3ItemData("Blood-stained Short Sword",           0x00100590, DS3ItemCategory.SKIP),
    DS3ItemData("Missionary's Axe",                    0x006C2F50, DS3ItemCategory.SKIP),
    DS3ItemData("Dragon King Greataxe",                0x006D40C0, DS3ItemCategory.SKIP),
    DS3ItemData("Four Knights Hammer",                 0x007D4650, DS3ItemCategory.SKIP),
    DS3ItemData("Hammer of the Great Tree",            0x007D9470, DS3ItemCategory.SKIP),
    DS3ItemData("Lothric's Scythe",                    0x009A4430, DS3ItemCategory.SKIP),
    DS3ItemData("Ancient Dragon Halberd",              0x009A6B40, DS3ItemCategory.SKIP),
    DS3ItemData("Scythe of Want",                      0x009A9250, DS3ItemCategory.SKIP),
    DS3ItemData("Sacred Beast Catalyst",               0x00C8A730, DS3ItemCategory.SKIP),
    DS3ItemData("Deep Pyromancy Flame",                0x00CC9ED0, DS3ItemCategory.SKIP), # Duplicate?
    DS3ItemData("Flickering Pyromancy Flame",          0x00CD3B10, DS3ItemCategory.SKIP),
    DS3ItemData("Strong Pyromancy Flame",              0x00CD6220, DS3ItemCategory.SKIP),
    DS3ItemData("Deep Pyromancy Flame",                0x00CDFE60, DS3ItemCategory.SKIP), # Duplicate?
    DS3ItemData("Pitch-Dark Pyromancy Flame",          0x00CE2570, DS3ItemCategory.SKIP),
    DS3ItemData("Dancer's Short Bow",                  0x00D77440, DS3ItemCategory.SKIP),
    DS3ItemData("Shield Crossbow",                     0x00D81080, DS3ItemCategory.SKIP),
    DS3ItemData("Golden Dual Swords",                  0x00F55C80, DS3ItemCategory.SKIP),
    DS3ItemData("Channeler's Trident",                 0x008C8890, DS3ItemCategory.SKIP),

    # Shields
    DS3ItemData("Cleric's Parma",                      0x013524A0, DS3ItemCategory.SKIP),
    DS3ItemData("Prince's Shield",                     0x01421CF0, DS3ItemCategory.SKIP),

    # Armor
    DS3ItemData("Dingy Maiden's Overcoat",             0x11DA9048, DS3ItemCategory.SKIP),
    DS3ItemData("Grotto Hat",                          0x11F78A40, DS3ItemCategory.SKIP),
    DS3ItemData("Grotto Robe",                         0x11F78E28, DS3ItemCategory.SKIP),
    DS3ItemData("Grotto Wrap",                         0x11F79210, DS3ItemCategory.SKIP),
    DS3ItemData("Grotto Trousers",                     0x11F795F8, DS3ItemCategory.SKIP),
    DS3ItemData("Soldier's Gauntlets",                 0x126261D0, DS3ItemCategory.SKIP),
    DS3ItemData("Soldier's Hood",                      0x1263E0A0, DS3ItemCategory.SKIP),
    DS3ItemData("Elder's Robe",                        0x129024A8, DS3ItemCategory.SKIP),
    DS3ItemData("Saint's Veil",                        0x12A70420, DS3ItemCategory.SKIP),
    DS3ItemData("Saint's Dress",                       0x12A70808, DS3ItemCategory.SKIP),
    DS3ItemData("Footman's Hood",                      0x12AEA540, DS3ItemCategory.SKIP),
    DS3ItemData("Footman's Overcoat",                  0x12AEA928, DS3ItemCategory.SKIP),
    DS3ItemData("Footman's Bracelets",                 0x12AEAD10, DS3ItemCategory.SKIP),
    DS3ItemData("Footman's Trousers",                  0x12AEB0F8, DS3ItemCategory.SKIP),
    DS3ItemData("Scholar's Shed Skin",                 0x12E40D20, DS3ItemCategory.SKIP),
    DS3ItemData("Man Serpent's Mask",                  0x138BE5E0, DS3ItemCategory.SKIP),
    DS3ItemData("Man Serpent's Robe",                  0x138BE9C8, DS3ItemCategory.SKIP),
    DS3ItemData("Old Monarch's Crown",                 0x13DFD240, DS3ItemCategory.SKIP),
    DS3ItemData("Old Monarch's Robe",                  0x13DFD628, DS3ItemCategory.SKIP),
    DS3ItemData("Frigid Valley Mask",                  0x13FE56C0, DS3ItemCategory.SKIP),
    DS3ItemData("Dingy Hood",                          0x140D9900, DS3ItemCategory.SKIP),
    DS3ItemData("Hexer's Hood",                        0x15A995C0, DS3ItemCategory.SKIP),
    DS3ItemData("Hexer's Robes",                       0x15A999A8, DS3ItemCategory.SKIP),
    DS3ItemData("Hexer's Gloves",                      0x15A99D90, DS3ItemCategory.SKIP),
    DS3ItemData("Hexer's Boots",                       0x15A9A178, DS3ItemCategory.SKIP),
    DS3ItemData("Varangian Helm",                      0x15C81A40, DS3ItemCategory.SKIP),
    DS3ItemData("Varangian Armor",                     0x15C81E28, DS3ItemCategory.SKIP),
    DS3ItemData("Varangian Cuffs",                     0x15C82210, DS3ItemCategory.SKIP),
    DS3ItemData("Varangian Leggings",                  0x15C825F8, DS3ItemCategory.SKIP),

    # Rings
    DS3ItemData("Rare Ring of Sacrifice",              0x20004EFC, DS3ItemCategory.SKIP),
    DS3ItemData("Baneful Bird Ring",                   0x20005032, DS3ItemCategory.SKIP),
    DS3ItemData("Darkmoon Blade Covenant Ring",        0x20004F7E, DS3ItemCategory.SKIP),
    DS3ItemData("Yorgh's Ring",                        0x2000505A, DS3ItemCategory.SKIP),
    DS3ItemData("Ring of Hiding",                      0x200050D2, DS3ItemCategory.SKIP),
    DS3ItemData("Ring of Sustained Toughness",         0x20005118, DS3ItemCategory.SKIP),
    DS3ItemData("Ring of Sustained Energy",            0x20005122, DS3ItemCategory.SKIP),
    DS3ItemData("Ring of Sustained Magic",             0x2000512C, DS3ItemCategory.SKIP),
    DS3ItemData("Ring of Sustained Essence",           0x20005140, DS3ItemCategory.SKIP),
    DS3ItemData("Ring of Sustained Might",             0x2000514A, DS3ItemCategory.SKIP),
    DS3ItemData("Ring of Sustained Fortune",           0x20005154, DS3ItemCategory.SKIP),

    # Items
    DS3ItemData("Soul of a Wicked Spirit",             0x400002C9, DS3ItemCategory.SKIP),

    # Spells
    DS3ItemData("Dark Orb",                            0x4027AC40, DS3ItemCategory.SKIP),
    DS3ItemData("Morbid Temptation",                   0x40359AA8, DS3ItemCategory.SKIP),
