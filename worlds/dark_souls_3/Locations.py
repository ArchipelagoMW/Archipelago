...
class DS3LocationData:
    ...
    This should only ever be None for DS3LocationCategory.EVENT locations.
    """
...
location_tables = {
    "Cemetery of Ash": [
        DS3LocationData("CA: Soul of a Deserted Corpse (right of spawn)",
                        "Soul of a Deserted Corpse", DS3LocationCategory.SOUL),
        DS3LocationData("CA: Firebomb (down the cliff edge)", "Firebomb x5",
                        DS3LocationCategory.MISC),
        DS3LocationData("CA: Titanite Shard (jump to coffin)", "Titanite Shard",
                        DS3LocationCategory.UPGRADE),
        DS3LocationData("CA: Soul of an Unknown Traveler (by miniboss)",
                        "Soul of an Unknown Traveler", DS3LocationCategory.SOUL),
        DS3LocationData("CA: Speckled Stoneplate Ring+1 (by miniboss)",
                        "Speckled Stoneplate Ring+1", DS3LocationCategory.RING, ngp = True),
        DS3LocationData("CA: Titanite Scale (miniboss drop)", "Titanite Scale",
                        DS3LocationCategory.UPGRADE, miniboss = True),
        DS3LocationData("CA: Coiled Sword (boss drop)", "Coiled Sword", DS3LocationCategory.KEY,
                        prominent = True, progression = True, boss = True),
    ],
    "Firelink Shrine": [
        # Ludleth drop, does not permanently die
        DS3LocationData("FS: Skull Ring (kill Ludleth)", "Skull Ring", DS3LocationCategory.RING,
                        hidden = True, drop = True, npc = True),

        # Sword Master drops
        DS3LocationData("FS: Uchigatana (NPC drop)", "Uchigatana", DS3LocationCategory.WEAPON,
                        hostile_npc = True), # Sword Master drop
        DS3LocationData("FS: Master's Attire (NPC drop)", "Master's Attire",
                        DS3LocationCategory.ARMOR, hostile_npc = True),
        DS3LocationData("FS: Master's Gloves (NPC drop)", "Master's Gloves",
                        DS3LocationCategory.ARMOR, hostile_npc = True),

        DS3LocationData("FS: Broken Straight Sword (gravestone after boss)",
                        "Broken Straight Sword", DS3LocationCategory.WEAPON),
        ...
        DS3LocationData("FS: Soul of a Deserted Corpse (bell tower door)",
                        "Soul of a Deserted Corpse", DS3LocationCategory.SOUL),
        DS3LocationData("FS: East-West Shield (tree by shrine entrance)", "East-West Shield", DS3LocationCategory.SHIELD),
        DS3LocationData("FS: Homeward Bone (path above shrine entrace)",
                        "Homeward Bone", DS3LocationCategory.MISC),
        DS3LocationData("FS: Ember (above shrine entrance)", "Ember", DS3LocationCategory.MISC),
        DS3LocationData("FS: Wolf Ring+2 (left of boss room exit)", "Wolf Ring+2",
                        DS3LocationCategory.RING, ngp = True),
        # Leonhard (quest)
        DS3LocationData("FS: Cracked Red Eye Orb (Leonhard)", "Cracked Red Eye Orb x5",
                        DS3LocationCategory.UNIQUE, missable = True, npc = True),
        ...
        DS3LocationData("FS: Lift Chamber Key (Leonhard)", "Lift Chamber Key",
                        DS3LocationCategory.KEY, missable = True, npc = True, key = True,
                        drop = True),

        # Shrine Handmaid shop
        DS3LocationData("FS: White Sign Soapstone (shop)", "White Sign Soapstone",
                        DS3LocationCategory.UNIQUE, shop = True),
        DS3LocationData("FS: Dried Finger (shop)", "Dried Finger", DS3LocationCategory.UNIQUE,
                        shop = True),
        DS3LocationData("FS: Tower Key (shop)", "Tower Key", DS3LocationCategory.KEY,
                        progression = True, shop = True, key = True),
        DS3LocationData("FS: Ember (shop)", "Ember", DS3LocationCategory.MISC,
                        offline = '99,0:-1:110000:', shop = True),
        DS3LocationData("FS: Farron Dart (shop)", "Farron Dart", DS3LocationCategory.SPELL,
                        offline = '99,0:-1:110000:', shop = True),
        DS3LocationData("FS: Soul Arrow (shop)", "Soul Arrow", DS3LocationCategory.SPELL,
                        offline = '99,0:-1:110000:', shop = True),
        DS3LocationData("FS: Heal Aid (shop)", "Heal Aid", DS3LocationCategory.SPELL,
                        shop = True),
        DS3LocationData("FS: Alluring Skull (Mortician's Ashes)", "Alluring Skull",
                        DS3LocationCategory.MISC, shop = True, conditional = True),
        DS3LocationData("FS: Ember (Mortician's Ashes)", "Ember", DS3LocationCategory.MISC,
                        offline = '99,0:-1:110000,70000100:', shop = True, conditional = True),
        DS3LocationData("FS: Grave Key (Mortician's Ashes)", "Grave Key", DS3LocationCategory.KEY,
                        shop = True, key = True, conditional = True),
        DS3LocationData("FS: Life Ring (Dreamchaser's Ashes)", "Life Ring",
                        DS3LocationCategory.RING, shop = True, conditional = True),
        # Only if you say where the ashes were found
        DS3LocationData("FS: Hidden Blessing (Dreamchaser's Ashes)", "Hidden Blessing",
                        DS3LocationCategory.MISC, missable = True, shop = True),
        DS3LocationData("FS: Lloyd's Shield Ring (Paladin's Ashes)", "Lloyd's Shield Ring",
                        DS3LocationCategory.RING, shop = True, conditional = True),
        DS3LocationData("FS: Ember (Grave Warden's Ashes)", "Ember", DS3LocationCategory.MISC,
        ...
        DS3LocationData("FS: Karla's Pointed Hat (Prisoner Chief's Ashes)", "Karla's Pointed Hat",
                        DS3LocationCategory.ARMOR, offline = '99,0:-1:110000,70000105:',
        ...
        DS3LocationData("FS: Karla's Gloves (Prisoner Chief's Ashes)", "Karla's Gloves",
                        DS3LocationCategory.ARMOR, offline = '99,0:-1:110000,70000105:',
                        shop = True, conditional = True),
        DS3LocationData("FS: Karla's Trousers (Prisoner Chief's Ashes)",
                        "Karla's Trousers", DS3LocationCategory.ARMOR,
                        offline = '99,0:-1:110000,70000105:', shop = True, conditional = True),
        DS3LocationData("FS: Xanthous Overcoat (Xanthous Ashes)", "Xanthous Overcoat",
                        DS3LocationCategory.ARMOR, shop = True, conditional = True),
        DS3LocationData("FS: Xanthous Gloves (Xanthous Ashes)", "Xanthous Gloves",
                        DS3LocationCategory.ARMOR, shop = True, conditional = True),
        DS3LocationData("FS: Xanthous Trousers (Xanthous Ashes)", "Xanthous Trousers",
                        DS3LocationCategory.ARMOR, shop = True, conditional = True),
        DS3LocationData("FS: Ember (Dragon Chaser's Ashes)", "Ember", DS3LocationCategory.MISC,
                        offline = '99,0:-1:110000,70000108:', shop = True, conditional = True),
        DS3LocationData("FS: Washing Pole (Easterner's Ashes)", "Washing Pole",
                        DS3LocationCategory.WEAPON, shop = True, conditional = True),
        DS3LocationData("FS: Eastern Helm (Easterner's Ashes)", "Eastern Helm",
                        DS3LocationCategory.ARMOR, shop = True, conditional = True),
        DS3LocationData("FS: Eastern Armor (Easterner's Ashes)", "Eastern Armor",
                        DS3LocationCategory.ARMOR, shop = True, conditional = True),
        DS3LocationData("FS: Eastern Gauntlets (Easterner's Ashes)", "Eastern Gauntlets",
                        DS3LocationCategory.ARMOR, shop = True, conditional = True),
        DS3LocationData("FS: Eastern Leggings (Easterner's Ashes)", "Eastern Leggings",
                        DS3LocationCategory.ARMOR, shop = True, conditional = True),
        DS3LocationData("FS: Wood Grain Ring (Easterner's Ashes)", "Wood Grain Ring",
                        DS3LocationCategory.RING, shop = True, conditional = True),
        DS3LocationData("FS: Millwood Knight Helm (Captain's Ashes)", "Millwood Knight Helm",
                        DS3LocationCategory.ARMOR, dlc = True, shop = True, conditional = True),
        ...
        DS3LocationData("FS: Millwood Knight Gauntlets (Captain's Ashes)",
                        "Millwood Knight Gauntlets", DS3LocationCategory.ARMOR, dlc = True,
                        shop = True, conditional = True),
        DS3LocationData("FS: Millwood Knight Leggings (Captain's Ashes)",
                        "Millwood Knight Leggings", DS3LocationCategory.ARMOR, dlc = True,
                        shop = True, conditional = True),
        DS3LocationData("FS: Refined Gem (Captain's Ashes)", "Refined Gem",
                        DS3LocationCategory.UPGRADE, dlc = True, shop = True, conditional = True),

        # Ludleth Shop
        DS3LocationData("FS: Vordt's Great Hammer (Ludleth for Vordt)", "Vordt's Great Hammer",
                        DS3LocationCategory.WEAPON, missable = True, boss = True, shop = True),
        DS3LocationData("FS: Pontiff's Left Eye (Ludleth for Vordt)", "Pontiff's Left Eye",
                        DS3LocationCategory.RING, missable = True, boss = True, shop = True),
        DS3LocationData("FS: Bountiful Sunlight (Ludleth for Rosaria)", "Bountiful Sunlight",
                        DS3LocationCategory.SPELL, missable = True, boss = True, shop = True),
        ...
        DS3LocationData("FS: Hollowslayer Greatsword (Ludleth for Greatwood)",
                        "Hollowslayer Greatsword", DS3LocationCategory.WEAPON, missable = True,
                        boss = True, shop = True),
        ...
        DS3LocationData("FS: Wolf Knight's Greatsword (Ludleth for Abyss Watchers)",
                        "Wolf Knight's Greatsword", DS3LocationCategory.WEAPON, missable = True,
                        boss = True, shop = True),
        ...
        DS3LocationData("FS: Old King's Great Hammer (Ludleth for Old Demon King)",
                        "Old King's Great Hammer", DS3LocationCategory.WEAPON, missable = True,
                        boss = True, shop = True),
        ...
        DS3LocationData("FS: Greatsword of Judgment (Ludleth for Pontiff)",
                        "Greatsword of Judgment", DS3LocationCategory.WEAPON, missable = True,
                        boss = True, shop = True),
        ...
        DS3LocationData("FS: Yhorm's Greatshield (Ludleth for Yhorm)", "Yhorm's Greatshield",
                        DS3LocationCategory.SHIELD, missable = True, boss = True, shop = True),
        DS3LocationData("FS: Dancer's Enchanted Swords (Ludleth for Dancer)",
                        "Dancer's Enchanted Swords", DS3LocationCategory.WEAPON, missable = True,
                        boss = True, shop = True),
        ...
        DS3LocationData("FS: Dragonslayer Greataxe (Ludleth for Dragonslayer)",
                        "Dragonslayer Greataxe", DS3LocationCategory.WEAPON, missable = True,
                        boss = True, shop = True),
        DS3LocationData("FS: Dragonslayer Greatshield (Ludleth for Dragonslayer)",
                        "Dragonslayer Greatshield", DS3LocationCategory.SHIELD, missable = True,
                        boss = True, shop = True),
        ...
        DS3LocationData("FS: Dragonslayer Swordspear (Ludleth for Nameless)",
                        "Dragonslayer Swordspear", DS3LocationCategory.WEAPON, missable = True,
                        boss = True, shop = True),
    ...
    "Firelink Shrine Bell Tower": [
        ...
        DS3LocationData("FSBT: Homeward Bone (roof)", "Homeward Bone x3",
                        DS3LocationCategory.MISC),
        DS3LocationData("FSBT: Estus Ring (rafters)", "Estus Ring", DS3LocationCategory.RING),
        DS3LocationData("FSBT: Estus Shard (rafters)", "Estus Shard", DS3LocationCategory.HEALTH),
        DS3LocationData("FSBT: Fire Keeper Soul (tower top)", "Fire Keeper Soul",
                        DS3LocationCategory.UNIQUE),
        DS3LocationData("FSBT: Fire Keeper Robe (partway down tower)", "Fire Keeper Robe",
                        DS3LocationCategory.ARMOR),
        ...
        DS3LocationData("FSBT: Covetous Silver Serpent Ring (illusory wall past rafters)",
                        "Covetous Silver Serpent Ring", DS3LocationCategory.RING, hidden = True),
        DS3LocationData("FSBT: Twinkling Titanite (lizard behind Firelink)",
                        "Twinkling Titanite", DS3LocationCategory.UPGRADE, lizard = True),
        ...
        DS3LocationData("FSBT: Very good! Carving (crow for Divine Blessing)",
                        "Very good! Carving", DS3LocationCategory.UNIQUE, missable = True),
        DS3LocationData("FSBT: Thank you Carving (crow for Hidden Blessing)", "Thank you Carving",
                        DS3LocationCategory.UNIQUE, missable = True),
        ...
        DS3LocationData("FSBT: Hollow Gem (crow for Eleonora)", "Hollow Gem",
                        DS3LocationCategory.UPGRADE, missable = True),
        DS3LocationData("FSBT: Titanite Scale (crow for Blacksmith Hammer)", "Titanite Scale x3",
                        DS3LocationCategory.UPGRADE, offline = '99,0:50004330::', missable = True),
        ...
        DS3LocationData("FSBT: Titanite Chunk (crow for Black Firebomb)", "Titanite Chunk",
                        DS3LocationCategory.UPGRADE, missable = True),
        DS3LocationData("FSBT: Iron Helm (crow for Lightning Urn)", "Iron Helm",
                        DS3LocationCategory.ARMOR, missable = True),
        ...
        DS3LocationData("FSBT: Twinkling Titanite (crow for Large Leather Shield)",
                        "Twinkling Titanite", DS3LocationCategory.UPGRADE, missable = True),
    ...
    "High Wall of Lothric": [
        ...
        DS3LocationData("HWL: Large Soul of a Deserted Corpse (flame plaza)",
                        "Large Soul of a Deserted Corpse", DS3LocationCategory.SOUL),
        ...
        DS3LocationData("HWL: Standard Arrow (back tower)", "Standard Arrow x12",
                        DS3LocationCategory.MISC),
        DS3LocationData("HWL: Longbow (back tower)", "Longbow", DS3LocationCategory.WEAPON),
        ...
        DS3LocationData("HWL: Soul of a Deserted Corpse (corpse tower, bottom floor)",
                        "Soul of a Deserted Corpse", DS3LocationCategory.SOUL),
        DS3LocationData("HWL: Club (flame plaza)", "Club", DS3LocationCategory.WEAPON),
        DS3LocationData("HWL: Claymore (flame plaza)", "Claymore",
                        DS3LocationCategory.WEAPON),
        DS3LocationData("HWL: Ember (flame plaza)", "Ember", DS3LocationCategory.MISC),
        ...
        DS3LocationData("HWL: Titanite Shard (wall tower, corner by bonfire)", "Titanite Shard",
                        DS3LocationCategory.UPGRADE, hidden = True),
        DS3LocationData("HWL: Undead Hunter Charm (fort, room off entry, in pot)",
                        "Undead Hunter Charm x2", DS3LocationCategory.MISC, hidden = True),
        ...
        DS3LocationData("HWL: Cell Key (fort basement, down stairs)", "Cell Key",
                        DS3LocationCategory.KEY, key = True),
        DS3LocationData("HWL: Ember (fountain #1)", "Ember", DS3LocationCategory.MISC),
        ...
        DS3LocationData("HWL: Mail Breaker (wall tower, path to Greirat)", "Mail Breaker",
                        DS3LocationCategory.WEAPON),
        DS3LocationData("HWL: Titanite Shard (fort basement, behind crates)",
                        "Titanite Shard", DS3LocationCategory.UPGRADE, hidden = True),
        DS3LocationData("HWL: Rapier (fountain, corner)", "Rapier", DS3LocationCategory.WEAPON),
        DS3LocationData("HWL: Titanite Shard (for, room off entry)",
                        "Titanite Shard", DS3LocationCategory.UPGRADE),
        ...
        DS3LocationData("HWL: Soul of a Deserted Corpse (path to corpse tower)",
                        "Soul of a Deserted Corpse", DS3LocationCategory.SOUL),
        DS3LocationData("HWL: Ember (fountain, #2)", "Ember", DS3LocationCategory.MISC),
        DS3LocationData("HWL: Large Soul of a Deserted Corpse (platform by fountain)",
                        "Large Soul of a Deserted Corpse", DS3LocationCategory.MISC,
        ...
        DS3LocationData("HWL: Ring of Sacrifice (awning by fountain)",
                        "Ring of Sacrifice", DS3LocationCategory.MISC,
                        hidden = True), # Easily missed turnoff
        ...
        DS3LocationData("HWL: Soul of a Deserted Corpse (fountain, path to promenade)",
                        "Soul of a Deserted Corpse", DS3LocationCategory.SOUL),
        DS3LocationData("HWL: Firebomb (fort roof)", "Firebomb x3", DS3LocationCategory.MISC),
        ...
        DS3LocationData("HWL: Estus Shard (fort basement, on anvil)", "Estus Shard",
                        DS3LocationCategory.HEALTH),
        DS3LocationData("HWL: Fleshbite Ring+1 (fort roof, jump to other roof)",
                        "Fleshbite Ring+1", DS3LocationCategory.RING, ngp = True,
                        hidden = True), # Hidden jump
        DS3LocationData("HWL: Ring of the Evil Eye+2 (fort basement, far wall)",
                        "Ring of the Evil Eye+2", DS3LocationCategory.RING, ngp = True,
                        hidden = True), # In barrels
        DS3LocationData("HWL: Silver Eagle Kite Shield (fort mezzanine)",
                        "Silver Eagle Kite Shield", DS3LocationCategory.SHIELD),
        DS3LocationData("HWL: Astora Straight Sword (fort walkway, drop down)",
                        "Astora Straight Sword", DS3LocationCategory.WEAPON,
                        hidden = True), # Hidden fall
        DS3LocationData("HWL: Battle Axe (flame tower, mimic)", "Battle Axe",
                        DS3LocationCategory.WEAPON, offline = '01,0:53000960::', mimic = True),

        # Only dropped after transformation    
        DS3LocationData("HWL: Ember (fort roof, transforming hollow)", "Ember",
                        DS3LocationCategory.MISC, hidden = True),
        DS3LocationData("HWL: Titanite Shard (fort roof, transforming hollow)",
                        "Titanite Shard", DS3LocationCategory.UPGRADE, hidden = True),
        ...
        DS3LocationData("HWL: Titanite Shard (back tower roof bonfire, transforming hollow)",
                        "Titanite Shard", DS3LocationCategory.MISC, hidden = True),

        DS3LocationData("HWL: Refined Gem (promenade miniboss)", "Refined Gem",
                        DS3LocationCategory.UPGRADE, miniboss = True),
        DS3LocationData("HWL: Way of Blue (Emma)", "Way of Blue", DS3LocationCategory.UNIQUE),
        ...
        DS3LocationData("HWL: Red Eye Orb (wall tower, miniboss)", "Red Eye Orb",
                        DS3LocationCategory.MISC, conditional = True, miniboss = True, npc = True),
        DS3LocationData("HWL: Raw Gem (fort roof, lizard)", "Raw Gem",
                        DS3LocationCategory.UPGRADE, lizard = True),
    ],
    "Undead Settlement": [
        DS3LocationData("US: Soul of the Rotted Greatwood", "Soul of the Rotted Greatwood",
                        DS3LocationCategory.SOUL, prominent = True, boss = True),
        DS3LocationData("US: Transposing Kiln (boss drop)", "Transposing Kiln",
                        DS3LocationCategory.UNIQUE, boss = True),
        # Missable because it's unavailable if you start as a Pyromancer
        DS3LocationData("US: Pyromancy Flame (Cornyx)", "Pyromancy Flame",
                        DS3LocationCategory.WEAPON, missable = True, npc = True),
        DS3LocationData("US: Old Sage's Blindfold (kill Cornyx)", "Old Sage's Blindfold",
                        DS3LocationCategory.ARMOR, npc = True),
        DS3LocationData("US: Cornyx's Garb (kill Cornyx)", "Cornyx's Garb", DS3LocationCategory.ARMOR,
                        offline = '02,0:50006141::', npc = True),
        DS3LocationData("US: Cornyx's Wrap (kill Cornyx)", "Cornyx's Wrap", DS3LocationCategory.ARMOR,
                        offline = '02,0:50006141::', npc = True),
        DS3LocationData("US: Cornyx's Skirt (kill Cornyx)", "Cornyx's Skirt", DS3LocationCategory.ARMOR,
                        offline = '02,0:50006141::', npc = True),
        DS3LocationData("US: Tower Key (kill Irina)", "Tower Key", DS3LocationCategory.KEY,
                        missable = True, npc = True, key = True),
        DS3LocationData("US: Flynn's Ring (tower village, rooftop)", "Flynn's Ring",
                        DS3LocationCategory.RING),
        ...
        DS3LocationData("US: Charcoal Pine Resin (hanging corpse room)", "Charcoal Pine Resin x2",
                        DS3LocationCategory.MISC),
        DS3LocationData("US: Loincloth (by Velka statue)", "Loincloth", DS3LocationCategory.ARMOR),
        DS3LocationData("US: Bloodbite Ring (miniboss in sewer)", "Bloodbite Ring",
                        DS3LocationCategory.RING, miniboss = True), # Giant Rat drop
        DS3LocationData("US: Charcoal Pine Bundle (first building)", "Charcoal Pine Bundle x2",
                        DS3LocationCategory.MISC),
        DS3LocationData("US: Soul of an Unknown Traveler (on the way to Dilapidated Bridge, in crates)",
                        "Soul of an Unknown Traveler", DS3LocationCategory.MISC, hidden = True),
        DS3LocationData("US: Titanite Shard (on the way to Dilapidated Bridge, up ladder)",
                        "Titanite Shard", DS3LocationCategory.MISC),
        DS3LocationData("US: Red Hilted Halberd (chasm crypt)", "Red Hilted Halberd",
                        DS3LocationCategory.WEAPON),
        DS3LocationData("US: Rusted Coin (wooden ledge above Dilapidated Bridge)", "Rusted Coin x2",
                        DS3LocationCategory.MISC),
        DS3LocationData("US: Caestus (sewer)", "Caestus", DS3LocationCategory.WEAPON),
        ...
        DS3LocationData("US: Alluring Skull (on the way to tower, behind building)",
                        "Alluring Skull x3", DS3LocationCategory.MISC),
        ...
        DS3LocationData("US: Titanite Shard (lower path to Cliff Underside)", "Titanite Shard",
                        DS3LocationCategory.UPGRADE, hidden = True), # hidden fall
        DS3LocationData("US: Hand Axe (by Cornyx)", "Hand Axe", DS3LocationCategory.WEAPON),
        DS3LocationData("US: Soul of an Unknown Traveler (pillory past stable)",
                        "Soul of an Unknown Traveler", DS3LocationCategory.SOUL),
        DS3LocationData("US: Ember (by stairs to boss)", "Ember", DS3LocationCategory.MISC),
        DS3LocationData("US: Mirrah Vest (tower village, jump from roof)", "Mirrah Vest",
                        DS3LocationCategory.ARMOR, hidden = True), # Hidden fall
        ...
        DS3LocationData("US: Red Bug Pellet (tower village building, basement)",
                        "Red Bug Pellet x2", DS3LocationCategory.MISC),
        DS3LocationData("US: Chloranthy Ring (tower village, jump from roof)", "Chloranthy Ring",
                        DS3LocationCategory.RING, hidden = True), # Hidden fall
        ...
        DS3LocationData("US: Estus Shard (under burning tree)", "Estus Shard",
                        DS3LocationCategory.HEALTH),
        DS3LocationData("US: Firebomb (stable roof)", "Firebomb x6", DS3LocationCategory.MISC),
        ...
        DS3LocationData("US: Whip (on the way to Dilapidated Bridge, behind wooden wall)",
                        "Whip", DS3LocationCategory.WEAPON, hidden = True),
        ...
        DS3LocationData("US: Large Soul of a Deserted Corpse (around corner by Cliff Underside)",
                        "Large Soul of a Deserted Corpse", DS3LocationCategory.SOUL,
                        hidden = True), # Hidden corner
        DS3LocationData("US: Ember (behind burning tree)", "Ember", DS3LocationCategory.MISC),
        DS3LocationData("US: Large Soul of a Deserted Corpse (across from Foot of the High Wall)",
                        "Large Soul of a Deserted Corpse", DS3LocationCategory.SOUL),
        DS3LocationData("US: Fading Soul (by white tree)", "Fading Soul", DS3LocationCategory.MISC),
        DS3LocationData("US: Young White Branch (by white tree #1)", "Young White Branch",
                        DS3LocationCategory.MISC),
        DS3LocationData("US: Ember (by white tree)", "Ember", DS3LocationCategory.MISC),
        ...
        DS3LocationData("US: Soul of a Nameless Soldier (top of tower)",
                        "Soul of a Nameless Soldier", DS3LocationCategory.SOUL),
        DS3LocationData("US: Loretta's Bone (first building, hanging corpse on balcony)",
                        "Loretta's Bone", DS3LocationCategory.KEY),
        ...
        DS3LocationData("US: Kukri (hanging corpse above burning tree)", "Kukri x9",
                        DS3LocationCategory.MISC, missable = True), # requires projectile
        DS3LocationData("US: Life Ring+1 (tower on the way to village)", "Life Ring+1",
                        DS3LocationCategory.RING, ngp = True),
        DS3LocationData("US: Poisonbite Ring+1 (graveyard by white tree, near well)", "Poisonbite Ring+1",
                        DS3LocationCategory.RING, ngp = True),
        DS3LocationData("US: Covetous Silver Serpent Ring+2 (tower village, drop down from roof)",
                        "Covetous Silver Serpent Ring+2", DS3LocationCategory.RING, ngp = True,
                        hidden = True), # Hidden fall
        DS3LocationData("US: Human Pine Resin (tower village building, chest upstairs)",
                        "Human Pine Resin x4", DS3LocationCategory.MISC),
        ...
        DS3LocationData("US: Irithyll Straight Sword (miniboss drop, by Road of Sacrifices)",
                        "Irithyll Straight Sword", DS3LocationCategory.WEAPON, miniboss = True),
        DS3LocationData("US: Fire Gem (tower village, miniboss drop)", "Fire Gem",
                        DS3LocationCategory.UPGRADE, miniboss = True),
        DS3LocationData("US: Warrior of Sunlight (hanging corpse room, drop through hole)",
                        "Warrior of Sunlight", DS3LocationCategory.UNIQUE,
                        hidden = True), # hidden fall
        DS3LocationData("US: Mound-makers (Hodrick)", "Mound-makers", DS3LocationCategory.UNIQUE,
                        missable = True),
        DS3LocationData("US: Sharp Gem (lizard by Dilapidated Bridge)", "Sharp Gem",
                        DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("US: Heavy Gem (chasm, lizard)", "Heavy Gem",
                        DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("US: Siegbräu (Siegward)", "Siegbräu", DS3LocationCategory.MISC,
                        missable = True, npc = True),
        DS3LocationData("US: Heavy Gem (Hawkwood)", "Heavy Gem", DS3LocationCategory.UPGRADE,
                        offline = '00,0:50006070::', missable = True,
                        npc = True), # Hawkwood (quest, after Greatwood or Sage)
        DS3LocationData("US -> RS", None, DS3LocationCategory.EVENT),

        # Yoel/Yuria of Londor
        DS3LocationData("FS: Soul Arrow (Yoel/Yuria)", "Soul Arrow", DS3LocationCategory.SPELL,
        ...
        DS3LocationData("FS: Heavy Soul Arrow (Yoel/Yuria)", "Heavy Soul Arrow",
                        DS3LocationCategory.SPELL, offline = '99,0:-1:50000,110000,70000116:',
                        missable = True, npc = True, shop = True),
        DS3LocationData("FS: Magic Weapon (Yoel/Yuria)", "Magic Weapon", DS3LocationCategory.SPELL,
                        offline = '99,0:-1:50000,110000,70000116:', missable = True, npc = True,
                        shop = True),
        DS3LocationData("FS: Magic Shield (Yoel/Yuria)", "Magic Shield", DS3LocationCategory.SPELL,
                        offline = '99,0:-1:50000,110000,70000116:', missable = True, npc = True,
                        shop = True),
        DS3LocationData("FS: Soul Greatsword (Yoel/Yuria)", "Soul Greatsword",
                        DS3LocationCategory.SPELL,
                        offline = '99,0:-1:50000,110000,70000450,70000475:', missable = True,
                        npc = True, shop = True),
        DS3LocationData("FS: Dark Hand (Yoel/Yuria)", "Dark Hand", DS3LocationCategory.WEAPON,
                        missable = True, npc = True),
        DS3LocationData("FS: Untrue White Ring (Yoel/Yuria)", "Untrue White Ring",
                        DS3LocationCategory.RING, missable = True, npc = True),
        DS3LocationData("FS: Untrue Dark Ring (Yoel/Yuria)", "Untrue Dark Ring",
                        DS3LocationCategory.RING, missable = True, npc = True),
        DS3LocationData("FS: Londor Braille Divine Tome (Yoel/Yuria)", "Londor Braille Divine Tome",
                        DS3LocationCategory.UNIQUE, offline = '99,0:-1:40000,110000,70000116:',
                        missable = True, npc = True),
        DS3LocationData("FS: Darkdrift (Yoel/Yuria)", "Darkdrift", DS3LocationCategory.WEAPON,
        ...
        DS3LocationData("FS: Fireball (Cornyx)", "Fireball", DS3LocationCategory.SPELL, npc = True,
                        shop = True),
        DS3LocationData("FS: Fire Surge (Cornyx)", "Fire Surge", DS3LocationCategory.SPELL,
                        npc = True, shop = True),
        DS3LocationData("FS: Great Combustion (Cornyx)", "Great Combustion",
                        DS3LocationCategory.SPELL, npc = True, shop = True),
        DS3LocationData("FS: Flash Sweat (Cornyx)", "Flash Sweat", DS3LocationCategory.SPELL,
                        npc = True, shop = True),
        ...
        DS3LocationData("FS: Poison Mist (Cornyx for Great Swamp Tome)", "Poison Mist",
                        DS3LocationCategory.SPELL, missable = True, npc = True, shop = True),
        ...
        DS3LocationData("FS: Great Chaos Fire Orb (Cornyx for Izalith Tome)",
                        "Great Chaos Fire Orb", DS3LocationCategory.SPELL, missable = True,
                        npc = True, shop = True),
        ...
        DS3LocationData("FS: Saint's Ring (Irina)", "Saint's Ring", DS3LocationCategory.RING,
                        npc = True, shop = True),
        DS3LocationData("FS: Heal (Irina)", "Heal", DS3LocationCategory.SPELL, npc = True,
                        shop = True),
        DS3LocationData("FS: Replenishment (Irina)", "Replenishment", DS3LocationCategory.SPELL,
                        npc = True, shop = True),
        DS3LocationData("FS: Caressing Tears (Irina)", "Caressing Tears", DS3LocationCategory.SPELL,
                        npc = True, shop = True),
        DS3LocationData("FS: Homeward (Irina)", "Homeward", DS3LocationCategory.SPELL, npc = True,
                        shop = True),
        ...
        DS3LocationData("FS: Tears of Denial (Irina for Tome of Carim)", "Tears of Denial",
                        DS3LocationCategory.SPELL, missable = True, npc = True, shop = True),
        DS3LocationData("FS: Force (Irina for Tome of Carim)", "Force", DS3LocationCategory.SPELL,
                        missable = True, npc = True, shop = True),
    ...
    "Road of Sacrifices": [
        DS3LocationData("RS: Soul of a Crystal Sage", "Soul of a Crystal Sage",
                        DS3LocationCategory.SOUL, prominent = True, boss = True),
        DS3LocationData("RS: Exile Greatsword (NPC drop by Farron Keep)", "Exile Greatsword",
                        DS3LocationCategory.WEAPON, hostile_npc = True), # Exile Knight #2 drop
        DS3LocationData("RS: Great Club (NPC drop by Farron Keep)", "Great Club",
                        DS3LocationCategory.WEAPON, hostile_npc = True), # Exile Knight #1 drop
        DS3LocationData("RS: Heysel Pick (Heysel drop)", "Heysel Pick", DS3LocationCategory.WEAPON,
                        missable = True, hostile_npc = True),
        DS3LocationData("RS: Xanthous Crown (Heysel drop)", "Xanthous Crown",
                        DS3LocationCategory.WEAPON, missable = True, hostile_npc = True),
        DS3LocationData("RS: Butcher Knife (NPC drop beneath road)", "Butcher Knife",
                        DS3LocationCategory.WEAPON, hostile_npc = True), # Madwoman
        ...
        DS3LocationData("RS: Green Blossom (by deep water)", "Green Blossom x4",
                        DS3LocationCategory.MISC),
        DS3LocationData("RS: Estus Shard (left of fire behind stronghold left room)", "Estus Shard",
                        DS3LocationCategory.HEALTH),
        DS3LocationData("RS: Ring of Sacrifice (stronghold, drop from right room balcony)",
                        "Ring of Sacrifice", DS3LocationCategory.MISC, hidden = True), # hidden fall
        ...
        DS3LocationData("RS: Large Soul of an Unknown Traveler (left of stairs to Farron Keep)",
                        "Large Soul of an Unknown Traveler", DS3LocationCategory.SOUL),
        ...
        DS3LocationData("RS: Green Blossom (water by Crucifixion Woods bonfire)",
                        "Green Blossom x2", DS3LocationCategory.MISC),
        DS3LocationData("RS: Great Swamp Pyromancy Tome (deep water)", "Great Swamp Pyromancy Tome",
                        DS3LocationCategory.UNIQUE),
        ...
        DS3LocationData("RS: Twin Dragon Greatshield (woods by Crucifixion Woods bonfire)",
                        "Twin Dragon Greatshield", DS3LocationCategory.SHIELD),
        ...
        DS3LocationData("RS: Grass Crest Shield (water by Crucifixion Woods bonfire)",
                        "Grass Crest Shield", DS3LocationCategory.SHIELD),
        ...
        DS3LocationData("RS: Braille Divine Tome of Carim (drop from bridge to Halfway Fortress)",
                        "Braille Divine Tome of Carim", DS3LocationCategory.UNIQUE,
                        hidden = True), # Hidden fall
        ...
        DS3LocationData("RS: Golden Falcon Shield (path from stronghold right room to Farron Keep)",
                        "Golden Falcon Shield", DS3LocationCategory.SHIELD),
        ...
        DS3LocationData("RS: Chloranthy Ring+2 (road, drop across from carriage)",
                        "Chloranthy Ring+2", DS3LocationCategory.RING, hidden = True,
                        ngp = True), # Hidden fall
        ...
        DS3LocationData("RS: Great Swamp Ring (miniboss drop, by Farron Keep)",
                        "Great Swamp Ring", DS3LocationCategory.RING,
                        miniboss = True), # Giant Crab drop
        DS3LocationData("RS: Blue Sentinels (Horace)", "Blue Sentinels", DS3LocationCategory.UNIQUE,
        ...
        DS3LocationData("RS: Fading Soul (woods by Crucifixion Woods bonfire)", "Fading Soul",
                        DS3LocationCategory.MISC, offline = '03,0:53300210::'),

        # Orbeck shop, all missable because he'll disappear if you don't talk to him for too long or
        # if you don't give him a scroll.
        DS3LocationData("FS: Farron Dart (Orbeck)", "Farron Dart", DS3LocationCategory.SPELL,
                        offline = '99,0:-1:110000,130100,70000111:', missable = True, npc = True,
                        shop = True),
        DS3LocationData("FS: Soul Arrow (Orbeck)", "Soul Arrow", DS3LocationCategory.SPELL,
                        offline = '99,0:-1:110000,130100,70000111:', missable = True, npc = True,
                        shop = True),
        DS3LocationData("FS: Great Soul Arrow (Orbeck)", "Great Soul Arrow",
                        DS3LocationCategory.SPELL, missable = True, npc = True, shop = True),
        DS3LocationData("FS: Heavy Soul Arrow (Orbeck)", "Heavy Soul Arrow",
                        DS3LocationCategory.SPELL, offline = '99,0:-1:110000,130100,70000111:',
                        missable = True, npc = True, shop = True),
        DS3LocationData("FS: Great Heavy Soul Arrow (Orbeck)", "Great Heavy Soul Arrow",
                        DS3LocationCategory.SPELL, missable = True, npc = True, shop = True),
        DS3LocationData("FS: Magic Weapon (Orbeck)", "Magic Weapon", DS3LocationCategory.SPELL,
                        offline = '99,0:-1:110000,130100,70000111:', missable = True, npc = True,
                        shop = True),
        DS3LocationData("FS: Magic Shield (Orbeck)", "Magic Shield", DS3LocationCategory.SPELL,
                        offline = '99,0:-1:110000,130100,70000111:', missable = True, npc = True,
                        shop = True),
        DS3LocationData("FS: Spook (Orbeck)", "Spook", DS3LocationCategory.SPELL, missable = True,
                        npc = True, shop = True),
        DS3LocationData("FS: Aural Decoy (Orbeck)", "Aural Decoy", DS3LocationCategory.SPELL,
                        missable = True, npc = True, shop = True),
        ...
        DS3LocationData("FS: Homing Crystal Soulmass (Orbeck for Crystal Scroll)",
                        "Homing Crystal Soulmass", DS3LocationCategory.SPELL, missable = True,
                        npc = True, shop = True),
        ...
        DS3LocationData("FS: Crystal Magic Weapon (Orbeck for Crystal Scroll)",
                        "Crystal Magic Weapon", DS3LocationCategory.SPELL, missable = True,
                        npc = True, shop = True),
        ...
        DS3LocationData("FS: Twisted Wall of Light (Orbeck for Golden Scroll)",
                        "Twisted Wall of Light", DS3LocationCategory.SPELL, missable = True,
                        npc = True, shop = True),
        ...
        DS3LocationData("FS: Hidden Body (Orbeck for Golden Scroll)", "Hidden Body",
                        DS3LocationCategory.SPELL, missable = True, npc = True, shop = True),
        DS3LocationData("FS: Repair (Orbeck for Golden Scroll)", "Repair",
                        DS3LocationCategory.SPELL, missable = True, npc = True, shop = True),
        DS3LocationData("FS: Clandestine Coat (shop with Orbeck's Ashes)", "Clandestine Coat",
                        DS3LocationCategory.ARMOR, missable = True, npc = True,
        ...
        DS3LocationData("FS: Young Dragon Ring (Orbeck for one scroll and buying three spells)",
                        "Young Dragon Ring", DS3LocationCategory.RING, missable = True, npc = True),
        DS3LocationData("FS: Slumbering Dragoncrest Ring (Orbeck for buying four specific spells)",
                        "Slumbering Dragoncrest Ring", DS3LocationCategory.RING, missable = True,
                        npc = True),
        ...
        DS3LocationData("FS: Exile Mask (shop after killing NPCs in RS)", "Exile Mask",
                        DS3LocationCategory.ARMOR, hidden = True, hostile_npc = True, shop = True),
        DS3LocationData("FS: Exile Armor (shop after killing NPCs in RS)",
                        "Exile Armor", DS3LocationCategory.ARMOR, hidden = True,
                        hostile_npc = True, shop = True),
        DS3LocationData("FS: Exile Gauntlets (shop after killing NPCs in RS)",
                        "Exile Gauntlets", DS3LocationCategory.ARMOR, hidden = True,
                        hostile_npc = True, shop = True),
        DS3LocationData("FS: Exile Leggings (shop after killing NPCs in RS)",
                        "Exile Leggings", DS3LocationCategory.ARMOR, hidden = True,
                        hostile_npc = True, shop = True),

        # Shrine Handmaid after killing Crystal Sage
        DS3LocationData("FS: Sage's Big Hat (shop after killing RS boss)",
                        "Sage's Big Hat", DS3LocationCategory.ARMOR, boss = True, shop = True),
    ...
    "Cathedral of the Deep": [
        ...
        DS3LocationData("CD: Twinkling Titanite (path, lizard #2)", "Twinkling Titanite",
                        DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("CD: Small Doll (boss drop)", "Small Doll", DS3LocationCategory.KEY,
                        prominent = True, progression = True, boss = True),
        DS3LocationData("CD: Soul of the Deacons of the Deep", "Soul of the Deacons of the Deep",
                        DS3LocationCategory.SOUL, boss = True),
        DS3LocationData("CD: Black Eye Orb (Rosaria from Leonhard's quest)", "Black Eye Orb",
                        DS3LocationCategory.UNIQUE, missable = True, npc = True),
        DS3LocationData("CD: Winged Spear (kill Patches)", "Winged Spear",
                        DS3LocationCategory.WEAPON, drop = True, missable = True), # Patches (kill)
        DS3LocationData("CD: Spider Shield (NPC drop on path)", "Spider Shield",
                        DS3LocationCategory.SHIELD, hostile_npc = True), # Brigand
        ...
        DS3LocationData("CD: Executioner's Greatsword (graveyard, far end)",
                        "Executioner's Greatsword", DS3LocationCategory.WEAPON),
        ...
        DS3LocationData("CD: Curse Ward Greatshield (by ladder from white tree to moat)",
                        "Curse Ward Greatshield", DS3LocationCategory.SHIELD),
        ...
        DS3LocationData("CD: Arbalest (upper roofs, end of furthest buttress)", "Arbalest",
                        DS3LocationCategory.WEAPON),
        DS3LocationData("CD: Ember (by back door)", "Ember", DS3LocationCategory.MISC),
        ...
        DS3LocationData("CD: Blessed Gem (upper roofs, rafters)", "Blessed Gem",
                        DS3LocationCategory.UPGRADE),
        DS3LocationData("CD: Red Bug Pellet (right of cathedral front doors)",
                        "Red Bug Pellet", DS3LocationCategory.MISC),
        ...
        DS3LocationData("CD: Undead Hunter Charm (lower roofs, up stairs between buttresses",
                        "Undead Hunter Charm x3", DS3LocationCategory.MISC),
        DS3LocationData("CD: Red Bug Pellet (lower roofs, up stairs between buttresses)",
                        "Red Bug Pellet x3", DS3LocationCategory.MISC),
        DS3LocationData("CD: Titanite Shard (outside building by white tree)",
                        "Titanite Shard", DS3LocationCategory.UPGRADE,
        ...
        DS3LocationData("CD: Rusted Coin (left of cathedral front doors, behind crates)",
                        "Rusted Coin x2", DS3LocationCategory.MISC, hidden = True),
        ...
        DS3LocationData("CD: Lloyd's Sword Ring (ledge above main hall south)",
                        "Lloyd's Sword Ring", DS3LocationCategory.RING),
        ...
        DS3LocationData("CD: Ring of Favor+2 (upper roofs, on buttress)", "Ring of Favor+2",
                        DS3LocationCategory.RING, hidden = True, ngp = True), # Hidden fall
        DS3LocationData("CD: Crest Shield (path, drop down by Cathedral of the Deep bonfire)",
                        "Crest Shield", DS3LocationCategory.SHIELD, hidden = True), # Hidden fall
        ...
        DS3LocationData("CD: Archdeacon White Crown (boss room after killing boss)",
                        "Archdeacon White Crown", DS3LocationCategory.ARMOR, boss = True,
                        hidden = True),
        DS3LocationData("CD: Archdeacon Holy Garb (boss room after killing boss)",
                        "Archdeacon Holy Garb", DS3LocationCategory.ARMOR, boss = True,
                        hidden = True),
        DS3LocationData("CD: Archdeacon Skirt (boss room after killing boss)", "Archdeacon Skirt",
                        DS3LocationCategory.ARMOR, boss = True, hidden = True),
        ...
        DS3LocationData("CD: Rosaria's Fingers (Rosaria)", "Rosaria's Fingers",
                        DS3LocationCategory.UNIQUE, hidden = True), # Hidden fall
        ...
        DS3LocationData("CD: Spiked Shield (Kirk drop)", "Spiked Shield",
                        DS3LocationCategory.SHIELD, missable = True, hostile_npc = True),
        # In Rosaria's Bed Chamber
        DS3LocationData("CD: Helm of Thorns (Rosaria's Bed Chamber after killing Kirk)",
                        "Helm of Thorns", DS3LocationCategory.ARMOR, missable = True,
                        hostile_npc = True),
        DS3LocationData("CD: Armor of Thorns (Rosaria's Bed Chamber after killing Kirk)",
                        "Armor of Thorns", DS3LocationCategory.ARMOR, missable = True,
                        hostile_npc = True),
        DS3LocationData("CD: Gauntlets of Thorns (Rosaria's Bed Chamber after killing Kirk)",
                        "Gauntlets of Thorns", DS3LocationCategory.ARMOR, missable = True,
                        hostile_npc = True),
        DS3LocationData("CD: Leggings of Thorns (Rosaria's Bed Chamber after killing Kirk)",
                        "Leggings of Thorns", DS3LocationCategory.ARMOR, missable = True,
                        hostile_npc = True),

        # Unbreakable Patches
        DS3LocationData("CD: Rusted Coin (don't forgive Patches)", "Rusted Coin",
                        DS3LocationCategory.MISC, missable = True, npc = True),
        DS3LocationData("FS: Rusted Gold Coin (don't forgive Patches)", "Rusted Gold Coin",
                        DS3LocationCategory.MISC, offline = '99,0:50006201::', missable = True,
                        npc = True), # Don't forgive Patches
        DS3LocationData("CD: Shotel (Patches)", "Shotel", DS3LocationCategory.WEAPON,
                        missable = True, npc = True, shop = True),
        DS3LocationData("CD: Ember (Patches)", "Ember", DS3LocationCategory.MISC, missable = True,
                        npc = True, shop = True),
        DS3LocationData("CD: Hidden Blessing (Patches)", "Hidden Blessing",
                        DS3LocationCategory.MISC, missable = True, npc = True, shop = True),
        DS3LocationData("CD: Horsehoof Ring (Patches)", "Horsehoof Ring", DS3LocationCategory.RING,
                        missable = True, npc = True, drop = True, shop = True), # (kill or buy)
    ],
    "Farron Keep": [
        DS3LocationData("FK: Lightning Spear (upper keep, far side of the wall)", "Lightning Spear",
                        DS3LocationCategory.WEAPON),
        DS3LocationData("FK: Dragon Crest Shield (upper keep, far side of the wall)",
                        "Dragon Crest Shield", DS3LocationCategory.SHIELD),
        ...
        DS3LocationData("FK: Cinders of a Lord - Abyss Watcher",
                        "Cinders of a Lord - Abyss Watcher", DS3LocationCategory.KEY,
        ...
        DS3LocationData("FK: Purple Moss Clump (keep ruins, ritual island)",
                        "Purple Moss Clump x2", DS3LocationCategory.MISC),
        DS3LocationData("FK: Purple Moss Clump (ramp directly in front of Farron Keep bonfire)",
                        "Purple Moss Clump x4", DS3LocationCategory.MISC),
        ...
        DS3LocationData("FK: Repair Powder (outside hidden cave)", "Repair Powder x4",
                        DS3LocationCategory.MISC, hidden = True),
        DS3LocationData("FK: Golden Scroll (hidden cave)", "Golden Scroll",
                        DS3LocationCategory.UNIQUE, hidden = True),
        DS3LocationData("FK: Sage's Scroll (near wall by keep ruins bonfire island)",
                        "Sage's Scroll", DS3LocationCategory.UNIQUE),
        DS3LocationData("FK: Dreamchaser's Ashes (keep proper, illusory wall)",
                        "Dreamchaser's Ashes", DS3LocationCategory.KEY, progression = True,
                        hidden = True),
        ...
        DS3LocationData("FK: Wolf's Blood Swordgrass (by ladder to keep proper)",
                        "Wolf's Blood Swordgrass", DS3LocationCategory.MISC),
        DS3LocationData("FK: Great Magic Weapon (perimeter, by door to Road of Sacrifices)",
                        "Great Magic Weapon", DS3LocationCategory.SPELL),
        DS3LocationData("FK: Ember (perimeter, path to boss)", "Ember", DS3LocationCategory.MISC),
        ...
        DS3LocationData("FK: Black Bug Pellet (perimeter, hill by boss door)",
                        "Black Bug Pellet x3", DS3LocationCategory.MISC),
        DS3LocationData("FK: Rotten Pine Resin (outside pavilion by left island)",
                        "Rotten Pine Resin x4", DS3LocationCategory.MISC),
        ...
        DS3LocationData("FK: Estus Shard (between Farron Keep bonfire and left island)",
                        "Estus Shard", DS3LocationCategory.HEALTH),
        ...
        DS3LocationData("FK: Large Soul of a Nameless Soldier (between right island and pillar)",
                        "Large Soul of a Nameless Soldier",  DS3LocationCategory.SOUL,
                        hidden = True), # Tricky corner to spot
        ...
        DS3LocationData("FK: Gold Pine Bundle (by white tree)", "Gold Pine Bundle x6",
                        DS3LocationCategory.MISC),
        DS3LocationData("FK: Ember (by white tree)", "Ember", DS3LocationCategory.MISC),
        DS3LocationData("FK: Soul of a Nameless Soldier (by white tree)", "Soul of a Nameless Soldier",
                        DS3LocationCategory.SOUL),
        ...
        DS3LocationData("FK: Dark Stoneplate Ring+2 (keep ruins ritual island, behind wall)",
                        "Dark Stoneplate Ring+2", DS3LocationCategory.RING, ngp = True,
                        hidden = True),
        DS3LocationData("FK: Magic Stoneplate Ring+1 (between right island and wall)",
                        "Magic Stoneplate Ring+1", DS3LocationCategory.RING, ngp = True),
        DS3LocationData("FK: Wolf Ring+1 (keep ruins bonfire island, outside building)",
                        "Wolf Ring+1", DS3LocationCategory.RING, ngp = True),
        DS3LocationData("FK: Antiquated Dress (hidden cave)", "Antiquated Dress",
                        DS3LocationCategory.ARMOR, hidden = True),
        DS3LocationData("FK: Antiquated Gloves (hidden cave)", "Antiquated Gloves",
                        DS3LocationCategory.ARMOR, hidden = True),
        DS3LocationData("FK: Antiquated Skirt (hidden cave)", "Antiquated Skirt",
                        DS3LocationCategory.ARMOR, hidden = True),
        DS3LocationData("FK: Sunlight Talisman (estus soup island, by ladder to keep proper)",
                        "Sunlight Talisman", DS3LocationCategory.WEAPON),
        ...
        DS3LocationData("FK: Lingering Dragoncrest Ring (by white tree, miniboss drop)",
                        "Lingering Dragoncrest Ring", DS3LocationCategory.RING,
                        miniboss = True), # Great Crab drop
        DS3LocationData("FK: Pharis's Hat (mob drop, around item in corner by keep ruins)",
                        "Pharis's Hat", DS3LocationCategory.ARMOR, drop = True, hidden = True),
        DS3LocationData("FK: Black Bow of Pharis (mob drop, around item in corner by keep ruins)",
                        "Black Bow of Pharis", DS3LocationCategory.WEAPON, drop = True,
                        hidden = True),
        DS3LocationData("FK: Titanite Scale (perimeter, miniboss drop)", "Titanite Scale x2",
                        DS3LocationCategory.UPGRADE,
                        miniboss = True), # Ravenous Crystal Lizard drop
        DS3LocationData("FK: Large Titanite Shard (upper keep, lizard #1)",
                        "Large Titanite Shard", DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("FK: Large Titanite Shard (upper keep, lizard #2)",
                        "Large Titanite Shard", DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("FK: Heavy Gem (uper keep, lizard on stairs)", "Heavy Gem",
                        DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("FK: Twinkling Titanite (keep proper, lizardl)",
                        "Twinkling Titanite", DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("FK: Soul of a Stray Demon (upper keep, miniboss drop)",
                        "Soul of a Stray Demon", DS3LocationCategory.SOUL, miniboss = True),
        DS3LocationData("FK: Watchdogs of Farron (Old Wolf)", "Watchdogs of Farron",
                        DS3LocationCategory.UNIQUE),
        DS3LocationData("FS: Hawkwood's Shield (Hawkwood)", "Hawkwood's Shield",
                        DS3LocationCategory.SHIELD, missable = True,
                        npc = True), # Hawkwood (quest, after Greatwood, Sage, Watchers, and Deacons)
        DS3LocationData("US: Hawk Ring (Giant Archer)", "Hawk Ring", DS3LocationCategory.RING,
        ...
        DS3LocationData("FS: Farron Ring (Hawkwood)", "Farron Ring", DS3LocationCategory.RING,
                        missable = True, npc = True),

        # Shrine Handmaid after killing Abyss Watchers
        DS3LocationData("FS: Undead Legion Helm (shop after killing FK boss)",
                        "Undead Legion Helm", DS3LocationCategory.ARMOR, boss = True, shop = True),
        DS3LocationData("FS: Undead Legion Armor (shop after killing FK boss)",
                        "Undead Legion Armor", DS3LocationCategory.ARMOR, boss = True, shop = True),
        DS3LocationData("FS: Undead Legion Gauntlet (shop after killing FK boss)",
                        "Undead Legion Gauntlet", DS3LocationCategory.ARMOR, boss = True,
                        shop = True),
        DS3LocationData("FS: Undead Legion Leggings (shop after killing FK boss)",
                        "Undead Legion Leggings", DS3LocationCategory.ARMOR, boss = True,
                        shop = True),
    ...
    "Catacombs of Carthus": [
        ...
        DS3LocationData("CC: Carthus Rouge (atrium upper, left after entrance)",
                        "Carthus Rouge x2", DS3LocationCategory.MISC),
        ...
        DS3LocationData("CC: Bloodred Moss Clump (atrium lower, down more stairs)",
                        "Bloodred Moss Clump x3", DS3LocationCategory.MISC),
        DS3LocationData("CC: Carthus Milkring (crypt upper, among pots)", "Carthus Milkring",
                        DS3LocationCategory.RING),
        DS3LocationData("CC: Ember (atrium, on long stairway)", "Ember", DS3LocationCategory.MISC),
        ...
        DS3LocationData("CC: Old Sage's Blindfold (tomb, hall before bonfire)",
                        "Old Sage's Blindfold", DS3LocationCategory.ARMOR),
        ...
        DS3LocationData("CC: Grave Warden Pyromancy Tome (boss arena)",
                        "Grave Warden Pyromancy Tome", DS3LocationCategory.UNIQUE),
        ...
        DS3LocationData("CC: Ring of Steel Protection+2 (atrium upper, drop onto pillar)",
                        "Ring of Steel Protection+2", DS3LocationCategory.RING, ngp = True),
        DS3LocationData("CC: Thunder Stoneplate Ring+1 (crypt upper, among pots)",
                        "Thunder Stoneplate Ring+1", DS3LocationCategory.RING, ngp = True),
        ...
        DS3LocationData("CC: Dark Gem (crypt lower, skeleton ball drop)", "Dark Gem",
                        DS3LocationCategory.UPGRADE, hidden = True), # Skeleton Ball puzzle
        DS3LocationData("CC: Black Blade (tomb, mimic)", "Black Blade", DS3LocationCategory.WEAPON,
                        mimic = True),
        DS3LocationData("CC: Soul of a Demon (tomb, miniboss drop)", "Soul of a Demon",
                        DS3LocationCategory.SOUL, miniboss = True),
        DS3LocationData("CC: Twinkling Titanite (atrium lower, lizard down more stairs)",
                        "Twinkling Titanite", DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("CC: Fire Gem (cavern, lizard)", "Fire Gem",
                        DS3LocationCategory.UPGRADE, lizard = True),
        ...
        DS3LocationData("CC: Pontiff's Right Eye (Irithyll bridge, miniboss drop)",
                        "Pontiff's Right Eye", DS3LocationCategory.RING,
                        miniboss = True), # Sulyvahn's Beast drop
        ...
        DS3LocationData("FS: Wolnir's Crown (shop after killing CC boss)", "Wolnir's Crown",
                        DS3LocationCategory.ARMOR, boss = True, shop = True),
    ],
    "Smouldering Lake": [
        ...
        DS3LocationData("SL: Speckled Stoneplate Ring (lake, ballista breaks bricks)",
                        "Speckled Stoneplate Ring", DS3LocationCategory.RING,
        ...
        DS3LocationData("SL: Izalith Pyromancy Tome (antechamber, room near bonfire)",
                        "Izalith Pyromancy Tome", DS3LocationCategory.UNIQUE),
        DS3LocationData("SL: Black Knight Sword (ruins main lower, illusory wall in far hall)",
                        "Black Knight Sword", DS3LocationCategory.WEAPON, hidden = True),
        ...
        DS3LocationData("SL: Quelana Pyromancy Tome (ruins main lower, illusory wall in grey room)",
                        "Quelana Pyromancy Tome", DS3LocationCategory.UNIQUE, hidden = True),
        DS3LocationData("SL: Izalith Staff (ruins basement, second illusory wall behind chest)",
                        "Izalith Staff", DS3LocationCategory.WEAPON, hidden = True),
        DS3LocationData("SL: White Hair Talisman (ruins main lower, in lava)",
                        "White Hair Talisman", DS3LocationCategory.WEAPON,
        ...
        DS3LocationData("SL: Undead Bone Shard (ruins main lower, left after stairs)",
                        "Undead Bone Shard", DS3LocationCategory.HEALTH),
        DS3LocationData("SL: Titanite Scale (ruins basement, path to lava)",
                        "Titanite Scale", DS3LocationCategory.UPGRADE),
        ...
        DS3LocationData("SL: Soul of a Crestfallen Knight (ruins basement, above lava)",
                        "Soul of a Crestfallen Knight", DS3LocationCategory.SOUL),
        DS3LocationData("SL: Ember (ruins basement, in lava)", "Ember", DS3LocationCategory.MISC,
                        missable = True), # In lava
        DS3LocationData("SL: Sacred Flame (ruins basement, in lava)", "Sacred Flame",
                        DS3LocationCategory.SPELL, missable = True), # In lava
        DS3LocationData("SL: Dragonrider Bow (by ladder from ruins basement to ballista)",
                        "Dragonrider Bow", DS3LocationCategory.WEAPON, hidden = True), # Hidden fall
        DS3LocationData("SL: Estus Shard (antechamber, illusory wall)", "Estus Shard",
                        DS3LocationCategory.HEALTH, hidden = True),
        ...
        DS3LocationData("SL: Flame Stoneplate Ring+2 (ruins main lower, illusory wall in far hall)",
                        "Flame Stoneplate Ring+2", DS3LocationCategory.RING, ngp = True,
                        hidden = True),
        DS3LocationData("SL: Large Titanite Shard (ruins basement, illusory wall in upper hall)",
                        "Large Titanite Shard x3", DS3LocationCategory.UPGRADE, hidden = True),
        DS3LocationData("SL: Undead Bone Shard (lake, miniboss drop)", "Undead Bone Shard",
                        DS3LocationCategory.HEALTH, miniboss = True), # Sand Worm drop
        DS3LocationData("SL: Lightning Stake (lake, miniboss drop)", "Lightning Stake",
                        DS3LocationCategory.SPELL, miniboss = True), # Sand Worm drop
        DS3LocationData("SL: Twinkling Titanite (path to side lake, lizard)",
                        "Twinkling Titanite", DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("SL: Titanite Chunk (path to side lake, lizard)", "Titanite Chunk",
                        DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("SL: Chaos Gem (antechamber, lizard at end of long hall)",
                        "Chaos Gem", DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("SL: Knight Slayer's Ring (ruins basement, NPC drop)",
                        "Knight Slayer's Ring", DS3LocationCategory.RING,
                        hostile_npc = True), # Knight Slayer Tsorig drop
        ...
        DS3LocationData("SL: Llewellyn Shield (Horace drop)", "Llewellyn Shield",
                        DS3LocationCategory.SHIELD, npc = True, hostile_npc = True),
        DS3LocationData("FS: Executioner Helm (shop after killing Horace)", "Executioner Helm",
                        DS3LocationCategory.ARMOR, npc = True, hostile_npc = True, shop = True,
                        hidden = True),
        ...
        DS3LocationData("FS: Executioner Gauntlets (shop after killing Horace)",
                        "Executioner Gauntlets", DS3LocationCategory.ARMOR,
                        hostile_npc = True, npc = True, shop = True, hidden = True),
        DS3LocationData("FS: Executioner Leggings (shop after killing Horace)",
                        "Executioner Leggings", DS3LocationCategory.ARMOR,
                        hostile_npc = True, npc = True, shop = True, hidden = True),
        ...
        DS3LocationData("FS: Black Iron Helm (shop after killing Tsorig)", "Black Iron Helm",
                        DS3LocationCategory.ARMOR, hostile_npc = True, shop = True, hidden = True),
        ...
        DS3LocationData("FS: Black Iron Gauntlets (shop after killing Tsorig)",
                        "Black Iron Gauntlets", DS3LocationCategory.ARMOR, hostile_npc = True,
                        shop = True, hidden = True),
        DS3LocationData("FS: Black Iron Leggings (shop after killing Tsorig)",
                        "Black Iron Leggings", DS3LocationCategory.ARMOR, hostile_npc = True,
                        shop = True, hidden = True),
    ...
    "Irithyll of the Boreal Valley": [
        ...
        DS3LocationData("IBV: Soul of a Weary Warrior (central, by first fountain)",
                        "Soul of a Weary Warrior", DS3LocationCategory.SOUL),
        ...
        DS3LocationData("IBV: Witchtree Branch (by Dorhys)", "Witchtree Branch",
                        DS3LocationCategory.WEAPON, hidden = True), # Behind illusory wall
        ...
        DS3LocationData("IBV: Budding Green Blossom (central, by second fountain)",
                        "Budding Green Blossom", DS3LocationCategory.MISC),
        DS3LocationData("IBV: Rime-blue Moss Clump (central, past second fountain)",
                        "Rime-blue Moss Clump x2", DS3LocationCategory.MISC),
        ...
        DS3LocationData("IBV: Large Titanite Shard (path to Dorhys)", "Large Titanite Shard",
                        DS3LocationCategory.UPGRADE, hidden = True), # Behind illusory wall
        DS3LocationData("IBV: Ring of the Sun's First Born (fall from in front of cathedral)",
                        "Ring of the Sun's First Born", DS3LocationCategory.RING,
                        hidden = True), # Hidden fall
        ...
        DS3LocationData("IBV: Magic Clutch Ring (plaza, illusory wall)", "Magic Clutch Ring",
                        DS3LocationCategory.RING, hidden = True), # Behind illusory wall
        ...
        DS3LocationData("IBV: Undead Bone Shard (descent, behind gravestone)", "Undead Bone Shard",
                        DS3LocationCategory.HEALTH, hidden = True), # Hidden behind gravestone
        DS3LocationData("IBV: Kukri (descent, side path)", "Kukri x8", DS3LocationCategory.MISC),
        ...
        DS3LocationData("IBV: Green Blossom (lake wall)", "Green Blossom x3",
                        DS3LocationCategory.MISC),
        DS3LocationData("IBV: Dung Pie (sewer #1)", "Dung Pie x3", DS3LocationCategory.MISC),
        DS3LocationData("IBV: Dung Pie (sewer #2)", "Dung Pie x3", DS3LocationCategory.MISC),
        ...
        DS3LocationData("IBV: Excrement-covered Ashes (sewer, by stairs)",
                        "Excrement-covered Ashes", DS3LocationCategory.UNIQUE),
        ...
        DS3LocationData("IBV: Proof of a Concord Kept (Church of Yorshka altar)",
                        "Proof of a Concord Kept", DS3LocationCategory.MISC),
        ...
        DS3LocationData("IBV: Covetous Gold Serpent Ring+1 (descent, drop after dark room)",
                        "Covetous Gold Serpent Ring+1", DS3LocationCategory.RING, ngp = True,
                        hidden = True), # Hidden fall
        ...
        DS3LocationData("IBV: Smough's Great Hammer (great hall, chest)",
                        "Smough's Great Hammer", DS3LocationCategory.WEAPON),
        ...
        DS3LocationData("IBV: Dorhys' Gnawing (Dorhys drop)", "Dorhys' Gnawing",
                        DS3LocationCategory.SPELL, hidden = True), # Behind illusory wall
        DS3LocationData("IBV: Divine Blessing (great hall, mob)",
                        "Divine Blessing", DS3LocationCategory.MISC, drop = True,
                        hidden = True), # Guaranteed drop from normal-looking Silver Knight
        DS3LocationData("IBV: Large Titanite Shard (great hall, mob)",
                        "Large Titanite Shard", DS3LocationCategory.UPGRADE, drop = True,
                        hidden = True), # Guaranteed drop from normal-looking Silver Knight
        DS3LocationData("IBV: Large Titanite Shard (great hall, mob)",
                        "Large Titanite Shard x2", DS3LocationCategory.UPGRADE, drop = True,
                        hidden = True), # Guaranteed drop from normal-looking Silver Knight
        DS3LocationData("IBV: Large Titanite Shard (great hall, mob)",
                        "Large Titanite Shard x2", DS3LocationCategory.UPGRADE, drop = True,
                        hidden = True), # Guaranteed drop from normal-looking Silver Knight
        ...
        DS3LocationData("IBV: Twinkling Titanite (central, lizard before plaza)",
                        "Twinkling Titanite", DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("IBV: Siegbräu (Siegward)", "Siegbräu", DS3LocationCategory.MISC,
                        missable = True, npc = True),
        DS3LocationData("IBV: Emit Force (Siegward)", "Emit Force", DS3LocationCategory.SPELL,
                        missable = True, npc = True),
        ...
        DS3LocationData("FS: Mail Breaker (Sirris for killing Creighton)", "Mail Breaker",
                        DS3LocationCategory.WEAPON, offline = '99,0:50006080::', missable = True,
                        hostile_npc = True, npc = True),
        DS3LocationData("FS: Silvercat Ring (Sirris for killing Creighton)", "Silvercat Ring",
                        DS3LocationCategory.RING, missable = True, hostile_npc = True, npc = True),
        ...
        DS3LocationData("IBV: Creighton's Steel Mask (bridge after killing Creighton)",
                        "Creighton's Steel Mask", DS3LocationCategory.ARMOR, missable = True,
                        hostile_npc = True, npc = True),
        DS3LocationData("IBV: Mirrah Chain Mail (bridge after killing Creighton)",
                        "Mirrah Chain Mail", DS3LocationCategory.ARMOR, missable = True,
                        hostile_npc = True, npc = True),
        DS3LocationData("IBV: Mirrah Chain Gloves (bridge after killing Creighton)",
                        "Mirrah Chain Gloves", DS3LocationCategory.ARMOR, missable = True,
                        hostile_npc = True, npc = True),
        DS3LocationData("IBV: Mirrah Chain Leggings (bridge after killing Creighton)",
                        "Mirrah Chain Leggings", DS3LocationCategory.ARMOR, missable = True,
                        hostile_npc = True, npc = True),
    ],
    "Irithyll Dungeon": [
        DS3LocationData("ID: Titanite Slab (Siegward)", "Titanite Slab",
                        DS3LocationCategory.UPGRADE, missable = True, npc = True),
        DS3LocationData("ID: Murakumo (Alva drop)", "Murakumo",
                        DS3LocationCategory.WEAPON, missable = True, hostile_npc = True),
        DS3LocationData("ID: Large Titanite Shard (B1 near, just past bonfire)", "Large Titanite Shard",
                        DS3LocationCategory.UPGRADE),
        DS3LocationData("ID: Fading Soul (B1 near, main hall)", "Fading Soul", DS3LocationCategory.MISC),
        ...
        DS3LocationData("ID: Jailbreaker's Key (B1 far, cell after gate)", "Jailbreaker's Key",
                        DS3LocationCategory.KEY, key = True),
        DS3LocationData("ID: Pale Pine Resin (B1 far, cell with broken wall)", "Pale Pine Resin x2",
                        DS3LocationCategory.MISC),
        ...
        DS3LocationData("ID: Large Soul of a Nameless Soldier (B2 far, by lift)",
                        "Large Soul of a Nameless Soldier", DS3LocationCategory.SOUL),
        DS3LocationData("ID: Large Titanite Shard (B1 far, rightmost cell)", "Large Titanite Shard",
                        DS3LocationCategory.UPGRADE),
        ...
        DS3LocationData("ID: Bellowing Dragoncrest Ring (drop from B1 towards pit)",
                        "Bellowing Dragoncrest Ring", DS3LocationCategory.RING, conditional = True),
        ...
        DS3LocationData("ID: Large Titanite Shard (pit)", "Large Titanite Shard",
                        DS3LocationCategory.UPGRADE),
        DS3LocationData("ID: Profaned Flame (pit)", "Profaned Flame", DS3LocationCategory.SPELL),
        DS3LocationData("ID: Large Titanite Shard (pit)",
                        "Large Titanite Shard", DS3LocationCategory.UPGRADE),
        ...
        DS3LocationData("ID: Dung Pie (B3, by path from pit)", "Dung Pie x4",
                        DS3LocationCategory.MISC),
        DS3LocationData("ID: Ember (B3 center)", "Ember", DS3LocationCategory.MISC),
        DS3LocationData("ID: Ember (B3 near, by exit)", "Ember", DS3LocationCategory.MISC),
        ...
        DS3LocationData("ID: Old Sorcerer Gauntlets (B2 near, middle cell)",
                        "Old Sorcerer Gauntlets", DS3LocationCategory.ARMOR),
        ...
        DS3LocationData("ID: Large Soul of a Weary Warrior (just before Profaned Capital)",
                        "Large Soul of a Weary Warrior", DS3LocationCategory.SOUL),
        DS3LocationData("ID: Covetous Gold Serpent Ring (Siegward's cell)",
                        "Covetous Gold Serpent Ring", DS3LocationCategory.RING, conditional = True),
        ...
        DS3LocationData("ID: Dusk Crown Ring (B3 far, right cell)", "Dusk Crown Ring",
                        DS3LocationCategory.RING),
        DS3LocationData("ID: Pickaxe (path from pit to B3)", "Pickaxe", DS3LocationCategory.WEAPON),
        ...
        DS3LocationData("ID: Covetous Silver Serpent Ring+1 (pit lift, middle platform)",
                        "Covetous Silver Serpent Ring+1", DS3LocationCategory.RING, ngp = True),
        ...
        DS3LocationData("ID: Prisoner Chief's Ashes (B2 near, locked cell by stairs)",
                        "Prisoner Chief's Ashes", DS3LocationCategory.KEY, progression = True),
        DS3LocationData("ID: Great Magic Shield (B2 near, mob drop in far left cell)",
                        "Great Magic Shield", DS3LocationCategory.SPELL,drop = True,
        ...
        DS3LocationData("ID: Alva Armor (B3 near, by Karla's cell, after killing Alva)",
                        "Alva Armor", DS3LocationCategory.ARMOR, missable = True, npc = True),
        DS3LocationData("ID: Alva Gauntlets (B3 near, by Karla's cell, after killing Alva)",
                        "Alva Gauntlets", DS3LocationCategory.ARMOR, missable = True, npc = True),
        DS3LocationData("ID: Alva Leggings (B3 near, by Karla's cell, after killing Alva)",
                        "Alva Leggings", DS3LocationCategory.ARMOR, missable = True, npc = True),
    ],
    "Profaned Capital": [
        DS3LocationData("PC: Soul of Yhorm the Giant", "Soul of Yhorm the Giant",
                        DS3LocationCategory.SOUL, boss = True),
        DS3LocationData("PC: Cinders of a Lord - Yhorm the Giant",
                        "Cinders of a Lord - Yhorm the Giant", DS3LocationCategory.KEY,
                        offline = "07,0:50002170::", prominent = True, progression = True,
                        boss = True),
        DS3LocationData("PC: Logan's Scroll (chapel roof, NPC drop)", "Logan's Scroll",
                        DS3LocationCategory.UNIQUE, hostile_npc = True), # Sorcerer
        ...
        DS3LocationData("PC: Blooming Purple Moss Clump (walkway above swamp)",
                        "Blooming Purple Moss Clump x3", DS3LocationCategory.MISC),
        ...
        DS3LocationData("PC: Onislayer Greatbow (drop from bridge)", "Onislayer Greatbow",
                        DS3LocationCategory.WEAPON, hidden = True), # Hidden fall
        DS3LocationData("PC: Jailer's Key Ring (hall past chapel)", "Jailer's Key Ring",
                        DS3LocationCategory.KEY, progression = True, key = True),
        DS3LocationData("PC: Ember (palace, far room)", "Ember", DS3LocationCategory.MISC),
        DS3LocationData("PC: Flame Stoneplate Ring+1 (chapel, drop from roof towards entrance)",
                        "Flame Stoneplate Ring+1", DS3LocationCategory.RING, ngp = True,
                        hidden = True), # Hidden fall
        ...
        DS3LocationData("PC: Court Sorcerer Trousers (chapel, second floor)",
                        "Court Sorcerer Trousers", DS3LocationCategory.ARMOR),
        DS3LocationData("PC: Storm Ruler (boss room)", "Storm Ruler", DS3LocationCategory.WEAPON),
        ...
        DS3LocationData("PC: Eleonora (chapel ground floor, kill mob)", "Eleonora",
                        DS3LocationCategory.WEAPON, drop = True,
        ...
        DS3LocationData("PC: Rusted Gold Coin (palace, mimic in far room)", "Rusted Gold Coin x2",
                        DS3LocationCategory.MISC, mimic = True),
        DS3LocationData("PC: Court Sorcerer's Staff (chapel, mimic on second floor)",
                        "Court Sorcerer's Staff", DS3LocationCategory.WEAPON, mimic = True),
        DS3LocationData("PC: Greatshield of Glory (palace, mimic in far room)",
                        "Greatshield of Glory", DS3LocationCategory.SHIELD, mimic = True),
        ...
        DS3LocationData("PC: Pierce Shield (Siegward)", "Pierce Shield", DS3LocationCategory.SHIELD,
    ...
    "Anor Londo": [
        ...
        DS3LocationData("AL: Cinders of a Lord - Aldrich", "Cinders of a Lord - Aldrich",
                        DS3LocationCategory.KEY, offline = '06,0:50002130::', prominent = True,
                        progression = True, boss = True),
        DS3LocationData("AL: Yorshka's Chime (kill Yorshka)", "Yorshka's Chime",
                        DS3LocationCategory.WEAPON, missable = True, drop = True,
                        npc = True), # Hidden walkway, missable because it will break Sirris's quest
        DS3LocationData("AL: Drang Twinspears (plaza, NPC drop)", "Drang Twinspears",
                        DS3LocationCategory.WEAPON, drop = True, hidden = True),
        ...
        DS3LocationData("AL: Painting Guardian's Curved Sword (prison tower rafters)",
                        "Painting Guardian's Curved Sword", DS3LocationCategory.WEAPON,
                        hidden = True), # Invisible walkway
        DS3LocationData("AL: Brass Helm (tomb)", "Brass Helm", DS3LocationCategory.ARMOR,
                        hidden = True), # Behind illusory wall
        DS3LocationData("AL: Brass Armor (tomb)", "Brass Armor", DS3LocationCategory.ARMOR,
                        hidden = True), # Behind illusory wall
        DS3LocationData("AL: Brass Gauntlets (tomb)", "Brass Gauntlets", DS3LocationCategory.ARMOR,
                        hidden = True), # Behind illusory wall
        DS3LocationData("AL: Brass Leggings (tomb)", "Brass Leggings", DS3LocationCategory.ARMOR,
                        hidden = True), # Behind illusory wall
        DS3LocationData("AL: Human Dregs (water reserves)", "Human Dregs", DS3LocationCategory.MISC,
                        hidden = True), # Behind illusory wall
        DS3LocationData("AL: Ember (spiral staircase, bottom)", "Ember", DS3LocationCategory.MISC),
        ...
        DS3LocationData("AL: Soul of a Weary Warrior (plaza, nearer)", "Soul of a Weary Warrior",
                        DS3LocationCategory.SOUL),
        DS3LocationData("AL: Ember (plaza, right side)", "Ember", DS3LocationCategory.MISC),
        DS3LocationData("AL: Ember (plaza, further)", "Ember", DS3LocationCategory.MISC),
        ...
        DS3LocationData("AL: Dark Stoneplate Ring (by dark stairs up from plaza)",
                        "Dark Stoneplate Ring", DS3LocationCategory.RING),
        DS3LocationData("AL: Large Titanite Shard (bottom of the nearest buttress)",
                        "Large Titanite Shard",                DS3LocationCategory.UPGRADE),
        DS3LocationData("AL: Deep Gem (water reserves)", "Deep Gem", DS3LocationCategory.UPGRADE),
        ...
        DS3LocationData("AL: Moonlight Arrow (dark cathedral, up right stairs)",
                        "Moonlight Arrow x6", DS3LocationCategory.MISC),
        ...
        DS3LocationData("AL: Havel's Ring+2 (prison tower, rafters)", "Havel's Ring+2",
                        DS3LocationCategory.RING, ngp = True, hidden = True), # Invisible walkway
        ...
        DS3LocationData("AL: Golden Ritual Spear (light cathedral, mimic upstairs)",
                        "Golden Ritual Spear", DS3LocationCategory.WEAPON, mimic = True),
        DS3LocationData("AL: Ring of Favor (water reserves, both minibosses)", "Ring of Favor",
                        DS3LocationCategory.RING, miniboss = True, 
        ...
        DS3LocationData("AL: Blade of the Darkmoon (Yorshka with Darkmoon Loyalty)",
                        "Blade of the Darkmoon", DS3LocationCategory.UNIQUE, missable = True,
                        drop = True,
                        npc = True), # Hidden walkway, missable because it will break Sirris's quest
        ...
        DS3LocationData("AL: Aldrich Faithful (water reserves, talk to McDonnel)", "Aldrich Faithful",
                        DS3LocationCategory.UNIQUE, hidden = True), # Behind illusory wall
        DS3LocationData("AL: Large Titanite Shard ?? (right after light cathedral)",
                        "Large Titanite Shard", DS3LocationCategory.UPGRADE,
        ...
        DS3LocationData("FS: Leonhard's Garb (shop after killing Leonhard)",
                        "Leonhard's Garb", DS3LocationCategory.ARMOR, hidden = True, npc = True,
                        shop = True, missable = True),
        DS3LocationData("FS: Leonhard's Gauntlets (shop after killing Leonhard)",
                        "Leonhard's Gauntlets", DS3LocationCategory.ARMOR, hidden = True,
                        npc = True, shop = True, missable = True),
        DS3LocationData("FS: Leonhard's Trousers (shop after killing Leonhard)",
                        "Leonhard's Trousers", DS3LocationCategory.ARMOR, hidden = True, npc = True,
                        shop = True, missable = True),
        ...
        DS3LocationData("FS: Elite Knight Helm (shop after Anri quest)", "Elite Knight Helm",
                        DS3LocationCategory.ARMOR, missable = True, npc = True, shop = True),
        ...
        DS3LocationData("FS: Elite Knight Gauntlets (shop after Anri quest)",
                        "Elite Knight Gauntlets", DS3LocationCategory.ARMOR, missable = True,
                        npc = True, shop = True),
        DS3LocationData("FS: Elite Knight Leggings (shop after Anri quest)",
                        "Elite Knight Leggings", DS3LocationCategory.ARMOR, missable = True,
                        npc = True, shop = True),

        # Ringfinger Leonhard (quest or kill)
        DS3LocationData("AL: Crescent Moon Sword (Leonhard drop)",
                        "Crescent Moon Sword", DS3LocationCategory.WEAPON, missable = True,
                        npc = True),
        DS3LocationData("AL: Silver Mask (Leonhard drop)",
                        "Silver Mask", DS3LocationCategory.ARMOR, missable = True, npc = True),
        DS3LocationData("AL: Soul of Rosaria (Leonhard drop)",
                        "Soul of Rosaria", DS3LocationCategory.UNIQUE, missable = True, npc = True),
    ],
    "Lothric Castle": [
        ...
        DS3LocationData("LC: Titanite Chunk (dark room mid, out door opposite wyvern)",
                        "Titanite Chunk", DS3LocationCategory.UPGRADE),
        ...
        DS3LocationData("LC: Sacred Bloom Shield (ascent, behind illusory wall)",
                        "Sacred Bloom Shield", DS3LocationCategory.SHIELD,
                        hidden = True), # Behind illusory wall
        DS3LocationData("LC: Titanite Chunk (ascent, final turret)", "Titanite Chunk x2",
                        DS3LocationCategory.UPGRADE),
        DS3LocationData("LC: Refined Gem (plaza)", "Refined Gem", DS3LocationCategory.UPGRADE),
        ...
        DS3LocationData("LC: Caitha's Chime (chapel, drop onto roof)", "Caitha's Chime",
                        DS3LocationCategory.WEAPON),
        DS3LocationData("LC: Lightning Urn (plaza)", "Lightning Urn x6", DS3LocationCategory.MISC),
        DS3LocationData("LC: Ember (plaza, by gate)", "Ember", DS3LocationCategory.MISC),
        DS3LocationData("LC: Raw Gem (plaza left)", "Raw Gem", DS3LocationCategory.UPGRADE),
        ...
        DS3LocationData("LC: Soul of a Crestfallen Knight (wyvern room, balcony)",
                        "Soul of a Crestfallen Knight", DS3LocationCategory.MISC,
                        hidden = True), # Hidden fall
        ...
        DS3LocationData("LC: Large Soul of a Nameless Soldier (moat, right path)",
                        "Large Soul of a Nameless Soldier", DS3LocationCategory.SOUL),
        DS3LocationData("LC: Knight's Ring (altar)", "Knight's Ring", DS3LocationCategory.RING),
        DS3LocationData("LC: Ember (main hall, left of stairs)", "Ember", DS3LocationCategory.MISC),
        ...
        DS3LocationData("LC: Large Soul of a Nameless Soldier (dark room mid)",
                        "Large Soul of a Nameless Soldier", DS3LocationCategory.SOUL),
        DS3LocationData("LC: Ember (plaza center)", "Ember", DS3LocationCategory.MISC),
        DS3LocationData("LC: Winged Knight Helm (ascent, behind illusory wall)",
                        "Winged Knight Helm", DS3LocationCategory.ARMOR, hidden = True),
        DS3LocationData("LC: Winged Knight Armor (ascent, behind illusory wall)",
                        "Winged Knight Armor", DS3LocationCategory.ARMOR, hidden = True),
        DS3LocationData("LC: Winged Knight Gauntlets (ascent, behind illusory wall)",
                        "Winged Knight Gauntlets", DS3LocationCategory.ARMOR, hidden = True),
        DS3LocationData("LC: Winged Knight Leggings (ascent, behind illusory wall)",
                        "Winged Knight Leggings", DS3LocationCategory.ARMOR, hidden = True),
        DS3LocationData("LC: Rusted Coin (chapel)", "Rusted Coin x2", DS3LocationCategory.MISC),
        DS3LocationData("LC: Braille Divine Tome of Lothric (wyvern room)",
                        "Braille Divine Tome of Lothric", DS3LocationCategory.UNIQUE,
                        hidden = True), # Hidden fall
        ...
        DS3LocationData("LC: Spirit Tree Crest Shield (basement, chest)",
                        "Spirit Tree Crest Shield", DS3LocationCategory.SHIELD),
        ...
        DS3LocationData("LC: Life Ring+2 (dark room mid, out door opposite wyvern, drop down)",
                        "Life Ring+2", DS3LocationCategory.RING, ngp = True,
                        hidden = True), # Hidden fall
        DS3LocationData("LC: Dark Stoneplate Ring+1 (wyvern room, balcony)",
                        "Dark Stoneplate Ring+1", DS3LocationCategory.RING, ngp = True,
                        hidden = True), # Hidden fall
        DS3LocationData("LC: Thunder Stoneplate Ring+2 (chapel, drop onto roof)",
                        "Thunder Stoneplate Ring+2", DS3LocationCategory.RING, ngp = True),
        DS3LocationData("LC: Sunlight Straight Sword (wyvern room, mimic)",
                        "Sunlight Straight Sword", DS3LocationCategory.WEAPON, mimic = True,
                        hidden = True), # Hidden fall
        ...
        DS3LocationData("LC: Ember (wyvern room, wyvern foot mob drop)", "Ember x2",
                        DS3LocationCategory.MISC,
                        hidden = True), # Hidden fall, Pus of Man Wyvern drop
        ...
        DS3LocationData("LC: Gotthard Twinswords (by Grand Archives door, after PC and AL bosses)",
                        "Gotthard Twinswords", DS3LocationCategory.WEAPON, conditional = True),
        DS3LocationData("LC: Grand Archives Key (by Grand Archives door, after PC and AL bosses)",
                        "Grand Archives Key", DS3LocationCategory.KEY, prominent = True,
                        progression = True, key = True, conditional = True),
        DS3LocationData("LC: Titanite Chunk (down stairs after boss)", "Titanite Chunk",
                        DS3LocationCategory.UPGRADE),

        # Eygon of Carim (kill or quest)
        DS3LocationData("FS: Morne's Great Hammer (Eygon)", "Morne's Great Hammer",
                        DS3LocationCategory.WEAPON, npc = True),
        DS3LocationData("FS: Moaning Shield (Eygon)", "Moaning Shield", DS3LocationCategory.SHIELD,
                        npc = True),
        ...
        DS3LocationData("FS: Dancer's Gauntlets (shop after killing LC entry boss)",
                        "Dancer's Gauntlets", DS3LocationCategory.ARMOR, boss = True, shop = True),
        DS3LocationData("FS: Dancer's Leggings (shop after killing LC entry boss)",
                        "Dancer's Leggings", DS3LocationCategory.ARMOR, boss = True, shop = True),
        ...
        DS3LocationData("FS: Morne's Gauntlets (shop after killing Eygon or LC boss)",
                        "Morne's Gauntlets", DS3LocationCategory.ARMOR, boss = True, shop = True),
        DS3LocationData("FS: Morne's Leggings (shop after killing Eygon or LC boss)",
                        "Morne's Leggings", DS3LocationCategory.ARMOR, boss = True, shop = True),
    ],
    "Consumed King's Garden": [
        ...
        DS3LocationData("CKG: Estus Shard (balcony)", "Estus Shard", DS3LocationCategory.HEALTH),
        ...
        DS3LocationData("CKG: Black Firebomb (under rotunda)", "Black Firebomb x2",
                        DS3LocationCategory.MISC),
        DS3LocationData("CKG: Claw (under rotunda)", "Claw", DS3LocationCategory.WEAPON),
        ...
        DS3LocationData("CKG: Dragonscale Ring (shortcut, leave halfway down lift)",
                        "Dragonscale Ring", DS3LocationCategory.RING),
        ...
        DS3LocationData("CKG: Human Pine Resin (by lone stairway bottom)",
                        "Human Pine Resin x2", DS3LocationCategory.MISC),
        ...
        DS3LocationData("CKG: Sage Ring+2 (balcony, drop onto rubble, jump back)", "Sage Ring+2",
                        DS3LocationCategory.RING, ngp = True, hidden = True),
        ...
        DS3LocationData("CKG: Magic Stoneplate Ring (mob drop before boss)",
                        "Magic Stoneplate Ring", DS3LocationCategory.RING, drop = True,
    ...
    "Grand Archives": [
        ...
        DS3LocationData("GA: Titanite Scale (3F, by ladder to 2F late)", "Titanite Scale",
                        DS3LocationCategory.UPGRADE, hidden = True), # Hidden by a table
        ...
        DS3LocationData("GA: Large Soul of a Crestfallen Knight (4F, back)",
                        "Large Soul of a Crestfallen Knight", DS3LocationCategory.SOUL),
        ...
        DS3LocationData("GA: Titanite Chunk (rooftops, just before 5F)", "Titanite Chunk",
                        DS3LocationCategory.UPGRADE),
        DS3LocationData("GA: Ember (5F, by entrance)", "Ember", DS3LocationCategory.MISC),
        DS3LocationData("GA: Blessed Gem (rafters)", "Blessed Gem", DS3LocationCategory.UPGRADE),
        ...
        DS3LocationData("GA: Divine Pillars of Light (cage above rafters)",
                        "Divine Pillars of Light", DS3LocationCategory.SPELL),
        DS3LocationData("GA: Power Within (dark room, behind retractable bookshelf)",
                        "Power Within", DS3LocationCategory.SPELL,
        ...
        DS3LocationData("GA: Lingering Dragoncrest Ring+2 (dome, room behind spire)",
                        "Lingering Dragoncrest Ring+2", DS3LocationCategory.RING, ngp = True),
        DS3LocationData("GA: Divine Blessing (rafters, down lower level ladder)", "Divine Blessing",
                        DS3LocationCategory.MISC),
        DS3LocationData("GA: Twinkling Titanite (rafters, down lower level ladder)",
                        "Twinkling Titanite x3", DS3LocationCategory.UPGRADE),
        DS3LocationData("GA: Witch's Locks (dark room, behind retractable bookshelf)",
                        "Witch's Locks", DS3LocationCategory.WEAPON,
                        hidden = True), # Switch in darkened room
        ...
        DS3LocationData("GA: Titanite Slab (dome, kill all mobs)", "Titanite Slab",
                        DS3LocationCategory.UPGRADE, drop = True,
        ...
        DS3LocationData("GA: Outrider Knight Helm (3F, behind illusory wall, miniboss drop)",
                        "Outrider Knight Helm", DS3LocationCategory.ARMOR,
        ...
        DS3LocationData("GA: Outrider Knight Armor (3F, behind illusory wall, miniboss drop)",
                        "Outrider Knight Armor", DS3LocationCategory.ARMOR, miniboss = True,
        ...
        DS3LocationData("GA: Outrider Knight Gauntlets (3F, behind illusory wall, miniboss drop)",
                        "Outrider Knight Gauntlets", DS3LocationCategory.ARMOR, miniboss = True,
                        hidden = True), # Behind illusory wall, Outrider Knight drop
        DS3LocationData("GA: Outrider Knight Leggings (3F, behind illusory wall, miniboss drop)",
                        "Outrider Knight Leggings", DS3LocationCategory.ARMOR, miniboss = True,
                        hidden = True), # Behind illusory wall, Outrider Knight drop
        DS3LocationData("GA: Crystal Scroll (2F late, miniboss drop)", "Crystal Scroll",
                        DS3LocationCategory.UNIQUE, miniboss = True), # Crystal Sage drop
        DS3LocationData("GA: Twinkling Titanite (dark room, lizard #1)", "Twinkling Titanite",
                        DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("GA: Chaos Gem (dark room, lizard)", "Chaos Gem",
                        DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("GA: Twinkling Titanite (1F, lizard by drop)", "Twinkling Titanite",
                        DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("GA: Crystal Gem (1F, lizard by drop)", "Crystal Gem",
                        DS3LocationCategory.UPGRADE, lizard = True),
        ...
        DS3LocationData("GA: Titanite Scale (1F, drop from 2F late onto bookshelves, lizard)",
                        "Titanite Scale x2", DS3LocationCategory.UPGRADE, lizard = True,
                        hidden = True), # Hidden fall
        DS3LocationData("GA: Twinkling Titanite (rooftops, lizard #1)", "Twinkling Titanite",
                        DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("GA: Heavy Gem (rooftops, lizard)", "Heavy Gem",
                        DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("GA: Twinkling Titanite (rooftops, lizard #2)", "Twinkling Titanite",
                        DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("GA: Sharp Gem (rooftops, lizard)", "Sharp Gem",
                        DS3LocationCategory.UPGRADE, lizard = True),
        ...
        DS3LocationData("FS: Sunless Gauntlets (shop, Sirris quest, kill GA boss)",
                        "Sunless Gauntlets", DS3LocationCategory.ARMOR, missable = True, npc = True,
                        shop = True),
        DS3LocationData("FS: Sunless Leggings (shop, Sirris quest, kill GA boss)",
                        "Sunless Leggings", DS3LocationCategory.ARMOR, missable = True, npc = True,
                        shop = True),
    ],
    "Untended Graves": [
        DS3LocationData("UG: Soul of Champion Gundyr", "Soul of Champion Gundyr",
                        DS3LocationCategory.SOUL, prominent = True, boss = True),
        DS3LocationData("UG: Priestess Ring (shop)", "Priestess Ring", DS3LocationCategory.RING,
                        shop = True),
        ...
        DS3LocationData("UG: Eyes of a Fire Keeper (shrine, Irina's room)", "Eyes of a Fire Keeper",
                        DS3LocationCategory.KEY, hidden = True), # Illusory wall
        ...
        DS3LocationData("UG: Chaos Blade (environs, left of shrine)", "Chaos Blade",
                        DS3LocationCategory.WEAPON),
        DS3LocationData("UG: Hornet Ring (environs, right of main path)",
                        "Hornet Ring", DS3LocationCategory.RING, conditional = True),
        ...
        DS3LocationData("UG: Ring of Steel Protection+1 (environs, behind bell tower)",
                        "Ring of Steel Protection+1", DS3LocationCategory.RING, ngp = True),
        ...
        DS3LocationData("UG: Ember (shop)", "Ember", DS3LocationCategory.RING, shop = True,
                        missable = True),
        ...
        DS3LocationData("UG: Wolf Knight Helm (shop after killing FK boss)", "Wolf Knight Helm",
                        DS3LocationCategory.ARMOR, boss = True, shop = True, conditional = True,
                        missable = True),
        DS3LocationData("UG: Wolf Knight Armor (shop after killing FK boss)",
                        "Wolf Knight Armor", DS3LocationCategory.ARMOR, boss = True, shop = True,
                        missable = True),
        DS3LocationData("UG: Wolf Knight Gauntlets (shop after killing FK boss)",
                        "Wolf Knight Gauntlets", DS3LocationCategory.ARMOR, boss = True,
                        shop = True, missable = True),
        DS3LocationData("UG: Wolf Knight Leggings (shop after killing FK boss)",
                        "Wolf Knight Leggings", DS3LocationCategory.ARMOR, boss = True, shop = True,
                        missable = True),
    ...
    "Archdragon Peak": [
        DS3LocationData("AP: Dragon Head Stone (fort, boss drop)", "Dragon Head Stone",
                        DS3LocationCategory.UNIQUE, prominent = True, boss = True),
        ...
        DS3LocationData("AP: Dragon Tooth (belfry roof, NPC drop)", "Dragon Tooth",
                        DS3LocationCategory.WEAPON, hostile_npc = True), # Havel Knight drop
        DS3LocationData("AP: Havel's Greatshield (belfry roof, NPC drop)", "Havel's Greatshield",
                        DS3LocationCategory.SHIELD, hostile_npc = True), # Havel Knight drop
        DS3LocationData("AP: Drakeblood Greatsword (mausoleum, NPC drop)", "Drakeblood Greatsword",
                        DS3LocationCategory.WEAPON, hostile_npc = True),
        ...
        DS3LocationData("AP: Lightning Clutch Ring (intro, left of boss door)",
                        "Lightning Clutch Ring", DS3LocationCategory.RING),
        ...
        DS3LocationData("AP: Titanite Chunk (intro, archway corner)", "Titanite Chunk",
                        DS3LocationCategory.UPGRADE),
        DS3LocationData("AP: Ember (fort overlook #2)", "Ember", DS3LocationCategory.MISC),
        ...
        DS3LocationData("AP: Lightning Urn (fort, left of first room entrance)",
                        "Lightning Urn x4", DS3LocationCategory.MISC),
        ...
        DS3LocationData("AP: Dung Pie (fort, landing after second room)", "Dung Pie x3",
                        DS3LocationCategory.MISC),
        DS3LocationData("AP: Titanite Scale (mausoleum, downstairs balcony #2)",
                        "Titanite Scale", DS3LocationCategory.UPGRADE),
        ...
        DS3LocationData("AP: Thunder Stoneplate Ring (walkway, up ladder)",
                        "Thunder Stoneplate Ring", DS3LocationCategory.RING),
        DS3LocationData("AP: Titanite Scale (mausoleum, upstairs balcony)", "Titanite Scale",
                        DS3LocationCategory.UPGRADE),
        DS3LocationData("AP: Ember (belfry, below bell)", "Ember", DS3LocationCategory.MISC),
        DS3LocationData("AP: Ancient Dragon Greatshield (intro, on archway)",
                        "Ancient Dragon Greatshield", DS3LocationCategory.SHIELD),
        ...
        DS3LocationData("AP: Dragon Chaser's Ashes (summit, side path)", "Dragon Chaser's Ashes",
                        DS3LocationCategory.KEY, progression = True),
        DS3LocationData("AP: Ember (intro, by bonfire)", "Ember", DS3LocationCategory.MISC),
        ...
        DS3LocationData("AP: Twinkling Titanite (fort, down second room balcony ladder)",
                        "Twinkling Titanite x2", DS3LocationCategory.UPGRADE),
        ...
        DS3LocationData("AP: Great Magic Barrier (drop off belfry roof)", "Great Magic Barrier",
                        DS3LocationCategory.SPELL, hidden = True), # Hidden fall
        DS3LocationData("AP: Titanite Slab (plaza)", "Titanite Slab", DS3LocationCategory.UPGRADE),
        DS3LocationData("AP: Ring of Steel Protection (fort overlook, beside stairs)",
                        "Ring of Steel Protection", DS3LocationCategory.RING),
        ...
        DS3LocationData("FS: Hawkwood's Swordgrass (Andre after gesture in AP summit)",
                        "Hawkwood's Swordgrass", DS3LocationCategory.UNIQUE, conditional = True,
                        hidden = True),
        ...
        DS3LocationData("FS: Dragonscale Waistcloth (shop after killing AP boss)",
                        "Dragonscale Waistcloth", DS3LocationCategory.ARMOR, boss = True,
                        shop = True),
        DS3LocationData("FK: Twinkling Dragon Head Stone (Hawkwood drop)",
                        "Twinkling Dragon Head Stone", DS3LocationCategory.UNIQUE, missable = True,
                        npc = True), # Hawkwood (quest)
    ],
    "Kiln of the First Flame": [
        DS3LocationData("KFF: Soul of the Lords", "Soul of the Lords", DS3LocationCategory.SOUL,
                        boss = True),
        ...
        DS3LocationData("FS: Titanite Slab (shop after placing all Cinders)", "Titanite Slab",
                        DS3LocationCategory.UPGRADE, offline = '99,0:-1:9210,110000:',
                        hidden = True),
        ...
        DS3LocationData("FS: Firelink Gauntlets (shop after placing all Cinders)",
                        "Firelink Gauntlets", DS3LocationCategory.ARMOR, boss = True, shop = True),
        DS3LocationData("FS: Firelink Leggings (shop after placing all Cinders)",
                        "Firelink Leggings", DS3LocationCategory.ARMOR, boss = True, shop = True),
    ...
    # DLC
    "Painted World of Ariandel (Before Contraption)": [
        DS3LocationData("PW1: Valorheart (boss drop)", "Valorheart",
                        DS3LocationCategory.WEAPON, prominent = True, boss = True),
        DS3LocationData("PW1: Contraption Key (library, NPC drop)", "Contraption Key",
                        DS3LocationCategory.KEY, prominent = True, progression = True,
                        hostile_npc = True, key = True), # Sir Vilhelm drop
        DS3LocationData("PW1: Onyx Blade (library, NPC drop)", "Onyx Blade",
                        DS3LocationCategory.WEAPON, hostile_npc = True), # Sir Vilhelm drop
        DS3LocationData("PW1: Chillbite Ring (Friede)", "Chillbite Ring",
                        DS3LocationCategory.RING, npc = True), # Friede conversation
        ...
        DS3LocationData("PW1: Blessed Gem (snowfield, behind tower)", "Blessed Gem",
                        DS3LocationCategory.UPGRADE, hidden = True), # Hidden behind a tower
        ...
        DS3LocationData("PW1: Black Firebomb (snowfield lower, path to bridge)",
                        "Black Firebomb x2", DS3LocationCategory.MISC),
        ...
        DS3LocationData("PW1: Millwood Greatarrow (snowfield village, loop back to lower)",
                        "Millwood Greatarrow x5", DS3LocationCategory.MISC),
        DS3LocationData("PW1: Millwood Greatbow (snowfield village, loop back to lower)",
                        "Millwood Greatbow", DS3LocationCategory.WEAPON),
        ...
        DS3LocationData("PW1: Rusted Gold Coin (settlement roofs, roof near second ladder)",
                        "Rusted Gold Coin x3", DS3LocationCategory.MISC),
        ...
        DS3LocationData("PW1: Way of White Corona (settlement hall, by altar)",
                        "Way of White Corona", DS3LocationCategory.SPELL),
        ...
        DS3LocationData("PW1: Budding Green Blossom (settlement courtyard, ledge)",
                        "Budding Green Blossom x3", DS3LocationCategory.MISC),
        ...
        DS3LocationData("PW1: Follower Sabre (roots above depths)", "Follower Sabre",
                        DS3LocationCategory.WEAPON),
        DS3LocationData("PW1: Ember (roots above depths)", "Ember", DS3LocationCategory.MISC),
        DS3LocationData("PW1: Snap Freeze (depths, far end, mob drop)", "Snap Freeze",
                        DS3LocationCategory.SPELL, drop = True,
        ...
        DS3LocationData("PW1: Rime-blue Moss Clump (snowfield upper, overhang)",
                        "Rime-blue Moss Clump", DS3LocationCategory.MISC),
        ...
        DS3LocationData("PW1: Titanite Slab (depths, up secret ladder)", "Titanite Slab",
                        DS3LocationCategory.UPGRADE, offline = '11,0:50004700::',
        ...
        DS3LocationData("PW1: Large Titanite Shard (settlement loop, lizard)",
                        "Large Titanite Shard x2", DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("PW1: Champion's Bones (boss drop)", "Champion's Bones",
                        DS3LocationCategory.UNIQUE, offline = '11,0:50002310::', boss = True),
    ],
    "Painted World of Ariandel (After Contraption)": [
        ...
        DS3LocationData("PW2: Floating Chaos (Dunnel drop)", "Floating Chaos",
                        DS3LocationCategory.SPELL, hostile_npc = True,
        ...
        DS3LocationData("PW2: Large Titanite Shard (pass, just before B1)",
                        "Large Titanite Shard x2", DS3LocationCategory.UPGRADE),
        DS3LocationData("PW2: Quakestone Hammer (pass, side path near B1)", "Quakestone Hammer",
                        DS3LocationCategory.WEAPON),
        DS3LocationData("PW2: Ember (pass, central alcove)", "Ember", DS3LocationCategory.MISC),
        ...
        DS3LocationData("PW2: Large Soul of a Crestfallen Knight (pit, by tree)",
                        "Large Soul of a Crestfallen Knight", DS3LocationCategory.SOUL),
        DS3LocationData("PW2: Earth Seeker (pit cave)", "Earth Seeker", DS3LocationCategory.WEAPON),
        DS3LocationData("PW2: Follower Torch (pass, far side path)", "Follower Torch",
                        DS3LocationCategory.SHIELD),
        DS3LocationData("PW2: Dung Pie (B1)", "Dung Pie x2", DS3LocationCategory.MISC),
        ...
        DS3LocationData("PW2: Pyromancer's Parting Flame (rotunda)",
                        "Pyromancer's Parting Flame", DS3LocationCategory.WEAPON,
                        hidden = True), # Behind illusory wall
        ...
        DS3LocationData("PW2: Twinkling Titanite (B3, lizard #2)", "Twinkling Titanite",
                        DS3LocationCategory.UPGRADE, lizard = True),
        DS3LocationData("PW2: Blood Gem (B2, center)", "Blood Gem", DS3LocationCategory.UPGRADE,
        ...
        DS3LocationData("PW1: Titanite Slab (Corvian)", "Titanite Slab",
                        DS3LocationCategory.UPGRADE, missable = True,
                        npc = True),
    ...
    "Dreg Heap": [
        DS3LocationData("DH: Soul of the Demon Prince", "Soul of the Demon Prince",
                        DS3LocationCategory.SOUL, prominent = True, boss = True),
        DS3LocationData("DH: Siegbräu (Lapp)", "Siegbräu", DS3LocationCategory.MISC,
        ...
        DS3LocationData("DH: Ember (castle, behind spire)", "Ember", DS3LocationCategory.MISC),
        ...
        DS3LocationData("DH: Ring of Steel Protection+3 (ledge before church)",
                        "Ring of Steel Protection+3", DS3LocationCategory.RING),
        ...
        DS3LocationData("DH: Ember (pantry, behind crates just before upstairs)", "Ember",
                        DS3LocationCategory.MISC, hidden = True), # Behind illusory wall
        ...
        DS3LocationData("DH: Covetous Silver Serpent Ring+3 (pantry upstairs, drop down)",
                        "Covetous Silver Serpent Ring+3", DS3LocationCategory.RING,
                        hidden = True), # Behind illusory wall
        ...
        DS3LocationData("DH: Desert Pyromancer Garb (ruins, by shack near cliff)",
                        "Desert Pyromancer Garb", DS3LocationCategory.ARMOR),
        DS3LocationData("DH: Titanite Chunk (ruins, by far shack)", "Titanite Chunk x2",
                        DS3LocationCategory.UPGRADE),
        DS3LocationData("DH: Giant Door Shield (ruins, path below far shack)",
                        "Giant Door Shield", DS3LocationCategory.SHIELD),
        DS3LocationData("DH: Ember (ruins, alcove before swamp)", "Ember",
                        DS3LocationCategory.MISC),
        DS3LocationData("DH: Desert Pyromancer Gloves (swamp, far right)",
                        "Desert Pyromancer Gloves", DS3LocationCategory.ARMOR),
        DS3LocationData("DH: Desert Pyromancer Skirt (swamp right, by roots)",
                        "Desert Pyromancer Skirt", DS3LocationCategory.ARMOR),
        ...
        DS3LocationData("DH: Harald Curved Greatsword (swamp left, under root)",
                        "Harald Curved Greatsword", DS3LocationCategory.WEAPON),
        ...
        DS3LocationData("DH: Desert Pyromancer Hood (swamp upper, tunnel end)",
                        "Desert Pyromancer Hood", DS3LocationCategory.ARMOR),
        DS3LocationData("DH: Twinkling Titanite (swamp upper, drop onto root)",
                        "Twinkling Titanite", DS3LocationCategory.UPGRADE,
                        hidden = True), # Hidden fall
        DS3LocationData("DH: Divine Blessing (swamp upper, building roof)", "Divine Blessing",
                        DS3LocationCategory.MISC),
        DS3LocationData("DH: Ember (ruins, alcove on cliff)", "Ember", DS3LocationCategory.MISC,
                        hidden = True), # Hidden fall
        DS3LocationData("DH: Small Envoy Banner (boss drop)", "Small Envoy Banner",
                        DS3LocationCategory.KEY, progression = True, boss = True),
        DS3LocationData("DH: Twinkling Titanite (ruins, alcove on cliff, mob drop)",
                        "Twinkling Titanite x2", DS3LocationCategory.UPGRADE, drop = True,
        ...
        DS3LocationData("DH: Splitleaf Greatsword (shop)", "Splitleaf Greatsword",
                        DS3LocationCategory.WEAPON, shop = True),
        DS3LocationData("DH: Divine Blessing (shop)", "Divine Blessing", DS3LocationCategory.MISC,
                        shop = True),
        DS3LocationData("DH: Hidden Blessing (shop)", "Hidden Blessing", DS3LocationCategory.MISC,
                        shop = True),
        DS3LocationData("DH: Rusted Gold Coin (shop)", "Rusted Gold Coin", DS3LocationCategory.MISC,
                        shop = True),
        DS3LocationData("DH: Ember (shop)", "Ember", DS3LocationCategory.MISC, shop = True),
    ],
    "Ringed City": [
        DS3LocationData("RC: Titanite Slab (mid boss drop)", "Titanite Slab",
                        DS3LocationCategory.UPGRADE, prominent = True,
                        boss = True), # Halflight drop, only once
        DS3LocationData("RC: Filianore's Spear Ornament (mid boss drop)",
                        "Filianore's Spear Ornament", DS3LocationCategory.MISC),
        DS3LocationData("RC: Soul of Darkeater Midir", "Soul of Darkeater Midir",
                        DS3LocationCategory.SOUL, prominent = True, boss = True),
        DS3LocationData("RC: Sacred Chime of Filianore (ashes, NPC drop)",
                        "Sacred Chime of Filianore", DS3LocationCategory.WEAPON,
                        hostile_npc = True), # Shira (kill or quest)
        DS3LocationData("RC: Titanite Slab (ashes, NPC drop)", "Titanite Slab",
                        DS3LocationCategory.UPGRADE, hostile_npc = True), # Shira (kill or quest)
        DS3LocationData("RC: Crucifix of the Mad King (ashes, NPC drop)",
                        "Crucifix of the Mad King", DS3LocationCategory.WEAPON,
                        hostile_npc = True), # Shira drop
        DS3LocationData("RC: Ledo's Great Hammer (streets high, opposite building, NPC drop)",
                        "Ledo's Great Hammer", DS3LocationCategory.WEAPON,
                        hostile_npc = True), # Silver Knight Ledo drop
        DS3LocationData("RC: Wolf Ring+3 (street gardens, NPC drop)", "Wolf Ring+3", DS3LocationCategory.RING,
                        hostile_npc = True), # Alva drop
        DS3LocationData("RC: Blindfold Mask (grave, NPC drop)", "Blindfold Mask",
                        DS3LocationCategory.ARMOR, hostile_npc = True), # Moaning Knight drop
        ...
        DS3LocationData("RC: Budding Green Blossom (wall top, in flower cluster)",
                        "Budding Green Blossom x2", DS3LocationCategory.MISC),
        DS3LocationData("RC: Titanite Chunk (wall top, among graves)", "Titanite Chunk x2",
                        DS3LocationCategory.MISC),
        DS3LocationData("RC: Ember (wall top, by statue)", "Ember", DS3LocationCategory.MISC),
        ...
        DS3LocationData("RC: Large Soul of a Weary Warrior (wall top, right of small tomb)",
                        "Large Soul of a Weary Warrior", DS3LocationCategory.SOUL),
        DS3LocationData("RC: Ember (wall upper, balcony)", "Ember", DS3LocationCategory.MISC),
        ...
        DS3LocationData("RC: Shira's Gloves (Shira's room after killing ashes NPC)",
                        "Shira's Gloves", DS3LocationCategory.ARMOR,
                        hidden = True), # Have to return to a cleared area
        DS3LocationData("RC: Shira's Trousers (Shira's room after killing ashes NPC)",
                        "Shira's Trousers", DS3LocationCategory.ARMOR,
                        hidden = True), # Have to return to a cleared area
        ...
        DS3LocationData("RC: Ringed Knight Spear (streets, down far right hall)",
                        "Ringed Knight Spear", DS3LocationCategory.WEAPON),
        DS3LocationData("RC: Black Witch Hat (streets garden)", "Black Witch Hat",
                        DS3LocationCategory.ARMOR, hostile_npc = True), # Alva
        ...
        DS3LocationData("RC: Dragonhead Shield (streets monument, across bridge)",
                        "Dragonhead Shield", DS3LocationCategory.SHIELD,
        ...
        DS3LocationData("RC: Large Soul of a Crestfallen Knight (streets monument, across bridge)",
                        "Large Soul of a Crestfallen Knight", DS3LocationCategory.MISC,
                        hidden = True), # "Show Your Humanity" puzzle
        DS3LocationData("RC: Covetous Gold Serpent Ring+3 (streets, by Lapp)",
                        "Covetous Gold Serpent Ring+3", DS3LocationCategory.RING),
        ...
        DS3LocationData("RC: Ringed Knight Straight Sword (swamp near, pillar by bonfire)",
                        "Ringed Knight Straight Sword", DS3LocationCategory.WEAPON),
        DS3LocationData("RC: Havel's Ring+3 (streets high, drop from building opposite)",
                        "Havel's Ring+3", DS3LocationCategory.RING, hidden = True), # Hidden fall
        ...
        DS3LocationData("RC: Preacher's Right Arm (swamp near right, by crystal)",
                        "Preacher's Right Arm", DS3LocationCategory.WEAPON),
        DS3LocationData("RC: Rubbish (swamp far, by crystal)", "Rubbish", DS3LocationCategory.MISC),
        ...
        DS3LocationData("RC: Black Witch Veil (swamp near right, by sinking church)",
                        "Black Witch Veil", DS3LocationCategory.ARMOR),
        ...
        DS3LocationData("RC: White Preacher Head (swamp near, ground near bonfire exit)",
                        "White Preacher Head", DS3LocationCategory.ARMOR),
        ...
        DS3LocationData("RC: Dragonhead Greatshield (upper cluff, under bridge)",
                        "Dragonhead Greatshield", DS3LocationCategory.SHIELD),
        DS3LocationData("RC: Titanite Scale (upper cliff, first alcove)", "Titanite Scale x2",
                        DS3LocationCategory.UPGRADE),
        DS3LocationData("RC: Rubbish (upper cliff, middle)", "Rubbish", DS3LocationCategory.MISC),
        ...
        DS3LocationData("RC: Large Soul of a Weary Warrior (wall lower, past two illusory walls)",
                        "Large Soul of a Weary Warrior", DS3LocationCategory.SOUL, hidden = True),
        DS3LocationData("RC: Lightning Arrow (wall lower, past three illusory walls)",
                        "Lightning Arrow", DS3LocationCategory.SPELL),
        DS3LocationData("RC: Chloranthy Ring+3 (wall hidden, drop onto statue)",
                        "Chloranthy Ring+3", DS3LocationCategory.RING,
                        hidden = True), # Hidden fall
        DS3LocationData("RC: Ember (wall hidden, statue room)", "Ember", DS3LocationCategory.MISC),
        ...
        DS3LocationData("RC: Antiquated Plain Garb (wall hidden, before boss)",
                        "Antiquated Plain Garb", DS3LocationCategory.ARMOR),
        ...
        DS3LocationData("RC: Young White Branch (swamp far left, by white tree)",
                        "Young White Branch", DS3LocationCategory.MISC),
        DS3LocationData("RC: Young White Branch (swamp far left, by white tree)",
                        "Young White Branch", DS3LocationCategory.MISC),
        DS3LocationData("RC: Young White Branch (swamp far left, by white tree)",
                        "Young White Branch", DS3LocationCategory.MISC),
        DS3LocationData("RC: Ringed Knight Paired Greatswords (church path, mob drop)",
                        "Ringed Knight Paired Greatswords", DS3LocationCategory.WEAPON, drop = True,
        ...
        DS3LocationData("RC: Hidden Blessing (swamp center, mob drop)", "Hidden Blessing",
                        DS3LocationCategory.MISC, drop = True,
                        hidden = True), # Guaranteed drop from Judicator
        ...
        # Lapp 
        DS3LocationData("RC: Siegbräu (Lapp)", "Siegbräu", DS3LocationCategory.MISC,
                        missable = True, npc = True), # Lapp (quest)
        # Quest or Shrine Handmaiden after death
        DS3LocationData("RC: Lapp's Helm (Lapp)", "Lapp's Helm", DS3LocationCategory.ARMOR,
                        npc = True, shop = True),
        DS3LocationData("RC: Lapp's Armor (Lapp)", "Lapp's Armor", DS3LocationCategory.ARMOR,
                        npc = True, shop = True),
        DS3LocationData("RC: Lapp's Gauntlets (Lapp)", "Lapp's Gauntlets",
                        DS3LocationCategory.ARMOR, npc = True, shop = True),
        DS3LocationData("RC: Lapp's Leggings (Lapp)", "Lapp's Leggings", DS3LocationCategory.ARMOR,
                        npc = True, shop = True),
    ],
    ...
    "Greirat's Shop": [
        DS3LocationData("FS: Blue Tearstone Ring (Greirat)", "Blue Tearstone Ring",
                        DS3LocationCategory.RING, offline = '01,0:50006120::', npc = True),
        DS3LocationData("FS: Ember (Greirat)", "Ember", DS3LocationCategory.MISC,
        ...
        DS3LocationData("FS: Divine Blessing (Greirat from US)", "Divine Blessing",
                        ...
                        shop = True, npc = True),
        DS3LocationData("FS: Ember (Greirat from US)", "Ember", DS3LocationCategory.MISC,
                        offline = '99,0:-1:110000,120000,70000150,70000175:', missable = True,
                        shop = True, npc = True),
    ...
    "Karla's Shop": [
        DS3LocationData("FS: Affinity (Karla)", "Affinity", DS3LocationCategory.SPELL,
                        shop = True, npc = True),
        DS3LocationData("FS: Dark Edge (Karla)", "Dark Edge", DS3LocationCategory.SPELL,
                        shop = True, npc = True),

        # Quelana Pyromancy Tome
        DS3LocationData("FS: Firestorm (Karla for Quelana Tome)", "Firestorm",
                        DS3LocationCategory.SPELL, missable = True, shop = True, npc = True),
        ...
        DS3LocationData("FS: Gnaw (Karla for Deep Braille Tome)", "Gnaw", DS3LocationCategory.SPELL,
                        missable = True, npc = True, shop = True),
        ...
        DS3LocationData("FS: Karla's Pointed Hat (kill Karla)", "Karla's Pointed Hat",
                        DS3LocationCategory.ARMOR, offline = '07,0:50006150::', missable = True,
                        drop = True, npc = True),
        DS3LocationData("FS: Karla's Coat (kill Karla)", "Karla's Coat", DS3LocationCategory.ARMOR,
