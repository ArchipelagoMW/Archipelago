...
location_tables = {
    ...
    "High Wall of Lothric": [
        ...
        DS3LocationData("HWL: Cell Key (fort basement, down stairs)", "Cell Key"),
        ...
        DS3LocationData("HWL: Titanite Shard (fort basement, behind crates)", "Titanite Shard",
                        hidden = True),
        DS3LocationData("HWL: Rapier (fountain, corner)", "Rapier"),
        DS3LocationData("HWL: Titanite Shard (for, room off entry)", "Titanite Shard"),
        ...
        DS3LocationData("HWL: Soul of a Deserted Corpse (path to back tower, by lift door)",
                        "Soul of a Deserted Corpse"),
        DS3LocationData("HWL: Green Blossom (shortcut, by lower lift door)", "Green Blossom x3"),
        DS3LocationData("HWL: Broadsword (fort, room off entry)", "Broadsword"),
        ...
        DS3LocationData("HWL: Soul of a Deserted Corpse (wall tower, right of exit)",
                        "Soul of a Deserted Corpse"),
        DS3LocationData("HWL: Estus Shard (fort basement, on anvil)", "Estus Shard"),
        DS3LocationData("HWL: Fleshbite Ring+1 (fort roof, jump to other roof)",
                        "Fleshbite Ring+1", ngp = True, hidden = True), # Hidden jump
        DS3LocationData("HWL: Ring of the Evil Eye+2 (fort basement, far wall)",
        ...
        DS3LocationData("HWL: Titanite Shard (fort roof, transforming hollow)", "Titanite Shard",
                        hidden = True),
        DS3LocationData("HWL: Ember (back tower roof bonfire, transforming hollow)", "Ember",
                        hidden = True),
        DS3LocationData("HWL: Titanite Shard (back tower roof bonfire, transforming hollow)",
                        "Titanite Shard", hidden = True),
    ...
    "Irithyll of the Boreal Valley": [
        ...
        DS3LocationData("IBV: Rusted Gold Coin (Distant Manor, down stairs)", "Rusted Gold Coin"),
    ...
    "Irithyll Dungeon": [
        ...
        DS3LocationData("ID: Murakumo (Alva drop)", "Murakumo", missable = True,
                        hostile_npc = True),
        DS3LocationData("ID: Large Titanite Shard (B1 near, just past bonfire)",
                        "Large Titanite Shard"),
        ...
        DS3LocationData("ID: Large Titanite Shard (pit)", "Large Titanite Shard"),
        ...
        DS3LocationData("ID: Rusted Coin (B1 near, just past bonfire)", "Rusted Coin"),
        ...
        DS3LocationData("ID: Xanthous Ashes (B3 far, right cell)", "Xanthous Ashes",
                        progression = True),
        DS3LocationData("ID: Rusted Gold Coin (B1 near, end of hall by door)", "Rusted Gold Coin"),
        DS3LocationData("ID: Large Titanite Shard (stairs between pit and B3)",
                        "Large Titanite Shard"),
    ...
    "Ringed City": [
        ...
        DS3LocationData("RC: Titanite Scale (wall top, behind spawn)", "Titanite Scale"),
        ...
        DS3LocationData("RC: Prism Stone (swamp near, path to bonfire)", "Prism Stone x4"),
        DS3LocationData("RC: Ringed Knight Straight Sword (swamp near, pillar by bonfire)",
        ...
        DS3LocationData("RC: Titanite Chunk (swamp near left, opposite ladder)", "Titanite Chunk"),
        ...
        DS3LocationData("RC: Preacher's Right Arm (swamp near right, by crystal)",
                        "Preacher's Right Arm"),
        DS3LocationData("RC: Rubbish (swamp far, by crystal)", "Rubbish"),
        DS3LocationData("RC: Titanite Chunk (swamp near right, by sinking church)",
                        "Titanite Chunk"),
        DS3LocationData("RC: Black Witch Veil (swamp near right, by sinking church)",
                        "Black Witch Veil"),
        DS3LocationData("RC: Twinkling Titanite (swamp near right, on sinking church)",
                        "Twinkling Titanite"),
        DS3LocationData("RC: Soul of a Crestfallen Knight (swamp near left, by ladder)",
                        "Soul of a Crestfallen Knight"),
        ...
        DS3LocationData("RC: Large Soul of a Weary Warrior (upper cliff, end)",
                        "Large Soul of a Weary Warrior"),
        DS3LocationData("RC: Titanite Scale (upper cliff, lower path)", "Titanite Scale x2"),
        DS3LocationData("RC: Titanite Scale (lower cliff, bridge)", "Titanite Scale"),
        ...
        DS3LocationData("RC: Soul of a Weary Warrior (upper cliff, by first alcove)",
                        "Soul of a Weary Warrior"),
        ...
        DS3LocationData("RC: Titanite Chunk (swamp center, along edge)", "Titanite Chunk"),
        DS3LocationData("RC: Large Soul of a Weary Warrior (swamp center)",
                        "Large Soul of a Weary Warrior"),
        ...
        DS3LocationData("RC: Young White Branch (swamp far left, by white tree)",
                        "Young White Branch"),
        DS3LocationData("RC: Young White Branch (swamp far left, by white tree)",
                        "Young White Branch"),
        DS3LocationData("RC: Young White Branch (swamp far left, by white tree)",
        ...
        DS3LocationData("RC: Titanite Scale (grave, lizard after first drop)", "Titanite Scale",
                        lizard = True),
        DS3LocationData("RC: Twinkling Titanite (grave, lizard after first drop)",
                        "Twinkling Titanite", lizard = True),
        DS3LocationData("RC: Titanite Scale (wall lower, lizard)", "Titanite Scale x2",
                        lizard = True),
        DS3LocationData("RC: Twinkling Titanite (streets high, lizard)", "Twinkling Titanite x2",
                        lizard = True),
        DS3LocationData("RC: Titanite Scale (wall top, lizard on side path)", "Titanite Scale",
                        lizard = True),
