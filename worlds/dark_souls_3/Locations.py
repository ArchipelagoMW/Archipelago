...
location_tables = {
    ...
    "High Wall of Lothric": [
        ...
        DS3LocationData("HWL: Way of Blue Covenant",               "Way of Blue",                       DS3LocationCategory.MISC),
    ...
    "Undead Settlement": [
        ...
        DS3LocationData("US: Mortician's Ashes",                   "Mortician's Ashes",                 DS3LocationCategory.MISC),
        ...
        DS3LocationData("US: Warrior of Sunlight Covenant",        "Warrior of Sunlight",               DS3LocationCategory.MISC),
    ...
    "Cathedral of the Deep": [
        ...
        DS3LocationData("CD: Rosaria's Fingers Covenant",          "Rosaria's Fingers",                 DS3LocationCategory.MISC)
    ],
    "Farron Keep": [
        ...
        DS3LocationData("FK: Watchdogs of Farron Covenant",        "Watchdogs of Farron",               DS3LocationCategory.MISC),
    ],
    "Catacombs of Carthus": [
    ...
    "Irithyll of the Boreal Valley": [
        ...
        DS3LocationData("IBV: Aldrich Faithful Covenant",          "Aldrich Faithful",                  DS3LocationCategory.MISC),
    ...
    "Irithyll Dungeon": [
        ...
        DS3LocationData("ID: Prisoner Chief's Ashes",              "Prisoner Chief's Ashes",            DS3LocationCategory.MISC),
    ...
    "Painted World of Ariandel": [
        ...
        DS3LocationData("PW: Captains Ashes",                      "Captain's Ashes",                         DS3LocationCategory.MISC),
        ...
        DS3LocationData("PW: Champions Bones",                     "Champion's Bones",                        DS3LocationCategory.MISC),
