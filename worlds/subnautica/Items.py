...
item_table: Dict[int, ItemDict] = {
    ...
    35007: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Stillsuit',
    ...
    35018: {'classification': ItemClassification.Philler,
            'count': 2,
    ...
    35023: {'classification': ItemClassification.Philler,
            'count': 2,
    ...
    35025: {'classification': ItemClassification.Philler,
            'count': 2,
    ...
    35031: {'classification': ItemClassification.Philler,
            'count': 1,
    ...
    35046: {'classification': ItemClassification.Philler,
            'count': 2,
            'name': 'Exterior Growbed',
            'tech_type': 'FarmingTray'},
    35047: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Picture Frame',
            'tech_type': 'PictureFrameFragment'},
    35048: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Bench',
            'tech_type': 'Bench'},
    35049: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Basic Plant Pot',
            'tech_type': 'PlanterPotFragment'},
    35050: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Interior Growbed',
            'tech_type': 'PlanterBoxFragment'},
    35051: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Plant Shelf',
            'tech_type': 'PlanterShelfFragment'},
    35052: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Observatory',
    ...
    35055: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Spotlight',
            'tech_type': 'Spotlight'},
    35056: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Desk',
            'tech_type': 'StarshipDesk'},
    35057: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Swivel Chair',
            'tech_type': 'StarshipChair'},
    35058: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Office Chair',
            'tech_type': 'StarshipChair2'},
    35059: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Command Chair',
            'tech_type': 'StarshipChair3'},
    35060: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Counter',
            'tech_type': 'LabCounter'},
    35061: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Single Bed',
            'tech_type': 'NarrowBed'},
    35062: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Basic Double Bed',
            'tech_type': 'Bed1'},
    35063: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Quilted Double Bed',
            'tech_type': 'Bed2'},
    35064: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Coffee Vending Machine',
            'tech_type': 'CoffeeVendingMachine'},
    35065: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Trash Can',
            'tech_type': 'Trashcans'},
    35066: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Floodlight',
            'tech_type': 'Techlight'},
    35067: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Bar Table',
            'tech_type': 'BarTable'},
    35068: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Vending Machine',
            'tech_type': 'VendingMachine'},
    35069: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Single Wall Shelf',
            'tech_type': 'SingleWallShelf'},
    35070: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Wall Shelves',
            'tech_type': 'WallShelves'},
    35071: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Round Plant Pot',
            'tech_type': 'PlanterPot2'},
    35072: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Chic Plant Pot',
            'tech_type': 'PlanterPot3'},
    35073: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Nuclear Waste Disposal',
            'tech_type': 'LabTrashcan'},
    35074: {'classification': ItemClassification.Philler,
            'count': 1,
            'name': 'Wall Planter',
    ...
    35080: {'classification': ItemClassification.Philler,
            'count': 1,
    ...
    35083: {'classification': ItemClassification.Philler,
            'count': 0,
            'name': 'Large Room Glass Dome',
            'tech_type': 'BaseLargeGlassDome'},
    35084: {'classification': ItemClassification.Philler,
            'count': 0,
            'name': 'Multipurpose Room Glass Dome',
            'tech_type': 'BaseGlassDome'},
    35085: {'classification': ItemClassification.Philler,
            'count': 0,
            'name': 'Partition',
            'tech_type': 'BasePartition'},
    35086: {'classification': ItemClassification.Philler,
            'count': 0,
            'name': 'Partition Door',
