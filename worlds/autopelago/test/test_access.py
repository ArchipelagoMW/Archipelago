...
class AccessTest(WorldTestBase):
    ...
    def assertAndCollectAdditionalRatsFromHere(self, location: str, rat_count: int, collect=True):
        assert rat_count >= 5, 'The game only requires increments of 5 or more'
        self.collectRats(rat_count - 5)
        self.assertFalse(self.can_reach_location(location))
    ...
    def testTopBranches(self) -> None:
        ...
        self.assertAndCollectAdditionalRatsFromHere('Bowling Ball Door', 14)
        ...
        # self.assertAndCollectAdditionalRatsFromHere('Broken-Down Bus', 0)
        self.assertAndCollectAccessDependencyFromHere('Copyright Mouse', 'Fake Mouse Ears', 'Legally Binding Contract')
        # self.assertAndCollectAdditionalRatsFromHere('Room Full of Typewriters', 0, collect=False)
        ...
        # self.assertAndCollectAdditionalRatsFromHere('Stalled Rocket! (Get Out and Push)', 0)
        self.assertAndCollectAccessDependencyFromHere('Seal of Fortune', 'Constellation Prize', 'Free Vowel')
        # self.assertAndCollectAdditionalRatsFromHere('Space Opera', 0)
    ...
    def testBottomBranches(self) -> None:
        ...
        self.assertAndCollectAdditionalRatsFromHere('Bowling Ball Door', 13)
        self.assertAndCollectAccessDependencyFromHere('Captured Goldfish', 'Giant Novelty Scissors')
        ...
        # self.assertAndCollectAdditionalRatsFromHere('Overweight Boulder', 0)
        ...
        self.assertAndCollectAccessDependencyFromHere('Makeshift Rocket Ship', *all_pairwise_combinations(
            ...
            'Ratstronaut', 'Turbo Encabulator'))
        self.assertAndCollectAccessDependencyFromHere('Robo-Clop: The Robot War Horse', 'Quantum Sugar Cube')
        # self.assertAndCollectAdditionalRatsFromHere('Stalled Rocket! (Get Out and Push)', 0, collect=False)
        ...
        # self.assertAndCollectAdditionalRatsFromHere('Space Opera', 0, collect=False)
