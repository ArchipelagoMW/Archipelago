...
all_region_connections: Dict[str, RegionConnection] = {
    ...
    "0a_0_mian---0a_0_east": RegionConnection("0a_0_main", "0a_0_east"),
    "0a_0_west---0a_0_main": RegionConnection("0a_0_west", "0a_0_main"),
    "0a_0_main---0a_0_west": RegionConnection("0a_0_main", "0a_0_west"),
    "0a_0_top---0a_0_main": RegionConnection("0a_0_top", "0a_0_main"),
    "0a_0_main---0a_0_top": RegionConnection("0a_0_main", "0a_0_top"),

    "0a_1_east---0a_1_main": RegionConnection("0a_1_east", "0a_1_main"),
    "0a_1_mian---0a_1_east": RegionConnection("0a_1_main", "0a_1_east"),
    ...
    "0a_2_mian---0a_2_east": RegionConnection("0a_2_main", "0a_2_east"),
    ...
    "0a_3_mian---0a_3_east": RegionConnection("0a_3_main", "0a_3_east"),
...
all_regions: Dict[str, PreRegion] = {
    ...
    "0a_0_top": PreRegion("0a_0_top", "0a_0", [reg_con for _, reg_con in all_region_connections.items() if reg_con.source_name == "0a_0_top"], [loc for _, loc in all_locations.items() if loc.region_name == "0a_0_top"]),
    ...
    "0a_0b_main": PreRegion("0a_0b_main", "0a_0b", [reg_con for _, reg_con in all_region_connections.items() if reg_con.source_name == "0a_0b_main"], [loc for _, loc in all_locations.items() if loc.region_name == "0a_0b_main"]),
...
all_room_connections: Dict[str, RoomConnection] = {
    ...
    "0a_0---0a_-1": RoomConnection("0a", all_doors["0a_0_west"], all_doors["0a_-1_east"]),
    "0a_0---0a_0b": RoomConnection("0a", all_doors["0a_0_north"], all_doors["0a_0b_south"]),
    "0a_0b---0a_0": RoomConnection("0a", all_doors["0a_0b_south"], all_doors["0a_0_north"]),
    "0a_0---0a_1": RoomConnection("0a", all_doors["0a_0_east"], all_doors["0a_1_west"]),
    "0a_1---0a_0": RoomConnection("0a", all_doors["0a_1_west"], all_doors["0a_0_east"]),
    "0a_1---0a_2": RoomConnection("0a", all_doors["0a_1_east"], all_doors["0a_2_west"]),
    "0a_2---0a_1": RoomConnection("0a", all_doors["0a_2_west"], all_doors["0a_1_east"]),
    "0a_2---0a_3": RoomConnection("0a", all_doors["0a_2_east"], all_doors["0a_3_west"]),
    "0a_3---0a_2": RoomConnection("0a", all_doors["0a_3_west"], all_doors["0a_2_east"]),
...
all_rooms: Dict[str, Room] = {
    ...
    "0a_0": Room("0a", "0a_0", "Prologue - Room 0", [reg for _, reg in all_regions.items() if reg.room_name == "0a_0"], [door for _, door in all_doors.items() if door.room_name == "0a_0"]),
