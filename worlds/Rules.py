...
def set_easy_rules(world: "YIWorld") -> None:
    ...
    set_rule(world.multiworld.get_location("Make Eggs, Throw Eggs: Level Clear", player), lambda state: state.has_all({'Beanstalk'}, player))
    ...
    set_rule(world.multiworld.get_location("Watch Out Below!: Stars", player), lambda state: state.has_all({'Large Spring Ball'}, player) and logic.has_midring(state))
    set_rule(world.multiworld.get_location("Watch Out Below!: Level Clear", player), lambda state: state.has_all({'Large Spring Ball'}, player))

    set_rule(world.multiworld.get_location("The Cave Of Chomp Rock: Red Coins", player), lambda state: state.has_all({'Chomp Rock'}, player))
    set_rule(world.multiworld.get_location("The Cave Of Chomp Rock: Flowers", player), lambda state: state.has_all({'Chomp Rock'}, player))

    set_rule(world.multiworld.get_location("Burt The Bashful's Fort: Red Coins", player), lambda state: state.has_all({'Spring Ball'}, player))
    ...
    set_rule(world.multiworld.get_location("Burt The Bashful's Fort: Stars", player), lambda state: state.has_all({'Spring Ball'}, player) and (logic.has_midring(state) or state.has('Key', player)))
    ...
    set_rule(world.multiworld.get_location("Shy-Guys On Stilts: Flowers", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    ...
    set_rule(world.multiworld.get_location("Salvo The Slime's Castle: Red Coins", player), lambda state: state.has_all({'Platform Ghost'}, player))
    set_rule(world.multiworld.get_location("Salvo The Slime's Castle: Flowers", player), lambda state: state.has_all({'Platform Ghost'}, player))
    ...
    set_rule(world.multiworld.get_location("What's Gusty Taste Like?: Red Coins", player), lambda state: state.has_all({'! Switch'}, player))
    ...
    set_rule(world.multiworld.get_location("Watch Out For Lakitu: Red Coins", player), lambda state: state.has_all({'Chomp Rock'}, player))
    ...
    set_rule(world.multiworld.get_location("Watch Out For Lakitu: Level Clear", player), lambda state: state.has_all({'Chomp Rock'}, player))

    set_rule(world.multiworld.get_location("The Cave Of The Mystery Maze: Red Coins", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    ...
    set_rule(world.multiworld.get_location("The Cave Of The Mystery Maze: Stars", player), lambda state: state.has_all({'Large Spring Ball'}, player) and logic.has_midring(state))
    set_rule(world.multiworld.get_location("The Cave Of The Mystery Maze: Level Clear", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    ...
    set_rule(world.multiworld.get_location("Lakitu's Wall: Stars", player), lambda state: state.has_all({'Giant Eggs'}, player) and logic.has_midring(state))
    ...
    set_rule(world.multiworld.get_location("Prince Froggy's Fort: Red Coins", player), lambda state: state.has_all({'Submarine Morph'}, player))
    ...
    set_rule(world.multiworld.get_location("Jammin' Through The Trees: Flowers", player), lambda state: state.has_all({'Watermelon'}, player) or logic.melon_item(state))
    set_rule(world.multiworld.get_location("Jammin' Through The Trees: Stars", player), lambda state: ((logic.has_midring(state) or state.has_all({'Tulip'}, player)) and logic.cansee_clouds(state)) or logic.has_midring(state) and state.has_all({'Tulip'}, player))
    ...
    set_rule(world.multiworld.get_location("Monkeys' Favorite Lake: Stars", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    set_rule(world.multiworld.get_location("Monkeys' Favorite Lake: Level Clear", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    ...
    set_rule(world.multiworld.get_location("The Cave Of The Lakitus: Level Clear", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    ...
    set_rule(world.multiworld.get_location("Don't Look Back!: Level Clear", player), lambda state: state.has_all({'! Switch'}, player))
    ...
    set_rule(world.multiworld.get_location("Marching Milde's Fort: Stars", player), lambda state: state.has_all({'Dashed Stairs'}, player) and (logic.has_midring(state) or state.has('Vanishing Arrow Wheel', player) or logic.cansee_clouds(state)))
    ...
    set_rule(world.multiworld.get_location("Lake Shore Paradise: Stars", player), lambda state: (logic.has_midring(state) or (state.has_all({'Tulip'}, player) and logic.cansee_clouds(state))) and (state.has('Egg Plant', player) or logic.combat_item(state)))
    ...
    set_rule(world.multiworld.get_location("Ride Like The Wind: Red Coins", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    set_rule(world.multiworld.get_location("Ride Like The Wind: Flowers", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    ...
    set_rule(world.multiworld.get_location("Ride Like The Wind: Level Clear", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    ...
    set_rule(world.multiworld.get_location("Scary Skeleton Goonies!: Stars", player), lambda state: state.has_all({'Dashed Platform'}, player) and logic.has_midring(state))
    ...
    set_rule(world.multiworld.get_location("The Cave Of The Bandits: Red Coins", player), lambda state: state.has_all({'Super Star'}, player))
    set_rule(world.multiworld.get_location("The Cave Of The Bandits: Flowers", player), lambda state: state.has_all({'Super Star'}, player))
    ...
    set_rule(world.multiworld.get_location("The Cave Of The Bandits: Level Clear", player), lambda state: state.has_all({'Super Star'}, player))
    ...
    set_rule(world.multiworld.get_location("The Very Loooooong Cave: Red Coins", player), lambda state: state.has_all({'Chomp Rock'}, player) and (state.has('Egg Capacity Upgrade', player, 3) or logic.combat_item(state)))
    set_rule(world.multiworld.get_location("The Very Loooooong Cave: Flowers", player), lambda state: state.has_all({'Chomp Rock'}, player) and (state.has('Egg Capacity Upgrade', player, 3) or logic.combat_item(state)))
    set_rule(world.multiworld.get_location("The Very Loooooong Cave: Stars", player), lambda state: state.has_all({'Chomp Rock'}, player) and (state.has('Egg Capacity Upgrade', player, 3) or logic.combat_item(state)) and logic.has_midring(state))
    ...
    set_rule(world.multiworld.get_location("KEEP MOVING!!!!: Flowers", player), lambda state: state.has_all({'Egg Plant'}, player))
...
def set_easy_extra_rules(world: "YIWorld", player: int, logic: YoshiLogic) -> None:
    ...
    set_rule(world.multiworld.get_location("Kamek's Revenge: Stars", player), lambda state: state.has_all({'! Switch'}, player) and logic.has_midring(state))
...
def set_normal_rules(world: "YIWorld") -> None:
    ...
    set_rule(world.multiworld.get_location("Burt The Bashful's Fort: Red Coins", player), lambda state: state.has_all({'Spring Ball'}, player))
    set_rule(world.multiworld.get_location("Burt The Bashful's Fort: Flowers", player), lambda state: state.has_all({'Spring Ball', 'Key'}, player) and (state.has('Egg Capacity Upgrade', player, 3) or logic.combat_item(state)))
    set_rule(world.multiworld.get_location("Burt The Bashful's Fort: Stars", player), lambda state: state.has_all({'Spring Ball'}, player))
    ...
    set_rule(world.multiworld.get_location("The Cave Of The Mystery Maze: Red Coins", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    set_rule(world.multiworld.get_location("The Cave Of The Mystery Maze: Flowers", player), lambda state: state.has_all({'Large Spring Ball', 'Egg Launcher'}, player))
    set_rule(world.multiworld.get_location("The Cave Of The Mystery Maze: Stars", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    set_rule(world.multiworld.get_location("The Cave Of The Mystery Maze: Level Clear", player), lambda state: state.has_all({'Large Spring Ball'}, player))

    set_rule(world.multiworld.get_location("Lakitu's Wall: Flowers", player), lambda state: state.has_all({'Large Spring Ball', '! Switch'}, player) and (logic.combat_item(state) or state.has('Giant Eggs', player)))
    set_rule(world.multiworld.get_location("Lakitu's Wall: Stars", player), lambda state: state.has_all({'Giant Eggs'}, player) or logic.has_midring(state))
    ...
    set_rule(world.multiworld.get_location("The Potted Ghost's Castle: Stars", player), lambda state: state.has_all({'Arrow Wheel'}, player) and (logic.has_midring(state) or state.has('Key', player)))

    set_rule(world.multiworld.get_location("Welcome To Monkey World!: Stars", player), lambda state: logic.has_midring(state))

    set_rule(world.multiworld.get_location("Jungle Rhythm...: Red Coins", player), lambda state: state.has_all({'Dashed Stairs'}, player))
    set_rule(world.multiworld.get_location("Jungle Rhythm...: Flowers", player), lambda state: state.has_all({'Dashed Stairs'}, player))
    set_rule(world.multiworld.get_location("Jungle Rhythm...: Stars", player), lambda state: logic.has_midring(state) and state.has('Tulip', player))
    set_rule(world.multiworld.get_location("Jungle Rhythm...: Level Clear", player), lambda state: state.has_all({'Dashed Stairs'}, player))
    ...
    set_rule(world.multiworld.get_location("Monkeys' Favorite Lake: Red Coins", player), lambda state: state.has_all({'! Switch', 'Submarine Morph', 'Large Spring Ball', 'Beanstalk'}, player))
    set_rule(world.multiworld.get_location("Monkeys' Favorite Lake: Flowers", player), lambda state: state.has_all({'Beanstalk'}, player))
    ...
    set_rule(world.multiworld.get_location("The Cave Of The Lakitus: Red Coins", player), lambda state: state.has_all({'Large Spring Ball', '! Switch', 'Egg Launcher'}, player))
    set_rule(world.multiworld.get_location("The Cave Of The Lakitus: Flowers", player), lambda state: state.has_all({'Large Spring Ball', 'Egg Launcher'}, player))
    set_rule(world.multiworld.get_location("The Cave Of The Lakitus: Stars", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    set_rule(world.multiworld.get_location("The Cave Of The Lakitus: Level Clear", player), lambda state: state.has_all({'Large Spring Ball'}, player))

    set_rule(world.multiworld.get_location("Don't Look Back!: Red Coins", player), lambda state: state.has_all({'Helicopter Morph', '! Switch', 'Large Spring Ball'}, player))
    set_rule(world.multiworld.get_location("Don't Look Back!: Flowers", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    ...
    set_rule(world.multiworld.get_location("Marching Milde's Fort: Stars", player), lambda state: state.has_all({'Dashed Stairs'}, player))
    ...
    set_rule(world.multiworld.get_location("Goonie Rides!: Red Coins", player), lambda state: state.has_all({'Helicopter Morph'}, player))
    set_rule(world.multiworld.get_location("Goonie Rides!: Flowers", player), lambda state: state.has_all({'Helicopter Morph', '! Switch'}, player))
    ...
    set_rule(world.multiworld.get_location("Scary Skeleton Goonies!: Red Coins", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    set_rule(world.multiworld.get_location("Scary Skeleton Goonies!: Flowers", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    set_rule(world.multiworld.get_location("Scary Skeleton Goonies!: Stars", player), lambda state: logic.has_midring(state))
    set_rule(world.multiworld.get_location("Scary Skeleton Goonies!: Level Clear", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    ...
    set_rule(world.multiworld.get_location("The Very Loooooong Cave: Red Coins", player), lambda state: state.has_all({'Chomp Rock'}, player) and (state.has('Egg Capacity Upgrade', player, 2) or logic.combat_item(state)))
    set_rule(world.multiworld.get_location("The Very Loooooong Cave: Flowers", player), lambda state: state.has_all({'Chomp Rock'}, player) and (state.has('Egg Capacity Upgrade', player, 2) or logic.combat_item(state)))
    set_rule(world.multiworld.get_location("The Very Loooooong Cave: Stars", player), lambda state: state.has_all({'Chomp Rock'}, player) and (state.has('Egg Capacity Upgrade', player, 2) or logic.combat_item(state)) and logic.has_midring(state))
...
def set_normal_extra_rules(world: "YIWorld", player: int, logic: YoshiLogic) -> None:
    ...
    set_rule(world.multiworld.get_location("Kamek's Revenge: Red Coins", player), lambda state: state.has_all({'Key', 'Skis', 'Helicopter Morph', '! Switch'}, player) and logic.has_midring(state))
    set_rule(world.multiworld.get_location("Kamek's Revenge: Flowers", player), lambda state: state.has_all({'Key', 'Skis', 'Helicopter Morph', '! Switch'}, player) and logic.has_midring(state))
    set_rule(world.multiworld.get_location("Kamek's Revenge: Stars", player), lambda state: state.has_all({'! Switch'}, player) or logic.has_midring(state))
...
def set_hard_rules(world: "YIWorld"):
    ...
    set_rule(world.multiworld.get_location("Visit Koopa And Para-Koopa: Red Coins", player), lambda state: state.has_all({'Large Spring Ball'}, player) and (state.has('Poochy', player) or logic.melon_item(state)))
    set_rule(world.multiworld.get_location("Visit Koopa And Para-Koopa: Flowers", player), lambda state: state.has_all({'Super Star', 'Large Spring Ball'}, player))
    ...
    set_rule(world.multiworld.get_location("The Baseball Boys: Red Coins", player), lambda state: state.has_all({'Mole Tank Morph'}, player) and (state.has_any({'Ice Melon', 'Large Spring Ball'}, player) or logic.melon_item(state)))
    ...
    set_rule(world.multiworld.get_location("Bigger Boo's Fort: Stars", player), lambda state: state.has_all({'! Switch'}, player))

    set_rule(world.multiworld.get_location("Watch Out For Lakitu: Flowers", player), lambda state: state.has_all({'Key', 'Train Morph'}, player))

    set_rule(world.multiworld.get_location("The Cave Of The Mystery Maze: Red Coins", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    set_rule(world.multiworld.get_location("The Cave Of The Mystery Maze: Flowers", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    set_rule(world.multiworld.get_location("The Cave Of The Mystery Maze: Level Clear", player), lambda state: state.has_all({'Large Spring Ball'}, player))

    set_rule(world.multiworld.get_location("Lakitu's Wall: Flowers", player), lambda state: state.has_all({'! Switch'}, player))
    set_rule(world.multiworld.get_location("Lakitu's Wall: Stars", player), lambda state: state.has_all({'Giant Eggs'}, player) or logic.has_midring(state))

    set_rule(world.multiworld.get_location("The Potted Ghost's Castle: Red Coins", player), lambda state: state.has_all({'Arrow Wheel', 'Key'}, player))
    set_rule(world.multiworld.get_location("The Potted Ghost's Castle: Flowers", player), lambda state: state.has_all({'Arrow Wheel', 'Key', 'Train Morph'}, player))
    set_rule(world.multiworld.get_location("The Potted Ghost's Castle: Stars", player), lambda state: state.has_all({'Arrow Wheel'}, player))
    ...
    set_rule(world.multiworld.get_location("The Cave Of The Lakitus: Flowers", player), lambda state: state.has_all({'Egg Launcher'}, player))
    ...
    set_rule(world.multiworld.get_location("Chomp Rock Zone: Red Coins", player), lambda state: state.has_all({'Large Spring Ball'}, player))
    ...
    set_rule(world.multiworld.get_location("Lake Shore Paradise: Stars", player), lambda state: (logic.has_midring(state) or (state.has_all({'Tulip'}, player) and logic.cansee_clouds(state))))
    ...
    set_rule(world.multiworld.get_location("King Bowser's Castle: Red Coins", player), lambda state: state.has_all({'Helicopter Morph'}, player) and logic._68CollectibleRoute(state))
...
def set_hard_extra_rules(world: "YIWorld", player: int, logic: YoshiLogic) -> None:
    ...
    set_rule(world.multiworld.get_location("Poochy Ain't Stupid: Red Coins", player), lambda state: state.has_all({'Poochy'}, player))
    set_rule(world.multiworld.get_location("Poochy Ain't Stupid: Flowers", player), lambda state: state.has_all({'Poochy'}, player))
    set_rule(world.multiworld.get_location("Poochy Ain't Stupid: Stars", player), lambda state: state.has_all({'Poochy'}, player))
    set_rule(world.multiworld.get_location("Poochy Ain't Stupid: Level Clear", player), lambda state: state.has_all({'Poochy'}, player))
