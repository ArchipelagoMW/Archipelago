...
PRISM_ITEM["Bulbasaur Prisma"]: PrismaItem(
    ...
    location=MemoryAddress(base_address=0x80377e1c, memory_range=MemoryRange.BYTE,value=0x03, offset=0x7fff+0x0003),
...
PRISM_ITEM["Venusaur Prisma"]: PrismaItem(
    ...
    location=MemoryAddress(base_address=0x80376DA8, memory_range=MemoryRange.BYTE,value=0x03, offset=0x7fff+0x0003),
...
PRISM_ITEM["Pelipper Prisma"]: PrismaItem(
    ...
    location=MemoryAddress(base_address=0x803772B8, memory_range=MemoryRange.BYTE,value=0x03, offset=0x7fff+0x0003),
...
PRISM_ITEM["Gyarados Prisma"]: PrismaItem(
    ...
    location=MemoryAddress(base_address=0x80377174, memory_range=MemoryRange.BYTE,value=0x03, offset=0x7fff+0x0003),
...
blocked_unlocks = [UNLOCK_ITEMS["Caterpie Unlock"], UNLOCK_ITEMS["Weedle Unlock"], UNLOCK_ITEMS["Shroomish Unlock"],
...
meadow_zone_unlock_pokemon_addresses_for_location = {
    ...
    0x0000000c: [UNLOCK_ITEMS.get("Bidoof1 Unlock"), UNLOCK_ITEMS.get("Bidoof2 Unlock"),
...
UNCHECKED_MEADOW_ZONE_LOCATION_POKEMON_IDS = [
    ...
    (0x0000002d, friend_item_checks[FRIENDSHIP_ITEMS["Turtwig"]], FRIENDSHIP_ITEMS["Turtwig"]),
    # static overworld blocked from event
    (0x00000002, friend_item_checks[FRIENDSHIP_ITEMS["Turtwig"]], FRIENDSHIP_ITEMS["Turtwig"]),
    # free walking overworld
    (0x00000003, friend_item_checks[FRIENDSHIP_ITEMS["Buneary"]], FRIENDSHIP_ITEMS["Buneary"]),
    # free walking overworld
    (0x0000002b, friend_item_checks[FRIENDSHIP_ITEMS["Buneary"]], FRIENDSHIP_ITEMS["Buneary"]),
    # standing beside bulbasaur after minigame
    ...
    (0x0000001a, friend_item_checks[FRIENDSHIP_ITEMS["Sudowoodo"]], FRIENDSHIP_ITEMS["Sudowoodo"]),
    # Sudowoodo overworld
    ...
    (0x00000012, friend_item_checks[FRIENDSHIP_ITEMS["Aipom"]], FRIENDSHIP_ITEMS["Aipom"]),
    # explainer aipom beside tree
    (0x0000000e, friend_item_checks[FRIENDSHIP_ITEMS["Shroomish"]], FRIENDSHIP_ITEMS["Shroomish"]),
    # overworld Shroomish
    ...
    (0x0000002e, friend_item_checks[FRIENDSHIP_ITEMS["Butterfree"]], FRIENDSHIP_ITEMS["Butterfree"]),
    # overworld flying Butterfree
    (0x00000016, friend_item_checks[FRIENDSHIP_ITEMS["Butterfree"]], FRIENDSHIP_ITEMS["Butterfree"]),
    # overworld flying Butterfree 2

    (0x0000001d, friend_item_checks[FRIENDSHIP_ITEMS["Croagunk"]], FRIENDSHIP_ITEMS["Croagunk"]),
    # standing before gate
    (0x00000014, friend_item_checks[FRIENDSHIP_ITEMS["Torterra"]], FRIENDSHIP_ITEMS["Torterra"]),
    # walking in overworld Torterra
...
UNCHECKED_BEACH_ZONE_LOCATION_POKEMON_IDS = [
    ...
    (0x00000006, friend_item_checks[FRIENDSHIP_ITEMS["Corsola"]], FRIENDSHIP_ITEMS["Corsola"]),
    # overworld Corsola quest on bridge
    (0x00000021, friend_item_checks[FRIENDSHIP_ITEMS["Corsola"]], FRIENDSHIP_ITEMS["Corsola"]),
    # overworld Corsola free
    (0x00000022, friend_item_checks[FRIENDSHIP_ITEMS["Corsola"]], FRIENDSHIP_ITEMS["Corsola"]),
    # overworld Corsola free

    (0x00000007, friend_item_checks[FRIENDSHIP_ITEMS["Taillow"]], FRIENDSHIP_ITEMS["Taillow"]),
    # overworld Taillow 1 todo:search all
    (0x00000029, friend_item_checks[FRIENDSHIP_ITEMS["Taillow"]], FRIENDSHIP_ITEMS["Taillow"]),  # overworld Taillow 2
    (0x00000024, friend_item_checks[FRIENDSHIP_ITEMS["Wingull"]], FRIENDSHIP_ITEMS["Wingull"]),
    # overworld Wingull 1 todo:search all
    (0x0000002b, friend_item_checks[FRIENDSHIP_ITEMS["Wingull"]], FRIENDSHIP_ITEMS["Wingull"]),
    # overworld Wingull 2 todo:search all
    (0x0000000a, friend_item_checks[FRIENDSHIP_ITEMS["Wingull"]], FRIENDSHIP_ITEMS["Wingull"]),
    # overworld Wingull 3 todo:search all
    (0x00000026, friend_item_checks[FRIENDSHIP_ITEMS["Starly"]], FRIENDSHIP_ITEMS["Starly"] + 1000),
    # overworld Starly 1 todo:search all
    ...
    (0x00000018, friend_item_checks[FRIENDSHIP_ITEMS["Pidgeotto"]], FRIENDSHIP_ITEMS["Pidgeotto"]),
    # overworld Pidgeotto
    ...
    (0x00000013, friend_item_checks[FRIENDSHIP_ITEMS["Wailord"]], FRIENDSHIP_ITEMS["Wailord"]),
    # overworld Wailord bottle quest
    (0x0000002f, friend_item_checks[FRIENDSHIP_ITEMS["Corphish"]], FRIENDSHIP_ITEMS["Corphish"]),  # Overworld Corphish
    (0x0000002e, friend_item_checks[FRIENDSHIP_ITEMS["Corphish"]], FRIENDSHIP_ITEMS["Corphish"]),
    # Overworld Corphish 2
    (0x0000000e, friend_item_checks[FRIENDSHIP_ITEMS["Corphish"]], FRIENDSHIP_ITEMS["Corphish"]),
    # Overworld Corphish 3

    (0x0000001e, friend_item_checks[FRIENDSHIP_ITEMS["Gyarados"]], FRIENDSHIP_ITEMS["Gyarados"]),  # minigame Gyarados
    (0x0000001b, friend_item_checks[FRIENDSHIP_ITEMS["Feraligatr"]], FRIENDSHIP_ITEMS["Feraligatr"]),
    # minigame Gyarados
