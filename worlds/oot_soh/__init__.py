...
class SohWorld(World):
    ...
    def create_regions(self) -> None: 
        ...
        # Root
        root.set_region_rules(self)

        # Overworld
        castle_grounds.set_region_rules(self)
        death_mountain_crater.set_region_rules(self)
        death_mountain_trail.set_region_rules(self)
        desert_colossus.set_region_rules(self)
        gerudo_fortress.set_region_rules(self)
        gerudo_valley.set_region_rules(self)
        goron_city.set_region_rules(self)
        graveyard.set_region_rules(self)
        haunted_wasteland.set_region_rules(self)
        hyrule_field.set_region_rules(self)
        kakariko.set_region_rules(self)
        ...
        deku_tree.set_region_rules(self)
        dodongos_cavern.set_region_rules(self)
        fire_temple.set_region_rules(self)
        forest_temple.set_region_rules(self)
        ganons_castle.set_region_rules(self)
        gerudo_training_ground.set_region_rules(self)
        ice_cavern.set_region_rules(self)
        jabujabus_belly.set_region_rules(self)
        shadow_temple.set_region_rules(self)
        spirit_temple.set_region_rules(self)
        water_temple.set_region_rules(self)
