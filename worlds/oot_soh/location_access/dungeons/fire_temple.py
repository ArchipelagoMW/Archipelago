...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.FIRE_TEMPLE_BIG_LAVA_ROOM, world, [
        (Locations.FIRE_TEMPLE_BIG_LAVA_POT1, lambda bundle: can_break_pots(bundle)),
        (Locations.FIRE_TEMPLE_BIG_LAVA_POT2, lambda bundle: can_break_pots(bundle)),
        (Locations.FIRE_TEMPLE_BIG_LAVA_POT3, lambda bundle: can_break_pots(bundle)),
    ])
    # Connections
    connect_regions(Regions.FIRE_TEMPLE_BIG_LAVA_ROOM, world, [
        (Regions.FIRE_TEMPLE_FIRST_ROOM, lambda bundle: small_keys(Items.FIRE_TEMPLE_SMALL_KEY, 2, bundle)),
    ...
    add_locations(Regions.FIRE_TEMPLE_FIRE_PILLAR_ROOM, world, [
        (Locations.FIRE_TEMPLE_FIRE_PILLAR_ROOM_LEFT_HEART, lambda bundle: fire_timer(bundle) >= 56),
        (Locations.FIRE_TEMPLE_FIRE_PILLAR_ROOM_RIGHT_HEART, lambda bundle: fire_timer(bundle) >= 56),
        (Locations.FIRE_TEMPLE_FIRE_PILLAR_ROOM_BACK_HEART, lambda bundle: fire_timer(bundle) >= 56),
    ])
    # Connections
    connect_regions(Regions.FIRE_TEMPLE_FIRE_PILLAR_ROOM, world, [
        (Regions.FIRE_TEMPLE_BIG_LAVA_ROOM, lambda bundle: small_keys(Items.FIRE_TEMPLE_SMALL_KEY, 3, bundle)),
    ...
    connect_regions(Regions.FIRE_TEMPLE_EAST_CENTRAL_ROOM, world, [
        ...
        (Regions.FIRE_TEMPLE_BOULDER_MAZE_LOWER, lambda bundle: small_keys(Items.FIRE_TEMPLE_SMALL_KEY, 5, bundle)),
        (Regions.FIRE_TEMPLE_FIRE_WALL_CHASE, lambda bundle: small_keys(Items.FIRE_TEMPLE_SMALL_KEY, 6, bundle)),
    ...
    add_locations(Regions.FIRE_TEMPLE_FIRE_WALL_CHASE, world, [
        ...
        (Locations.FIRE_TEMPLE_FIRE_WALL_CHASE_WEST_PILLAR_HEART, lambda bundle:
            (fire_timer(bundle) >= 24 and
             (is_adult(bundle) or
              can_use(Items.BOOMERANG, bundle)))),
        (Locations.FIRE_TEMPLE_FIRE_WALL_CHASE_EXIT_PLATFORM_HEART, lambda bundle: fire_timer(bundle) >= 24)
    ])
    # Connections
    ...
    add_locations(Regions.FIRE_TEMPLE_EAST_PEAK, world, [
        ...
        (Locations.FIRE_TEMPLE_GS_SCARECROW_TOP, lambda bundle: can_use_projectile(bundle))
    ])
    # Connections
    ...
    connect_regions(Regions.FIRE_TEMPLE_CORRIDOR, world, [
        (Regions.FIRE_TEMPLE_FIRE_WALL_CHASE, lambda bundle: small_keys(Items.FIRE_TEMPLE_SMALL_KEY, 7, bundle)),
    ...
    add_locations(Regions.FIRE_TEMPLE_FIRE_MAZE_ROOM, world, [
        (Locations.FIRE_TEMPLE_FLAME_MAZE_LEFT_POT1, lambda bundle: can_break_pots(bundle)),
        (Locations.FIRE_TEMPLE_FLAME_MAZE_LEFT_POT2, lambda bundle: can_break_pots(bundle)),
        (Locations.FIRE_TEMPLE_FLAME_MAZE_LEFT_POT3, lambda bundle: can_break_pots(bundle)),
        (Locations.FIRE_TEMPLE_FLAME_MAZE_LEFT_POT4, lambda bundle: can_break_pots(bundle)),
    ])
    # Connections
    ...
    connect_regions(Regions.FIRE_TEMPLE_FIRE_MAZE_UPPER, world, [
        (Regions.FIRE_TEMPLE_NEAR_BOSS_ROOM, lambda bundle: can_use(Items.MEGATON_HAMMER, bundle)),
        (Regions.FIRE_TEMPLE_FIRE_MAZE_ROOM, lambda bundle: True),
        (Regions.FIRE_TEMPLE_WEST_CENTRAL_UPPER, lambda bundle: can_use(Items.MEGATON_HAMMER, bundle))
    ])
    ...
    connect_regions(Regions.FIRE_TEMPLE_WEST_CENTRAL_LOWER, world, [
        (Regions.FIRE_TEMPLE_FIRE_MAZE_ROOM, lambda bundle: small_keys(Items.FIRE_TEMPLE_SMALL_KEY, 8, bundle)),
    ...
    add_locations(Regions.FIRE_TEMPLE_LATE_FIRE_MAZE, world, [
        (Locations.FIRE_TEMPLE_FLAME_MAZE_RIGHT_POT1, lambda bundle: can_break_pots(bundle)),
        (Locations.FIRE_TEMPLE_FLAME_MAZE_RIGHT_POT2, lambda bundle: can_break_pots(bundle)),
        (Locations.FIRE_TEMPLE_FLAME_MAZE_RIGHT_POT3, lambda bundle: can_break_pots(bundle)),
        (Locations.FIRE_TEMPLE_FLAME_MAZE_RIGHT_POT4, lambda bundle: can_break_pots(bundle)),
    ])
    # Connections
    connect_regions(Regions.FIRE_TEMPLE_LATE_FIRE_MAZE, world, [
        (Regions.FIRE_TEMPLE_FIRE_MAZE_ROOM, lambda bundle: False),
        (Regions.FIRE_TEMPLE_WEST_CENTRAL_LOWER, lambda bundle: True),
        (Regions.FIRE_TEMPLE_UPPER_FLARE_DANCER, lambda bundle: has_explosives(bundle))
    ])
    
    ## Fire Temple Upper Flare Dancer
    # Connections
    connect_regions(Regions.FIRE_TEMPLE_UPPER_FLARE_DANCER, world, [
        (Regions.FIRE_TEMPLE_LATE_FIRE_MAZE, lambda bundle: can_kill_enemy(bundle, Enemies.FLARE_DANCER)),
        (Regions.FIRE_TEMPLE_WEST_CLIMB, lambda bundle: can_kill_enemy(bundle, Enemies.FLARE_DANCER))
    ])
    ...
    connect_regions(Regions.FIRE_TEMPLE_WEST_PEAK, world, [
        (Regions.FIRE_TEMPLE_WEST_CENTRAL_UPPER, lambda bundle: take_damage(bundle)),
        (Regions.FIRE_TEMPLE_WEST_CLIMB, lambda bundle: True),
        (Regions.FIRE_TEMPLE_HAMMER_RETURN_PATH, lambda bundle: can_use(Items.MEGATON_HAMMER, bundle))
    ])
    
    ## Fire Temple Hammer Return Path
    # Locations
    add_locations(Regions.FIRE_TEMPLE_HAMMER_RETURN_PATH, world, [
        (Locations.FIRE_TEMPLE_AFTER_HAMMER_SMALL_CRATE1, lambda bundle: can_break_small_crates(bundle)),
        (Locations.FIRE_TEMPLE_AFTER_HAMMER_SMALL_CRATE2, lambda bundle: can_break_small_crates(bundle)),
    ])
    # Connections
    connect_regions(Regions.FIRE_TEMPLE_HAMMER_RETURN_PATH, world, [
        (Regions.FIRE_TEMPLE_ABOVE_FIRE_MAZE, lambda bundle: can_use(Items.MEGATON_HAMMER, bundle))
    ])
    ...
    connect_regions(Regions.FIRE_TEMPLE_ABOVE_FIRE_MAZE, world, [
        ...
        (Regions.FIRE_TEMPLE_FIRE_MAZE_UPPER, lambda bundle: can_use(Items.MEGATON_HAMMER, bundle))
    ])
    ...
    connect_regions(Regions.FIRE_TEMPLE_BOSS_ENTRYWAY, world, [
        ...
        (Regions.FIRE_TEMPLE_BOSS_ROOM, lambda bundle: has_item(Items.FIRE_TEMPLE_BOSS_KEY, bundle))
    ])
