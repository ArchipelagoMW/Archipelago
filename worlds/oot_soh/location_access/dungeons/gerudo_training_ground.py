...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.GERUDO_TRAINING_GROUND_LOBBY, world, [
        ...
        (Locations.GERUDO_TRAINING_GROUND_LOBBY_RIGHT_CHEST, lambda bundle: can_hit_eye_targets(bundle)),
    ...
    connect_regions(Regions.GERUDO_TRAINING_GROUND_CENTRAL_MAZE_RIGHT, world, [
        (Regions.GERUDO_TRAINING_GROUND_HAMMER_ROOM, lambda bundle: can_use(Items.HOOKSHOT, bundle)),
    ...
    add_locations(Regions.GERUDO_TRAINING_GROUND_LIKE_LIKE_ROOM, world, [
        ...
        (Locations.GERUDO_TRAINING_GROUND_HEAVY_BLOCK_THIRD_CHEST, lambda bundle: can_jump_slash_except_hammer(bundle)),
