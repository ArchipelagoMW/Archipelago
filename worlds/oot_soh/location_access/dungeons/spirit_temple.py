...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.SPIRIT_TEMPLE_CENTRAL_CHAMBER, world, [
        ...
        (Locations.SPIRIT_TEMPLE_GS_HALL_AFTER_SUN_BLOCK_ROOM, lambda bundle: (has_explosives(bundle) and can_use(Items.BOOMERANG, bundle) and can_use(Items.HOOKSHOT, bundle)) or (can_use(Items.BOOMERANG, bundle) and small_keys(Items.SPIRIT_TEMPLE_SMALL_KEY, 5, bundle) and has_explosives(bundle)) or (can_use(Items.HOOKSHOT, bundle) and can_use(Items.SILVER_GAUNTLETS, bundle) and small_keys(Items.SPIRIT_TEMPLE_SMALL_KEY, 2, bundle))),
    ...
    add_locations(Regions.SPIRIT_TEMPLE_OUTDOOR_HANDS, world, [
        (Locations.SPIRIT_TEMPLE_SILVER_GAUNTLETS_CHEST, lambda bundle: (small_keys(Items.SPIRIT_TEMPLE_SMALL_KEY, 3, bundle) and can_use(Items.LONGSHOT, bundle) and has_explosives(bundle)) or small_keys(Items.SPIRIT_TEMPLE_SMALL_KEY, 5, bundle)),
        (Locations.SPIRIT_TEMPLE_MIRROR_SHIELD_CHEST, lambda bundle: small_keys(Items.SPIRIT_TEMPLE_SMALL_KEY, 4, bundle) and can_use(Items.SILVER_GAUNTLETS, bundle) and has_explosives(bundle))
    ])
    # Connections
    connect_regions(Regions.SPIRIT_TEMPLE_OUTDOOR_HANDS, world, [
        (Regions.DESERT_COLOSSUS, lambda bundle: (is_child(bundle) and small_keys(Items.SPIRIT_TEMPLE_SMALL_KEY, 5, bundle)) or (can_use(Items.SILVER_GAUNTLETS, bundle) and ((small_keys(Items.SPIRIT_TEMPLE_SMALL_KEY, 3, bundle) and has_explosives(bundle)) or small_keys(Items.SPIRIT_TEMPLE_SMALL_KEY, 5, bundle))))
    ])
    ...
    connect_regions(Regions.SPIRIT_TEMPLE_BEYOND_CENTRAL_LOCKED_DOOR, world, [
        (Regions.SPIRIT_TEMPLE_BEYOND_FINAL_LOCKED_DOOR, lambda bundle: small_keys(Items.SPIRIT_TEMPLE_SMALL_KEY, 5, bundle) and (can_do_trick(Tricks.SPIRIT_WALL, bundle) or can_use_any([Items.LONGSHOT, Items.BOMBCHUS_5], bundle) or ((can_use_any([Items.BOMB_BAG, Items.NUTS, Items.DINS_FIRE], bundle)) and (can_use_any([Items.FAIRY_BOW, Items.HOOKSHOT, Items.MEGATON_HAMMER], bundle)))))
    ])
    ...
    connect_regions(Regions.SPIRIT_TEMPLE_BEYOND_FINAL_LOCKED_DOOR, world, [
        (Regions.SPIRIT_TEMPLE_INSIDE_STATUE_HEAD, lambda bundle: can_use(Items.MIRROR_SHIELD, bundle) and has_explosives(bundle) and can_use(Items.HOOKSHOT, bundle))
    ])
