...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.WATER_TEMPLE_MAP_ROOM, world, [
        (Locations.WATER_TEMPLE_MAP_CHEST, lambda bundle: can_kill_enemy(bundle, Enemies.SPIKE, EnemyDistance.CLOSE, True, 3))
    ])
    # Connections
    connect_regions(Regions.WATER_TEMPLE_MAP_ROOM, world, [
        (Regions.WATER_TEMPLE_EAST_LOWER, lambda bundle: can_kill_enemy(bundle, Enemies.SPIKE, EnemyDistance.CLOSE, True, 3))
    ])
    
    ## Water Temple Cracked Wall
    # Locations
    add_locations(Regions.WATER_TEMPLE_CRACKED_WALL, world, [
        (Locations.WATER_TEMPLE_CRACKED_WALL_CHEST, lambda bundle: has_explosives(bundle))
    ])
    # Connections
    ...
    add_locations(Regions.WATER_TEMPLE_TORCH_ROOM, world, [
        (Locations.WATER_TEMPLE_TORCHES_CHEST, lambda bundle: can_kill_enemy(bundle, Enemies.SHELL_BLADE, EnemyDistance.CLOSE, True, 3))
    ])
    # Connections
    connect_regions(Regions.WATER_TEMPLE_TORCH_ROOM, world, [
        (Regions.WATER_TEMPLE_EAST_LOWER, lambda bundle: can_kill_enemy(bundle, Enemies.SHELL_BLADE, EnemyDistance.CLOSE, True, 3))
    ])
    ...
    add_locations(Regions.WATER_TEMPLE_BLOCK_ROOM, world, [
        (Locations.WATER_TEMPLE_BASEMENT_BLOCK_PUZZLE_POT1, lambda bundle: can_break_pots(bundle)),
        (Locations.WATER_TEMPLE_BASEMENT_BLOCK_PUZZLE_POT2, lambda bundle: can_break_pots(bundle))
    ])
    # Connections
    ...
    connect_regions(Regions.WATER_TEMPLE_JETS_ROOM, world, [
        (Regions.WATER_TEMPLE_BLOCK_ROOM, lambda bundle: can_use(Items.HOOKSHOT, bundle)),
    ...
    add_events(Regions.WATER_TEMPLE_BOSS_KEY_ROOM, world, [
        (EventLocations.WATER_TEMPLE_BOSS_KEY_ROOM_FAIRY_POT, Events.CAN_ACCESS_FAIRIES, lambda bundle: True)
    ])
    # Locations
    add_locations(Regions.WATER_TEMPLE_BOSS_KEY_ROOM, world, [
        (Locations.WATER_TEMPLE_BOSS_KEY_CHEST, lambda bundle: True),
        (Locations.WATER_TEMPLE_BOSS_KEY_POT1, lambda bundle: can_break_pots(bundle)),
        (Locations.WATER_TEMPLE_BOSS_KEY_POT2, lambda bundle: can_break_pots(bundle)),
    ])
    # Connections
    ...
    add_locations(Regions.WATER_TEMPLE_CENTRAL_PILLAR_UPPER, world, [
        (Locations.WATER_TEMPLE_GS_CENTRAL_PILLAR, lambda bundle: (can_use(Items.LONGSHOT, bundle) or
                                                                   (((can_do_trick(Tricks.WATER_FW_CENTRAL_GS, bundle) and
                                                                     ...
                                                                     (can_do_trick(Tricks.WATER_IRONS_CENTRAL_GS) and
                                                                      can_use(Items.IRON_BOOTS, bundle) and
                                                                      ((can_use(Items.HOOKSHOT, bundle) and
                                                                        can_use(Items.FAIRY_BOW, bundle)) or
    ...
    add_locations(Regions.WATER_TEMPLE_EAST_MIDDLE, world, [
        (Locations.WATER_TEMPLE_COMPASS_CHEST, lambda bundle: can_use_projectile(bundle)),
        (Locations.WATER_TEMPLE_NEAR_COMPASS_POT1, lambda bundle: can_break_pots(bundle)),
        (Locations.WATER_TEMPLE_NEAR_COMPASS_POT2, lambda bundle: can_break_pots(bundle)),
        (Locations.WATER_TEMPLE_NEAR_COMPASS_POT3, lambda bundle: can_break_pots(bundle)),
    ])
    # Connections
    ...
    add_locations(Regions.WATER_TEMPLE_FALLING_PLATFORM_ROOM, world, [
        (Locations.WATER_TEMPLE_GS_FALLING_PLATFORM_ROOM, lambda bundle: (can_use(Items.LONGSHOT, bundle) or
                                                                          (can_do_trick(Tricks.WATER_RANG_FALLING_PLATFORM_GS) and
                                                                           is_child(bundle) and
                                                                           can_use(Items.BOOMERANG, bundle)) or
                                                                          (can_do_trick(Tricks.WATER_HOOKSHOT_FALLING_PLATFORM_GS) and
                                                                           is_adult(bundle) and
                                                                           can_use(Items.HOOKSHOT, bundle))))
    ])
    # Connections
    ...
    add_locations(Regions.WATER_TEMPLE_DRAGON_PILLARS_ROOM, world, [
        (Locations.WATER_TEMPLE_LIKE_LIKE_POT1, lambda bundle: can_use(Items.HOOKSHOT, bundle)),
        (Locations.WATER_TEMPLE_LIKE_LIKE_POT2, lambda bundle: can_use(Items.HOOKSHOT, bundle))
    ])
    # Connections
    connect_regions(Regions.WATER_TEMPLE_DRAGON_PILLARS_ROOM, world, [
        (Regions.WATER_TEMPLE_FALLING_PLATFORM_ROOM, lambda bundle: can_use_projectile(bundle)),
        (Regions.WATER_TEMPLE_DARK_LINK_ROOM, lambda bundle: can_use(Items.HOOKSHOT, bundle))
    ])
    
    ## Water Temple Dark Link Room
    # Connections
    connect_regions(Regions.WATER_TEMPLE_DARK_LINK_ROOM, world, [
        (Regions.WATER_TEMPLE_DRAGON_PILLARS_ROOM, lambda bundle: can_kill_enemy(bundle, Enemies.DARK_LINK)),
        (Regions.WATER_TEMPLE_LONGSHOT_ROOM, lambda bundle: can_kill_enemy(bundle, Enemies.DARK_LINK)),
    ])
    ...
    add_events(Regions.WATER_TEMPLE_PRE_BOSS_ROOM, world, [
        (EventLocations.WATER_TEMPLE_PRE_BOSS_ROOM_FAIRY_POT, Events.CAN_ACCESS_FAIRIES, lambda bundle: True)
    ])
    # Locations
    add_locations(Regions.WATER_TEMPLE_PRE_BOSS_ROOM, world, [
        (Locations.WATER_TEMPLE_MAIN_LEVEL1_POT1, lambda bundle: can_break_pots(bundle)),
        (Locations.WATER_TEMPLE_MAIN_LEVEL1_POT2, lambda bundle: can_break_pots(bundle))
    ])
    # Connections
