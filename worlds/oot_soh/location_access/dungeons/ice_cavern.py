...
def set_region_rules(world: "SohWorld") -> None:
    ...
    connect_regions(Regions.ICE_CAVERN_HUB, world, [
        (Regions.ICE_CAVERN_BEGINNING, lambda bundle: True),
        (Regions.ICE_CAVERN_MAP_ROOM, lambda bundle: (is_adult(bundle) or (can_do_trick(Tricks.GROUND_JUMP_HARD, bundle) and can_ground_jump(bundle))) and can_clear_stalagmite(bundle)),
    ...
    add_locations(Regions.ICE_CAVERN_BLOCK_ROOM, world, [
        (Locations.ICE_CAVERN_GS_PUSH_BLOCK_ROOM, lambda bundle: hookshot_or_boomerang(bundle) or (can_do_trick(Tricks.ICE_BLOCK_GS, bundle) and is_adult(bundle) and can_use(Items.HOVER_BOOTS, bundle) and can_get_enemy_drop(bundle, Enemies.GOLD_SKULLTULA, EnemyDistance.SHORT_JUMPSLASH))),
    ...
    add_locations(Regions.ICE_CAVERN_FINAL_ROOM, world, [
        (Locations.ICE_CAVERN_IRON_BOOTS_CHEST, lambda bundle: can_kill_enemy(bundle, Enemies.WOLFOS)),
        (Locations.SHEIK_IN_ICE_CAVERN, lambda bundle: can_kill_enemy(bundle, Enemies.WOLFOS)) # Rando enables this for child
    ])
    # Connections
