...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.THIEVES_HIDEOUT_DOUBLE_CELL, world, [
        ...
        (Locations.TH_DOUBLE_CELL_LEFT_CRATE, lambda bundle: can_break_crates(bundle)),
        (Locations.TH_DOUBLE_CELL_RIGHT_CRATE, lambda bundle: can_break_crates(bundle))
    ])
    # Connections
    ...
    add_locations(Regions.THIEVES_HIDEOUT_DEAD_END_CELL, world, [
        (Locations.TH_DEAD_END_CARPENTER, lambda bundle: can_kill_enemy(bundle, Enemies.GERUDO_WARRIOR)),
    ...
    connect_regions(Regions.THIEVES_HIDEOUT_KITCHEN_BOTTOM, world, [
        (Regions.THIEVES_HIDEOUT_KITCHEN_CORRIDOR, lambda bundle: can_pass_enemy(bundle, Enemies.GERUDO_GUARD)),
        (Regions.THIEVES_HIDEOUT_KITCHEN_TOP, lambda bundle: can_pass_enemy(bundle, Enemies.GERUDO_GUARD)),
    ...
    add_locations(Regions.THIEVES_HIDEOUT_BREAK_ROOM, world, [
        (Locations.TH_BREAK_ROOM_FRONT_POT,
         lambda bundle: (can_pass_enemy(bundle, Enemies.BREAK_ROOM_GUARD) and can_break_pots(bundle))
                         or (can_pass_enemy(bundle, Enemies.GERUDO_GUARD) and can_use(Items.BOOMERANG, bundle))),
        (Locations.TH_BREAK_ROOM_BACK_POT,
         lambda bundle: (can_pass_enemy(bundle, Enemies.BREAK_ROOM_GUARD) and can_break_pots(bundle))
                        or (can_pass_enemy(bundle, Enemies.GERUDO_GUARD) and can_use(Items.BOOMERANG, bundle))),
        (Locations.TH_BREAK_HALLWAY_OUTER_CRATE, lambda bundle: can_break_crates(bundle)),
        (Locations.TH_BREAK_HALLWAY_INNER_CRATE, lambda bundle: can_break_crates(bundle)),
        (Locations.TH_BREAK_ROOM_RIGHT_CRATE,
         lambda bundle: (can_pass_enemy(bundle, Enemies.BREAK_ROOM_GUARD) and can_break_crates(bundle))
    ...
    connect_regions(Regions.THIEVES_HIDEOUT_BREAK_ROOM, world, [
        (Regions.GF_BELOW_CHEST, lambda bundle: can_pass_enemy(bundle, Enemies.GERUDO_GUARD)),
