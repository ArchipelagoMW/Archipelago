...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.MARKET_BOMBCHU_BOWLING, world, [
        (Locations.MARKET_BOMBCHU_BOWLING_FIRST_PRIZE, lambda bundle: (has_item(Events.COULD_PLAY_BOWLING, bundle) and bombchus_enabled(bundle))),
        (Locations.MARKET_BOMBCHU_BOWLING_SECOND_PRIZE, lambda bundle: (has_item(Events.COULD_PLAY_BOWLING, bundle) and bombchus_enabled(bundle)))
    ])
    # Connections
