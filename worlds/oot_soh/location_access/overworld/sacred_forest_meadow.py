...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.SACRED_FOREST_MEADOW, world, [
        ...
        (Locations.SFM_GS, lambda bundle: is_adult(bundle) and hookshot_or_boomerang(bundle) and can_get_nighttime_gs(bundle)),
        (Locations.SFM_MAZE_LOWER_GOSSIP_STONE_FAIRY, lambda bundle: call_gossip_fairy_except_suns(bundle)),
        (Locations.SFM_MAZE_LOWER_GOSSIP_STONE_BIG_FAIRY, lambda bundle: can_play_song(Items.SONG_OF_STORMS, bundle)),
        (Locations.SFM_MAZE_UPPER_GOSSIP_STONE_FAIRY, lambda bundle: call_gossip_fairy_except_suns(bundle)),
    ...
    add_locations(Regions.SFM_STORMS_GROTTO, world, [
        ...
        (Locations.SFM_DEKU_SCRUB_GROTTO_REAR, lambda bundle: can_stun_deku(bundle)),
        (Locations.SFM_DEKU_SCRUB_GROTTO_BEEHIVE, lambda bundle: can_break_upper_beehives(bundle)),
    ])
    # Connections
