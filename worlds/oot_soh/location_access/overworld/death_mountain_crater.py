...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.DMC_UPPER_LOCAL, world, [
        ...
        (Locations.DMC_GOSSIP_STONE, lambda bundle: has_explosives(bundle) and (fire_timer(bundle) >= 16 or hearts(bundle) >= 3)),
    ...
    connect_regions(Regions.DMC_LOWER_LOCAL, world, [
        ...
        (Regions.GC_DARUNIAS_CHAMBER, lambda bundle: fire_timer(bundle) >= 8 or hearts(bundle) >= 3),
    ...
    add_locations(Regions.DMC_UPPER_GROTTO, world, [
        ...
        (Locations.DMC_UPPER_GROTTO_GOSSIP_STONE, lambda bundle: has_bottle(bundle)),
