...
class EventLocations(str, Enum):
    ...
    KOKIRI_FOREST_STORMS_GROTTO_GOSSIP_STONE = "Kokiri Forest Storms Grotto Gossip Stone"
...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.KOKIRI_FOREST, world, [
        ...
        (Locations.KF_CHILD_GRASS1, lambda bundle: (is_child(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_CHILD_GRASS2, lambda bundle: (is_child(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_CHILD_GRASS3, lambda bundle: (is_child(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_CHILD_GRASS4, lambda bundle: (is_child(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_CHILD_GRASS5, lambda bundle: (is_child(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_CHILD_GRASS6, lambda bundle: (is_child(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_CHILD_GRASS7, lambda bundle: (is_child(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_CHILD_GRASS8, lambda bundle: (is_child(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_CHILD_GRASS9, lambda bundle: (is_child(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_CHILD_GRASS10, lambda bundle: (is_child(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_CHILD_GRASS11, lambda bundle: (is_child(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_CHILD_GRASS12, lambda bundle: (is_child(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_CHILD_GRASS_MAZE1, lambda bundle: (is_child(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_CHILD_GRASS_MAZE2, lambda bundle: (is_child(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_CHILD_GRASS_MAZE3, lambda bundle: (is_child(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_ADULT_GRASS1, lambda bundle: (is_adult(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_ADULT_GRASS2, lambda bundle: (is_adult(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_ADULT_GRASS3, lambda bundle: (is_adult(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_ADULT_GRASS4, lambda bundle: (is_adult(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_ADULT_GRASS5, lambda bundle: (is_adult(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_ADULT_GRASS6, lambda bundle: (is_adult(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_ADULT_GRASS7, lambda bundle: (is_adult(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_ADULT_GRASS8, lambda bundle: (is_adult(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_ADULT_GRASS9, lambda bundle: (is_adult(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_ADULT_GRASS10, lambda bundle: (is_adult(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_ADULT_GRASS11, lambda bundle: (is_adult(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_ADULT_GRASS12, lambda bundle: (is_adult(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_ADULT_GRASS13, lambda bundle: (is_adult(bundle) and can_cut_shrubs(bundle))),
        (Locations.KF_ADULT_GRASS14, lambda bundle: (is_adult(bundle) and can_cut_shrubs(bundle))),
    ...
    add_events(Regions.KF_STORMS_GROTTO, world, [
        (EventLocations.KOKIRI_FOREST_STORMS_GROTTO_GOSSIP_STONE, Events.CAN_ACCESS_FAIRIES, lambda bundle: (call_gossip_fairy(bundle))),
