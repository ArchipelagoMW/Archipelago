...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_events(Regions.THE_GRAVEYARD, world, [
        ...
        (EventLocations.GRAVEYARD_BEAN_PATCH, LocalEvents.GRAVEYARD_BEAN_PLANTED, lambda bundle: is_child(bundle) and can_use(Items.MAGIC_BEAN, bundle)),
    ])
    # Locations
    add_locations(Regions.THE_GRAVEYARD, world, [
        (Locations.GRAVEYARD_FREESTANDING_POH, lambda bundle: (((is_adult(bundle) and has_item(LocalEvents.GRAVEYARD_BEAN_PLANTED, bundle)) or can_use(Items.LONGSHOT, bundle)) and can_break_crates(bundle)) or (can_do_trick(Tricks.GY_POH, bundle) and can_use(Items.BOOMERANG, bundle))),
        ...
        (Locations.GRAVEYARD_BEAN_SPROUT_FAIRY1, lambda bundle: is_child(bundle) and can_use(Items.MAGIC_BEAN, bundle) and can_use(Items.SONG_OF_STORMS, bundle)),
        (Locations.GRAVEYARD_BEAN_SPROUT_FAIRY2, lambda bundle: is_child(bundle) and can_use(Items.MAGIC_BEAN, bundle) and can_use(Items.SONG_OF_STORMS, bundle)),
        (Locations.GRAVEYARD_BEAN_SPROUT_FAIRY3, lambda bundle: is_child(bundle) and can_use(Items.MAGIC_BEAN, bundle) and can_use(Items.SONG_OF_STORMS, bundle)),
        (Locations.GRAVEYARD_GRASS1, lambda bundle: can_cut_shrubs(bundle)),
        (Locations.GRAVEYARD_GRASS2, lambda bundle: can_cut_shrubs(bundle)),
        (Locations.GRAVEYARD_GRASS3, lambda bundle: can_cut_shrubs(bundle)),
        (Locations.GRAVEYARD_GRASS4, lambda bundle: can_cut_shrubs(bundle)),
        (Locations.GRAVEYARD_GRASS5, lambda bundle: can_cut_shrubs(bundle)),
        (Locations.GRAVEYARD_GRASS6, lambda bundle: can_cut_shrubs(bundle)),
        (Locations.GRAVEYARD_GRASS7, lambda bundle: can_cut_shrubs(bundle)),
        (Locations.GRAVEYARD_GRASS8, lambda bundle: can_cut_shrubs(bundle)),
        (Locations.GRAVEYARD_GRASS9, lambda bundle: can_cut_shrubs(bundle)),
        ...
        (Locations.GRAVEYARD_FREESTANDING_POH_CRATE, lambda bundle: (is_adult(bundle) and has_item(LocalEvents.GRAVEYARD_BEAN_PLANTED, bundle)) or can_use(Items.LONGSHOT, bundle) and can_break_crates(bundle))
    ...
    connect_regions(Regions.GRAVEYARD_SHIELD_GRAVE, world, [
        ...
        (Regions.GRAVEYARD_SHIELD_GRAVE_BACK, lambda bundle: can_break_mud_walls(bundle))
    ])
    ...
    add_locations(Regions.GRAVEYARD_HEART_PIECE_GRAVE, world, [
        (Locations.GRAVEYARD_HEART_PIECE_GRAVE_CHEST, lambda bundle: can_use(Items.SUNS_SONG, bundle))
    ])
    # Connections
    ...
    add_locations(Regions.GRAVEYARD_COMPOSERS_GRAVE, world, [
        (Locations.GRAVEYARD_ROYAL_FAMILYS_TOMB_CHEST, lambda bundle: has_fire_source(bundle)),
        (Locations.SONG_FROM_ROYAL_FAMILYS_TOMB, lambda bundle: can_use_projectile(bundle) or can_jump_slash(bundle)),
        (Locations.GRAVEYARD_ROYAL_FAMILYS_TOMB_SUNS_SONG_FAIRY, lambda bundle: can_use(Items.SUNS_SONG, bundle))
    ])
    # Connections
    ...
    add_locations(Regions.GRAVEYARD_DAMPES_GRAVE, world, [
        ...
        (Locations.GRAVEYARD_DAMPES_GRAVE_POT4, lambda bundle: can_break_pots(bundle)),
        (Locations.GRAVEYARD_DAMPES_GRAVE_POT5, lambda bundle: can_break_pots(bundle)),
        (Locations.GRAVEYARD_DAMPES_GRAVE_POT6, lambda bundle: can_break_pots(bundle)),
    ...
    add_locations(Regions.GRAVEYARD_WARP_PAD_REGION, world, [
        ...
        (Locations.GRAVEYARD_GOSSIP_STONE_BIG_FAIRY, lambda bundle: can_use(Items.SONG_OF_STORMS, bundle))
    ])
    # Connections
