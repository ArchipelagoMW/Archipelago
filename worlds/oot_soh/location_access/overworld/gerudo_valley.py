...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.GV_UPPER_STREAM, world, [
        ...
        (Locations.GV_GOSSIP_STONE_BIG_FAIRY, lambda bundle: can_use(Items.SONG_OF_STORMS, bundle)),
        (Locations.GV_NEAR_COW_CRATE, lambda bundle: is_child(bundle) and can_break_crates(bundle)),
    ])
    # Connections
    ...
    connect_regions(Regions.GV_GROTTO_LEDGE, world, [
        ...
        (Regions.GV_LOWER_STREAM,
         lambda bundle: has_item(Items.BRONZE_SCALE, bundle) or can_use(Items.IRON_BOOTS, bundle)),
        (Regions.GV_OCTOROK_GROTTO, lambda bundle: can_use(Items.SILVER_GAUNTLETS, bundle)),
    ...
    add_locations(Regions.GV_CRATE_LEDGE, world, [
        ...
        (Locations.GV_FREESTANDING_POH_CRATE, lambda bundle: can_break_crates(bundle)),
    ])
    # Connections
    ...
    add_locations(Regions.GV_FORTRESS_SIDE, world, [
        ...
        (Locations.GV_TRADE_SAW, lambda bundle: is_adult(bundle) and can_use(Items.POACHERS_SAW, bundle)),
        ...
        (Locations.GV_GS_PILLAR,
         lambda bundle: is_adult(bundle) and hookshot_or_boomerang(bundle) and can_get_nighttime_gs(bundle)),
        (Locations.GV_NEAR_BRIDGE_CRATE1, lambda bundle: is_child(bundle) and can_break_crates(bundle)),
        (Locations.GV_NEAR_BRIDGE_CRATE2, lambda bundle: is_child(bundle) and can_break_crates(bundle)),
        (Locations.GV_NEAR_BRIDGE_CRATE3, lambda bundle: is_child(bundle) and can_break_crates(bundle)),
        (Locations.GV_NEAR_BRIDGE_CRATE4, lambda bundle: is_child(bundle) and can_break_crates(bundle)),
    ])
    # Connections
    connect_regions(Regions.GV_FORTRESS_SIDE, world, [
        ...
        (Regions.GV_STORMS_GROTTO, lambda bundle: is_adult(bundle) and can_open_storms_grotto(bundle)),
