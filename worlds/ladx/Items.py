...
links_awakening_items = [
    ...
    ItemData(ItemName.RUPEES_20, "RUPEES_20", ItemClassification.Philler),
    ...
    ItemData(ItemName.HEART_PIECE, "HEART_PIECE", ItemClassification.Philler),
    ItemData(ItemName.BOWWOW, "BOWWOW", ItemClassification.progression),
    ItemData(ItemName.ARROWS_10, "ARROWS_10", ItemClassification.Philler),
    ItemData(ItemName.SINGLE_ARROW, "SINGLE_ARROW", ItemClassification.Philler),
    ItemData(ItemName.ROOSTER, "ROOSTER", ItemClassification.progression),
    ItemData(ItemName.MAX_POWDER_UPGRADE, "MAX_POWDER_UPGRADE", ItemClassification.Philler),
    ItemData(ItemName.MAX_BOMBS_UPGRADE, "MAX_BOMBS_UPGRADE", ItemClassification.Philler),
    ItemData(ItemName.MAX_ARROWS_UPGRADE, "MAX_ARROWS_UPGRADE", ItemClassification.Philler),
    ...
    DungeonItemData(ItemName.MAP, "MAP", ItemClassification.Philler),
    DungeonItemData(ItemName.MAP1, "MAP1", ItemClassification.Philler),
    DungeonItemData(ItemName.MAP2, "MAP2", ItemClassification.Philler),
    DungeonItemData(ItemName.MAP3, "MAP3", ItemClassification.Philler),
    DungeonItemData(ItemName.MAP4, "MAP4", ItemClassification.Philler),
    DungeonItemData(ItemName.MAP5, "MAP5", ItemClassification.Philler),
    DungeonItemData(ItemName.MAP6, "MAP6", ItemClassification.Philler),
    DungeonItemData(ItemName.MAP7, "MAP7", ItemClassification.Philler),
    DungeonItemData(ItemName.MAP8, "MAP8", ItemClassification.Philler),
    DungeonItemData(ItemName.MAP9, "MAP9", ItemClassification.Philler),
    DungeonItemData(ItemName.COMPASS, "COMPASS", ItemClassification.Philler),
    DungeonItemData(ItemName.COMPASS1, "COMPASS1", ItemClassification.Philler),
    DungeonItemData(ItemName.COMPASS2, "COMPASS2", ItemClassification.Philler),
    DungeonItemData(ItemName.COMPASS3, "COMPASS3", ItemClassification.Philler),
    DungeonItemData(ItemName.COMPASS4, "COMPASS4", ItemClassification.Philler),
    DungeonItemData(ItemName.COMPASS5, "COMPASS5", ItemClassification.Philler),
    DungeonItemData(ItemName.COMPASS6, "COMPASS6", ItemClassification.Philler),
    DungeonItemData(ItemName.COMPASS7, "COMPASS7", ItemClassification.Philler),
    DungeonItemData(ItemName.COMPASS8, "COMPASS8", ItemClassification.Philler),
    DungeonItemData(ItemName.COMPASS9, "COMPASS9", ItemClassification.Philler),
    DungeonItemData(ItemName.STONE_BEAK, "STONE_BEAK", ItemClassification.Philler),
    DungeonItemData(ItemName.STONE_BEAK1, "STONE_BEAK1", ItemClassification.Philler),
    DungeonItemData(ItemName.STONE_BEAK2, "STONE_BEAK2", ItemClassification.Philler),
    DungeonItemData(ItemName.STONE_BEAK3, "STONE_BEAK3", ItemClassification.Philler),
    DungeonItemData(ItemName.STONE_BEAK4, "STONE_BEAK4", ItemClassification.Philler),
    DungeonItemData(ItemName.STONE_BEAK5, "STONE_BEAK5", ItemClassification.Philler),
    DungeonItemData(ItemName.STONE_BEAK6, "STONE_BEAK6", ItemClassification.Philler),
    DungeonItemData(ItemName.STONE_BEAK7, "STONE_BEAK7", ItemClassification.Philler),
    DungeonItemData(ItemName.STONE_BEAK8, "STONE_BEAK8", ItemClassification.Philler),
    DungeonItemData(ItemName.STONE_BEAK9, "STONE_BEAK9", ItemClassification.Philler),
