...
hexcells_infinite_locations = {
    ...
    "Level 10": LocData(750010, "Level Group 2"),
    "Level 11": LocData(750011, "Level Group 2"),
    "Level 12": LocData(750012, "Level Group 2"),

    "Level 13": LocData(750013, "Level Group 3"),
    "Level 14": LocData(750014, "Level Group 3"),
    "Level 15": LocData(750015, "Level Group 3"), 
    "Level 16": LocData(750016, "Level Group 3"),
    "Level 17": LocData(750017, "Level Group 3"),
    "Level 18": LocData(750018, "Level Group 3"),

    "Level 19": LocData(750019, "Level Group 4"),
    "Level 20": LocData(750020, "Level Group 4"),
    "Level 21": LocData(750021, "Level Group 4"),
    "Level 22": LocData(750022, "Level Group 4"),
    "Level 23": LocData(750023, "Level Group 4"),
    "Level 24": LocData(750024, "Level Group 4"),

    "Level 25": LocData(750025, "Level Group 5"),
    "Level 26": LocData(750026, "Level Group 5"),
    "Level 27": LocData(750027, "Level Group 5"),
    "Level 28": LocData(750028, "Level Group 5"),
    "Level 29": LocData(750029, "Level Group 5"),
    "Level 30": LocData(750030, "Level Group 5"),

    "Level 31": LocData(750031, "Level Group 6"),
    "Level 32": LocData(750032, "Level Group 6"),
    "Level 33": LocData(750033, "Level Group 6"),
    "Level 34": LocData(750034, "Level Group 6"),
    "Level 35": LocData(750035, "Level Group 6"),
    "Level 36": LocData(750036, "Level Group 6")
