...
- Every minor pickup (Missile/Power Bomb/Energy Tanks)
- Every major upgrade (including the Ice Beam)
- Every location where the above is found (the ARC Data Room only once)
- The six additional locations mentioned above.

## What items from Metroid Fusion can appear in other players' worlds?

All items can appear in other players' worlds.

## What does another world's item look like in Metroid Fusion?

All local items appear as normal. Remote items from other Metroid games will appear with a corresponding Fusion sprite.
All other remote items will appear as a ? (question mark) pickup.
