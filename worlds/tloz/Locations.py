...
level_locations = [
    [
        "Level 1 Item (Bow)", "Level 1 Item (Boomerang)", "Level 1 Boss",
    ...
    [
        "Level 2 Item (Magical Boomerang)", "Level 2 Boss", "Level 2 Triforce",
    ...
    [
        "Level 3 Item (Raft)", "Level 3 Boss", "Level 3 Triforce",
        "Level 3 Key Drop (Zols and Keese)", "Level 3 Key Drop (Keese North)",
    ...
    [
        "Level 6 Item (Magical Rod)", "Level 6 Boss", "Level 6 Triforce",
    ...
    [
        "Level 7 Item (Red Candle)", "Level 7 Boss", "Level 7 Triforce",
    ...
    [
        "Level 8 Item (Magical Key)", "Level 8 Item (Book of Magic)", "Level 8 Boss",
...
floor_location_game_offsets_early = {
    ...
    "Level 3 Key Drop (Zols and Keese)": 0x49,
...
floor_location_game_offsets_late = {
    ...
    "Level 8 Bomb Drop (Pols Voice North)": 0x3F,
    "Level 8 Rupee Drop (Manhandla Entrance West)": 0x7D,
    "Level 8 Rupee Drop (Manhandla Entrance North)": 0x4E,
    "Level 8 Rupee Drop (Darknuts and Gibdos)": 0x6E,
