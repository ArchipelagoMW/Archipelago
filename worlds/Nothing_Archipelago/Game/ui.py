...
class UI:
    ...
    def display_timer(self,data):
        ...
        if self.playing_state == 1:
            ...
            text_rect6 = text_surf6.get_frect(center = (data.WINDOW_WIDTH/2,data.WINDOW_HEIGHT/2))
            ...
            text_rect6 = text_surf6.get_frect(center = (data.WINDOW_WIDTH/2,data.WINDOW_HEIGHT/2-20))
            text_surf7 = self.font.render(timeformated,False,data.colors[data.colorselect][1])
            text_rect7 = text_surf7.get_frect(center = (data.WINDOW_WIDTH/2,data.WINDOW_HEIGHT/2+20))
            self.display_surface.blit(text_surf6, text_rect6)
    ...
    def display_shop(self,data):
        ...
        self.shopbutton1.updatetl(data.shop[data.shopstate][0][0],40,data.WINDOW_HEIGHT/4+20,data.colors[data.colorselect][1],0)
        self.shopbutton2.updatetl(data.shop[data.shopstate][1][0],40,data.WINDOW_HEIGHT/4+60,data.colors[data.colorselect][1],0)
        self.shopbutton3.updatetl(data.shop[data.shopstate][2][0],40,data.WINDOW_HEIGHT/4+100,data.colors[data.colorselect][1],0)
        self.shopbutton4.updatetl(data.shop[data.shopstate][3][0],40,data.WINDOW_HEIGHT/4+140,data.colors[data.colorselect][1],0)
        self.shopbutton5.updatetl(data.shop[data.shopstate][4][0],40,data.WINDOW_HEIGHT/4+180,data.colors[data.colorselect][1],0)
        self.shopbutton6.updatetl(data.shop[data.shopstate][5][0],40,data.WINDOW_HEIGHT/4+220,data.colors[data.colorselect][1],0)
        self.shopbutton7.updatetl(data.shop[data.shopstate][6][0],40,data.WINDOW_HEIGHT/4+260,data.colors[data.colorselect][1],0)
    ...
    def display_pointer(self,data):
        ...
        text_rect = text_surf.get_frect(center = (data.WINDOW_WIDTH/2,40))
    ...
    def display_digits(self,data):
        ...
        text_rect3 = text_surf3.get_frect(center = (data.WINDOW_WIDTH/2,data.WINDOW_HEIGHT/2+100))
    ...
    def display_timecap(self,data):
        ...
        text_rect2 = text_surf2.get_frect(center = (data.WINDOW_WIDTH/2,data.WINDOW_HEIGHT/2+60))
    ...
    def display_startmenu(self,data):
        ...
        text_rect = text_surf.get_frect(center = (data.WINDOW_WIDTH/2,data.WINDOW_HEIGHT/2-360))
        self.display_surface.blit(text_surf, text_rect)
                    ...
                    if self.delta2 > 8:
                        ...
                        if self.delta2 > 10:
                            ...
                            if self.delta2 > 12:
                                ...
                                self.display_surface.blit(text_surf7, text_rect7)
                                if self.delta2 > 14:
                                    self.continuebutton.updatec("[CONUTINUE]",data.WINDOW_WIDTH/2,data.WINDOW_HEIGHT/2+160,data.colors[data.colorselect][1],1)
