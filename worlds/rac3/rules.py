...
GOOD_EXP_PLANETS = [RAC3ITEM.KOROS, RAC3ITEM.COMMAND_CENTER, RAC3ITEM.CRASH_SITE, RAC3ITEM.METROPOLIS]
...
def set_rules(world: "RaC3World"):
    ...
    rules_dict: dict[str, Callable] = {
        ...
        RAC3WEAPONLEVEL.SHOCK_BLASTER_V6: lambda state: state.has(RAC3ITEM.SHOCK_BLASTER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.SHOCK_BLASTER_V7: lambda state: state.has(RAC3ITEM.SHOCK_BLASTER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.SHOCK_BLASTER_V8: lambda state: state.has(RAC3ITEM.SHOCK_BLASTER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        ...
        RAC3WEAPONLEVEL.NITRO_LAUNCHER_V6: lambda state: state.has(RAC3ITEM.NITRO_LAUNCHER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.NITRO_LAUNCHER_V7: lambda state: state.has(RAC3ITEM.NITRO_LAUNCHER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.NITRO_LAUNCHER_V8: lambda state: state.has(RAC3ITEM.NITRO_LAUNCHER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        ...
        RAC3WEAPONLEVEL.PLASMA_WHIP_V6: lambda state: state.has(RAC3ITEM.PLASMA_WHIP, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.PLASMA_WHIP_V7: lambda state: state.has(RAC3ITEM.PLASMA_WHIP, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.PLASMA_WHIP_V8: lambda state: state.has(RAC3ITEM.PLASMA_WHIP, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        ...
        RAC3WEAPONLEVEL.N60_STORM_V6: lambda state: state.has(RAC3ITEM.N60_STORM, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.N60_STORM_V7: lambda state: state.has(RAC3ITEM.N60_STORM, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.N60_STORM_V8: lambda state: state.has(RAC3ITEM.N60_STORM, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        ...
        RAC3WEAPONLEVEL.INFECTOR_V6: lambda state: state.has(RAC3ITEM.INFECTOR, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.INFECTOR_V7: lambda state: state.has(RAC3ITEM.INFECTOR, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.INFECTOR_V8: lambda state: state.has(RAC3ITEM.INFECTOR, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        ...
        RAC3WEAPONLEVEL.SUCK_CANNON_V6: lambda state: state.has(RAC3ITEM.SUCK_CANNON, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.SUCK_CANNON_V7: lambda state: state.has(RAC3ITEM.SUCK_CANNON, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.SUCK_CANNON_V8: lambda state: state.has(RAC3ITEM.SUCK_CANNON, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        ...
        RAC3WEAPONLEVEL.SPITTING_HYDRA_V6: lambda state: state.has(RAC3ITEM.SPITTING_HYDRA, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.SPITTING_HYDRA_V7: lambda state: state.has(RAC3ITEM.SPITTING_HYDRA, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.SPITTING_HYDRA_V8: lambda state: state.has(RAC3ITEM.SPITTING_HYDRA, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        ...
        RAC3WEAPONLEVEL.AGENTS_OF_DOOM_V6: lambda state: state.has(RAC3ITEM.AGENTS_OF_DOOM, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.AGENTS_OF_DOOM_V7: lambda state: state.has(RAC3ITEM.AGENTS_OF_DOOM, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.AGENTS_OF_DOOM_V8: lambda state: state.has(RAC3ITEM.AGENTS_OF_DOOM, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        ...
        RAC3WEAPONLEVEL.FLUX_RIFLE_V6: lambda state: state.has(RAC3ITEM.FLUX_RIFLE, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.FLUX_RIFLE_V7: lambda state: state.has(RAC3ITEM.FLUX_RIFLE, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.FLUX_RIFLE_V8: lambda state: state.has(RAC3ITEM.FLUX_RIFLE, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        ...
        RAC3WEAPONLEVEL.LAVA_GUN_V6: lambda state: state.has(RAC3ITEM.LAVA_GUN, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.LAVA_GUN_V7: lambda state: state.has(RAC3ITEM.LAVA_GUN, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.LAVA_GUN_V8: lambda state: state.has(RAC3ITEM.LAVA_GUN, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        ...
        RAC3WEAPONLEVEL.MINI_TURRET_V6: lambda state: state.has(RAC3ITEM.MINI_TURRET, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.MINI_TURRET_V7: lambda state: state.has(RAC3ITEM.MINI_TURRET, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.MINI_TURRET_V8: lambda state: state.has(RAC3ITEM.MINI_TURRET, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        ...
        RAC3WEAPONLEVEL.ANNIHILATOR_V6: lambda state: state.has(RAC3ITEM.ANNIHILATOR, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.ANNIHILATOR_V7: lambda state: state.has(RAC3ITEM.ANNIHILATOR, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.ANNIHILATOR_V8: lambda state: state.has(RAC3ITEM.ANNIHILATOR, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        ...
        RAC3WEAPONLEVEL.HOLO_SHIELD_V6: lambda state: state.has(RAC3ITEM.HOLO_SHIELD, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.HOLO_SHIELD_V7: lambda state: state.has(RAC3ITEM.HOLO_SHIELD, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.HOLO_SHIELD_V8: lambda state: state.has(RAC3ITEM.HOLO_SHIELD, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        ...
        RAC3WEAPONLEVEL.DISC_BLADE_V6: lambda state: state.has(RAC3ITEM.DISC_BLADE, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.DISC_BLADE_V7: lambda state: state.has(RAC3ITEM.DISC_BLADE, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.DISC_BLADE_V8: lambda state: state.has(RAC3ITEM.DISC_BLADE, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        ...
        RAC3WEAPONLEVEL.RIFT_INDUCER_V6: lambda state: state.has(RAC3ITEM.RIFT_INDUCER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.RIFT_INDUCER_V7: lambda state: state.has(RAC3ITEM.RIFT_INDUCER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.RIFT_INDUCER_V8: lambda state: state.has(RAC3ITEM.RIFT_INDUCER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        ...
        RAC3WEAPONLEVEL.QWACK_O_RAY_V6: lambda state: state.has(RAC3ITEM.QWACK_O_RAY, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.QWACK_O_RAY_V7: lambda state: state.has(RAC3ITEM.QWACK_O_RAY, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.QWACK_O_RAY_V8: lambda state: state.has(RAC3ITEM.QWACK_O_RAY, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.BOUNCER_V2: lambda state: state.has(RAC3ITEM.BOUNCER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.BOUNCER_V3: lambda state: state.has(RAC3ITEM.BOUNCER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.BOUNCER_V4: lambda state: state.has(RAC3ITEM.BOUNCER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.BOUNCER_V5: lambda state: state.has(RAC3ITEM.BOUNCER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.BOUNCER_V6: lambda state: state.has(RAC3ITEM.BOUNCER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.BOUNCER_V7: lambda state: state.has(RAC3ITEM.BOUNCER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.BOUNCER_V8: lambda state: state.has(RAC3ITEM.BOUNCER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.PLASMA_COIL_V2: lambda state: state.has(RAC3ITEM.PLASMA_COIL, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.PLASMA_COIL_V3: lambda state: state.has(RAC3ITEM.PLASMA_COIL, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.PLASMA_COIL_V4: lambda state: state.has(RAC3ITEM.PLASMA_COIL, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.PLASMA_COIL_V5: lambda state: state.has(RAC3ITEM.PLASMA_COIL, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.PLASMA_COIL_V6: lambda state: state.has(RAC3ITEM.PLASMA_COIL, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.PLASMA_COIL_V7: lambda state: state.has(RAC3ITEM.PLASMA_COIL, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.PLASMA_COIL_V8: lambda state: state.has(RAC3ITEM.PLASMA_COIL, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.SHIELD_CHARGER_V2: lambda state: state.has(RAC3ITEM.SHIELD_CHARGER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.SHIELD_CHARGER_V3: lambda state: state.has(RAC3ITEM.SHIELD_CHARGER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.SHIELD_CHARGER_V4: lambda state: state.has(RAC3ITEM.SHIELD_CHARGER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.SHIELD_CHARGER_V5: lambda state: state.has(RAC3ITEM.SHIELD_CHARGER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.SHIELD_CHARGER_V6: lambda state: state.has(RAC3ITEM.SHIELD_CHARGER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.SHIELD_CHARGER_V7: lambda state: state.has(RAC3ITEM.SHIELD_CHARGER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.SHIELD_CHARGER_V8: lambda state: state.has(RAC3ITEM.SHIELD_CHARGER, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.RY3N0_V2: lambda state: state.has(RAC3ITEM.RY3N0, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.RY3N0_V3: lambda state: state.has(RAC3ITEM.RY3N0, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.RY3N0_V4: lambda state: state.has(RAC3ITEM.RY3N0, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
        RAC3WEAPONLEVEL.RY3N0_V5: lambda state: state.has(RAC3ITEM.RY3N0, world.player) and state.has_any(GOOD_EXP_PLANETS, world.player),
    }
