...
def set_rules(world: "RaC3World"):
    ...
    rules_dict: dict[str, Callable] = {
        ...
        #RAC3VENDORLOCATION.PHOENIX_WINGS_1
        #RAC3VENDORLOCATION.PHOENIX_WINGS_2
        #RAC3VENDORLOCATION.PHOENIX_WINGS_3
        #RAC3VENDORLOCATION.PHOENIX_NOSE_1
        #RAC3VENDORLOCATION.PHOENIX_NOSE_2
        #RAC3VENDORLOCATION.PHOENIX_NOSE_3
        RAC3VENDORLOCATION.PHOENIX_SKIN_1: lambda state: state.has_from_list(infobot_data.keys(), world.player, 1),
        RAC3VENDORLOCATION.PHOENIX_SKIN_2: lambda state: state.has_from_list(infobot_data.keys(), world.player, 1),
        RAC3VENDORLOCATION.PHOENIX_SKIN_3: lambda state: state.has_from_list(infobot_data.keys(), world.player, 1),
        RAC3VENDORLOCATION.PHOENIX_SKIN_4: lambda state: state.has_from_list(infobot_data.keys(), world.player, 2),
        RAC3VENDORLOCATION.PHOENIX_SKIN_5: lambda state: state.has_from_list(infobot_data.keys(), world.player, 2),
        RAC3VENDORLOCATION.PHOENIX_SKIN_6: lambda state: state.has_from_list(infobot_data.keys(), world.player, 2),
        RAC3VENDORLOCATION.PHOENIX_SKIN_7: lambda state: state.has_from_list(infobot_data.keys(), world.player, 3),
        RAC3VENDORLOCATION.PHOENIX_SKIN_8: lambda state: state.has_from_list(infobot_data.keys(), world.player, 3),
        RAC3VENDORLOCATION.PHOENIX_SKIN_9: lambda state: state.has_from_list(infobot_data.keys(), world.player, 3),
        RAC3VENDORLOCATION.PHOENIX_SKIN_10: lambda state: state.has_from_list(infobot_data.keys(), world.player, 4),
        RAC3VENDORLOCATION.PHOENIX_SKIN_11: lambda state: state.has_from_list(infobot_data.keys(), world.player, 4),
        RAC3VENDORLOCATION.PHOENIX_SKIN_12: lambda state: state.has_from_list(infobot_data.keys(), world.player, 4),
        RAC3VENDORLOCATION.PHOENIX_SKIN_13: lambda state: state.has_from_list(infobot_data.keys(), world.player, 5),
        RAC3VENDORLOCATION.PHOENIX_SKIN_14: lambda state: state.has_from_list(infobot_data.keys(), world.player, 5),
        RAC3VENDORLOCATION.PHOENIX_SKIN_15: lambda state: state.has_from_list(infobot_data.keys(), world.player, 5),
        RAC3VENDORLOCATION.PHOENIX_SKIN_16: lambda state: state.has_from_list(infobot_data.keys(), world.player, 6),
        RAC3VENDORLOCATION.PHOENIX_SKIN_17: lambda state: state.has_from_list(infobot_data.keys(), world.player, 6),
        RAC3VENDORLOCATION.PHOENIX_SKIN_18: lambda state: state.has_from_list(infobot_data.keys(), world.player, 6),
        RAC3VENDORLOCATION.PHOENIX_SKIN_19: lambda state: state.has_from_list(infobot_data.keys(), world.player, 7),
        RAC3VENDORLOCATION.PHOENIX_SKIN_20: lambda state: state.has_from_list(infobot_data.keys(), world.player, 7),
        RAC3VENDORLOCATION.PHOENIX_SKIN_21: lambda state: state.has_from_list(infobot_data.keys(), world.player, 7),
        RAC3VENDORLOCATION.PHOENIX_SKIN_22: lambda state: state.has_from_list(infobot_data.keys(), world.player, 8),
        RAC3VENDORLOCATION.PHOENIX_SKIN_23: lambda state: state.has_from_list(infobot_data.keys(), world.player, 8),
        RAC3VENDORLOCATION.PHOENIX_SKIN_24: lambda state: state.has_from_list(infobot_data.keys(), world.player, 8),
        RAC3VENDORLOCATION.PHOENIX_SKIN_25: lambda state: state.has_from_list(infobot_data.keys(), world.player, 9),
        RAC3VENDORLOCATION.PHOENIX_SKIN_26: lambda state: state.has_from_list(infobot_data.keys(), world.player, 9),
        RAC3VENDORLOCATION.PHOENIX_SKIN_27: lambda state: state.has_from_list(infobot_data.keys(), world.player, 9),
        RAC3VENDORLOCATION.PHOENIX_SKIN_28: lambda state: state.has_from_list(infobot_data.keys(), world.player, 10),
        RAC3VENDORLOCATION.PHOENIX_SKIN_29: lambda state: state.has_from_list(infobot_data.keys(), world.player, 10),
        RAC3VENDORLOCATION.PHOENIX_SKIN_30: lambda state: state.has_from_list(infobot_data.keys(), world.player, 10),
        RAC3VENDORLOCATION.PHOENIX_SKIN_31: lambda state: state.has_from_list(infobot_data.keys(), world.player, 11),
        RAC3VENDORLOCATION.PHOENIX_SKIN_32: lambda state: state.has_from_list(infobot_data.keys(), world.player, 11),
