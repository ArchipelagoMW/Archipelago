...
ITEM_TO_STRING_TABLE_INDEX_OFFSET: dict[str, int] = {
    ...
    RAC3ITEM.SHIELD_CHARGER: 0x0BD0,
    RAC3ITEM.RY3N0: 0x0780,
    RAC3ITEM.MAGNAPLATE: 0x12B0,
    RAC3ITEM.ADAMANTINE: 0x12F0,
    RAC3ITEM.AEGIS: 0x1330,
    RAC3ITEM.INFERNOX: 0x1310,
}
