...
class NanotechLimitation(Range):
    """
    Determines the upper limit of the number of nanotech milestone locations in the multiworld between 1 and 90.
    ...
    Example: If set to 40 then you only need to level up 40 times so up to nanotech level 50.
    Any more won't count as checks.
