...
class Rangers(Choice):
    ...
    these are the following: all Marcadia, Blackwater City, Aridia mission.
    Optional Missions: Ranger Missions that are optional in the main game, and anything directly locked behind them,
    are added as locations, these are the following:
    Tyhrranosis: Operation ISLAND STRIKE and Metropolis: Operation URBAN STORM missions
