...
Currently, weapon vendors and some gadget checks are being sent out when you receive them as items. The best action to
take is to put **Gadgets** and **Weapons** into the exclusion list, this makes them always contain filler items (e.g.
jackpot mode, bolts).
