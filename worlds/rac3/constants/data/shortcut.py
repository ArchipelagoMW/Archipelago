...
RAC3_SHORTCUT_DATA_TABLE: dict[str, RAC3SHORTCUTDATA] = {
    ...
    RAC3SHORTCUTS.FLORANA_BRIDGE: RAC3SHORTCUTDATA(RAC3REGION.FLORANA,
                                                   [[RAC3ITEM.HELI_PACK], [RAC3ITEM.CLANK], [RAC3ITEM.PROGRESSIVE_PACK],
    ...
    RAC3SHORTCUTS.TYHRRANOSIS_INTRO: RAC3SHORTCUTDATA(RAC3REGION.TYHRRANOSIS,
                                                      flag=[RAC3PROGRESSFLAG.TYHRRANOSIS_COMPLETE_PROLOGUE,
                                                            RAC3PROGRESSFLAG.TYHRRANOSIS_COMPLETE_PROLOGUE_MISSION]),
    ...
    RAC3SHORTCUTS.KOROS_TELEPORTER: RAC3SHORTCUTDATA(RAC3REGION.KOROS,
                                                     flag=[RAC3PROGRESSFLAG.KOROS_HALFWAY_CHECKPOINT]),
