...
BASE_WEAPON_TO_OMEGA_WEAPON: dict[str, str] = {
    ...
    RAC3ITEM.MINI_TURRET: RAC3ITEM.MEGA_TURRET_V6,
    RAC3ITEM.LAVA_GUN: RAC3ITEM.LIQUID_NITROGEN_V6,
    RAC3ITEM.SHIELD_CHARGER: RAC3ITEM.TESLA_BARRIER_V6,
    RAC3ITEM.BOUNCER: RAC3ITEM.HEAVY_BOUNCER_V6,
    RAC3ITEM.PLASMA_COIL: RAC3ITEM.PLASMA_STORM_V6,
}
