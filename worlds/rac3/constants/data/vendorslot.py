...
BASE_WEAPON_TO_OMEGA_WEAPON: dict[str, str] = {
    RAC3ITEM.SHOCK_BLASTER: RAC3ITEM.SHOCK_CANNON_V6,
    RAC3ITEM.NITRO_LAUNCHER: RAC3ITEM.NITRO_ERUPTOR_V6,
    RAC3ITEM.PLASMA_WHIP: RAC3ITEM.QUANTUM_WHIP_V6,
    RAC3ITEM.N60_STORM: RAC3ITEM.N90_HURRICANE_V6,
    RAC3ITEM.SUCK_CANNON: RAC3ITEM.VORTEX_CANNON_V6,
    RAC3ITEM.INFECTOR: RAC3ITEM.INFECTO_BOMB_V6,
    RAC3ITEM.SPITTING_HYDRA: RAC3ITEM.TEMPEST_V6,
    RAC3ITEM.AGENTS_OF_DOOM: RAC3ITEM.AGENTS_OF_DREAD_V6,
    RAC3ITEM.FLUX_RIFLE: RAC3ITEM.SPLITTER_RIFLE_V6,
    RAC3ITEM.ANNIHILATOR: RAC3ITEM.DECIMATOR_V6,
    RAC3ITEM.HOLO_SHIELD: RAC3ITEM.ULTRA_SHIELD_V6,
    RAC3ITEM.DISC_BLADE: RAC3ITEM.MULTI_DISC_V6,
    RAC3ITEM.RIFT_INDUCER: RAC3ITEM.RIFT_RIPPER_V6,
    RAC3ITEM.QWACK_O_RAY: RAC3ITEM.QWACK_O_BLITZER_V6,
    # Megacorp needs to have the same base weapon id for mega version to work in the vendor
    RAC3ITEM.MINI_TURRET: RAC3ITEM.MINI_TURRET,
    RAC3ITEM.LAVA_GUN: RAC3ITEM.LAVA_GUN,
    RAC3ITEM.SHIELD_CHARGER: RAC3ITEM.SHIELD_CHARGER,
    RAC3ITEM.BOUNCER: RAC3ITEM.BOUNCER,
    RAC3ITEM.PLASMA_COIL: RAC3ITEM.PLASMA_COIL,
}
