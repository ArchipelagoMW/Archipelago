...
class RAC3LOCATION:
    ...
    NATION_TYHRRA_GUISE = "Annihilation Nation: Grand Prize Bout Reward 1"
    ...
    ZELDRIN_STARPORT_BOLT_GRABBER = "Zeldrin Starport: Explore the port Reward 1"
    ZELDRIN_STARPORT_BOX_BREAKER = "Zeldrin Starport: Explore the port Reward 2"
    ...
    CRASH_SITE_NANO_PAK = "Crash Site: Under the Crashed Ship"
    ...
    KOROS_BASE = "Koros: Fire the Canon"
