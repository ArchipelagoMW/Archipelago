...
location_table: List[LocationDict] = [
    ...
    {"name": "Start Beach Seashell", "id": ID + ID + 1, "needsShovel": False, "purchase": False},
    ...
    {"name": "East Coast Buried Chest", "id": ID + 98, "needsShovel": True, "purchase": False},
    ...
    {"name": "Hawk Peak East Chest", "id": ID + 107, "needsShovel": False, "purchase": False},
    ...
    {"name": "Small South Island Chest", "id": ID + 112, "needsShovel": False, "purchase": False},
    ...
    {"name": "Sunhat Island Chest", "id": ID + 115, "needsShovel": False, "purchase": False},
