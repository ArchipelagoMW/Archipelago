...
item_table: List[ItemDict] = [
    ...
    {"name": "Fishing Rod", "id": base_id + 7, "count": 1, "classification": ItemClassification.progression},
    ...
    {"name": "Shell Necklace", "id": base_id + 12, "count": 1, "classification": ItemClassification.progression_skip_balancing},
    ...
    {"name": "Fishing Journal", "id": base_id + 17, "count": 1, "classification": ItemClassification.progression},
    ...
    {"name": "Headband", "id": base_id + 25, "count": 1, "classification": ItemClassification.progression_skip_balancing},
