...
class TestOverworld(WorldTestBase):
    ...
    def testSurfMinimal(self):
        ...
        self.assertFalse(self.can_reach_entrance("MAP_FORTREE_CITY:2/MAP_FORTREE_CITY_GYM:0"))
        ...
        self.assertTrue(self.can_reach_entrance("MAP_FORTREE_CITY:2/MAP_FORTREE_CITY_GYM:0"))
