...
def get_random_species(random: random, nearby_bst: Optional[int] = None, species_type: Optional[int] = None) -> SpeciesData:
    ...
    return candidate_species[random.randrange(0, len(candidate_species))]
