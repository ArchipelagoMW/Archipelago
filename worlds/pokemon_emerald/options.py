...
class Trainersanity(Toggle):
    ...
    Trainers are no longer missable.
...
class NormalizeEncounterRates(Toggle):
    ...
    This does NOT mean each species is equally likely, but it will always raise the probability of any encounter to at least 8% (higher in water)."""
