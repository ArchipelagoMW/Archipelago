...
LEVEL_DATA = {
    ...
    "Island-5": {
        "name": "Victory Spring",
        "parent": "Island",
        "winLogic": HasAll("Text", "Is", "Float", "Win"),
        "connects": {
            "Island-4": can_win,
            "Island-6": can_win,
            "Island-8": can_win,
    ...
    "Island-Extra 6": {
        ...
        "parent": "Island",
        "winLogic": HasAll("Water", "Is", "Sink", "Flag"),
        "connects": {
            "Island-9": can_win,
            "Island-11": can_win,
        },
    ...
    "Fall-E": {
        "name": "Skeletal Door",
        "parent": "Fall",
        "winLogic": HasAll("Baba", "Is", "You", "Text", "Push"),
        "connects": {
            "Fall-C": can_win,
            "Fall-D": can_win,
        },
    ...
    "Forest-9": {
        "name": "Moving Floor",
        "parent": "Forest",
        "winLogic": HasAll("Flag", "Is", "Push", "Win"),
        "connects": {
            "Forest-3": can_win,
            "Forest-12": can_win,
    ...
    "Space-5": {
        "name": "Horror Story",
        "parent": "Space",
        "winLogic": HasAll("Baba", "Is", "You", "Empty"),
        "connects": {
            "Space-1": can_win,
            "Space-3": can_win,
    ...
    "Space-9": {
        "name": "Platformer",
        "parent": "Space",
        "winLogic": HasAll("Rocket", "And", "UFO", "Open"),
        "connects": {
            "Space-6": can_win,
            "Space-7": can_win,
            "Space-10": can_win,
    ...
    "Chasm-Extra 4": {
        "name": "Alley",
        "parent": "Chasm",
        "winLogic": HasAll("Water", "Is", "Rock", "Push"),
        "connects": {
            "Chasm-Extra 1": can_win,
            "Chasm-Extra 5": can_win,
            "Chasm-Extra 6": can_win,
    ...
    "Cavern-4": {
        "name": "Mouse Hole",
        "parent": "Cavern",
        "winLogic": HasAll("Bat", "Rock", "Is", "Push"),
        "connects": {
            "Cavern-1": can_win,
            "Cavern-2": can_win,
            "Cavern-8": can_win,
    ...
    "Cavern-5": {
        "name": "Torn Apart",
        "parent": "Cavern",
        "winLogic": HasAll("Baba", "Is", "Group", "You"),
        "connects": {
            "Cavern-3": can_win,
            "Cavern-6": can_win,
            "Cavern-7": can_win,
    ...
    "Cavern-13": {
        "name": "Tunnel",
        "parent": "Cavern",
        "winLogic": HasAll("Skull", "Facing", "Is", "Not"),
        "connects": {
            "Cavern-12": can_win,
        },
    },
    ...
    "Mountain-1": {
        "name": "Shuffle",
        "parent": "Mountain",
        "winLogic": HasAll("Lonely", "Baba", "Is", "You", "Skull", "Defeat"),
        "connects": {
            "Mountain": None,
            "Mountain-2": can_win,
            "Mountain-3": can_win,
    ...
    "Mountain-5": {
        "name": "Connector",
        "parent": "Mountain",
        "winLogic": HasAll("Sun", "Baba", "Is", "You", "Shut", "Text"),
        "connects": {
            "Mountain-2": can_win,
            "Mountain-6": can_win,
        },
    ...
    "Mountain-7": {
        ...
        "parent": "Mountain",
        "winLogic": HasAll("Lonely", "Baba", "Is", "Tile", "On", "Flag"),
        "connects": {
            "Mountain-6": can_win,
            "Mountain-7": can_win,
        },
