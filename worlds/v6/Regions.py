...
def create_regions(world: MultiWorld, player: int):
    regOvr = Region("Menu", "Dimension VVVVVV", player, world)
    ...
    regLab = Region("Laboratory", "Laboratory", player, world)
    ...
    regTow = Region("The Tower", "The Tower", player, world)
    ...
    regSp2 = Region("Space Station 2", "Space Station 2", player, world)
    ...
    regWrp = Region("Warp Zone", "Warp Zone", player, world)
