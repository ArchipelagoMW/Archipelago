...
item_table: Dict[int, ItemDict] = {
    ...
    360006: {'classification': ItemClassification.progression,
             ...
             'episode': -1,
             'map': -1},
    360007: {'classification': ItemClassification.progression_skip_balancing,
             'count': 1,
             'name': 'Backpack',
             'doom_type': 8,
             'episode': -1,
    ...
    360495: {'classification': ItemClassification.filler,
             ...
             'episode': 4,
             'map': 2},
    360600: {'classification': ItemClassification.progression_skip_balancing,
             'count': 0,
             'name': 'Bullet capacity',
             'doom_type': 65001,
             'episode': -1,
             'map': -1},
    360601: {'classification': ItemClassification.progression_skip_balancing,
             'count': 0,
             'name': 'Shell capacity',
             'doom_type': 65002,
             'episode': -1,
             'map': -1},
    360602: {'classification': ItemClassification.progression_skip_balancing,
             'count': 0,
             'name': 'Energy cell capacity',
             'doom_type': 65003,
             'episode': -1,
             'map': -1},
    360603: {'classification': ItemClassification.progression_skip_balancing,
             'count': 0,
