...
item_table: Dict[int, ItemDict] = {
    ...
    360495: {'classification': ItemClassification.filler,
             ...
             'episode': 4,
             'map': 2},
    360600: {'classification': ItemClassification.progression,
             'count': 0,
             'name': 'Bullet capacity',
             'doom_type': 65001,
             'episode': -1,
             'map': -1},
    360601: {'classification': ItemClassification.progression,
             'count': 0,
             'name': 'Shell capacity',
             'doom_type': 65002,
             'episode': -1,
             'map': -1},
    360602: {'classification': ItemClassification.progression,
             'count': 0,
             'name': 'Energy cell capacity',
             'doom_type': 65003,
             'episode': -1,
             'map': -1},
    360603: {'classification': ItemClassification.progression,
             'count': 0,
