...
postgame_items: Set[str] = [
    "Graffiti (M - Flow)",
    "Graffiti (M - EVIL DARUMA)",
    "Graffiti (M - All Screws Loose)",
    "Graffiti (M - Constellation Circle)",
    "Graffiti (M - 8 MINUTES OF LEAN MEAN)",
    "Graffiti (L - Dynamo)",
    "Graffiti (L - KANI-BOZU)",
    "Graffiti (L - Dinner On The Court)",
    "Graffiti (L - Solstice Script)",
    "Graffiti (L - DIGITAL BLOCKBUSTER)",
    "Graffiti (XL - Bevel)",
    "Graffiti (XL - CYBER TENGU)",
    "Graffiti (XL - Don't Screw Around)",
    "Graffiti (XL - Astrological Augury)",
    "Graffiti (XL - HIGH TECH WS)",
]
...
group_table: Dict[str, Set[str]] = {
    ...
    "graffitil": ["Graffiti (L - WHOLE SIXER)",
                  ...
                  "Graffiti (L - DIGITAL BLOCKBUSTER)"],
    "graffitixl": ["Graffiti (XL - WILD STRUXXA)",
    ...
    "skateboard": ["Skateboard (Devon)",
                   ...
                   "Skateboard (Mantra)"],
    "inline skates": ["Inline Skates (Pop 3.0)",
                      "Inline Skates (Glaciers)",
