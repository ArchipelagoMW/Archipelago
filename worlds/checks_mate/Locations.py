...
location_table = {
    ...
    "Capture 2 Pieces": CMLocationData(4_027, True, False),
    "Capture 3 Pieces": CMLocationData(4_028, True, False),
    "Capture 4 Pieces": CMLocationData(4_029, True, False),
    "Capture 5 Pieces": CMLocationData(4_030, True, False),
    "Capture 6 Pieces": CMLocationData(4_031, True, False),
    "Capture 7 Pieces": CMLocationData(4_032, True, False),
    "Capture 2 Of Each": CMLocationData(4_033, True, False),
    "Capture 3 Of Each": CMLocationData(4_034, True, False),
    "Capture 4 Of Each": CMLocationData(4_035, True, False),
    "Capture 5 Of Each": CMLocationData(4_036, True, False),
    ...
    # "Checkmate 2 Pieces": CMLocationData(4_086, True, False),
    # "Checkmate 3 Pieces": CMLocationData(4_087, True, False),
    # "Checkmate 4 Pieces": CMLocationData(4_088, True, False),
    # "Checkmate 5 Pieces": CMLocationData(4_089, True, False),
    # "Checkmate 6 Pieces": CMLocationData(4_090, True, False),
    # "Checkmate 7 Pieces": CMLocationData(4_091, True, False),
    # "Checkmate 8 Pieces": CMLocationData(4_092, True, False),
    # "Checkmate 9 Pieces": CMLocationData(4_093, True, False),
    # "Checkmate 10 Pieces": CMLocationData(4_094, True, False),
    # "Checkmate 11 Pieces": CMLocationData(4_095, True, False),
    # "Checkmate 12 Pieces": CMLocationData(4_096, True, False),
    # "Checkmate 13 Pieces": CMLocationData(4_097, True, False),
    # "Checkmate 14 Pieces": CMLocationData(4_098, True, False),
    "Checkmate Maxima": CMLocationData(4_099, True, False),
