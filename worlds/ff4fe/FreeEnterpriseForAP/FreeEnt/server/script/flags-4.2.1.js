...
class FlagLogicCore {
    ...
    fix(flagset) {
        var all_spoiler_flags, ch, char_objective_flags, distinct_count, distinct_flags, has_unavailable_characters, log, only_flags, pass_quest_flags, pool, required_chars, sparse_spoiler_flags, win_flags;
        log = [];
        ...
        if (flagset.has("Chero")) {
            this._simple_disable(flagset, log, "Hero challenge includes smith weapon", ["-supersmith"]);
        }
