...
```
1. Use a canonical tag: kirbyam-vMAJOR.MINOR.PATCH (workflow injects this semver into world_version during release builds and syncs `worlds/kirbyam/archipelago.json` on `main`)
