...
def get_unused_locations() -> List[LocationData]:
    location_table: List[LocationData] = [
        ...
        LocationData(NORTHERN_STRETCH_AP_REGION, NORTHERN_STRETCH_DISPLAY_NAME + " NPC - Master Aegis", 3610 + npc_index_offset),
        LocationData(NORTHERN_STRETCH_AP_REGION, NORTHERN_STRETCH_DISPLAY_NAME + " NPC - Master Beastmaster", 3608 + npc_index_offset),
        LocationData(NORTHERN_STRETCH_AP_REGION, NORTHERN_STRETCH_DISPLAY_NAME + " NPC - Master Ninja", 3550 + npc_index_offset),
        LocationData(NORTHERN_STRETCH_AP_REGION, NORTHERN_STRETCH_DISPLAY_NAME + " NPC - Master Nomad", 3548 + npc_index_offset),
        LocationData(NORTHERN_STRETCH_AP_REGION, NORTHERN_STRETCH_DISPLAY_NAME + " NPC - Master Reaper", 3611 + npc_index_offset),
        LocationData(NORTHERN_STRETCH_AP_REGION, NORTHERN_STRETCH_DISPLAY_NAME + " NPC - Master Summoner", 3557 + npc_index_offset),
        LocationData(NORTHERN_STRETCH_AP_REGION, NORTHERN_STRETCH_DISPLAY_NAME + " NPC - Master Valkyrie", 3554 + npc_index_offset),
