...
def get_locations(player: Optional[int], options: Optional[CrystalProjectOptions]) -> List[LocationData]:
    ...
    location_table: List[LocationData] = [
        ...
        LocationData("Capital Sequoia", "Capital Sequoia Chest - Locked in Luxury Store storage 1", 1533 + treasure_index_offset, lambda state: logic.has_key(state, LUXURY_KEY)), #Fenix Syrup Pouch chest
        LocationData("Capital Sequoia", "Capital Sequoia Chest - Locked in Luxury Store storage 2", 1532 + treasure_index_offset, lambda state: logic.has_key(state, LUXURY_KEY)), #Lucky Briefs chest
        LocationData("Capital Sequoia", "Capital Sequoia Chest - Locked in Luxury Store storage 3", 1531 + treasure_index_offset, lambda state: logic.has_key(state, LUXURY_KEY)), #Lucky Socks chest
        ...
        LocationData("Capital Jail", "Capital Jail Chest - Locked among the foliage in West Wing", 916 + treasure_index_offset, lambda state: logic.has_key(state, WEST_WING_KEY) and logic.has_key(state, CELL_KEY, 4)), #Cell Key chest
        ...
        LocationData("Shoudu Province", "Shoudu Province Chest - Below fast boi spark", 3504 + treasure_index_offset, logic.has_vertical_movement or logic.has_glide), #Elevator Part chest
        ...
        LocationData("Shoudu Province", "Shoudu Province Chest - Through rooftop window south of fast boi spark 1", 3506 + treasure_index_offset, logic.has_vertical_movement or logic.has_glide), #Elevator Part chest
        ...
        LocationData("Shoudu Province", "Shoudu Province Chest - Samurai Lounge", 3512 + treasure_index_offset, logic.has_vertical_movement or logic.has_glide), #Elevator Part chest
        LocationData("Shoudu Province", "Shoudu Province Chest - Assassin Lounge", 3513 + treasure_index_offset, logic.has_vertical_movement or logic.has_glide), #Elevator Part chest
        LocationData("Shoudu Province", "Shoudu Province Chest - Among crates across from Assassin Lounge", 3514 + treasure_index_offset, logic.has_vertical_movement or logic.has_glide), #Elevator Part chest
        LocationData("Shoudu Province", "Shoudu Province Chest - Its in a room and there is a bed", 3515 + treasure_index_offset, logic.has_vertical_movement or logic.has_glide), #Elevator Part chest
        LocationData("Shoudu Province", "Shoudu Province Chest - Granary", 3520 + treasure_index_offset, logic.has_vertical_movement or logic.has_glide), #Elevator Part chest
        LocationData("Shoudu Province", "Shoudu Province Chest - Below the flower house", 3521 + treasure_index_offset, logic.has_vertical_movement or logic.has_glide), #Elevator Part chest
        LocationData("Shoudu Province", "Shoudu Province Chest - White hut", 3522 + treasure_index_offset, logic.has_vertical_movement or logic.has_glide), #Elevator Part chest
        ...
        LocationData("Shoudu Province", "Shoudu Province Chest - Crawl along the attic", 1536 + treasure_index_offset, logic.has_vertical_movement or logic.has_glide), #Knicked Knackers chest
        LocationData("Shoudu Province", "Shoudu Province Chest - Sneaky back door of cramped storage room", 1519 + treasure_index_offset, logic.has_vertical_movement or logic.has_glide), #Looters Pin chest
        LocationData("Shoudu Province", "Shoudu Province Chest - Sneak behind crates near Assassin Lounge", 2760 + treasure_index_offset, logic.has_vertical_movement or logic.has_glide), #Muggers Glove chest
        LocationData("Shoudu Province", "Shoudu Province Chest - Weaponsmith", 1505 + treasure_index_offset), #Plague Mask chest
        LocationData("Shoudu Province", "Shoudu Province Chest - Outside the inn", 2985 + treasure_index_offset, logic.has_vertical_movement or logic.has_glide), #Potion chest
        ...
        LocationData("Shoudu Province", "Shoudu Province Chest - In the flower room", 2789 + treasure_index_offset, logic.has_vertical_movement or logic.has_glide), #Potion chest
        ...
        LocationData("Shoudu Province", "Shoudu Province Chest - Lurking above spike ball pit by goldsmith", 2984 + treasure_index_offset), #(753, 105, -176) Tincture Pouch chest
        ...
        #NPCs
        LocationData("Continental Tram", "Continental Tram NPC - Diamond hanging out with the conscript 1", 2895 + npc_index_offset), #Dust
        LocationData("Continental Tram", "Continental Tram NPC - Diamond hanging out with the conscript 2", 2894 + npc_index_offset), #Ingot
...
def get_bosses(player: Optional[int], options: Optional[CrystalProjectOptions]) -> List[LocationData]:
    ...
    location_table: List[LocationData] = [
        ...
        LocationData("Castle Ramparts", "Castle Ramparts Boss - Rampart Demon", 1373 + boss_index_offset, logic.has_glide),
        LocationData("Continental Tram", "Continental Tram Boss - Conscript", 1621 + boss_index_offset, lambda state: logic.is_area_in_level_range(state, 5)),
...
def get_shops(player: Optional[int], options: Optional[CrystalProjectOptions]) -> List[LocationData]:
    ...
    location_table: List[LocationData] = [
        #Zones (Beginner)
        #Spawning Meadows
        LocationData("Spawning Meadows", "Spawning Meadows Shop - Nans Knick Knacks 1", 10013 + shop_index_offset),
        LocationData("Spawning Meadows", "Spawning Meadows Shop - Nans Knick Knacks 2", 20013 + shop_index_offset),
        LocationData("Spawning Meadows", "Spawning Meadows Shop - Nans Knick Knacks 3", 30013 + shop_index_offset),
        LocationData("Spawning Meadows", "Spawning Meadows Shop - Nans Knick Knacks 4", 40013 + shop_index_offset),
        LocationData("Spawning Meadows", "Spawning Meadows Shop - Nans Knick Knacks 5", 50013 + shop_index_offset),
        LocationData("Spawning Meadows", "Spawning Meadows Shop - Nans Knick Knacks 6", 60013 + shop_index_offset),
        LocationData("Spawning Meadows", "Spawning Meadows Shop - Nans Knick Knacks 7", 70013 + shop_index_offset),
        LocationData("Spawning Meadows", "Spawning Meadows Shop - Nans Knick Knacks 8", 80013 + shop_index_offset),
        LocationData("Spawning Meadows", "Spawning Meadows Shop - Nans Knick Knacks 9", 90013 + shop_index_offset),
        LocationData("Spawning Meadows", "Spawning Meadows Shop - Nans Knick Knacks 10", 100013 + shop_index_offset),
        LocationData("Spawning Meadows", "Spawning Meadows Shop - Nans Knick Knacks 11", 110013 + shop_index_offset),
        LocationData("Spawning Meadows", "Spawning Meadows Shop - Nans Knick Knacks 12", 120013 + shop_index_offset),
        ...
        #Seaside Cliffs
        LocationData("Seaside Cliffs", "Seaside Cliffs Shop - Camp Merchant 1", 10116 + shop_index_offset),
        LocationData("Seaside Cliffs", "Seaside Cliffs Shop - Camp Merchant 2", 20116 + shop_index_offset),
        LocationData("Seaside Cliffs", "Seaside Cliffs Shop - Camp Merchant 3", 30116 + shop_index_offset),
        LocationData("Seaside Cliffs", "Seaside Cliffs Shop - Camp Merchant 4", 40116 + shop_index_offset),
        LocationData("Seaside Cliffs", "Seaside Cliffs Shop - Camp Merchant 5", 50116 + shop_index_offset),
        LocationData("Seaside Cliffs", "Seaside Cliffs Shop - Camp Merchant 6", 60116 + shop_index_offset),
        LocationData("Seaside Cliffs", "Seaside Cliffs Shop - Camp Merchant 7", 70116 + shop_index_offset),
        LocationData("Seaside Cliffs", "Seaside Cliffs Shop - Camp Merchant 8", 80116 + shop_index_offset),
        LocationData("Seaside Cliffs", "Seaside Cliffs Shop - Camp Merchant 9", 90116 + shop_index_offset),

        #Mercury Shrine
        LocationData("Mercury Shrine", "Mercury Shrine Shop - Attendant 1", 10132 + shop_index_offset),
        LocationData("Mercury Shrine", "Mercury Shrine Shop - Attendant 2", 20132 + shop_index_offset),
        LocationData("Mercury Shrine", "Mercury Shrine Shop - Attendant 3", 30132 + shop_index_offset),

        #Proving Meadows
        LocationData("Proving Meadows", "Proving Meadows Shop - Item Merchant 1", 10253 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Item Merchant 2", 20253 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Item Merchant 3", 30253 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Item Merchant 4", 40253 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Item Merchant 5", 50253 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Item Merchant 6", 60253 + shop_index_offset),

        LocationData("Proving Meadows", "Proving Meadows Shop - Armor Merchant 1", 10133 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Armor Merchant 2", 20133 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Armor Merchant 3", 30133 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Armor Merchant 4", 40133 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Armor Merchant 5", 50133 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Armor Merchant 6", 60133 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Armor Merchant 7", 70133 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Armor Merchant 8", 80133 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Armor Merchant 9", 90133 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Armor Merchant 10", 100133 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Armor Merchant 11", 110133 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Armor Merchant 12", 120133 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Armor Merchant 13", 130133 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Armor Merchant 14", 140133 + shop_index_offset),

        LocationData("Proving Meadows", "Proving Meadows Shop - Weapon Merchant 1", 10117 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Weapon Merchant 2", 20117 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Weapon Merchant 3", 30117 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Weapon Merchant 4", 40117 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Weapon Merchant 5", 50117 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Weapon Merchant 6", 60117 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Weapon Merchant 7", 70117 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Weapon Merchant 8", 80117 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Weapon Merchant 9", 90117 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Weapon Merchant 10", 100117 + shop_index_offset),

        LocationData("Proving Meadows", "Proving Meadows Shop - Accessories Merchant 1", 10134 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Accessories Merchant 2", 20134 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Accessories Merchant 3", 30134 + shop_index_offset),
        LocationData("Proving Meadows", "Proving Meadows Shop - Accessories Merchant 4", 40134 + shop_index_offset),

        #Zones (Advanced)
        #Capital Sequoia
        LocationData("Capital Sequoia", "Gaea Shrine Shop - Attendant 1", 10379 + shop_index_offset),
        LocationData("Capital Sequoia", "Gaea Shrine Shop - Attendant 2", 20379 + shop_index_offset),

        LocationData("Capital Sequoia", "Capital Sequoia Shop - Candy Merchant 1", 10575 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Candy Merchant 2", 20575 + shop_index_offset),

        LocationData("Capital Sequoia", "Capital Sequoia Shop - Map Seller 1", 11158 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Map Seller 2", 21158 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Map Seller 3", 31158 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Map Seller 4", 41158 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Map Seller 5", 51158 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Map Seller 6", 61158 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Map Seller 7", 71158 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Map Seller 8", 81158 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Map Seller 9", 91158 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Map Seller 10", 101158 + shop_index_offset),

        LocationData("Capital Sequoia", "Capital Sequoia Shop - Luxury Shop Martial Weapons 1", 10599 + shop_index_offset, lambda state: state.has_any({"Item - Progressive Luxury Pass"}, player)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Luxury Shop Martial Weapons 2", 20599 + shop_index_offset, lambda state: state.has_any({"Item - Progressive Luxury Pass"}, player)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Luxury Shop Martial Weapons 3", 30599 + shop_index_offset, lambda state: state.has_any({"Item - Progressive Luxury Pass"}, player)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Luxury Shop Martial Weapons 4", 40599 + shop_index_offset, lambda state: state.has_any({"Item - Progressive Luxury Pass"}, player)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Martial Weapons 1", 50599 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Martial Weapons 2", 60599 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Martial Weapons 3", 70599 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Martial Weapons 4", 80599 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Martial Weapons 5", 90599 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Martial Weapons 6", 100599 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),

        LocationData("Capital Sequoia", "Capital Sequoia Shop - Luxury Shop Exotic Weapons 1", 10600 + shop_index_offset, lambda state: state.has_any({"Item - Progressive Luxury Pass"}, player)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Luxury Shop Exotic Weapons 2", 20600 + shop_index_offset, lambda state: state.has_any({"Item - Progressive Luxury Pass"}, player)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Luxury Shop Exotic Weapons 3", 30600 + shop_index_offset, lambda state: state.has_any({"Item - Progressive Luxury Pass"}, player)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Luxury Shop Exotic Weapons 4", 40600 + shop_index_offset, lambda state: state.has_any({"Item - Progressive Luxury Pass"}, player)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Exotic Weapons 1", 50600 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Exotic Weapons 2", 60600 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Exotic Weapons 3", 70600 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Exotic Weapons 4", 80600 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),

        LocationData("Capital Sequoia", "Capital Sequoia Shop - Luxury Shop Heavy Armor 1", 10601 + shop_index_offset, lambda state: state.has_any({"Item - Progressive Luxury Pass"}, player)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Luxury Shop Heavy Armor 2", 20601 + shop_index_offset, lambda state: state.has_any({"Item - Progressive Luxury Pass"}, player)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Luxury Shop Heavy Armor 3", 30601 + shop_index_offset, lambda state: state.has_any({"Item - Progressive Luxury Pass"}, player)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Heavy Armor 1", 40601 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Heavy Armor 2", 50601 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Heavy Armor 3", 60601 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),

        LocationData("Capital Sequoia", "Capital Sequoia Shop - Luxury Shop Medium Armor 1", 10602 + shop_index_offset, lambda state: state.has_any({"Item - Progressive Luxury Pass"}, player)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Luxury Shop Medium Armor 2", 20602 + shop_index_offset, lambda state: state.has_any({"Item - Progressive Luxury Pass"}, player)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Medium Armor 1", 30602 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Medium Armor 2", 40602 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),

        LocationData("Capital Sequoia", "Capital Sequoia Shop - Luxury Shop Magic Weapons 1", 10603 + shop_index_offset, lambda state: state.has_any({"Item - Progressive Luxury Pass"}, player)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Luxury Shop Magic Weapons 2", 20603 + shop_index_offset, lambda state: state.has_any({"Item - Progressive Luxury Pass"}, player)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Luxury Shop Magic Weapons 3", 30603 + shop_index_offset, lambda state: state.has_any({"Item - Progressive Luxury Pass"}, player)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Magic Weapons 1", 40603 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Magic Weapons 2", 50603 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Magic Weapons 3", 60603 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),

        LocationData("Capital Sequoia", "Capital Sequoia Shop - Luxury Shop Light Armor 1", 10604 + shop_index_offset, lambda state: state.has_any({"Item - Progressive Luxury Pass"}, player)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Luxury Shop Light Armor 2", 20604 + shop_index_offset, lambda state: state.has_any({"Item - Progressive Luxury Pass"}, player)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Light Armor 1", 30604 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Upgraded Luxury Shop Light Armor 2", 40604 + shop_index_offset, lambda state: state.has("Item - Progressive Luxury Pass", player, 2)),

        LocationData("Capital Sequoia", "Capital Sequoia Shop - Martial Weapons R Us 1", 10500 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Martial Weapons R Us 2", 20500 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Martial Weapons R Us 3", 30500 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Martial Weapons R Us 4", 40500 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Martial Weapons R Us 5", 50500 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Martial Weapons R Us 6", 60500 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Martial Weapons R Us 7", 70500 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Martial Weapons R Us 8", 80500 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Martial Weapons R Us 9", 90500 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Martial Weapons R Us 10", 100500 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Martial Weapons R Us 11", 110500 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Martial Weapons R Us 12", 120500 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Martial Weapons R Us 13", 130500 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Martial Weapons R Us 14", 140500 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Martial Weapons R Us 15", 150500 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Martial Weapons R Us 16", 160500 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Martial Weapons R Us 17", 170500 + shop_index_offset),

        LocationData("Capital Sequoia", "Capital Sequoia Shop - Exotic Weapons R Us 1", 10501 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Exotic Weapons R Us 2", 20501 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Exotic Weapons R Us 3", 30501 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Exotic Weapons R Us 4", 40501 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Exotic Weapons R Us 5", 50501 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Exotic Weapons R Us 6", 60501 + shop_index_offset),

        LocationData("Capital Sequoia", "Capital Sequoia Shop - Milk Man", 10579 + shop_index_offset),

        LocationData("Capital Sequoia", "Capital Sequoia Shop - Heavy Armor 4 All 1", 10416 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Heavy Armor 4 All 2", 20416 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Heavy Armor 4 All 3", 30416 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Heavy Armor 4 All 4", 40416 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Heavy Armor 4 All 5", 50416 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Heavy Armor 4 All 6", 60416 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Heavy Armor 4 All 7", 70416 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Heavy Armor 4 All 8", 80416 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Heavy Armor 4 All 9", 90416 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Heavy Armor 4 All 10", 100416 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Heavy Armor 4 All 11", 110416 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Heavy Armor 4 All 12", 120416 + shop_index_offset),

        LocationData("Capital Sequoia", "Capital Sequoia Shop - Medium Armor 4 All 1", 10417 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Medium Armor 4 All 2", 20417 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Medium Armor 4 All 3", 30417 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Medium Armor 4 All 4", 40417 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Medium Armor 4 All 5", 50417 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Medium Armor 4 All 6", 60417 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Medium Armor 4 All 7", 70417 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Medium Armor 4 All 8", 80417 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Medium Armor 4 All 9", 90417 + shop_index_offset),

        LocationData("Capital Sequoia", "Capital Sequoia Shop - Magic and Magic Things Light Armor 1", 10455 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Magic and Magic Things Light Armor 2", 20455 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Magic and Magic Things Light Armor 3", 30455 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Magic and Magic Things Light Armor 4", 40455 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Magic and Magic Things Light Armor 5", 50455 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Magic and Magic Things Light Armor 6", 60455 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Magic and Magic Things Light Armor 7", 70455 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Magic and Magic Things Light Armor 8", 80455 + shop_index_offset),

        LocationData("Capital Sequoia", "Capital Sequoia Shop - Magic and Magic Things Weapons 1", 10499 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Magic and Magic Things Weapons 2", 20499 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Magic and Magic Things Weapons 3", 30499 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Magic and Magic Things Weapons 4", 40499 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Magic and Magic Things Weapons 5", 50499 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Magic and Magic Things Weapons 6", 60499 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Magic and Magic Things Weapons 7", 70499 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Magic and Magic Things Weapons 8", 80499 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Magic and Magic Things Weapons 9", 90499 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Magic and Magic Things Weapons 10", 100499 + shop_index_offset),

        LocationData("Capital Sequoia", "Capital Sequoia Shop - Accessory Merchant 1", 10398 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Accessory Merchant 2", 20398 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Accessory Merchant 3", 30398 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Accessory Merchant 4", 40398 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Accessory Merchant 5", 50398 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Accessory Merchant 6", 60398 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Accessory Merchant 7", 70398 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Accessory Merchant 8", 80398 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Accessory Merchant 9", 90398 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Accessory Merchant 10", 100398 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Accessory Merchant 11", 110398 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Accessory Merchant 12", 120398 + shop_index_offset),

        LocationData("Capital Sequoia", "Capital Sequoia Shop - Item Merchant 1", 10456 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Item Merchant 2", 20456 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Item Merchant 3", 30456 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Item Merchant 4", 40456 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Item Merchant 5", 50456 + shop_index_offset),
        LocationData("Capital Sequoia", "Capital Sequoia Shop - Item Merchant 6", 60456 + shop_index_offset),

        LocationData("Capital Sequoia", "Capital Sequoia Shop - Old Nans Stew", 10423 + shop_index_offset),

        #Salmon River
        LocationData("Salmon River", "Poseidon Shrine Shop - Attendant 1", 10631 + shop_index_offset),
        LocationData("Salmon River", "Poseidon Shrine Shop - Attendant 2", 20631 + shop_index_offset),
        LocationData("Salmon River", "Poseidon Shrine Shop - Attendant 3", 30631 + shop_index_offset),

        #Sara Sara Bazaar
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Old Nans Stew Subsidiary", 10957 + shop_index_offset),

        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Accessory Merchant 1", 11386 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Accessory Merchant 2", 21386 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Accessory Merchant 3", 31386 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Accessory Merchant 4", 41386 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Accessory Merchant 5", 51386 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Accessory Merchant 6", 61386 + shop_index_offset),

        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Item Merchant 1", 11193 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Item Merchant 2", 21193 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Item Merchant 3", 31193 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Item Merchant 4", 41193 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Item Merchant 5", 51193 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Item Merchant 6", 61193 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Item Merchant 7", 71193 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Item Merchant 8", 81193 + shop_index_offset),
        ...
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Armor Merchant 1", 11603 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Armor Merchant 2", 21603 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Armor Merchant 3", 31603 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Armor Merchant 4", 41603 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Armor Merchant 5", 51603 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Armor Merchant 6", 61603 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Armor Merchant 7", 71603 + shop_index_offset),

        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Weapon Merchant 1", 11604 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Weapon Merchant 2", 21604 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Weapon Merchant 3", 31604 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Weapon Merchant 4", 41604 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Weapon Merchant 5", 51604 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Weapon Merchant 6", 61604 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Weapon Merchant 7", 71604 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Weapon Merchant 8", 81604 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Weapon Merchant 9", 91604 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Weapon Merchant 10", 101604 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Weapon Merchant 11", 111604 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Weapon Merchant 12", 121604 + shop_index_offset),
        LocationData("Sara Sara Bazaar", "Sara Sara Bazaar Shop - Weapon Merchant 13", 131604 + shop_index_offset),

        #Zones (Expert)
        #Shoudu Province
        LocationData("Shoudu Province", "Shoudu Province Shop - Item Merchant 1", 10951 + shop_index_offset),
        LocationData("Shoudu Province", "Shoudu Province Shop - Item Merchant 2", 20951 + shop_index_offset),
        LocationData("Shoudu Province", "Shoudu Province Shop - Item Merchant 3", 30951 + shop_index_offset),
        LocationData("Shoudu Province", "Shoudu Province Shop - Item Merchant 4", 40951 + shop_index_offset),
        LocationData("Shoudu Province", "Shoudu Province Shop - Item Merchant 5", 50951 + shop_index_offset),
        LocationData("Shoudu Province", "Shoudu Province Shop - Item Merchant 6", 60951 + shop_index_offset),
        LocationData("Shoudu Province", "Shoudu Province Shop - Item Merchant 7", 70951 + shop_index_offset),
        LocationData("Shoudu Province", "Shoudu Province Shop - Item Merchant 8", 80951 + shop_index_offset),
        LocationData("Shoudu Province", "Shoudu Province Shop - Item Merchant 9", 90951 + shop_index_offset),

        LocationData("Shoudu Province", "Shoudu Province Shop - No Shoudu Stew for you 1", 11199 + shop_index_offset),

        LocationData("Shoudu Province", "Shoudu Province Shop - Accessory Merchant 1", 11614 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Accessory Merchant 2", 21614 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Accessory Merchant 3", 31614 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Accessory Merchant 4", 41614 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Accessory Merchant 5", 51614 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Accessory Merchant 6", 61614 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),

        LocationData("Shoudu Province", "Shoudu Province Shop - Armor Merchant 1", 11535 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Armor Merchant 2", 21535 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Armor Merchant 3", 31535 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Armor Merchant 4", 41535 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Armor Merchant 5", 51535 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Armor Merchant 6", 61535 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Armor Merchant 7", 71535 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Armor Merchant 8", 81535 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Armor Merchant 9", 91535 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Armor Merchant 10", 101535 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),

        LocationData("Shoudu Province", "Shoudu Province Shop - Weapon Merchant 1", 11544 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Weapon Merchant 2", 21544 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Weapon Merchant 3", 31544 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Weapon Merchant 4", 41544 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Weapon Merchant 5", 51544 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Weapon Merchant 6", 61544 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Weapon Merchant 7", 71544 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Weapon Merchant 8", 81544 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Weapon Merchant 9", 91544 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Weapon Merchant 10", 101544 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Weapon Merchant 11", 111544 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Weapon Merchant 12", 121544 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Weapon Merchant 13", 131544 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Weapon Merchant 14", 141544 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Weapon Merchant 15", 151544 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),
        LocationData("Shoudu Province", "Shoudu Province Shop - Weapon Merchant 16", 161544 + shop_index_offset, logic.has_vertical_movement or logic.has_glide),

        #Ganymede Shrine
        LocationData("Ganymede Shrine", "Ganymede Shrine Shop - Attendant 1", 11574 + shop_index_offset),
        LocationData("Ganymede Shrine", "Ganymede Shrine Shop - Attendant 2", 21574 + shop_index_offset),
        LocationData("Ganymede Shrine", "Ganymede Shrine Shop - Attendant 3", 31574 + shop_index_offset),

        #Quintar Reserve
        LocationData("Quintar Reserve", "Quintar Reserve Shop - Babel to this Quintar 1", 10470 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData("Quintar Reserve", "Quintar Reserve Shop - Babel to this Quintar 2", 20470 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData("Quintar Reserve", "Quintar Reserve Shop - Babel to this Quintar 3", 30470 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData("Quintar Reserve", "Quintar Reserve Shop - Babel to this Quintar 4", 40470 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData("Quintar Reserve", "Quintar Reserve Shop - Babel to this Quintar 5", 50470 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),

        #Dione Shrine
        LocationData("Dione Shrine", "Dione Shrine Shop - Quintar Attendant 1", 12253 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData("Dione Shrine", "Dione Shrine Shop - Quintar Attendant 2", 22253 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),

        LocationData("Dione Shrine", "Dione Shrine Shop - Quintar Raising Supplies 1", 12227 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData("Dione Shrine", "Dione Shrine Shop - Quintar Raising Supplies 2", 22227 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData("Dione Shrine", "Dione Shrine Shop - Quintar Raising Supplies 3", 32227 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData("Dione Shrine", "Dione Shrine Shop - Quintar Raising Supplies 4", 42227 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData("Dione Shrine", "Dione Shrine Shop - Quintar Raising Supplies 5", 52227 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData("Dione Shrine", "Dione Shrine Shop - Quintar Raising Supplies 6", 62227 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData("Dione Shrine", "Dione Shrine Shop - Quintar Raising Supplies 7", 72227 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData("Dione Shrine", "Dione Shrine Shop - Quintar Raising Supplies 8", 82227 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData("Dione Shrine", "Dione Shrine Shop - Quintar Raising Supplies 9", 92227 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),

        #Tall Tall Heights
        LocationData("Tall Tall Heights", "Triton Shrine Shop - Attendant 1", 11165 + shop_index_offset),
        LocationData("Tall Tall Heights", "Triton Shrine Shop - Attendant 2", 21165 + shop_index_offset),

        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Armor Merchant 1", 12746 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Armor Merchant 2", 22746 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Armor Merchant 3", 32746 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Armor Merchant 4", 42746 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Armor Merchant 5", 52746 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Armor Merchant 6", 62746 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Armor Merchant 7", 72746 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Armor Merchant 8", 82746 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Armor Merchant 9", 92746 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Armor Merchant 10", 102746 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),

        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Weapon Merchant 1", 10540 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Weapon Merchant 2", 20540 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Weapon Merchant 3", 30540 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Weapon Merchant 4", 40540 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Weapon Merchant 5", 50540 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Weapon Merchant 6", 60540 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Weapon Merchant 7", 70540 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Weapon Merchant 8", 80540 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Weapon Merchant 9", 90540 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Weapon Merchant 10", 100540 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),

        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Souvenir Merchant 1", 12918 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Souvenir Merchant 2", 22918 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Souvenir Merchant 3", 32918 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),
        LocationData("Tall Tall Heights", "Tall Tall Heights Shop - Souvenir Merchant 4", 42918 + shop_index_offset, logic.has_vertical_movement and logic.has_glide),

        #Jidamba Tangle
        LocationData("Jidamba Tangle", "Europa Shrine Shop - Attendant 1", 11163 + shop_index_offset),
        LocationData("Jidamba Tangle", "Europa Shrine Shop - Attendant 2", 21163 + shop_index_offset),

        #Neptune Shrine
        LocationData("Neptune Shrine", "Neptune Shrine Shop - Attendant 1", 13164 + shop_index_offset),
        LocationData("Neptune Shrine", "Neptune Shrine Shop - Attendant 2", 23164 + shop_index_offset),
        LocationData("Neptune Shrine", "Neptune Shrine Shop - Attendant 3", 33164 + shop_index_offset),

        #Zones (End-Game)
        #The New World
        LocationData("The New World", "New World Shrine Shop - Attendant 1", 11877 + shop_index_offset),
        LocationData("The New World", "New World Shrine Shop - Attendant 2", 21877 + shop_index_offset),
    ]
