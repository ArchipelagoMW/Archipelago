...
def get_region_completions(player: int, options: CrystalProjectOptions) -> List[LocationData]:
    logic = CrystalProjectLogic(player, options)
    region_completion_text = " Region Completion"
    location_table: List[LocationData] = [
        LocationData(SPAWNING_MEADOWS_AP_REGION, SPAWNING_MEADOWS_DISPLAY_NAME + region_completion_text, 6001 + regionsanity_index_offset, regionsanity=True),
        LocationData(DELENDE_AP_REGION, DELENDE_DISPLAY_NAME + region_completion_text, 6002 + regionsanity_index_offset, regionsanity=True),
        LocationData(MERCURY_SHRINE_AP_REGION, MERCURY_SHRINE_DISPLAY_NAME + region_completion_text, 6007 + regionsanity_index_offset, regionsanity=True),
        LocationData(SOILED_DEN_AP_REGION, SOILED_DEN_DISPLAY_NAME + region_completion_text, 6003 + regionsanity_index_offset, regionsanity=True),
        LocationData(THE_PALE_GROTTO_AP_REGION, THE_PALE_GROTTO_DISPLAY_NAME + region_completion_text, 6004 + regionsanity_index_offset, regionsanity=True),
        LocationData(SEASIDE_CLIFFS_AP_REGION, SEASIDE_CLIFFS_DISPLAY_NAME + region_completion_text, 6005 + regionsanity_index_offset, regionsanity=True),
        LocationData(DRAFT_SHAFT_CONDUIT_AP_REGION, DRAFT_SHAFT_CONDUIT_DISPLAY_NAME + region_completion_text, 6006 + regionsanity_index_offset, regionsanity=True),
        LocationData(YAMAGAWA_MA_AP_REGION, YAMAGAWA_MA_DISPLAY_NAME + region_completion_text, 6008 + regionsanity_index_offset, regionsanity=True),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + region_completion_text, 6009 + regionsanity_index_offset, regionsanity=True),
        LocationData(SKUMPARADISE_AP_REGION, SKUMPARADISE_DISPLAY_NAME + region_completion_text, 6010 + regionsanity_index_offset, regionsanity=True),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + region_completion_text, 6011 + regionsanity_index_offset, regionsanity=True),
        LocationData(JOJO_SEWERS_AP_REGION, JOJO_SEWERS_DISPLAY_NAME + region_completion_text, 6012 + regionsanity_index_offset, regionsanity=True),
        LocationData(BOOMER_SOCIETY_AP_REGION, BOOMER_SOCIETY_DISPLAY_NAME + region_completion_text, 6013 + regionsanity_index_offset, regionsanity=True),
        LocationData(ROLLING_QUINTAR_FIELDS_AP_REGION, ROLLING_QUINTAR_FIELDS_DISPLAY_NAME + region_completion_text, 6014 + regionsanity_index_offset, regionsanity=True),
        LocationData(QUINTAR_NEST_AP_REGION, QUINTAR_NEST_DISPLAY_NAME + region_completion_text, 6015 + regionsanity_index_offset, regionsanity=True),
        LocationData(QUINTAR_SANCTUM_AP_REGION, QUINTAR_SANCTUM_DISPLAY_NAME + region_completion_text, 6016 + regionsanity_index_offset, regionsanity=True),
        LocationData(CAPITAL_JAIL_AP_REGION, CAPITAL_JAIL_DISPLAY_NAME + region_completion_text, 6017 + regionsanity_index_offset, regionsanity=True),
        LocationData(CAPITAL_PIPELINE_AP_REGION, CAPITAL_PIPELINE_DISPLAY_NAME + region_completion_text, 6018 + regionsanity_index_offset, regionsanity=True),
        LocationData(COBBLESTONE_CRAG_AP_REGION, COBBLESTONE_CRAG_DISPLAY_NAME + region_completion_text, 6019 + regionsanity_index_offset, regionsanity=True),
        LocationData(OKIMOTO_NS_AP_REGION, OKIMOTO_NS_DISPLAY_NAME + region_completion_text, 6020 + regionsanity_index_offset, regionsanity=True),
        LocationData(GREENSHIRE_REPRISE_AP_REGION, GREENSHIRE_REPRISE_DISPLAY_NAME + region_completion_text, 6021 + regionsanity_index_offset, regionsanity=True),
        LocationData(SALMON_PASS_AP_REGION, SALMON_PASS_DISPLAY_NAME + region_completion_text, 6022 + regionsanity_index_offset, regionsanity=True),
        LocationData(SALMON_RIVER_AP_REGION, SALMON_RIVER_DISPLAY_NAME + region_completion_text, 6023 + regionsanity_index_offset, regionsanity=True),
        LocationData(POKO_POKO_DESERT_AP_REGION, POKO_POKO_DESERT_DISPLAY_NAME + region_completion_text, 6024 + regionsanity_index_offset, regionsanity=True),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + region_completion_text, 6025 + regionsanity_index_offset, regionsanity=True),
        LocationData(SARA_SARA_BEACH_EAST_AP_REGION, SARA_SARA_BEACH_EAST_DISPLAY_NAME + region_completion_text, 6026 + regionsanity_index_offset, regionsanity=True),
        LocationData(SARA_SARA_BEACH_WEST_AP_REGION, SARA_SARA_BEACH_WEST_DISPLAY_NAME + region_completion_text, 6027 + regionsanity_index_offset, regionsanity=True),
        LocationData(ANCIENT_RESERVOIR_AP_REGION, ANCIENT_RESERVOIR_DISPLAY_NAME + region_completion_text, 6028 + regionsanity_index_offset, regionsanity=True),
        LocationData(SALMON_BAY_AP_REGION, SALMON_BAY_DISPLAY_NAME + region_completion_text, 6030 + regionsanity_index_offset, regionsanity=True),
        LocationData(THE_OPEN_SEA_AP_REGION, THE_OPEN_SEA_DISPLAY_NAME + region_completion_text, 6031 + regionsanity_index_offset, regionsanity=True),
        LocationData(SHOUDU_WATERFRONT_AP_REGION, SHOUDU_WATERFRONT_DISPLAY_NAME + region_completion_text, 6032 + regionsanity_index_offset, regionsanity=True),
        LocationData(SHOUDU_PROVINCE_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + region_completion_text, 6033 + regionsanity_index_offset, regionsanity=True),
        LocationData(THE_UNDERCITY_AP_REGION, THE_UNDERCITY_DISPLAY_NAME + region_completion_text, 6034 + regionsanity_index_offset, regionsanity=True),
        LocationData(GANYMEDE_SHRINE_AP_REGION, GANYMEDE_SHRINE_DISPLAY_NAME + region_completion_text, 6035 + regionsanity_index_offset, regionsanity=True),
        LocationData(BEAURIOR_VOLCANO_AP_REGION, BEAURIOR_VOLCANO_DISPLAY_NAME + region_completion_text, 6036 + regionsanity_index_offset, regionsanity=True),
        LocationData(BEAURIOR_ROCK_AP_REGION, BEAURIOR_ROCK_DISPLAY_NAME + region_completion_text, 6037 + regionsanity_index_offset, regionsanity=True),
        LocationData(LAKE_DELENDE_AP_REGION, LAKE_DELENDE_DISPLAY_NAME + region_completion_text, 6038 + regionsanity_index_offset, regionsanity=True),
        LocationData(QUINTAR_RESERVE_AP_REGION, QUINTAR_RESERVE_DISPLAY_NAME + region_completion_text, 6039 + regionsanity_index_offset, regionsanity=True),
        LocationData(DIONE_SHRINE_AP_REGION, DIONE_SHRINE_DISPLAY_NAME + region_completion_text, 6040 + regionsanity_index_offset, regionsanity=True),
        LocationData(QUINTAR_MAUSOLEUM_AP_REGION, QUINTAR_MAUSOLEUM_DISPLAY_NAME + region_completion_text, 6041 + regionsanity_index_offset, regionsanity=True),
        LocationData(EASTERN_CHASM_AP_REGION, EASTERN_CHASM_DISPLAY_NAME + region_completion_text, 6042 + regionsanity_index_offset, regionsanity=True),
        LocationData(TALL_TALL_HEIGHTS_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + region_completion_text, 6043 + regionsanity_index_offset, regionsanity=True),
        LocationData(NORTHERN_CAVE_AP_REGION, NORTHERN_CAVE_DISPLAY_NAME + region_completion_text, 6044 + regionsanity_index_offset, regionsanity=True),
        LocationData(LANDS_END_AP_REGION, LANDS_END_DISPLAY_NAME + region_completion_text, 6045 + regionsanity_index_offset, regionsanity=True),
        LocationData(SLIP_GLIDE_RIDE_AP_REGION, SLIP_GLIDE_RIDE_DISPLAY_NAME + region_completion_text, 6046 + regionsanity_index_offset, regionsanity=True),
        LocationData(SEQUOIA_ATHENAEUM_AP_REGION, SEQUOIA_ATHENAEUM_DISPLAY_NAME + region_completion_text, 6047 + regionsanity_index_offset, regionsanity=True),
        LocationData(NORTHERN_STRETCH_AP_REGION, NORTHERN_STRETCH_DISPLAY_NAME + region_completion_text, 6048 + regionsanity_index_offset, regionsanity=True),
        LocationData(CASTLE_RAMPARTS_AP_REGION, CASTLE_RAMPARTS_DISPLAY_NAME + region_completion_text, 6049 + regionsanity_index_offset, regionsanity=True),
        LocationData(THE_CHALICE_OF_TAR_AP_REGION, THE_CHALICE_OF_TAR_DISPLAY_NAME + region_completion_text, 6050 + regionsanity_index_offset, regionsanity=True),
        LocationData(FLYERS_CRAG_AP_REGION, FLYERS_CRAG_DISPLAY_NAME + region_completion_text, 6051 + regionsanity_index_offset, regionsanity=True),
        LocationData(JIDAMBA_TANGLE_AP_REGION, JIDAMBA_TANGLE_DISPLAY_NAME + region_completion_text, 6052 + regionsanity_index_offset, regionsanity=True),
        LocationData(JIDAMBA_EACLANEYA_AP_REGION, JIDAMBA_EACLANEYA_DISPLAY_NAME + region_completion_text, 6053 + regionsanity_index_offset, regionsanity=True),
        LocationData(THE_DEEP_SEA_AP_REGION, THE_DEEP_SEA_DISPLAY_NAME + region_completion_text, 6054 + regionsanity_index_offset, regionsanity=True),
        LocationData(NEPTUNE_SHRINE_AP_REGION, NEPTUNE_SHRINE_DISPLAY_NAME + region_completion_text, 6055 + regionsanity_index_offset, regionsanity=True),
        LocationData(JADE_CAVERN_AP_REGION, JADE_CAVERN_DISPLAY_NAME + region_completion_text, 6056 + regionsanity_index_offset, regionsanity=True),
        LocationData(CONTINENTAL_TRAM_AP_REGION, CONTINENTAL_TRAM_DISPLAY_NAME + region_completion_text, 6057 + regionsanity_index_offset, regionsanity=True),
        LocationData(ANCIENT_LABYRINTH_AP_REGION, ANCIENT_LABYRINTH_DISPLAY_NAME + region_completion_text, 6058 + regionsanity_index_offset, regionsanity=True),
        LocationData(THE_SEQUOIA_AP_REGION, THE_SEQUOIA_DISPLAY_NAME + region_completion_text, 6059 + regionsanity_index_offset, regionsanity=True),
        LocationData(THE_DEPTHS_AP_REGION, THE_DEPTHS_DISPLAY_NAME + region_completion_text, 6060 + regionsanity_index_offset, regionsanity=True),
        LocationData(CASTLE_SEQUOIA_AP_REGION, CASTLE_SEQUOIA_DISPLAY_NAME + region_completion_text, 6061 + regionsanity_index_offset, regionsanity=True),
        LocationData(THE_NEW_WORLD_AP_REGION, THE_NEW_WORLD_DISPLAY_NAME + region_completion_text, 6063 + regionsanity_index_offset, regionsanity=True),
        ]
    return location_table