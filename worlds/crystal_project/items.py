...
region_name_to_pass_dict: Dict[str, str] = {
    #Beginner
    SPAWNING_MEADOWS_AP_REGION: SPAWNING_MEADOWS_PASS,
    DELENDE_AP_REGION: DELENDE_PASS,
    SOILED_DEN_AP_REGION: SOILED_DEN_PASS,
    THE_PALE_GROTTO_AP_REGION: THE_PALE_GROTTO_PASS,
    SEASIDE_CLIFFS_AP_REGION: SEASIDE_CLIFFS_PASS,
    DRAFT_SHAFT_CONDUIT_AP_REGION: DRAFT_SHAFT_CONDUIT_PASS,
    MERCURY_SHRINE_AP_REGION: MERCURY_SHRINE_PASS,
    YAMAGAWA_MA_AP_REGION: YAMAGAWA_MA_PASS,
    PROVING_MEADOWS_AP_REGION: PROVING_MEADOWS_PASS,
    SKUMPARADISE_AP_REGION: SKUMPARADISE_PASS,
    #Advanced
    CAPITAL_SEQUOIA_AP_REGION: CAPITAL_SEQUOIA_PASS,
    JOJO_SEWERS_AP_REGION: JOJO_SEWERS_PASS,
    BOOMER_SOCIETY_AP_REGION: BOOMER_SOCIETY_PASS,
    ROLLING_QUINTAR_FIELDS_AP_REGION: ROLLING_QUINTAR_FIELDS_PASS,
    QUINTAR_NEST_AP_REGION: QUINTAR_NEST_PASS,
    QUINTAR_SANCTUM_AP_REGION: QUINTAR_SANCTUM_PASS,
    CAPITAL_JAIL_AP_REGION: CAPITAL_JAIL_PASS,
    CAPITAL_PIPELINE_AP_REGION: CAPITAL_PIPELINE_PASS,
    COBBLESTONE_CRAG_AP_REGION: COBBLESTONE_CRAG_PASS,
    OKIMOTO_NS_AP_REGION: OKIMOTO_NS_PASS,
    GREENSHIRE_REPRISE_AP_REGION: GREENSHIRE_REPRISE_PASS,
    SALMON_PASS_AP_REGION: SALMON_PASS_PASS,
    SALMON_RIVER_AP_REGION: SALMON_RIVER_PASS,
    SHOUDU_WATERFRONT_AP_REGION: SHOUDU_WATERFRONT_PASS,
    POKO_POKO_DESERT_AP_REGION: POKO_POKO_DESERT_PASS,
    SARA_SARA_BAZAAR_AP_REGION: SARA_SARA_BAZAAR_PASS,
    SARA_SARA_BEACH_EAST_AP_REGION: SARA_SARA_BEACH_EAST_PASS,
    SARA_SARA_BEACH_WEST_AP_REGION: SARA_SARA_BEACH_WEST_PASS,
    ANCIENT_RESERVOIR_AP_REGION: ANCIENT_RESERVOIR_PASS,
    SALMON_BAY_AP_REGION: SALMON_BAY_PASS,
    #Expert
    THE_OPEN_SEA_AP_REGION: THE_OPEN_SEA_PASS,
    SHOUDU_PROVINCE_AP_REGION: SHOUDU_PROVINCE_PASS,
    THE_UNDERCITY_AP_REGION: THE_UNDERCITY_PASS,
    GANYMEDE_SHRINE_AP_REGION: GANYMEDE_SHRINE_PASS,
    BEAURIOR_VOLCANO_AP_REGION: BEAURIOR_VOLCANO_PASS,
    BEAURIOR_ROCK_AP_REGION: BEAURIOR_ROCK_PASS,
    LAKE_DELENDE_AP_REGION: LAKE_DELENDE_PASS,
    QUINTAR_RESERVE_AP_REGION: QUINTAR_RESERVE_PASS,
    DIONE_SHRINE_AP_REGION: DIONE_SHRINE_PASS,
    QUINTAR_MAUSOLEUM_AP_REGION: QUINTAR_MAUSOLEUM_PASS,
    EASTERN_CHASM_AP_REGION: EASTERN_CHASM_PASS,
    TALL_TALL_HEIGHTS_AP_REGION: TALL_TALL_HEIGHTS_PASS,
    NORTHERN_CAVE_AP_REGION: NORTHERN_CAVE_PASS,
    LANDS_END_AP_REGION: LANDS_END_PASS,
    SLIP_GLIDE_RIDE_AP_REGION: SLIP_GLIDE_RIDE_PASS,
    SEQUOIA_ATHENAEUM_AP_REGION: SEQUOIA_ATHENAEUM_PASS,
    NORTHERN_STRETCH_AP_REGION: NORTHERN_STRETCH_PASS,
    CASTLE_RAMPARTS_AP_REGION: CASTLE_RAMPARTS_PASS,
    THE_CHALICE_OF_TAR_AP_REGION: THE_CHALICE_OF_TAR_PASS,
    FLYERS_CRAG_AP_REGION: FLYERS_CRAG_PASS,
    JIDAMBA_TANGLE_AP_REGION: JIDAMBA_TANGLE_PASS,
    JIDAMBA_EACLANEYA_AP_REGION: JIDAMBA_EACLANEYA_PASS,
    THE_DEEP_SEA_AP_REGION: THE_DEEP_SEA_PASS,
    NEPTUNE_SHRINE_AP_REGION: NEPTUNE_SHRINE_PASS,
    JADE_CAVERN_AP_REGION: JADE_CAVERN_PASS,
    CONTINENTAL_TRAM_AP_REGION: CONTINENTAL_TRAM_PASS,
    #End Game
    ANCIENT_LABYRINTH_AP_REGION: ANCIENT_LABYRINTH_PASS,
    THE_SEQUOIA_AP_REGION: THE_SEQUOIA_PASS,
    THE_DEPTHS_AP_REGION: THE_DEPTHS_PASS,
    CASTLE_SEQUOIA_AP_REGION: CASTLE_SEQUOIA_PASS,
    THE_OLD_WORLD_AP_REGION: THE_OLD_WORLD_PASS,
    THE_NEW_WORLD_AP_REGION: THE_NEW_WORLD_PASS,
}
