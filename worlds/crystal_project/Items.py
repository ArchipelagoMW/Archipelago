...
item_table: Dict[str, ItemData] = {
    ...
    # "Equipment - Progressive 1H Sword": ItemData("Equipment", 11 + equipment_index_offset, ItemClassification.useful), #1H Sword IDs 11, 71, 89, 93, 200, 377, 375, 380, 372, 381, 303, 411, 316
    # "Equipment - Progressive 2H Sword": ItemData("Equipment", 12 + equipment_index_offset, ItemClassification.useful), # 2H Sword IDs 12, 177, 197, 525, 382, 279
    # "Equipment - Progressive 1H Axe": ItemData("Equipment", 94 + equipment_index_offset, ItemClassification.useful), # 1H Axe IDs 94, 187, 386, 388
    # "Equipment - Progressive 2H Axe": ItemData("Equipment", 2 + equipment_index_offset, ItemClassification.useful), # 2H Axe IDs 2, 385, 280, 274
    # "Equipment - Progressive Dagger": ItemData("Equipment", 63 + equipment_index_offset, ItemClassification.useful), # Dagger IDs 63, 40, 95, 184, 198, 305, 393, 72, 306
