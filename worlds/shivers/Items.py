...
item_table = {
    ...
    # Keys
    "Key for Office Elevator": ItemData(SHIVERS_ITEM_ID_OFFSET + 20, ItemType.KEY),
    "Key for Bedroom Elevator": ItemData(SHIVERS_ITEM_ID_OFFSET + 21, ItemType.KEY),
    "Key for Three Floor Elevator": ItemData(SHIVERS_ITEM_ID_OFFSET + 22, ItemType.KEY),
    "Key for Workshop": ItemData(SHIVERS_ITEM_ID_OFFSET + 23, ItemType.KEY),
    "Key for Office": ItemData(SHIVERS_ITEM_ID_OFFSET + 24, ItemType.KEY),
    "Key for Prehistoric Room": ItemData(SHIVERS_ITEM_ID_OFFSET + 25, ItemType.KEY),
    "Key for Greenhouse": ItemData(SHIVERS_ITEM_ID_OFFSET + 26, ItemType.KEY),
    "Key for Ocean Room": ItemData(SHIVERS_ITEM_ID_OFFSET + 27, ItemType.KEY),
    "Key for Projector Room": ItemData(SHIVERS_ITEM_ID_OFFSET + 28, ItemType.KEY),
    "Key for Generator Room": ItemData(SHIVERS_ITEM_ID_OFFSET + 29, ItemType.KEY),
    "Key for Egypt Room": ItemData(SHIVERS_ITEM_ID_OFFSET + 30, ItemType.KEY),
    "Key for Library": ItemData(SHIVERS_ITEM_ID_OFFSET + 31, ItemType.KEY),
    "Key for Shaman Room": ItemData(SHIVERS_ITEM_ID_OFFSET + 32, ItemType.KEY),
    "Key for UFO Room": ItemData(SHIVERS_ITEM_ID_OFFSET + 33, ItemType.KEY),
    "Key for Torture Room": ItemData(SHIVERS_ITEM_ID_OFFSET + 34, ItemType.KEY),
    "Key for Puzzle Room": ItemData(SHIVERS_ITEM_ID_OFFSET + 35, ItemType.KEY),
    "Key for Bedroom": ItemData(SHIVERS_ITEM_ID_OFFSET + 36, ItemType.KEY),
    "Key for Underground Lake": ItemData(SHIVERS_ITEM_ID_OFFSET + 37, ItemType.KEY),
    "Key for Janitor Closet": ItemData(SHIVERS_ITEM_ID_OFFSET + 38, ItemType.KEY),
    "Key for Front Door": ItemData(SHIVERS_ITEM_ID_OFFSET + 39, ItemType.KEY_OPTIONAL),
