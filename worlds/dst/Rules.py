...
def has_survived_num_days (day_goal:int, state: CollectionState, player: int) -> bool:
	...
	if item_count < 4:
		return False
	return (day_goal if day_goal < 20 else 20) > (4 - (item_count/2))
...
def basic_exploration (state: CollectionState, player: int) -> bool:
	return state.has_all(["Backpack", "Bug Net", "Rope"], player) and state.has_any(["Shovel", "Regal Shovel"], player)
...
def base_making (state: CollectionState, player: int) -> bool:
	return state.has_all(["Boards", "Cut Stone", "Electrical Doodad", "Rope"], player)
...
def spring_survival (state: CollectionState, player: int) -> bool:
	return state.has_any(["Umbrella", "Rain Coat", "Rain Hat"], player) or state.has_all(["Eyebrella", "Deerclops Eyeball"], player) or advanced_player_bias(state, player)
...
def has_summer_insulation (state: CollectionState, player: int) -> bool:
	return (state.has_any(["Umbrella", "Summer Frest", "Thermal Stone"], player) 
			...
			or state.has_all(["Eyebrella", "Deerclops Eyeball"], player)
		)
def summer_survival (state: CollectionState, player: int) -> bool:
	return (has_cooling_source(state,player) and has_summer_insulation(state,player)) or advanced_player_bias(state, player)
...
def advanced_cooking (state: CollectionState, player: int) -> bool:
	return basic_cooking(state, player) and basic_farming(state, player) and state.has_all(["Bird Trap", "Birdcage", "Papyrus"], player)
						
def advanced_exploration (state: CollectionState, player: int) -> bool:
	return (state.has_all(["Piggyback", "Walking Cane", "Reach Winter"], player)) or advanced_player_bias(state, player)
...
def crab_king (state: CollectionState, player: int) -> bool:
	return advanced_boating(state, player) and state.count("Crabby Hermit Friendship", player) >= 10
...
def moonstorm_exploration (state: CollectionState, player: int) -> bool:
	return state.has_all(["Celestial Sanctum Icon", "Celestial Sanctum Ward", "Inactive Celestial Tribute", "Pinchin' Winch"], player) and lunar_island(state, player) and storm_protection(state,player) and advanced_exploration(state, player)
						
def celestial_champion (state: CollectionState, player: int) -> bool:
	return moonstorm_exploration(state, player) and state.has_all(["Incomplete Experiment", "Celestial Orb"], player)
...
def ancient_fuelweaver (state: CollectionState, player: int) -> bool:
	return dark_magic(state, player) and state.has_all(["Shadow Atrium", "Ancient Key"], player) and (state.has("Nightmare Amulet", player) or expert_player_bias(state, player))

def moon_quay_exploration (state: CollectionState, player: int) -> bool:
	return advanced_boating(state, player)

def wall_building (state: CollectionState, player: int) -> bool:
	return (base_making(state,player) and (state.has_any(["Stone Wall", "Potter's Wheel"], player))) or ruins_exploration(state,player)
...
def get_rules_lookup(player: int):
	rules_lookup: typing.Dict[str, typing.List[Callable[[CollectionState], bool]]] = {
		"locations": {
			...
			# Bosses
			"Treeguard": lambda state: basic_combat(state,player),
			"Spider Queen": lambda state: advanced_combat(state,player) and reached_spring(state,player),
			"Deerclops": lambda state: basic_combat(state,player) and is_winter(state,player),
			"Moose/Goose": lambda state: basic_combat(state,player) and is_spring(state,player),
			"Antlion": lambda state: advanced_combat(state,player) and is_summer(state,player) and storm_protection(state,player),
			"Bearger": lambda state: basic_combat(state,player) and reached_autumn(state,player),
			"Ancient Guardian": lambda state: state.has("Ancient Key", player), # Given by event
			"Dragonfly": lambda state: advanced_combat(state,player) and wall_building(state,player),
			"Bee Queen": lambda state: epic_combat(state,player),
			"Crab King": lambda state: state.has("Inactive Celestial Tribute", player), # Given by event
			"Klaus": lambda state: advanced_combat(state,player) and is_winter(state, player),
			"Malbatross": lambda state: advanced_combat(state,player) and advanced_boating(state, player),
			"Toadstool": lambda state: epic_combat(state,player) and cave_exploration(state, player) and dark_magic(state,player),
			"Shadow Bishop": lambda state: state.has("Shadow Atrium", player), # Given by event
			"Shadow Knight": lambda state: state.has("Shadow Atrium", player),
			"Shadow Rook": lambda state: state.has("Shadow Atrium", player),
			"Ancient Fuelweaver": lambda state: ancient_fuelweaver(state,player),
			"Lord of the Fruit Flies": lambda state: basic_combat(state,player) and advanced_farming(state,player) and reached_spring(state, player),
			"Celestial Champion": lambda state: celestial_champion(state,player),
			"Eye Of Terror": lambda state: advanced_combat(state,player),
			"Retinazor": lambda state: epic_combat(state,player),
			"Spazmatism": lambda state: epic_combat(state,player),
			"Nightmare Werepig": lambda state: ruins_exploration(state,player) and epic_combat(state,player) and state.has_all(["Opulent Pickaxe", "Luxury Axe"], player),
			"Scrappy Werepig": lambda state: ruins_exploration(state,player) and epic_combat(state,player) and state.has_all(["Opulent Pickaxe", "Luxury Axe"], player),
			"Frostjaw": lambda state: advanced_boating(state,player) and advanced_combat(state,player) and advanced_exploration(state, player),
			...
			"Canary": lambda state: advanced_cooking(state,player),
			...
			"Crow": lambda state: advanced_cooking(state,player),
			...
			"Ghost": lambda state: basic_exploration(state,player),
			"Gnarwail": lambda state: basic_combat(state,player) and advanced_boating(state,player),
			"Grass Gator": lambda state: basic_combat(state,player) and advanced_boating(state,player),
			"Grass Gekko": lambda state: basic_combat(state,player),
			"Briar Wolf": lambda state: basic_combat(state,player),
			"Hound": lambda state: basic_combat(state,player),
			...
			"Koalefant": lambda state: basic_combat(state,player) and basic_cooking(state,player),
			"Krampus": lambda state: basic_combat(state,player),
			"Treeguard": lambda state: basic_combat(state,player),
			"Crustashine": lambda state: moon_quay_exploration(state,player),
			"Bulbous Lightbug": lambda state: cave_exploration(state,player),
			"Volt Goat": lambda state: basic_combat(state,player),
			"Merm": lambda state: basic_combat(state,player),
			...
			"Mosquito": lambda state: basic_combat(state,player),
			...
			"Redbird": lambda state: advanced_cooking(state,player),
			"Snowbird": lambda state: advanced_cooking(state,player) and is_winter(state,player),
			...
			"Rockjaw": lambda state: advanced_combat(state,player) and advanced_boating(state,player),
			...
			"Tentacle": lambda state: basic_combat(state,player) and healing(state,player),
			...
			"Varglet": lambda state: basic_combat(state,player) and advanced_exploration(state,player) and reached_winter(state,player),
			...
			"Taffy": lambda state: basic_cooking(state,player),
			"Pumpkin Cookies": lambda state: advanced_cooking(state,player),
			"Stuffed Eggplant": lambda state: advanced_cooking(state,player),
			"Fishsticks": lambda state: basic_cooking(state,player) and fishing(state,player),
			"Honey Nuggets": lambda state: basic_cooking(state,player),
			"Honey Ham": lambda state: basic_cooking(state,player),
			"Dragonpie": lambda state: advanced_cooking(state,player) or (basic_cooking(state,player) and lunar_island(state,player)),
			"Kabobs": lambda state: pre_basic_cooking(state,player),
			"Mandrake Soup": lambda state: basic_cooking(state,player),
			"Bacon and Eggs": lambda state: advanced_cooking(state,player),
			"Meatballs": lambda state: pre_basic_cooking(state,player),
			"Meaty Stew": lambda state: pre_basic_cooking(state,player),
			"Pierogi": lambda state: advanced_cooking(state,player),
			"Turkey Dinner": lambda state: basic_cooking(state,player),
			"Ratatouille": lambda state: pre_basic_cooking(state,player),
			"Fist Full of Jam": lambda state: pre_basic_cooking(state,player),
			"Fruit Medley": lambda state: advanced_cooking(state,player),
			"Fish Tacos": lambda state: advanced_cooking(state,player) and fishing(state, player),
			"Waffles": lambda state: advanced_cooking(state,player) and has_survived_num_days(10, state, player),
			...
			"Ice Cream": lambda state: basic_cooking(state,player) and spring_survival(state,player) and state.has("Morning Star", player),
			"Melonsicle": lambda state: advanced_cooking(state,player),
			...
			"Fancy Spiralled Tubers": lambda state: advanced_cooking(state,player),
			"Creamy Potato Purée": lambda state: advanced_cooking(state,player),
			"Asparagus Soup": lambda state: advanced_cooking(state,player),
			"Vegetable Stinger": lambda state: advanced_cooking(state,player),
			...
			"Ceviche": lambda state: advanced_cooking(state,player),
			"Salsa Fresca": lambda state: advanced_cooking(state,player),
			"Stuffed Pepper Poppers": lambda state: advanced_cooking(state,player),
			...
			"Lobster Bisque": lambda state: sea_cooking(state,player),
			"Lobster Dinner": lambda state: sea_cooking(state,player),
			...
			"Leafy Meatloaf": lambda state: sea_cooking(state,player),
			"Veggie Burger": lambda state: advanced_cooking(state,player) and sea_cooking(state, player),
			"Jelly Salad": lambda state: sea_cooking(state,player),
			"Beefy Greens": lambda state: advanced_cooking(state,player) and sea_cooking(state,player),
			"Mushy Cake": lambda state: basic_cooking(state,player) and cave_exploration(state,player),
			"Soothing Tea": lambda state: advanced_cooking(state,player),
			...
			"Plain Omelette": lambda state: advanced_cooking(state,player),
			"Breakfast Skillet": lambda state: advanced_cooking(state,player),
			"Tall Scotch Eggs": lambda state: advanced_cooking(state,player),
			"Steamed Twigs": lambda state: basic_cooking(state,player),
			"Beefalo Treats": lambda state: basic_cooking(state,player),
			"Milkmade Hat": lambda state: basic_cooking(state,player) and cave_exploration(state,player) and basic_boating(state,player),
			...
			# Warly Dishes
			"Grim Galette": lambda state: advanced_cooking(state,player) and warly_dishes_enabled(state,player),
			...
			"Hot Dragon Chili Salad": lambda state: advanced_cooking(state,player) and warly_dishes_enabled(state,player),
			"Asparagazpacho": lambda state: advanced_cooking(state,player) and warly_dishes_enabled(state,player),
			...
			"Fresh Fruit Crepes": lambda state: advanced_cooking(state,player) and warly_dishes_enabled(state,player),
			"Bone Bouillon": lambda state: advanced_cooking(state,player) and warly_dishes_enabled(state,player),
			"Moqueca": lambda state: advanced_cooking(state,player) and sea_cooking(state,player) and warly_dishes_enabled(state,player),
			# Farming 
			...
			"Science (Azure Feather)": lambda state: (expert_player_bias(state, player) or (reached_winter(state, player) and (state.has("Bird Trap", player) or advanced_player_bias(state, player)))),	
			"Science (Crimson Feather)": lambda state: (expert_player_bias(state, player) or ((state.has("Bird Trap", player) or advanced_player_bias(state, player)))),	
			"Science (Jet Feather)": lambda state: (advanced_player_bias(state, player) or state.has("Bird Trap", player)),	
			"Science (Saffron Feather)": lambda state: (expert_player_bias(state, player) or (state.has_all(["Friendly Scarecrow", "Boards", "Bird Trap"], player) and basic_farming(state,player))),	
			...
			"Science (Fig)": lambda state: basic_boating(state,player),			
			...
			"Science (Butter)": lambda state: has_survived_num_days(8, state, player),				
			"Science (Asparagus)": lambda state: basic_farming(state,player) and has_survived_num_days(15, state, player),			
			...
			"Science (Pomegranate)": lambda state: basic_farming(state,player) and has_survived_num_days(15, state, player),		
			...
			"Science (Watermelon)": lambda state: basic_farming(state,player) and has_survived_num_days(15, state, player),		
			"Science (Pepper)": lambda state: basic_farming(state,player) and has_survived_num_days(15, state, player),				
			"Science (Durian)": lambda state: basic_farming(state,player) and has_survived_num_days(15, state, player),				
			"Science (Carrot)": lambda state: True,				
			"Science (Stone Fruit)": lambda state: lunar_island(state,player),		
			"Magic (Blue Gem)": lambda state: reached_winter(state, player) or cave_exploration(state,player) or state.has_any(["Shovel", "Regal Shovel"],player),					
			...
			"Magic (Red Gem)": lambda state: (reached_summer(state, player) or cave_exploration(state,player) or state.has_any(["Shovel", "Regal Shovel"],player)),					
			...
			"Magic (Leafy Meat)": lambda state: (reached_spring(state,player) or lunar_island(state, player)),				
			"Magic (Canary (Volatile))": lambda state: cave_exploration(state,player) and advanced_cooking(state,player),		
			"Magic (Life Giving Amulet)": lambda state: state.has("Life Giving Amulet", player),			
			...
			"Think Tank (Lunar Wobster)": lambda state: advanced_boating(state,player) and sea_fishing(state, player),
