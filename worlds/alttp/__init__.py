...
class ALTTPWorld(World):
    ...
    location_name_groups = {
        ...
        "Hyrule Castle": {"Hyrule Castle - Inner Basement Chest", "Hyrule Castle - First Basement Chest",
                          "Hyrule Castle - Zelda's Chest", "Sewers - Dark Cross", "Sewers - Secret Room - Left",
                          "Sewers - Secret Room - Middle", "Sewers - Secret Room - Right",
                          "Hyrule Castle - Inner Guard Key Drop", "Hyrule Castle - First Guard Key Drop",
                          "Hyrule Castle - Prison Key Drop", "Sewers - Key Rat Key Drop"},
        "Eastern Palace": {"Eastern Palace - Skeleton Ambush Chest", "Eastern Palace - Big Chest",
                           "Eastern Palace - Cannonball Chest", "Eastern Palace - Antifairy Chest",
                           "Eastern Palace - Eastern Ledge Chest", "Eastern Palace - Boss",
                           "Eastern Palace - Dark Eyegore Key Drop", "Eastern Palace - Dark Square Pot Key"},
        "Desert Palace": {"Desert Palace - Big Chest", "Desert Palace - Torch", "Desert Palace - Wide Room Chest",
                          "Desert Palace - Pre-Cannonball Chest", "Desert Palace - Post-Cannonball Chest", "Desert Palace - Boss",
                          "Desert Palace - Desert Tiles 1 Pot Key", "Desert Palace - Beamos Hall Pot Key",
                          "Desert Palace - Desert Tiles 2 Pot Key"},
        "Tower of Hera": {"Tower of Hera - Basement Cage", "Tower of Hera - Entryway Chest", "Tower of Hera - Basement Chest",
        ...
        "Palace of Darkness": {"Palace of Darkness - Shooter Room", "Palace of Darkness - The Arena - Bridge",
                               "Palace of Darkness - Stalfos Basement", "Palace of Darkness - Central Island",
                               "Palace of Darkness - The Arena - Ledge", "Palace of Darkness - Mimic Chest",
                               "Palace of Darkness - Turtle Room", "Palace of Darkness - Dark Basement - Left",
        ...
        "Swamp Palace": {"Swamp Palace - Entrance", "Swamp Palace - Bomb Wall", "Swamp Palace - Big Chest",
                         "Swamp Palace - South Loop", "Swamp Palace - West Side Switch Chest", "Swamp Palace - West Side Free Chest",
                         "Swamp Palace - Flooded Room - Left", "Swamp Palace - Flooded Room - Right",
                         "Swamp Palace - Waterfall Room", "Swamp Palace - Boss",
                         "Swamp Palace - Pot Row Pot Key", "Swamp Palace - Trench 1 Pot Key", "Swamp Palace - Trench 2 Pot Key",
                         "Swamp Palace - Hookshot Pot Key", "Swamp Palace - Waterway Pot Key"},
        "Thieves' Town": {"Thieves' Town - Entryway Alcove Chest", "Thieves' Town - Entryway Floor Chest", "Thieves' Town - SE Ledge Chest",
        ...
        "Skull Woods": {"Skull Woods - Chest Near Front Door", "Skull Woods - Pinball Room", "Skull Woods - Pit Trap Chest",
                        "Skull Woods - Pot Prison", "Skull Woods - Big Chest", "Skull Woods - Middle Section Chest",
                        "Skull Woods - Bridge Room", "Skull Woods - Boss",
                        "Skull Woods - West Lobby Pot Key", "Skull Woods - Spike Corner Key Drop"},
        "Ice Palace": {"Ice Palace - Pengator Chest", "Ice Palace - Freezor Chest", "Ice Palace - Big Chest",
                       "Ice Palace - Freezor Chest", "Ice Palace - Big Chest", "Ice Palace - Iced T Room",
                       "Ice Palace - Spike Room", "Ice Palace - Icebreaker Chest", "Ice Palace - Tongue Pull Chest",
                       "Ice Palace - Boss",
                       "Ice Palace - Jelly Key Drop", "Ice Palace - Conveyor Key Drop", "Ice Palace - Many Pots Pot Key"},
        "Misery Mire": {"Misery Mire - Big Chest", "Misery Mire - Switch Block Chest", "Misery Mire - Main Lobby",
                        "Misery Mire - Bridge Chest", "Misery Mire - Spike Chest", "Misery Mire - Torch Tiles Chest",
                        "Misery Mire - Cutscene Chest", "Misery Mire - Boss",
                        "Misery Mire - Spikes Pot Key", "Misery Mire - Conveyor Crystal Key Drop", "Misery Mire - Fishbone Pot Key"},
        "Turtle Rock": {"Turtle Rock - Spiky Trap Room", "Turtle Rock - Roller Room - Left",
                        "Turtle Rock - Roller Room - Right", "Turtle Rock - Chain Chomps", "Turtle Rock - Pipe Maze Center",
        ...
        "Ganons Tower": {"Ganons Tower - Bob's Torch", "Ganons Tower - Hope Room - Left",
                         ...
                         "Ganons Tower - Twin Firebar Chest", "Ganons Tower - Firesnake Room",
                         "Ganons Tower - Randomizer Room - Top Left", "Ganons Tower - Randomizer Room - Top Right",
                         "Ganons Tower - Randomizer Room - Bottom Left", "Ganons Tower - Randomizer Room - Bottom Right",
                         "Ganons Tower - Bob's Chest", "Ganons Tower - Big Chest", "Ganons Tower - Ice Armos Room - Left",
        ...
        # Remove the following aliases come 2025, when players have adjusted to the changes
        "Hyrule Castle - Boomerang Chest": {"Hyrule Castle - Inner Basement Chest"},
        "Hyrule Castle - Boomerang Guard Key Drop": {"Hyrule Castle - Inner Guard Key Drop"},
        "Hyrule Castle - Map Chest": {"Hyrule Castle - First Basement Chest"},
        "Hyrule Castle - Map Guard Key Drop": {"Hyrule Castle - First Guard Key Drop"},
        "Hyrule Castle - Big Key Drop": {"Hyrule Castle - Prison Key Drop"},
        "Eastern Palace - Map Chest": {"Eastern Palace - Eastern Ledge Chest"},
        "Eastern Palace - Compass Chest": {"Eastern Palace - Skeleton Ambush Chest"},
        "Eastern Palace - Big Key Chest": {"Eastern Palace - Antifairy Chest"},
        "Desert Palace - Map Chest": {"Desert Palace - Wide Room Chest"},
        "Desert Palace - Compass Chest": {"Desert Palace - Pre-Cannonball Chest"},
        "Desert Palace - Big Key Chest": {"Desert Palace - Post-Cannonball Chest"},
        "Tower of Hera - Map Chest": {"Tower of Hera - Entryway Chest"},
        "Tower of Hera - Compass Chest": {"Tower of Hera - South of Big Chest"},
        "Tower of Hera - Big Key Chest": {"Tower of Hera - Basement Chest"},
        "Palace of Darkness - Map Chest": {"Palace of Darkness - Mimic Chest"},
        "Palace of Darkness - Compass Chest": {"Palace of Darkness - Turtle Room"},
        "Palace of Darkness - Big Key Chest": {"Palace of Darkness - Central Island"},
        "Swamp Palace - Map Chest": {"Swamp Palace - Bomb Wall"},
        "Swamp Palace - Compass Chest": {"Swamp Palace - South Loop"},
        "Swamp Palace - Big Key Chest": {"Swamp Palace - West Side Switch Chest"},
        "Swamp Palace - West Chest": {"Swamp Palace - West Side Free Chest"},
        "Skull Woods - Map Chest": {"Skull Woods - Chest Near Front Door"},
        "Skull Woods - Compass Chest": {"Skull Woods - Pit Trap Chest"},
        "Skull Woods - Big Key Chest": {"Skull Woods - Middle Section Chest"},
        "Thieves' Town - Map Chest": {"Thieves' Town - Entryway Floor Chest"},
        "Thieves' Town - Compass Chest": {"Thieves' Town - SE Ledge Chest"},
        "Thieves' Town - Big Key Chest": {"Thieves' Town - Entryway Alcove Chest"},
        "Ice Palace - Map Chest": {"Ice Palace - Tongue Pull Chest"},
        "Ice Palace - Compass Chest": {"Ice Palace - Pengator Chest"},
        "Ice Palace - Big Key Chest": {"Ice Palace - Icebreaker Chest"},
        "Misery Mire - Map Chest": {"Misery Mire - Switch Block Chest"},
        "Misery Mire - Compass Chest": {"Misery Mire - Torch Tiles Chest"},
        "Misery Mire - Big Key Chest": {"Misery Mire - Cutscene Chest"},
        "Turtle Rock - Compass Chest": {"Turtle Rock - Spiky Trap Room"},
        "Turtle Rock - Big Key Chest": {"Turtle Rock - Pipe Maze Center"},
        "Ganons Tower - Map Chest": {"Ganons Tower - Twin Firebar Chest"},
        "Ganons Tower - Compass Room - Bottom Left": {"Ganons Tower - East Warp Room - Bottom Left"},
        "Ganons Tower - Compass Room - Bottom Right": {"Ganons Tower - East Warp Room - Bottom Right"},
        "Ganons Tower - Compass Room - Top Left": {"Ganons Tower - East Warp Room - Top Left"},
        "Ganons Tower - Compass Room - Top Right": {"Ganons Tower - East Warp Room - Top Right"},
        "Ganons Tower - Big Key Chest": {"Ganons Tower - Ice Armos Room - Middle"},
        "Ganons Tower - Big Key Room - Left": {"Ganons Tower - Ice Armos Room - Left"},
        "Ganons Tower - Big Key Room - Right": {"Ganons Tower - Ice Armos Room - Right"}
        # End of aliases
    }
