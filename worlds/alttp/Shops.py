...
from worlds.alttp.Options import SmallKeyShuffle, Goal
...
def create_shops(world, player: int):
    ...
    chance_100 = int(world.retro_bow[player]) * 0.25 + int(
        world.smallkey_shuffle[player] == SmallKeyShuffle.option_universal) * 0.5
...
def set_up_shops(world, player: int):
    ...
    if world.smallkey_shuffle[player] == SmallKeyShuffle.option_universal or world.retro_bow[player]:
