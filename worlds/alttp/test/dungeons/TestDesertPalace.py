...
class TestDesertPalace(TestDungeon):
    ...
    def testDesertPalace(self):
        ...
        self.run_tests([
            ...
            ["Desert Palace - Pre-Cannonball Chest", False, ['Small Key (Desert Palace)']],
            ["Desert Palace - Pre-Cannonball Chest", True, ['Progressive Sword', 'Small Key (Desert Palace)']],
            ...
            ["Desert Palace - Post-Cannonball Chest", False, ['Small Key (Desert Palace)']],
            ["Desert Palace - Post-Cannonball Chest", True, ['Progressive Sword', 'Small Key (Desert Palace)']],
