...
class TestIcePalace(TestDungeon):
    ...
    def testIcePalace(self):
        ...
        self.run_tests([
            ...
            ["Ice Palace - Icebreaker Chest", True, ['Bomb Upgrade (+5)', 'Progressive Glove', 'Fire Rod', 'Hammer', 'Hookshot', 'Small Key (Ice Palace)', 'Small Key (Ice Palace)', 'Small Key (Ice Palace)', 'Small Key (Ice Palace)']],
            ["Ice Palace - Icebreaker Chest", True, ['Bomb Upgrade (+5)', 'Progressive Glove', 'Bombos', 'Progressive Sword', 'Hammer', 'Hookshot', 'Small Key (Ice Palace)', 'Small Key (Ice Palace)', 'Small Key (Ice Palace)', 'Small Key (Ice Palace)']],
            ...
            ["Ice Palace - Pengator Chest", True, ['Small Key (Ice Palace)', 'Fire Rod']],
            ["Ice Palace - Pengator Chest", True, ['Small Key (Ice Palace)', 'Bombos', 'Progressive Sword']],
            ...
            ["Ice Palace - Tongue Pull Chest", True, ['Small Key (Ice Palace)', 'Bomb Upgrade (+5)', 'Progressive Glove', 'Fire Rod', 'Hammer', 'Hookshot', 'Small Key (Ice Palace)']],
            ["Ice Palace - Tongue Pull Chest", True, ['Small Key (Ice Palace)', 'Bomb Upgrade (+5)', 'Progressive Glove', 'Bombos', 'Progressive Sword', 'Hammer', 'Hookshot', 'Small Key (Ice Palace)']],
