...
class TestIcePalace(TestDungeon):
    ...
    def testIcePalace(self):
        ...
        self.run_tests([
            ...
            ["Ice Palace - Icebreaker Chest", True, ['Progressive Glove', 'Fire Rod', 'Hammer', 'Hookshot', 'Small Key (Ice Palace)']],
            ["Ice Palace - Icebreaker Chest", True, ['Progressive Glove', 'Bombos', 'Progressive Sword', 'Hammer', 'Hookshot', 'Small Key (Ice Palace)']],
            ...
            ["Ice Palace - Tongue Pull Chest", True, ['Progressive Glove', 'Fire Rod', 'Hammer', 'Hookshot', 'Small Key (Ice Palace)']],
            ["Ice Palace - Tongue Pull Chest", True, ['Progressive Glove', 'Bombos', 'Progressive Sword', 'Hammer', 'Hookshot', 'Small Key (Ice Palace)']],
