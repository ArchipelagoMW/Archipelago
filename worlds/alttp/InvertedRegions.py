...
def create_inverted_regions(multiworld: MultiWorld, player: int):
    ...
    multiworld.regions += [
        ...
        create_dungeon_region(multiworld, player, 'Eastern Palace', 'Eastern Palace',
                              ['Eastern Palace - Skeleton Ambush Chest', 'Eastern Palace - Big Chest',
                               ...
                               'Eastern Palace - Eastern Ledge Chest', 'Eastern Palace - Boss', 'Eastern Palace - Prize'],
                              ['Eastern Palace Exit']),
        ...
        create_dungeon_region(multiworld, player, 'Hyrule Castle', 'Hyrule Castle',
                              ['Hyrule Castle - Inner Basement Chest', 'Hyrule Castle - First Basement Chest',
                               'Hyrule Castle - Zelda\'s Chest',
                               'Hyrule Castle - First Guard Key Drop', 'Hyrule Castle - Inner Guard Key Drop',
                               'Hyrule Castle - Prison Key Drop'],
        ...
        create_dungeon_region(multiworld, player, 'Tower of Hera (Bottom)', 'Tower of Hera', ['Tower of Hera - Basement Cage', 'Tower of Hera - Entryway Chest'], ['Tower of Hera Small Key Door', 'Tower of Hera Big Key Door', 'Tower of Hera Exit']),
        create_dungeon_region(multiworld, player, 'Tower of Hera (Basement)', 'Tower of Hera', ['Tower of Hera - Basement Chest']),
        create_dungeon_region(multiworld, player, 'Tower of Hera (Top)', 'Tower of Hera', ['Tower of Hera - South of Big Chest', 'Tower of Hera - Big Chest', 'Tower of Hera - Boss', 'Tower of Hera - Prize']),
        ...
        create_dungeon_region(multiworld, player, 'Turtle Rock (Second Section)', 'Turtle Rock',
                              ['Turtle Rock - Pipe Maze Center', 'Turtle Rock - Pokey 2 Key Drop'],
        ...
        create_dungeon_region(multiworld, player, 'Ganons Tower (Compass Room)', 'Ganon\'s Tower',
                              ['Ganons Tower - East Warp Room - Top Left', 'Ganons Tower - East Warp Room - Top Right',
                               'Ganons Tower - East Warp Room - Bottom Left',
                               'Ganons Tower - East Warp Room - Bottom Right',
        ...
        create_dungeon_region(multiworld, player, 'Ganons Tower (Bottom)', 'Ganon\'s Tower',
                              ['Ganons Tower - Bob\'s Chest', 'Ganons Tower - Big Chest',
                               'Ganons Tower - Ice Armos Room - Left',
