...
def create_inverted_regions(world, player):
    ...
    world.regions += [
        ...
        create_dungeon_region(player, 'Desert Palace North', 'Desert Palace',
        ...
        create_dungeon_region(player, 'Eastern Palace', 'Eastern Palace',
        ...
        create_dungeon_region(player, 'Hyrule Castle', 'Hyrule Castle',
        ...
        create_dungeon_region(player, 'Inverted Agahnims Tower', 'Castle Tower', ['Castle Tower - Room 03', 'Castle Tower - Dark Maze',  'Castle Tower - Dark Archer Key Drop', 'Castle Tower - Circle of Pots Key Drop'], ['Agahnim 1', 'Inverted Agahnims Tower Exit']),
        ...
        create_dungeon_region(player, 'Swamp Palace (Starting Area)', 'Swamp Palace', ['Swamp Palace - Map Chest', 'Swamp Palace - Pot Row Pot Key',
                                                                                       'Swamp Palace - Trench 1 Pot Key'], ['Swamp Palace (Center)']),
        create_dungeon_region(player, 'Swamp Palace (Center)', 'Swamp Palace', ['Swamp Palace - Big Chest', 'Swamp Palace - Compass Chest', 'Swamp Palace - Hookshot Pot Key',
                                                                                'Swamp Palace - Trench 2 Pot Key'], ['Swamp Palace (North)', 'Swamp Palace (West)']),
        create_dungeon_region(player, 'Swamp Palace (West)', 'Swamp Palace', ['Swamp Palace - Big Key Chest', 'Swamp Palace - West Chest']),
        ...
        create_dungeon_region(player, 'Skull Woods Second Section', 'Skull Woods', ['Skull Woods - Big Key Chest', 'Skull Woods - West Lobby Pot Key'], ['Skull Woods Second Section Exit (East)', 'Skull Woods Second Section Exit (West)']),
        create_dungeon_region(player, 'Skull Woods Final Section (Entrance)', 'Skull Woods', ['Skull Woods - Bridge Room', 'Skull Woods - Spike Corner Key Drop'], ['Skull Woods Torch Room', 'Skull Woods Final Section Exit']),
        create_dungeon_region(player, 'Skull Woods Final Section (Mothula)', 'Skull Woods', ['Skull Woods - Boss', 'Skull Woods - Prize']),
        create_dungeon_region(player, 'Ice Palace (Entrance)', 'Ice Palace', ['Ice Palace - Jelly Key Drop'], ['Ice Palace (Second Section)', 'Ice Palace Exit']),
        create_dungeon_region(player, 'Ice Palace (Second Section)', 'Ice Palace', ['Ice Palace - Conveyor Key Drop', 'Ice Palace - Compass Chest'], ['Ice Palace (Main)']),
        create_dungeon_region(player, 'Ice Palace (Main)', 'Ice Palace', ['Ice Palace - Freezor Chest',
        ...
        create_dungeon_region(player, 'Ice Palace (East Top)', 'Ice Palace', ['Ice Palace - Big Key Chest', 'Ice Palace - Map Chest', 'Ice Palace - Hammer Block Key Drop']),
        ...
        create_dungeon_region(player, 'Turtle Rock (Pokey Room)', 'Turtle Rock', ['Turtle Rock - Pokey 1 Key Drop'], ['Turtle Rock (Pokey Room) (North)', 'Turtle Rock (Pokey Room) (South)']),
        create_dungeon_region(player, 'Turtle Rock (Chain Chomp Room)', 'Turtle Rock', ['Turtle Rock - Chain Chomps'],
                              ['Turtle Rock (Chain Chomp Room) (North)', 'Turtle Rock (Chain Chomp Room) (South)']),
        create_dungeon_region(player, 'Turtle Rock (Second Section)', 'Turtle Rock',
        ...
        create_dungeon_region(player, 'Inverted Ganons Tower (Entrance)', 'Ganon\'s Tower',
        ...
        create_dungeon_region(player, 'Ganons Tower (Tile Room)', 'Ganon\'s Tower', ['Ganons Tower - Tile Room'],
                              ['Ganons Tower (Tile Room) Key Door']),
        create_dungeon_region(player, 'Ganons Tower (Compass Room)', 'Ganon\'s Tower',
        ...
        create_dungeon_region(player, 'Ganons Tower (Hookshot Room)', 'Ganon\'s Tower',
        ...
        create_dungeon_region(player, 'Ganons Tower (Firesnake Room)', 'Ganon\'s Tower',
                              ['Ganons Tower - Firesnake Room'], ['Ganons Tower (Firesnake Room)']),
        create_dungeon_region(player, 'Ganons Tower (Teleport Room)', 'Ganon\'s Tower',
        ...
        create_dungeon_region(player, 'Ganons Tower (Bottom)', 'Ganon\'s Tower',
        ...
        create_dungeon_region(player, 'Ganons Tower (Before Moldorm)', 'Ganon\'s Tower',
