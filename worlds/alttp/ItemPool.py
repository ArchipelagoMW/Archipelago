...
from .Items import item_factory, GetBeemizerItem
...
def generate_itempool(world):
    ...
    if multiworld.goal[player] == 'icerodhunt':
        ...
        multiworld.push_item(loc, item_factory('Triforce Piece', world), False)
    ...
    for key_loc in key_drop_data:
        ...
        if not multiworld.key_drop_shuffle[player]:
            ...
            multiworld.itempool.append(item_factory(GetBeemizerItem(world, player, 'Nothing'), world))
            ...
            multiworld.itempool.append(item_factory(GetBeemizerItem(world, player, 'Small Key (Universal)'), world))
    ...
    if multiworld.goal[player] == 'icerodhunt':
        for item in dungeon_items:
            multiworld.itempool.append(item_factory(GetBeemizerItem(multiworld, player, 'Nothing'), world))
    ...
    if additional_triforce_pieces:
        ...
        progressionitems += [item_factory("Triforce Piece", world) for _ in range(additional_triforce_pieces)]
