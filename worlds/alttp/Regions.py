...
def create_regions(world, player):
    ...
    world.regions += [
        create_lw_region(player, 'Menu', world, None, ['Links House S&Q', 'Sanctuary S&Q', 'Old Man S&Q']),
        create_lw_region(player, 'Light World', world, ['Mushroom', 'Bottle Merchant', 'Flute Spot', 'Sunken Treasure',
        ...
        create_lw_region(player, 'Death Mountain Entrance', world, None, ['Old Man Cave (West)', 'Death Mountain Entrance Drop']),
        create_lw_region(player, 'Lake Hylia Central Island', world, None, ['Capacity Upgrade', 'Lake Hylia Central Island Teleporter']),
        ...
        create_cave_region(player, 'Links House', 'your house', world, ['Link\'s House'], ['Links House Exit']),
        ...
        create_lw_region(player, 'Cave 45 Ledge', world, None, ['Cave 45']),
        create_cave_region(player, 'Cave 45', 'a cave with an item', world, ['Cave 45']),
        create_lw_region(player, 'Graveyard Ledge', world, None, ['Graveyard Cave']),
        ...
        create_lw_region(player, 'Maze Race Ledge', world, ['Maze Race'], ['Two Brothers House (West)']),
        create_cave_region(player, '50 Rupee Cave', 'a cave with some cash', world),
        create_lw_region(player, 'Desert Ledge', world, ['Desert Ledge'], ['Desert Palace Entrance (North) Rocks', 'Desert Palace Entrance (West)']),
        create_lw_region(player, 'Desert Ledge (Northeast)', world, None, ['Checkerboard Cave']),
        create_lw_region(player, 'Desert Palace Stairs', world, None, ['Desert Palace Entrance (South)']),
        create_lw_region(player, 'Desert Palace Lone Stairs', world, None, ['Desert Palace Stairs Drop', 'Desert Palace Entrance (East)']),
        create_lw_region(player, 'Desert Palace Entrance (North) Spot', world, None, ['Desert Palace Entrance (North)', 'Desert Ledge Return Rocks']),
        ...
        create_lw_region(player, 'Hyrule Castle Courtyard', world, None, ['Hyrule Castle Secret Entrance Stairs', 'Hyrule Castle Entrance (South)']),
        create_lw_region(player, 'Hyrule Castle Ledge', world, None, ['Hyrule Castle Entrance (East)', 'Hyrule Castle Entrance (West)', 'Agahnims Tower', 'Hyrule Castle Ledge Courtyard Drop']),
        ...
        create_dungeon_region(player, 'Agahnims Tower', 'Castle Tower', world, ['Castle Tower - Room 03', 'Castle Tower - Dark Maze'], ['Agahnim 1', 'Agahnims Tower Exit']),
        ...
        create_lw_region(player, 'Death Mountain', world, None, ['Old Man Cave (East)', 'Old Man House (Bottom)', 'Old Man House (Top)', 'Death Mountain Return Cave (East)', 'Spectacle Rock Cave', 'Spectacle Rock Cave Peak', 'Spectacle Rock Cave (Bottom)', 'Broken Bridge (West)', 'Death Mountain Teleporter']),
        ...
        create_lw_region(player, 'Death Mountain Return Ledge', world, None, ['Death Mountain Return Ledge Drop', 'Death Mountain Return Cave (West)']),
        ...
        create_lw_region(player, 'East Death Mountain (Bottom)', world, None, ['Broken Bridge (East)', 'Paradox Cave (Bottom)', 'Paradox Cave (Middle)', 'East Death Mountain Teleporter', 'Hookshot Fairy', 'Fairy Ascension Rocks', 'Spiral Cave (Bottom)']),
        ...
        create_lw_region(player, 'East Death Mountain (Top)', world, None, ['Paradox Cave (Top)', 'Death Mountain (Top)', 'Spiral Cave Ledge Access', 'East Death Mountain Drop', 'Turtle Rock Teleporter', 'Fairy Ascension Ledge']),
        create_lw_region(player, 'Spiral Cave Ledge', world, None, ['Spiral Cave', 'Spiral Cave Ledge Drop']),
        ...
        create_lw_region(player, 'Fairy Ascension Ledge', world, None, ['Fairy Ascension Ledge Drop', 'Fairy Ascension Cave (Top)']),
        create_lw_region(player, 'Death Mountain (Top)', world, ['Ether Tablet'], ['East Death Mountain (Top)', 'Tower of Hera', 'Death Mountain Drop']),
        create_lw_region(player, 'Spectacle Rock', world, ['Spectacle Rock'], ['Spectacle Rock Drop']),
        ...
        create_dw_region(player, 'Northeast Dark World', world, None, ['West Dark World Gap', 'Dark World Potion Shop', 'East Dark World Broken Bridge Pass', 'Catfish Entrance Rock', 'Dark Lake Hylia Teleporter']),
        ...
        create_dw_region(player, 'South Dark World', world, ['Stumpy', 'Digging Game'], ['Dark Lake Hylia Drop (South)', 'Hype Cave', 'Swamp Palace', 'Village of Outcasts Heavy Rock', 'Maze Race Mirror Spot',
        ...
        create_lw_region(player, 'Bombos Tablet Ledge', world, ['Bombos Tablet']),
        create_cave_region(player, 'Big Bomb Shop', 'the bomb shop', world),
        create_cave_region(player, 'Archery Game', 'a game of skill', world),
        create_dw_region(player, 'Dark Lake Hylia', world, None, ['Lake Hylia Island Mirror Spot', 'East Dark World Pier', 'Dark Lake Hylia Ledge']),
        create_dw_region(player, 'Dark Lake Hylia Central Island', world, None, ['Ice Palace', 'Lake Hylia Central Island Mirror Spot']),
        create_dw_region(player, 'Dark Lake Hylia Ledge', world, None, ['Dark Lake Hylia Ledge Drop', 'Dark Lake Hylia Ledge Fairy', 'Dark Lake Hylia Ledge Hint', 'Dark Lake Hylia Ledge Spike Cave']),
        ...
        create_dw_region(player, 'West Dark World', world, ['Frog'], ['Village of Outcasts Drop', 'East Dark World River Pier', 'Brewery', 'C-Shaped House', 'Chest Game', 'Thieves Town', 'Graveyard Ledge Mirror Spot', 'Kings Grave Mirror Spot', 'Bumper Cave Entrance Rock',
        ...
        create_dw_region(player, 'Dark Grassy Lawn', world, None, ['Grassy Lawn Pegs', 'Village of Outcasts Shop']),
        create_dw_region(player, 'Hammer Peg Area', world, ['Dark Blacksmith Ruins'], ['Bat Cave Drop Ledge Mirror Spot', 'Dark World Hammer Peg Cave', 'Peg Area Rocks']),
        create_dw_region(player, 'Bumper Cave Entrance', world, None, ['Bumper Cave (Bottom)', 'Bumper Cave Entrance Mirror Spot', 'Bumper Cave Entrance Drop']),
        ...
        create_cave_region(player, 'Dark Sanctuary Hint', 'a storyteller', world),
        create_cave_region(player, 'Bumper Cave', 'a connector', world, None, ['Bumper Cave Exit (Bottom)', 'Bumper Cave Exit (Top)']),
        create_dw_region(player, 'Bumper Cave Ledge', world, ['Bumper Cave Ledge'], ['Bumper Cave Ledge Drop', 'Bumper Cave (Top)', 'Bumper Cave Ledge Mirror Spot']),
        ...
        create_dw_region(player, 'Dark Desert',  world, None, ['Misery Mire', 'Mire Shed', 'Desert Ledge (Northeast) Mirror Spot', 'Desert Ledge Mirror Spot', 'Desert Palace Stairs Mirror Spot',
        ...
        create_dw_region(player, 'Dark Death Mountain (West Bottom)', world, None, ['Spike Cave', 'Spectacle Rock Mirror Spot', 'Dark Death Mountain Fairy']),
        create_dw_region(player, 'Dark Death Mountain (Top)', world, None, ['Dark Death Mountain Drop (East)', 'Dark Death Mountain Drop (West)', 'Ganons Tower', 'Superbunny Cave (Top)',
                                                             'Hookshot Cave', 'East Death Mountain (Top) Mirror Spot', 'Turtle Rock']),
        create_dw_region(player, 'Dark Death Mountain Ledge', world, None, ['Dark Death Mountain Ledge (East)', 'Dark Death Mountain Ledge (West)', 'Mimic Cave Mirror Spot', 'Spiral Cave Mirror Spot']),
        create_dw_region(player, 'Dark Death Mountain Isolated Ledge', world, None, ['Isolated Ledge Mirror Spot', 'Turtle Rock Isolated Ledge Entrance']),
        create_dw_region(player, 'Dark Death Mountain (East Bottom)', world, None, ['Superbunny Cave (Bottom)', 'Cave Shop (Dark Death Mountain)', 'Fairy Ascension Mirror Spot']),
        ...
        create_dw_region(player, 'Death Mountain Floating Island (Dark World)', world, None, ['Floating Island Drop', 'Hookshot Cave Back Entrance', 'Floating Island Mirror Spot']),
        create_lw_region(player, 'Death Mountain Floating Island (Light World)', world, ['Floating Island']),
        create_dw_region(player, 'Turtle Rock (Top)', world, None, ['Turtle Rock Drop']),
        create_lw_region(player, 'Mimic Cave Ledge', world, None, ['Mimic Cave']),
        ...
        create_dungeon_region(player, 'Ganons Tower (Entrance)', 'Ganon\'s Tower', world, ['Ganons Tower - Bob\'s Torch', 'Ganons Tower - Hope Room - Left', 'Ganons Tower - Hope Room - Right'],
        ...
        create_dw_region(player, 'Pyramid Ledge', world, None, ['Pyramid Entrance', 'Pyramid Drop']),
        create_lw_region(player, 'Desert Northern Cliffs', world),
        create_dw_region(player, 'Dark Death Mountain Bunny Descent Area', world)
    ]

    world.initialize_regions()


def create_lw_region(player: int, name: str, world: MultiWorld, locations=None, exits=None):
    return _create_region(player, name, LTTPRegionType.LightWorld, 'Light World', locations, exits, world)


def create_dw_region(player: int, name: str, world: MultiWorld, locations=None, exits=None):
    return _create_region(player, name, LTTPRegionType.DarkWorld, 'Dark World', locations, exits, world)


def create_cave_region(player: int, name: str, hint: str, world: MultiWorld, locations=None, exits=None):
    return _create_region(player, name, LTTPRegionType.Cave, hint, locations, exits, world)


def create_dungeon_region(player: int, name: str, hint: str, world: MultiWorld, locations=None, exits=None):
    return _create_region(player, name, LTTPRegionType.Dungeon, hint, locations, exits, world)


def _create_region(player: int, name: str, type: LTTPRegionType, hint: str, locations=None, exits=None, world: MultiWorld = None):
