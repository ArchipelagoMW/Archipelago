...
def create_regions(multiworld: MultiWorld, player: int):
    ...
    multiworld.regions += [
        ...
        create_dungeon_region(multiworld, player, 'Desert Palace Main (Outer)', 'Desert Palace', ['Desert Palace - Big Chest', 'Desert Palace - Torch', 'Desert Palace - Wide Room Chest'],
        ...
        create_dungeon_region(multiworld, player, 'Desert Palace East', 'Desert Palace', ['Desert Palace - Pre-Cannonball Chest', 'Desert Palace - Post-Cannonball Chest']),
        ...
        create_dungeon_region(multiworld, player, 'Eastern Palace', 'Eastern Palace', ['Eastern Palace - Skeleton Ambush Chest', 'Eastern Palace - Big Chest', 'Eastern Palace - Cannonball Chest',
                                                                           'Eastern Palace - Dark Square Pot Key', 'Eastern Palace - Dark Eyegore Key Drop', 'Eastern Palace - Antifairy Chest',
                                                                           'Eastern Palace - Eastern Ledge Chest', 'Eastern Palace - Boss', 'Eastern Palace - Prize'], ['Eastern Palace Exit']),
        ...
        create_dungeon_region(multiworld, player, 'Hyrule Castle', 'Hyrule Castle', ['Hyrule Castle - Inner Basement Chest', 'Hyrule Castle - First Basement Chest', 'Hyrule Castle - Zelda\'s Chest',
                                                                         'Hyrule Castle - First Guard Key Drop', 'Hyrule Castle - Inner Guard Key Drop', 'Hyrule Castle - Prison Key Drop'],
        ...
        create_dungeon_region(multiworld, player, 'Tower of Hera (Bottom)', 'Tower of Hera',
                              ['Tower of Hera - Basement Cage', 'Tower of Hera - Entryway Chest'],
        ...
        create_dungeon_region(multiworld, player, 'Tower of Hera (Top)', 'Tower of Hera',
                              ['Tower of Hera - South of Big Chest', 'Tower of Hera - Big Chest', 'Tower of Hera - Boss',
                               'Tower of Hera - Prize']),
        ...
        create_dungeon_region(multiworld, player, 'Swamp Palace (Starting Area)', 'Swamp Palace', ['Swamp Palace - Bomb Wall', 'Swamp Palace - Pot Row Pot Key',
                                                                                       'Swamp Palace - Trench 1 Pot Key'], ['Swamp Palace (Center)']),
        create_dungeon_region(multiworld, player, 'Swamp Palace (Center)', 'Swamp Palace', ['Swamp Palace - Big Chest', 'Swamp Palace - South Loop', 'Swamp Palace - Hookshot Pot Key',
                                                                                'Swamp Palace - Trench 2 Pot Key'], ['Swamp Palace (North)', 'Swamp Palace (West)']),
        create_dungeon_region(multiworld, player, 'Swamp Palace (West)', 'Swamp Palace', ['Swamp Palace - West Side Switch Chest', 'Swamp Palace - West Side Free Chest']),
        ...
        create_dungeon_region(multiworld, player, 'Thieves Town (Entrance)', 'Thieves\' Town', ['Thieves\' Town - Entryway Alcove Chest',
                                                                            'Thieves\' Town - Entryway Floor Chest',
                                                                            'Thieves\' Town - SE Ledge Chest',
        ...
        create_dungeon_region(multiworld, player, 'Skull Woods First Section', 'Skull Woods', ['Skull Woods - Chest Near Front Door'], ['Skull Woods First Section Exit', 'Skull Woods First Section Bomb Jump', 'Skull Woods First Section South Door', 'Skull Woods First Section West Door']),
        ...
        create_dungeon_region(multiworld, player, 'Skull Woods First Section (Left)', 'Skull Woods', ['Skull Woods - Pit Trap Chest', 'Skull Woods - Pot Prison'], ['Skull Woods First Section (Left) Door to Exit', 'Skull Woods First Section (Left) Door to Right']),
        ...
        create_dungeon_region(multiworld, player, 'Skull Woods Second Section', 'Skull Woods', ['Skull Woods - Middle Section Chest', 'Skull Woods - West Lobby Pot Key'], ['Skull Woods Second Section Exit (East)', 'Skull Woods Second Section Exit (West)']),
        ...
        create_dungeon_region(multiworld, player, 'Ice Palace (Entrance)', 'Ice Palace', ['Ice Palace - Jelly Key Drop', 'Ice Palace - Pengator Chest'], ['Ice Palace (Second Section)', 'Ice Palace Exit']),
        ...
        create_dungeon_region(multiworld, player, 'Ice Palace (East Top)', 'Ice Palace', ['Ice Palace - Icebreaker Chest', 'Ice Palace - Tongue Pull Chest', 'Ice Palace - Hammer Block Key Drop']),
        ...
        create_dungeon_region(multiworld, player, 'Misery Mire (Main)', 'Misery Mire', ['Misery Mire - Big Chest', 'Misery Mire - Switch Block Chest', 'Misery Mire - Main Lobby',
        ...
        create_dungeon_region(multiworld, player, 'Misery Mire (West)', 'Misery Mire', ['Misery Mire - Torch Tiles Chest', 'Misery Mire - Cutscene Chest']),
        ...
        create_dungeon_region(multiworld, player, 'Turtle Rock (First Section)', 'Turtle Rock', ['Turtle Rock - Spiky Trap Room', 'Turtle Rock - Roller Room - Left',
        ...
        create_dungeon_region(multiworld, player, 'Turtle Rock (Second Section)', 'Turtle Rock', ['Turtle Rock - Pipe Maze Center', 'Turtle Rock - Pokey 2 Key Drop'], ['Turtle Rock Chain Chomp Staircase', 'Turtle Rock Big Key Door', 'Turtle Rock Second Section Bomb Wall']),
        ...
        create_dungeon_region(multiworld, player, 'Palace of Darkness (Big Key Chest)', 'Palace of Darkness', ['Palace of Darkness - Central Island']),
        create_dungeon_region(multiworld, player, 'Palace of Darkness (Bonk Section)', 'Palace of Darkness', ['Palace of Darkness - The Arena - Ledge', 'Palace of Darkness - Mimic Chest'], ['Palace of Darkness Hammer Peg Drop']),
        create_dungeon_region(multiworld, player, 'Palace of Darkness (North)', 'Palace of Darkness', ['Palace of Darkness - Turtle Room', 'Palace of Darkness - Dark Basement - Left', 'Palace of Darkness - Dark Basement - Right'],
        ...
        create_dungeon_region(multiworld, player, 'Ganons Tower (Compass Room)', 'Ganon\'s Tower', ['Ganons Tower - East Warp Room - Top Left', 'Ganons Tower - East Warp Room - Top Right',
                                                                                'Ganons Tower - East Warp Room - Bottom Left', 'Ganons Tower - East Warp Room - Bottom Right',
        ...
        create_dungeon_region(multiworld, player, 'Ganons Tower (Map Room)', 'Ganon\'s Tower', ['Ganons Tower - Twin Firebar Chest']),
        ...
        create_dungeon_region(multiworld, player, 'Ganons Tower (Bottom)', 'Ganon\'s Tower', ['Ganons Tower - Bob\'s Chest', 'Ganons Tower - Big Chest', 'Ganons Tower - Ice Armos Room - Left',
                                                                          'Ganons Tower - Ice Armos Room - Right', 'Ganons Tower - Ice Armos Room - Middle']),
...
location_table: typing.Dict[str,
    ...
    {'Mushroom': (0x180013, 0x186338, False, 'in the woods'),
     ...
     'Desert Palace - Wide Room Chest': (0xe9b6, 0x18618a, False, 'in Desert Palace'),
     'Desert Palace - Pre-Cannonball Chest': (0xe9cb, 0x18619f, False, 'in Desert Palace'),
     'Desert Palace - Post-Cannonball Chest': (0xe9c2, 0x186196, False, 'in Desert Palace'),
     'Desert Palace - Boss': (0x180151, 0x18633f, False, 'with the boss of Desert Palace'),
     'Eastern Palace - Skeleton Ambush Chest': (0xe977, 0x18614b, False, 'in Eastern Palace'),
     ...
     'Eastern Palace - Antifairy Chest': (0xe9b9, 0x18618d, False, 'in Eastern Palace'),
     'Eastern Palace - Eastern Ledge Chest': (0xe9f5, 0x1861c9, False, 'in Eastern Palace'),
     ...
     'Hyrule Castle - Inner Basement Chest': (0xe974, 0x186148, False, 'in Hyrule Castle'),
     'Hyrule Castle - First Basement Chest': (0xeb0c, 0x1862e0, False, 'in Hyrule Castle'),
     ...
     'Tower of Hera - Entryway Chest': (0xe9ad, 0x186181, False, 'in Tower of Hera'),
     'Tower of Hera - Basement Chest': (0xe9e6, 0x1861ba, False, 'in Tower of Hera'),
     'Tower of Hera - South of Big Chest': (0xe9fb, 0x1861cf, False, 'in Tower of Hera'),
     ...
     'Swamp Palace - Bomb Wall': (0xe986, 0x18615a, False, 'in Swamp Palace'),
     'Swamp Palace - Big Chest': (0xe989, 0x18615d, False, 'in Swamp Palace'),
     'Swamp Palace - South Loop': (0xeaa0, 0x186274, False, 'in Swamp Palace'),
     'Swamp Palace - West Side Switch Chest': (0xeaa6, 0x18627a, False, 'in Swamp Palace'),
     'Swamp Palace - West Side Free Chest': (0xeaa3, 0x186277, False, 'in Swamp Palace'),
     ...
     "Thieves' Town - Entryway Alcove Chest": (0xea04, 0x1861d8, False, "in Thieves' Town"),
     "Thieves' Town - Entryway Floor Chest": (0xea01, 0x1861d5, False, "in Thieves' Town"),
     "Thieves' Town - SE Ledge Chest": (0xea07, 0x1861db, False, "in Thieves' Town"),
     ...
     'Skull Woods - Pit Trap Chest': (0xe992, 0x186166, False, 'in Skull Woods'),
     'Skull Woods - Chest Near Front Door': (0xe99b, 0x18616f, False, 'in Skull Woods'),
     ...
     'Skull Woods - Middle Section Chest': (0xe99e, 0x186172, False, 'in Skull Woods'),
     ...
     'Ice Palace - Pengator Chest': (0xe9d4, 0x1861a8, False, 'in Ice Palace'),
     ...
     'Ice Palace - Icebreaker Chest': (0xe9a4, 0x186178, False, 'in Ice Palace'),
     'Ice Palace - Tongue Pull Chest': (0xe9dd, 0x1861b1, False, 'in Ice Palace'),
     ...
     'Misery Mire - Switch Block Chest': (0xea6a, 0x18623e, False, 'in Misery Mire'),
     ...
     'Misery Mire - Torch Tiles Chest': (0xea64, 0x186238, False, 'in Misery Mire'),
     'Misery Mire - Cutscene Chest': (0xea6d, 0x186241, False, 'in Misery Mire'),
     'Misery Mire - Boss': (0x180158, 0x186346, False, 'with the boss of Misery Mire'),
     'Turtle Rock - Spiky Trap Room': (0xea22, 0x1861f6, False, 'in Turtle Rock'),
     ...
     'Turtle Rock - Pipe Maze Center': (0xea25, 0x1861f9, False, 'in Turtle Rock'),
     ...
     'Palace of Darkness - Central Island': (0xea37, 0x18620b, False, 'in Palace of Darkness'),
     'Palace of Darkness - The Arena - Ledge': (0xea3a, 0x18620e, False, 'in Palace of Darkness'),
     'Palace of Darkness - Mimic Chest': (0xea52, 0x186226, False, 'in Palace of Darkness'),
     'Palace of Darkness - Turtle Room': (0xea43, 0x186217, False, 'in Palace of Darkness'),
     ...
     'Ganons Tower - East Warp Room - Top Left': (0xeae5, 0x1862b9, False, "in Ganon's Tower"),
     'Ganons Tower - East Warp Room - Top Right': (0xeae8, 0x1862bc, False, "in Ganon's Tower"),
     'Ganons Tower - East Warp Room - Bottom Left': (0xeaeb, 0x1862bf, False, "in Ganon's Tower"),
     'Ganons Tower - East Warp Room - Bottom Right': (0xeaee, 0x1862c2, False, "in Ganon's Tower"),
     ...
     'Ganons Tower - Twin Firebar Chest': (0xead3, 0x1862a7, False, "in Ganon's Tower"),
     ...
     'Ganons Tower - Ice Armos Room - Left': (0xeaf4, 0x1862c8, False, "in Ganon's Tower"),
     'Ganons Tower - Ice Armos Room - Right': (0xeaf7, 0x1862cb, False, "in Ganon's Tower"),
     'Ganons Tower - Ice Armos Room - Middle': (0xeaf1, 0x1862c5, False, "in Ganon's Tower"),
