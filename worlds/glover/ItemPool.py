...
decoupled_garib_table = {
	...
	"12 Garibs" : 								ItemData(BASE_ID + 10012, 2, "Garib", None)
}
garbinsanity = ItemData(BASE_ID + 10001, 440, "Garib", None)
...
garbinsanity_bonus_count = 25 #45
