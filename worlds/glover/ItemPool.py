...
decoupled_garib_table = {
	"1 Garib" : 								ItemData(BASE_ID + 10001, 8, "Garib", None),
	"2 Garibs" : 								ItemData(BASE_ID + 10002, 7, "Garib", None),
	"3 Garibs" : 								ItemData(BASE_ID + 10003, 7, "Garib", None),
	"4 Garibs" : 								ItemData(BASE_ID + 10004, 17, "Garib", None),
	"5 Garibs" : 								ItemData(BASE_ID + 10005, 14, "Garib", None),
	"6 Garibs" : 								ItemData(BASE_ID + 10006, 5, "Garib", None),
	"7 Garibs" : 								ItemData(BASE_ID + 10007, 2, "Garib", None),
	"8 Garibs" : 								ItemData(BASE_ID + 10008, 8, "Garib", None),
	...
	"12 Garibs" : 								ItemData(BASE_ID + 10012, 1, "Garib", None)
}
