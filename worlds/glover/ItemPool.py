...
decoupled_garib_table = {
	"1 Garib" : 								ItemData(BASE_ID + 10001, 13, "Garib", None),
	"2 Garibs" : 								ItemData(BASE_ID + 10002, 8, "Garib", None),
	"3 Garibs" : 								ItemData(BASE_ID + 10003, 13, "Garib", None),
	"4 Garibs" : 								ItemData(BASE_ID + 10004, 30, "Garib", None),
	"5 Garibs" : 								ItemData(BASE_ID + 10005, 15, "Garib", None),
	"6 Garibs" : 								ItemData(BASE_ID + 10006, 9, "Garib", None),
	"7 Garibs" : 								ItemData(BASE_ID + 10007, 3, "Garib", None),
	"8 Garibs" : 								ItemData(BASE_ID + 10008, 11, "Garib", None),
	"9 Garibs" : 								ItemData(BASE_ID + 10009, 3, "Garib", None),
	"10 Garibs" : 								ItemData(BASE_ID + 10010, 3, "Garib", None),
	"11 Garibs" : 								ItemData(BASE_ID + 10011, 1, "Garib", None),
	"12 Garibs" : 								ItemData(BASE_ID + 10012, 3, "Garib", None)
} 

garbinsanity = ItemData(BASE_ID + 10001, 530, "Garib", None)
