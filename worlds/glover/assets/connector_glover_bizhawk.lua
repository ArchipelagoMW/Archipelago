...
local ROM_ITEM_TABLE = {
	...
	"AP_FORTRESS_L1_DOORWAY_KEY_1",
	"AP_FORTRESS_L1_DOORWAY_KEY_2",
...
GLOVERHACK = {
    ...
    pc_taglink = 0x70B,
    n64_taglink = 0x70E,
    ROM_MAJOR_VERSION = 0x76C,
    ROM_MINOR_VERSION = 0x76D,
    ROM_PATCH_VERSION = 0x76E,
...
function received_events(itemId)
	...
	elseif itemId == 6500076 then
	    GVR:setItem(ITEM_TABLE["AP_FORTRESS_L1_DOORWAY_KEY_1"], 1)
	elseif itemId == 6500077 then
	    GVR:setItem(ITEM_TABLE["AP_FORTRESS_L1_DOORWAY_KEY_2"], 1)
