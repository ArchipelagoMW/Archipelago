...
3. If you are using an emulator, you should assign RetroArch as your default program for launching ROM
   files.
    1. Extract your emulator's folder to your Desktop, or somewhere you will remember.
    2. Right-click on a ROM file and select **Open with...**
    3. Check the box next to **Always use this app to open .sms files**
...
5. Double-click on your patch file, and the Zillion Client will launch automatically, create your ROM from the
...
files. Your patch file should have a `.apzl` extension.
...
4. Go to Main Menu --> Online Updater --> Core Downloader. Scroll down and select "Sega - MS/GG (SMS Plus GX)".

When loading a ROM, be sure to select the **SMS Plus GX** core. This core will allow external tools to read RAM data.
...
# TODO make sure client shows connection for game and server
When the client shows both Game and Server as connected, you're ready to begin playing. Congratulations on
