...
item_table: Dict[int, ItemDict] = {
    ...
    350105: {'classification': ItemClassification.progression,
             ...
             'episode': -1,
             'map': -1},
    350106: {'classification': ItemClassification.progression_skip_balancing,
             'count': 1,
             'name': 'Backpack',
             'doom_type': 8,
             'episode': -1,
    ...
    350190: {'classification': ItemClassification.filler,
             ...
             'episode': 4,
             'map': 9},
    350191: {'classification': ItemClassification.progression_skip_balancing,
             'count': 0,
             'name': 'Bullet capacity',
             'doom_type': 65001,
             'episode': -1,
             'map': -1},
    350192: {'classification': ItemClassification.progression_skip_balancing,
             'count': 0,
             'name': 'Shell capacity',
             'doom_type': 65002,
             'episode': -1,
             'map': -1},
    350193: {'classification': ItemClassification.progression_skip_balancing,
             'count': 0,
             'name': 'Energy cell capacity',
             'doom_type': 65003,
             'episode': -1,
             'map': -1},
    350194: {'classification': ItemClassification.progression_skip_balancing,
             'count': 0,
