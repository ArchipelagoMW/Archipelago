...
item_table: Dict[int, ItemDict] = {
    ...
    350190: {'classification': ItemClassification.filler,
             ...
             'episode': 4,
             'map': 9},
    350191: {'classification': ItemClassification.progression,
             'count': 0,
             'name': 'Bullet capacity',
             'doom_type': 65001,
             'episode': -1,
             'map': -1},
    350192: {'classification': ItemClassification.progression,
             'count': 0,
             'name': 'Shell capacity',
             'doom_type': 65002,
             'episode': -1,
             'map': -1},
    350193: {'classification': ItemClassification.progression,
             'count': 0,
             'name': 'Energy cell capacity',
             'doom_type': 65003,
             'episode': -1,
             'map': -1},
    350194: {'classification': ItemClassification.progression,
             'count': 0,
