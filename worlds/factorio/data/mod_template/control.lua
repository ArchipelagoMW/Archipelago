...
commands.add_command("toggle-connection-change-filter", "Toggle filtering of players joining or parting", function(call)
    log("Player command toggle-connection-change-filter") -- notifies client
end)
