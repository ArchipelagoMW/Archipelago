...
--         base_level = -1,
--         pipe_connections = {
--             { type = "input", direction = defines.direction.south, position = { 0, 5 } },
--             { type = "input", direction = defines.direction.north, position = { 0, -5 } },
--             { type = "input", direction = defines.direction.east, position = { 5, 0 } },
--             { type = "input", direction = defines.direction.west, position = { -5, 0 } }
--         }
--     },
--     {
--         production_type = "input",
...
--         base_level = -1,
--         pipe_connections = {
--             { type = "input", direction = defines.direction.south, position = { -3, 5 } },
--             { type = "input", direction = defines.direction.north, position = { -3, -5 } },
--             { type = "input", direction = defines.direction.east, position = { 5, -3 } },
--             { type = "input", direction = defines.direction.west, position = { -5, -3 } }
--         }
--     },
--     {
--         production_type = "input",
