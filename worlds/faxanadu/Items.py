...
class ItemDef:
    def __init__(self, id: Optional[int], name: str, classification: ItemClassification, count: int, progression_count: int, prefill_location: str):
        self.id = id
        self.name = name
...
items: List[ItemDef] = [
    ...
    ItemDef(400024, 'Red Potion', ItemClassification.filler, 15, 4, None), # We need at least 4 red potions for the Tower of Red Potion. Up to the player to save them up!
    ...
    ItemDef(400029, 'Wingboots', ItemClassification.useful, 0, 0, None), # Placeholder item so the game knows which shop slot to prefill wingboots
]
