...
def create_regions(faxanadu_world: "FaxanaduWorld"):
    ...
    tower_of_trunk = create_region("Tower of Trunk", player, multiworld)
    ...
    joker_spring = create_region("Joker Spring", player, multiworld)
    tower_of_fortress = create_region("Tower of Fortress", player, multiworld)
    path_to_mascon = create_region("Path to Mascon", player, multiworld)
    tower_of_red_potion = create_region("Tower of Red Potion", player, multiworld)
    mascon = create_region("Mascon", player, multiworld)
    path_to_victim = create_region("Path to Victim", player, multiworld)
    tower_of_suffer = create_region("Tower of Suffer", player, multiworld)
    victim = create_region("Victim", player, multiworld)
    mist = create_region("Mist", player, multiworld)
    useless_tower = create_region("Useless Tower", player, multiworld)
    tower_of_mist = create_region("Tower of Mist", player, multiworld)
    path_to_conflate = create_region("Path to Conflate", player, multiworld)
    helm_branch = create_region("Helm Branch", player, multiworld)
    conflate = create_region("Conflate", player, multiworld)
    ...
    dartmoor = create_region("Dartmoor", player, multiworld)
    fraternal_castle = create_region("Fraternal Castle", player, multiworld)
    evil_fortress = create_region("Evil Fortress", player, multiworld)
