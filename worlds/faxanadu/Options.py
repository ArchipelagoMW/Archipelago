...
class IncludePendant(Toggle):
    ...
    This could be use in conjunction with this option to increase or lower difficulty.
    """
...
class IncludePoisons(DefaultOnToggle):
    """
    Wether or not to include Poison Potions in the pool of items. Including them
...
class RandomMusic(Toggle):
    """
    All levels' music are shuffled. Except title screen because it's finite.
...
class RandomMonsters(Choice):
    ...
    level_shuffle: Monsters are shuffled within a level
    level_random: Monsters are picked randomly, balanced based on the ratio of the current level
    world_shuffle: Monsters are shuffled across the entire world
    world_random: Monsters are picked randomly, balanced based on the ratio of the entire world
