...
locations = {
    ...
    RegionNames.KAMIKI_VILLAGE: {
        "Kamiki Village - Chest After Mr.Orange Yokai Fight": LocData(966056),  # spawn_idx=16, Rabbit Statue
        "Kamiki Village - Buried Chest near Komuso": LocData(966048, type=LocationType.BURIED_CHEST),  # spawn_idx=0, Traveler's Charm
        "Kamiki Village - Underwater Chest 1": LocData(966098, type=LocationType.UNDERWATER_CHEST_SHALLOW),  # spawn_idx=7, Inkfinity Stone
        "Kamiki Village - Underwater Chest 2": LocData(966102, type=LocationType.UNDERWATER_CHEST_SHALLOW),  # spawn_idx=8, Stray Bead
        ...
        "Kamiki Village - West Island chest ": LocData(966055),  # spawn_idx=33, Glass Beads
    ...
    RegionNames.KAMIKI_ISLANDS: {
        ...
        "Kamiki Village - East Islands Buried Stray Bead Chest": LocData(966064),  # spawn_idx=50, Stray Bead
        "Kamiki Village - East Islands Buried Chest": LocData(966081, type=LocationType.BURIED_CHEST),  # spawn_idx=54, Wooden Bear
    }
}
