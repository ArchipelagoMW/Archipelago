...
locations = {
    RegionNames.AGATA_COMMON_LOGIC: {
        "Agata Forest - Burning Chest near Madame Fawn's 1": LocData(container_check_id(MapIds.HEALED_AGATA, 20),
                                                                     type=LocationType.BURNING_CHEST),
        "Agata Forest - Burning Chest near Madame Fawn's 2": LocData(container_check_id(MapIds.HEALED_AGATA, 21),
                                                                     type=LocationType.BURNING_CHEST),
        "Agata Forest - Burning Chest near Madame Fawn's 3": LocData(container_check_id(MapIds.HEALED_AGATA, 22),
                                                                     type=LocationType.BURNING_CHEST),
        "Agata Forest - Ledge chest near Madame Fawn's ": LocData(container_check_id(MapIds.HEALED_AGATA, 26),
                                                                  required_brush_techniques=[
                                                                      BrushTechniques.WATERSPOUT]),
    },
}
warps = {
    RegionNames.CURSED_AGATA_FOREST: [
