...
item_table: typing.Dict[str, ItemData] = {
    'Eternal Crown': ItemData('Equipment', 1337000, 1, False),
    #'Security Visor': ItemData('Equipment', 1337001, 1, False),
    #'Engineer Goggles': ItemData('Equipment', 1337002, 1, False),
    #'Leather Helmet': ItemData('Equipment', 1337003, 1, False),
    #'Copper Helmet': ItemData('Equipment', 1337004, 1, False),
    'Pointy Hat': ItemData('Equipment', 1337005, 1, False),
    #'Dragoon Helmet': ItemData('Equipment', 1337006, 1, False),
    'Buckle Hat': ItemData('Equipment', 1337007, 1, False),
    #'Advisor Hat': ItemData('Equipment', 1337008, 1, False),
    'Librarian Hat': ItemData('Equipment', 1337009, 1, False),
    #'Combat Helmet': ItemData('Equipment', 1337010, 1, False),
    'Captain\'s Cap': ItemData('Equipment', 1337011, 1, False),
    'Lab Glasses': ItemData('Equipment', 1337012, 1, False),
    'Empire Crown': ItemData('Equipment', 1337013, 1, False),
    'Viletian Crown': ItemData('Equipment', 1337014, 1, False),
    #'Sunglasses': ItemData('Equipment', 1337015, 1, False),
    'Old Coat': ItemData('Equipment', 1337016, 1, False),
    #'Trendy Jacket': ItemData('Equipment', 1337017, 1, False),
    #'Security Vest': ItemData('Equipment', 1337018, 1, False),
    #'Leather Jerkin': ItemData('Equipment', 1337019, 1, False),
    #'Copper Breastplate': ItemData('Equipment', 1337020, 1, False),
    'Traveler\'s Cloak': ItemData('Equipment', 1337021, 1, False),
    #'Dragoon Armor': ItemData('Equipment', 1337022, 1, False),
    'Midnight Cloak': ItemData('Equipment', 1337023, 1, False),
    #'Advisor Robe': ItemData('Equipment', 1337024, 1, False),
    'Librarian Robe': ItemData('Equipment', 1337025, 1, False),
    #'Military Armor': ItemData('Equipment', 1337026, 1, False),
    'Captain\'s Uniform': ItemData('Equipment', 1337027, 1, False),
    'Lab Coat': ItemData('Equipment', 1337028, 1, False),
    'Empress Robe': ItemData('Equipment', 1337029, 1, False),
    'Princess Dress': ItemData('Equipment', 1337030, 1, False),
    'Eternal Coat': ItemData('Equipment', 1337031, 1, False),
    #'Synthetic Plume': ItemData('Equipment', 1337032, 1, False),
    #'Cheveur Plume': ItemData('Equipment', 1337033, 1, False),
    'Metal Wristband': ItemData('Equipment', 1337034, 1, False),
    #'Nymph Hairband': ItemData('Equipment', 1337035, 1, False),
    #'Mother o\' Pearl': ItemData('Equipment', 1337036, 1, False),
    'Bird Statue': ItemData('Equipment', 1337037, 1, False),
    #'Chaos Stole': ItemData('Equipment', 1337038, 1, False),
    'Pendulum': ItemData('Equipment', 1337039, 1, False),
    #'Chaos Horn': ItemData('Equipment', 1337040, 1, False),
    'Filigree Clasp': ItemData('Equipment', 1337041, 1, False),
    #'Azure Stole': ItemData('Equipment', 1337042, 1, False),
    'Ancient Coin': ItemData('Equipment', 1337043, 1, False),
    #'Shiny Rock': ItemData('Equipment', 1337044, 1, False),
    'Galaxy Earrings': ItemData('Equipment', 1337045, 1, False),
    'Selen\'s Bangle': ItemData('Equipment', 1337046, 1, False),
    'Glass Pumpkin': ItemData('Equipment', 1337047, 1, False),
    'Gilded Egg': ItemData('Equipment', 1337048, 1, False),
    ...
    'Potion': ItemData('UseItem', 1337055, 0, False),
    'Ether': ItemData('UseItem', 1337056, 0, False),
    'Sand Vial': ItemData('UseItem', 1337057, 0, False),
    'Hi-Potion': ItemData('UseItem', 1337058, 0, False),
    'Hi-Ether': ItemData('UseItem', 1337059, 0, False),
    'Sand Bottle': ItemData('UseItem', 1337060, 0, False),
    'Berry Pick-Mi-Up': ItemData('UseItem', 1337061, 0, False),
    'Berry Pick-Mi-Up+': ItemData('UseItem', 1337062, 0, False),
    'Mind Refresh': ItemData('UseItem', 1337063, 0, False),
    'Mind Refresh ULTRA': ItemData('UseItem', 1337064, 0, False),
    'Antidote': ItemData('UseItem', 1337065, 0, False),
    'Chaos Rose': ItemData('UseItem', 1337066, 0, False),
    ...
    'Max Sand': ItemData('Stat', 1337249, 14, False)
}
