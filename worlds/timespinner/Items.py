...
item_table: Dict[str, ItemData] = {
    ...
    'Empire Crown': ItemData('Equipment', 1337013, never_exclude=True),
    'Viletian Crown': ItemData('Equipment', 1337014, never_exclude=True),
    ...
    'Empress Robe': ItemData('Equipment', 1337029, never_exclude=True),
    'Princess Dress': ItemData('Equipment', 1337030, never_exclude=True),
    ...
    'Filigree Clasp': ItemData('Equipment', 1337041, never_exclude=True),
    'Azure Stole': ItemData('Equipment', 1337042, 0),
    'Ancient Coin': ItemData('Equipment', 1337043, never_exclude=True),
    ...
    'Blue Orb': ItemData('Orb Melee', 1337131, never_exclude=True),
    'Blade Orb': ItemData('Orb Melee', 1337132, never_exclude=True),
    'Fire Orb': ItemData('Orb Melee', 1337133, never_exclude=True, progression=True),
    'Plasma Orb': ItemData('Orb Melee', 1337134, never_exclude=True, progression=True),
    'Iron Orb': ItemData('Orb Melee', 1337135, never_exclude=True),
    'Ice Orb': ItemData('Orb Melee', 1337136, never_exclude=True),
    'Wind Orb': ItemData('Orb Melee', 1337137, never_exclude=True),
    'Gun Orb': ItemData('Orb Melee', 1337138, never_exclude=True),
    'Umbra Orb': ItemData('Orb Melee', 1337139, never_exclude=True),
    'Empire Orb': ItemData('Orb Melee', 1337140, never_exclude=True),
    'Eye Orb': ItemData('Orb Melee', 1337141, never_exclude=True),
    'Blood Orb': ItemData('Orb Melee', 1337142, never_exclude=True),
    'Forbidden Tome': ItemData('Orb Melee', 1337143, never_exclude=True),
    'Shattered Orb': ItemData('Orb Melee', 1337144, never_exclude=True),
    'Nether Orb': ItemData('Orb Melee', 1337145, never_exclude=True),
    'Radiant Orb': ItemData('Orb Melee', 1337146, never_exclude=True),
    'Aura Blast': ItemData('Orb Spell', 1337147, never_exclude=True),
    'Colossal Blade': ItemData('Orb Spell', 1337148, never_exclude=True),
    'Infernal Flames': ItemData('Orb Spell', 1337149, never_exclude=True, progression=True),
    'Plasma Geyser': ItemData('Orb Spell', 1337150, never_exclude=True, progression=True),
    'Colossal Hammer': ItemData('Orb Spell', 1337151, never_exclude=True),
    'Frozen Spires': ItemData('Orb Spell', 1337152, never_exclude=True),
    'Storm Eye': ItemData('Orb Spell', 1337153, never_exclude=True),
    'Arm Cannon': ItemData('Orb Spell', 1337154, never_exclude=True),
    'Dark Flames': ItemData('Orb Spell', 1337155, never_exclude=True),
    'Aura Serpent': ItemData('Orb Spell', 1337156, never_exclude=True),
    'Chaos Blades': ItemData('Orb Spell', 1337157, never_exclude=True),
    'Crimson Vortex': ItemData('Orb Spell', 1337158, never_exclude=True),
    'Djinn Inferno': ItemData('Orb Spell', 1337159, never_exclude=True, progression=True),
    'Bombardment': ItemData('Orb Spell', 1337160, never_exclude=True),
    'Corruption': ItemData('Orb Spell', 1337161, never_exclude=True),
    'Lightwall': ItemData('Orb Spell', 1337162, never_exclude=True, progression=True),
    'Bleak Ring': ItemData('Orb Passive', 1337163, never_exclude=True),
    'Scythe Ring': ItemData('Orb Passive', 1337164),
    'Pyro Ring': ItemData('Orb Passive', 1337165, never_exclude=True, progression=True),
    'Royal Ring': ItemData('Orb Passive', 1337166, never_exclude=True, progression=True),
