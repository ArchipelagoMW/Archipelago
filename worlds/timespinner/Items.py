...
item_table: Dict[str, ItemData] = {
    ...
    'Timeworn Warp Beacon': ItemData('Relic', 1337104, 0, progression=True),
    'Modern Warp Beacon': ItemData('Relic', 1337105, 0, progression=True),
    'Mysterious Warp Beacon': ItemData('Relic', 1337106, 0, progression=True),
