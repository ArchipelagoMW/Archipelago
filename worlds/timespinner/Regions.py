...
def create_regions(world: MultiWorld, player: int, locations: Tuple[LocationData, ...], location_cache: List[Location],
    ...
    connect(world, player, names, 'Lake desolation', 'Space time continuum', lambda state: logic.has_teleport(state))
    ...
    connect(world, player, names, 'Eastern lake desolation', 'Space time continuum', lambda state: logic.has_teleport(state))
    ...
    connect(world, player, names, 'Library', 'Space time continuum', lambda state: logic.has_teleport(state))
    ...
    connect(world, player, names, 'Varndagroth tower right (lower)', 'Varndagroth tower left', lambda state: logic.has_keycard_B(state))
    ...
    connect(world, player, names, 'Varndagroth tower right (lower)', 'Military Fortress', lambda state: logic.can_kill_all_3_bosses(state))
    connect(world, player, names, 'Varndagroth tower right (lower)', 'Space time continuum', lambda state: logic.has_teleport(state))
    ...
    connect(world, player, names, 'Sealed Caves (Sirens)', 'Space time continuum', lambda state: logic.has_teleport(state))
    connect(world, player, names, 'Military Fortress', 'Varndagroth tower right (lower)', lambda state: logic.can_kill_all_3_bosses(state))
    connect(world, player, names, 'Military Fortress', 'Temporal Gyre', lambda state: state.has('Timespinner Wheel', player))
    connect(world, player, names, 'Military Fortress', 'Military Fortress (hangar)', lambda state: logic.has_doublejump(state))
    ...
    connect(world, player, names, 'The lab', 'The lab (power off)', lambda state: logic.has_doublejump_of_npc(state))
    ...
    connect(world, player, names, 'Skeleton Shaft', 'Space time continuum', lambda state: logic.has_teleport(state))
    ...
    connect(world, player, names, 'Sealed Caves (Xarion)', 'Sealed Caves (upper)', lambda state: logic.has_doublejump(state))
    connect(world, player, names, 'Sealed Caves (Xarion)', 'Space time continuum', lambda state: logic.has_teleport(state))
    ...
    connect(world, player, names, 'Refugee Camp', 'Space time continuum', lambda state: logic.has_teleport(state))
    ...
    connect(world, player, names, 'Left Side forest Caves', 'Upper Lake Serene', lambda state: logic.has_timestop(state))
    ...
    connect(world, player, names, 'Left Side forest Caves', 'Space time continuum', lambda state: logic.has_teleport(state))
    ...
    connect(world, player, names, 'Caves of Banishment (upper)', 'Space time continuum', lambda state: logic.has_teleport(state))
    ...
    connect(world, player, names, 'Caves of Banishment (Maw)', 'Space time continuum', lambda state: logic.has_teleport(state))
    ...
    connect(world, player, names, 'Castle Ramparts', 'Space time continuum', lambda state: logic.has_teleport(state))
    connect(world, player, names, 'Castle Keep', 'Castle Ramparts')
    connect(world, player, names, 'Castle Keep', 'Royal towers (lower)', lambda state: logic.has_doublejump(state))
    connect(world, player, names, 'Castle Keep', 'Space time continuum', lambda state: logic.has_teleport(state))
    ...
    connect(world, player, names, 'Royal towers (lower)', 'Space time continuum', lambda state: logic.has_teleport(state))
    connect(world, player, names, 'Royal towers', 'Royal towers (lower)')
    connect(world, player, names, 'Royal towers', 'Royal towers (upper)', lambda state: logic.has_doublejump(state))
    ...
    connect(world, player, names, 'Ancient Pyramid (entrance)', 'Ancient Pyramid (left)', lambda state: logic.has_doublejump(state))
    ...
    connect(world, player, names, 'Space time continuum', 'Varndagroth tower right (lower)', lambda state: present_keys_unlock == "GateMilitairyGate")
    ...
    connect(world, player, names, 'Space time continuum', 'Left Side forest Caves', lambda state: past_keys_unlock == "GateLakeSirineRight")
