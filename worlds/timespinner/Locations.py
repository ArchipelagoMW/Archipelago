...
def get_location_datas(player: Optional[int], options: Optional[TimespinnerOptions],
    ...
    location_table: List[LocationData] = [
        ...
        LocationData('Main Lab', 'Lab: Dynamo Works', 1337071, lambda state: not options.lock_key_amadeus or (state.has_all(('Lab Access Research', 'Lab Access Dynamo'), player) and logic.has_upwarddash(state)) ),
