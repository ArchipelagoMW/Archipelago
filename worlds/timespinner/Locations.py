...
def get_location_datas(world: Optional[MultiWorld], player: Optional[int], 
    ...
    location_table: List[LocationData] = [
        ...
        LocationData('Lower Lake Serene', 'Lake Serene (Lower): T chest',  1337109, lambda state: flooded.dry_lake_serene or logic.has_doublejump_of_npc(state)),
        LocationData('Lower Lake Serene', 'Lake Serene (Lower): Past the eels',  1337110),
        LocationData('Lower Lake Serene', 'Lake Serene (Lower): Underwater pedestal',  1337111, lambda state: flooded.dry_lake_serene or logic.has_doublejump(state)),
