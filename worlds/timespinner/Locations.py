...
def get_locations(world: Optional[MultiWorld], player: Optional[int], flooded: PreCalculatedWeights) -> Tuple[LocationData, ...]:
    ...
    location_table: List[LocationData] = [
        ...
        LocationData('Lake desolation', 'Lake Desolation (Lower): Chicken chest', 1337007, lambda state: logic.has_timestop(state)),
        LocationData('Lower lake desolation', 'Lake Desolation (Lower): Not so secret room',  1337008, lambda state: logic.can_break_walls(state)),
        LocationData('Lower lake desolation', 'Lake Desolation (Upper): Tank chest',  1337009, lambda state: logic.has_timestop(state)),
        LocationData('Upper lake desolation', 'Lake Desolation (Upper): Oxygen recovery room',  1337010),
        LocationData('Upper lake desolation', 'Lake Desolation (Upper): Secret room',  1337011, lambda state: logic.can_break_walls(state)),
        LocationData('Upper lake desolation', 'Lake Desolation (Upper): Double jump cave platform',  1337012, lambda state: logic.has_doublejump(state)),
        ...
        LocationData('Library', 'Library: Storage room chest 1',  1337023, lambda state: logic.has_keycard_D(state)),
        LocationData('Library', 'Library: Storage room chest 2',  1337024, lambda state: logic.has_keycard_D(state)),
        LocationData('Library', 'Library: Storage room chest 3',  1337025, lambda state: logic.has_keycard_D(state)),
        ...
        LocationData('Varndagroth tower left', 'Varndagroth Towers (Left): Bottom floor',  1337033, lambda state: logic.has_keycard_C(state)),
        LocationData('Varndagroth tower left', 'Varndagroth Towers (Left): Air vents secret',  1337034, lambda state: logic.can_break_walls(state)),
        ...
        LocationData('Varndagroth tower right (elevator)', 'Varndagroth Towers (Right): Varndagroth',  1337042, lambda state: logic.has_keycard_C(state)),
        LocationData('Varndagroth tower right (elevator)', 'Varndagroth Towers (Right): Spider Hell',  1337043, lambda state: logic.has_keycard_A(state)),
        LocationData('Skeleton Shaft', 'Sealed Caves (Xarion): Skeleton',  1337044),
        LocationData('Sealed Caves (Xarion)', 'Sealed Caves (Xarion): Shroom jump room',  1337045, lambda state: logic.has_timestop(state)),
        LocationData('Sealed Caves (Xarion)', 'Sealed Caves (Xarion): Double shroom room',  1337046),
        LocationData('Sealed Caves (Xarion)', 'Sealed Caves (Xarion): Mini jackpot room',  1337047, lambda state: logic.has_forwarddash_doublejump(state)),
        LocationData('Sealed Caves (Xarion)', 'Sealed Caves (Xarion): Below mini jackpot room',  1337048),
        LocationData('Sealed Caves (Xarion)', 'Sealed Caves (Xarion): Secret room',  1337049, lambda state: logic.can_break_walls(state)),
        LocationData('Sealed Caves (Xarion)', 'Sealed Caves (Xarion): Bottom left room',  1337050),
        LocationData('Sealed Caves (Xarion)', 'Sealed Caves (Xarion): Last chance before Xarion',  1337051, lambda state: logic.has_doublejump(state)),
        ...
        LocationData('The lab', 'Lab: Lower trash right',  1337067, lambda state: logic.has_doublejump(state)),
        LocationData('The lab', 'Lab: Lower trash left',  1337068, lambda state: logic.has_upwarddash(state)),
        LocationData('The lab', 'Lab: Below lab entrance',  1337069, lambda state: logic.has_doublejump(state)),
        ...
        LocationData('The lab (upper)', 'Lab: Lab secret',  1337075, lambda state: logic.can_break_walls(state)),
        LocationData('The lab (power off)', 'Lab: Spider Hell',  1337076, lambda state: logic.has_keycard_A(state)),
        ...
        LocationData('Emperors tower', 'Emperor\'s Tower: Wayyyy up there',  1337082, lambda state: logic.has_doublejump_of_npc(state)),
        ...
        LocationData('Forest', 'Forest: Green platform secret',  1337092, lambda state: logic.can_break_walls(state)),
        ...
        LocationData('Upper Lake Serene', 'Lake Serene (Upper): Double jump cave platform',  1337100, lambda state: logic.has_doublejump(state)),
        LocationData('Upper Lake Serene', 'Lake Serene (Upper): Double jump cave floor',  1337101),
        LocationData('Upper Lake Serene', 'Lake Serene (Upper): Cave secret',  1337102, lambda state: logic.can_break_walls(state)),
        ...
        LocationData('Lower Lake Serene', 'Lake Serene (Lower): Underwater secret',  1337108, lambda state: logic.can_break_walls(state)),
        ...
        LocationData('Castle Ramparts', 'Castle Ramparts: Bomber chest',  1337128, lambda state: logic.has_multiple_small_jumps_of_npc(state)),
        ...
        LocationData('Castle Keep', 'Castle Keep: Basement secret pedestal',  1337133, lambda state: logic.can_break_walls(state)),
        LocationData('Castle Keep', 'Castle Keep: Clean the castle basement',  1337134),
        LocationData('Royal towers (lower)', 'Castle Keep: Yas queen room',  1337135, lambda state: logic.has_pink(state)),
        ...
        LocationData('Castle Keep', 'Killed Twins',  EventId, lambda state: logic.has_timestop(state)),
        LocationData('Castle Keep', 'Castle Keep: Advisor jump', 1337171, lambda state: logic.has_timestop(state)),
        LocationData('Castle Keep', 'Castle Keep: Twins',  1337140, lambda state: logic.has_timestop(state)),
        ...
        LocationData('Royal towers', 'Royal Towers: Bottom struggle juggle',  1337146, lambda state: logic.has_doublejump_of_npc(state)),
        LocationData('Royal towers (upper)', 'Royal Towers: Top struggle juggle',  1337147, lambda state: logic.has_doublejump_of_npc(state)),
        LocationData('Royal towers (upper)', 'Royal Towers: No struggle required',  1337148, lambda state: logic.has_doublejump_of_npc(state)),
        ...
        LocationData('Royal towers (upper)', 'Royal Towers: Aelana\'s attic',  1337153, lambda state: logic.has_upwarddash(state)),
    ...
    if not world or is_option_enabled(world, player, "LoreChecks"):
        location_table += (
            ...
            LocationData('Varndagroth tower right (lower)', 'Varndagroth Towers: Memory - Siren Elevator (Childhood)',  1337182, lambda state: logic.has_keycard_B(state)),
            ...
            LocationData('The lab', 'Lab: Memory - Genza\'s Secret Stash 1 (An Old Friend)',  1337185, lambda state: logic.can_break_walls(state)),
            LocationData('The lab', 'Lab: Memory - Genza\'s Secret Stash 2 (Twilight Dinner)',  1337186, lambda state: logic.can_break_walls(state)),
            LocationData('Emperors tower', 'Emperor\'s Tower: Memory - Way Up There (Final Circle)',  1337187, lambda state: logic.has_doublejump_of_npc(state)),
            ...
            LocationData('Royal towers (lower)', 'Royal Towers: Journal - Aelana\'s Room (Diplomatic Missive)',  1337194, lambda state: logic.has_pink(state)),
