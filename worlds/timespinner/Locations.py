...
def get_locations(world: Optional[MultiWorld], player: Optional[int]) -> Tuple[LocationData, ...]:
    location_table: Tuple[LocationData, ...] = (
        ...
        LocationData('Sealed Caves (Sirens)', 'Sealed cave water hook',  1337053, lambda state: state.has('Water Mask', player)),
        LocationData('Sealed Caves (Sirens)', 'Sealed cave siren room right',  1337054, lambda state: state.has('Water Mask', player)),
        LocationData('Sealed Caves (Sirens)', 'Sealed cave siren room left',  1337055, lambda state: state.has('Water Mask', player)),
        LocationData('Sealed Caves (Sirens)', 'After sealed cave sirens chest 2',  1337056),
        LocationData('Sealed Caves (Sirens)', 'After sealed cave sirens chest 1',  1337057),
        ...
        LocationData('Military Fortress', 'Crowded military bridge',  1337062),
        ...
        LocationData('Caves of Banishment (Sirens)', 'Upper banishment sirens',  1337124),
