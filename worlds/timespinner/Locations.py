...
def get_locations(world: Optional[MultiWorld], player: Optional[int]) -> Tuple[LocationData, ...]:
    location_table: Tuple[LocationData, ...] = (
        ...
        LocationData('Upper lake desolation', 'Upper desolated secret',  1337011, lambda state: state._timespinner_can_break_walls(world, player)),
        LocationData('Upper lake desolation', 'Upper desolated double jump cave floor',  1337012, lambda state: state._timespinner_has_doublejump(world, player)),
        LocationData('Upper lake desolation', 'Upper desolated double jump cave platform',  1337013),
        ...
        LocationData('Library', 'Library Pyramid room',  1337020),
        ...
        LocationData('Varndagroth tower left', 'Varndagroth left side bottom floor',  1337033, lambda state: state._timespinner_has_keycard_C(world, player)),
        ...
        LocationData('Varndagroth tower right (lower)', 'Varndagroth right side bottom floor',  1337041),
        ...
        LocationData('Sealed Caves (Xarion)', 'Sealed shroom jump room',  1337045, lambda state: state._timespinner_has_timestop(world, player)),
        LocationData('Sealed Caves (Xarion)', 'Sealed double shroom room',  1337046),
        LocationData('Sealed Caves (Xarion)', 'Sealed Mini jackpot room',  1337047, lambda state: state._timespinner_has_forwarddash_doublejump(world, player)),
        LocationData('Sealed Caves (Xarion)', 'Below sealed mini jackpot room',  1337048),
        ...
        LocationData('Sealed Caves (Sirens)', 'Sealed Water Hook',  1337053, lambda state: state.has('Water Mask', player)),
        LocationData('Sealed Caves (Sirens)', 'Sealed siren room right',  1337054, lambda state: state.has('Water Mask', player)),
        LocationData('Sealed Caves (Sirens)', 'Sealed siren room left',  1337055, lambda state: state.has('Water Mask', player)),
        LocationData('Sealed Caves (Sirens)', 'After sealed sirens chest 2',  1337056),
        LocationData('Sealed Caves (Sirens)', 'After sealed sirens chest 1',  1337057),
        ...
        LocationData('Military Fortress', 'Loaded military bridge',  1337062),
        ...
        LocationData('The lab', 'Lab basement',  1337069, lambda state: state._timespinner_has_doublejump(world, player)),
        ...
        LocationData('Forest', 'Forest rat guarded chest',  1337093),
        ...
        LocationData('Left Side forest Caves', 'Before Serene batcave',  1337098),
        LocationData('Upper Lake Serene', 'Upper left lake rat nest',  1337099),
        ...
        LocationData('Upper Lake Serene', 'Burn me not',  1337103),
        ...
        LocationData('Caves of Banishment (upper)', 'Banished shroom jump room',  1337112, lambda state: state._timespinner_has_doublejump(world, player)),
        LocationData('Caves of Banishment (upper)', 'Banished secret room',  1337113),
        LocationData('Caves of Banishment (upper)', 'Below Banished secret',  1337114),
        LocationData('Caves of Banishment (upper)', 'Banished single shroom room',  1337115),
        LocationData('Caves of Banishment (upper)', 'Banished jackpot room chest 1',  1337116, lambda state: state._timespinner_has_forwarddash_doublejump(world, player)),
        LocationData('Caves of Banishment (upper)', 'Banished jackpot room chest 2',  1337117, lambda state: state._timespinner_has_forwarddash_doublejump(world, player)),
        LocationData('Caves of Banishment (upper)', 'Banished jackpot room chest 3',  1337118, lambda state: state._timespinner_has_forwarddash_doublejump(world, player)),
        LocationData('Caves of Banishment (upper)', 'Banished jackpot room chest 4',  1337119, lambda state: state._timespinner_has_forwarddash_doublejump(world, player)),
        LocationData('Caves of Banishment (upper)', 'Banished pedestal',  1337120),
        ...
        LocationData('Caves of Banishment (Sirens)', 'Banished sirens',  1337124),
        LocationData('Caves of Banishment (Sirens)', 'Under banished sirens left',  1337125, lambda state: state.has('Water Mask', player)),
        LocationData('Caves of Banishment (Sirens)', 'Under banished sirens right',  1337126, lambda state: state.has('Water Mask', player)),
        ...
        LocationData('Royal towers', 'Above royal tower floor secret',  1337143),
        ...
        LocationData('Royal towers (upper)', 'Above Aelana',  1337153, lambda state: state._timespinner_has_upwarddash(world, player)),
        LocationData('Royal towers (upper)', 'Aelana\'s pedestal',  1337154),
        LocationData('Royal towers (upper)', 'Aelana\'s hopes',  1337155),
