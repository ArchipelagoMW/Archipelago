...
relic_table = {
    ...
    "Fire of bat": ItemData(301, Type.RELIC, ItemClassification.filler),
    "Echo of bat": ItemData(302, Type.RELIC, ItemClassification.progression),
    "Force of echo": ItemData(303, Type.RELIC, ItemClassification.filler),
    "Soul of wolf": ItemData(304, Type.RELIC, ItemClassification.progression),
    "Power of wolf": ItemData(305, Type.RELIC, ItemClassification.filler),
    "Skill of wolf": ItemData(306, Type.RELIC, ItemClassification.filler),
    "Form of mist": ItemData(307, Type.RELIC, ItemClassification.progression),
    "Power of mist": ItemData(308, Type.RELIC, ItemClassification.filler),
    "Gas cloud": ItemData(309, Type.RELIC, ItemClassification.filler),
    "Cube of zoe": ItemData(310, Type.RELIC, ItemClassification.progression),
    "Spirit orb": ItemData(311, Type.RELIC, ItemClassification.filler),
    ...
    "Faerie scroll": ItemData(315, Type.RELIC, ItemClassification.filler),
    ...
    "Bat card": ItemData(318, Type.RELIC, ItemClassification.filler),
    "Ghost card": ItemData(319, Type.RELIC, ItemClassification.filler),
    "Faerie card": ItemData(320, Type.RELIC, ItemClassification.filler),
    "Demon card": ItemData(321, Type.RELIC, ItemClassification.progression),
    "Sword card": ItemData(322, Type.RELIC, ItemClassification.filler),
