...
from .utils import WatchdogShutdownError, load_class, platform
...
if TYPE_CHECKING:
    ...
    from .observers import ObserverType
    from .observers.api import BaseObserver
