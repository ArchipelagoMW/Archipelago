...
:author: chpasbusiness@gmail.com (chpas)
...
from ..observers.api import DEFAULT_EMITTER_TIMEOUT, DEFAULT_OBSERVER_TIMEOUT, BaseObserver, EventEmitter
from ..observers.inotify_buffer import InotifyBuffer
from ..observers.inotify_c import InotifyConstants

if TYPE_CHECKING:
    from ..observers.api import EventQueue, ObservedWatch
