cv64_char_dict = {"\n": [0x01, 0], " ": [0x02, 4], "!": [0x03, 2], '"': [0x04, 5], "#": [0x05, 6], "$": [0x06, 5],
                  ...
                  "O": [0x31, 6], "P": [0x32, 5], "Q": [0x33, 8], "R": [0x34, 6], "S": [0x35, 5], "T": [0x36, 6],
                  "U": [0x37, 6], "V": [0x38, 7], "W": [0x39, 8], "X": [0x3A, 6], "Y": [0x3B, 7], "Z": [0x3C, 6],
                  "[": [0x3D, 3], "\\": [0x3E, 6], "]": [0x3F, 3], "^": [0x40, 6], "_": [0x41, 5], "a": [0x43, 5],
                  "b": [0x44, 6], "c": [0x45, 4], "d": [0x46, 6], "e": [0x47, 4], "f": [0x48, 5], "g": [0x49, 5],
                  "h": [0x4A, 6], "i": [0x4B, 3], "j": [0x4C, 3], "k": [0x4D, 6], "l": [0x4E, 3], "m": [0x4F, 8],
                  "n": [0x50, 6], "o": [0x51, 4], "p": [0x52, 5], "q": [0x53, 5], "r": [0x54, 4], "s": [0x55, 4],
...
def cv64_string_to_bytes(cv64text: str, a_advance: bool, append_end: bool = True) -> list:
    """Converts a string into a list of bytes following CV64's string format."""
    text_bytes = []
