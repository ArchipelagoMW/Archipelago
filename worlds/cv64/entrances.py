...
def get_warp_entrances(options: CV64Options, active_warp_list: list, player: int):
...
def get_drac_rule(options: CV64Options, player: int, required_s2s: int):
...
def verify_entrances(options: CV64Options, entrances: list, active_stage_exits: dict, player: int):
    verified_entrances = {}
    verified_rules = {}
