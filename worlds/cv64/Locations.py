...
main_location_table = {
    ...
    LName.forest_werewolf_plaque: LocationData(0x1, 0xBFC8AF, RName.forest_mid, "inv"),
    ...
    LName.villafy_inner_gate:            LocationData(0x138, 0xBFC8D7, RName.villa_start),
    ...
    LName.villafy_fountain_fl:           LocationData(0x139, 0xBFC8CF, RName.villa_main),
    ...
    LName.villafy_fountain_rl:           LocationData(0x13B, 0xBFC8D3, RName.villa_main),
    ...
    LName.villala_vincent:               LocationData(0x23, 0xBFE42F, RName.villa_main, "npc"),
    ...
    LName.ccll_heinrich:                 LocationData(0x69, 0xBFE443, RName.cc_upper, "npc"),
...
sub_weapon_table = {
    ...
    LName.villala_hallway_r:          LocationData(0x4F, 0xBFC8F7, RName.villa_main),
