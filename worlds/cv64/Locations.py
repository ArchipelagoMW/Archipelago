...
main_location_table = {
    ...
    LName.ck_flame_r:     LocationData(0xC640D1, 0xBFCA1F, RName.ck_main, "inv"),
...
cc_lizard_generator_table = {
    ...
    LName.ccff_lizard_coffin_nmr: LocationData(0xC640D7, 0xBFC98B, RName.cc_main),
    LName.ccff_lizard_coffin_nml: LocationData(0xC640D8, 0xBFC98F, RName.cc_main),
...
sub_weapon_table = {
    ...
    # Villa sub-weapons
    LName.villala_hallway_l:          LocationData(0xC6412D, 0xBFC903, RName.villa_main),
