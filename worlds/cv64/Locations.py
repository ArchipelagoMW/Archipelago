...
main_location_table = {
    ...
    LName.tunnel_twin_arrows:            LocationData(0xC6405E, 0xBFC96B, RName.tunnel_start, "inv"),
    ...
    LName.ccia_nitro_shelf_i:            LocationData(0xC640A8, 0xBFCBBF, RName.cc_main),
    ...
    LName.ck_flame_r:     LocationData(0xC640D3, 0xBFCA1F, RName.ck_main, "inv"),
...
multi_breakable_table = {
    ...
    LName.tosci_ibridge_b1: LocationData(0xC64113, 0x10CE59, RName.tosci_conveyors),
    LName.tosci_ibridge_b2: LocationData(0xC64114, 0x10CE5B, RName.tosci_conveyors),
    LName.tosci_ibridge_b3: LocationData(0xC64115, 0x10CE5D, RName.tosci_conveyors),
    LName.tosci_ibridge_b4: LocationData(0xC64116, 0x10CE5F, RName.tosci_conveyors),
    LName.tosci_ibridge_b5: LocationData(0xC64117, 0x10CE61, RName.tosci_conveyors),
    LName.tosci_ibridge_b6: LocationData(0xC64118, 0x10CE63, RName.tosci_conveyors),
    # Clock Tower multi-hits
    LName.ct_gearclimb_battery_slab1: LocationData(0xC64119, 0x10CEF9, RName.ct_start),
    LName.ct_gearclimb_battery_slab2: LocationData(0xC6411A, 0x10CEFB, RName.ct_start),
    LName.ct_gearclimb_battery_slab3: LocationData(0xC6411B, 0x10CEFD, RName.ct_start),
    LName.ct_gearclimb_door_slab1:    LocationData(0xC6411C, 0x10CF01, RName.ct_start),
    LName.ct_gearclimb_door_slab2:    LocationData(0xC6411D, 0x10CF03, RName.ct_start),
    LName.ct_gearclimb_door_slab3:    LocationData(0xC6411E, 0x10CF05, RName.ct_start),
    LName.ct_finalroom_door_slab1:    LocationData(0xC6411F, 0x10CF09, RName.ct_end),
    LName.ct_finalroom_door_slab2:    LocationData(0xC64120, 0x10CF0B, RName.ct_end),
    LName.ct_finalroom_renon_slab1:   LocationData(0xC64121, 0x10CF0D, RName.ct_end),
    LName.ct_finalroom_renon_slab2:   LocationData(0xC64122, 0x10CF0F, RName.ct_end),
    LName.ct_finalroom_renon_slab3:   LocationData(0xC64123, 0x10CF11, RName.ct_end),
    LName.ct_finalroom_renon_slab4:   LocationData(0xC64124, 0x10CF13, RName.ct_end),
    LName.ct_finalroom_renon_slab5:   LocationData(0xC64125, 0x10CF15, RName.ct_end),
    LName.ct_finalroom_renon_slab6:   LocationData(0xC64126, 0x10CF17, RName.ct_end),
}

sub_weapon_table = {
    # Forest of Silence sub-weapons
    LName.forest_pillars_left:    LocationData(0xC64127, 0x10C6EB, RName.forest_start),
    LName.forest_dirge_ped:       LocationData(0xC64128, 0x10C6FB, RName.forest_start),
    LName.forest_dbridge_gate_l:  LocationData(0xC64129, 0x10C6F3, RName.forest_mid),
    LName.forest_werewolf_island: LocationData(0xC6412A, 0x10C703, RName.forest_mid),
    # Castle Wall sub-weapons
    LName.cw_pillar:       LocationData(0xC6412B, 0x7F9A0F, RName.cw_start),
    LName.cw_shelf_torch:  LocationData(0xC6412C, 0x10C82F, RName.cw_start),
    LName.cw_ground_left:  LocationData(0xC6412D, 0x10C827, RName.cw_exit),
    LName.cw_ground_right: LocationData(0xC6412E, 0x10C81F, RName.cw_exit),
    # Villa sub-weapons
    LName.villala_hallway_l:          LocationData(0xC6412F, 0xBFC903, RName.villa_main),
    LName.villala_hallway_r:          LocationData(0xC64130, 0x83A5F1, RName.villa_main),
    LName.villala_slivingroom_mirror: LocationData(0xC64131, 0x83A5D9, RName.villa_main),
    LName.villala_archives_entrance:  LocationData(0xC64132, 0x83A5E5, RName.villa_archives),
    LName.villam_frankieturf_r:       LocationData(0xC64133, 0x10C98F, RName.villa_maze),
    LName.villam_fplatform:           LocationData(0xC64134, 0x10C987, RName.villa_maze),
    LName.villam_rplatform:           LocationData(0xC64135, 0x10C997, RName.villa_maze),
    LName.villac_coffin_l:            LocationData(0xC64136, 0x10CF73, RName.villa_crypt),
    # Tunnel sub-weapons
    LName.tunnel_stone_alcove_r:        LocationData(0xC64137, 0x10CA57, RName.tunnel_start),
    LName.tunnel_lbucket_mdoor_l:       LocationData(0xC64138, 0x10CA67, RName.tunnel_start),
    LName.tunnel_gondola_rc_sdoor_l:    LocationData(0xC64139, 0x10CA5F, RName.tunnel_start),
    LName.tunnel_corpse_bucket_mdoor_l: LocationData(0xC6413A, 0x10CA6F, RName.tunnel_end),
    LName.tunnel_shovel_mdoor_r:        LocationData(0xC6413B, 0x10CA77, RName.tunnel_end),
    LName.tunnel_shovel_sdoor_r:        LocationData(0xC6413C, 0x10CA7F, RName.tunnel_end),
    # Castle Center sub-weapons
    LName.ccb_skel_hallway_ba:     LocationData(0xC6413D, 0x10CBC7, RName.cc_main),
    LName.ccelv_switch:            LocationData(0xC6413E, 0x10CC0F, RName.cc_main),
    LName.ccff_lizard_near_knight: LocationData(0xC6413F, 0x10CC5B, RName.cc_main),
    # Duel Tower sub-weapon
    LName.dt_stones_end: LocationData(0xC64140, 0x10CE83, RName.dt_main),
    # Tower of Execution sub-weapon
    LName.toe_keygate_r: LocationData(0xC64141, 0x10CD3F, RName.toe_ledge),
    # Tower of Science sub-weapon
    LName.tosci_key3_m:  LocationData(0xC64142, 0x10CE2B, RName.tosci_key3),
    # Room of Clocks sub-weapons
    LName.roc_elev_l: LocationData(0xC64143, 0x10CF8B, RName.roc_main),
    LName.roc_elev_r: LocationData(0xC64144, 0x10CF93, RName.roc_main),
    # Clock Tower sub-weapons
    LName.ct_bp_chasm_rl:  LocationData(0xC64145, 0x99BC5A, RName.ct_middle),
    LName.ct_finalroom_fl: LocationData(0xC64146, 0x10CED3, RName.ct_end),
    LName.ct_finalroom_fr: LocationData(0xC64147, 0x10CECB, RName.ct_end),
    LName.ct_finalroom_rl: LocationData(0xC64148, 0x10CEE3, RName.ct_end),
    LName.ct_finalroom_rr: LocationData(0xC64149, 0x10CEDB, RName.ct_end),
}

empty_breakables_table = {
    LName.forest_dirge_tomb_l:     LocationData(0xC6414A, 0x10C74B, RName.forest_start),
    LName.forest_dbridge_tomb_l:   LocationData(0xC6414B, 0x10C763, RName.forest_mid),
    LName.forest_dbridge_tomb_ur:  LocationData(0xC6414C, 0x10C773, RName.forest_mid),
    LName.forest_bface_tomb_lr:    LocationData(0xC6414D, 0x10C753, RName.forest_mid),
    LName.forest_werewolf_tomb_lf: LocationData(0xC6414E, 0x10C783, RName.forest_mid),
    LName.forest_werewolf_tomb_lr: LocationData(0xC6414F, 0x10C73B, RName.forest_mid),

    LName.villafo_mid_r: LocationData(0xC64150, 0x10C8CF, RName.villa_main),

    LName.roc_cont_l: LocationData(0xC64151, 0x10CFA3, RName.roc_main),
    LName.roc_exit:   LocationData(0xC64152, 0x10CF9B, RName.roc_main),
}
