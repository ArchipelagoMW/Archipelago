...
main_location_table = {
    ...
    LocationName.forest_dirge_plaque:    LocationData(0xC6400A, 0x7C7F9D, RegionName.forest_start, "invisible"),
    ...
    LocationName.forest_werewolf_plaque: LocationData(0xC64015, 0xBFC937, RegionName.forest_mid, "invisible"),
    ...
    LocationName.cw_shelf_sandbags: LocationData(0xC6401D, 0x7F9A3E, RegionName.cw_start, "invisible"),
    ...
    LocationName.villafy_tombstone:             LocationData(0xC64028, 0x8099CC, RegionName.villa_main, "invisible"),
    ...
    LocationName.villala_slivingroom_table:     LocationData(0xC6403A, 0x83A635, RegionName.villa_main, "invisible"),
    LocationName.villala_diningroom_roses:      LocationData(0xC6403B, 0xBFC98B, RegionName.villa_main, "invisible"),
    ...
    LocationName.villala_llivingroom_painting:  LocationData(0xC6403E, 0xBFC987, RegionName.villa_main, "invisible"),
    LocationName.villala_llivingroom_light:     LocationData(0xC6403F, 0x10C91F, RegionName.villa_main),
    LocationName.villala_llivingroom_lion:      LocationData(0xC64040, 0x83A610, RegionName.villa_main, "invisible"),
    ...
    LocationName.villala_storeroom_s:           LocationData(0xC64044, 0x83A604, RegionName.villa_storeroom, "invisible"),
    LocationName.villala_archives_table:        LocationData(0xC64045, 0xBFC98F, RegionName.villa_archives, "invisible"),
    ...
    LocationName.villam_malus_bush:             LocationData(0xC64048, 0x850FEC, RegionName.villa_maze, "invisible"),
    ...
    LocationName.tunnel_twin_arrows:            LocationData(0xC6405D, 0xBFC9B7, RegionName.tunnel_start, "invisible"),
    LocationName.tunnel_lonesome_bucket:        LocationData(0xC6405E, 0x86D8E1, RegionName.tunnel_start, "invisible"),
    ...
    LocationName.tunnel_shovel:                 LocationData(0xC6406E, 0x86D8FC, RegionName.tunnel_end, "invisible"),
    ...
    LocationName.ccff_redcarpet_knight:         LocationData(0xC64088, 0x8C44D9, RegionName.cc_main, "invisible"),
    ...
    LocationName.ccff_lizard_knight:            LocationData(0xC6408C, 0x8C44E7, RegionName.cc_main, "invisible"),
    ...
    LocationName.ccll_brokenstairs_knight:      LocationData(0xC64090, 0x8DF782, RegionName.cc_main, "invisible"),
    ...
    LocationName.ccll_cwhall_flamethrower:      LocationData(0xC64097, 0x8DF580, RegionName.cc_main, "invisible"),
    ...
    LocationName.ccia_nitro_crates:             LocationData(0xC6409A, 0x90FCE9, RegionName.cc_main, "invisible"),
    LocationName.ccia_nitro_shelf:              LocationData(0xC6409B, 0xBFC1C3, RegionName.cc_main, "npc"),
    LocationName.ccia_stairs_knight:            LocationData(0xC6409C, 0x90FE5C, RegionName.cc_main, "invisible"),
    LocationName.ccia_maids_vase:               LocationData(0xC6409D, 0x90FF1D, RegionName.cc_main, "invisible"),
    ...
    LocationName.ccia_inventions_famicart:      LocationData(0xC640A2, 0x90FBB3, RegionName.cc_main, "invisible"),
    LocationName.ccia_inventions_zeppelin:      LocationData(0xC640A3, 0x90FBC0, RegionName.cc_main),
    LocationName.ccia_inventions_round:         LocationData(0xC640A4, 0x90FBA7, RegionName.cc_main, "invisible"),
    LocationName.ccia_nitrohall_flamethrower:   LocationData(0xC640A5, 0x90FCDA, RegionName.cc_main, "invisible"),
    ...
    LocationName.ccb_torture_rack:              LocationData(0xC640A8, 0x8985E5, RegionName.cc_torture_chamber, "invisible"),
    ...
    LocationName.dt_ibridge_l:      LocationData(0xC640AC, 0x10CE8B, RegionName.duel_tower),
    LocationName.dt_ibridge_r:      LocationData(0xC640AD, 0x10CE93, RegionName.duel_tower),
    LocationName.dt_stones_start:   LocationData(0xC640AE, 0x10CE73, RegionName.duel_tower),
    LocationName.dt_werebull_arena: LocationData(0xC640AF, 0x10CE7B, RegionName.duel_tower),
    ...
    LocationName.tosor_stained_tower:   LocationData(0xC640BF, 0x10CDB3, RegionName.tower_of_sorcery),
    LocationName.tosor_savepoint:       LocationData(0xC640C0, 0x10CDBB, RegionName.tower_of_sorcery),
    LocationName.tosor_trickshot:       LocationData(0xC640C1, 0x10CDD3, RegionName.tower_of_sorcery),
    LocationName.tosor_yellow_bubble:   LocationData(0xC640C2, 0x10CDDB, RegionName.tower_of_sorcery),
    LocationName.tosor_blue_platforms:  LocationData(0xC640C3, 0x10CDC3, RegionName.tower_of_sorcery),
    LocationName.tosor_side_isle:       LocationData(0xC640C4, 0x10CDCB, RegionName.tower_of_sorcery),
    LocationName.tosor_ibridge:         LocationData(0xC640C5, 0x10CDE3, RegionName.tower_of_sorcery),
    # Room Of Clocks locations
    LocationName.roc_ent_l: LocationData(0xC640C6, 0x10CF7B, RegionName.room_of_clocks),
    LocationName.roc_gs_r:  LocationData(0xC640C7, 0x10CFB3, RegionName.room_of_clocks),
    LocationName.roc_ent_r: LocationData(0xC640C8, 0x10CFBB, RegionName.room_of_clocks),
    ...
    LocationName.ck_flame_l:     LocationData(0xC640CF, 0x9778C8, RegionName.castle_keep, "invisible"),
    LocationName.ck_flame_r:     LocationData(0xC640D0, 0xBFCA6B, RegionName.castle_keep, "invisible"),
    LocationName.ck_behind_drac: LocationData(0xC640D1, 0x10CE9B, RegionName.castle_keep),
    LocationName.ck_cube:        LocationData(0xC640D2, 0x10CEA3, RegionName.castle_keep)
}
...
boss_table = {
    ...
    LocationName.dt_boss_one:           LocationData(None, 0x000000, RegionName.duel_tower, "event"),
    LocationName.dt_boss_two:           LocationData(None, 0x000000, RegionName.duel_tower, "event"),
    LocationName.dt_boss_three:         LocationData(None, 0x000000, RegionName.duel_tower, "event"),
    LocationName.dt_boss_four:          LocationData(None, 0x000000, RegionName.duel_tower, "event"),
    LocationName.roc_boss:              LocationData(None, 0x000000, RegionName.room_of_clocks, "event"),
    LocationName.ck_boss_one:           LocationData(None, 0x000000, RegionName.castle_keep, "event"),
    LocationName.ck_boss_two:           LocationData(None, 0x000000, RegionName.castle_keep, "event"),
}

crystal_table = {
    LocationName.cc_behind_the_seal:    LocationData(None, 0x000000, RegionName.castle_keep, "event"),
}

end_table = {
    LocationName.the_end:               LocationData(None, 0x000000, RegionName.drac_chamber, "event"),
}
