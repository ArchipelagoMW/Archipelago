normal_door_hook = [
    ...
    0x0C, 0x0F, 0xF1, 0x3C,  # JAL 0x803FC4F0
...
ct_door_hook = [
    0x0C, 0x0F, 0xF1, 0x4A,  # JAL   0x803FC528
    0x00, 0x00, 0x00, 0x00,  # NOP
...
custom_code_loader = [
    ...
    0x15, 0x00, 0x00, 0x0B,  # BNEZ  T0, [forward 0x0C]
...
tlb_modifiers = [
    ...
    0x15, 0x09, 0x00, 0x03,  # BNE   T0, T1, 0x8018384C
    0x00, 0x00, 0x00, 0x00,  # NOP
    0x03, 0x20, 0x00, 0x08,  # JR    T9
    ...
    0x15, 0x09, 0x00, 0x03,  # BNE   T0, T1, 0x80183860
    0x00, 0x00, 0x00, 0x00,  # NOP
    0x03, 0x20, 0x00, 0x08,  # JR    T9
    ...
    0x15, 0x09, 0x00, 0x09,  # BNE   T0, T1, 0x80183894
    ...
    0x15, 0x09, 0x00, 0x09,  # BNE   T0, T1, 0x801838C0
    ...
    0x15, 0x09, 0x00, 0x0E,  # BNE   T0, T1, 0x80183900
    0x24, 0x0A, 0x00, 0x18,  # ADDIU T2, R0, 0x0018
    0x24, 0x0B, 0x39, 0x08,  # ADDIU T3, R0, 0x3908
    0x24, 0x0C, 0x39, 0x9C,  # ADDIU T4, R0, 0x399C
    0x24, 0x0D, 0x39, 0x5C,  # ADDIU T5, R0, 0x395C
...
double_component_checker = [
    ...
    0x15, 0x20, 0x00, 0x08,  # BNEZ  T1, 0x80183938
    0x91, 0x49, 0x9C, 0x5D,  # LBU   T1, 0x9C5D (T2)
    0x11, 0x20, 0x00, 0x06,  # BEQZ  T1, 0x80183938
    0x00, 0x00, 0x00, 0x00,  # NOP
    0x10, 0x00, 0x00, 0x07,  # B     0x80183944
    0x31, 0xE9, 0x01, 0x00,  # ANDI  T1, T7, 0x0100
    0x15, 0x20, 0x00, 0x02,  # BNEZ  T1, 0x80183938
    0x91, 0x49, 0x9C, 0x5D,  # LBU   T1, 0x9C5D (T2)
    0x15, 0x20, 0x00, 0x03,  # BNEZ  T1, 0x80183944
    ...
    0x15, 0x20, 0x00, 0x08,  # BNEZ  T1, 0x8018398C
    0x91, 0x49, 0x9C, 0x5C,  # LBU   T1, 0x9C5C
    0x11, 0x20, 0x00, 0x06,  # BEQZ  T1, 0x8018398C
    0x00, 0x00, 0x00, 0x00,  # NOP
    0x10, 0x00, 0xFF, 0xF4,  # B     0x8018394C
    0x91, 0x4F, 0x9C, 0x18,  # LBU   T7, 0x9C18 (T2)
    0x31, 0xE9, 0x00, 0x02,  # ANDI  T1, T7, 0x0002
    0x15, 0x20, 0xFF, 0xEC,  # BNEZ  T1, 0x80183938
    0x91, 0x49, 0x9C, 0x5C,  # LBU   T1, 0x9C5C (T2)
    0x15, 0x20, 0xFF, 0xEF,  # BNEZ  T1, 0x8018394C
    0x00, 0x00, 0x00, 0x00,  # NOP
...
downstairs_seal_checker = [
    ...
    0x11, 0x40, 0x00, 0x03,  # BEQZ  T2, 0x801839B8
    0x3C, 0x19, 0x80, 0x00,  # LUI   T9, 0x8000
...
scene_data_modifiers = [
    ...
    0x15, 0x09, 0x00, 0x11,  # BNE   T0, T1, 0x80183AA4
    0x24, 0x0A, 0x00, 0x01,  # ADDIU T2, R0, 0x0001
    0x24, 0x0B, 0x00, 0x01,  # ADDIU T3, R0, 0x0001
    ...
    0x10, 0x00, 0x00, 0x08,  # B     0x80183AC4
    ...
    0x15, 0x09, 0x00, 0x06,  # BNE   T0, T1, 0x80183AC4
    0x24, 0x0A, 0x00, 0x01,  # ADDIU T2, R0, 0x0001
    0xA0, 0x4A, 0x00, 0x59,  # SB    T2, 0x0059 (V0)
    0x24, 0x0A, 0x01, 0x00,  # ADDIU T2, R0, 0x0100
    0x24, 0x0B, 0x02, 0x00,  # ADDIU T3, R0, 0x0200
