...
deathlink_counter_decrementer = [
    # Decrements the DeathLink counter if it's above zero.
    0x3C, 0x08, 0x80, 0x39,  # LUI   T0, 0x8039
...
death_flag_unsetter = [
    # Un-sets the Death status bitflag when overwriting the "Restart this stage" state to ensure DeathLinked players
    # don't get trapped in a perpetual death loop.
    0x3C, 0x04, 0x80, 0x39,  # LUI   A0, 0x8039
...
warp_menu_addresses = [
    # Changed jump addresses to go with the warp menu rewrite
    0x80, 0x12, 0xAD, 0xD0,
    0x80, 0x12, 0xAD, 0xE0,
    0x80, 0x12, 0xAD, 0xF0,
    0x80, 0x12, 0xAE, 0x00,
