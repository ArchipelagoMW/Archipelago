...
scene_data_modifiers = [
    ...
    0x10, 0x00, 0x00, 0x44,  # B     [forward 0x44]
    ...
    0x10, 0x00, 0x00, 0x3B,  # B     [forward 0x3B]
    ...
    0x10, 0x00, 0x00, 0x2E,  # B     [forward 0x2E]
    ...
    0x24, 0x0A, 0x00, 0x1A,  # ADDIU T2, R0, 0x0001
    0x24, 0x0B, 0x00, 0x03,  # ADDIU T3, R0, 0x0001
    ...
    0x10, 0x00, 0x00, 0x16,  # B     [forward 0x16]
    ...
    0x15, 0x09, 0x00, 0x0C,  # BNE   T0, T1, 0x803FC33C
    ...
    0x25, 0xAD, 0x01, 0x05,  # ADDIU T5, T5, 0x0105
