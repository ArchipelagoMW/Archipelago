# Setup Guide for Castlevania 64 Archipelago
...
- The built-in Archipelago client, which can be installed [here](https://github.com/ArchipelagoMW/Archipelago/releases)
  (select `Castlevania 64 Client` during installation).
- A Castlevania 64 US v1.0 ROM; v1.1/Rev A and v1.2/Rev B will not work.
...
### Obtain your CV64 patch file

When you join a multiworld game, you will be asked to provide your YAML file to whoever is hosting. Once that is done,
the host will provide you with either a link to download your data file, or with a zip file containing everyone's data
files. Your data file should have a `.apcv64` extension.

Double-click on your `.apcv64` file to start your client and start the ROM patch process. Once the process is finished
...
Now you are ready to start your adventure in Dracula's estate.
