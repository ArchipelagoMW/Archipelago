...
stage_dict = {
    ...
    "Duel Tower":           CV64Stage(RegionName.dt_main, 0x109DA7, 0x109DA9, 0x13, 0x00,
                                      RegionName.dt_main, 0x13, 0x15,
                                      RegionName.dt_main, 0x109D8F, 0x109D91, 0x13, 0x01,
                                      [0x104ACD]),
    ...
    "Tower of Sorcery":     CV64Stage(RegionName.tosor_main, 0x109D47, 0x109D49, 0x11, 0x00,
                                      RegionName.tosor_main, 0x11, 0x01,
                                      RegionName.tosor_main, 0x109D2F, 0x109D31, 0x11, 0x13,
                                      [0x104A8D]),
    "Room of Clocks":       CV64Stage(RegionName.roc_main, 0xFFFFFF, 0xFFFFFF, 0x1B, 0x00,
                                      RegionName.roc_main, 0x1B, 0x02,
                                      RegionName.roc_main, 0x109EAF, 0x109EB1, 0x1B, 0x14,
                                      [0x104AC5]),
    "Clock Tower":          CV64Stage(RegionName.ct_start, 0xFFFFFF, 0xFFFFFF, 0x17, 0x00,
                                      ...
                                      [0x104AB5, 0x104ABD]),
    "Castle Keep":          CV64Stage(RegionName.ck_main, 0xFFFFFF, 0xFFFFFF, 0x14, 0x02,
                                      RegionName.ck_main, 0x14, 0x03,
                                      RegionName.ck_drac_chamber, 0xFFFFFF, 0xFFFFFF, 0xFF, 0xFF,
                                      [0x104AAD])
}
