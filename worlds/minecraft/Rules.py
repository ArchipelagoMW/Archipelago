...
def set_rules(world: MultiWorld, player: int):
    ...
    set_rule(world.get_location("Adventuring Time", player), lambda state: state.has("Progressive Weapons", player) and state.has("Progressive Armor", player) and state.has_iron_ingots(player))
