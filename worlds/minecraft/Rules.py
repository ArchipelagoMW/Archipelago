...
def set_rules(world: MultiWorld, player: int):
    ...
    set_rule(world.get_location("The End... Again...", player), lambda state: can_complete(state) and state.has("Ingot Crafting", player)) # furnace for glass
    ...
    set_rule(world.get_location("A Balanced Diet", player), lambda state: state.has("Bottles", player) and state.has("Ingot Crafting", player) and 
                                                                          state.has("Resource Blocks", player) and state.can_reach('The End', 'Region', player)) # honey bottle, gapple, chorus fruit
