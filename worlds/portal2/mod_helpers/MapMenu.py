...
items_shortened = {
    ...
    portal_gun_2 : "Upg PG",
    potatos : "Potato",
    weighted_cube : "Wgt. Cube",
    reflection_cube : "Lsr Cube",
    spherical_cube : "Ball",
    antique_cube : "Old Cube",
    button : "Btn",
    old_button : "Old Btn",
    floor_button : "Floor Btn",
    old_floor_button : "Old Floor Btn",
    cube_button : "Cube Btn",
    ball_button : "Ball Btn",
    frankenturret : "Frnkncube",
    paint : "Gels",
    laser : "Laser",
    faith_plate : "Faith P.",
    funnel : "Funnel",
    bridge : "Bridge",
    laser_relays : "Lsr Relay",
    laser_catcher : "Lsr Catch",
    turrets : "Turret",
