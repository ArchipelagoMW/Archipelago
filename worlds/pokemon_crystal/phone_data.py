...
def split_location(location_name):
    ...
    return [line_cmd, location_name[:15] + "-", cont_cmd, location_name[15:-1] + "…"]
...
elm_mew_call = PhoneScript(caller_elm, [
    ...
    ScriptLine([para_cmd, "find a rare ", poke_cmd, "MON"]),
    ScriptLine([line_cmd, "if I didn't call"]),
    ScriptLine([cont_cmd, "the police."]),
