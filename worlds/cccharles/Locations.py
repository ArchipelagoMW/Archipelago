...
loc_south_mine_outside = {
    ...
    "South Mine Outside Scraps 4": base_id + 1118, # ItemPickup13_2 Mine_1_OutsideDetails (X=110989.156 Y=57840.090 Z=8700.936) \!/ Existing match 6
...
loc_port = {
    ...
    "Port Scraps 16": base_id + 1244, # ItemPickup14_5 Port_Main (X=80336.297 Y=-12276.590 Z=7436.639) \!/ Existing match 7
    "Port Scraps 17": base_id + 1245, # ItemPickup325_5 Port_Main (X=79845.086 Y=-13410.705 Z=7440.597)
    "Port Scraps 18": base_id + 1246, # ItemPickup13_2 Port_Main (X=76156.719 Y=-12816.718 Z=7439.269) \!/ Existing match 6
    "Port Scraps 19": base_id + 1247, # ItemPickup16 Port_Main (X=80754.914 Y=-14055.545 Z=7445.339) \!/ Existing match 2
...
loc_north_mine_outside = {
    ...
    "North Mine Outside Scraps 14": base_id + 1368, # ItemPickup13_2 Mine2_Interior2 (X=-52235.836 Y=-114501.117 Z=9462.438) \!/ Existing match 6
    "North Mine Outside Scraps 15": base_id + 1369 # ItemPickup14_5 Mine2_Interior2 (X=-53470.418 Y=-109766.102 Z=10252.304) \!/ Existing match 7
}

loc_north_mine_inside = {
    "North Mine Inside Scraps 1": base_id + 1370, # ItemPickup17_2 Mine2_Interior1 (X=-58433.055 Y=-104081.570 Z=9378.083) \!/ Existing match 8
    "North Mine Inside Scraps 2": base_id + 1371, # ItemPickup246_2 Mine2_Interior1 (X=-58987.199 Y=-103262.906 Z=9186.494)
    "North Mine Inside Scraps 3": base_id + 1372, # ItemPickup247_5 Mine2_Interior1 (X=-58812.801 Y=-99259.570 Z=8847.714)
    "North Mine Inside Scraps 4": base_id + 1373, # ItemPickup248_8 Mine2_Interior1 (X=-56634.379 Y=-99529.563 Z=8851.877)
    "North Mine Inside Scraps 5": base_id + 1374, # ItemPickup22_4 Mine2_Interior1 (X=-55604.477 Y=-98342.906 Z=8842.766)
    "North Mine Inside Scraps 6": base_id + 1375, # ItemPickup250_14 Mine2_Interior1 (X=-54824.535 Y=-98526.492 Z=8852.156)
    "North Mine Inside Scraps 7": base_id + 1376, # ItemPickup21_14 Mine2_Interior1 (X=-54887.254 Y=-99047.141 Z=8849.855)
    "North Mine Inside Scraps 8": base_id + 1377, # ItemPickup20_2 Mine2_Interior1 (X=-55610.020 Y=-101877.961 Z=9081.042)
    "North Mine Inside Scraps 9": base_id + 1378, # ItemPickup19_2 Mine2_Interior1 (X=-56519.340 Y=-101375.008 Z=9001.270)
    "North Mine Inside Scraps 10": base_id + 1379, # ItemPickup249_11 Mine2_Interior1 (X=-53329.922 Y=-99469.773 Z=8848.643)
    "North Mine Inside Scraps 11": base_id + 1380, # ItemPickup251_17 Mine2_Interior1 (X=-52814.828 Y=-96286.969 Z=8851.372)
    "North Mine Inside Scraps 12": base_id + 1381, # ItemPickup24_1 Mine2_Interior1 (X=-52605.957 Y=-96535.156 Z=8940.480)
    "North Mine Inside Scraps 13": base_id + 1382, # ItemPickup23_20 Mine2_Interior1 (X=-53237.699 Y=-96609.461 Z=8846.201)
    "North Mine Inside Scraps 14": base_id + 1383, # ItemPickup18_5 Mine2_Interior1 (X=-58543.488 Y=-95879.695 Z=8981.646)
...
loc_wood_bridge = {
    "Wood Bridge Scraps 1": base_id + 1386, # ItemPickup127_35 Bridge_Details (X=-66790.141 Y=-110340.367 Z=10454.417)
    "Wood Bridge Scraps 2": base_id + 1387, # ItemPickup18613654 Bridge_Details (X=-68364.586 Y=-111691.625 Z=10444.172)
    "Wood Bridge Scraps 3": base_id + 1388, # ItemPickup1311221 Bridge_StructureDetails (X=-69013.555 Y=-112353.977 Z=10399.942)
    "Wood Bridge Scraps 4": base_id + 1389, # ItemPickup93564 Bridge_StructureDetails (X=-70398.797 Y=-112916.945 Z=10372.192)
    "Wood Bridge Scraps 5": base_id + 1390, # ItemPickup161323 Bridge_Details (X=-71336.172 Y=-106966.672 Z=8430.104)
    "Wood Bridge Scraps 6": base_id + 1391, # ItemPickup128_38 Bridge_Details (X=-72776.086 Y=-107813.102 Z=8305.589)
    "Wood Bridge Scraps 7": base_id + 1392, # ItemPickup17975 Bridge_Details (X=-75224.648 Y=-108280.867 Z=7929.499)
    "Wood Bridge Scraps 8": base_id + 1393, # ItemPickup126_32 Bridge_Details (X=-68112.172 Y=-105119.656 Z=9458.937)
    "Wood Bridge Scraps 9": base_id + 1394, # ItemPickup118_8 Bridge_Details (X=-71847.625 Y=-103623.203 Z=10707.521)
    "Wood Bridge Scraps 10": base_id + 1395, # ItemPickup116_2 Bridge_Details (X=-71812.219 Y=-107256.094 Z=10780.134)
    "Wood Bridge Scraps 11": base_id + 1396, # ItemPickup134321 Bridge_Details (X=-72011.570 Y=-109054.547 Z=10866.852)
    "Wood Bridge Scraps 12": base_id + 1397, # ItemPickup117_5 Bridge_Details (X=-72862.430 Y=-106144.852 Z=10329.061)
    "Wood Bridge Scraps 13": base_id + 1398 # ItemPickup1494567 Bridge_Details (X=-71843.117 Y=-107174.133 Z=10367.116)
}

loc_museum = {
    "Museum Scraps 1": base_id + 1399, # ItemPickup119_11 Bridge_Details (X=-69687.773 Y=-100002.406 Z=10806.339)
    "Museum Scraps 2": base_id + 1400, # ItemPickup120_14 Bridge_Details (X=-68035.195 Y=-99480.672 Z=11049.731)
    "Museum Scraps 3": base_id + 1401, # ItemPickup125_29 Bridge_Details (X=-66912.641 Y=-99976.750 Z=11064.357)
    "Museum Scraps 4": base_id + 1402, # ItemPickup13532 Bridge_HouseDetails (X=-64901.117 Y=-99624.953 Z=11176.359)
    "Museum Scraps 5": base_id + 1403, # ItemPickup121_17 Bridge_Details (X=-66082.328 Y=-98105.555 Z=11089.308)
    "Museum Scraps 6": base_id + 1404, # ItemPickup21765 Bridge_HouseDetails (X=-67402.742 Y=-97735.133 Z=11153.927)
    "Museum Scraps 7": base_id + 1405, # ItemPickup124_26 Bridge_Details (X=-66716.031 Y=-98282.508 Z=11195.624)
    "Museum Scraps 8": base_id + 1406, # ItemPickup122_20 Bridge_Details (X=-66582.703 Y=-99092.461 Z=11630.082)
    "Museum Scraps 9": base_id + 1407, # ItemPickup123_23 Bridge_Details (X=-66798.164 Y=-99550.266 Z=11547.321)
    "Museum Scraps 10": base_id + 1408, # ItemPickup183423 Bridge_HouseDetails (X=-66850.336 Y=-99682.844 Z=11543.618)
    "Museum Scraps 11": base_id + 1409, # ItemPickup244_40 Mine2_OutsideDetails (X=-60156.828 Y=-98516.953 Z=11811.422)
    "Museum Scraps 12": base_id + 1410, # ItemPickup245_43 Mine2_OutsideDetails (X=-61195.203 Y=-98262.422 Z=11779.118)
...
loc_barbed_shelter = {
    ...
    "Barbed Shelter Scraps 1": base_id + 1414, # ItemPickup100_8 Bob_NPCHouseMain (X=-72525.500 Y=-89333.734 Z=9820.663)
    "Barbed Shelter Scraps 2": base_id + 1415, # ItemPickup98_2 Bob_NPCHouseMain (X=-74870.758 Y=-88576.641 Z=9836.814)
    "Barbed Shelter Scraps 3": base_id + 1416, # ItemPickup22_1 Bob_NPCHouseDetails (X=-76193.914 Y=-88038.836 Z=9818.776)
    "Barbed Shelter Scraps 4": base_id + 1417, # ItemPickup99_5 Bob_NPCHouseMain (X=-74494.859 Y=-87609.969 Z=9837.866)
    "Barbed Shelter Scraps 5": base_id + 1418 # ItemPickup23_3 Bob_NPCHouseDetails (X=-74826.930 Y=-88402.039 Z=9929.854)
}
...
loc_west_beach = {
    ...
    "West Beach Scraps 1": base_id + 1425, # ItemPickup87_13 Secret11_Details (X=-84489.945 Y=-91235.977 Z=8360.803)
    "West Beach Scraps 2": base_id + 1426, # ItemPickup349_2 Secret11_Details1 (X=-84386.320 Y=-90391.789 Z=8376.434)
    "West Beach Scraps 3": base_id + 1427, # ItemPickup86_10 Secret11_Details (X=-84714.773 Y=-89876.992 Z=7707.064)
    "West Beach Scraps 4": base_id + 1428, # ItemPickup350_5 Secret11_Details1 (X=-85478.672 Y=-90648.414 Z=7708.377)
    "West Beach Scraps 5": base_id + 1429, # ItemPickup85_7 Secret11_Details (X=-86276.633 Y=-90674.289 Z=7532.364)
    "West Beach Scraps 6": base_id + 1430, # ItemPickup88_16 Secret11_Details (X=-84363.055 Y=-87497.938 Z=7582.647)
    "West Beach Scraps 7": base_id + 1431, # ItemPickup351_8 Secret11_Details1 (X=-86556.266 Y=-89748.484 Z=7297.274)
    "West Beach Scraps 8": base_id + 1432 # ItemPickup352_11 Secret11_Details1 (X=-83210.836 Y=-92551.953 Z=8460.213)
}

loc_church = {
    "Church Black Paint Can": base_id + 1433, # PaintCan_4 Secret5_ChurchDetails (X=-67628.172 Y=-83801.375 Z=9865.983)
    "Church Scraps 1": base_id + 1434, # ItemPickup391_11 Secret5_ChurchDetails (X=-64009.039 Y=-84252.156 Z=10258.335)
    "Church Scraps 2": base_id + 1435, # ItemPickup389_5 Secret5_ChurchDetails (X=-66870.719 Y=-85202.180 Z=9843.936)
    "Church Scraps 3": base_id + 1436, # ItemPickup388_2 Secret5_ChurchDetails (X=-68588.352 Y=-84041.867 Z=9790.541)
    "Church Scraps 4": base_id + 1437, # ItemPickup396_26 Secret5_ChurchDetails (X=-67595.797 Y=-82120.094 Z=9818.303)
    "Church Scraps 5": base_id + 1438, # ItemPickup390_8 Secret5_ChurchDetails (X=-67291.000 Y=-83324.836 Z=9774.942)
    "Church Scraps 6": base_id + 1439, # ItemPickup392_14 Secret5_ChurchDetails (X=-65849.070 Y=-80676.477 Z=9895.943)
    "Church Scraps 7": base_id + 1440, # ItemPickup395_23 Secret5_ChurchDetails (X=-65170.266 Y=-79155.227 Z=9904.275)
    "Church Scraps 8": base_id + 1441, # ItemPickup24_4 Secret5_GraveyardMain (X=-64837.563 Y=-80885.305 Z=9906.755)
    "Church Scraps 9": base_id + 1442, # ItemPickup22_3 Secret5_ChurchDetails (X=-68248.359 Y=-83578.008 Z=9807.300)
    "Church Scraps 10": base_id + 1443, # ItemPickup23_5 Secret5_ChurchDetails (X=-67086.102 Y=-84605.086 Z=9805.521)
    "Church Scraps 11": base_id + 1444, # ItemPickup393_17 Secret5_ChurchDetails (X=-67901.930 Y=-83477.625 Z=9812.613)
    "Church Scraps 12": base_id + 1445 # ItemPickup394_20 Secret5_ChurchDetails (X=-65834.344 Y=-84192.102 Z=9987.823)
}

loc_west_cottage = {
    "West Cottage Gale Mission Start": base_id + 1446, # (dialog 10) -> mountain_ruin_key
    "West Cottage Scraps 1": base_id + 1447, # ItemPickup15_3 Mine3_NPCHouse (X=-74407.695 Y=-81781.250 Z=10120.775)
    "West Cottage Scraps 2": base_id + 1448, # ItemPickup283_5 Mine3_NPCHouseDetails (X=-73784.695 Y=-79414.359 Z=10128.285)
    "West Cottage Scraps 3": base_id + 1449, # ItemPickup13_1 Mine3_NPCHouse (X=-73992.391 Y=-78600.094 Z=10162.495)
    "West Cottage Scraps 4": base_id + 1450, # ItemPickup284_8 Mine3_NPCHouseDetails (X=-71623.000 Y=-75998.023 Z=10275.477)
    "West Cottage Scraps 5": base_id + 1451 # ItemPickup282_2 Mine3_NPCHouseDetails (X=-72626.453 Y=-79391.070 Z=10211.037)
}

loc_caravan = {
    "Caravan Scraps 1": base_id + 1452, # ItemPickup348_11 Secret10_PAth (X=-52638.109 Y=-43924.395 Z=10579.809)
    "Caravan Scraps 2": base_id + 1453, # ItemPickup347_8 Secret10_PAth (X=-50203.695 Y=-42865.672 Z=10778.871)
    "Caravan Scraps 3": base_id + 1454, # ItemPickup346_5 Secret10_PAth (X=-48467.738 Y=-42018.488 Z=10818.758)
    "Caravan Scraps 4": base_id + 1455, # ItemPickup77_14 Secret10_Details (X=-46325.219 Y=-41707.512 Z=11003.229)
    "Caravan Scraps 5": base_id + 1456, # ItemPickup345_2 Secret10_PAth (X=-44557.043 Y=-40652.930 Z=11076.221)
    "Caravan Scraps 6": base_id + 1457, # ItemPickup76_11 Secret10_Details (X=-43380.664 Y=-38207.152 Z=11165.370)
    "Caravan Scraps 7": base_id + 1458, # ItemPickup73_2 Secret10_Details (X=-42919.410 Y=-38797.738 Z=11265.633)
    "Caravan Scraps 8": base_id + 1459, # ItemPickup74_5 Secret10_Details (X=-42787.523 Y=-38601.820 Z=11254.003)
    "Caravan Scraps 9": base_id + 1460, # ItemPickup75_8 Secret10_Details (X=-42711.363 Y=-39141.523 Z=11173.905)
...
loc_trailer_cabin = {
    "Trailer Cabin Scraps 1": base_id + 1466, # ItemPickup493_17 TrailerCabin_Details (X=-50702.449 Y=-38850.020 Z=10810.316)
    "Trailer Cabin Scraps 2": base_id + 1467, # ItemPickup489_5 TrailerCabin_Details (X=-51365.684 Y=-38502.379 Z=10875.761)
    "Trailer Cabin Scraps 3": base_id + 1468, # ItemPickup491_11 TrailerCabin_Details (X=-52397.570 Y=-37530.145 Z=10873.624)
    "Trailer Cabin Scraps 4": base_id + 1469, # ItemPickup490_8 TrailerCabin_Details (X=-50625.746 Y=-37916.758 Z=10886.909)
    "Trailer Cabin Scraps 5": base_id + 1470, # ItemPickup488_2 TrailerCabin_Details (X=-51201.051 Y=-37467.137 Z=10910.795)
    "Trailer Cabin Scraps 6": base_id + 1471 # ItemPickup492_14 TrailerCabin_Details (X=-51891.320 Y=-40549.492 Z=10675.211)
}

loc_towers = {
    "Towers Scraps 1": base_id + 1472, # ItemPickup486_32 Towers_Environment_Details (X=-24434.766 Y=-25708.373 Z=11200.865)
    "Towers Scraps 2": base_id + 1473, # ItemPickup483_23 Towers_Environment_Details (X=-20970.262 Y=-25678.754 Z=11731.241)
    "Towers Scraps 3": base_id + 1474, # ItemPickup481_17 Towers_Environment_Details (X=-19812.230 Y=-27768.301 Z=12051.623)
    "Towers Scraps 4": base_id + 1475, # ItemPickup484_26 Towers_Environment_Details (X=-19940.912 Y=-25411.576 Z=12035.366)
    "Towers Scraps 5": base_id + 1476, # ItemPickup41_17 Towers_Environment (X=-18596.791 Y=-25100.035 Z=12290.350)
    "Towers Scraps 6": base_id + 1477, # ItemPickup482_20 Towers_Environment_Details (X=-23302.396 Y=-23270.324 Z=12036.164)
    "Towers Scraps 7": base_id + 1478, # ItemPickup487_35 Towers_Environment_Details (X=-22955.039 Y=-27576.859 Z=11211.258)
    "Towers Scraps 8": base_id + 1479, # ItemPickup478_8 Towers_Environment_Details (X=-21485.520 Y=-29634.893 Z=11787.103)
    "Towers Scraps 9": base_id + 1480, # ItemPickup477_5 Towers_Environment_Details (X=-23667.957 Y=-29825.240 Z=12035.269)
    "Towers Scraps 10": base_id + 1481, # ItemPickup39_11 Towers_Environment (X=-25361.008 Y=-29794.301 Z=12026.073)
    "Towers Scraps 11": base_id + 1482, # ItemPickup476_2 Towers_Environment_Details (X=-26549.584 Y=-32768.133 Z=12289.732)
    "Towers Scraps 12": base_id + 1483, # ItemPickup38_8 Towers_Environment (X=-27240.127 Y=-27404.748 Z=12027.208)
    "Towers Scraps 13": base_id + 1484, # ItemPickup40_14 Towers_Environment (X=-23231.639 Y=-27799.158 Z=11829.792)
    "Towers Scraps 14": base_id + 1485, # ItemPickup485_29 Towers_Environment_Details (X=-22949.568 Y=-26146.012 Z=11702.730)
    "Towers Scraps 15": base_id + 1486, # ItemPickup479_11 Towers_Environment_Details (X=-19726.715 Y=-32464.682 Z=12118.678)
    "Towers Scraps 16": base_id + 1487, # ItemPickup1366543 Tower_BuildingsExteriorDetails (X=-23495.104 Y=-27644.689 Z=11872.844)
    "Towers Scraps 17": base_id + 1488, # ItemPickup139978 Tower_BuildingsExteriorDetails (X=-23512.971 Y=-27493.051 Z=12218.543)
    "Towers Scraps 18": base_id + 1489, # ItemPickup42_20 Towers_Environment (X=-22731.439 Y=-26331.393 Z=12102.758)
    "Towers Scraps 19": base_id + 1490, # ItemPickup131123 Tower_BuildingsExteriorDetails (X=-22599.641 Y=-26454.590 Z=11752.040)
    "Towers Scraps 20": base_id + 1491, # ItemPickup196987 Tower_BuildingsExteriorDetails (X=-22589.721 Y=-26397.414 Z=12571.282)
    "Towers Scraps 21": base_id + 1492, # ItemPickup138787 Tower_BuildingsExteriorDetails (X=-22163.268 Y=-26775.938 Z=13107.048)
    "Towers Scraps 22": base_id + 1493, # ItemPickup43_23 Towers_Environment (X=-21996.184 Y=-26754.393 Z=13105.997)
    "Towers Scraps 23": base_id + 1494, # ItemPickup837454 Tower_BuildingsExteriorDetails (X=-24068.221 Y=-27874.443 Z=12819.666)
    "Towers Scraps 24": base_id + 1495, # ItemPickup44_29 Towers_Environment (X=-23525.330 Y=-27770.035 Z=12612.871)
    "Towers Scraps 25": base_id + 1496, # ItemPickup18932 Tower_BuildingsExteriorDetails (X=-23472.215 Y=-27617.404 Z=13213.256)
    "Towers Scraps 26": base_id + 1497, # ItemPickup188348 Tower_BuildingsExteriorDetails (X=-23981.588 Y=-27984.385 Z=13219.854)
    "Towers Scraps 27": base_id + 1498, # ItemPickup480_14 Towers_Environment_Details (X=-18696.230 Y=-34511.277 Z=12704.238)
...
loc_north_beach = {
    ...
    "North Beach Scraps 1": base_id + 1506, # ItemPickup376_5 Secret3_CampDetails (X=-75003.078 Y=-131084.016 Z=8729.731)
    "North Beach Scraps 2": base_id + 1507, # ItemPickup378_11 Secret3_CampDetails (X=-75477.758 Y=-129413.750 Z=9082.617)
    "North Beach Scraps 3": base_id + 1508, # ItemPickup377_8 Secret3_CampDetails (X=-75608.453 Y=-130483.430 Z=8909.659)
    "North Beach Scraps 4": base_id + 1509, # ItemPickup375_2 Secret3_CampDetails (X=-74143.469 Y=-131117.953 Z=8752.130)
    "North Beach Scraps 5": base_id + 1510, # ItemPickup387_6 Secret4_BeachHouseMain (X=-80847.078 Y=-135628.719 Z=7915.444)
    "North Beach Scraps 6": base_id + 1511, # ItemPickup386_3 Secret4_BeachHouseMain (X=-84044.789 Y=-137591.000 Z=7359.172)
    "North Beach Scraps 7": base_id + 1512, # ItemPickup379_2 Secret4_BeachHouseDetails (X=-83992.836 Y=-132933.531 Z=7941.225)
    "North Beach Scraps 8": base_id + 1513, # ItemPickup380_5 Secret4_BeachHouseDetails (X=-87355.734 Y=-134216.438 Z=7237.310)
    "North Beach Scraps 9": base_id + 1514, # ItemPickup384_17 Secret4_BeachHouseDetails (X=-89213.844 Y=-134625.922 Z=7185.133)
    "North Beach Scraps 10": base_id + 1515, # ItemPickup25_0 Secret4_BeachHouseDetails (X=-88423.430 Y=-135922.969 Z=7290.801)
    "North Beach Scraps 11": base_id + 1516, # ItemPickup381_8 Secret4_BeachHouseDetails (X=-87668.977 Y=-136850.359 Z=7275.346)
    "North Beach Scraps 12": base_id + 1517, # ItemPickup383_14 Secret4_BeachHouseDetails (X=-90241.328 Y=-136381.000 Z=7199.622)
    "North Beach Scraps 13": base_id + 1518, # ItemPickup27_8 Secret4_BeachHouseDetails (X=-91728.680 Y=-135288.203 Z=7319.699)
    "North Beach Scraps 14": base_id + 1519, # ItemPickup26_2 Secret4_BeachHouseDetails (X=-88789.039 Y=-135461.719 Z=7305.800)
    "North Beach Scraps 15": base_id + 1520, # ItemPickup382_11 Secret4_BeachHouseDetails (X=-88572.078 Y=-135970.734 Z=7302.674)
...
loc_mine_shaft = {
    ...
    "Mine Shaft Scraps 1": base_id + 1529, # ItemPickup369_23 Secret13_Details (X=-16985.645 Y=-70377.273 Z=10837.127)
    "Mine Shaft Scraps 2": base_id + 1530, # ItemPickup368_20 Secret13_Details (X=-18292.045 Y=-71003.563 Z=10975.308)
    "Mine Shaft Scraps 3": base_id + 1531, # ItemPickup367_17 Secret13_Details (X=-16150.797 Y=-72075.289 Z=10609.141)
    "Mine Shaft Scraps 4": base_id + 1532, # ItemPickup24456463 Secret13_EntranceDetails1 (X=-18404.480 Y=-71894.367 Z=10968.230)
    "Mine Shaft Scraps 5": base_id + 1533, # ItemPickup2565644 Secret13_Details (X=-17777.268 Y=-71467.172 Z=10441.745)
    "Mine Shaft Scraps 6": base_id + 1534, # ItemPickup366_14 Secret13_Details (X=-17630.971 Y=-72800.641 Z=8842.322)
    "Mine Shaft Scraps 7": base_id + 1535, # ItemPickup18_8 Secret13_Details (X=-17979.719 Y=-73413.563 Z=8118.260)
    "Mine Shaft Scraps 8": base_id + 1536, # ItemPickup21_11 Secret13_Details (X=-16554.467 Y=-74139.781 Z=7892.738)
    "Mine Shaft Scraps 9": base_id + 1537, # ItemPickup365_11 Secret13_Details (X=-16343.033 Y=-74617.555 Z=7298.177)
    "Mine Shaft Scraps 10": base_id + 1538, # ItemPickup22123 Secret13_Details (X=-12390.332 Y=-77620.320 Z=7324.504)
    "Mine Shaft Scraps 11": base_id + 1539, # ItemPickup364_8 Secret13_Details (X=-10969.702 Y=-77961.477 Z=7297.171)
    "Mine Shaft Scraps 12": base_id + 1540, # ItemPickup363_5 Secret13_Details (X=-9888.596 Y=-78208.930 Z=7269.473)
    "Mine Shaft Scraps 13": base_id + 1541, # ItemPickup362_2 Secret13_Details (X=-8865.696 Y=-79063.977 Z=7247.677)
    "Mine Shaft Scraps 14": base_id + 1542 # ItemPickup238976 Secret13_ExitDetails (X=-8143.984 Y=-79764.617 Z=7222.096)
}

loc_mob_camp = {
    "Mob Camp Key": base_id + 1543, # ItemPickup29_0 Bob_CampDetails2 (X=-29114.480 Y=-53608.520 Z=12839.528)
    "Mob Camp Scraps 1": base_id + 1544, # ItemPickup25_5 Bob_CampDetails2 (X=-27373.525 Y=-53008.668 Z=12706.465)
    "Mob Camp Scraps 2": base_id + 1545, # ItemPickup26_1 Bob_CampDetails2 (X=-28786.941 Y=-53009.762 Z=12760.727)
    "Mob Camp Scraps 3": base_id + 1546, # ItemPickup13_14 Mine3_Mountain (X=-29650.207 Y=-53328.070 Z=12724.598)
    "Mob Camp Scraps 4": base_id + 1547, # ItemPickup90_5 Bob_CampDetails2 (X=-31515.057 Y=-55533.324 Z=12344.274)
    "Mob Camp Scraps 5": base_id + 1548, # ItemPickup49513294 Mine3_Mountain (X=-31847.229 Y=-55152.352 Z=11574.255)
    "Mob Camp Scraps 6": base_id + 1549, # ItemPickup92_14 Bob_CampDetails2 (X=-31323.533 Y=-55432.871 Z=11245.139)
    "Mob Camp Scraps 7": base_id + 1550, # ItemPickup91_8 Bob_CampDetails2 (X=-31583.443 Y=-55475.805 Z=11234.112)
    "Mob Camp Scraps 8": base_id + 1551, # ItemPickup95_23 Bob_CampDetails2 (X=-32925.406 Y=-57157.605 Z=11086.322)
    "Mob Camp Scraps 9": base_id + 1552, # ItemPickup96_26 Bob_CampDetails2 (X=-33052.488 Y=-58560.098 Z=11101.021)
    "Mob Camp Scraps 10": base_id + 1553, # ItemPickup13121212 Mine3_Mountain (X=-32422.406 Y=-60145.063 Z=11203.182)
    "Mob Camp Scraps 11": base_id + 1554, # ItemPickup93_17 Bob_CampDetails2 (X=-30891.457 Y=-60046.465 Z=11237.567)
    "Mob Camp Scraps 12": base_id + 1555, # ItemPickup97_29 Bob_CampDetails2 (X=-31888.428 Y=-59222.645 Z=11179.302)
    "Mob Camp Scraps 13": base_id + 1556, # ItemPickup62156 Mine3_Mountain (X=-31161.750 Y=-57410.789 Z=11279.820)
    "Mob Camp Scraps 14": base_id + 1557, # ItemPickup24_3 Bob_CampDetails2 (X=-31256.545 Y=-59865.809 Z=11904.155)
    "Mob Camp Scraps 15": base_id + 1558, # ItemPickup27_0 Bob_CampDetails2 (X=-31757.953 Y=-57179.258 Z=11295.150)
    "Mob Camp Scraps 16": base_id + 1559 # ItemPickup89_2 Bob_CampDetails2 (X=-29137.043 Y=-54824.797 Z=12418.673)
}

loc_mob_camp_locked_room = {
    "Mob Camp Locked Room Scraps 1": base_id + 1560, # ItemPickup94_20 Bob_CampDetails2 (X=-31736.459 Y=-59761.465 Z=11211.379)
    "Mob Camp Locked Room Scraps 2": base_id + 1561, # ItemPickup28_14 Bob_CampDetails2 (X=-32150.889 Y=-59879.594 Z=11297.058)
    "Mob Camp Locked Room Stolen Bob": base_id + 1562 # Bob_Clickbox (X=-31771.172 Y=-59892.449 Z=11323.562)
}

loc_mine_elevator_exit = {
    "Mine Elevator Exit Scraps 1": base_id + 1563, # ItemPickup266_19 Mine3_ExitCampDetails (X=-29587.271 Y=-42650.797 Z=12515.042)
    "Mine Elevator Exit Scraps 2": base_id + 1564, # ItemPickup265_16 Mine3_ExitCampDetails (X=-30727.555 Y=-42715.438 Z=12485.763)
    "Mine Elevator Exit Scraps 3": base_id + 1565, # ItemPickup267_22 Mine3_ExitCampDetails (X=-29814.680 Y=-43722.777 Z=12518.878)
    "Mine Elevator Exit Scraps 4": base_id + 1566, # ItemPickup261_2 Mine3_ExitCampDetails (X=-30983.000 Y=-42943.754 Z=12474.396)
    "Mine Elevator Exit Scraps 5": base_id + 1567, # ItemPickup262_5 Mine3_ExitCampDetails (X=-31824.576 Y=-43997.270 Z=12345.908)
    "Mine Elevator Exit Scraps 6": base_id + 1568, # ItemPickup268_25 Mine3_ExitCampDetails (X=-32553.924 Y=-44761.855 Z=12341.698)
    "Mine Elevator Exit Scraps 7": base_id + 1569, # ItemPickup263_10 Mine3_ExitCampDetails (X=-33598.023 Y=-44369.297 Z=12438.430)
    "Mine Elevator Exit Scraps 8": base_id + 1570, # ItemPickup264_13 Mine3_ExitCampDetails (X=-31947.459 Y=-42017.137 Z=12384.311)
    "Mine Elevator Exit Scraps 9": base_id + 1571 # ItemPickup269_28 Mine3_ExitCampDetails (X=-30127.123 Y=-46004.891 Z=12229.104)
}

loc_mountain_ruin_outside = {
    "Mountain Ruin Outside Scraps 1": base_id + 1572, # ItemPickup112345556 Mine3_Outside (X=-2218.456 Y=-43914.789 Z=11238.952)
    "Mountain Ruin Outside Scraps 2": base_id + 1573, # ItemPickup35621 Mine3_Outside (X=-2402.206 Y=-45494.766 Z=11244.650)
    "Mountain Ruin Outside Scraps 3": base_id + 1574, # ItemPickup13000 Mine3_Outside (X=-2781.385 Y=-47365.313 Z=11235.389)
    "Mountain Ruin Outside Scraps 4": base_id + 1575, # ItemPickup995959 Mine3_Outside (X=-2961.431 Y=-45445.973 Z=11255.289)
    "Mountain Ruin Outside Scraps 5": base_id + 1576, # ItemPickup136999 Mine3_Outside (X=-5873.435 Y=-46300.633 Z=11228.667)
    "Mountain Ruin Outside Scraps 6": base_id + 1577, # ItemPickup1589994 Mine3_Outside (X=-1823.357 Y=-47071.813 Z=11161.523)
    "Mountain Ruin Outside Scraps 7": base_id + 1578, # ItemPickup09871230948 Mine3_Outside (X=-3478.155 Y=-49094.965 Z=11083.230)
    "Mountain Ruin Outside Scraps 8": base_id + 1579, # ItemPickup258_20 Mine3_Camp (X=-4606.678 Y=-50246.180 Z=11613.938)
    "Mountain Ruin Outside Scraps 9": base_id + 1580, # ItemPickup257_17 Mine3_Camp (X=-5454.638 Y=-53508.004 Z=12062.944)
    "Mountain Ruin Outside Scraps 10": base_id + 1581, # ItemPickup18_3 Mine3_Camp (X=-8192.042 Y=-53726.535 Z=11947.394)
    "Mountain Ruin Outside Scraps 11": base_id + 1582, # ItemPickup252_2 Mine3_Camp (X=-9409.834 Y=-53970.621 Z=11923.256)
    "Mountain Ruin Outside Scraps 12": base_id + 1583, # ItemPickup254_8 Mine3_Camp (X=-8977.424 Y=-57134.637 Z=12232.596)
    "Mountain Ruin Outside Scraps 13": base_id + 1584, # ItemPickup19_1 Mine3_Camp (X=-10449.292 Y=-56481.938 Z=12274.706)
    "Mountain Ruin Outside Scraps 14": base_id + 1585, # ItemPickup255_11 Mine3_Camp (X=-10490.690 Y=-56584.301 Z=12281.096)
    "Mountain Ruin Outside Scraps 15": base_id + 1586, # ItemPickup256_14 Mine3_Camp (X=-11600.937 Y=-55831.191 Z=12388.329)
    "Mountain Ruin Outside Scraps 16": base_id + 1587, # ItemPickup259_23 Mine3_Camp (X=-3307.077 Y=-49973.461 Z=11282.041)
    "Mountain Ruin Outside Scraps 17": base_id + 1588 # ItemPickup260_26 Mine3_Camp (X=-8878.345 Y=-49816.922 Z=13700.768)
}

loc_mountain_ruin_inside = {
    "Mountain Ruin Inside Scraps 1": base_id + 1589, # ItemPickup253_5 Mine3_Camp (X=-10647.446 Y=-52039.848 Z=11925.344)
    "Mountain Ruin Inside Scraps 2": base_id + 1590, # ItemPickup270_2 Mine3_Interior1 (X=-12834.990 Y=-48683.176 Z=10200.083)
    "Mountain Ruin Inside Scraps 3": base_id + 1591, # ItemPickup271_5 Mine3_Interior1 (X=-15748.594 Y=-44925.523 Z=10199.975)
    "Mountain Ruin Inside Scraps 4": base_id + 1592, # ItemPickup20_3 Mine3_Interior1 (X=-15312.152 Y=-43957.055 Z=10350.783)
    "Mountain Ruin Inside Scraps 5": base_id + 1593, # ItemPickup273_11 Mine3_Interior1 (X=-16709.586 Y=-44997.316 Z=10198.888)
    "Mountain Ruin Inside Scraps 6": base_id + 1594, # ItemPickup272_8 Mine3_Interior1 (X=-17412.561 Y=-46041.977 Z=10349.650)
    "Mountain Ruin Inside Scraps 7": base_id + 1595, # ItemPickup274_14 Mine3_Interior1 (X=-17452.596 Y=-43804.941 Z=10201.436)
    "Mountain Ruin Inside Scraps 8": base_id + 1596, # ItemPickup21_2 Mine3_Interior1 (X=-18119.473 Y=-42001.453 Z=10198.855)
    "Mountain Ruin Inside Scraps 9": base_id + 1597, # ItemPickup276_20 Mine3_Interior1 (X=-18975.068 Y=-42906.488 Z=10279.690)
    "Mountain Ruin Inside Scraps 10": base_id + 1598, # ItemPickup277_26 Mine3_Interior1 (X=-19727.902 Y=-41581.039 Z=10199.614)
    "Mountain Ruin Inside Scraps 11": base_id + 1599, # ItemPickup275_17 Mine3_Interior1 (X=-19187.891 Y=-40516.941 Z=10201.049)
    "Mountain Ruin Inside Scraps 12": base_id + 1600, # ItemPickup278_29 Mine3_Interior1 (X=-22470.986 Y=-41602.875 Z=10073.847)
    "Mountain Ruin Inside Scraps 13": base_id + 1601, # ItemPickup279_2 Mine3_Interior2 (X=-23717.383 Y=-42597.141 Z=7455.452)
    "Mountain Ruin Inside Scraps 14": base_id + 1602, # ItemPickup22_7 Mine3_Interior2 (X=-24494.582 Y=-44598.086 Z=7433.633)
    "Mountain Ruin Inside Scraps 15": base_id + 1603, # ItemPickup280_5 Mine3_Interior2 (X=-26783.293 Y=-42331.145 Z=7446.357)
    "Mountain Ruin Inside Scraps 16": base_id + 1604, # ItemPickup281_8 Mine3_Interior2 (X=-28636.996 Y=-46745.340 Z=7430.463)
    "Mountain Ruin Inside Scraps 17": base_id + 1605, # ItemPickup23_1 Mine3_Interior2 (X=-27752.643 Y=-47453.973 Z=7445.047)
...
loc_pickle_val = {
    "Pickle Val Scraps 1": base_id + 1608, # ItemPickup56_2 Pickles_HouseDetails (X=60402.582 Y=25252.434 Z=11151.982)
    "Pickle Val Scraps 2": base_id + 1609, # ItemPickup57_5 Pickles_HouseDetails (X=58717.516 Y=24457.180 Z=11343.938)
    "Pickle Val Scraps 3": base_id + 1610, # ItemPickup311_14 Pickles_EnvironmentDetails (X=56455.688 Y=22324.875 Z=11655.192)
    "Pickle Val Scraps 4": base_id + 1611, # ItemPickup310_11 Pickles_EnvironmentDetails (X=52888.387 Y=22541.955 Z=12428.012)
    "Pickle Val Scraps 5": base_id + 1612, # ItemPickup58_2 Pickles_EnvironmentDetails (X=50374.863 Y=22073.027 Z=12591.468)
    "Pickle Val Scraps 6": base_id + 1613, # ItemPickup309_8 Pickles_EnvironmentDetails (X=45985.988 Y=23063.826 Z=13043.497)
    "Pickle Val Scraps 7": base_id + 1614, # ItemPickup316_27 Pickles_EnvironmentDetails (X=45533.469 Y=24876.168 Z=13015.539)
    "Pickle Val Scraps 8": base_id + 1615, # ItemPickup317_30 Pickles_EnvironmentDetails (X=44928.848 Y=30913.396 Z=14273.230)
    "Pickle Val Scraps 9": base_id + 1616, # ItemPickup321_42 Pickles_EnvironmentDetails (X=41572.684 Y=37403.539 Z=13527.379)
    "Pickle Val Scraps 10": base_id + 1617, # ItemPickup61_11 Pickles_EnvironmentDetails (X=42266.566 Y=30556.238 Z=13584.196)
    "Pickle Val Scraps 11": base_id + 1618, # ItemPickup314_21 Pickles_EnvironmentDetails (X=43356.219 Y=29465.746 Z=13449.486)
    "Pickle Val Scraps 12": base_id + 1619, # ItemPickup323_48 Pickles_EnvironmentDetails (X=40893.461 Y=30669.398 Z=13465.039)
    "Pickle Val Scraps 13": base_id + 1620, # ItemPickup318_33 Pickles_EnvironmentDetails (X=41276.863 Y=32313.068 Z=13480.846)
    "Pickle Val Scraps 14": base_id + 1621, # ItemPickup319_36 Pickles_EnvironmentDetails (X=38630.031 Y=30471.996 Z=13571.207)
    "Pickle Val Scraps 15": base_id + 1622, # ItemPickup320_39 Pickles_EnvironmentDetails (X=38596.938 Y=30050.293 Z=13559.574)
    "Pickle Val Scraps 16": base_id + 1623, # ItemPickup60_8 Pickles_EnvironmentDetails (X=42042.520 Y=25136.820 Z=13077.339)
    "Pickle Val Scraps 17": base_id + 1624, # ItemPickup308_5 Pickles_EnvironmentDetails (X=43770.914 Y=23307.234 Z=12374.002)
    "Pickle Val Scraps 18": base_id + 1625, # ItemPickup59_5 Pickles_EnvironmentDetails (X=44672.641 Y=20936.520 Z=12198.017)
    "Pickle Val Scraps 19": base_id + 1626, # ItemPickup307_2 Pickles_EnvironmentDetails (X=42844.730 Y=22869.387 Z=12832.900)
    "Pickle Val Scraps 20": base_id + 1627, # ItemPickup315_24 Pickles_EnvironmentDetails (X=43397.758 Y=26367.248 Z=13005.097)
    "Pickle Val Scraps 21": base_id + 1628, # ItemPickup322_45 Pickles_EnvironmentDetails (X=39352.430 Y=32668.316 Z=14494.778)
    "Pickle Val Scraps 22": base_id + 1629, # ItemPickup313 Pickles_EnvironmentDetails (X=59688.781 Y=25266.756 Z=11425.324)
    "Pickle Val Scraps 23": base_id + 1630, # ItemPickup312_17 Pickles_EnvironmentDetails (X=59197.871 Y=24760.773 Z=11425.324)
...
loc_shrine_near_temple = {
    "Shrine Near Temple Scraps 1": base_id + 1634, # ItemPickup3 Photorealistic_Island (X=-4675.183 Y=-21143.846 Z=11984.782)
    "Shrine Near Temple Scraps 2": base_id + 1635, # ItemPickup_2 Photorealistic_Island (X=-4994.117 Y=-20496.621 Z=11874.112)
    "Shrine Near Temple Scraps 3": base_id + 1636 # ItemPickup2 Photorealistic_Island (X=-4196.896 Y=-20477.025 Z=11882.833)
}
...
loc_morse_bunker = {
    ...
    "Morse Bunker Scraps 1": base_id + 1642, # ItemPickup397_2 Secret6_BunkerDetails (X=-48336.863 Y=-85458.453 Z=10574.537)
    "Morse Bunker Scraps 2": base_id + 1643, # ItemPickup62_2 Secret6_BunkerDetails (X=-48253.844 Y=-84944.609 Z=10573.793)
    "Morse Bunker Scraps 3": base_id + 1644, # ItemPickup63_5 Secret6_BunkerDetails (X=-47272.422 Y=-84549.945 Z=10543.671)
    "Morse Bunker Scraps 4": base_id + 1645, # ItemPickup398_5 Secret6_BunkerDetails (X=-47080.836 Y=-85268.281 Z=10564.355)
    "Morse Bunker Scraps 5": base_id + 1646, # ItemPickup406_31 Secret6_BunkerDetails (X=-47913.855 Y=-85234.258 Z=10819.314)
    "Morse Bunker Scraps 6": base_id + 1647, # ItemPickup405_28 Secret6_BunkerDetails (X=-46410.227 Y=-83293.742 Z=10361.746)
    "Morse Bunker Scraps 7": base_id + 1648, # ItemPickup399_8 Secret6_BunkerDetails (X=-45204.199 Y=-84841.211 Z=10329.200)
    "Morse Bunker Scraps 8": base_id + 1649, # ItemPickup401_14 Secret6_BunkerDetails (X=-43895.801 Y=-83794.750 Z=10265.661)
    "Morse Bunker Scraps 9": base_id + 1650, # ItemPickup402_17 Secret6_BunkerDetails (X=-45163.078 Y=-80832.828 Z=10090.777)
    "Morse Bunker Scraps 10": base_id + 1651, # ItemPickup403_20 Secret6_BunkerDetails (X=-46782.027 Y=-82284.805 Z=10289.180)
    "Morse Bunker Scraps 11": base_id + 1652, # ItemPickup404_23 Secret6_BunkerDetails (X=-49240.047 Y=-83654.961 Z=10898.540)
    "Morse Bunker Scraps 12": base_id + 1653, # ItemPickup407_34 Secret6_BunkerDetails (X=-46571.930 Y=-85962.773 Z=10697.339)
    "Morse Bunker Scraps 13": base_id + 1654 # ItemPickup400_11 Secret6_BunkerDetails (X=-43472.793 Y=-85983.805 Z=10310.322)
}

loc_prism_temple = {
    "Prism Temple Chest Scraps 1": base_id + 1655, # ItemPickup16632 MainShrine_DetailsREPAIRED (X=12659.641 Y=-27827.016 Z=10930.621)
    "Prism Temple Chest Scraps 2": base_id + 1656, # ItemPickup148864 MainShrine_DetailsREPAIRED (X=12648.021 Y=-27825.189 Z=10916.296)
    "Prism Temple Chest Scraps 3": base_id + 1657, # ItemPickup13123 MainShrine_DetailsREPAIRED (X=12665.557 Y=-27836.633 Z=10905.999)
    "Prism Temple Scraps 1": base_id + 1658, # ItemPickup225_77 MainShrine_ExteriorDetails (X=5281.087 Y=-16620.387 Z=10520.609)
    "Prism Temple Scraps 2": base_id + 1659, # ItemPickup223_71 MainShrine_ExteriorDetails (X=15032.147 Y=-16788.352 Z=10992.200)
    "Prism Temple Scraps 3": base_id + 1660, # ItemPickup222_68 MainShrine_ExteriorDetails (X=16591.920 Y=-18725.771 Z=11004.751)
    "Prism Temple Scraps 4": base_id + 1661, # ItemPickup135123 MainShrine_DetailsREPAIRED (X=17940.854 Y=-20726.746 Z=10999.944)
    "Prism Temple Scraps 5": base_id + 1662, # ItemPickup220_62 MainShrine_ExteriorDetails (X=18187.346 Y=-21390.066 Z=11025.650)
    "Prism Temple Scraps 6": base_id + 1663, # ItemPickup218_56 MainShrine_ExteriorDetails (X=19218.670 Y=-24017.619 Z=10906.966)
    "Prism Temple Scraps 7": base_id + 1664, # ItemPickup209_29 MainShrine_ExteriorDetails (X=7710.977 Y=-23469.254 Z=11012.888)
    "Prism Temple Scraps 8": base_id + 1665, # ItemPickup138765 MainShrine_DetailsREPAIRED (X=8160.002 Y=-22335.266 Z=11016.638)
    "Prism Temple Scraps 9": base_id + 1666, # ItemPickup210_32 MainShrine_ExteriorDetails (X=8637.903 Y=-24295.850 Z=10929.299)
    "Prism Temple Scraps 10": base_id + 1667, # ItemPickup1112 MainShrine_DetailsREPAIRED (X=7923.367 Y=-25204.055 Z=10832.877)
    "Prism Temple Scraps 11": base_id + 1668, # ItemPickup214_44 MainShrine_ExteriorDetails (X=10694.420 Y=-27246.365 Z=10569.074)
    "Prism Temple Scraps 12": base_id + 1669, # ItemPickup215_47 MainShrine_ExteriorDetails (X=12892.631 Y=-26743.068 Z=10868.578)
    "Prism Temple Scraps 13": base_id + 1670, # ItemPickup213_41 MainShrine_ExteriorDetails (X=12483.535 Y=-27253.867 Z=10876.461)
    "Prism Temple Scraps 14": base_id + 1671, # ItemPickup212_38 MainShrine_ExteriorDetails (X=13259.813 Y=-27092.033 Z=10887.968)
    "Prism Temple Scraps 15": base_id + 1672, # ItemPickup211_35 MainShrine_ExteriorDetails (X=9303.245 Y=-25057.908 Z=10943.273)
    "Prism Temple Scraps 16": base_id + 1673, # ItemPickup201_2 MainShrine_ExteriorDetails (X=11750.875 Y=-22999.371 Z=12426.734)
    "Prism Temple Scraps 17": base_id + 1674, # ItemPickup203_8 MainShrine_ExteriorDetails (X=12966.615 Y=-23568.324 Z=12519.387)
    "Prism Temple Scraps 18": base_id + 1675, # ItemPickup204_11 MainShrine_ExteriorDetails (X=14093.343 Y=-22393.182 Z=12426.847)
    "Prism Temple Scraps 19": base_id + 1676, # ItemPickup206_17 MainShrine_ExteriorDetails (X=13767.980 Y=-21269.568 Z=12425.791)
    "Prism Temple Scraps 20": base_id + 1677, # ItemPickup207_23 MainShrine_ExteriorDetails (X=12882.754 Y=-20027.527 Z=12516.095)
    "Prism Temple Scraps 21": base_id + 1678, # ItemPickup114535 MainShrine_DetailsREPAIRED (X=11883.399 Y=-20801.344 Z=12428.452)
    "Prism Temple Scraps 22": base_id + 1679, # ItemPickup208_26 MainShrine_ExteriorDetails (X=13281.792 Y=-21302.344 Z=12902.728)
    "Prism Temple Scraps 23": base_id + 1680, # ItemPickup205_14 MainShrine_ExteriorDetails (X=14190.678 Y=-23671.621 Z=11781.533)
    "Prism Temple Scraps 24": base_id + 1681, # ItemPickup8903 MainShrine_DetailsREPAIRED (X=14311.736 Y=-22347.758 Z=11765.781)
    "Prism Temple Scraps 25": base_id + 1682, # ItemPickup654 MainShrine_DetailsREPAIRED (X=13826.154 Y=-19923.131 Z=11755.189)
    "Prism Temple Scraps 26": base_id + 1683, # ItemPickup224_74 MainShrine_ExteriorDetails (X=12443.228 Y=-18577.926 Z=11240.455)
    "Prism Temple Scraps 27": base_id + 1684, # ItemPickup202_5 MainShrine_ExteriorDetails (X=10993.180 Y=-23783.047 Z=11754.121)
    "Prism Temple Scraps 28": base_id + 1685, # ItemPickup13098 MainShrine_DetailsREPAIRED (X=16762.963 Y=-23634.342 Z=11031.588)
    "Prism Temple Scraps 29": base_id + 1686, # ItemPickup221_65 MainShrine_ExteriorDetails (X=17804.979 Y=-23512.395 Z=11066.884)
    "Prism Temple Scraps 30": base_id + 1687, # ItemPickup17123123565 MainShrine_DetailsREPAIRED (X=16998.229 Y=-23241.652 Z=11055.539)
    "Prism Temple Scraps 31": base_id + 1688, # ItemPickup10812783 MainShrine_DetailsREPAIRED (X=17613.518 Y=-23799.813 Z=11057.277)
    "Prism Temple Scraps 32": base_id + 1689, # ItemPickup216_50 MainShrine_ExteriorDetails (X=15342.375 Y=-24807.357 Z=11024.192)
    "Prism Temple Scraps 33": base_id + 1690, # ItemPickup217_53 MainShrine_ExteriorDetails (X=15963.284 Y=-24834.156 Z=11021.444)
    "Prism Temple Scraps 34": base_id + 1691 # ItemPickup219_59 MainShrine_ExteriorDetails (X=21563.559 Y=-23705.184 Z=10895.696)
}
