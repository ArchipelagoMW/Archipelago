...
def set_entrances(multiworld, world, player):
    ...
    loonyland_entrance_table: List[EntranceData] = [
        ...
        EntranceData("Halloween Hill", "Dusty Crypt", True, lambda state: have_light_source(state, player)),
        EntranceData("Zombiton", "Musty Crypt", True, lambda state: have_light_source(state, player)),
        EntranceData("Zombiton", "A Messy Cabin", True, lambda state: True),
        EntranceData("Halloween Hill", "Rusty Crypt", True, lambda state: have_light_source(state, player)),
        EntranceData("Halloween Hill", "Under The Lake", True, lambda state: have_light_source(state, player) and state.has("Orb", player, 4)),
        EntranceData("Halloween Hill", "Haunted Tower", True, lambda state: state.has("Ghost Potion", player)),
        EntranceData("Rocky Cliffs", "Abandoned Mines", True, lambda state: have_light_source(state, player)),
        EntranceData("Rocky Cliffs", "The Shrine Of Bombulus", True, lambda state: True),
        EntranceData("Rocky Cliffs", "A Gloomy Cavern", True, lambda state: have_light_source(state, player)),
        EntranceData("Halloween Hill", "Happy Stick Woods", True, lambda state: state.has("Happy Stick", player)),
        EntranceData("Zombiton", "A Cabin Larry", True, lambda state: True),
        EntranceData("Halloween Hill", "The Wolf Den", True, lambda state: state.has("Silver Sling", player) and have_light_source(state, player)),
        EntranceData("Rocky Cliffs", "Upper Creepy Caverns", True, lambda state: have_light_source(state, player) and state.has("Bombs", player)),
        EntranceData("Rocky Cliffs", "Creepy Caverns Left", True, lambda state: have_light_source(state, player)),
        ...
        EntranceData("Vampy Land", "Creepy Caverns Right", True, lambda state: have_light_source(state, player)),
        ...
        EntranceData("Haunted Tower", "Haunted Basement", True, lambda state: have_light_source(state, player) and
                                                                              state.has("Bat Key", player) and
        ...
        EntranceData("Upper Creepy Caverns", "Creepy Caverns Left", True, lambda state: have_light_source(state, player)),
        EntranceData("Upper Creepy Caverns", "Creepy Caverns Middle", True, lambda state: have_light_source(state, player)),
        EntranceData("Under The Ravine", "Creepy Caverns Middle", True, lambda state: have_light_source(state, player)),
        EntranceData("Under The Ravine", "Creepy Caverns Right", True, lambda state: have_light_source(state, player)),
        EntranceData("Creepy Caverns Left", "Rocky Cliffs", True, lambda state: True),
        EntranceData("Creepy Caverns Left", "Upper Creepy Caverns", True, lambda state: have_light_source(state, player)),
        EntranceData("Creepy Caverns Middle", "Upper Creepy Caverns", True, lambda state: have_light_source(state, player)),
