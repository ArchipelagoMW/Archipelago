...
loonyland_location_table: Dict[str, LoonylandLocationData] = {
    ...
    "Pumpkin Door":     LoonylandLocationData(37, LocationCategory.PICKUP, "Dusty Crypt"),
    ...
    "Bat Door":     LoonylandLocationData(44, LocationCategory.PICKUP, "Under the Lake"),
    ...
    "Boss Reward":     LoonylandLocationData(47, LocationCategory.PICKUP, "Frankenjulie's Laboratory"),
