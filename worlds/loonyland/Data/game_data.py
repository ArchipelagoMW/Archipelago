...
loony_item_table: dict[str, LLItem] = {
    ...
    "Play As Swampdog": LLItem(ll_base_id + CH_SWAMPDOG + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.useful, flags=["MULTISAVE"]),
    ...
    "Play As Witch": LLItem(ll_base_id + CH_WITCH + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.useful, flags=["MULTISAVE"]),
...
loonyland_location_table: dict[str, LLLocation] = {
    ...
    "Digitally Masterin'": LLLocation(153, LLLocCat.BADGE, 39, "Menu", flags=["LONG", "REMIX", "MULTISAVE"], base_item="Farley Free Zone"),
