...
loony_item_table: dict[str, LLItem] = {
    ...
    "Quick Mode": LLItem(ll_base_id + CH_QUICK + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.useful),
    ...
    "Homing Shots": LLItem(ll_base_id + CH_HOMING + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.useful),
    ...
    "Heavy Hitter": LLItem(ll_base_id + CH_HEAVYHIT + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.useful),
    "Rapid Fire": LLItem(ll_base_id + CH_RAPIDFIRE + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.filler),
    ...
    "Guided Shots": LLItem(ll_base_id + CH_GUIDED + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.useful),
    "Slo-Mo": LLItem(ll_base_id + CH_SLOMO + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.useful),
    "Combo-Bombo": LLItem(ll_base_id + CH_CORPSE + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.useful),
...
loonyland_location_table: dict[str, LLLocation] = {
    ...
    "Q: The Collection": LLLocation(113, LLLocCat.QUEST, 19, "A Cabin Collector"),
    ...
    "Extreme Survivin'": LLLocation(
        135, LLLocCat.BADGE, 21, "Survival", flags=["LONG_VANILLA"], base_item="Touch Of Death"
    ),
    ...
    "Mad Skeelz": LLLocation(
        140, LLLocCat.BADGE, 26, "The Evilizer", flags=["LONG_VANILLA"], base_item="Kick The Cat!"
    ),
    ...
    "Ninjitsu": LLLocation(146, LLLocCat.BADGE, 32, "Menu", flags=["LONG_VANILLA"], base_item="Molecular Dispersion"),
    ...
    "Brawlin'": LLLocation(
        151, LLLocCat.BADGE, 37, "Benny's Cocktails", flags=["LONG_VANILLA"], base_item="Thorns Aura"
    ),
...
def set_rules(multiworld, world, player):
    access_rules: dict[str, CollectionRule] = {
        ...
        "Q: The Collection": lambda state: can_kill_werewolves(state, player)
        and state.has("Ghost Potion", player)
        and state.can_reach_region("Castle Vampy", player),
        "Greed": lambda state: state.can_reach_region("Castle Vampy IV", player),
