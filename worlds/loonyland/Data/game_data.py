...
loony_item_table: dict[str, LLItem] = {
    ...
    "Touch Of Death": LLItem(
        ll_base_id + CH_DEATH + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.progression, flags=["PWR_MAX"]
    ),
    ...
    "Play As Swampdog": LLItem(
        ll_base_id + CH_SWAMPDOG + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.useful, flags=["MULTISAVE"]
    ),
    ...
    "Play As Witch": LLItem(
        ll_base_id + CH_WITCH + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.useful, flags=["MULTISAVE"]
    ),
    ...
    "Guaranteed Survival": LLItem(
        ll_base_id + CH_SUPERSURV + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.progression, flags=["PWR_MAX"]
    ),
...
loonyland_region_table: dict[str, LLRegion] = {
    ...
    "Remix": LLRegion(False, flags=["MODE"]),
}
loonyland_location_table: dict[str, LLLocation] = {
    ...
    "Q: A True Hero": LLLocation(106, LLLocCat.QUEST, 12, "Under The Ravine", flags=["LONG"]),
    ...
    "Mad Skeelz": LLLocation(
        140, LLLocCat.BADGE, 26, "The Evilizer", flags=["LONG_VANILLA_BADGES", "MULTISAVE"], base_item="Kick The Cat!"
    ),
    ...
    "Brawlin'": LLLocation(
        151, LLLocCat.BADGE, 37, "Benny's Cocktails", flags=["LONG_VANILLA_BADGES"], base_item="Thorns Aura"
    ),
    ...
    "Digitally Masterin'": LLLocation(
        153, LLLocCat.BADGE, 39, "Menu", flags=["LONG", "REMIX", "MULTISAVE"], base_item="Farley Free Zone"
    ),
...
def set_entrance_rules(multiworld, world):
    loonyland_entrance_table: list[LLEntrance] = [
        ...
        LLEntrance("Menu", "Remix", False, lambda state: state.has("Remix Access", world.player), flags=["MODE"]),
