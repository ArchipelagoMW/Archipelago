...
loony_item_table: dict[str, LLItem] = {
    ...
    "Infinite Gems": LLItem(ll_base_id + CH_GEMS + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.useful),
    ...
    "Ultimate Firepower": LLItem(ll_base_id + CH_MAXPOWER + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.filler),
    "Vintage Mode": LLItem(ll_base_id + CH_VINTAGE + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.useful),
    "Play As Bonkula": LLItem(ll_base_id + CH_BONKULA + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.filler),
    "Play As Toad": LLItem(ll_base_id + CH_TOAD + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.filler),
    ...
    "Touch Of Death": LLItem(ll_base_id + CH_DEATH + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.progression, flags=["PWR_MAX"]),
    "All Access Pass": LLItem(ll_base_id + CH_ALLACCESS + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.progression),
    "Play As Swampdog": LLItem(ll_base_id + CH_SWAMPDOG + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.useful),
    "Hardcore Mode": LLItem(ll_base_id + CH_HARDCORE + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.filler),
    ...
    "Play As Witch": LLItem(ll_base_id + CH_WITCH + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.useful),
    ...
    "Guaranteed Survival": LLItem(ll_base_id + CH_SUPERSURV + AP_BADGEMOD, LLItemCat.CHEAT, ItemClassification.progression, flags=["PWR_MAX"]),
...
loonyland_location_table: dict[str, LLLocation] = {
    ...
    "Evil Smashin'": LLLocation(114, LLLocCat.BADGE, 0, "The Evilizer", base_item="Quick Mode"),
    ...
    "Ultimate Victory": LLLocation(122, LLLocCat.BADGE, 8, "The Evilizer", base_item="Ultimate Firepower"),
    ...
    "Winnin'": LLLocation(131, LLLocCat.BADGE, 17, "The Evilizer", base_item="Crystal Ball"),
    ...
    "Mad Skeelz": LLLocation(140, LLLocCat.BADGE, 26, "The Evilizer", flags=["LONG_VANILLA_BADGES"], base_item="Kick The Cat!"),
    ...
    "Witchcraft": LLLocation(145, LLLocCat.BADGE, 31, "Menu", flags=["LONG"], base_item="Play As Ninja Girl"),
    "Ninjitsu": LLLocation(146, LLLocCat.BADGE, 32, "Menu", flags=["LONG_VANILLA_BADGES"], base_item="Molecular Dispersion"),
    "Stayin' Alive": LLLocation(147, LLLocCat.BADGE, 33, "Survival", base_item="Guaranteed Survival"),
    "Hooliganin'": LLLocation(148, LLLocCat.BADGE, 34, "Loony Ball", base_item="Bend It Like Bouapha"),
    "Swampdoggin'": LLLocation(149, LLLocCat.BADGE, 35, "Menu", flags=["LONG"], base_item="Stinky Farley"),
    "Scorin'": LLLocation(150, LLLocCat.BADGE, 36, "The Evilizer", base_item="Ultra Weapons Are Go!"),
    "Brawlin'": LLLocation(151, LLLocCat.BADGE, 37, "Benny's Cocktails", flags=["LONG_VANILLA_BADGES"], base_item="Thorns Aura"),
    "Minin' For Treasure": LLLocation(152, LLLocCat.BADGE, 38, "Menu", flags=["REMIX"], base_item="Monster Regeneration"),
    "Digitally Masterin'": LLLocation(153, LLLocCat.BADGE, 39, "Menu", flags=["LONG"], base_item="Farley Free Zone"),
    ...
    "Mayor Reward": LLLocation(157, LLLocCat.REWARD, VAR_ZOMBIEREWARD, "Zombiton"),
    "Bat Drop": LLLocation(158, LLLocCat.DOLL, 0, "Menu", base_item="Bat Doll"),
    "Skeleton Drop": LLLocation(159, LLLocCat.DOLL, 1, "Menu", base_item="Skeleton Doll"),
    "Frog Drop": LLLocation(160, LLLocCat.DOLL, 2, "Menu", base_item="Frog Doll"),
    "Ghost Drop": LLLocation(161, LLLocCat.DOLL, 3, "Menu", base_item="Ghost Doll"),
    "Mummy Drop": LLLocation(162, LLLocCat.DOLL, 4, "Menu", base_item="Mummy Doll"),
    "Swampdog Drop": LLLocation(163, LLLocCat.DOLL, 5, "Menu", base_item="Swampdog Doll"),
    "Vampire Drop": LLLocation(164, LLLocCat.DOLL, 6, "Menu", base_item="Vampire Doll"),
    "Wolf Drop": LLLocation(165, LLLocCat.DOLL, 7, "Menu", base_item="Wolfman Doll"),
}
def set_rules(multiworld, world):
    access_rules: dict[str, CollectionRule] = {
        "Rocky Cliffs: Vine": lambda state: state.has("Fertilizer", world.player),
        "Rocky Cliffs: Rock Corner": lambda state: have_bombs(state, world),
        "Witch's Cabin: Bedroom": lambda state: have_light_source(state, world),
        "Bog Pit: Top Door": lambda state: state.has("Skull Key", world.player),
        "Tunnel: Swampdog Pumpkin Door": lambda state: state.has("Pumpkin Key", world.player),
        "Tunnel: Scratch Wall": lambda state: have_special_weapon_bullet(state, world),
        "Swamp Gas: Scratch Wall": lambda state: have_special_weapon_bullet(state, world),
        "Swamp Gas: Bat Door": lambda state: state.has("Bat Key", world.player),
        "Swamp Gas: Rock Prison": lambda state: have_bombs(state, world),
        "Dusty Crypt: Pumpkin Door": lambda state: state.has("Pumpkin Key", world.player),
        "Musty Crypt: Maze Room": lambda state: have_special_weapon_bullet(state, world),
        "Rusty Crypt: Vine": lambda state: state.has("Fertilizer", world.player),
        "Under The Lake: Bat Door": lambda state: state.has("Bat Key", world.player),
        ...
        "Hidey-Hole: Bat Door": lambda state: state.has("Bat Key", world.player),
        "Swampdog Lair: End": lambda state: have_light_source(state, world) and state.has("Fertilizer", world.player),
        "Q: Save Halloween Hill": lambda state: power_level(state, world, 30),
        "Q: Scaredy Cat": lambda state: state.has("Cat", world.player),
        "Q: Mushroom Hunt": lambda state: state.has("Mushroom", world.player, 10),
        "Q: Picking Daisies": lambda state: state.has("Doom Daisy", world.player),
        "Q: Curse The Darkness": lambda state: state.has("Stick", world.player),
        "Q: Zombie Stomp": lambda state: can_cleanse_crypts(state, world),
        "Q: Smashing Pumpkins": lambda state: can_cleanse_crypts(state, world),
        "Q: Mystery Lake": lambda state: state.has("Orb", world.player, 4),
        ...
        "Extreme Survivin'": lambda state: state.has("Terror Mode", world.player),
        ...
        "Mad Skeelz": lambda state: state.has("Terror Mode", world.player),
        ...
        "Ninjitsu": lambda state: state.has("Play As Ninja Girl", world.player) and have_all_weapons(state, world),
        ...
        "Bat Drop": lambda state: can_reach_bats(state, world),
        "Skeleton Drop": lambda state: can_reach_skeleton(state, world),
        "Frog Drop": lambda state: can_reach_frog(state, world),
        "Ghost Drop": lambda state: can_reach_ghost(state, world) and state.has("Ghost Potion", world.player),
        "Mummy Drop": lambda state: can_reach_mummy(state, world),
        "Swampdog Drop": lambda state: can_reach_swampdog(state, world),
        "Vampire Drop": lambda state: can_reach_vampire(state, world),
        "Wolf Drop": lambda state: can_reach_wolves(state, world) and can_kill_werewolves(state, world),
    }
...
def set_entrance_rules(multiworld, world):
    loonyland_entrance_table: list[LLEntrance] = [
        ...
        LLEntrance("Menu", "Bowling", False, lambda state: state.has("Bowling Access", world.player)),
        LLEntrance("Menu", "Survival", False, lambda state: state.has("Survival Access", world.player)),
        LLEntrance("Menu", "Boss Bash", False, lambda state: state.has("Boss Bash Access", world.player)),
        LLEntrance("Menu", "Loony Ball", False, lambda state: state.has("Loony Ball Access", world.player)),
        LLEntrance("Menu", "Remix", False, lambda state: state.has("Remix Access", world.player)),
        ...
        LLEntrance("Halloween Hill", "A Tiny Cabin", True, lambda state: state.has("Skull Key", world.player)),
        ...
        LLEntrance("Dusty Crypt Entrance", "Dusty Crypt", False, lambda state: have_light_source(state, world)),
        LLEntrance("Dusty Crypt Entrance", "Halloween Hill", True),
        LLEntrance("Dusty Crypt", "Dusty Crypt Entrance", False),
        LLEntrance("Musty Crypt Entrance", "Musty Crypt", True, lambda state: have_light_source(state, world)),
        LLEntrance("Musty Crypt Entrance", "Zombiton", True),
        LLEntrance("Musty Crypt", "Musty Crypt Entrance", False),
        LLEntrance("Rusty Crypt Entrance", "Rusty Crypt", False, lambda state: have_light_source(state, world)),
        ...
        LLEntrance("Under The Lake Entrance", "Under The Lake", False, lambda state: have_light_source(state, world)),
        ...
        LLEntrance("Haunted Tower Entrance", "Haunted Tower", False, lambda state: state.has("Ghost Potion", world.player)),
        ...
        LLEntrance("Haunted Tower Stairs Up", "Haunted Tower", False, lambda state: state.has("Ghost Potion", world.player)),
        LLEntrance("Haunted Tower Stairs Down", "Haunted Tower", False, lambda state: state.has("Bat Key", world.player) and state.has("Pumpkin Key", world.player) and state.has("Skull Key", world.player) and state.has("Ghost Potion", world.player)),
        ...
        LLEntrance("A Gloomy Cavern Entrance", "A Gloomy Cavern", False, lambda state: have_light_source(state, world)),
        ...
        LLEntrance("Swampdog Lair Entrance", "Swampdog Lair", False, lambda state: state.has("Boots", world.player)),
