...
class Rules:
    ...
    def fill_rules(self):
        self.common_rules.update({
            ...
            "dowsingmachine_if_opt": (lambda state : state.has_all(["DOWSING MACHINE", "Poketch"], self.player)) if self.opts.dowsing_machine_logic.value != 0 else always_true,
            ...
            "poketch_req": (lambda state : state.has_all(["Coupon 2", "Coupon 3", "Coupon 1", "Parcel"], self.player)),
        })
        self.exit_rules = {
        ...
        self.location_rules = {
            ...
            "Oreburgh Gate B1F - Item in Pit North": (lambda state : self.common_rules["strength"](state) and self.common_rules["surf"](state)),
            "Oreburgh Gate B1F - Item in Pit South": (lambda state : self.common_rules["strength"](state) and self.common_rules["surf"](state)),
            ...
            "Mt. Coronet B1F - Item Behind West Boulder": (lambda state : self.common_rules["strength"](state) and self.common_rules["rock_smash"](state)),
            ...
            "Poketch Company - Memo Pad App": (lambda state : state.has_all(["Coupon 2", "Coupon 3", "Coupon 1", "Parcel"], self.player) and self.common_rules["badges"](1)(state)),
            "Poketch Company - Marking Map App": (lambda state : state.has_all(["Coupon 2", "Coupon 3", "Coupon 1", "Parcel"], self.player) and self.common_rules["badges"](3)(state)),
            "Poketch Company - Link Searcher App": (lambda state : state.has_all(["Coupon 2", "Coupon 3", "Coupon 1", "Parcel"], self.player) and self.common_rules["badges"](5)(state)),
            "Poketch Company - Move Tester App": (lambda state : state.has_all(["Coupon 2", "Coupon 3", "Coupon 1", "Parcel"], self.player) and self.common_rules["badges"](7)(state)),
