...
def Handle_Items(rom):
    ...
    rom.write_bytes(0x007CF0, bytearray([0xDA, 0xE2, 0x20, 0xAD, 0x5D, 0x14, 0xF0, 0x33, 0xAA, 0x4C, 0x53, 0xFF, 0xFF, 0x18, 0x6D, 0xCC])),
    rom.write_bytes(0x007D00, bytearray([0x00, 0x8D, 0x5E, 0x14, 0xC2, 0x20, 0xFA, 0x68, 0x1A, 0x1A, 0xC9, 0x0E, 0x00, 0x90, 0x06, 0x80])),
...
def Handle_Locations(rom):
    ...
    rom.write_bytes(0x05F520, bytearray([0xF0, 0x25, 0xC2, 0x20, 0xAD, 0x77, 0x14, 0xE2, 0x20, 0xF0, 0x12, 0xA9, 0x04, 0x8D, 0x00, 0x02])),
    ...
    rom.write_bytes(0x05FB58, bytearray([0x22, 0x28, 0xFD, 0x04, 0xAF, 0xAC, 0x00, 0x70])),
    ...
    rom.write_bytes(0x05FBC2, bytearray([0x05, 0x68, 0x5C, 0xAC, 0x82, 0x07, 0x68, 0x5C, 0xFB, 0x81, 0x07])),
