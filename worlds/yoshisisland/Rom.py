...
def CodeHandler(rom):
    ...
    rom.write_bytes(0x06F1B4, bytearray([0x5C, 0x22, 0xFB, 0x0B])), #Save AP data when loading the credits
...
def Handle_Locations(rom):
    ...
    rom.write_bytes(0x05FB22, bytearray([0xA0, 0x0A, 0x8C, 0x4D, 0x00, 0x48, 0xC2, 0x10, 0xDA, 0x5A, 0x8B, 0xAD, 0x0E, 0x03, 0x29, 0x0F, 0x00, 0xAA, 0xBF, 0x07, 0xFF, 0x06, 0xA8, 0xE2])),
    rom.write_bytes(0x05FB3A, bytearray([0x20, 0xA9, 0x08, 0x0C, 0xB0, 0x14, 0xA9, 0x00, 0xEB, 0xA9, 0x7F, 0xA2, 0x40, 0x14, 0x54, 0x70, 0x7E, 0xAB, 0x7A, 0xFA, 0x1A, 0xB5, 0x14, 0xC2, 0x20, 0x68, 0x5C, 0xB9, 0xF1, 0x0D]))
