...
def CodeHandler(rom):
    ...
    rom.write_bytes(0x05F911, bytearray([0x6C])) #On pause menu, read the panel score not the level score
...
def ExtendedItemHandler(rom):
    ...
    rom.write_bytes(0x10B400, bytearray([0x0C, 0xC2, 0x20, 0xA9, 0x10, 0x03, 0x8D, 0x6C, 0x14, 0x5C, 0xCF, 0xF4, 0x0B, 0xAD, 0x0F, 0x0B])),
    rom.write_bytes(0x10B410, bytearray([0xD0, 0x38, 0xEE, 0xB5, 0x14, 0xA9, 0x18, 0x8D, 0x53, 0x00, 0xAF, 0x8F, 0xFC, 0x0D, 0xF0, 0x09])),
    rom.write_bytes(0x10B420, bytearray([0xAD, 0xB5, 0x14, 0xCF, 0x8E, 0xFC, 0x0D, 0xB0, 0x04, 0x5C, 0x0A, 0xF5, 0x0B, 0xAD, 0xB6, 0x14])),
