...
def Menu_Data(rom):
    ...
    rom.write_bytes(0x115430, bytearray([0x06, 0x06, 0x08, 0x08, 0x0A])),
...
def Handle_Locations(rom):
    ...
    rom.write_bytes(0x05FC42, bytearray([0x04, 0x80, 0xE8, 0x48, 0xDA, 0xE2, 0x20, 0xAD, 0x1A, 0x02, 0xA2, 0x00, 0xDF, 0x1F, 0xD4, 0x22])),
    rom.write_bytes(0x05FC52, bytearray([0xF0, 0x03, 0xE8, 0x80, 0xF7, 0xBF, 0x8D, 0xFC, 0x0D, 0xAA, 0xBF, 0x2A, 0xD4, 0x22, 0x8D, 0xDC])),
    rom.write_bytes(0x05FC62, bytearray([0x00, 0xC2, 0x20, 0xFA, 0x68, 0x0D, 0xDC, 0x00, 0x95, 0x76, 0x5C, 0x29, 0xDB, 0x0C])),
...
def patch_rom(world, rom, player: int, multiworld):
    ...
    rom.write_bytes(0x0A8660, bytearray(world.boss_slime_data))
    rom.write_bytes(0x0A9BE1, bytearray(world.boss_boo_data))
    rom.write_bytes(0x0072BE, bytearray(world.boss_pot_data))
