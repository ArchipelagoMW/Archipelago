...
def Menu_Data(rom):
    ...
    rom.write_bytes(0x115410, bytearray([0x5A, 0x5C, 0x5E, 0x60, 0x62, 0x50, 0x52, 0x54, 0x09, 0x15, 0x21, 0x2D, 0x39, 0x45, 0x0C]))
...
def Handle_Locations(rom):
    ...
    rom.write_bytes(0x05F4C0, bytearray([0x42, 0xF0, 0x2D, 0xC9, 0x43, 0xF0, 0x3A, 0xC2, 0x20, 0xA9, 0x10, 0x03, 0x8D, 0x77, 0x14, 0xE2])),
    ...
    rom.write_bytes(0x05F520, bytearray([0xF0, 0x25, 0xC2, 0x20, 0xAD, 0x77, 0x14, 0xE2, 0x20, 0xF0, 0x12, 0xA9, 0x02, 0x8D, 0x00, 0x02])),
    rom.write_bytes(0x05F530, bytearray([0xC2, 0x20, 0xAD, 0x77, 0x14, 0x3A, 0x8D, 0x77, 0x14, 0xE2, 0x20, 0x80, 0x0A, 0xA9, 0x0F, 0x8D])),
    rom.write_bytes(0x05F540, bytearray([0x00, 0x02, 0xA9, 0x00, 0x8D, 0x6B, 0x14, 0xAD, 0x68, 0x14, 0xF0, 0x32, 0xC2, 0x20, 0xAD, 0x69])),
    rom.write_bytes(0x05F550, bytearray([0x14, 0xF0, 0x1B, 0x3A, 0x8D, 0x69, 0x14, 0xE2, 0x20, 0xA9, 0x01, 0x8F, 0xE8, 0x1F, 0x70, 0xAD])),
    ...
    rom.write_bytes(0x05F840, bytearray([0xFF, 0x00, 0xC9, 0x80, 0x00, 0xF0, 0x18, 0xC9, 0x81, 0x00, 0xF0, 0x30, 0x5C, 0xD4, 0xCF, 0x01])),
    ...
    rom.write_bytes(0x05FC42, bytearray([0x04, 0x80, 0xE8]))
...
def patch_rom(world, rom, player: int, multiworld):
    ...
    rom.write_bytes(0x010001, bytearray(world.boss_burt_data))
    rom.write_bytes(0x010001, bytearray(world.boss_slime_data))
    rom.write_bytes(0x010001, bytearray(world.boss_boo_data))
    rom.write_bytes(0x010001, bytearray(world.boss_pot_data))
    rom.write_bytes(0x010001, bytearray(world.boss_frog_data))
    rom.write_bytes(0x010001, bytearray(world.boss_plant_data))
    rom.write_bytes(0x010001, bytearray(world.boss_milde_data))
    rom.write_bytes(0x010001, bytearray(world.boss_koop_data))
    rom.write_bytes(0x010001, bytearray(world.boss_slug_data))
    rom.write_bytes(0x010001, bytearray(world.boss_raph_data))
    rom.write_bytes(0x010001, bytearray(world.boss_tap_data))
