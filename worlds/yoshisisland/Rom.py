...
def CodeHandler(rom):
    ...
    rom.write_bytes(0x0382A7, bytearray([0x5C, 0xB2, 0xFB, 0x0B])), #Make cactus eggplants check the eggplant item correctly
...
def Handle_Locations(rom):
    ...
    rom.write_bytes(0x05FB58, bytearray([0x4C, 0xCD, 0xFB, 0x04, 0xAF, 0xAC, 0x00, 0x70])),
    ...
    rom.write_bytes(0x05FBB2, bytearray([0x48, 0xC9, 0x06, 0x00, 0xB0, 0x10, 0xE2, 0x20, 0xAD, 0x54, 0x14, 0xC9, 0x00, 0xC2, 0x20, 0xF0])),
    rom.write_bytes(0x05FBC2, bytearray([0x05, 0x68, 0x5C, 0xAC, 0x82, 0x07, 0x68, 0x5C, 0xFB, 0x81, 0x07, 0xAD, 0x6A, 0x02, 0xF0, 0x11])),
    rom.write_bytes(0x05FBD2, bytearray([0xC2, 0x20, 0xA9, 0x0E, 0x00, 0x22, 0xE2, 0xF6, 0x04, 0xA9, 0x00, 0x00, 0x8D, 0x6A, 0x02, 0xE2])),
    rom.write_bytes(0x05FBE2, bytearray([0x20, 0x22, 0x28, 0xFD, 0x04, 0x4C, 0x5C, 0xFB]))
