...
def Handle_Locations(rom):
    ...
    rom.write_bytes(0x05FB22, bytearray([0xA0, 0x0A, 0x8C, 0x4D, 0x00, 0xE2, 0x20, 0xA9, 0x08, 0x0C, 0xB1, 0x14, 0xC2, 0x20, 0x5C, 0xB9, 0xF1, 0x0D, 0xBF, 0x07, 0xFF, 0x06, 0xA8, 0xE2])),
    ...
    rom.write_bytes(0x05FDE2, bytearray([0x00, 0xAF, 0x8E, 0xFC, 0x0D, 0x80, 0x25, 0xE2, 0x20, 0xAD, 0xB5, 0x14, 0xC9, 0x64, 0xC2, 0x20])),
    ...
    rom.write_bytes(0x05FE42, bytearray([0xE0, 0x10, 0xD0, 0x06, 0xAE, 0x6C, 0x02, 0x8E, 0x1A, 0x02, 0xC2, 0x20, 0xE2, 0x10, 0x5C, 0xBC])),
...
def ExtendedItemHandler(rom):
    ...
    rom.write_bytes(0x10B400, bytearray([0x0C, 0xC2, 0x20, 0xA9, 0x10, 0x03, 0x8D, 0x6C, 0x14, 0x5C, 0xCF, 0xF4, 0x0B, 0xEE, 0xB5, 0x14])),
    rom.write_bytes(0x10B410, bytearray([0xA9, 0x18, 0x8D, 0x53, 0x00, 0xAF, 0x8F, 0xFC, 0x0D, 0xF0, 0x09, 0xAD, 0xB5, 0x14, 0xCF, 0x8E])),
    rom.write_bytes(0x10B420, bytearray([0xFC, 0x0D, 0xB0, 0x04, 0x5C, 0x0C, 0xF5, 0x0B, 0xAD, 0xB6, 0x14, 0xD0, 0xF7, 0xA9, 0x01, 0x8D])),
    rom.write_bytes(0x10B430, bytearray([0xB6, 0x14, 0xEA, 0xEA, 0xEA, 0xEA, 0xEA, 0xA9, 0x16, 0x8D, 0x18, 0x01, 0xA9, 0x97, 0x8D, 0x53])),
