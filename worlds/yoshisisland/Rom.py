...
def CodeHandler(rom):
    ...
    rom.write_bytes(0x08636F, bytearray([0x5C, 0x22, 0xFB, 0x0B])), #Save AP data when loading the credits
    ...
    #rom.write_bytes(0x0802A1, bytearray([0x5C, 0x8B, 0xFD, 0x0B])) #Return to the original list when exiting a level

    rom.write_bytes(0x00C14B, bytearray([0xAE, 0x6C, 0x02, 0x8E, 0x1A, 0x02])) #Return to the original list when exiting a level

    rom.write_bytes(0x00B2B8, bytearray([0x5C, 0x3F, 0xFE, 0x0B])) #Save the original level when beating a shuffled one.

    rom.write_bytes(0x00E702, bytearray([0xAD, 0x6C, 0x02, 0x8D, 0x1A, 0x02, 0x80, 0x05])) #Save the original level when leaving through death

    rom.write_bytes(0x0BE72A, bytearray([0x6C])) #Load yoshi colors by slot number not level number
...
def Handle_Locations(rom):
    ...
    rom.write_bytes(0x05F4D0, bytearray([0x20, 0xA9, 0x01, 0x8D, 0x6B, 0x14, 0xA9, 0x2E, 0x8D, 0x53, 0x00, 0x80, 0x2F, 0xA9, 0x01, 0x8D])),
    ...
    rom.write_bytes(0x05F510, bytearray([0x67, 0x14, 0xA9, 0x10, 0x8D, 0x83, 0x0B, 0x5C, 0xDE, 0xC0, 0x01, 0xE2, 0x20, 0xAD, 0x6B, 0x14])),
    rom.write_bytes(0x05F520, bytearray([0xF0, 0x25, 0xC2, 0x20, 0xAD, 0x6C, 0x14, 0xE2, 0x20, 0xF0, 0x12, 0xA9, 0x02, 0x8D, 0x00, 0x02])),
    rom.write_bytes(0x05F530, bytearray([0xC2, 0x20, 0xAD, 0x6C, 0x14, 0x3A, 0x8D, 0x6C, 0x14, 0xE2, 0x20, 0x80, 0x0A, 0xA9, 0x0F, 0x8D])),
    rom.write_bytes(0x05F540, bytearray([0x00, 0x02, 0xA9, 0x00, 0x8D, 0x6B, 0x14, 0xAD, 0x68, 0x14, 0xF0, 0x32, 0xC2, 0x20, 0xAD, 0x69])),
    ...
    rom.write_bytes(0x05F910, bytearray([0xAF, 0x1A, 0x02, 0x00, 0x5C, 0x7B, 0xD2, 0x01, 0xA5, 0x38, 0x89, 0x20, 0xD0, 0x0A, 0x29, 0x10])),
    ...
    rom.write_bytes(0x05FB22, bytearray([0x9C, 0xAA, 0x71, 0xEE, 0x18, 0x01, 0x48, 0xC2, 0x10, 0xDA, 0x5A, 0x8B, 0xAD, 0x0E, 0x03, 0x29, 0x0F, 0x00, 0xAA, 0xBF, 0x07, 0xFF, 0x06, 0xA8, 0xE2])),
    rom.write_bytes(0x05FB3B, bytearray([0x20, 0xA9, 0x08, 0x0C, 0xB0, 0x14, 0xA9, 0x00, 0xEB, 0xA9, 0x7F, 0xA2, 0x40, 0x14, 0x54, 0x70, 0x7E, 0xAB, 0x7A, 0xFA, 0xE2, 0x10, 0xC2, 0x20, 0x68, 0x5C, 0x75, 0xE3, 0x10]))
    ...
    rom.write_bytes(0x05FD52, bytearray([0x70, 0x4C, 0x5F, 0xF5, 0xDA, 0xAD, 0x1A, 0x02, 0x8D, 0x6C, 0x02, 0xAD, 0x12, 0x11, 0xC9, 0x08])),
    ...
    rom.write_bytes(0x05FD82, bytearray([0xA9, 0x02, 0x8D, 0x13, 0x11, 0x5C, 0x70, 0xE0, 0x17, 0xAC, 0x6C, 0x02, 0x8C, 0x1A, 0x02, 0xB9])),
    rom.write_bytes(0x05FD92, bytearray([0x22, 0x02, 0x5C, 0xA7, 0x82, 0x10, 0xAD, 0x6C, 0x02, 0x8D, 0x1A, 0x02, 0xC2, 0x20, 0xE2, 0x10])),
    rom.write_bytes(0x05FDA2, bytearray([0x5C, 0xBC, 0xB2, 0x01, 0xC9, 0x45, 0xB0, 0x03, 0x8D, 0x6C, 0x02, 0x8D, 0x1A, 0x02, 0x29, 0x07])),
    ...
    rom.write_bytes(0x05FDD2, bytearray([0xAF, 0x8E, 0xFC, 0x0D, 0x80, 0x16, 0xDA, 0xE2, 0x20, 0xAD, 0xE3, 0x00, 0xD0, 0x4E, 0x9C, 0xE1])),
    rom.write_bytes(0x05FDE2, bytearray([0x00, 0xAF, 0x8E, 0xFC, 0x0D, 0x80, 0x25, 0xE2, 0x20, 0xAD, 0xB4, 0x14, 0xC9, 0x64, 0xC2, 0x20])),
    rom.write_bytes(0x05FDF2, bytearray([0xB0, 0x06, 0xA9, 0x4E, 0x00, 0x4C, 0x4C, 0xF8, 0xA9, 0x52, 0x00, 0x4C, 0x4C, 0xF8, 0xDA, 0xE2])),
    rom.write_bytes(0x05FE02, bytearray([0x20, 0xAD, 0xE3, 0x00, 0xD0, 0x26, 0x9C, 0xE1, 0x00, 0xAD, 0xB4, 0x14, 0xC9, 0x0A, 0x90, 0x08])),
    ...
    rom.write_bytes(0x05FE32, bytearray([0xE2, 0x00, 0xAA, 0xBF, 0x0B, 0xD4, 0x22, 0xC2, 0x20, 0xFA, 0x4C, 0x4C, 0xF8, 0xAE, 0x18, 0x01])),
    rom.write_bytes(0x05FE42, bytearray([0xE0, 0x10, 0xD0, 0x06, 0xAE, 0x6B, 0x02, 0x8E, 0x1A, 0x02, 0xC2, 0x20, 0xE2, 0x10, 0x5C, 0xBC])),
    rom.write_bytes(0x05FE52, bytearray([0xB2, 0x01, 0xE2, 0x20, 0xAD, 0x1A, 0x02, 0xc9, 0x3C, 0xC2, 0x20, 0xB0, 0x04, 0xA9, 0x02, 0x00])),
    rom.write_bytes(0x05FE62, bytearray([0x6B, 0xA9, 0x00, 0x00, 0x6B]))


def ExtendedItemHandler(rom):
    rom.write_bytes(0x10B3FB, bytearray([0xE2, 0x20, 0xC9, 0x45, 0xB0])),
    rom.write_bytes(0x10B400, bytearray([0x0C, 0xC2, 0x20, 0xA9, 0x10, 0x03, 0x8D, 0x6C, 0x14, 0x5C, 0xCF, 0xF4, 0x0B, 0xEE, 0xB4, 0x14])),
    rom.write_bytes(0x10B410, bytearray([0xA9, 0x18, 0x8D, 0x53, 0x00, 0xAF, 0x8F, 0xFC, 0x0D, 0xF0, 0x09, 0xAD, 0xB4, 0x14, 0xCF, 0x8E])),
    rom.write_bytes(0x10B420, bytearray([0xFC, 0x0D, 0xB0, 0x04, 0x5C, 0x0C, 0xF5, 0x0B, 0xAD, 0xB5, 0x14, 0xD0, 0xF7, 0xA9, 0x01, 0x8D])),
    rom.write_bytes(0x10B430, bytearray([0xB5, 0x14, 0xA9, 0x0A, 0x8D, 0x18, 0x02, 0xA9, 0x16, 0x8D, 0x18, 0x01, 0xA9, 0x97, 0x8D, 0x53])),
    rom.write_bytes(0x10B440, bytearray([0x00, 0x5C, 0x0C, 0xF5, 0x0B]))
...
def patch_rom(world, rom, player: int, multiworld):
    ...
    rom.write_bytes(0x06FC88, ([multiworld.shuffle_midrings[player].value]))
    rom.write_bytes(0x06FC85, ([multiworld.castle_open_condition[player].value]))
    rom.write_bytes(0x06FC86, ([multiworld.castle_clear_condition[player].value]))
    rom.write_bytes(0x06FC87, ([multiworld.disable_autoscroll[player].value]))
    rom.write_bytes(0x06FC8B, ([multiworld.minigame_checks[player].value]))
    rom.write_byte(0x06FC8C, multiworld.death_link[player].value)
    rom.write_bytes(0x06FC8D, bytearray(world.boss_room_id))
    rom.write_bytes(0x06FC8E, bytearray([multiworld.luigi_pieces_required[player].value]))
    rom.write_bytes(0x06FC8F, bytearray([multiworld.goal[player].value]))
    ...
    rom.write_bytes(0x045A2E, bytearray(world._11StageGFX))
    rom.write_bytes(0x045A31, bytearray(world._12StageGFX))
    rom.write_bytes(0x045A34, bytearray(world._13StageGFX))
    rom.write_bytes(0x045A37, bytearray(world._14StageGFX))
    rom.write_bytes(0x045A3A, bytearray(world._15StageGFX))
    rom.write_bytes(0x045A3D, bytearray(world._16StageGFX))
    rom.write_bytes(0x045A40, bytearray(world._17StageGFX))
    rom.write_bytes(0x045A43, bytearray(world._18StageGFX))

    rom.write_bytes(0x045A52, bytearray(world._21StageGFX))
    rom.write_bytes(0x045A55, bytearray(world._22StageGFX))
    rom.write_bytes(0x045A58, bytearray(world._23StageGFX))
    rom.write_bytes(0x045A5B, bytearray(world._24StageGFX))
    rom.write_bytes(0x045A5E, bytearray(world._25StageGFX))
    rom.write_bytes(0x045A61, bytearray(world._26StageGFX))
    rom.write_bytes(0x045A64, bytearray(world._27StageGFX))
    rom.write_bytes(0x045A67, bytearray(world._28StageGFX))

    rom.write_bytes(0x045A76, bytearray(world._31StageGFX))
    rom.write_bytes(0x045A79, bytearray(world._32StageGFX))
    rom.write_bytes(0x045A7C, bytearray(world._33StageGFX))
    rom.write_bytes(0x045A7F, bytearray(world._34StageGFX))
    rom.write_bytes(0x045A82, bytearray(world._35StageGFX))
    rom.write_bytes(0x045A85, bytearray(world._36StageGFX))
    rom.write_bytes(0x045A88, bytearray(world._37StageGFX))
    rom.write_bytes(0x045A8B, bytearray(world._38StageGFX))

    rom.write_bytes(0x045A9A, bytearray(world._41StageGFX))
    rom.write_bytes(0x045A9D, bytearray(world._42StageGFX))
    rom.write_bytes(0x045AA0, bytearray(world._43StageGFX))
    rom.write_bytes(0x045AA3, bytearray(world._44StageGFX))
    rom.write_bytes(0x045AA6, bytearray(world._45StageGFX))
    rom.write_bytes(0x045AA9, bytearray(world._46StageGFX))
    rom.write_bytes(0x045AAC, bytearray(world._47StageGFX))
    rom.write_bytes(0x045AAF, bytearray(world._48StageGFX))

    rom.write_bytes(0x045ABE, bytearray(world._51StageGFX))
    rom.write_bytes(0x045AC1, bytearray(world._52StageGFX))
    rom.write_bytes(0x045AC4, bytearray(world._53StageGFX))
    rom.write_bytes(0x045AC7, bytearray(world._54StageGFX))
    rom.write_bytes(0x045ACA, bytearray(world._55StageGFX))
    rom.write_bytes(0x045ACD, bytearray(world._56StageGFX))
    rom.write_bytes(0x045AD0, bytearray(world._57StageGFX))
    rom.write_bytes(0x045AD3, bytearray(world._58StageGFX))

    rom.write_bytes(0x045AE2, bytearray(world._61StageGFX))
    rom.write_bytes(0x045AE5, bytearray(world._62StageGFX))
    rom.write_bytes(0x045AE8, bytearray(world._63StageGFX))
    rom.write_bytes(0x045AEB, bytearray(world._64StageGFX))
    rom.write_bytes(0x045AEE, bytearray(world._65StageGFX))
    rom.write_bytes(0x045AF1, bytearray(world._66StageGFX))
    rom.write_bytes(0x045AF4, bytearray(world._67StageGFX))

    rom.write_bytes(0x0BDBAF, bytearray(world.level_gfx_table))
    rom.write_bytes(0x0BDC4F, bytearray(world.palette_panel_list))


    if get_option_value(world, player, "yoshi_colors") == 1:
    ...
    elif get_option_value(multiworld, player, "yoshi_colors") == 2 or get_option_value(multiworld, player, "yoshi_colors") == 3:
        rom.write_bytes(0x010000, bytearray(world.level_colors))

    if get_option_value(multiworld, player, "minigame_checks") == 2 or get_option_value(multiworld, player, "minigame_checks") == 3:
        bonus_checks(rom)

    if get_option_value(multiworld, player, "minigame_checks") == 1 or get_option_value(multiworld, player, "minigame_checks") == 3:
        bandit_checks(rom)

    rom.write_bytes(0x00BF2C, bytearray(world.world_bonus))

    if get_option_value(multiworld, player, "softlock_prevention") == 1:
    ...
    if get_option_value(multiworld, player, "bowser_door_mode") == 5:
...
def get_base_rom_path(file_name: str = "") -> str:
    if not file_name:
        file_name = "Super Mario World 2 - Yoshi's Island (U).sfc"
