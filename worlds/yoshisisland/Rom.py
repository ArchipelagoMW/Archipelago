...
def Handle_Locations(rom):
    ...
    rom.write_bytes(0x05F520, bytearray([0xF0, 0x25, 0xC2, 0x20, 0xAD, 0x6B, 0x14, 0xE2, 0x20, 0xF0, 0x12, 0xA9, 0x02, 0x8D, 0x00, 0x02])),
    rom.write_bytes(0x05F530, bytearray([0xC2, 0x20, 0xAD, 0x6B, 0x14, 0x3A, 0x8D, 0x6B, 0x14, 0xE2, 0x20, 0x80, 0x0A, 0xA9, 0x0F, 0x8D])),
...
def ExtendedItemHandler(rom):
    ...
    rom.write_bytes(0x10B400, bytearray([0x0C, 0xC2, 0x20, 0xA9, 0x10, 0x03, 0x8D, 0x6B, 0x14, 0x5C, 0xCF, 0xF4, 0x0B, 0xAD, 0x0F, 0x0B])),
