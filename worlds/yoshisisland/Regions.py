...
def create_regions(multiworld: MultiWorld, player: int, locations: Tuple[LocationData, ...], location_cache: List[Location], gamevar, boss_order: list, level_location_list: list, luigi_pieces: int):
    ...
    regions = [
        ...
        create_region(multiworld, player, locations_per_region, location_cache, 'Make Eggs, Throw Eggs'),
        create_region(multiworld, player, locations_per_region, location_cache, 'Watch Out Below!'),
        create_region(multiworld, player, locations_per_region, location_cache, 'The Cave Of Chomp Rock'),
        create_region(multiworld, player, locations_per_region, location_cache, "Burt The Bashful's Fort"),
        create_region(multiworld, player, locations_per_region, location_cache, "Burt The Bashful's Boss Room"),
        create_region(multiworld, player, locations_per_region, location_cache, 'Hop! Hop! Donut Lifts'),
        create_region(multiworld, player, locations_per_region, location_cache, 'Shy-Guys On Stilts'),
        create_region(multiworld, player, locations_per_region, location_cache, 'Touch Fuzzy Get Dizzy'),
        create_region(multiworld, player, locations_per_region, location_cache, "Salvo The Slime's Castle"),
        create_region(multiworld, player, locations_per_region, location_cache, "Salvo The Slime's Boss Room"),

        create_region(multiworld, player, locations_per_region, location_cache, "Visit Koopa And Para-Koopa"),
        create_region(multiworld, player, locations_per_region, location_cache, "The Baseball Boys"),
        create_region(multiworld, player, locations_per_region, location_cache, "What's Gusty Taste Like?"),
        create_region(multiworld, player, locations_per_region, location_cache, "Bigger Boo's Fort"),
        create_region(multiworld, player, locations_per_region, location_cache, "Bigger Boo's Boss Room"),
        create_region(multiworld, player, locations_per_region, location_cache, "Watch Out For Lakitu"),
        create_region(multiworld, player, locations_per_region, location_cache, "The Cave Of The Mystery Maze"),
        create_region(multiworld, player, locations_per_region, location_cache, "Lakitu's Wall"),
        create_region(multiworld, player, locations_per_region, location_cache, "The Potted Ghost's Castle"),
        create_region(multiworld, player, locations_per_region, location_cache, "Roger The Ghost's Boss Room"),

        create_region(multiworld, player, locations_per_region, location_cache, "Welcome To Monkey World!"),
        create_region(multiworld, player, locations_per_region, location_cache, "Jungle Rhythm..."),
        create_region(multiworld, player, locations_per_region, location_cache, "Nep-Enuts' Domain"),
        create_region(multiworld, player, locations_per_region, location_cache, "Prince Froggy's Fort"),
        create_region(multiworld, player, locations_per_region, location_cache, "Prince Froggy's Boss Room"),
        create_region(multiworld, player, locations_per_region, location_cache, "Jammin' Through The Trees"),
        create_region(multiworld, player, locations_per_region, location_cache, "The Cave Of Harry Hedgehog"),
        create_region(multiworld, player, locations_per_region, location_cache, "Monkeys' Favorite Lake"),
        create_region(multiworld, player, locations_per_region, location_cache, "Naval Piranha's Castle"),
        create_region(multiworld, player, locations_per_region, location_cache, "Naval Piranha's Boss Room"),

        create_region(multiworld, player, locations_per_region, location_cache, "GO! GO! MARIO!!"),
        create_region(multiworld, player, locations_per_region, location_cache, "The Cave Of The Lakitus"),
        create_region(multiworld, player, locations_per_region, location_cache, "Don't Look Back!"),
        create_region(multiworld, player, locations_per_region, location_cache, "Marching Milde's Fort"),
        create_region(multiworld, player, locations_per_region, location_cache, "Marching Milde's Boss Room"),
        create_region(multiworld, player, locations_per_region, location_cache, "Chomp Rock Zone"),
        create_region(multiworld, player, locations_per_region, location_cache, "Lake Shore Paradise"),
        create_region(multiworld, player, locations_per_region, location_cache, "Ride Like The Wind"),
        create_region(multiworld, player, locations_per_region, location_cache, "Hookbill The Koopa's Castle"),
        create_region(multiworld, player, locations_per_region, location_cache, "Hookbill The Koopa's Boss Room"),

        create_region(multiworld, player, locations_per_region, location_cache, "BLIZZARD!!!"),
        create_region(multiworld, player, locations_per_region, location_cache, "Ride The Ski Lifts"),
        create_region(multiworld, player, locations_per_region, location_cache, "Danger - Icy Conditions Ahead"),
        create_region(multiworld, player, locations_per_region, location_cache, "Sluggy The Unshaven's Fort"),
        create_region(multiworld, player, locations_per_region, location_cache, "Sluggy The Unshaven's Boss Room"),
        create_region(multiworld, player, locations_per_region, location_cache, "Goonie Rides!"),
        create_region(multiworld, player, locations_per_region, location_cache, "Welcome To Cloud World"),
        create_region(multiworld, player, locations_per_region, location_cache, "Shifting Platforms Ahead"),
        create_region(multiworld, player, locations_per_region, location_cache, "Raphael The Raven's Castle"),
        create_region(multiworld, player, locations_per_region, location_cache, "Raphael The Raven's Boss Room"),

        create_region(multiworld, player, locations_per_region, location_cache, "Scary Skeleton Goonies!"),
        create_region(multiworld, player, locations_per_region, location_cache, "The Cave Of The Bandits"),
        create_region(multiworld, player, locations_per_region, location_cache, "Beware The Spinning Logs"),
        create_region(multiworld, player, locations_per_region, location_cache, "Tap-Tap The Red Nose's Fort"),
        create_region(multiworld, player, locations_per_region, location_cache, "Tap-Tap The Red Nose's Boss Room"),
        create_region(multiworld, player, locations_per_region, location_cache, "The Very Loooooong Cave"),
        create_region(multiworld, player, locations_per_region, location_cache, "The Deep, Underground Maze"),
        create_region(multiworld, player, locations_per_region, location_cache, "KEEP MOVING!!!!"),
        create_region(multiworld, player, locations_per_region, location_cache, "King Bowser's Castle"),
    ...
    if get_option_value(multiworld, player, "extras_enabled") == 1:
        regions.insert(72, create_region(multiworld, player, locations_per_region, location_cache, "Castles - Masterpiece Set")),
        regions.insert(62, create_region(multiworld, player, locations_per_region, location_cache, "Kamek's Revenge")),
        regions.insert(51, create_region(multiworld, player, locations_per_region, location_cache, "The Impossible? Maze")),
        regions.insert(40, create_region(multiworld, player, locations_per_region, location_cache, "More Monkey Madness")),
        regions.insert(30, create_region(multiworld, player, locations_per_region, location_cache, "Hit That Switch!!")),
    ...
    if get_option_value(multiworld, player, "minigame_checks") >= 2:
        ...
        regions.insert(60, create_region(multiworld, player, locations_per_region, location_cache, "Roulette")),
        regions.insert(51, create_region(multiworld, player, locations_per_region, location_cache, "Match Cards")),
        regions.insert(40, create_region(multiworld, player, locations_per_region, location_cache, "Drawing Lots")),
        regions.insert(30, create_region(multiworld, player, locations_per_region, location_cache, "Scratch And Match")),
        regions.insert(18, create_region(multiworld, player, locations_per_region, location_cache, "Flip Cards"))
    ...
    connect(multiworld, player, names, "Burt The Bashful's Fort", gamevar.boss_order[0], lambda state: logic._14Clear(state)),
    connect(multiworld, player, names, "Salvo The Slime's Castle", gamevar.boss_order[1], lambda state: logic._18Clear(state)),
    ...
    connect(multiworld, player, names, "Bigger Boo's Fort", gamevar.boss_order[2], lambda state: logic._24Clear(state)),
    connect(multiworld, player, names, "The Potted Ghost's Castle", gamevar.boss_order[3], lambda state: logic._28Clear(state)),
    ...
    connect(multiworld, player, names, "Prince Froggy's Fort", gamevar.boss_order[4], lambda state: logic._34Clear(state)),
    connect(multiworld, player, names, "Naval Piranha's Castle", gamevar.boss_order[5], lambda state: logic._38Clear(state)),
    ...
    connect(multiworld, player, names, "Marching Milde's Fort", gamevar.boss_order[6], lambda state: logic._44Clear(state)),
    connect(multiworld, player, names, "Hookbill The Koopa's Castle", gamevar.boss_order[7], lambda state: logic._48Clear(state)),
    ...
    connect(multiworld, player, names, "Sluggy The Unshaven's Fort", gamevar.boss_order[8], lambda state: logic._54Clear(state)),
    connect(multiworld, player, names, "Raphael The Raven's Castle", gamevar.boss_order[9], lambda state: logic._58Clear(state)),
    ...
    connect(multiworld, player, names, 'World 6', "King Bowser's Castle", lambda state: bosses.castle_access(state)),
    connect(multiworld, player, names, "King Bowser's Castle", "Bowser's Room", lambda state: bosses.castle_clear(state)),
    connect(multiworld, player, names, "Tap-Tap The Red Nose's Fort", gamevar.boss_order[10], lambda state: logic._64Clear(state))
