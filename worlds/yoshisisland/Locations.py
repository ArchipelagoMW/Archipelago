...
def get_locations(world: Optional[MultiWorld], player: Optional[int], boss_order: Optional[list]) -> Tuple[LocationData, ...]:
    ...
    LocationData("Burt The Bashful's Fort", "Burt The Bashful's Fort: Level Clear", 0x30502F, lambda state: logic._14CanFightBoss(state)),
    ...
    LocationData("Touch Fuzzy Get Dizzy", 'Touch Fuzzy Get Dizzy: Gather Coins', EventId, lambda state: logic._17Game(state)),
    ...
    LocationData("Salvo The Slime's Castle", "Salvo The Slime's Castle: Level Clear", 0x305040, lambda state: logic._18CanFightBoss(state)),
    ...
    LocationData("Bigger Boo's Fort", "Bigger Boo's Fort: Level Clear", 0x305050, lambda state: logic._24CanFightBoss(state)),
    ...
    LocationData("Lakitu's Wall", "Lakitu's Wall: Gather Coins", EventId, lambda state: logic._27Game(state)),
    ...
    LocationData("The Potted Ghost's Castle", "The Potted Ghost's Castle: Level Clear", 0x305060, lambda state: logic._28CanFightBoss(state)),
    ...
    LocationData("Prince Froggy's Fort", "Prince Froggy's Fort: Level Clear", 0x305070, lambda state: logic._34CanFightBoss(state)),
    ...
    LocationData("Naval Piranha's Castle", "Naval Piranha's Castle: Level Clear", 0x305080, lambda state: logic._38CanFightBoss(state)),
    ...
    LocationData("Marching Milde's Fort", "Marching Milde's Fort: Level Clear", 0x305090, lambda state: logic._44CanFightBoss(state)),
    ...
    LocationData("Ride Like The Wind", 'Ride Like The Wind: Gather Coins', EventId, lambda state: logic._47Game(state)),
    ...
    LocationData("Hookbill The Koopa's Castle", "Hookbill The Koopa's Castle: Level Clear", 0x3050A0, lambda state: logic._48CanFightBoss(state)),
    ...
    LocationData("Sluggy The Unshaven's Fort", "Sluggy The Unshaven's Fort: Level Clear", 0x3050B0, lambda state: logic._54CanFightBoss(state)),
    ...
    LocationData("Raphael The Raven's Castle", "Raphael The Raven's Castle: Level Clear", 0x3050C0, lambda state: logic._58CanFightBoss(state)),
    ...
    LocationData("Tap-Tap The Red Nose's Fort", "Tap-Tap The Red Nose's Fort: Level Clear", 0x3050D0, lambda state: logic._64CanFightBoss(state)),
