...
def get_locations(world: Optional[MultiWorld], player: Optional[int]) -> Tuple[LocationData, ...]:
    ...
    LocationData("Burt The Bashful's Fort", "Burt The Bashful's Fort: Level Clear", 0x30502F, lambda state: logic._14Clear(state)),
    LocationData("Burt The Bashful's Fort", 'Burt The Bashful Defeated', 0x305030, lambda state: logic._14Clear(state)),
    ...
    LocationData("Salvo The Slime's Castle", "Salvo The Slime's Castle: Level Clear", 0x305040, lambda state: logic._18Clear(state)),
    LocationData("Salvo The Slime's Castle", 'Salvo The Slime Defeated', 0x30510C, lambda state: logic._18Clear(state)),
    ############################################################################################
    ...
    LocationData("Bigger Boo's Fort", "Bigger Boo's Fort: Level Clear", 0x305050, lambda state: logic._24Clear(state)),
    LocationData("Bigger Boo's Fort", 'Bigger Boo Defeated', 0x30510D, lambda state: logic._24Clear(state)),
    ...
    LocationData("The Potted Ghost's Castle", "The Potted Ghost's Castle: Level Clear", 0x305060, lambda state: logic._28Clear(state)),
    LocationData("The Potted Ghost's Castle", 'Roger The Ghost Defeated', 0x30510E, lambda state: logic._28Clear(state)),
    ###############################################################################################
    ...
    LocationData("Prince Froggy's Fort", "Prince Froggy's Fort: Level Clear", 0x305070, lambda state: logic._34Clear(state)),
    LocationData("Prince Froggy's Fort", 'Prince Froggy Defeated', 0x30510F, lambda state: logic._34Clear(state)),
    ...
    LocationData("Naval Piranha's Castle", "Naval Piranha's Castle: Level Clear", 0x305080, lambda state: logic._38Clear(state)),
    LocationData("Naval Piranha's Castle", 'Naval Piranha Defeated', 0x305110, lambda state: logic._38Clear(state)),
    ##############################################################################################
    ...
    LocationData("Marching Milde's Fort", "Marching Milde's Fort: Level Clear", 0x305090, lambda state: logic._44Clear(state)),
    LocationData("Marching Milde's Fort", 'Marching Milde Defeated', 0x305111, lambda state: logic._44Clear(state)),
    ...
    LocationData("Hookbill The Koopa's Castle", "Hookbill The Koopa's Castle: Level Clear", 0x3050A0, lambda state: logic._48Clear(state)),
    LocationData("Hookbill The Koopa's Castle", 'Hookbill The Koopa Defeated', 0x305112, lambda state: logic._48Clear(state)),
    ######################################################################################################
    ...
    LocationData("Sluggy The Unshaven's Fort", "Sluggy The Unshaven's Fort: Level Clear", 0x3050B0, lambda state: logic._54Clear(state)),
    LocationData("Sluggy The Unshaven's Fort", 'Sluggy The Unshaven Defeated', 0x305113, lambda state: logic._54Clear(state)),
    ...
    LocationData("Raphael The Raven's Castle", "Raphael The Raven's Castle: Level Clear", 0x3050C0, lambda state: logic._58Clear(state)),
    LocationData("Raphael The Raven's Castle", 'Raphael The Raven Defeated', 0x305114, lambda state: logic._58Clear(state)),
    ######################################################################################################
    ...
    LocationData("Tap-Tap The Red Nose's Fort", "Tap-Tap The Red Nose's Fort: Level Clear", 0x3050D0, lambda state: logic._64Clear(state)),
    LocationData("Tap-Tap The Red Nose's Fort", 'Tap-Tap The Red Nose Defeated', 0x305115, lambda state: logic._64Clear(state)),
