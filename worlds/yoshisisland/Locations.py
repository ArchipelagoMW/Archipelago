...
def get_locations(multiworld: Optional[MultiWorld], player: Optional[int], boss_order: Optional[list], luigi_pieces: Optional[int]) -> Tuple[LocationData, ...]:
    ...
    if not multiworld or get_option_value(multiworld, player, "extras_enabled") == 1:
        location_table += ( 
            ...
            LocationData("2-Extra", "Hit That Switch!!: Red Coins", 0x3050E4, lambda state: logic._2ECoins(state)),
            LocationData("2-Extra", "Hit That Switch!!: Flowers", 0x3050E5, lambda state: logic._2EFlowers(state)),
            LocationData("2-Extra", "Hit That Switch!!: Stars", 0x3050E6, lambda state: logic._2EStars(state)),
            LocationData("2-Extra", "Hit That Switch!!: Level Clear", 0x3050E7, lambda state: logic._2EClear(state)),

            LocationData("3-Extra", "More Monkey Madness: Red Coins", 0x3050E8, lambda state: logic._3ECoins(state)),
            LocationData("3-Extra", "More Monkey Madness: Flowers", 0x3050E9, lambda state: logic._3EFlowers(state)),
            LocationData("3-Extra", "More Monkey Madness: Stars", 0x3050EA, lambda state: logic._3EStars(state)),
            LocationData("3-Extra", "More Monkey Madness: Level Clear", 0x3050EB, lambda state: logic._3EClear(state)),

            LocationData("4-Extra", "The Impossible? Maze: Red Coins", 0x3050EC, lambda state: logic._4ECoins(state)),
            LocationData("4-Extra", "The Impossible? Maze: Flowers", 0x3050ED, lambda state: logic._4EFlowers(state)),
            LocationData("4-Extra", "The Impossible? Maze: Stars", 0x3050EE, lambda state: logic._4EStars(state)),
            LocationData("4-Extra", "The Impossible? Maze: Level Clear", 0x3050EF, lambda state: logic._4EClear(state)),

            LocationData("5-Extra", "Kamek's Revenge: Red Coins", 0x3050F0, lambda state: logic._5ECoins(state)),
            LocationData("5-Extra", "Kamek's Revenge: Flowers", 0x3050F1, lambda state: logic._5EFlowers(state)),
            LocationData("5-Extra", "Kamek's Revenge: Stars", 0x3050F2, lambda state: logic._5EStars(state)),
            LocationData("5-Extra", "Kamek's Revenge: Level Clear", 0x3050F3, lambda state: logic._5EClear(state)),

            LocationData("6-Extra", "Castles - Masterpiece Set: Red Coins", 0x3050F4, lambda state: logic._6ECoins(state)),
            LocationData("6-Extra", "Castles - Masterpiece Set: Flowers", 0x3050F5, lambda state: logic._6EFlowers(state)),
            LocationData("6-Extra", "Castles - Masterpiece Set: Stars", 0x3050F6, lambda state: logic._6EStars(state)),
            LocationData("6-Extra", "Castles - Masterpiece Set: Level Clear", 0x3050F7, lambda state: logic._6EClear(state)),
        )
