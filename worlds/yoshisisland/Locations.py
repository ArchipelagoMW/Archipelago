...
def get_locations(multiworld: Optional[MultiWorld], player: Optional[int], boss_order: Optional[list], luigi_pieces: Optional[int]) -> Tuple[LocationData, ...]:
    ...
    LocationData("1-7", 'Touch Fuzzy Get Dizzy: Gather Coins', EventId, lambda state: logic._17Game(state)),
    ...
    LocationData("2-6", 'Seed Spitting Contest', EventId, lambda state: logic._26Game(state)),
    ...
    LocationData("2-7", "Lakitu's Wall: Gather Coins", EventId, lambda state: logic._27Game(state)),
    ...
    LocationData("4-7", 'Ride Like The Wind: Gather Coins', EventId, lambda state: logic._47Game(state)),
