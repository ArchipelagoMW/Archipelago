if __name__ == "__main__":
    ...
    print("}")
    print("")
    print("region_names: set[str] = {cxn.source_name for _, cxn in all_region_connections.items()}")
    print("region_names.update([loc.region_name for _, loc in all_locations.items()])")
    ...
    print("}")
    print("")
    print("room_names: set[str] = {region.room_name for _, region in all_regions.items()}")
    print("room_names.update([door.room_name for _, door in all_doors.items()])")
    ...
    print("}")
    print("")
    print("levels: set[str] = {room.level_name for _, room in all_rooms.items()}")
    print("levels.update([connection.level_name for _, connection in all_room_connections.items()])")
    ...
    print("")
    print("for _, connection in all_room_connections.items():")
    print("    room_cons_by_level[connection.level_name].append(connection)")
    print("")
