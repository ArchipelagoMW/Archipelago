...
opponets = [
    ...
    OpponentData(48, "Magician of Faith", [], 1, 1, 4434, 13022, "deck/theme_022.ydc\x00\x00\x00\x00"),
    OpponentData(49, "Mask of Darkness", [], 1, 1, 4108, 13023, "deck/theme_023.ydc\x00\x00\x00\x00"),
    OpponentData(50, "Dark Ruler Vandalgyon", [], 1, 1, 6410, 13024, "deck/theme_024.ydc\x00\x00\x00\x00"),
    OpponentData(51, "Aussa the Earth Charmer", [], 1, 1, 6335, 13025, "deck/theme_025.ydc\x00\x00\x00\x00"),
    OpponentData(52, "Exodia Necross", [], 1, 1, 5701, 13026, "deck/theme_026.ydc\x00\x00\x00\x00"),
    OpponentData(53, "Dark Necrofear", [], 1, 1, 5222, 13027, "deck/theme_027.ydc\x00\x00\x00\x00"),
    OpponentData(54, "Demise, King of Armageddon", [], 1, 1, 6613, 13028, "deck/theme_028.ydc\x00\x00\x00\x00"),
    OpponentData(55, "Yamata Dragon", [], 1, 1, 5377, 13029, "deck/theme_029.ydc\x00\x00\x00\x00"),
    OpponentData(56, "Blue-Eyes Ultimate Dragon", [], 1, 1, 4386, 13030, "deck/theme_030.ydc\x00\x00\x00\x00"),
    OpponentData(57, "Wave-Motion Cannon", [], 1, 1, 5614, 13031, "deck/theme_031.ydc\x00\x00\x00\x00"),
    # Unused opponent
    ...
    OpponentData(60, "Morphing Jar", [], 1, 1, 4597, 13034, "deck/theme_034.ydc\x00\x00\x00\x00"),
    OpponentData(61, "Spirit Reaper", [], 1, 1, 5526, 13035, "deck/theme_035.ydc\x00\x00\x00\x00"),
    OpponentData(62, "Victory D.", [], 1, 1, 5868, 13036, "deck/theme_036.ydc\x00\x00\x00\x00"),
    OpponentData(63, "VWXYZ-Dragon Catapult Cannon", [], 1, 1, 6484, 13037, "deck/theme_037.ydc\x00\x00\x00\x00"),
    OpponentData(64, "XYZ-Dragon Cannon", [], 1, 1, 5556, 13038, "deck/theme_038.ydc\x00\x00\x00\x00"),
    OpponentData(65, "Uria, Lord of Searing Flames", [], 1, 1, 6563, 13039, "deck/theme_039.ydc\x00\x00\x00\x00"),
    OpponentData(66, "Hamon, Lord of Striking Thunder", [], 1, 1, 6564, 13040, "deck/theme_040.ydc\x00\x00\x00\x00"),
    OpponentData(67, "Raviel, Lord of Phantasms TD", [], 1, 1, 6565, 13041, "deck/theme_041.ydc\x00\x00\x00\x00"),
    OpponentData(68, "Uria, Lord of Searing Flames", [], 1, 1, 5738, 13042, "deck/theme_042.ydc\x00\x00\x00\x00"),
    OpponentData(69, "Ojama Trio", [], 1, 1, 5578, 13043, "deck/theme_043.ydc\x00\x00\x00\x00"),
    OpponentData(70, "Cyber-Stein", [], 1, 1, 4426, 13044, "deck/theme_044.ydc\x00\x00\x00\x00"),
    OpponentData(71, "Winged Kuriboh LV10", [], 1, 1, 6406, 13045, "deck/theme_045.ydc\x00\x00\x00\x00"),
    OpponentData(72, "Blue-Eyes Shining Dragon", [], 1, 1, 6082, 13046, "deck/theme_046.ydc\x00\x00\x00\x00"),
    OpponentData(73, "Perfectly Ultimate Great Moth", [], 1, 1, 4073, 13047, "deck/theme_047.ydc\x00\x00\x00\x00"),
    OpponentData(74, "Gate Guardian", [], 1, 1, 4380, 13048, "deck/theme_048.ydc\x00\x00\x00\x00"),
    OpponentData(75, "Valkyrion the Magna Warrior", [], 1, 1, 5002, 13049, "deck/theme_049.ydc\x00\x00\x00\x00"),
    OpponentData(76, "Dark Sage", [], 1, 1, 5230, 13050, "deck/theme_050.ydc\x00\x00\x00\x00"),
    OpponentData(77, "Don Zaloog", [], 1, 1, 5426, 13051, "deck/theme_051.ydc\x00\x00\x00\x00"),
    OpponentData(78, "Blast Magician", [], 1, 1, 6250, 13052, "deck/theme_052.ydc\x00\x00\x00\x00"),
    OpponentData(79, "Zombyra the Dark", [], 1, 1, 5245, 23000, "deck/limit_000.ydc\x00\x00\x00\x00"),
    OpponentData(80, "Goblin Attack Force", [], 1, 1, 5145, 23001, "deck/limit_001.ydc\x00\x00\x00\x00"),
    OpponentData(81, "Giant Kozaky", [], 1, 1, 6420, 23002, "deck/limit_002.ydc\x00\x00\x00\x00"),
    OpponentData(82, "Big Shield Gardna", [], 1, 1, 4764, 23003, "deck/limit_003.ydc\x00\x00\x00\x00"),
    OpponentData(83, "Panther Warrior", [], 1, 1, 4751, 23004, "deck/limit_004.ydc\x00\x00\x00\x00"),
    OpponentData(84, "Silent Magician LV4", [], 1, 1, 6167, 23005, "deck/limit_005.ydc\x00\x00\x00\x00"),
    OpponentData(85, "Summoned Skull", [], 1, 1, 4028, 23006, "deck/limit_006.ydc\x00\x00\x00\x00"),
    OpponentData(86, "Ancient Gear Golem", [], 1, 1, 6315, 23007, "deck/limit_007.ydc\x00\x00\x00\x00"),
    OpponentData(87, "Chaos Sorcerer", [], 1, 1, 5833, 23008, "deck/limit_008.ydc\x00\x00\x00\x00"),
    OpponentData(88, "Breaker the Magical Warrior", [], 1, 1, 5655, 23009, "deck/limit_009.ydc\x00\x00\x00\x00"),
    OpponentData(89, "Dark Magician of Chaos", [], 1, 1, 5880, 23010, "deck/limit_010.ydc\x00\x00\x00\x00"),
    OpponentData(90, "Stealth Bird", [], 1, 1, 5882, 23011, "deck/limit_011.ydc\x00\x00\x00\x00"),
    OpponentData(91, "Rapid-Fire Magician", [], 1, 1, 6500, 23012, "deck/limit_012.ydc\x00\x00\x00\x00"),
    OpponentData(92, "Morphing Jar #2", [], 1, 1, 4969, 23013, "deck/limit_013.ydc\x00\x00\x00\x00"),
    OpponentData(93, "Cyber Jar", [], 1, 1, 4913, 23014, "deck/limit_014.ydc\x00\x00\x00\x00"),
    # Unused/Broken
    # OpponentData(94, "Exodia the Forbidden One", [], 1, 1, 4027, 23015, "deck/limit_015.ydc\x00\x00\x00\x00"),
    OpponentData(94, "Dark Paladin", [], 1, 1, 5628, 23016, "deck/limit_016.ydc\x00\x00\x00\x00"),
    OpponentData(95, "F.G.D.", [], 1, 1, 5502, 23017, "deck/limit_017.ydc\x00\x00\x00\x00"),
    OpponentData(96, "Blue-Eyes Toon Dragon", [], 1, 1, 4773, 23018, "deck/limit_018.ydc\x00\x00\x00\x00"),
    OpponentData(97, "Tsukuyomi", [], 1, 1, 5780, 23019, "deck/limit_019.ydc\x00\x00\x00\x00"),
    OpponentData(98, "Silent Swordsman LV3", [], 1, 1, 6162, 23020, "deck/limit_020.ydc\x00\x00\x00\x00"),
    OpponentData(99, "Elemental Hero Flame Wingman", [], 1, 1, 6344, 23021, "deck/limit_021.ydc\x00\x00\x00\x00"),
    OpponentData(100, "Armed Dragon LV7", [], 1, 1, 6107, 23022, "deck/limit_022.ydc\x00\x00\x00\x00"),
...
def get_opponents(multiworld: Optional[MultiWorld], player: Optional[int]) -> Tuple[OpponentData, ...]:
    opponents_table: List[OpponentData] = [
        ...
        # Tier 2
        OpponentData(5, "Battery Man C", ["Quick-Finish"], 2, 1, 6428, 8005, "deck/LV2_denti.ydc\x00\x00\x00\x00",
                     lambda state: state.yugioh06_difficulty(player, 1)),
        OpponentData(6, "Ojama Yellow", [], 2, 2, 5811, 8006, "deck/LV2_ojama.ydc\x00\x00\x00\x00",
                     lambda state: state.yugioh06_difficulty(player, 1)),
        OpponentData(7, "Goblin King", ["Quick-Finish"], 2, 3, 5973, 8007, "deck/LV2_kingG.ydc\x00\x00\x00\x00",
                     lambda state: state.yugioh06_difficulty(player, 1)),
        OpponentData(8, "Des Frog", ["Quick-Finish"], 2, 4, 6424, 8008, "deck/LV2_kaeru.ydc\x00\x00\x00\x00",
                     lambda state: state.yugioh06_difficulty(player, 1)),
        OpponentData(9, "Water Dragon", ["Quick-Finish"], 2, 5, 6481, 8009, "deck/LV2_waterD.ydc\x00\x00\x00",
                     lambda state: state.yugioh06_difficulty(player, 1)),
        # Tier 3
        ...
        OpponentData(11, "Vampire Genesis", ["Quick-Finish"], 3, 2, 6293, 8011, "deck/LV3_vamp.ydc\x00\x00\x00\x00\x00",
                     lambda state: state.yugioh06_difficulty(player, 2)),
        OpponentData(12, "Infernal Flame Emperor", [], 3, 3, 6368, 8012, "deck/LV3_flame.ydc\x00\x00\x00\x00",
                     lambda state: state.yugioh06_difficulty(player, 2)),
        OpponentData(13, "Ocean Dragon Lord - Neo-Daedalus", [], 3, 4, 6376, 8013, "deck/LV3_daidaros.ydc\x00",
                     lambda state: state.yugioh06_difficulty(player, 2)),
        OpponentData(14, "Helios Duo Megiste", ["Quick-Finish"], 3, 5, 6647, 8014, "deck/LV3_heriosu.ydc\x00\x00",
                     lambda state: state.yugioh06_difficulty(player, 2)),
        # Tier 4
        ...
        OpponentData(16, "Dark Eradicator Warlock", ["Quick-Finish"], 4, 2, 6530, 8016, "deck/LV4_kuromadou.ydc",
                     lambda state: state.yugioh06_difficulty(player, 3)),
        OpponentData(17, "Guardian Exode", [], 4, 3, 6640, 8017, "deck/LV4_exodo.ydc\x00\x00\x00\x00",
                     lambda state: state.yugioh06_difficulty(player, 3)),
        ...
        OpponentData(21, "Horus the Black Flame Dragon LV8", [], 5, 2, 6100, 8021, "deck/LV5_horus.ydc\x00\x00\x00\x00",
                     lambda state: state.yugioh06_difficulty(player, 4)),
        OpponentData(22, "Stronghold", [], 5, 3, 6153, 8022, "deck/LV5_gadget.ydc\x00\x00\x00",
                     lambda state: state.yugioh06_difficulty(player, 5)),
        OpponentData(23, "Sacred Phoenix of Nephthys", [], 5, 4, 6236, 8023, "deck/LV5_nephthys.ydc\x00",
