...
from worlds.yugioh06 import Limited_Duels, Theme_Duels
...
def set_rules(world):
    ...
    add_rule(world.get_location("LD02: Medium/high Level forbidden Complete", player),
             lambda state: state.has("LD02: Medium/high Level forbidden Unlock", player)),
    add_rule(world.get_location("LDO3: ATK 1500 or more forbidden", player),
             lambda state: state.has("LDO3: ATK 1500 or more forbidden Unlock", player)),
    add_rule(world.get_location("LDO3: ATK 1500 or more forbidden Complete", player),
             lambda state: state.has("LDO3: ATK 1500 or more forbidden Unlock", player)),
