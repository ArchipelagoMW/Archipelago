...
def has_ladder(ladder: str, state: CollectionState, player: int) -> bool:
...
def set_er_region_rules(world: "TunicWorld", regions: Dict[str, Region], portal_pairs: Dict[Portal, Portal]) -> None:
    ...
    regions["Overworld"].connect(
        ...
        rule=lambda state: has_ability(holy_cross, state, player))

    # grapple on the west side, down the stairs from moss wall, across from ruined shop
    regions["Overworld"].connect(
        connecting_region=regions["Overworld Beach"],
        rule=lambda state: has_ladder("Ladders in Overworld Town", state, player)
    ...
    regions["Overworld Beach"].connect(
        ...
        rule=lambda state: has_ladder("Ladder to Ruined Atoll", state, player))
    ...
    regions["Overworld Belltower"].connect(
        ...
        rule=lambda state: has_ladder("Ladders to West Bell", state, player))
    ...
    regions["Overworld"].connect(
        ...
        rule=lambda state: has_ladder("Ladders near Weathervane", state, player)
    ...
    regions["Overworld"].connect(
        connecting_region=regions["East Overworld"],
        rule=lambda state: has_ladder("Ladders near Overworld Checkpoint", state, player)
        or has_ice_grapple_logic(True, state, player))
    regions["East Overworld"].connect(
        connecting_region=regions["Overworld"],
        rule=lambda state: has_ladder("Ladders near Overworld Checkpoint", state, player))
    ...
    regions["Overworld at Patrol Cave"].connect(
        ...
        rule=lambda state: has_ladder("Ladders near Patrol Cave", state, player)
        or has_ice_grapple_logic(True, state, player))
    regions["Overworld above Patrol Cave"].connect(
        connecting_region=regions["Overworld at Patrol Cave"],
        rule=lambda state: has_ladder("Ladders near Patrol Cave", state, player))
    ...
    regions["Upper Overworld"].connect(
        ...
        rule=lambda state: has_ladder("Ladder near Temple Rafters", state, player))
    ...
    regions["Overworld above Quarry Entrance"].connect(
        connecting_region=regions["Overworld"],
        rule=lambda state: has_ladder("Ladders near Dark Tomb", state, player))
    regions["Overworld"].connect(
        connecting_region=regions["Overworld above Quarry Entrance"],
        rule=lambda state: has_ladder("Ladders near Dark Tomb", state, player))
    ...
    regions["Overworld after Envoy"].connect(
        ...
        rule=lambda state: has_ladder("Ladder to Quarry", state, player))
    ...
    regions["Overworld"].connect(
        connecting_region=regions["Overworld Quarry Entry"],
        rule=lambda state: has_ice_grapple_logic(False, state, player))
    regions["Overworld Quarry Entry"].connect(
        connecting_region=regions["Overworld"],
        rule=lambda state: has_ice_grapple_logic(False, state, player))
    ...
    regions["Overworld"].connect(
        ...
        rule=lambda state: has_ladder("Ladder to Swamp", state, player))
    ...
    regions["Hourglass Cave"].connect(
        ...
        rule=lambda state: has_ladder("Ladders in Hourglass Cave", state, player))
    ...
    regions["Forest Belltower Main"].connect(
        ...
        rule=lambda state: has_ladder("Ladder to East Forest", state, player))
    ...
    regions["West Garden Portal Item"].connect(
        ...
        rule=lambda state: state.has(laurels, player) and has_ability(prayer, state, player))
    ...
    regions["Ruined Atoll"].connect(
        ...
        rule=lambda state: has_ladder("Ladders in South Atoll", state, player))
    ...
    regions["Ruined Atoll"].connect(
        ...
        rule=lambda state: has_ladder("Ladders to Frog's Domain", state, player))
    ...
    regions["Ruined Atoll"].connect(
        ...
        rule=lambda state: has_ability(prayer, state, player)
        and has_ladder("Ladders in South Atoll", state, player))
    ...
    regions["Library Hall Bookshelf"].connect(
        ...
        rule=lambda state: has_ladder("Ladders in Library", state, player))
    ...
    regions["Fortress Exterior from Overworld"].connect(
        ...
        rule=lambda state: state.has(laurels, player) or has_ability(prayer, state, player))

    regions["Fortress Exterior near cave"].connect(
        connecting_region=regions["Beneath the Vault Entry"],
        rule=lambda state: has_ladder("Ladder to Beneath the Vault", state, player))
    ...
    regions["Quarry"].connect(
        ...
        rule=lambda state: has_mask(state, player))
    ...
    regions["Lower Quarry"].connect(
        ...
        rule=lambda state: has_ladder("Ladders in Lower Quarry", state, player)
        or has_ice_grapple_logic(True, state, player))
    ...
    regions["Even Lower Quarry"].connect(
        ...
        rule=lambda state: state.has("Activate Quarry Fuse", player)
        or (has_ice_grapple_logic(False, state, player) and options.entrance_rando))
    ...
    regions["Rooted Ziggurat Lower Front"].connect(
        ...
        rule=lambda state: state.has(laurels, player)
        or (has_sword(state, player) and has_ability(prayer, state, player)))
    ...
    regions["Swamp Front"].connect(
        ...
        rule=lambda state: has_ladder("Ladders in Swamp", state, player)
        or state.has(laurels, player)
        or has_ice_grapple_logic(False, state, player))  # nmg: ice grapple through gate
    ...
    regions["Swamp Ledge under Cathedral Door"].connect(
        connecting_region=regions["Swamp Mid"],
        rule=lambda state: has_ladder("Ladders in Swamp", state, player)
        or has_ice_grapple_logic(True, state, player))  # nmg: ice grapple the enemy at door
    ...
    regions["Back of Swamp Laurels Area"].connect(
        connecting_region=regions["Swamp Mid"],
        rule=lambda state: state.has(laurels, player)
        and has_ice_grapple_logic(True, state, player))
        ...
        for region_name, scene_dest, ladders in ladder_storages:
            ...
            if portal_name == "Swamp to Cathedral Secret Legend Room Entrance" and region_name == "Back of Swamp":
                regions[region_name].connect(
                    ...
                    and (has_ladder("Ladders in Swamp", state, player)
                         or has_ice_grapple_logic(True, state, player)
...
def set_er_location_rules(world: "TunicWorld") -> None:
    ...
    set_rule(multiworld.get_location("Rooted Ziggurat Lower - After Guarded Fuse", player),
             lambda state: has_sword(state, player) and has_ability(prayer, state, player))
    ...
    set_rule(multiworld.get_location("Quarry Connector Fuse", player),
             lambda state: has_ability(prayer, state, player) and state.has(grapple, player))
