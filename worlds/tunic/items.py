...
item_table: Dict[str, TunicItemData] = {
    ...
    "Money x2": TunicItemData(IC.filler, 0, 151, "Money"),
    "Money x3": TunicItemData(IC.filler, 0, 152, "Money"),
    "Money x4": TunicItemData(IC.filler, 0, 153, "Money"),
    "Money x5": TunicItemData(IC.filler, 0, 154, "Money"),
