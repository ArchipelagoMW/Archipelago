...
item_table: Dict[str, TunicItemData] = {
    ...
    "Overworld Shortcut Ladders": TunicItemData(ItemClassification.progression, 0, 131, "ladders"),
    "Ladder Drop to East Forest": TunicItemData(ItemClassification.progression, 0, 132, "ladders"),
    "Ladders next to Patrol Cave": TunicItemData(ItemClassification.progression, 0, 133, "ladders"),
    "Ladder to Well": TunicItemData(ItemClassification.progression, 0, 134, "ladders"),
    "Well Back Ladder": TunicItemData(ItemClassification.progression, 0, 135, "ladders"),
    "Ladders next to West Belltower": TunicItemData(ItemClassification.progression, 0, 136, "ladders"),
    "Ladder to Quarry": TunicItemData(ItemClassification.progression, 0, 137, "ladders"),
    "Dark Tomb Ladder": TunicItemData(ItemClassification.progression, 0, 138, "ladders"),
    "Ladders next to Dark Tomb": TunicItemData(ItemClassification.progression, 0, 139, "ladders"),
    "Ladder by Temple Rafters Exit": TunicItemData(ItemClassification.progression, 0, 140, "ladders"),
