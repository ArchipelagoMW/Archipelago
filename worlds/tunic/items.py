...
item_table: Dict[str, TunicItemData] = {
    ...
    "Central Swamp Ladder": TunicItemData(ItemClassification.progression, 0, 143, "ladders"),
    ...
    "Frog's Domain Ladders": TunicItemData(ItemClassification.progression, 0, 146, "ladders"),
