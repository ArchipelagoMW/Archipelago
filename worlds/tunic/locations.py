...
location_table: Dict[str, TunicLocationData] = {
    ...
    "Dark Tomb - Skulls Chest": TunicLocationData("Dark Tomb", "Dark Tomb Main", ladder_region="Dark Tomb Front"),
    ...
    "Guardhouse 2 - Bottom Floor Secret": TunicLocationData("East Forest", "Guard House 2", ladder_region="Lower Forest"),
    ...
    "East Forest - Golden Obelisk Holy Cross": TunicLocationData("East Forest", "East Forest", ladder_region="Lower Forest", location_group="holy cross"),
    ...
    "East Forest - Beneath Spider Chest": TunicLocationData("East Forest", "East Forest", ladder_region="Lower Forest"),
    "East Forest - Near Telescope": TunicLocationData("East Forest", "East Forest"),
    "East Forest - Spider Chest": TunicLocationData("East Forest", "East Forest", ladder_region="Lower Forest"),
    "East Forest - Lower Dash Chest": TunicLocationData("East Forest", "East Forest", ladder_region="Lower Forest"),
    "East Forest - Lower Grapple Chest": TunicLocationData("East Forest", "East Forest", ladder_region="Lower Forest"),
    ...
    "Overworld - [East] Chest Near Pots": TunicLocationData("Overworld", "Overworld", ladder_region="East Overworld"),
    ...
    "Overworld - [Southeast] Chest Near Swamp": TunicLocationData("Overworld", "Overworld", ladder_region="Swamp"),
    ...
    "Overworld - [Northeast] Chest Above Patrol Cave": TunicLocationData("Overworld", "Overworld", ladder_region="Upper Overworld"),
    ...
    "Overworld - [East] Page Near Secret Shop": TunicLocationData("Overworld", "Overworld", ladder_region="East Overworld"),
    ...
    "Overworld - [Northwest] Fire Wand Pickup": TunicLocationData("Overworld", "Overworld", ladder_region="Upper Overworld"),
    ...
    "Overworld - [Southwest] Flowers Holy Cross": TunicLocationData("Overworld Holy Cross", "Overworld Holy Cross", location_group="holy cross"),
    ...
    "Overworld - [Northeast] Flowers Holy Cross": TunicLocationData("Overworld Holy Cross", "Overworld Holy Cross", ladder_region="East Overworld", location_group="holy cross"),
    "Overworld - [East] Weathervane Holy Cross": TunicLocationData("Overworld Holy Cross", "Overworld Holy Cross", ladder_region="East Overworld", location_group="holy cross"),
    "Overworld - [West] Windmill Holy Cross": TunicLocationData("Overworld Holy Cross", "Overworld Holy Cross", location_group="holy cross"),
    "Overworld - [Southwest] Haiku Holy Cross": TunicLocationData("Overworld Holy Cross", "Overworld Holy Cross", location_group="holy cross"),
    ...
    "Overworld - [Northwest] Golden Obelisk Page": TunicLocationData("Overworld Holy Cross", "Overworld Holy Cross", ladder_region="Upper Overworld", location_group="holy cross"),
    ...
    "Swamp - [Upper Graveyard] Obscured Behind Hill": TunicLocationData("Swamp", "Swamp", ladder_region="Swamp Middle"),
    "Swamp - [South Graveyard] 4 Orange Skulls": TunicLocationData("Swamp", "Swamp"),
    "Swamp - [Central] Near Ramps Up": TunicLocationData("Swamp", "Swamp", ladder_region="Swamp Middle"),
    "Swamp - [Upper Graveyard] Near Shield Fleemers": TunicLocationData("Swamp", "Swamp", ladder_region="Swamp Middle"),
    "Swamp - [South Graveyard] Obscured Behind Ridge": TunicLocationData("Swamp", "Swamp", ladder_region="Swamp Middle"),
    ...
    "Swamp - [Central] South Secret Passage": TunicLocationData("Swamp", "Swamp", ladder_region="Swamp Middle"),
    ...
    "Swamp - [Upper Graveyard] Near Telescope": TunicLocationData("Swamp", "Swamp", ladder_region="Swamp Middle"),
    "Swamp - [Outside Cathedral] Near Moonlight Bridge Door": TunicLocationData("Swamp", "Swamp", ladder_region="Swamp Middle"),
    ...
    "Swamp - [Central] Obscured Behind Northern Mountain": TunicLocationData("Swamp", "Swamp", ladder_region="Swamp Middle"),
    "Swamp - [South Graveyard] Upper Walkway Dash Chest": TunicLocationData("Swamp", "Swamp", ladder_region="Swamp Middle"),
    "Swamp - [South Graveyard] Above Big Skeleton": TunicLocationData("Swamp", "Swamp"),
    "Swamp - [Central] Beneath Memorial": TunicLocationData("Swamp", "Swamp", ladder_region="Swamp Middle"),
