...
breakable_location_table: dict[str, TunicLocationData] = {
    ...
    "Fortress Courtyard - Fire Pot 1": TunicLocationData("Fortress Courtyard", BreakableType.fire_pot),
    "Fortress Courtyard - Fire Pot 2": TunicLocationData("Fortress Courtyard", BreakableType.fire_pot),
    "Fortress Courtyard - Fire Pot 3": TunicLocationData("Fortress Courtyard", BreakableType.fire_pot),
    "Fortress Courtyard - Fire Pot 4": TunicLocationData("Fortress Courtyard", BreakableType.fire_pot),
