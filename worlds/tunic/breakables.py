...
breakable_location_table: dict[str, TunicLocationData] = {
    "Overworld by Quarry Gate - Sign": TunicLocationData("Overworld", breakable="Sign"),
    "Overworld South of Checkpoint - Sign": TunicLocationData("Overworld", breakable="Sign"),
    "Overworld by Ruined Passage - Sign": TunicLocationData("Overworld", breakable="Sign"),
    ...
    "Guardhouse 1 - Pot 1": TunicLocationData("Guard House 1 East", breakable="Pot"),
    "Guardhouse 1 - Pot 2": TunicLocationData("Guard House 1 East", breakable="Pot"),
    "Guardhouse 1 - Pot 3": TunicLocationData("Guard House 1 East", breakable="Pot"),
    "Guardhouse 1 - Pot 4": TunicLocationData("Guard House 1 East", breakable="Pot"),
    "Guardhouse 1 - Pot 5": TunicLocationData("Guard House 1 East", breakable="Pot"),
    ...
    "Guardhouse 2 - Pot 1": TunicLocationData("Guard House 2 Lower", breakable="Pot"),
    "Guardhouse 2 - Pot 2": TunicLocationData("Guard House 2 Lower", breakable="Pot"),
    "Guardhouse 2 - Pot 3": TunicLocationData("Guard House 2 Lower", breakable="Pot"),
    "Guardhouse 2 - Pot 4": TunicLocationData("Guard House 2 Lower", breakable="Pot"),
    "Guardhouse 2 - Pot 5": TunicLocationData("Guard House 2 Lower", breakable="Pot"),
    ...
    "Beneath the Fortress Entry Spot - Pot 1": TunicLocationData("Beneath the Vault Entry Spot", breakable="Pot"),
    "Beneath the Fortress Entry Spot - Pot 2": TunicLocationData("Beneath the Vault Entry Spot", breakable="Pot"),
    "Beneath the Fortress Entry Spot - Crate 1": TunicLocationData("Beneath the Vault Entry Spot", breakable="Crate"),
    "Beneath the Fortress Entry Spot - Crate 2": TunicLocationData("Beneath the Vault Entry Spot", breakable="Crate"),
    "Beneath the Fortress Entry Spot - Crate 3": TunicLocationData("Beneath the Vault Entry Spot", breakable="Crate"),
    "Beneath the Fortress Entry Spot - Crate 4": TunicLocationData("Beneath the Vault Entry Spot", breakable="Crate"),
    "Beneath the Fortress Entry Spot - Crate 5": TunicLocationData("Beneath the Vault Entry Spot", breakable="Crate"),
    "Beneath the Fortress Entry Spot - Crate 6": TunicLocationData("Beneath the Vault Entry Spot", breakable="Crate"),
    "Beneath the Fortress Entry Spot - Crate 7": TunicLocationData("Beneath the Vault Entry Spot", breakable="Crate"),
    "Beneath the Fortress Main - Crate 1": TunicLocationData("Beneath the Vault Main", breakable="Crate"),
    "Beneath the Fortress Main - Crate 2": TunicLocationData("Beneath the Vault Main", breakable="Crate"),
    "Beneath the Fortress Main - Crate 3": TunicLocationData("Beneath the Vault Main", breakable="Crate"),
    "Beneath the Fortress Main - Crate 4": TunicLocationData("Beneath the Vault Main", breakable="Crate"),
    "Beneath the Fortress Main - Crate 5": TunicLocationData("Beneath the Vault Main", breakable="Crate"),
    "Beneath the Fortress Main - Crate 6": TunicLocationData("Beneath the Vault Main", breakable="Crate"),
    "Beneath the Fortress Main - Crate 7": TunicLocationData("Beneath the Vault Main", breakable="Crate"),
    "Beneath the Fortress Main - Crate 8": TunicLocationData("Beneath the Vault Main", breakable="Crate"),
    "Beneath the Fortress Back - Fire Pot 1": TunicLocationData("Beneath the Vault Back", breakable="Fire Pot"),
    "Beneath the Fortress Back - Fire Pot 2": TunicLocationData("Beneath the Vault Back", breakable="Fire Pot"),
    "Beneath the Fortress Back - Fire Pot 3": TunicLocationData("Beneath the Vault Back", breakable="Fire Pot"),
    "Beneath the Fortress Back - Barrel 1": TunicLocationData("Beneath the Vault Back", breakable="Barrel"),
    "Beneath the Fortress Back - Barrel 2": TunicLocationData("Beneath the Vault Back", breakable="Barrel"),
    "Beneath the Fortress Back - Barrel 3": TunicLocationData("Beneath the Vault Back", breakable="Barrel"),
    "Beneath the Fortress Back - Barrel 4": TunicLocationData("Beneath the Vault Back", breakable="Barrel"),
    "Beneath the Fortress Back - Barrel 5": TunicLocationData("Beneath the Vault Back", breakable="Barrel"),
    "Beneath the Fortress Back - Barrel 6": TunicLocationData("Beneath the Vault Back", breakable="Barrel"),
    "Beneath the Fortress Back - Barrel 7": TunicLocationData("Beneath the Vault Back", breakable="Barrel"),
    "Beneath the Fortress Back - Barrel 8": TunicLocationData("Beneath the Vault Back", breakable="Barrel"),
    "Beneath the Fortress Back - Barrel 9": TunicLocationData("Beneath the Vault Back", breakable="Barrel"),
    "Beneath the Fortress Back - Barrel 10": TunicLocationData("Beneath the Vault Back", breakable="Barrel"),
    "Beneath the Fortress Back - Barrel 11": TunicLocationData("Beneath the Vault Back", breakable="Barrel"),
    "Beneath the Fortress Back - Barrel 12": TunicLocationData("Beneath the Vault Back", breakable="Barrel"),
    "Beneath the Fortress Back - Barrel 13": TunicLocationData("Beneath the Vault Back", breakable="Barrel"),
    ...
    "Ruined Atoll Southwest - Pot 1": TunicLocationData("Ruined Atoll", breakable="Pot"),
    "Ruined Atoll Southwest - Pot 2": TunicLocationData("Ruined Atoll", breakable="Pot"),
    "Ruined Atoll Southwest - Table": TunicLocationData("Ruined Atoll", breakable="Table"),
    "Ruined Atoll near Birds - Explosive Pot": TunicLocationData("Ruined Atoll", breakable="Explosive Pot"),
