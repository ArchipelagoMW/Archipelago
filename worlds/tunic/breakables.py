...
breakable_location_table: dict[str, TunicLocationData] = {
    ...
    "East Overworld near Slimes - Pot 1": TunicLocationData("East Overworld", BreakableType.pot),
    "East Overworld near Slimes - Pot 2": TunicLocationData("East Overworld", BreakableType.pot),
    "East Overworld near Slimes - Pot 3": TunicLocationData("East Overworld", BreakableType.pot),
    "East Overworld near Slimes - Pot 4": TunicLocationData("East Overworld", BreakableType.pot),
    "East Overworld near Slimes - Pot 5": TunicLocationData("East Overworld", BreakableType.pot),
    "East Overworld - Forest Sign": TunicLocationData("East Overworld", BreakableType.sign),
    "East Overworld - Fortress Sign": TunicLocationData("East Overworld", BreakableType.sign),
    ...
    "East Forest by Grave Path - Sign": TunicLocationData("East Forest", BreakableType.sign),
    "East Forest by Guardhouse 1 - Sign": TunicLocationData("East Forest", BreakableType.sign),
    "East Forest by Grave Path - Pot 1": TunicLocationData("East Forest", BreakableType.pot),
    "East Forest by Grave Path - Pot 2": TunicLocationData("East Forest", BreakableType.pot),
    "East Forest by Grave Path - Pot 3": TunicLocationData("East Forest", BreakableType.pot),
    ...
    "Guardhouse 2 Lower - Pot 1": TunicLocationData("Guard House 2 Lower", BreakableType.pot),
    "Guardhouse 2 Lower - Pot 2": TunicLocationData("Guard House 2 Lower", BreakableType.pot),
    "Guardhouse 2 Lower - Pot 3": TunicLocationData("Guard House 2 Lower", BreakableType.pot),
    "Guardhouse 2 Lower - Pot 4": TunicLocationData("Guard House 2 Lower", BreakableType.pot),
    "Guardhouse 2 Lower - Pot 5": TunicLocationData("Guard House 2 Lower", BreakableType.pot),
    ...
    "Beneath the Fortress under Rope - Crate 1": TunicLocationData("Beneath the Vault Main", BreakableType.crate),
    "Beneath the Fortress under Rope - Crate 2": TunicLocationData("Beneath the Vault Main", BreakableType.crate),
    "Beneath the Fortress under Rope - Crate 3": TunicLocationData("Beneath the Vault Main", BreakableType.crate),
    "Beneath the Fortress under Rope - Crate 4": TunicLocationData("Beneath the Vault Main", BreakableType.crate),
    "Beneath the Fortress under Rope - Crate 5": TunicLocationData("Beneath the Vault Main", BreakableType.crate),
    "Beneath the Fortress under Rope - Crate 6": TunicLocationData("Beneath the Vault Main", BreakableType.crate),
    ...
    "Beneath the Fortress Fuse Room - Barrel 1": TunicLocationData("Beneath the Vault Back", BreakableType.barrel),
    "Beneath the Fortress Fuse Room - Barrel 2": TunicLocationData("Beneath the Vault Back", BreakableType.barrel),
    "Beneath the Fortress Fuse Room - Barrel 3": TunicLocationData("Beneath the Vault Back", BreakableType.barrel),
    "Beneath the Fortress Fuse Room - Barrel 4": TunicLocationData("Beneath the Vault Back", BreakableType.barrel),
    "Beneath the Fortress Fuse Room - Barrel 5": TunicLocationData("Beneath the Vault Back", BreakableType.barrel),
    "Beneath the Fortress Fuse Room - Barrel 6": TunicLocationData("Beneath the Vault Back", BreakableType.barrel),
    ...
    "Lower Quarry near Bomb Wall - Explosive Pot 1": TunicLocationData("Lower Quarry upper pots", BreakableType.explosive_pot),
    "Lower Quarry near Bomb Wall - Explosive Pot 2": TunicLocationData("Lower Quarry upper pots", BreakableType.explosive_pot),
    "Lower Quarry above Shooting Range - Explosive Pot": TunicLocationData("Lower Quarry", BreakableType.explosive_pot),
