...
class SecondStageSymbolsActIndependently(OptionSet):
    ...
    Rotated Shapers always act independently from Shapers. The ability to make them dependent on Shapers by omitting them from the set may be added in the future.
    """
