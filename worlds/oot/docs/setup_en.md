...
to navigate to and select the `ArchipelagoOoTClient` in the root of the `Archipelago` directory.  This will launch
the OoT client and prompt you for the ROM file.  The patched ROM will be placed in the same directory as the original
`.apz5` file.
