...
#Warps, attached to Hub1
hub1_b004 = f"{RegionNames.hub1}->{RegionNames.b004}"
hub1_c004 = f"{RegionNames.hub1}->{RegionNames.c004}"
hub1_e004 = f"{RegionNames.hub1}->{RegionNames.e004}"
hub1_e006 = f"{RegionNames.hub1}->{RegionNames.e006}"
hub1_e009 = f"{RegionNames.hub1}->{RegionNames.e009}"
hub1_f003 = f"{RegionNames.hub1}->{RegionNames.f003}"
hub1_f007 = f"{RegionNames.hub1}->{RegionNames.f007}"
hub1_o001 = f"{RegionNames.hub1}->{RegionNames.o001}"
hub1_o004 = f"{RegionNames.hub1}->{RegionNames.o004}"
hub1_o006 = f"{RegionNames.hub1}->{RegionNames.o006}"
hub1_g001 = f"{RegionNames.hub1}->{RegionNames.g001}"
hub1_g005 = f"{RegionNames.hub1}->{RegionNames.g005}"
hub1_g008 = f"{RegionNames.hub1}->{RegionNames.g008}"
hub1_i003 = f"{RegionNames.hub1}->{RegionNames.i003}"
hub1_i006 = f"{RegionNames.hub1}->{RegionNames.i006}"
hub1_l014 = f"{RegionNames.hub1}->{RegionNames.l014}"
hub1_l015 = f"{RegionNames.hub1}->{RegionNames.l015}"
hub1_l018 = f"{RegionNames.hub1}->{RegionNames.l018}"
hub1_p003 = f"{RegionNames.hub1}->{RegionNames.p003}"
hub1_p005 = f"{RegionNames.hub1}->{RegionNames.p005}"
hub1_r003 = f"{RegionNames.hub1}->{RegionNames.r003}"
hub1_s002 = f"{RegionNames.hub1}->{RegionNames.s002}"
hub1_w022 = f"{RegionNames.hub1}->{RegionNames.w022}"
hub1_w026 = f"{RegionNames.hub1}->{RegionNames.w026}"
