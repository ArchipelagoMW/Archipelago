...
upgrade_rules = [
    # connections
    {
        ...
        ConnectionNames.r021_r003: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1),
    ...
    # locations
    {
        ...
        ItemNames.MonsterTokens:
        {
            ...
            # Rooftops
            LocationNames.witchdoctor_token_r020: lambda player: lambda state: (state.has(ItemNames.PlungerPower, player, 1) and state.has(ItemNames.HelmetPower, player, 1)) or state.has(ItemNames.ProgressiveJump, player, 1),
        ...
        ItemNames.Warps:
            {
                LocationNames.warp_gate_o001: lambda player: lambda state: state.has(ItemNames.Balc1_Warp, player, 1) or state.has(ItemNames.BootsPower, player, 1) and state.has(ItemNames.ProgressiveJump, player, 1),
                LocationNames.warp_gate_o006: lambda player: lambda state: state.has(ItemNames.Balc6_Warp, player, 1) or state.can_reach(RegionNames.o008, "Region", player) and (state.can_reach(ConnectionNames.o005_o006, "Entrance", player) or state.has(ItemNames.HelmetPower, player, 1))
            },
...
# connections
    ...
    # locations
    {
        ...
        ItemNames.MonsterTokens:
            {
                # Manor
                LocationNames.geronimo_token_i005: lambda player: lambda state: state.can_reach(RegionNames.i006, "Region", player),
...
snack_rules = [
    ...
    # locations
    {
        ItemNames.Upgrades:
        {
            ...
            LocationNames.e009_SNACK__120: lambda player: lambda state: state.has(ItemNames.ProgressiveJump, player, 1),
            ...
            LocationNames.g003_SNACK__16: lambda player: lambda state: state.has(ItemNames.ProgressiveJump, player, 2),
            ...
            LocationNames.g003_SNACK__174: lambda player: lambda state: state.has(ItemNames.ProgressiveJump, player, 2),
            ...
            LocationNames.i020_SN17: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.i001_i020, "Entrance", player),
            LocationNames.i020_SN18: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.i001_i020, "Entrance", player),
            LocationNames.i020_SN19: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.i001_i020, "Entrance", player),
            LocationNames.i020_SN20: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.i001_i020, "Entrance", player),
            LocationNames.i020_SN21: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.i001_i020, "Entrance", player),
            ...
            LocationNames.i020_SN25: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.i001_i020, "Entrance", player),
            LocationNames.i020_SN26: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.i001_i020, "Entrance", player),
            LocationNames.i020_SN32: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.i001_i020, "Entrance", player),
            LocationNames.i020_SN33: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.i001_i020, "Entrance", player),
            LocationNames.i020_SN34: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.i001_i020, "Entrance", player),
            LocationNames.i020_SN35: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(RegionNames.i021, "Region", player),
            LocationNames.i020_SN36: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(RegionNames.i021, "Region", player),
            LocationNames.i020_SN37: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(RegionNames.i021, "Region", player),
            LocationNames.i020_SN40: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(RegionNames.i021, "Region", player),
            LocationNames.i020_SN41: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(RegionNames.i021, "Region", player),
            LocationNames.i020_SN42: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(RegionNames.i021, "Region", player),
            LocationNames.i020_SN48: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.i001_i020, "Entrance", player),
            LocationNames.i020_SN49: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.i001_i020, "Entrance", player),
            LocationNames.i020_SNACKBOX1: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1),
            LocationNames.i020_SNACKBOX2: lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(RegionNames.i021, "Region", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.i020_SNACKBOX3: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1),
            LocationNames.i020_SNACK__BOX__OVER__PIT: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.i001_i020, "Entrance", player),
            LocationNames.i020_SNACK__BOX__OVER__PIT__2: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.i001_i020, "Entrance", player),
            LocationNames.i020_SS1: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(RegionNames.i021, "Region", player),

            LocationNames.i021_SNACK__BOX__IN__SECRET: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1),
            ...
            LocationNames.r020_SN84: lambda player: lambda state: (state.has(ItemNames.PlungerPower, player, 1) and state.has(ItemNames.HelmetPower, player, 1)) or state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r020_SN85: lambda player: lambda state: (state.has(ItemNames.PlungerPower, player, 1) and state.has(ItemNames.HelmetPower, player, 1)) or state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r020_SN86: lambda player: lambda state: (state.has(ItemNames.PlungerPower, player, 1) and state.has(ItemNames.HelmetPower, player, 1)) or state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r020_SN87: lambda player: lambda state: (state.has(ItemNames.PlungerPower, player, 1) and state.has(ItemNames.HelmetPower, player, 1)) or state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r020_SN88: lambda player: lambda state: (state.has(ItemNames.PlungerPower, player, 1) and state.has(ItemNames.HelmetPower, player, 1)) or state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r020_SN89: lambda player: lambda state: (state.has(ItemNames.PlungerPower, player, 1) and state.has(ItemNames.HelmetPower, player, 1)) or state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r020_SN90: lambda player: lambda state: (state.has(ItemNames.PlungerPower, player, 1) and state.has(ItemNames.HelmetPower, player, 1)) or state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r020_SN26: lambda player: lambda state: (state.has(ItemNames.PlungerPower, player, 1) and state.has(ItemNames.HelmetPower, player, 1)) or state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r020_SN27: lambda player: lambda state: (state.has(ItemNames.PlungerPower, player, 1) and state.has(ItemNames.HelmetPower, player, 1)) or state.has(ItemNames.ProgressiveJump, player, 1),

            LocationNames.r021_CRATE__2__PRIZE: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player) and state.has(ItemNames.PoundPower, player, 1),
            LocationNames.r021_CRATE__3__PRIZE: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player) and state.has(ItemNames.PoundPower, player, 1),
            LocationNames.r021_SN1: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN10: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN100: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN11: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN12: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN13: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN14: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN15: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            ...
            LocationNames.r021_SN27 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            ...
            LocationNames.r021_SN29 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN3: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN30 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN31 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN32 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN33 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN34 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN35 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN36 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN37 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN38 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN39 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN4: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN40 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN41 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN42 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN43 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN44 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player),
            LocationNames.r021_SN45 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player),
            LocationNames.r021_SN46 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player),
            LocationNames.r021_SN47 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player),
            LocationNames.r021_SN48 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player),
            LocationNames.r021_SN49 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN5: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN50 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN51 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN52 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN53 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN54 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN55 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN56 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN57 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN58 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN59 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN6: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN60 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1)  or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN61 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1)  or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN62 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1)  or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN63 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1)  or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN64 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1)  or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN65 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1)  or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN66 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1)  or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN67 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1)  or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN68 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1)  or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN69 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1)  or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN7: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN70 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1)  or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN71 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1)  or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)),
            LocationNames.r021_SN72 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1)  or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)),
            LocationNames.r021_SN73 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1)  or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)),
            LocationNames.r021_SN74 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1)  or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)),
            LocationNames.r021_SN75 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1)  or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)),
            ...
            LocationNames.r021_SN85 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player),
            LocationNames.r021_SN86 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player),
            LocationNames.r021_SN87 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player),
            LocationNames.r021_SN88 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN89 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN9: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN90 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN91 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN92 : lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r021_r020, "Entrance", player),
            LocationNames.r021_SN93 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)),
            LocationNames.r021_SN94 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN95 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN96 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.r021_SN97 : lambda player: lambda state: (state.has(ItemNames.HelmetPower, player, 1) or state.can_reach(ConnectionNames.r003_r021, "Entrance", player)) and state.has(ItemNames.ProgressiveJump, player, 1),
            ...
            LocationNames.r004_SN95: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.has(ItemNames.PoundPower, player, 1),
            LocationNames.r004_SN96: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.has(ItemNames.PoundPower, player, 1),
            LocationNames.r004_SN97: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.has(ItemNames.PoundPower, player, 1),
            LocationNames.r004_SN98: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.has(ItemNames.PoundPower, player, 1),
            LocationNames.r004_SN105: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.has(ItemNames.PoundPower, player, 1),
            LocationNames.r004_SN101: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.has(ItemNames.PoundPower, player, 1),
            LocationNames.r004_SN102: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.has(ItemNames.PoundPower, player, 1),
            LocationNames.r004_SN103: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.has(ItemNames.PoundPower, player, 1),
            LocationNames.r004_SN104: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.has(ItemNames.PoundPower, player, 1),
            LocationNames.r004_SNACKBOX__2: lambda player: lambda state: state.has(ItemNames.HelmetPower, player, 1) or state.has(ItemNames.PoundPower, player, 1),
            ...
            LocationNames.b004_SS2400:  lambda player: lambda state: state.can_reach(ConnectionNames.b003_b004, "Entrance", player) and (state.has(ItemNames.HelmetPower, player, 1) or state.has(ItemNames.PoundPower, player, 1)),
            LocationNames.b004_SS6: lambda player: lambda state: state.can_reach(ConnectionNames.b003_b004, "Entrance", player),
            LocationNames.b004_SS7: lambda player: lambda state: state.can_reach(ConnectionNames.b003_b004, "Entrance", player),
            LocationNames.b004_SS70: lambda player: lambda state: state.can_reach(ConnectionNames.b003_b004, "Entrance", player),
            LocationNames.b004_SS5: lambda player: lambda state: state.can_reach(ConnectionNames.b003_b004, "Entrance", player),
            LocationNames.b004_SS1: lambda player: lambda state: state.can_reach(ConnectionNames.b003_b004, "Entrance", player),
            LocationNames.b004_SS8: lambda player: lambda state: state.can_reach(ConnectionNames.b003_b004, "Entrance", player),
            LocationNames.b004_SS4: lambda player: lambda state: state.can_reach(ConnectionNames.b003_b004, "Entrance", player),
            LocationNames.b004_SS2: lambda player: lambda state: state.can_reach(ConnectionNames.b003_b004, "Entrance", player),
            LocationNames.b004_SS3: lambda player: lambda state: state.can_reach(ConnectionNames.b003_b004, "Entrance", player),
            LocationNames.b004_SNACKBOX5: lambda player: lambda state: state.can_reach(ConnectionNames.b003_b004, "Entrance", player) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.b004_SS9: lambda player: lambda state: state.can_reach(ConnectionNames.b003_b004, "Entrance", player) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.b004_SS100: lambda player: lambda state: state.can_reach(ConnectionNames.b003_b004, "Entrance", player) and state.has(ItemNames.ProgressiveJump, player, 1),
            LocationNames.b004_SS10: lambda player: lambda state: state.can_reach(ConnectionNames.b003_b004, "Entrance", player) and state.has(ItemNames.ProgressiveJump, player, 1),
            ...
            LocationNames.s003_SNACKBOX: lambda player: lambda state: state.has(ItemNames.PoundPower, player, 1) and state.has(ItemNames.ProgressiveJump, player, 1) and
                                                                              (state.has(ItemNames.GumPower, player, 1) or state.has(ItemNames.SoapPower, player, 1)) ,
        ...
        ItemNames.Keys:
        {
            ...
            LocationNames.i005_BOX__OVER__WITCH: lambda player: lambda state: state.has(ItemNames.ProgressiveJump, player, 1) and state.can_reach(RegionNames.i006, "Region", player),
            LocationNames.i005_SN13: lambda player: lambda state: state.can_reach(RegionNames.i006, "Region", player),
            LocationNames.i005_SN17: lambda player: lambda state: state.can_reach(RegionNames.i006, "Region", player),
            LocationNames.i005_SN18: lambda player: lambda state: state.can_reach(RegionNames.i006, "Region", player),
            LocationNames.i005_SN25: lambda player: lambda state: state.can_reach(RegionNames.i006, "Region", player),
            ...
            LocationNames.i005_SN68: lambda player: lambda state: state.has(ItemNames.ProgressiveJump, player, 1) and state.can_reach(RegionNames.i006, "Region", player),
            LocationNames.i005_SN680: lambda player: lambda state: state.can_reach(RegionNames.i006, "Region", player),
            LocationNames.i005_SN6800: lambda player: lambda state: state.can_reach(RegionNames.i006, "Region", player),
            ...
            LocationNames.i005_SN83: lambda player: lambda state: state.can_reach(RegionNames.i006, "Region", player),
            LocationNames.i005_SN84: lambda player: lambda state: state.can_reach(RegionNames.i006, "Region", player),
            LocationNames.i005_SN85: lambda player: lambda state: state.can_reach(RegionNames.i006, "Region", player),
...
def set_rules(multiworld: MultiWorld, options: NO100FOptions, player: int):
    ...
    if ItemNames.Keys not in allowed_loc_types:
        ...
        if ItemNames.Snacks in allowed_loc_types:
            ...
            add_rule(multiworld.get_location(LocationNames.i005_SN48, player), lambda state: state.has(ItemNames.ProgressiveJump, player, 1))
            add_rule(multiworld.get_location(LocationNames.i005_BOX__OVER__WITCH, player), lambda state: state.has(ItemNames.ProgressiveJump, player, 1))
            add_rule(multiworld.get_location(LocationNames.i005_SN68, player), lambda state: state.has(ItemNames.ProgressiveJump, player, 1))
            ...
            add_rule(multiworld.get_entrance(ConnectionNames.o006_sn, player), lambda state: state.can_reach(RegionNames.o005, "Region", player) and state.has(ItemNames.HelmetPower, player, 1) and state.has(ItemNames.ProgressiveJump, player, 1))
            add_rule(multiworld.get_location(LocationNames.o006_SSBOX05, player), lambda state: state.has(ItemNames.PlungerPower, player, 1))
