...
pickup_sanity = {
    ...
    LocationName.storm_eagle_1up:           STARTING_ID + 0x0058,
    LocationName.storm_eagle_hp_1:          STARTING_ID + 0x0059,
    LocationName.storm_eagle_energy_1:      STARTING_ID + 0x005A,
    LocationName.flame_mammoth_hp_1:        STARTING_ID + 0x005B,
    LocationName.flame_mammoth_hp_2:        STARTING_ID + 0x005C,
    LocationName.flame_mammoth_1up:         STARTING_ID + 0x005D,
    LocationName.sigma_fortress_3_hp_1:     STARTING_ID + 0x005E,
    LocationName.sigma_fortress_3_hp_2:     STARTING_ID + 0x005F,
    LocationName.sigma_fortress_3_energy_1: STARTING_ID + 0x0060,
    LocationName.sigma_fortress_3_hp_3:     STARTING_ID + 0x0061,
    LocationName.sigma_fortress_3_energy_2: STARTING_ID + 0x0062,
    LocationName.sigma_fortress_3_hp_4:     STARTING_ID + 0x0063,
    LocationName.sigma_fortress_3_energy_3: STARTING_ID + 0x0064,
    LocationName.sigma_fortress_3_1up:      STARTING_ID + 0x0065,
}
...
location_groups = {
    ...
    "Armored Armadillo Stage": {location for location in all_locations.keys() if "Armored Armadillo Stage - " in location},
    "Chill Penguin Stage": {location for location in all_locations.keys() if "Chill Penguin Stage - " in location},
    "Spark Mandrill Stage": {location for location in all_locations.keys() if "Spark Mandrill Stage - " in location},
    "Launch Octopus Stage": {location for location in all_locations.keys() if "Launch Octopus Stage - " in location},
    "Boomer Kuwanger Stage": {location for location in all_locations.keys() if "Boomer Kuwanger Stage - " in location},
    "Sting Chameleon Stage": {location for location in all_locations.keys() if "Sting Chameleon Stage - " in location},
    "Storm Eagle Stage": {location for location in all_locations.keys() if "Storm Eagle Stage - " in location},
    "Flame Mammoth Stage": {location for location in all_locations.keys() if "Flame Mammoth Stage - " in location},
