...
items: dict[str, CandyBox2ItemData] = {
    ...
    "Pitchfork": CandyBox2ItemData(candy_box_2_base_id + 46, 1),
    ...
    "The Shell Powder": CandyBox2ItemData(candy_box_2_base_id + 54, 1),
    "The Red Fin": CandyBox2ItemData(candy_box_2_base_id + 55, 1, ItemClassification.useful),
    "The Green Fin": CandyBox2ItemData(candy_box_2_base_id + 56, 1),
