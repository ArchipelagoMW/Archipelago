...
items: dict[str, CandyBox2ItemData] = {
    ...
    "Advanced Grimoire": CandyBox2ItemData(candy_box_2_base_id + 12, 1, ItemClassification.progression),
    ...
    "Heart Plug": CandyBox2ItemData(candy_box_2_base_id + 17, 1, ItemClassification.progression),
    ...
    "Heart Pendant": CandyBox2ItemData(candy_box_2_base_id + 43, 1, ItemClassification.progression),
