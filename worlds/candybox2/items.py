...
items: dict[str, CandyBox2ItemData] = {
    ...
    "The Troll's Bludgeon": CandyBox2ItemData(candy_box_2_base_id + 9, 1, ItemClassification.progression),
    "A desert bird feather": CandyBox2ItemData(candy_box_2_base_id + 10, 1, ItemClassification.progression),
    "The Beginners' Grimoire": CandyBox2ItemData(candy_box_2_base_id + 11, 1, ItemClassification.progression),
    "The Advanced Grimoire": CandyBox2ItemData(candy_box_2_base_id + 12, 1, ItemClassification.useful),
    "The Sorceress' Cauldron": CandyBox2ItemData(candy_box_2_base_id + 13, 1, ItemClassification.progression),
    "The Sorceress' Hat": CandyBox2ItemData(candy_box_2_base_id + 14, 1, ItemClassification.useful),
    "The Octopus King Crown": CandyBox2ItemData(candy_box_2_base_id + 15, 1, ItemClassification.progression),
    "The Monkey Wizard Staff": CandyBox2ItemData(candy_box_2_base_id + 16, 1, ItemClassification.progression),
    "The Heart Plug": CandyBox2ItemData(candy_box_2_base_id + 17, 1, ItemClassification.useful),
    "The Pogo Stick": CandyBox2ItemData(candy_box_2_base_id + 18, 1, ItemClassification.progression),
    "The P Stone": CandyBox2ItemData(candy_box_2_base_id + 19, 1, ItemClassification.progression | ItemClassification.useful),
    ...
    "The Sponge": CandyBox2ItemData(candy_box_2_base_id + 53, 1, ItemClassification.progression),
    "The Shell Powder": CandyBox2ItemData(candy_box_2_base_id + 54, 1, ItemClassification.progression),
    "The Red Fin": CandyBox2ItemData(candy_box_2_base_id + 55, 1, ItemClassification.useful),
    "The Green Fin": CandyBox2ItemData(candy_box_2_base_id + 56, 1, ItemClassification.progression),
