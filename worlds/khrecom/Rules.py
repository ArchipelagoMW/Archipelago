...
def set_rules(multiworld: MultiWorld, player: int):
    ...
    multiworld.get_location("Twilight Town Post Floor (Item Cards Mega-Potion)"                  , player).access_rule = lambda state: has_item(state, player,"World Card Halloween Town") and has_item(state, player,"World Card Atlantica")
    multiworld.get_location("Destiny Islands Post Floor (Enemy Cards Larxene)"                   , player).access_rule = lambda state: has_item(state, player,"World Card Halloween Town") and has_item(state, player,"World Card Atlantica") and has_item(state, player,"World Card Twilight Town")
    multiworld.get_location("Destiny Islands Post Floor (Enemy Cards Riku)"                      , player).access_rule = lambda state: has_item(state, player,"World Card Halloween Town") and has_item(state, player,"World Card Atlantica") and has_item(state, player,"World Card Twilight Town")
    multiworld.get_location("Destiny Islands Post Floor (Attack Cards Oblivion)"                 , player).access_rule = lambda state: has_item(state, player,"World Card Halloween Town") and has_item(state, player,"World Card Atlantica") and has_item(state, player,"World Card Twilight Town")
