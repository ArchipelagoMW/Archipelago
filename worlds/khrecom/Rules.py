...
def set_rules(multiworld: MultiWorld, player: int, options):
   ...
   #multiworld.get_location("11F Exit Hall Riku III (Item Cards Mega-Potion)"                    , player).access_rule = lambda state: has_x_worlds(state, player, 6)
    ...
    multiworld.get_location("Defeat 5 Heartless Air Pirate"                                  , player).access_rule = lambda state: has_item(state, player,"World Card Neverland")
    multiworld.get_location("Defeat 9 Heartless Air Pirate"                                  , player).access_rule = lambda state: has_item(state, player,"World Card Neverland")
    ...
    multiworld.get_location("Defeat 5 Heartless Air Soldier"                                 , player).access_rule = lambda state: has_item(state, player,"World Card Monstro") or has_item(state, player,"World Card Agrabah") or has_item(state, player,"World Card Halloween Town") or has_item(state, player,"World Card Destiny Islands")
    multiworld.get_location("Defeat 9 Heartless Air Soldier"                                 , player).access_rule = lambda state: has_item(state, player,"World Card Monstro") or has_item(state, player,"World Card Agrabah") or has_item(state, player,"World Card Halloween Town") or has_item(state, player,"World Card Destiny Islands")
    ...
    multiworld.get_location("Defeat 5 Heartless Aquatank"                                    , player).access_rule = lambda state: has_item(state, player,"World Card Atlantica")
    multiworld.get_location("Defeat 9 Heartless Aquatank"                                    , player).access_rule = lambda state: has_item(state, player,"World Card Atlantica")
    ...
    multiworld.get_location("Defeat 5 Heartless Bandit"                                      , player).access_rule = lambda state: has_item(state, player,"World Card Agrabah")
    multiworld.get_location("Defeat 9 Heartless Bandit"                                      , player).access_rule = lambda state: has_item(state, player,"World Card Agrabah")
    ...
    multiworld.get_location("Defeat 5 Heartless Barrel Spider"                               , player).access_rule = lambda state: has_item(state, player,"World Card Monstro") or has_item(state, player,"World Card Agrabah") or has_item(state, player,"World Card Neverland") or has_item(state, player,"World Card Destiny Islands")
    multiworld.get_location("Defeat 9 Heartless Barrel Spider"                               , player).access_rule = lambda state: has_item(state, player,"World Card Monstro") or has_item(state, player,"World Card Agrabah") or has_item(state, player,"World Card Neverland") or has_item(state, player,"World Card Destiny Islands")
    ...
    multiworld.get_location("Defeat 5 Heartless Bouncywild"                                  , player).access_rule = lambda state: has_item(state, player,"World Card Olympus Coliseum")
    multiworld.get_location("Defeat 9 Heartless Bouncywild"                                  , player).access_rule = lambda state: has_item(state, player,"World Card Olympus Coliseum")
    ...
    multiworld.get_location("Defeat 5 Heartless Creeper Plant"                               , player).access_rule = lambda state: has_item(state, player,"World Card Wonderland") or has_item(state, player,"World Card Halloween Town") or has_item(state, player,"World Card Destiny Islands")
    multiworld.get_location("Defeat 9 Heartless Creeper Plant"                               , player).access_rule = lambda state: has_item(state, player,"World Card Wonderland") or has_item(state, player,"World Card Halloween Town") or has_item(state, player,"World Card Destiny Islands")
    ...
    multiworld.get_location("Defeat 5 Heartless Crescendo"                                   , player).access_rule = lambda state: has_item(state, player,"World Card Wonderland") or has_item(state, player,"World Card Neverland") or has_item(state, player,"World Card Destiny Islands")
    multiworld.get_location("Defeat 9 Heartless Crescendo"                                   , player).access_rule = lambda state: has_item(state, player,"World Card Wonderland") or has_item(state, player,"World Card Neverland") or has_item(state, player,"World Card Destiny Islands")
    ...
    multiworld.get_location("Defeat 5 Heartless Darkball"                                    , player).access_rule = lambda state: has_item(state, player,"World Card Atlantica") or has_item(state, player,"World Card Neverland") or has_item(state, player,"World Card Destiny Islands") or has_castle_oblivion(state, player)
    multiworld.get_location("Defeat 9 Heartless Darkball"                                    , player).access_rule = lambda state: has_item(state, player,"World Card Atlantica") or has_item(state, player,"World Card Neverland") or has_item(state, player,"World Card Destiny Islands") or has_castle_oblivion(state, player)
    ...
    multiworld.get_location("Defeat 5 Heartless Defender"                                    , player).access_rule = lambda state: has_item(state, player,"World Card Hollow Bastion") or has_castle_oblivion(state, player)
    multiworld.get_location("Defeat 9 Heartless Defender"                                    , player).access_rule = lambda state: has_item(state, player,"World Card Hollow Bastion") or has_castle_oblivion(state, player)
    ...
    multiworld.get_location("Defeat 5 Heartless Fat Bandit"                                  , player).access_rule = lambda state: has_item(state, player,"World Card Agrabah")
    multiworld.get_location("Defeat 9 Heartless Fat Bandit"                                  , player).access_rule = lambda state: has_item(state, player,"World Card Agrabah")
    ...
    multiworld.get_location("Defeat 5 Heartless Gargoyle"                                    , player).access_rule = lambda state: has_item(state, player,"World Card Halloween Town")
    multiworld.get_location("Defeat 9 Heartless Gargoyle"                                    , player).access_rule = lambda state: has_item(state, player,"World Card Halloween Town")
    ...
    multiworld.get_location("Defeat 5 Heartless Green Requiem"                               , player).access_rule = lambda state: has_item(state, player,"World Card Monstro") or has_item(state, player,"World Card Agrabah") or has_castle_oblivion(state, player)
    multiworld.get_location("Defeat 9 Heartless Green Requiem"                               , player).access_rule = lambda state: has_item(state, player,"World Card Monstro") or has_item(state, player,"World Card Agrabah") or has_castle_oblivion(state, player)
    ...
    multiworld.get_location("Defeat 5 Heartless Large Body"                                  , player).access_rule = lambda state: has_item(state, player,"World Card Wonderland") or has_item(state, player,"World Card Olympus Coliseum")
    multiworld.get_location("Defeat 9 Heartless Large Body"                                  , player).access_rule = lambda state: has_item(state, player,"World Card Wonderland") or has_item(state, player,"World Card Olympus Coliseum")
    multiworld.get_location("Defeat 1 Heartless Neoshadow"                                   , player).access_rule = lambda state: has_castle_oblivion(state, player)
    multiworld.get_location("Defeat 5 Heartless Neoshadow"                                   , player).access_rule = lambda state: has_castle_oblivion(state, player)
    multiworld.get_location("Defeat 9 Heartless Neoshadow"                                   , player).access_rule = lambda state: has_castle_oblivion(state, player)
    ...
    multiworld.get_location("Defeat 5 Heartless Pirate"                                      , player).access_rule = lambda state: has_item(state, player,"World Card Neverland")
    multiworld.get_location("Defeat 9 Heartless Pirate"                                      , player).access_rule = lambda state: has_item(state, player,"World Card Neverland")
    ...
    multiworld.get_location("Defeat 5 Heartless Powerwild"                                   , player).access_rule = lambda state: has_item(state, player,"World Card Olympus Coliseum")
    multiworld.get_location("Defeat 9 Heartless Powerwild"                                   , player).access_rule = lambda state: has_item(state, player,"World Card Olympus Coliseum")
    ...
    multiworld.get_location("Defeat 5 Heartless Screwdiver"                                  , player).access_rule = lambda state: has_item(state, player,"World Card Atlantica")
    multiworld.get_location("Defeat 9 Heartless Screwdiver"                                  , player).access_rule = lambda state: has_item(state, player,"World Card Atlantica")
    ...
    multiworld.get_location("Defeat 5 Heartless Sea Neon"                                    , player).access_rule = lambda state: has_item(state, player,"World Card Atlantica")
    multiworld.get_location("Defeat 9 Heartless Sea Neon"                                    , player).access_rule = lambda state: has_item(state, player,"World Card Atlantica")
    ...
    multiworld.get_location("Defeat 5 Heartless Search Ghost"                                , player).access_rule = lambda state: has_item(state, player,"World Card Monstro") or has_item(state, player,"World Card Atlantica")
    multiworld.get_location("Defeat 9 Heartless Search Ghost"                                , player).access_rule = lambda state: has_item(state, player,"World Card Monstro") or has_item(state, player,"World Card Atlantica")
    ...
    multiworld.get_location("Defeat 5 Heartless Tornado Step"                                , player).access_rule = lambda state: has_item(state, player,"World Card Monstro") or has_item(state, player,"World Card Hollow Bastion") or has_item(state, player,"World Card Destiny Islands")
    multiworld.get_location("Defeat 9 Heartless Tornado Step"                                , player).access_rule = lambda state: has_item(state, player,"World Card Monstro") or has_item(state, player,"World Card Hollow Bastion") or has_item(state, player,"World Card Destiny Islands")
    ...
    multiworld.get_location("Defeat 5 Heartless Wight Knight"                                , player).access_rule = lambda state: has_item(state, player,"World Card Halloween Town")
    multiworld.get_location("Defeat 9 Heartless Wight Knight"                                , player).access_rule = lambda state: has_item(state, player,"World Card Halloween Town")
    ...
    multiworld.get_location("Defeat 5 Heartless Wizard"                                      , player).access_rule = lambda state: has_item(state, player,"World Card Hollow Bastion") or has_castle_oblivion(state, player)
    multiworld.get_location("Defeat 9 Heartless Wizard"                                      , player).access_rule = lambda state: has_item(state, player,"World Card Hollow Bastion") or has_castle_oblivion(state, player)
    ...
    multiworld.get_location("Defeat 5 Heartless Wyvern"                                      , player).access_rule = lambda state: has_item(state, player,"World Card Hollow Bastion") or has_castle_oblivion(state, player)
    multiworld.get_location("Defeat 9 Heartless Wyvern"                                      , player).access_rule = lambda state: has_item(state, player,"World Card Hollow Bastion") or has_castle_oblivion(state, player)
    ...
    multiworld.get_location("Defeat 5 Heartless Yellow Opera"                                , player).access_rule = lambda state: has_item(state, player,"World Card Monstro") or has_item(state, player,"World Card Agrabah") or has_item(state, player,"World Card Neverland") or has_castle_oblivion(state, player)
    multiworld.get_location("Defeat 9 Heartless Yellow Opera"                                , player).access_rule = lambda state: has_item(state, player,"World Card Monstro") or has_item(state, player,"World Card Agrabah") or has_item(state, player,"World Card Neverland") or has_castle_oblivion(state, player)
