...
def create_regions(multiworld: MultiWorld, player: int, options):
   ...
   #regions["Twilight Town"].locations.append("11F Exit Hall Riku III (Item Cards Mega-Potion)")
    ...
    regions["Heartless"].locations.append("Defeat 5 Heartless Air Pirate")                                              
    regions["Heartless"].locations.append("Defeat 9 Heartless Air Pirate")                                              
    regions["Heartless"].locations.append("Defeat 1 Heartless Air Soldier")                                             
    regions["Heartless"].locations.append("Defeat 5 Heartless Air Soldier")                                             
    regions["Heartless"].locations.append("Defeat 9 Heartless Air Soldier")                                             
    regions["Heartless"].locations.append("Defeat 1 Heartless Aquatank")                                                
    regions["Heartless"].locations.append("Defeat 5 Heartless Aquatank")                                                
    regions["Heartless"].locations.append("Defeat 9 Heartless Aquatank")                                                
    regions["Heartless"].locations.append("Defeat 1 Heartless Bandit")                                                  
    regions["Heartless"].locations.append("Defeat 5 Heartless Bandit")                                                  
    regions["Heartless"].locations.append("Defeat 9 Heartless Bandit")                                                  
    regions["Heartless"].locations.append("Defeat 1 Heartless Barrel Spider")                                           
    regions["Heartless"].locations.append("Defeat 5 Heartless Barrel Spider")                                           
    regions["Heartless"].locations.append("Defeat 9 Heartless Barrel Spider")                                           
    regions["Heartless"].locations.append("Defeat 1 Heartless Black Fungus")                                            
    regions["Heartless"].locations.append("Defeat 5 Heartless Black Fungus")                                            
    regions["Heartless"].locations.append("Defeat 9 Heartless Black Fungus")                                            
    regions["Heartless"].locations.append("Defeat 1 Heartless Blue Rhapsody")                                           
    regions["Heartless"].locations.append("Defeat 5 Heartless Blue Rhapsody")                                           
    regions["Heartless"].locations.append("Defeat 9 Heartless Blue Rhapsody")                                           
    regions["Heartless"].locations.append("Defeat 1 Heartless Bouncywild")                                              
    regions["Heartless"].locations.append("Defeat 5 Heartless Bouncywild")                                              
    regions["Heartless"].locations.append("Defeat 9 Heartless Bouncywild")                                              
    regions["Heartless"].locations.append("Defeat 1 Heartless Creeper Plant")                                           
    regions["Heartless"].locations.append("Defeat 5 Heartless Creeper Plant")                                           
    regions["Heartless"].locations.append("Defeat 9 Heartless Creeper Plant")                                           
    regions["Heartless"].locations.append("Defeat 1 Heartless Crescendo")                                               
    regions["Heartless"].locations.append("Defeat 5 Heartless Crescendo")                                               
    regions["Heartless"].locations.append("Defeat 9 Heartless Crescendo")                                               
    regions["Heartless"].locations.append("Defeat 1 Heartless Darkball")                                                
    regions["Heartless"].locations.append("Defeat 5 Heartless Darkball")                                                
    regions["Heartless"].locations.append("Defeat 9 Heartless Darkball")                                                
    regions["Heartless"].locations.append("Defeat 1 Heartless Defender")                                                
    regions["Heartless"].locations.append("Defeat 5 Heartless Defender")                                                
    regions["Heartless"].locations.append("Defeat 9 Heartless Defender")                                                
    regions["Heartless"].locations.append("Defeat 1 Heartless Fat Bandit")                                              
    regions["Heartless"].locations.append("Defeat 5 Heartless Fat Bandit")                                              
    regions["Heartless"].locations.append("Defeat 9 Heartless Fat Bandit")                                              
    regions["Heartless"].locations.append("Defeat 1 Heartless Gargoyle")                                                
    regions["Heartless"].locations.append("Defeat 5 Heartless Gargoyle")                                                
    regions["Heartless"].locations.append("Defeat 9 Heartless Gargoyle")                                                
    regions["Heartless"].locations.append("Defeat 1 Heartless Green Requiem")                                           
    regions["Heartless"].locations.append("Defeat 5 Heartless Green Requiem")                                           
    regions["Heartless"].locations.append("Defeat 9 Heartless Green Requiem")                                           
    regions["Heartless"].locations.append("Defeat 1 Heartless Large Body")                                              
    regions["Heartless"].locations.append("Defeat 5 Heartless Large Body")                                              
    regions["Heartless"].locations.append("Defeat 9 Heartless Large Body")                                              
    regions["Heartless"].locations.append("Defeat 1 Heartless Neoshadow")                                               
    regions["Heartless"].locations.append("Defeat 5 Heartless Neoshadow")                                               
    regions["Heartless"].locations.append("Defeat 9 Heartless Neoshadow")                                               
    regions["Heartless"].locations.append("Defeat 1 Heartless Pirate")                                                  
    regions["Heartless"].locations.append("Defeat 5 Heartless Pirate")                                                  
    regions["Heartless"].locations.append("Defeat 9 Heartless Pirate")                                                  
    regions["Heartless"].locations.append("Defeat 1 Heartless Powerwild")                                               
    regions["Heartless"].locations.append("Defeat 5 Heartless Powerwild")                                               
    regions["Heartless"].locations.append("Defeat 9 Heartless Powerwild")                                               
    regions["Heartless"].locations.append("Defeat 1 Heartless Red Nocturne")                                            
    regions["Heartless"].locations.append("Defeat 5 Heartless Red Nocturne")                                            
    regions["Heartless"].locations.append("Defeat 9 Heartless Red Nocturne")                                            
    regions["Heartless"].locations.append("Defeat 1 Heartless Screwdiver")                                              
    regions["Heartless"].locations.append("Defeat 5 Heartless Screwdiver")                                              
    regions["Heartless"].locations.append("Defeat 9 Heartless Screwdiver")                                              
    regions["Heartless"].locations.append("Defeat 1 Heartless Sea Neon")                                                
    regions["Heartless"].locations.append("Defeat 5 Heartless Sea Neon")                                                
    regions["Heartless"].locations.append("Defeat 9 Heartless Sea Neon")                                                
    regions["Heartless"].locations.append("Defeat 1 Heartless Search Ghost")                                            
    regions["Heartless"].locations.append("Defeat 5 Heartless Search Ghost")                                            
    regions["Heartless"].locations.append("Defeat 9 Heartless Search Ghost")                                            
    regions["Heartless"].locations.append("Defeat 1 Heartless Shadow")                                                  
    regions["Heartless"].locations.append("Defeat 5 Heartless Shadow")                                                  
    regions["Heartless"].locations.append("Defeat 9 Heartless Shadow")                                                  
    regions["Heartless"].locations.append("Defeat 1 Heartless Soldier")                                                 
    regions["Heartless"].locations.append("Defeat 5 Heartless Soldier")                                                 
    regions["Heartless"].locations.append("Defeat 9 Heartless Soldier")                                                 
    regions["Heartless"].locations.append("Defeat 1 Heartless Tornado Step")                                            
    regions["Heartless"].locations.append("Defeat 5 Heartless Tornado Step")                                            
    regions["Heartless"].locations.append("Defeat 9 Heartless Tornado Step")                                            
    regions["Heartless"].locations.append("Defeat 1 Heartless White Mushroom")                                          
    regions["Heartless"].locations.append("Defeat 5 Heartless White Mushroom")                                          
    regions["Heartless"].locations.append("Defeat 9 Heartless White Mushroom")                                          
    regions["Heartless"].locations.append("Defeat 1 Heartless Wight Knight")                                            
    regions["Heartless"].locations.append("Defeat 5 Heartless Wight Knight")                                            
    regions["Heartless"].locations.append("Defeat 9 Heartless Wight Knight")                                            
    regions["Heartless"].locations.append("Defeat 1 Heartless Wizard")                                                  
    regions["Heartless"].locations.append("Defeat 5 Heartless Wizard")                                                  
    regions["Heartless"].locations.append("Defeat 9 Heartless Wizard")                                                  
    regions["Heartless"].locations.append("Defeat 1 Heartless Wyvern")                                                  
    regions["Heartless"].locations.append("Defeat 5 Heartless Wyvern")                                                  
    regions["Heartless"].locations.append("Defeat 9 Heartless Wyvern")                                                  
    regions["Heartless"].locations.append("Defeat 1 Heartless Yellow Opera")                                            
    regions["Heartless"].locations.append("Defeat 5 Heartless Yellow Opera")                                            
    regions["Heartless"].locations.append("Defeat 9 Heartless Yellow Opera")                                            
