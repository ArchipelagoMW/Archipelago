...
location_table: Dict[str, KHRECOMLocationData] = {
   ...
   #"Castle Oblivion Bounty (Enemy Cards Lexaeus)":                      KHRECOMLocationData("Days"       ,  269_1304), #Days Location
    ...
    "Starting Checks (Sleight Blizzara)":                                KHRECOMLocationData("Starting"   ,  269_1511),
    "06F Exit Hall Larxene I (Sleight Thundara)":                        KHRECOMLocationData("Progression",  269_1512),
    "Starting Checks (Sleight Cura)":                                    KHRECOMLocationData("Starting"   ,  269_1513),
    ...
    "Starting Checks (Sleight Blizzaga)":                                KHRECOMLocationData("Starting"   ,  269_1518),
    "06F Exit Hall Larxene I (Sleight Thundaga)":                        KHRECOMLocationData("Progression",  269_1519),
    "Starting Checks (Sleight Curaga)":                                  KHRECOMLocationData("Starting"   ,  269_1520),
    ...
    "Starting Checks (Sleight Magic LV2)":                               KHRECOMLocationData("Starting"   ,  269_1565),
    "Starting Checks (Sleight Magic LV3)":                               KHRECOMLocationData("Starting"   ,  269_1566),
    "Twilight Town Room of Rewards (Sleight Stardust Blitz)":            KHRECOMLocationData("Progression",  269_1567),
    "Starting Checks (Sleight Goofy Tornado LV2)":                       KHRECOMLocationData("Starting"   ,  269_1568),
    "Starting Checks (Sleight Goofy Tornado LV3)":                       KHRECOMLocationData("Starting"   ,  269_1569),
    "Starting Checks (Sleight Goofy Smash)":                             KHRECOMLocationData("Starting"   ,  269_1570),
    "Starting Checks (Sleight Wild Crush)":                              KHRECOMLocationData("Starting"   ,  269_1571),
