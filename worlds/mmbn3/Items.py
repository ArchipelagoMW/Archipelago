...
chipList: typing.List[ItemData] = [
    ...
    ItemData(0xB31029, ItemName.Barrier_L, ItemClassification.useful, ItemType.Chip, 173, chip_code('L')),
    ...
    ItemData(0xB31036, ItemName.Geddon1_star, ItemClassification.useful, ItemType.Chip, 138, chip_code('*')),
    ...
    ItemData(0xB31041, ItemName.GutPunch_E, ItemClassification.useful, ItemType.Chip, 47, chip_code('E')),
    ItemData(0xB31042, ItemName.GutsPunch_B, ItemClassification.useful, ItemType.Chip, 47, chip_code('B')),
    ...
    ItemData(0xB31050, ItemName.Navi_plus_40_star, ItemClassification.useful, ItemType.Chip, 206, chip_code('*')),
    ItemData(0xB31051, ItemName.Panic_C, ItemClassification.useful, ItemType.Chip, 41, chip_code('C')),
    ItemData(0xB31052, ItemName.PanlOut3_star, ItemClassification.useful, ItemType.Chip, 120, chip_code('*')),
    ItemData(0xB31053, ItemName.Poltergeist_G, ItemClassification.useful, ItemType.Chip, 213, chip_code('G')),
    ...
    ItemData(0xB31059, ItemName.Recov150_P, ItemClassification.useful, ItemType.Chip, 126, chip_code('P')),
    ItemData(0xB3105A, ItemName.Recov200_N, ItemClassification.useful, ItemType.Chip, 127, chip_code('N')),
    ...
    ItemData(0xB3105D, ItemName.Recov50_G, ItemClassification.useful, ItemType.Chip, 123, chip_code('G')),
    ...
    ItemData(0xB31063, ItemName.SandStage_C, ItemClassification.useful, ItemType.Chip, 182, chip_code('C')),
    ...
    ItemData(0xB31076, ItemName.Tornado_L, ItemClassification.useful, ItemType.Chip, 65, chip_code('L')),
    ...
    ItemData(0xB310B8, ItemName.Roll_R, ItemClassification.useful, ItemType.Chip, 219, chip_code('R')),
    ItemData(0xB310B9, ItemName.RollV2_R, ItemClassification.useful, ItemType.Chip, 220, chip_code('R')),
    ItemData(0xB310BA, ItemName.RollV3_R, ItemClassification.useful, ItemType.Chip, 221, chip_code('R')),

    ItemData(0xB310BB, ItemName.GutsMan_G, ItemClassification.useful, ItemType.Chip, 222, chip_code('G')),
    ItemData(0xB310BC, ItemName.GutsManV2_G, ItemClassification.useful, ItemType.Chip, 223, chip_code('G')),
    ItemData(0xB310BD, ItemName.GutsManV3_G, ItemClassification.useful, ItemType.Chip, 224, chip_code('G')),

    ItemData(0xB310BE, ItemName.ProtoMan_B, ItemClassification.useful, ItemType.Chip, 227, chip_code('B')),
    ItemData(0xB310BF, ItemName.ProtoManV2_B, ItemClassification.useful, ItemType.Chip, 228, chip_code('B')),
    ItemData(0xB310C0, ItemName.ProtoManV3_B, ItemClassification.useful, ItemType.Chip, 229, chip_code('B')),

    ItemData(0xB310C1, ItemName.FlashMan_F, ItemClassification.useful, ItemType.Chip, 232, chip_code('F')),
    ItemData(0xB310C2, ItemName.FlashManV2_F, ItemClassification.useful, ItemType.Chip, 233, chip_code('F')),
    ItemData(0xB310C3, ItemName.FlashManV3_F, ItemClassification.useful, ItemType.Chip, 234, chip_code('F')),

    ItemData(0xB310C4, ItemName.BeastMan_B, ItemClassification.useful, ItemType.Chip, 237, chip_code('B')),
    ItemData(0xB310C5, ItemName.BeastManV2_B, ItemClassification.useful, ItemType.Chip, 238, chip_code('B')),
    ItemData(0xB310C6, ItemName.BeastManV3_B, ItemClassification.useful, ItemType.Chip, 239, chip_code('B')),

    ItemData(0xB310C7, ItemName.BubblMan_B, ItemClassification.useful, ItemType.Chip, 242, chip_code('B')),
    ItemData(0xB310C8, ItemName.BubblManV2_B, ItemClassification.useful, ItemType.Chip, 243, chip_code('B')),
    ItemData(0xB310C9, ItemName.BubblManV3_B, ItemClassification.useful, ItemType.Chip, 244, chip_code('B')),

    ItemData(0xB310CA, ItemName.DesertMan_D, ItemClassification.useful, ItemType.Chip, 247, chip_code('D')),
    ItemData(0xB310CB, ItemName.DesertManV2_D, ItemClassification.useful, ItemType.Chip, 248, chip_code('D')),
    ItemData(0xB310CC, ItemName.DesertManV3_D, ItemClassification.useful, ItemType.Chip, 249, chip_code('D')),

    ItemData(0xB310CD, ItemName.PlantMan_P, ItemClassification.useful, ItemType.Chip, 252, chip_code('P')),
    ItemData(0xB310CE, ItemName.PlantManV2_P, ItemClassification.useful, ItemType.Chip, 253, chip_code('P')),
    ItemData(0xB310CF, ItemName.PlantManV3_P, ItemClassification.useful, ItemType.Chip, 254, chip_code('P')),

    ItemData(0xB310D0, ItemName.FlamMan_F, ItemClassification.useful, ItemType.Chip, 257, chip_code('F')),
    ItemData(0xB310D1, ItemName.FlamManV2_F, ItemClassification.useful, ItemType.Chip, 258, chip_code('F')),
    ItemData(0xB310D2, ItemName.FlamManV3_F, ItemClassification.useful, ItemType.Chip, 259, chip_code('F')),

    ItemData(0xB310D3, ItemName.DrillMan_D, ItemClassification.useful, ItemType.Chip, 262, chip_code('D')),
    ItemData(0xB310D4, ItemName.DrillManV2_D, ItemClassification.useful, ItemType.Chip, 263, chip_code('D')),
    ItemData(0xB310D5, ItemName.DrillManV3_D, ItemClassification.useful, ItemType.Chip, 264, chip_code('D')),

    ItemData(0xB310D6, ItemName.MetalMan_M, ItemClassification.useful, ItemType.Chip, 267, chip_code('M')),
    ItemData(0xB310D7, ItemName.MetalManV2_M, ItemClassification.useful, ItemType.Chip, 268, chip_code('M')),
    ItemData(0xB310D8, ItemName.MetalManV3_M, ItemClassification.useful, ItemType.Chip, 269, chip_code('M')),

    ItemData(0xB310D9, ItemName.KingMan_K, ItemClassification.useful, ItemType.Chip, 277, chip_code('K')),
    ItemData(0xB310DA, ItemName.KingManV2_K, ItemClassification.useful, ItemType.Chip, 278, chip_code('K')),
    ItemData(0xB310DB, ItemName.KingManV3_K, ItemClassification.useful, ItemType.Chip, 279, chip_code('K')),

    ItemData(0xB310DC, ItemName.BowlMan_B, ItemClassification.useful, ItemType.Chip, 287, chip_code('B')),
    ItemData(0xB310DD, ItemName.BowlManV2_B, ItemClassification.useful, ItemType.Chip, 288, chip_code('B')),
