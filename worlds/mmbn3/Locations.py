...
bmds = [
    ...
    LocationData(LocationName.Undernet_4_Bottom_Pillar_BMD, 0xB30017, 0x2000161, 0x1),
    ...
    LocationData(LocationName.School_1_Entrance_BMD,        0xB3002C, 0x2000208, 0x2),
    LocationData(LocationName.School_1_North_Central_BMD,   0xB3002D, 0x2000208, 0x4),
    LocationData(LocationName.School_1_Far_West_BMD_2,      0xB3002E, 0x2000208, 0x1),
    LocationData(LocationName.School_2_Entrance_BMD,        0xB3002F, 0x2000209, 0x4),
    LocationData(LocationName.School_2_South_BMD,           0xB30030, 0x2000209, 0x1),
    LocationData(LocationName.School_2_Mainframe_BMD,       0xB30031, 0x2000209, 0x2),
    ...
    LocationData(LocationName.ACDC_Yais_Phone_BMD,          0xB3005A, 0x2000244, 0x8),
    ...
    LocationData(LocationName.ACDC_School_Server_BMD_1,     0xB3005E, 0x2000242, 0x8),
    LocationData(LocationName.ACDC_School_Server_BMD_2,     0xB3005F, 0x2000242, 0x4),
    ...
    LocationData(LocationName.SciLab_Virus_Lab_BMD,         0xB30062, 0x2000249, 0x8),
    LocationData(LocationName.SciLab_Computer_BMD,          0xB30063, 0x2000241, 0x8),
    LocationData(LocationName.Yoka_Armor_BMD,               0xB30064, 0x2000248, 0x80),
    LocationData(LocationName.Yoka_TV_BMD,                  0xB30065, 0x2000247, 0x8),
    ...
    LocationData(LocationName.Beach_Hospital_Bed_BMD,       0xB3006A, 0x2000245, 0x8),
    ...
    LocationData(LocationName.Beach_Battle_Console_BMD,     0xB3006E, 0x2000243, 0x8),
    LocationData(LocationName.Beach_Security_System_BMD,    0xB3006F, 0x2000244, 0x40),
    LocationData(LocationName.Beach_Broadcast_Computer_BMD, 0xB30070, 0x200024b, 0x2),
    LocationData(LocationName.Hades_Gargoyle_BMD,           0xB30071, 0x200024b, 0x8),
...
pmds = [
    ...
    LocationData(LocationName.SciLab_Computer_PMD,          0xB3007D, 0x2000241, 0x4),
    ...
    LocationData(LocationName.DNN_Main_Console_PMD,         0xB30080, 0x200024b, 0x1),
    LocationData(LocationName.Tamakos_HP_PMD,               0xB30081, 0x200023c, 0x40)
]

overworlds = [
    LocationData(LocationName.Yoka_Quiz_Master,             0xB30082, 0x200005f, 0x8),
    LocationData(LocationName.Hospital_Quiz_Queen,          0xB30083, 0x200005f, 0x2),
    LocationData(LocationName.Hades_Quiz_King,              0xB30084, 0x2000164, 0x8),
    LocationData(LocationName.ACDC_SonicWav_W_Trade,        0xB30085, 0x2000162, 0x10),
    LocationData(LocationName.ACDC_Bubbler_C_Trade,         0xB30086, 0x2000162, 0x8),
    ...
    LocationData(LocationName.Yoka_FireSwrd_P_Trade,        0xB30089, 0x2000162, 0x4),
    LocationData(LocationName.Hospital_DynaWav_V_Trade,     0xB3008A, 0x2000163, 0x4),
    LocationData(LocationName.DNN_WideSwrd_C_Trade,         0xB3008B, 0x2000162, 0x1),
    LocationData(LocationName.DNN_HoleMetr_H_Trade,         0xB3008C, 0x2000164, 0x10),
    LocationData(LocationName.DNN_Shadow_J_Trade,           0xB3008D, 0x2000163, 0x2),
    ...
    LocationData(LocationName.ACDC_School_Desk,             0xB30092, 0x200024c, 0x1),
    LocationData(LocationName.ACDC_Class_5B_Blackboard,     0xB30093, 0x200024c, 0x40),
    LocationData(LocationName.SciLab_Garbage_Can,           0xB30094, 0x200024c, 0x8),
    LocationData(LocationName.Yoka_Inn_TV,                  0xB30095, 0x200024c, 0x80),
    LocationData(LocationName.Yoka_Zoo_Garbage,             0xB30096, 0x200024d, 0x8),
    LocationData(LocationName.Beach_Department_Store,       0xB30097, 0x2000161, 0x40),
    LocationData(LocationName.Beach_Hospital_Vent,          0xB30098, 0x200024c, 0x4),
    LocationData(LocationName.Beach_Hospital_Pink_Door,     0xB30099, 0x200024d, 0x4),
    LocationData(LocationName.Beach_Hospital_Tree,          0xB3009A, 0x200024c, 0x2),
    LocationData(LocationName.Beach_Hospital_Hidden_Conversation, 0xB3009B, 0x2000162, 0x20),
    LocationData(LocationName.Beach_Hospital_Girl,          0xB3009C, 0x2000160, 0x1),
    ...
    LocationData(LocationName.WWW_Wilys_Desk,               0xB300A2, 0x200024d, 0x2)
]

jobs = [
    LocationData(LocationName.Please_deliver_this,          0xB300A3, 0x2000300, 0x8),
    LocationData(LocationName.My_Navi_is_sick,              0xB300A4, 0x2000300, 0x4),
    LocationData(LocationName.Help_me_with_my_son,          0xB300A5, 0x2000300, 0x2),
    LocationData(LocationName.Transmission_error,           0xB300A6, 0x2000300, 0x1),
    ...
    LocationData(LocationName.Will_you_deliver,             0xB300AB, 0x2000301, 0x8),
    ...
    LocationData(LocationName.Somebody_please_help,         0xB300B0, 0x2000301, 0x4),
    LocationData(LocationName.Looking_for_condor,           0xB300B1, 0x2000301, 0x2),
    LocationData(LocationName.Help_with_rehab,              0xB300B2, 0x2000301, 0x1),
    ...
    LocationData(LocationName.Hide_and_seek_First_Child,    0xB300B8, 0x2000188, 0x4),
    LocationData(LocationName.Hide_and_seek_Second_Child,   0xB300B9, 0x2000188, 0x2),
    LocationData(LocationName.Hide_and_seek_Third_Child,    0xB300BA, 0x2000188, 0x1),
    LocationData(LocationName.Hide_and_seek_Fourth_Child,   0xB300BB, 0x2000189, 0x80),
    LocationData(LocationName.Hide_and_seek_Fifth_Child,    0xB300BC, 0x2000302, 0x8),
    LocationData(LocationName.Finding_the_blue_Navi,        0xB300BD, 0x2000031, 0x1),
    LocationData(LocationName.Give_your_support,            0xB300BE, 0x2000302, 0x2),
    LocationData(LocationName.Stamp_collecting,             0xB300BF, 0x2000302, 0x1),
    LocationData(LocationName.Help_with_a_will,             0xB300C0, 0x2000303, 0x80)
]

number_traders = [
    LocationData(LocationName.Numberman_Code_01, 0xB300C1, 0x2000430, 0x1),
    LocationData(LocationName.Numberman_Code_02, 0xB300C2, 0x2000430, 0x2),
    LocationData(LocationName.Numberman_Code_03, 0xB300C3, 0x2000430, 0x4),
    LocationData(LocationName.Numberman_Code_04, 0xB300C4, 0x2000430, 0x8),
    ...
    LocationData(LocationName.Numberman_Code_09, 0xB300C9, 0x2000431, 0x1),
    LocationData(LocationName.Numberman_Code_10, 0xB300CA, 0x2000431, 0x2),
    LocationData(LocationName.Numberman_Code_11, 0xB300CB, 0x2000431, 0x4),
    LocationData(LocationName.Numberman_Code_12, 0xB300CC, 0x2000431, 0x8),
    ...
    LocationData(LocationName.Numberman_Code_16, 0xB300D0, 0x2000432, 0x1),
    LocationData(LocationName.Numberman_Code_17, 0xB300D1, 0x2000432, 0x2),
    LocationData(LocationName.Numberman_Code_18, 0xB300D2, 0x2000432, 0x4),
    LocationData(LocationName.Numberman_Code_19, 0xB300D3, 0x2000432, 0x8),
    ...
    LocationData(LocationName.Numberman_Code_24, 0xB300D8, 0x2000433, 0x1),
    LocationData(LocationName.Numberman_Code_25, 0xB300D9, 0x2000433, 0x2),
    LocationData(LocationName.Numberman_Code_26, 0xB300DA, 0x2000433, 0x4),
    LocationData(LocationName.Numberman_Code_27, 0xB300DB, 0x2000433, 0x8),
...
story_bmds = [
    LocationData(LocationName.Undernet_7_Upper_BMD,         0xB300E0, 0x20001f6, 0x1),
