...
class LocationData:
    ...
    def __init__(self, name, id, flag, mask, text_archive_address=0x0, text_script_index=0x0, text_box_indices=None):
        self.name = name
        self.id = id
        self.flag_byte = flag
        self.flag_mask = mask
...
bmds = [
    ...
    LocationData(LocationName.Hospital_1_North_BMD,         0xb31041, 0x2000218, 0x40, 0x75C864, 231, [1, 2]),
