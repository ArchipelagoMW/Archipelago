...
number_traders = [
    LocationData(LocationName.Numberman_Code_01, 0xb310cd, 0x2000430, 0x80, 0x800000, 30, 0),
    LocationData(LocationName.Numberman_Code_02, 0xb310ce, 0x2000430, 0x40, 0x800000, 31, 0),
    LocationData(LocationName.Numberman_Code_03, 0xb310cf, 0x2000430, 0x20, 0x800000, 32, 0),
    LocationData(LocationName.Numberman_Code_04, 0xb310d0, 0x2000430, 0x10, 0x800000, 33, 0),
    LocationData(LocationName.Numberman_Code_05, 0xb310d1, 0x2000430, 0x08, 0x800000, 34, 0),
    LocationData(LocationName.Numberman_Code_06, 0xb310d2, 0x2000430, 0x04, 0x800000, 35, 0),
    LocationData(LocationName.Numberman_Code_07, 0xb310d3, 0x2000430, 0x02, 0x800000, 36, 0),
    LocationData(LocationName.Numberman_Code_08, 0xb310d4, 0x2000430, 0x01, 0x800000, 37, 0),
    LocationData(LocationName.Numberman_Code_09, 0xb310d5, 0x2000431, 0x80, 0x800000, 38, 0),
    LocationData(LocationName.Numberman_Code_10, 0xb310d6, 0x2000431, 0x40, 0x800000, 39, 0),
    LocationData(LocationName.Numberman_Code_11, 0xb310d7, 0x2000431, 0x20, 0x800000, 40, 0),
    LocationData(LocationName.Numberman_Code_12, 0xb310d8, 0x2000431, 0x10, 0x800000, 41, 0),
    LocationData(LocationName.Numberman_Code_13, 0xb310d9, 0x2000431, 0x08, 0x800000, 42, 0),
    LocationData(LocationName.Numberman_Code_14, 0xb310da, 0x2000431, 0x04, 0x800000, 43, 0),
    LocationData(LocationName.Numberman_Code_15, 0xb310db, 0x2000431, 0x02, 0x800000, 44, 0),
    LocationData(LocationName.Numberman_Code_16, 0xb310dc, 0x2000432, 0x01, 0x800000, 45, 0),
    LocationData(LocationName.Numberman_Code_17, 0xb310dd, 0x2000432, 0x80, 0x800000, 46, 0),
    LocationData(LocationName.Numberman_Code_18, 0xb310de, 0x2000432, 0x40, 0x800000, 47, 0),
    LocationData(LocationName.Numberman_Code_19, 0xb310df, 0x2000432, 0x20, 0x800000, 48, 0),
    LocationData(LocationName.Numberman_Code_20, 0xb310e0, 0x2000432, 0x10, 0x800000, 49, 0),
    ...
    LocationData(LocationName.Numberman_Code_28, 0xb310e8, 0x2000433, 0x10, 0x800000, 57, 0),
    LocationData(LocationName.Numberman_Code_29, 0xb310e9, 0x2000433, 0x08, 0x800000, 58, 0),
    LocationData(LocationName.Numberman_Code_30, 0xb310ea, 0x2000433, 0x04, 0x800000, 59, 0),
