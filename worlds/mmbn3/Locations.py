...
overworlds = [
    ...
    LocationData(LocationName.ACDC_Class_5B_Blackboard,           0xb3109e, 0x200024c, 0x40, 0x737634, 235, 5),
    LocationData(LocationName.SciLab_Garbage_Can,                 0xb3109f, 0x200024c, 0x8, 0x73AC20, 222, 4),
    LocationData(LocationName.Yoka_Inn_TV,                        0xb310a0, 0x200024c, 0x80, 0x747B1C, 237, 4),
