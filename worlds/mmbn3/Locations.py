...
overworlds = [
    ...
    LocationData(LocationName.Beach_DNN_WideSwrd_C_Trade, 0xb31097, 0x2000162, 0x1, 0x750C9C, 192, 0),
    LocationData(LocationName.Beach_DNN_HoleMetr_H_Trade, 0xb31098, 0x2000164, 0x10, 0x751110, 192, 0),
    LocationData(LocationName.Beach_DNN_Shadow_J_Trade, 0xb31099, 0x2000163, 0x2, 0x750248, 192, 0),
    ...
    LocationData(LocationName.ACDC_Class_5B_Bookshelf, 0xb3109e, 0x200024c, 0x40, 0x737634, 235, 5),
    LocationData(LocationName.SciLab_Garbage_Can,                 0xb3109f, 0x200024c, 0x8, 0x73AC20, 222, 4),
    LocationData(LocationName.Yoka_Inn_Jars, 0xb310a0, 0x200024c, 0x80, 0x747B1C, 237, 4),
    ...
    LocationData(LocationName.Beach_Hospital_Plaque, 0xb310a3, 0x200024c, 0x4, 0x754394, 220, 3),
...
number_traders = [
    LocationData(LocationName.Numberman_Code_01, 0xb310cc, 0x2000430, 0x80, 0x800000, 30, 0),
    LocationData(LocationName.Numberman_Code_02, 0xb310cd, 0x2000430, 0x40, 0x800000, 31, 0),
    LocationData(LocationName.Numberman_Code_03, 0xb310ce, 0x2000430, 0x20, 0x800000, 32, 0),
    LocationData(LocationName.Numberman_Code_04, 0xb310cf, 0x2000430, 0x10, 0x800000, 33, 0),
    LocationData(LocationName.Numberman_Code_05, 0xb310d0, 0x2000430, 0x08, 0x800000, 34, 0),
    LocationData(LocationName.Numberman_Code_06, 0xb310d1, 0x2000430, 0x04, 0x800000, 35, 0),
    LocationData(LocationName.Numberman_Code_07, 0xb310d2, 0x2000430, 0x02, 0x800000, 36, 0),
    LocationData(LocationName.Numberman_Code_08, 0xb310d3, 0x2000430, 0x01, 0x800000, 37, 0),
    LocationData(LocationName.Numberman_Code_09, 0xb310d4, 0x2000431, 0x80, 0x800000, 38, 0),
    LocationData(LocationName.Numberman_Code_10, 0xb310d5, 0x2000431, 0x40, 0x800000, 39, 0),
    LocationData(LocationName.Numberman_Code_11, 0xb310d6, 0x2000431, 0x20, 0x800000, 40, 0),
    LocationData(LocationName.Numberman_Code_12, 0xb310d7, 0x2000431, 0x10, 0x800000, 41, 0),
    LocationData(LocationName.Numberman_Code_13, 0xb310d8, 0x2000431, 0x08, 0x800000, 42, 0),
    LocationData(LocationName.Numberman_Code_14, 0xb310d9, 0x2000431, 0x04, 0x800000, 43, 0),
    LocationData(LocationName.Numberman_Code_15, 0xb310da, 0x2000431, 0x02, 0x800000, 44, 0),
    LocationData(LocationName.Numberman_Code_16, 0xb310db, 0x2000432, 0x80, 0x800000, 45, 0),
    LocationData(LocationName.Numberman_Code_17, 0xb310dc, 0x2000432, 0x40, 0x800000, 46, 0),
    LocationData(LocationName.Numberman_Code_18, 0xb310dd, 0x2000432, 0x20, 0x800000, 47, 0),
    LocationData(LocationName.Numberman_Code_19, 0xb310de, 0x2000432, 0x10, 0x800000, 48, 0),
    LocationData(LocationName.Numberman_Code_20, 0xb310df, 0x2000432, 0x08, 0x800000, 49, 0),
    LocationData(LocationName.Numberman_Code_21, 0xb310e0, 0x2000432, 0x04, 0x800000, 50, 0),
    LocationData(LocationName.Numberman_Code_22, 0xb310e1, 0x2000432, 0x02, 0x800000, 51, 0),
    LocationData(LocationName.Numberman_Code_23, 0xb310e2, 0x2000432, 0x01, 0x800000, 52, 0),
    LocationData(LocationName.Numberman_Code_24, 0xb310e3, 0x2000433, 0x80, 0x800000, 53, 0),
    LocationData(LocationName.Numberman_Code_25, 0xb310e4, 0x2000433, 0x40, 0x800000, 54, 0),
    LocationData(LocationName.Numberman_Code_26, 0xb310e5, 0x2000433, 0x20, 0x800000, 55, 0),
    LocationData(LocationName.Numberman_Code_27, 0xb310e6, 0x2000433, 0x10, 0x800000, 56, 0),
    LocationData(LocationName.Numberman_Code_28, 0xb310e7, 0x2000433, 0x08, 0x800000, 57, 0),
    LocationData(LocationName.Numberman_Code_29, 0xb310e8, 0x2000433, 0x04, 0x800000, 58, 0),
    LocationData(LocationName.Numberman_Code_30, 0xb310e9, 0x2000433, 0x02, 0x800000, 59, 0),
    LocationData(LocationName.Numberman_Code_31, 0xb310ea, 0x2000433, 0x01, 0x800000, 60, 0)
]
