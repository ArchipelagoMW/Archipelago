                    ...
                    if third_color not in [first_color, second_color]:
                        for fourth_color in ["y", "p", "c", "w", "u"]:
                            if fourth_color not in [first_color, second_color, third_color]:
                                ...
                                color_code = ''.join(sorted(colors))
                                shapesanity_1_4[f"{color_code} Circle"] = f"Shapesanity Colorful Full {color_region}"
                                shapesanity_1_4[f"{color_code} Square"] = f"Shapesanity Colorful Full {color_region}"
                                shapesanity_1_4[f"{color_code} Star"] = f"Shapesanity Colorful Full {color_region}"
                                shapesanity_1_4[f"{color_code} Windmill"] \
                                    = f"Shapesanity Colorful East Windmill {color_region}"
                        fourth_color = "-"
                        colors = [first_color, second_color, third_color, fourth_color]
            ...
            for first_color in ["r", "g", "b", "y", "p", "c", "w", "u"]:
                for second_color in ["r", "g", "b", "y", "p", "c", "w", "u"]:
                    ...
                    if not first_combo == second_combo:
                        ...
                        shape_regions = ((["East Windmill", "East Windmill", "Colorful Half"] if first_shape == "W"
                                          else ["Colorful Full", "Colorful Full", "Colorful Half"])
                                         if first_shape == second_shape else ["Stitched", "Half-Half", "Stitched"])
                        ...
                        shapesanity_two_sided[f"Adjacent Singles {ordered_combo}"] \
                            = f"Shapesanity {shape_regions[2]} {color_region}"
                                ...
                                if third_combo not in [first_combo, second_combo]:
                                    ...
                                    if not (first_color == second_color == third_color or
                                        ...
                                        shapesanity_three_parts[f"Singles {ordered_all}"] \
                                            = f"Shapesanity Stitched {color_region}"
                                    shape_regions = ["Stitched", "Stitched"] if not second_shape == third_shape \
                                        else ((["East Windmill", "East Windmill"] if first_shape == "W"
                                               else ["Colorful Full", "Colorful Full"])
                                              if first_shape == second_shape else ["Colorful Half-Half", "Stitched"])
                                    ...
                                    for fourth_shape in ["C", "R", "W", "S"]:
                                        for fourth_color in ["r", "g", "b", "y", "p", "c", "w", "u"]:
                                            ...
                                            if fourth_combo not in [first_combo, second_combo, third_combo]:
                                                if not (first_color == second_color == third_color == fourth_color
                                                        or first_shape == second_shape == third_shape == fourth_shape):
                                                    colors = [first_color, second_color, third_color, fourth_color]
                                                    color_region = color_to_needed_building(colors)
