...
This version of the shapez APWorld removes a significant amount of location checks for better performance. However, the 
game and the used client mod are the same.
...
- Levels (minimum 1-25, up to 119 depending on player options, with additional checks for levels 1 and 20)
- Upgrades (minimum tiers II-VIII (2-8), up to CXX (120) depending on player options)
