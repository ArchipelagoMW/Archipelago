...
def set_rules(world: MultiWorld, player: int):
    ...
    if world.state._is_route(world,player,2) and world.rando_love[player]:
        set_rule(world.get_location(("LOVE 6"), player), lambda state: state._reach_snowdin(player))
        set_rule(world.get_location(("LOVE 7"), player), lambda state: state._reach_snowdin(player))
        set_rule(world.get_location(("LOVE 8"), player), lambda state: state._reach_snowdin(player))
        set_rule(world.get_location(("LOVE 9"), player), lambda state: state._reach_waterfall(player))
        set_rule(world.get_location(("LOVE 10"), player), lambda state: state._reach_waterfall(player))
        set_rule(world.get_location(("LOVE 11"), player), lambda state: state._reach_waterfall(player))
        set_rule(world.get_location(("LOVE 12"), player), lambda state: state._reach_hotland(player))
        set_rule(world.get_location(("LOVE 13"), player), lambda state: state._reach_hotland(player))
        set_rule(world.get_location(("LOVE 14"), player), lambda state: state._reach_hotland(player))
        set_rule(world.get_location(("LOVE 15"), player), lambda state: state._reach_core_mettaton(player))
        set_rule(world.get_location(("LOVE 16"), player), lambda state: state._reach_core_mettaton(player))
        set_rule(world.get_location(("LOVE 17"), player), lambda state: state._reach_core_mettaton(player))
        set_rule(world.get_location(("LOVE 18"), player), lambda state: state._reach_core_mettaton(player))
        set_rule(world.get_location(("LOVE 19"), player), lambda state: state._reach_core_mettaton(player))
        set_rule(world.get_location(("LOVE 20"), player), lambda state: state._reach_sans(player))
