...
class MarioLand2World(World):
    ...
    def set_rules(self):
        entrance_rules = {
            ...
            "Macro Zone 3 -> Macro Zone 4": lambda state: state.has("Macro Zone Progression", self.player, 3),
            ...
            "Mario Zone 1 -> Mario Zone 2": lambda state: state.has("Mario Zone Progression", self.player),
        ...
        rules = {
            ...
            # It is possible, however quite difficulty, normally to beat the Moon Stage without Carrot or Space Physics.
            ...
            # visit.
            "Space Zone 2 - Star Stage": lambda state: state.has("Space Physics", self.player)
                        or ((not state.multiworld.shuffle_midway_bells[self.player])
                            and state.has_any(["Mushroom", "Fire Flower", "Carrot"], self.player))
                        or (state.has("Mushroom", self.player)
        ...
        if self.multiworld.golden_coins[self.player] == "progressive":
            self.multiworld.completion_condition[self.player] = lambda state: ([
                ...
                state.has("Pumpkin Zone Progression", self.player, 4),
