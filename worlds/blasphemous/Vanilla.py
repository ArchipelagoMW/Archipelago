...
unrandomized_dict: Dict[str, str] = {
    ...
    "Albero: First gift for Cleofas": "Cord of the True Burying",
    "Albero: Final gift for Cleofas": "Tiento to your Thorned Hairs",
    "Ossuary: Isidora, Voice of the Dead": "Severed Right Eye of the Traitor",
    "MaH: Sierpes' eye": "Broken Left Eye of the Traitor",
    "TRPotS: Perpetva's shrine": "Incomplete Scapular",
    "BotSS: Crisanta's gift": "Holy Wound of Abnegation",
    "BotSS: Esdras' final gift": "Key Grown from Twisted Wood",
    "LotNW: Twisted wood hidden wall": "Crimson Heart of a Miura",
    "KotTW: Gift from the Traitor": "Apodictic Heart of Mea Culpa",
