...
class MessengerRegion(Region):
    ...
    def add_locations(self, name_to_id: Dict[str, int]) -> None:
        ...
        if self.world.options.shuffle_seals and self.name not in {"Searing Crags", "Tower HQ", "Cloud Ruins"}:
        ...
        if self.world.options.shuffle_shards and self.name in MEGA_SHARDS:
