...
SHOP_ITEMS: Dict[str, ShopData] = {
    ...
    "Serendipitous Bodies": ShopData("ENEMY_DROP_HP", 20, 300, "Karuta Plates"),
    "Path of Resilience":   ShopData("DAMAGE_REDUCTION", 100, 500, "Serendipitous Bodies"),
    "Kusari Jacket":        ShopData("HP_UPGRADE_2", 100, 500, "Serendipitous Bodies"),
    "Energy Shuriken":      ShopData("SHURIKEN", 20, 200),
    "Serendipitous Minds":  ShopData("ENEMY_DROP_MANA", 20, 300, "Energy Shuriken"),
    "Prepared Mind":        ShopData("SHURIKEN_UPGRADE_1", 100, 600, "Serendipitous Minds"),
    "Meditation":           ShopData("CHECKPOINT_FULL", 100, 600, {"Prepared Mind", "Kusari Jacket"}),
    "Rejuvenative Spirit":  ShopData("POTION_FULL_HEAL_AND_HP", 300, 800, "Meditation"),
    "Centered Mind":        ShopData("SHURIKEN_UPGRADE_2", 300, 800, "Meditation"),
    ...
    "Focused Power Sense":  ShopData("POWER_SEAL_WORLD_MAP", 300, 600, "Power Sense"),
}
