...
def create_regions(world: MultiWorld, player: int):
    regSS = Region("Menu", "Castle Area", player, world)
    ...
    regBoB = Region("Bob-omb Battlefield", "Bob-omb Battlefield", player, world)
    ...
    regWhomp = Region("Whomp's Fortress", "Whomp's Fortress", player, world)
    ...
    regJRB = Region("Jolly Roger Bay", "Jolly Roger Bay", player, world)
    ...
    regCCM = Region("Cool, Cool Mountain", "Cool, Cool Mountain", player, world)
    ...
    regBBH = Region("Big Boo's Haunt", "Big Boo's Haunt", player, world)
    ...
    regBitDW = Region("Bowser in the Dark World", "Bowser in the Dark World", player, world)
    ...
    regBasement = Region("Basement", "Basement", player, world)
    world.regions.append(regBasement)

    regHMC = Region("Hazy Maze Cave", "Hazy Maze Cave", player, world)
    ...
    regLLL = Region("Lethal Lava Land", "Lethal Lava Land", player, world)
    ...
    regSSL = Region("Shifting Sand Land", "Shifting Sand Land", player, world)
    ...
    regDDD = Region("Dire, Dire Docks", "Dire, Dire Docks", player, world)
    ...
    regBitFS = Region("Bowser in the Fire Sea", "Bowser in the Fire Sea", player, world)
    ...
    regFloor2 = Region("Second Floor", "Second Floor", player, world)
    world.regions.append(regFloor2)

    regSL = Region("Snowman's Land", "Snowman's Land", player, world)
    ...
    regWDW = Region("Wet-Dry World", "Wet-Dry World", player, world)
    ...
    regTTM = Region("Tall, Tall Mountain", "Tall, Tall Mountain", player, world)
    ...
    regTHI = Region("Tiny-Huge Island", "Tiny-Huge Island", player, world)
    ...
    regFloor3 = Region("Third Floor", "Third Floor", player, world)
    world.regions.append(regFloor3)

    regTTC = Region("Tick Tock Clock", "Tick Tock Clock", player, world)
    ...
    regRR = Region("Rainbow Ride", "Rainbow Ride", player, world)
