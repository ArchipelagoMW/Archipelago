...
def create_regions(world: MultiWorld, player: int):
    ...
    regBoB = Region("Bob-omb Battlefield", player, world)
    ...
    regWhomp = Region("Whomp's Fortress", player, world)
    ...
    regJRB = Region("Jolly Roger Bay", player, world)
    ...
    regCCM = Region("Cool, Cool Mountain", player, world)
    ...
    regBBH = Region("Big Boo's Haunt", player, world)
    ...
    regBitDW = Region("Bowser in the Dark World", player, world)
    ...
    regBasement = Region("Basement", player, world)
    world.regions.append(regBasement)

    regHMC = Region("Hazy Maze Cave", player, world)
    ...
    regLLL = Region("Lethal Lava Land", player, world)
    ...
    regSSL = Region("Shifting Sand Land", player, world)
    ...
    regDDD = Region("Dire, Dire Docks", player, world)
    ...
    regBitFS = Region("Bowser in the Fire Sea", player, world)
    ...
    regFloor2 = Region("Second Floor", player, world)
    world.regions.append(regFloor2)

    regSL = Region("Snowman's Land", player, world)
    ...
    regWDW = Region("Wet-Dry World", player, world)
    ...
    regTTM = Region("Tall, Tall Mountain", player, world)
    ...
    regTHI = Region("Tiny-Huge Island", player, world)
    ...
    regFloor3 = Region("Third Floor", player, world)
    world.regions.append(regFloor3)

    regTTC = Region("Tick Tock Clock", player, world)
    ...
    regRR = Region("Rainbow Ride", player, world)
