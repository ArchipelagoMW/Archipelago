...
class SpiritTracksStartingTime(Range):
    """
    How much time to start with in your Spirit Tracks, in minutes
    """
    display_name = "Spirit Tracks Starting Time"
    range_start = 0
    range_end = 30
    default = 10


class SpiritTracksTimeIncrement(Range):
    """
...
class SpiritTracksTriforceCrestRandomization(Toggle):
    """
...
class SpiritTracksBellumAccess(Choice):
    """
...
class SpiritTracksBoatRequriesSeaChart(Toggle):
    """
...
class SpiritTracksFogSettings(Choice):
    """
...
class SpiritTracksRandomizeHarrow(Toggle):
    """
...
class SpiritTracksGhostShipInDungeonPool(Choice):
    """
...
class SpiritTracksTotokInDungeonPool(Toggle):
    """
...
class SpiritTracksRandomizeMaskedBeedle(Toggle):
    """
...
class SpiritTracksExcludeNonRequriedDungeons(Toggle):
    """
...
class SpiritTracksHintSpiritIsland(Choice):
    """
...
class SpiritTracksOptions(PerGameCommonOptions):
    ...
    exclude_non_required_dungeons: SpiritTracksExcludeNonRequriedDungeons
    #bellum_access: SpiritTracksBellumAccess
    #ghost_ship_in_dungeon_pool: SpiritTracksGhostShipInDungeonPool
    totok_in_dungeon_pool: SpiritTracksTotokInDungeonPool

    # Logic options
    logic: SpiritTracksLogic
    phantom_combat_difficulty: SpiritTracksPhantomCombatDifficulty
    #boat_requires_sea_chart: SpiritTracksBoatRequriesSeaChart

    # Item Randomization
    keysanity: SpiritTracksKeyRandomization
    #randomize_frogs: SpiritTracksFrogRandomization
    #randomize_triforce_crest: SpiritTracksTriforceCrestRandomization
    #randomize_harrow: SpiritTracksRandomizeHarrow
    #randomize_masked_beedle: SpiritTracksRandomizeMaskedBeedle

    # Hint Options
    dungeon_hints: SpiritTracksDungeonHints
    shop_hints: SpiritTracksShopHints
    #spirit_island_hints: SpiritTracksHintSpiritIsland

    # World Options
    #fog_settings: SpiritTracksFogSettings

    # Spirit Tracks
    #ph_starting_time: SpiritTracksStartingTime
    #ph_time_increment: SpiritTracksTimeIncrement
