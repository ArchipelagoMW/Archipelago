...
# Locations are encoded as 8-bit numbers as follows:
#                   | 7 | 6 | 5 | 4 | 3 | 2 | 1 | 0 |
# Jewel pieces:     |  passage  | level | 0 | qdrnt |
# CD:               |  passage  | level | 1   0   0 |
# Full health item: |  passage  | level | 1   0   1 |
#
# passage = 0-5 for entry/emerald/ruby/topaz/sapphire/golden
# level = 0-3 increasing deeper; entry passage and golden pyramid only have 0
# qdrnt = 0-3 for top right/top left/bot left/bot right
#
# Archipelago item IDs are 0xEC appended to the encoded ID like with items

def location_id(passage, level, encoded_id):
	return 0xEC00 | passage << 5 | level << 3 | encoded_id

box_location_table = {
	# Entry Passage
	LocationName.hall_of_hieroglyphs.jewels.ne:  location_id(0, 0, 0),
	LocationName.hall_of_hieroglyphs.jewels.nw:  location_id(0, 0, 1),
	LocationName.hall_of_hieroglyphs.jewels.sw:  location_id(0, 0, 2),
	LocationName.hall_of_hieroglyphs.jewels.se:  location_id(0, 0, 3),
	LocationName.hall_of_hieroglyphs.fullhealth: location_id(0, 0, 5),
	#
	# Emerald Passage
	LocationName.palm_tree_paradise.jewels.ne:  location_id(1, 0, 0),
	LocationName.palm_tree_paradise.jewels.nw:  location_id(1, 0, 1),
	LocationName.palm_tree_paradise.jewels.sw:  location_id(1, 0, 2),
	LocationName.palm_tree_paradise.jewels.se:  location_id(1, 0, 3),
	...
	LocationName.wildflower_fields.jewels.nw:  location_id(1, 1, 1),
	LocationName.wildflower_fields.jewels.sw:  location_id(1, 1, 2),
	LocationName.wildflower_fields.jewels.se:  location_id(1, 1, 3),
	...
	LocationName.mystic_lake.jewels.nw:  location_id(1, 2, 1),
	LocationName.mystic_lake.jewels.sw:  location_id(1, 2, 2),
	LocationName.mystic_lake.jewels.se:  location_id(1, 2, 3),
	...
	LocationName.monsoon_jungle.jewels.nw:  location_id(1, 3, 1),
	LocationName.monsoon_jungle.jewels.sw:  location_id(1, 3, 2),
	LocationName.monsoon_jungle.jewels.se:  location_id(1, 3, 3),
	...
	LocationName.curious_factory.jewels.nw:  location_id(2, 0, 1),
	LocationName.curious_factory.jewels.sw:  location_id(2, 0, 2),
	LocationName.curious_factory.jewels.se:  location_id(2, 0, 3),
	...
	LocationName.toxic_landfill.jewels.nw:  location_id(2, 1, 1),
	LocationName.toxic_landfill.jewels.sw:  location_id(2, 1, 2),
	LocationName.toxic_landfill.jewels.se:  location_id(2, 1, 3),
	...
	LocationName.forty_below_fridge.jewels.nw:  location_id(2, 2, 1),
	LocationName.forty_below_fridge.jewels.sw:  location_id(2, 2, 2),
	LocationName.forty_below_fridge.jewels.se:  location_id(2, 2, 3),
	...
	LocationName.pinball_zone.jewels.nw:  location_id(2, 3, 1),
	LocationName.pinball_zone.jewels.sw:  location_id(2, 3, 2),
	LocationName.pinball_zone.jewels.se:  location_id(2, 3, 3),
	...
	LocationName.toy_block_tower.jewels.nw:  location_id(3, 0, 1),
	LocationName.toy_block_tower.jewels.sw:  location_id(3, 0, 2),
	LocationName.toy_block_tower.jewels.se:  location_id(3, 0, 3),
	...
	LocationName.big_board.jewels.nw:  location_id(3, 1, 1),
	LocationName.big_board.jewels.sw:  location_id(3, 1, 2),
	LocationName.big_board.jewels.se:  location_id(3, 1, 3),
	...
	LocationName.doodle_woods.jewels.nw:  location_id(3, 2, 1),
	LocationName.doodle_woods.jewels.sw:  location_id(3, 2, 2),
	LocationName.doodle_woods.jewels.se:  location_id(3, 2, 3),
	...
	LocationName.domino_row.jewels.nw:  location_id(3, 3, 1),
	LocationName.domino_row.jewels.sw:  location_id(3, 3, 2),
	LocationName.domino_row.jewels.se:  location_id(3, 3, 3),
	...
	LocationName.crescent_moon_village.jewels.nw:  location_id(4, 0, 1),
	LocationName.crescent_moon_village.jewels.sw:  location_id(4, 0, 2),
	LocationName.crescent_moon_village.jewels.se:  location_id(4, 0, 3),
	...
	LocationName.arabian_night.jewels.nw:  location_id(4, 1, 1),
	LocationName.arabian_night.jewels.sw:  location_id(4, 1, 2),
	LocationName.arabian_night.jewels.se:  location_id(4, 1, 3),
	...
	LocationName.fiery_cavern.jewels.nw:  location_id(4, 2, 1),
	LocationName.fiery_cavern.jewels.sw:  location_id(4, 2, 2),
	LocationName.fiery_cavern.jewels.se:  location_id(4, 2, 3),
	...
	LocationName.hotel_horror.jewels.nw:  location_id(4, 3, 1),
	LocationName.hotel_horror.jewels.sw:  location_id(4, 3, 2),
	LocationName.hotel_horror.jewels.se:  location_id(4, 3, 3),
	...
	LocationName.golden_passage.jewels.nw: location_id(5, 0, 1),
	LocationName.golden_passage.jewels.sw: location_id(5, 0, 2),
	LocationName.golden_passage.jewels.se: location_id(5, 0, 3),
}
