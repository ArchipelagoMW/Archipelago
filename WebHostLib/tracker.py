...
if "Starcraft 2" in network_data_package["games"]:
    def render_Starcraft2_tracker(tracker_data: TrackerData, team: int, player: int) -> str:
        ...
        icons = {
            ...
            "Projectile Accelerator (Bunker)":             organics_icon_base_url + "ProjectileAccelerator.png",
            ...
            "Hellstorm Batteries (Missile Turret)":        organics_icon_base_url + "HellstormBatteries.png",
            "Advanced Construction (SCV)":                 organics_icon_base_url + "AdvancedConstruction.png",
            "Dual-Fusion Welders (SCV)":                   organics_icon_base_url + "Dual-FusionWelders.png",
            ...
            "Planetary Command Module":                    "FIXME",
            ...
            "Stimpack (Marine)":                           organics_icon_base_url + "StimpacksCampaign.png",
            "Super Stimpack (Marine)":                     github_icon_base_url + "blizzard/btn-upgrade-terran-superstimppack.png",
            "Combat Shield (Marine)":                      organics_icon_base_url + "CombatShieldCampaign.png",
            ...
            "Stabilizer Medpacks (Medic)":                 organics_icon_base_url + "StabilizerMedpacks.png",
            ...
            "Incinerator Gauntlets (Firebat)":             organics_icon_base_url + "IncineratorGauntlets.png",
            "Juggernaut Plating (Firebat)":                organics_icon_base_url + "JuggernautPlating.png",
            "Stimpack (Firebat)":                          organics_icon_base_url + "StimpacksCampaign.png",
            ...
            "Concussive Shells (Marauder)":                organics_icon_base_url + "ConcussiveShellsCampaign.png",
            "Kinetic Foam (Marauder)":                     organics_icon_base_url + "KineticFoam.png",
            "Stimpack (Marauder)":                         organics_icon_base_url + "StimpacksCampaign.png",
            ...
            "G-4 Clusterbomb (Reaper)":                    organics_icon_base_url + "G-4Clusterbomb.png",
            "Stimpack (Reaper)":                           organics_icon_base_url + "StimpacksCampaign.png",
            ...
            "Crius Suit (Ghost)":                          organics_icon_base_url + "CriusSuit.png",
            ...
            "Nyx-Class Cloaking Module (Spectre)":         organics_icon_base_url + "Nyx-ClassCloakingModule.png",
            ...
            "Twin-Linked Flamethrower (Hellion)":          organics_icon_base_url + "Twin-LinkedFlamethrower.png",
            "Thermite Filaments (Hellion)":                organics_icon_base_url + "ThermiteFilaments.png",
            ...
            "Stimpack (Hellion)":                          organics_icon_base_url + "StimpacksCampaign.png",
            ...
            "Cerberus Mine (Spider Mine)":                 organics_icon_base_url + "CerberusMine.png",
            "High Explosive Munition (Spider Mine)":       github_icon_base_url + "original/btn-ability-terran-spidermine.png",
            "Replenishable Magazine (Vulture)":            organics_icon_base_url + "ReplenishableMagazine.png",
            ...
            "Multi-Lock Weapons System (Goliath)":         organics_icon_base_url + "Multi-LockWeaponsSystem.png",
            "Ares-Class Targeting System (Goliath)":       organics_icon_base_url + "Ares-ClassTargetingSystem.png",
            ...
            "Maelstrom Rounds (Siege Tank)":               organics_icon_base_url + "MaelstromRounds.png",
            ...
            "330mm Barrage Cannon (Thor)":                 organics_icon_base_url + "330mmBarrageCannon.png",
            ...
            "Advanced Healing AI (Medivac)":               organics_icon_base_url + "AdvancedHealingAI.png",
            ...
            "Displacement Field (Wraith)":                 organics_icon_base_url + "DisplacementField.png",
            "Advanced Laser Technology (Wraith)":          github_icon_base_url + "blizzard/btn-upgrade-swann-improvedburstlaser.png",
            "Ripwave Missiles (Viking)":                   organics_icon_base_url + "RipwaveMissiles.png",
            "Phobos-Class Weapons System (Viking)":        organics_icon_base_url + "Phobos-ClassWeaponsSystem.png",
            ...
            "Shockwave Missile Battery (Banshee)":         organics_icon_base_url + "ShockwaveMissileBattery.png",
            ...
            "Defensive Matrix (Science Vessel)":           organics_icon_base_url + "DefensiveMatrix.png",
            ...
            "Enhanced Cluster Launchers (Valkyrie)":       organics_icon_base_url + "HellstormBatteries.png",
