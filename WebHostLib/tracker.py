...
if "Factorio" in network_data_package["games"]:
    factorio_item_mapping = {
        "advanced-circuit": ["advanced-circuit"],
        "advanced-combinators": ["selector-combinator"],
        "progressive-advanced-material-processing": ["steel-furnace"],
        "progressive-advanced-material-processing-2": ["electric-furnace"],
        "progressive-processing-4": [
            "advanced-oil-processing", "heavy-oil-cracking", "light-oil-cracking", "solid-fuel-from-heavy-oil",
            "solid-fuel-from-light-oil"
        ],
        "artillery": ["artillery-wagon", "artillery-turret", "artillery-shell"],
        "progressive-rocketry-3": ["atomic-bomb"],
        "progressive-train-network-2": ["train-stop", "rail-signal", "rail-chain-signal"],
        "progressive-automation": ["assembling-machine-1", "long-handed-inserter"],
        "progressive-automation-2": ["assembling-machine-2"],
        "progressive-automation-3": ["assembling-machine-3"],
        "automation-science-pack": ["automation-science-pack"],
        "progressive-vehicle-1": ["car"],
        "battery": ["battery"],
        "progressive-personal-battery-1": ["battery-equipment"],
        "progressive-personal-battery-2": ["battery-mk2-equipment"],
        "belt-immunity-equipment": ["belt-immunity-equipment"],
        "progressive-train-network-3": ["braking-force-1"],
        "progressive-train-network-4": ["braking-force-2"],
        "progressive-train-network-5": ["braking-force-3"],
        "progressive-train-network-6": ["braking-force-4"],
        "progressive-train-network-7": ["braking-force-5"],
        "progressive-train-network-8": ["braking-force-6"],
        "progressive-train-network-9": ["braking-force-7"],
        "progressive-inserter-2": ["bulk-inserter"],
        "progressive-science-pack-3": ["chemical-science-pack"],
        "circuit-network": [
            "arithmetic-combinator", "decider-combinator", "constant-combinator", "power-switch",
            "programmable-speaker", "display-panel", "iron-stick"
        ],
        "cliff-explosives": ["cliff-explosives"],
        "progressive-processing-5": ["coal-liquefaction"],
        "concrete": ["concrete", "hazard-concrete", "refined-concrete", "refined-hazard-concrete", "iron-stick"],
        "construction-robotics": ["roboport", "passive-provider-chest", "storage-chest", "construction-robot"],
        "progressive-follower-1": ["defender-capsule"],
        "progressive-follower-3": ["destroyer-capsule"],
        "discharge-defense-equipment": ["discharge-defense-equipment"],
        "progressive-follower-2": ["distractor-capsule"],
        "effect-transmission": ["beacon"],
        "progressive-efficiency-module": ["efficiency-module"],
        "progressive-efficiency-module-2": ["efficiency-module-2"],
        "progressive-efficiency-module-3": ["efficiency-module-3"],
        "electric-energy-accumulators": ["accumulator"],
        "progressive-electric-energy-distribution-1": ["medium-electric-pole", "big-electric-pole", "iron-stick"],
        "progressive-electric-energy-distribution-2": ["substation"],
        "progressive-engine-2": ["electric-engine-unit"],
        "electric-mining-drill": ["electric-mining-drill"],
        "electronics": ["copper-cable", "electronic-circuit", "lab", "inserter", "small-electric-pole"],
        "progressive-energy-shield-1": ["energy-shield-equipment"],
        "progressive-energy-shield-2": ["energy-shield-mk2-equipment"],
        "progressive-engine-1": ["engine-unit"],
        "exoskeleton-equipment": ["exoskeleton-equipment"],
        "progressive-rocketry-2": ["explosive-rocket"],
        "explosives": ["explosives"],
        "progressive-inserter-1": ["fast-inserter"],
        "fission-reactor-equipment": ["fission-reactor-equipment"],
        "progressive-flamethrower-1": ["flamethrower", "flamethrower-ammo", "flamethrower-turret"],
        "flammables": [],
        "progressive-fluid-handling-1": [
            "storage-tank", "pump", "barrel", "water-barrel", "empty-water-barrel", "sulfuric-acid-barrel",
            "empty-sulfuric-acid-barrel", "crude-oil-barrel", "empty-crude-oil-barrel", "heavy-oil-barrel",
            "empty-heavy-oil-barrel", "light-oil-barrel", "empty-light-oil-barrel", "petroleum-gas-barrel",
            "empty-petroleum-gas-barrel", "lubricant-barrel", "empty-lubricant-barrel"
        ],
        "progressive-fluid-handling-2": ["fluid-wagon"],
        "progressive-follower-robot-count-1": [],
        "progressive-follower-robot-count-2": [],
        "progressive-follower-robot-count-3": [],
        "progressive-follower-robot-count-4": [],
        "progressive-wall-2": ["gate"],
        "progressive-turret-1": ["gun-turret"],
        "progressive-armor-1": ["heavy-armor"],
        "progressive-inserter-3": ["inserter-capacity-bonus-1"],
        "progressive-inserter-4": ["inserter-capacity-bonus-2"],
        "progressive-inserter-5": ["inserter-capacity-bonus-3"],
        "progressive-inserter-6": ["inserter-capacity-bonus-4"],
        "progressive-inserter-7": ["inserter-capacity-bonus-5"],
        "progressive-inserter-8": ["inserter-capacity-bonus-6"],
        "progressive-inserter-9": ["inserter-capacity-bonus-7"],
        "progressive-processing-7": ["kovarex-enrichment-process", "nuclear-fuel"],
        "lamp": ["small-lamp"],
        "land-mine": ["land-mine"],
        "landfill": ["landfill"],
        "laser": [],
        "progressive-laser-shooting-speed-1": [],
        "progressive-laser-shooting-speed-2": [],
        "progressive-laser-shooting-speed-3": [],
        "progressive-laser-shooting-speed-4": [],
        "progressive-laser-shooting-speed-5": [],
        "progressive-laser-shooting-speed-6": [],
        "progressive-laser-shooting-speed-7": [],
        "progressive-turret-2": ["laser-turret"],
        "progressive-laser-weapons-damage-1": [],
        "progressive-laser-weapons-damage-2": [],
        "progressive-laser-weapons-damage-3": [],
        "progressive-laser-weapons-damage-4": [],
        "progressive-laser-weapons-damage-5": [],
        "progressive-laser-weapons-damage-6": [],
        "logistic-robotics": ["roboport", "passive-provider-chest", "storage-chest", "logistic-robot"],
        "progressive-science-pack-1": ["logistic-science-pack"],
        "logistic-system": ["active-provider-chest", "requester-chest", "buffer-chest"],
        "progressive-logistics": ["underground-belt", "splitter"],
        "progressive-logistics-2": ["fast-transport-belt", "fast-underground-belt", "fast-splitter"],
        "progressive-logistics-3": ["express-transport-belt", "express-underground-belt", "express-splitter"],
        "low-density-structure": ["low-density-structure"],
        "lubricant": ["lubricant"],
        "progressive-military": ["submachine-gun", "shotgun", "shotgun-shell"],
        "progressive-military-2": ["piercing-rounds-magazine", "grenade"],
        "progressive-military-3": ["poison-capsule", "slowdown-capsule", "combat-shotgun"],
        "progressive-military-4": ["piercing-shotgun-shell", "cluster-grenade"],
        "progressive-science-pack-2": ["military-science-pack"],
        "progressive-mining-productivity-1": [],
        "progressive-mining-productivity-2": [],
        "progressive-mining-productivity-3": [],
        "progressive-armor-2": ["modular-armor"],
        "modules": [],
        "night-vision-equipment": ["night-vision-equipment"],
        "progressive-processing-8": ["nuclear-fuel-reprocessing"],
        "nuclear-power": ["nuclear-reactor", "heat-exchanger", "heat-pipe", "steam-turbine", "uranium-fuel-cell"],
        "oil-gathering": ["pumpjack"],
        "progressive-processing-2": [
            "oil-refinery", "chemical-plant", "basic-oil-processing", "solid-fuel-from-petroleum-gas", "petroleum"
        ],
        "personal-laser-defense-equipment": ["personal-laser-defense-equipment"],
        "progressive-personal-roboport-equipment-1": ["personal-roboport-equipment"],
        "progressive-personal-roboport-equipment-2": ["personal-roboport-mk2-equipment"],
        "progressive-physical-projectile-damage-1": [],
        "progressive-physical-projectile-damage-2": [],
        "progressive-physical-projectile-damage-3": [],
        "progressive-physical-projectile-damage-4": [],
        "progressive-physical-projectile-damage-5": [],
        "progressive-physical-projectile-damage-6": [],
        "plastics": ["plastic-bar"],
        "progressive-armor-3": ["power-armor"],
        "progressive-armor-4": ["power-armor-mk2"],
        "processing-unit": ["processing-unit"],
        "progressive-science-pack-4": ["production-science-pack"],
        "progressive-productivity-module": ["productivity-module"],
        "progressive-productivity-module-2": ["productivity-module-2"],
        "progressive-productivity-module-3": ["productivity-module-3"],
        "radar": ["radar"],
        "progressive-train-network-1": ["rail", "locomotive", "cargo-wagon", "iron-stick"],
        "progressive-flamethrower-2": ["refined-flammables-1"],
        "progressive-flamethrower-3": ["refined-flammables-2"],
        "progressive-flamethrower-4": ["refined-flammables-3"],
        "progressive-flamethrower-5": ["refined-flammables-4"],
        "progressive-flamethrower-6": ["refined-flammables-5"],
        "progressive-flamethrower-7": ["refined-flammables-6"],
        "repair-pack": ["repair-pack"],
        "progressive-research-speed-1": [],
        "progressive-research-speed-2": [],
        "progressive-research-speed-3": [],
        "progressive-research-speed-4": [],
        "progressive-research-speed-5": [],
        "progressive-research-speed-6": [],
        "robotics": ["flying-robot-frame"],
        "rocket-fuel": ["rocket-fuel"],
        "rocket-silo": ["rocket-silo", "rocket-part", "cargo-landing-pad", "satellite"],
        "progressive-rocketry-1": ["rocket-launcher", "rocket"],
        "solar-energy": ["solar-panel"],
        "solar-panel-equipment": ["solar-panel-equipment"],
        "progressive-science-pack-6": ["space-science-pack"],
        "progressive-speed-module": ["speed-module"],
        "progressive-speed-module-2": ["speed-module-2"],
        "progressive-speed-module-3": ["speed-module-3"],
        "progressive-vehicle-3": ["spidertron"],
        "steam-power": ["pipe", "pipe-to-ground", "offshore-pump", "boiler", "steam-engine"],
        "steel-axe": [],
        "progressive-processing-1": ["steel-plate", "steel-chest"],
        "progressive-wall-1": ["stone-wall"],
        "progressive-stronger-explosives-1": [],
        "progressive-stronger-explosives-2": [],
        "progressive-stronger-explosives-3": [],
        "progressive-stronger-explosives-4": [],
        "progressive-stronger-explosives-5": [],
        "progressive-stronger-explosives-6": [],
        "progressive-processing-3": ["sulfuric-acid", "sulfur"],
        "progressive-vehicle-2": ["tank", "cannon-shell", "explosive-cannon-shell"],
        "toolbelt": [],
        "uranium-ammo": ["uranium-rounds-magazine", "uranium-cannon-shell", "explosive-uranium-cannon-shell"],
        "uranium-mining": [],
        "progressive-processing-6": ["centrifuge", "uranium-processing"],
        "progressive-science-pack-5": ["utility-science-pack"],
        "progressive-weapon-shooting-speed-1": [],
        "progressive-weapon-shooting-speed-2": [],
        "progressive-weapon-shooting-speed-3": [],
        "progressive-weapon-shooting-speed-4": [],
        "progressive-weapon-shooting-speed-5": [],
        "progressive-weapon-shooting-speed-6": [],
        "progressive-worker-robots-speed-1": [],
        "progressive-worker-robots-speed-2": [],
        "progressive-worker-robots-speed-3": [],
        "progressive-worker-robots-speed-4": [],
        "progressive-worker-robots-speed-5": [],
        "progressive-worker-robots-storage-1": [],
        "progressive-worker-robots-storage-2": [],
        "progressive-worker-robots-storage-3": []
    }

    def factorio_process_mapping(key: str, source: Dict[str, List[str]], target: Dict[str, int]):
        if not key in source:
            target[key] = 1
        else:
            for unlock in source[key]:
                target[unlock] = 1

        return

    def revert_mapping(source: Dict[str, int]):
        target: Dict[str, int] = {
            "offshore-pump": 1,
            "boiler": 1,
            "steam-engine": 1,
        ...
        for k in source:
            factorio_process_mapping(k, factorio_item_mapping, target)
            for progression in range(source[k]):
                factorio_process_mapping(k + '-' + str(progression + 1), factorio_item_mapping, target)
    ...
    def render_Factorio_tracker(tracker_data: TrackerData, team: int, player: int):
        inventory = revert_mapping(collections.Counter({
