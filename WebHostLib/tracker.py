...
if "Minecraft" in network_data_package["games"]:
    ...
    __player_trackers["Minecraft"] = render_Minecraft_tracker
...
if "Ocarina of Time" in network_data_package["games"]:
    ...
    __player_trackers["Ocarina of Time"] = render_OcarinaOfTime_tracker
...
if "Timespinner" in network_data_package["games"]:
    ...
    __player_trackers["Timespinner"] = render_Timespinner_tracker
...
if "Super Metroid" in network_data_package["games"]:
    ...
    __player_trackers["Super Metroid"] = render_SuperMetroid_tracker
...
if "ChecksFinder" in network_data_package["games"]:
    ...
    __player_trackers["ChecksFinder"] = render_ChecksFinder_tracker
...
if "Starcraft 2 Wings of Liberty" in network_data_package["games"]:
    ...
    __player_trackers["Starcraft 2 Wings of Liberty"] = render_Starcraft2WingsOfLiberty_tracker
