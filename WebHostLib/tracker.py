...
if "A Link to the Past" in network_data_package["games"].keys():
    ...
    # def render_ALinkToThePast_tracker(room_state: RoomState, tracked_team: int, tracked_player: int, inventory: Counter) -> str:
    #     # Helper objects.
    #     alttp_id_lookup = {name: id for id, name in room_state.data.item_id_to_name["A Link to the Past"].items()}
    #
    #     groups = room_state.data.groups
    #     links = {
    #         "Bow":                   "Progressive Bow",
    #         "Silver Arrows":         "Progressive Bow",
    #         "Silver Bow":            "Progressive Bow",
    ...
    #         "Ice Palace":         {59872, 59875, 59812, 59818, 59860, 59797, 1573207, 59869},
    #         "Misery Mire":        {60001, 60004, 60007, 60010, 60013, 1573208, 59866, 59998},
    #         "Turtle Rock":        {59938, 59941, 59944, 1573209, 59947, 59950, 59953, 59956, 59926, 59929, 59932,
    #                                59935},
    #         "Palace of Darkness": {
    #             59968, 59971, 59974, 59977, 59980, 59983, 59986, 1573203, 59989, 59959, 59992, 59962, 59995,
    #             59965
    ...
    #         return loc_to_area
    #
    #     def _attribute_item_solo(item: int):
    ...
    #     # for location in room_state.data.locations[tracked_player]:
    #     #     if room_state.checked_locations:
    #               pass
    #
    #     for (ms_team, ms_player), locations_checked in room_state.multisave.get("location_checks", {}).items():
    #         # Skip teams and players not matching the request
    #         player_locations = room_state.data.locations[ms_player]
    ...
    #     if room_state.states[tracked_team, tracked_player] == ClientStatus.CLIENT_GOAL:
    ...
    #         inventory=inventory,
    #         player_name=room_state.player_names[tracked_team, tracked_player],
    #         checks_done=checks_done,
    #         checks_in_area=checks_in_area,
    #         acquired_items={room_state.data.item_id_to_name["A Link to the Past"][id] for id in inventory},
    #         sp_areas=sp_areas,
    #         small_key_ids=small_key_ids,
