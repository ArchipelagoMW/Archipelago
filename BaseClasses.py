...
from typing import AbstractSet, Any, ClassVar, Literal, NamedTuple, Protocol, TYPE_CHECKING
...
class MultiWorld():
    ...
    def can_beat_game(self, starting_state: CollectionState | None = None) -> bool:
        if starting_state:
...
class Region:
    ...
    def add_locations(self, locations: dict[str, int | None],
                      location_type: type[Location] | None = None) -> None:
        """
    ...
    def add_exits(self, exits: Iterable[str] | dict[str, str | None],
