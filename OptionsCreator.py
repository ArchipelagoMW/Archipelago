...
class OptionsCreator(ThemedApp):
    ...
    def export_options(self, button: Widget) -> None:
        if 0 < len(self.name_input.text) < 17 and self.current_game:
            ...
            if self.current_world_version != "" and self.current_world_version != "0.0.0":
                requires = {
                    "version": Utils.__version__,
                    "game" : {self.current_game: self.current_world_version},
                }
            options = {
    ...
    def create_options_panel(self, world_button: WorldButton):
        ...
        self.current_world_version = cls.world_version.as_simple_string()
